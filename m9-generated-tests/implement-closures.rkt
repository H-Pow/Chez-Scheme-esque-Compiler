 ...
 '(module
    ...
    (cletrec
     ((vector-init-loop.8
      ...
      (make-vector.58 (make-closure L.make-vector.58.9 1 make-init-vector.1)))
 ...
 '(module
    ...
    (cletrec
     ((vector-init-loop.6
      ...
      (make-vector.56 (make-closure L.make-vector.56.9 1 make-init-vector.1)))
     (if #f
 ...
 '(module
    ...
    (cletrec
     ((vector?.63 (make-closure L.vector?.63.7 1))
      ...
      (make-vector.62 (make-closure L.make-vector.62.10 1 make-init-vector.1))
 ...
 '(module
    ...
    (cletrec
     ((*.66 (make-closure L.*.66.7 2))
      ...
      (fun/vector8589.5 (make-closure L.fun/vector8589.5.14 0 make-vector.63))
 ...
 '(module
    ...
    (cletrec
     ((boolean?.67 (make-closure L.boolean?.67.7 1))
      ...
      (fun/vector8765.4 (make-closure L.fun/vector8765.4.12 0 make-vector.65))
      ...
      (call
        ...
        *.109
        (let ((error0.44 (error 211))
              ...
              (procedure3.41
               (cletrec ((lam.110 (make-closure L.lam.110.27 0))) lam.110)))
          226)
 ...
 '(module
    ...
    (cletrec
     ((fun/error8923.4 (make-closure L.fun/error8923.4.7 0 fun/error8924.14))
      ...
      (fun/error8919.9 (make-closure L.fun/error8919.9.12 0 fun/error8920.12))
 ...
 '(module
    ...
    (cletrec
     ((<=.78 (make-closure L.<=.78.7 2))
      ...
      (make-vector.76 (make-closure L.make-vector.76.11 1 make-init-vector.1))
      ...
      (fun/vector9133.9 (make-closure L.fun/vector9133.9.17 0 make-vector.76))
 ...
 '(module
    ...
    (cletrec
     ((fun/ascii-char9194.4 (make-closure L.fun/ascii-char9194.4.7 0))
      ...
      (fun/empty9199.7 (make-closure L.fun/empty9199.7.10 0 fun/empty9200.10))
      ...
      (fun/void9201.15 (make-closure L.fun/void9201.15.18 0 fun/void9202.11)))
     (let ((procedure0.20
            (cletrec
 ...
 '(module
    ...
    (cletrec
     ((<=.73 (make-closure L.<=.73.7 2))
      ...
      (make-vector.68 (make-closure L.make-vector.68.14 1 make-init-vector.1))
 ...
 '(module
    ...
    (cletrec
     ((*.69 (make-closure L.*.69.7 2))
      ...
      (fun/void10625.9 (make-closure L.fun/void10625.9.15 0 fun/void10626.6)))
 ...
 '(module
    ...
    (cletrec
     ((fixnum?.73 (make-closure L.fixnum?.73.7 1))
      ...
      (make-vector.72 (make-closure L.make-vector.72.10 1 make-init-vector.1))
      (fun/error10718.4 (make-closure L.fun/error10718.4.11 0))
      (fun/any10714.5 (make-closure L.fun/any10714.5.12 0 make-vector.72))
      (fun/void10715.6 (make-closure L.fun/void10715.6.13 0 fun/void10716.14))
      (fun/vector10712.7
...
(check-by-interp
 '(module
    (define L.lam.75.24
      (lambda (c.93)
        (let ((|-.70| (closure-ref c.93 0)) (|+.71| (closure-ref c.93 1)))
          (call
           L.+.71.9
           |+.71|
           (call
    ...
    (cletrec
     ((unsafe-vector-ref.3 (make-closure L.unsafe-vector-ref.3.7 2))
      ...
      (make-vector.69 (make-closure L.make-vector.69.13 1 make-init-vector.1))
      (fun/void10791.4 (make-closure L.fun/void10791.4.14 0 fun/void10792.10))
 ...
 '(module
    ...
    (cletrec
     ((cons.75 (make-closure L.cons.75.7 2))
      ...
      (make-vector.74 (make-closure L.make-vector.74.10 1 make-init-vector.1))
      (fun/vector11667.4
       (make-closure L.fun/vector11667.4.11 0 fun/vector11668.9))
      (fun/pair11669.5 (make-closure L.fun/pair11669.5.12 0 fun/pair11670.11))
      (fun/void11665.6 (make-closure L.fun/void11665.6.13 0 fun/void11666.14))
      (fun/empty11663.7
 ...
 '(module
    ...
    (cletrec
     ((cons.74 (make-closure L.cons.74.7 2))
      ...
      (fun/pair13985.9 (make-closure L.fun/pair13985.9.13 0 fun/pair13986.12))
      (fun/void13993.10 (make-closure L.fun/void13993.10.14 0 fun/void13994.6))
      ...
      (fun/void13995.14 (make-closure L.fun/void13995.14.18 0 fun/void13996.7))
      (fun/void13989.15
    ...
    (cletrec
     ...
     (let ((vector0.21 (call L.fun/vector14738.4.15 fun/vector14738.4))
           ...
           (procedure5.16
            (cletrec
             ((lam.80
               (make-closure L.lam.80.27 0 fun/any14746.10 ascii-char?.79)))
             lam.80)))
 ...
 '(module
    ...
    (cletrec
     ((procedure?.76 (make-closure L.procedure?.76.7 1))
      ...
      (make-vector.72 (make-closure L.make-vector.72.13 1 make-init-vector.1))
 ...
 '(module
    ...
    (cletrec
     ((ascii-char?.77 (make-closure L.ascii-char?.77.7 1))
      ...
      (fun/pair15426.6 (make-closure L.fun/pair15426.6.11 0 fun/pair15427.15))
      (fun/error15423.7 (make-closure L.fun/error15423.7.12 0))
      (fun/void15424.8 (make-closure L.fun/void15424.8.13 0 fun/void15425.13))
 ...
 '(module
    ...
    (cletrec
     ((|+.76| (make-closure L.+.76.7 2))
      ...
      (fun/void16439.6 (make-closure L.fun/void16439.6.12 0 fun/void16440.14))
 ...
 '(module
    ...
    (cletrec
     ((>.89 (make-closure L.>.89.7 2))
      ...
      (make-vector.83 (make-closure L.make-vector.83.15 1 make-init-vector.1))
 ...
 '(module
    ...
    (cletrec
     ((procedure?.78 (make-closure L.procedure?.78.7 1))
      ...
      (fun/void16600.16 (make-closure L.fun/void16600.16.24 0 fun/void16601.9))
      (fun/vector16594.17
 ...
 '(module
    ...
    (cletrec
     ((void?.79 (make-closure L.void?.79.7 1))
      ...
      (make-vector.76 (make-closure L.make-vector.76.12 1 make-init-vector.1))
      (fun/vector18001.4
      ...
      (fun/void18006.8 (make-closure L.fun/void18006.8.17 0 fun/void18007.12))
 ...
 '(module
    ...
    (cletrec
     ((|+.76| (make-closure L.+.76.7 2))
      ...
      (fun/void18494.9 (make-closure L.fun/void18494.9.15 0 fun/void18495.15))
 ...
 '(module
    ...
    (cletrec
     ((cons.76 (make-closure L.cons.76.7 2))
      (fun/empty22590.4 (make-closure L.fun/empty22590.4.8 0 fun/empty22591.9))
      ...
      (fun/pair22600.13 (make-closure L.fun/pair22600.13.17 0 fun/pair22601.6))
      (fun/error22592.14
 ...
 '(module
    ...
    (cletrec
     ((empty?.78 (make-closure L.empty?.78.7 1))
      ...
      (fun/void24631.10 (make-closure L.fun/void24631.10.20 0 fun/void24632.9))
