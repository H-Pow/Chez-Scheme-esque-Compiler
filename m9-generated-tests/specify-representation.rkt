...
(check-by-interp
 '(module
    ...
    (let ((cons.56 (make-procedure L.cons.56.7 2 0)))
      (call L.cons.56.7 cons.56 6 501))))
(check-by-interp
 '(module
    (define L.cons.56.7
      (lambda (c.57 tmp.51 tmp.52) (let () (cons tmp.51 tmp.52))))
    (let ((cons.56 (make-procedure L.cons.56.7 2 0)))
      (call L.cons.56.7 cons.56 42 510))))
(check-by-interp
 '(module
    (define L.fun/error8439.4.7 (lambda (c.57) (let () (error 148))))
    (let ((fun/error8439.4 (make-procedure L.fun/error8439.4.7 0 0)))
      (call L.fun/error8439.4.7 fun/error8439.4))))
(check-by-interp
 '(module
    (define L.fun/error8442.4.7 (lambda (c.57) (let () (error 247))))
    (let ((fun/error8442.4 (make-procedure L.fun/error8442.4.7 0 0)))
      (call L.fun/error8442.4.7 fun/error8442.4))))
(check-by-interp
 '(module
    (define L.fun/error8445.4.7 (lambda (c.57) (let () (error 141))))
    (let ((fun/error8445.4 (make-procedure L.fun/error8445.4.7 0 0)))
      (call L.fun/error8445.4.7 fun/error8445.4))))
(check-by-interp
 '(module
    (define L.fun/pair8448.4.8
      (lambda (c.59)
        (let ((cons.57 (unsafe-procedure-ref c.59 0)))
          (call L.cons.57.7 cons.57 183 277))))
    (define L.cons.57.7
      (lambda (c.58 tmp.52 tmp.53) (let () (cons tmp.52 tmp.53))))
    (let ((cons.57 (make-procedure L.cons.57.7 2 0))
          (fun/pair8448.4 (make-procedure L.fun/pair8448.4.8 0 1)))
      (begin
        (unsafe-procedure-set! fun/pair8448.4 0 cons.57)
        (call L.fun/pair8448.4.8 fun/pair8448.4)))))
(check-by-interp '(module (let ((ascii-char0.5 #\N) (void1.4 (void))) #t)))
(check-by-interp
 '(module
    (define L.lam.59.10 (lambda (c.63) (let () 72)))
    ...
    (define L.make-init-vector.1.8
      (lambda (c.61 tmp.6)
        (let ((vector-init-loop.8 (unsafe-procedure-ref c.61 0)))
    ...
    (define L.vector-init-loop.8.7
      (lambda (c.60 len.9 i.11 vec.10)
        (let ((vector-init-loop.8 (unsafe-procedure-ref c.60 0)))
          (if (eq? len.9 i.11)
            vec.10
            (begin
              ...
              (call
               ...
               (unsafe-fx+ i.11 1)
               vec.10))))))
    (let ((vector-init-loop.8 (make-procedure L.vector-init-loop.8.7 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.8 1 1))
          (make-vector.58 (make-procedure L.make-vector.58.9 1 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.8 0 vector-init-loop.8)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.8)
        (unsafe-procedure-set! make-vector.58 0 make-init-vector.1)
        (let ((vector0.5 (call L.make-vector.58.9 make-vector.58 8))
              (procedure1.4
               (let ((lam.59 (make-procedure L.lam.59.10 0 0))) lam.59)))
          empty)))))
(check-by-interp
 '(module
    (define L.fun/empty8457.5.9
      (lambda (c.62 oprand0.6)
        (let ((fun/empty8458.4 (unsafe-procedure-ref c.62 0)))
          (call L.fun/empty8458.4.8 fun/empty8458.4))))
    (define L.fun/empty8458.4.8 (lambda (c.61) (let () empty)))
    (define L.cons.59.7
      (lambda (c.60 tmp.54 tmp.55) (let () (cons tmp.54 tmp.55))))
    (let ((cons.59 (make-procedure L.cons.59.7 2 0))
          (fun/empty8458.4 (make-procedure L.fun/empty8458.4.8 0 0))
          (fun/empty8457.5 (make-procedure L.fun/empty8457.5.9 1 1)))
      (begin
        (unsafe-procedure-set! fun/empty8457.5 0 fun/empty8458.4)
        (call
         L.fun/empty8457.5.9
         fun/empty8457.5
         (if #f
           (call L.cons.59.7 cons.59 197 480)
           (call L.cons.59.7 cons.59 47 421)))))))
...
(check-by-interp
 '(module
    (define L.fun/empty8466.6.10 (lambda (c.65) (let () empty)))
    (define L.fun/empty8465.5.9
      (lambda (c.64 oprand0.8)
        (let ((fun/empty8466.6 (unsafe-procedure-ref c.64 0)))
          (call L.fun/empty8466.6.10 fun/empty8466.6))))
    (define L.fun/error8467.4.8 (lambda (c.63 oprand0.7) (let () (error 175))))
    (define L.cons.61.7
      (lambda (c.62 tmp.56 tmp.57) (let () (cons tmp.56 tmp.57))))
    (let ((cons.61 (make-procedure L.cons.61.7 2 0))
          (fun/error8467.4 (make-procedure L.fun/error8467.4.8 1 0))
          (fun/empty8465.5 (make-procedure L.fun/empty8465.5.9 1 1))
          (fun/empty8466.6 (make-procedure L.fun/empty8466.6.10 0 0)))
      (begin
        (unsafe-procedure-set! fun/empty8465.5 0 fun/empty8466.6)
        (call
         L.fun/empty8465.5.9
         fun/empty8465.5
         (call
      ...
      (lambda (c.64 tmp.29 tmp.30)
        (let ()
          (if (fixnum? tmp.30)
            ...
            (error 3)))))
    (let ((|-.63| (make-procedure L.-.63.7 2 0))
          (fun/void8484.4 (make-procedure L.fun/void8484.4.8 0 0))
          (fun/ascii-char8485.5 (make-procedure L.fun/ascii-char8485.5.9 2 0))
          (fun/void8483.6 (make-procedure L.fun/void8483.6.10 2 1)))
      (begin
        (unsafe-procedure-set! fun/void8483.6 0 fun/void8484.4)
        (call
         L.fun/void8483.6.10
         fun/void8483.6
         (call
          ...
          (call L.-.63.7 |-.63| 28 88)
          (call L.fun/ascii-char8485.5.9 fun/ascii-char8485.5 88 #\C))
         (if #t 120 66))))))
(check-by-interp
 '(module
    (if (if #t #t #f)
...
(check-by-interp
 '(module
    (define L.fun/void8491.6.13 (lambda (c.70) (let () (void))))
...
(check-by-interp
 '(module
    (define L.fun/ascii-char8529.5.10 (lambda (c.66) (let () #\W)))
    (define L.fun/error8528.4.9 (lambda (c.65) (let () (error 215))))
    (define L.empty?.61.8 (lambda (c.64 tmp.48) (let () (empty? tmp.48))))
    (define L.-.62.7
      (lambda (c.63 tmp.27 tmp.28)
        (let ()
          (if (fixnum? tmp.28)
            ...
            (error 3)))))
    (let ((|-.62| (make-procedure L.-.62.7 2 0))
          (empty?.61 (make-procedure L.empty?.61.8 1 0))
          (fun/error8528.4 (make-procedure L.fun/error8528.4.9 0 0))
          (fun/ascii-char8529.5
           (make-procedure L.fun/ascii-char8529.5.10 0 0)))
      (let ((error0.8 (call L.fun/error8528.4.9 fun/error8528.4))
            (ascii-char1.7
             (call L.fun/ascii-char8529.5.10 fun/ascii-char8529.5))
            (boolean2.6 (call L.empty?.61.8 empty?.61 #\I)))
        (call L.-.62.7 |-.62| 186 245)))))
(check-by-interp
 '(module
    (define L.fun/pair8538.5.9
      (lambda (c.65 oprand0.9 oprand1.8)
        (let ((cons.62 (unsafe-procedure-ref c.65 0)))
          (call L.cons.62.7 cons.62 5 510))))
    (define L.fun/pair8539.4.8
      (lambda (c.64 oprand0.7 oprand1.6) (let () oprand1.6)))
    (define L.cons.62.7
      (lambda (c.63 tmp.57 tmp.58) (let () (cons tmp.57 tmp.58))))
    (let ((cons.62 (make-procedure L.cons.62.7 2 0))
          (fun/pair8539.4 (make-procedure L.fun/pair8539.4.8 2 0))
          (fun/pair8538.5 (make-procedure L.fun/pair8538.5.9 2 1)))
      (begin
        (unsafe-procedure-set! fun/pair8538.5 0 cons.62)
        (if (if #t #f #f)
          (call L.fun/pair8538.5.9 fun/pair8538.5 247 #f)
          (call
           L.fun/pair8539.4.8
           fun/pair8539.4
           #f
           (call L.cons.62.7 cons.62 28 345)))))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    (define L.fun/ascii-char8590.6.15 (lambda (c.75) (let () #\D)))
    ...
    (let ((*.66 (make-procedure L.*.66.7 2 0))
          ...
          (fun/ascii-char8590.6
           (make-procedure L.fun/ascii-char8590.6.15 0 0)))
      (begin
        ...
        (let ((fixnum0.10
               (call
                L.-.64.9
                |-.64|
                (call L.-.64.9 |-.64| 215 72)
                (call L.-.64.9 |-.64| 219 173)))
              (vector1.9 (call L.fun/vector8589.5.14 fun/vector8589.5))
              (fixnum2.8
               (call
                L.+.65.8
                |+.65|
                (call L.+.65.8 |+.65| 93 220)
                (call L.*.66.7 *.66 170 131)))
              (ascii-char3.7
...
(check-by-interp
 '(module
    ...
    (let ((cons.56 (make-procedure L.cons.56.7 2 0)))
      (if (if #t #t #f)
        (if #t
          (call L.cons.56.7 cons.56 51 420)
          (call L.cons.56.7 cons.56 40 364))
        (if #t
          (call L.cons.56.7 cons.56 241 350)
          (call L.cons.56.7 cons.56 112 345))))))
(check-by-interp
 '(module
    (define L.lam.65.12
      (lambda (c.71)
        (let ((fun/error8691.5 (unsafe-procedure-ref c.71 0)))
          (call L.fun/error8691.5.8 fun/error8691.5))))
    (define L.fun/void8690.8.11 (lambda (c.70) (let () (void))))
    (define L.fun/ascii-char8688.7.10 (lambda (c.69) (let () #\j)))
    (define L.fun/empty8692.6.9 (lambda (c.68) (let () empty)))
    (define L.fun/error8691.5.8 (lambda (c.67) (let () (error 124))))
    (define L.fun/ascii-char8689.4.7 (lambda (c.66) (let () #\I)))
    (let ((fun/ascii-char8689.4 (make-procedure L.fun/ascii-char8689.4.7 0 0))
          (fun/error8691.5 (make-procedure L.fun/error8691.5.8 0 0))
          (fun/empty8692.6 (make-procedure L.fun/empty8692.6.9 0 0))
          (fun/ascii-char8688.7 (make-procedure L.fun/ascii-char8688.7.10 0 0))
          (fun/void8690.8 (make-procedure L.fun/void8690.8.11 0 0)))
      (let ((ascii-char0.12
            ...
            (procedure3.9
             (let ((lam.65 (make-procedure L.lam.65.12 0 1)))
               (begin
                 (unsafe-procedure-set! lam.65 0 fun/error8691.5)
                 lam.65))))
        (call L.fun/empty8692.6.9 fun/empty8692.6)))))
(check-by-interp
 '(module
    (define L.fun/any8764.8.16 (lambda (c.77) (let () (error 55))))
...
(check-by-interp
 '(module
    (define L.lam.110.27 (lambda (c.131) (let () #\X)))
    (define L.fun/pair8798.16.26
      (lambda (c.130)
        (let ((cons.105 (unsafe-procedure-ref c.130 0)))
          (call L.cons.105.13 cons.105 24 277))))
    ...
    (define L.fun/pair8790.10.20
      (lambda (c.124)
        (let ((cons.105 (unsafe-procedure-ref c.124 0)))
          (call L.cons.105.13 cons.105 25 485))))
    ...
    (let ((*.109 (make-procedure L.*.109.7 2 0))
          ...
          (fun/ascii-char8795.12
           (make-procedure L.fun/ascii-char8795.12.22 0 0))
          ...
          (fun/ascii-char8794.15
           (make-procedure L.fun/ascii-char8794.15.25 3 1))
         ...
         (call
           ...
           *.109
           (let ((error0.44 (error 211))
                 ...
                 (procedure3.41
                  (let ((lam.110 (make-procedure L.lam.110.27 0 0))) lam.110)))
             226)
           (call
...
(check-by-interp
 '(module
    (define L.fun/void8928.15.18 (lambda (c.84) (let () (void))))
    (define L.fun/error8924.14.17 (lambda (c.83) (let () (error 130))))
    (define L.fun/ascii-char8925.13.16
      (lambda (c.82)
        (let ((fun/ascii-char8926.5 (unsafe-procedure-ref c.82 0)))
          (call L.fun/ascii-char8926.5.8 fun/ascii-char8926.5))))
    (define L.fun/error8920.12.15 (lambda (c.81) (let () (error 185))))
    (define L.fun/empty8930.11.14 (lambda (c.80) (let () empty)))
    (define L.fun/ascii-char8922.10.13 (lambda (c.79) (let () #\k)))
    (define L.fun/error8919.9.12
      (lambda (c.78)
        (let ((fun/error8920.12 (unsafe-procedure-ref c.78 0)))
          (call L.fun/error8920.12.15 fun/error8920.12))))
    (define L.fun/ascii-char8921.8.11
      (lambda (c.77)
        (let ((fun/ascii-char8922.10 (unsafe-procedure-ref c.77 0)))
          (call L.fun/ascii-char8922.10.13 fun/ascii-char8922.10))))
    (define L.fun/void8927.7.10
      (lambda (c.76)
        (let ((fun/void8928.15 (unsafe-procedure-ref c.76 0)))
          (call L.fun/void8928.15.18 fun/void8928.15))))
    (define L.fun/empty8929.6.9
      (lambda (c.75)
        (let ((fun/empty8930.11 (unsafe-procedure-ref c.75 0)))
          (call L.fun/empty8930.11.14 fun/empty8930.11))))
    (define L.fun/ascii-char8926.5.8 (lambda (c.74) (let () #\x)))
    (define L.fun/error8923.4.7
      (lambda (c.73)
        (let ((fun/error8924.14 (unsafe-procedure-ref c.73 0)))
          (call L.fun/error8924.14.17 fun/error8924.14))))
    (let ((fun/error8923.4 (make-procedure L.fun/error8923.4.7 0 1))
          (fun/ascii-char8926.5 (make-procedure L.fun/ascii-char8926.5.8 0 0))
          (fun/empty8929.6 (make-procedure L.fun/empty8929.6.9 0 1))
          (fun/void8927.7 (make-procedure L.fun/void8927.7.10 0 1))
          (fun/ascii-char8921.8 (make-procedure L.fun/ascii-char8921.8.11 0 1))
          (fun/error8919.9 (make-procedure L.fun/error8919.9.12 0 1))
          (fun/ascii-char8922.10
           (make-procedure L.fun/ascii-char8922.10.13 0 0))
          (fun/empty8930.11 (make-procedure L.fun/empty8930.11.14 0 0))
          (fun/error8920.12 (make-procedure L.fun/error8920.12.15 0 0))
          (fun/ascii-char8925.13
           (make-procedure L.fun/ascii-char8925.13.16 0 1))
          (fun/error8924.14 (make-procedure L.fun/error8924.14.17 0 0))
          (fun/void8928.15 (make-procedure L.fun/void8928.15.18 0 0)))
      (begin
        (unsafe-procedure-set! fun/error8923.4 0 fun/error8924.14)
        (unsafe-procedure-set! fun/empty8929.6 0 fun/empty8930.11)
        (unsafe-procedure-set! fun/void8927.7 0 fun/void8928.15)
        (unsafe-procedure-set! fun/ascii-char8921.8 0 fun/ascii-char8922.10)
        (unsafe-procedure-set! fun/error8919.9 0 fun/error8920.12)
        (unsafe-procedure-set! fun/ascii-char8925.13 0 fun/ascii-char8926.5)
...
(check-by-interp
 '(module
    (define L.lam.72.18
      (lambda (c.84)
        (let ((|-.67| (unsafe-procedure-ref c.84 0))
              (|+.69| (unsafe-procedure-ref c.84 1))
              (<=.70 (unsafe-procedure-ref c.84 2)))
          (call
           L.<=.70.8
           <=.70
           (call
            L.+.69.9
            |+.69|
            (call L.+.69.9 |+.69| 101 114)
            (call L.+.69.9 |+.69| 88 54))
           (call
            L.+.69.9
            |+.69|
            (call L.+.69.9 |+.69| 59 2)
            (call L.-.67.11 |-.67| 47 76))))))
    (define L.fun/void9118.9.17
      (lambda (c.83)
        (let ((fun/void9119.7 (unsafe-procedure-ref c.83 0)))
          (call L.fun/void9119.7.15 fun/void9119.7))))
    (define L.fun/ascii-char9122.8.16
      (lambda (c.82)
        (let ((fun/ascii-char9123.5 (unsafe-procedure-ref c.82 0)))
          (call L.fun/ascii-char9123.5.13 fun/ascii-char9123.5))))
    (define L.fun/void9119.7.15 (lambda (c.81) (let () (void))))
    (define L.fun/empty9120.6.14
      (lambda (c.80)
        (let ((fun/empty9121.4 (unsafe-procedure-ref c.80 0)))
          (call L.fun/empty9121.4.12 fun/empty9121.4))))
    (define L.fun/ascii-char9123.5.13 (lambda (c.79) (let () #\s)))
    (define L.fun/empty9121.4.12 (lambda (c.78) (let () empty)))
    (define L.-.67.11
      ...
      (lambda (c.73 tmp.41 tmp.42)
        (let ()
          (if (fixnum? tmp.42)
            ...
            (error 7)))))
    (let ((>=.71 (make-procedure L.>=.71.7 2 0))
          (<=.70 (make-procedure L.<=.70.8 2 0))
          (|+.69| (make-procedure L.+.69.9 2 0))
          (*.68 (make-procedure L.*.68.10 2 0))
          (|-.67| (make-procedure L.-.67.11 2 0))
          (fun/empty9121.4 (make-procedure L.fun/empty9121.4.12 0 0))
          (fun/ascii-char9123.5 (make-procedure L.fun/ascii-char9123.5.13 0 0))
          (fun/empty9120.6 (make-procedure L.fun/empty9120.6.14 0 1))
          (fun/void9119.7 (make-procedure L.fun/void9119.7.15 0 0))
          (fun/ascii-char9122.8 (make-procedure L.fun/ascii-char9122.8.16 0 1))
          (fun/void9118.9 (make-procedure L.fun/void9118.9.17 0 1)))
      (begin
        (unsafe-procedure-set! fun/empty9120.6 0 fun/empty9121.4)
        (unsafe-procedure-set! fun/ascii-char9122.8 0 fun/ascii-char9123.5)
        (unsafe-procedure-set! fun/void9118.9 0 fun/void9119.7)
        (let ((void0.14 (call L.fun/void9118.9.17 fun/void9118.9))
              (fixnum1.13
                ...
                *.68
                (call
                 L.*.68.10
                 *.68
                 (call L.-.67.11 |-.67| 25 226)
                 (call L.-.67.11 |-.67| 159 56))
                (call
                 L.-.67.11
                 |-.67|
                 (call L.*.68.10 *.68 192 122)
                 (call L.-.67.11 |-.67| 47 86))))
              (empty2.12 (call L.fun/empty9120.6.14 fun/empty9120.6))
              (procedure3.11
               (let ((lam.72 (make-procedure L.lam.72.18 0 3)))
                 (begin
                   (unsafe-procedure-set! lam.72 0 |-.67|)
                   (unsafe-procedure-set! lam.72 1 |+.69|)
                   (unsafe-procedure-set! lam.72 2 <=.70)
                   lam.72)))
              (ascii-char4.10
          ...
          (call
           ...
           (call
            L.-.67.11
            |-.67|
            (call L.+.69.9 |+.69| 68 167)
            (call L.+.69.9 |+.69| 167 157))
           (call
            L.-.67.11
            |-.67|
            (call L.-.67.11 |-.67| 30 155)
            (call L.+.69.9 |+.69| 28 101))))))))
(check-by-interp
 '(module
    (define L.lam.80.23
      (lambda (c.97)
    ...
    (let ((<=.78 (make-procedure L.<=.78.7 2 0))
          ...
          (fun/ascii-char9129.10
           (make-procedure L.fun/ascii-char9129.10.18 0 0))
          ...
          (fun/ascii-char9135.13
           (make-procedure L.fun/ascii-char9135.13.21 0 0)))
      (begin
        ...
        (if (call L.vector?.77.8 vector?.77 (if #f empty (void)))
          (let ((procedure0.18
                 (let ((lam.79 (make-procedure L.lam.79.22 0 1)))
                   (begin
          ...
          (let ((procedure0.23
                 (let ((lam.80 (make-procedure L.lam.80.23 0 1)))
                   (begin
...
(check-by-interp
 '(module
    (define L.lam.73.19
      (lambda (c.86)
        (let ((fun/error9191.12 (unsafe-procedure-ref c.86 0)))
          (call L.fun/error9191.12.15 fun/error9191.12))))
    (define L.fun/void9201.15.18
      (lambda (c.85)
        (let ((fun/void9202.11 (unsafe-procedure-ref c.85 0)))
          (call L.fun/void9202.11.14 fun/void9202.11))))
    (define L.fun/error9192.14.17 (lambda (c.84) (let () (error 213))))
    (define L.fun/error9196.13.16 (lambda (c.83) (let () (error 198))))
    (define L.fun/error9191.12.15
      (lambda (c.82)
        (let ((fun/error9192.14 (unsafe-procedure-ref c.82 0)))
          (call L.fun/error9192.14.17 fun/error9192.14))))
    (define L.fun/void9202.11.14 (lambda (c.81) (let () (void))))
    (define L.fun/empty9200.10.13 (lambda (c.80) (let () empty)))
    (define L.fun/ascii-char9193.9.12
      (lambda (c.79)
        (let ((fun/ascii-char9194.4 (unsafe-procedure-ref c.79 0)))
          (call L.fun/ascii-char9194.4.7 fun/ascii-char9194.4))))
    (define L.fun/void9198.8.11 (lambda (c.78) (let () (void))))
    (define L.fun/empty9199.7.10
      (lambda (c.77)
        (let ((fun/empty9200.10 (unsafe-procedure-ref c.77 0)))
          (call L.fun/empty9200.10.13 fun/empty9200.10))))
    (define L.fun/error9195.6.9
      (lambda (c.76)
        (let ((fun/error9196.13 (unsafe-procedure-ref c.76 0)))
          (call L.fun/error9196.13.16 fun/error9196.13))))
    (define L.fun/void9197.5.8
      (lambda (c.75)
        (let ((fun/void9198.8 (unsafe-procedure-ref c.75 0)))
          (call L.fun/void9198.8.11 fun/void9198.8))))
    (define L.fun/ascii-char9194.4.7 (lambda (c.74) (let () #\f)))
    (let ((fun/ascii-char9194.4 (make-procedure L.fun/ascii-char9194.4.7 0 0))
          (fun/void9197.5 (make-procedure L.fun/void9197.5.8 0 1))
          (fun/error9195.6 (make-procedure L.fun/error9195.6.9 0 1))
          (fun/empty9199.7 (make-procedure L.fun/empty9199.7.10 0 1))
          (fun/void9198.8 (make-procedure L.fun/void9198.8.11 0 0))
          (fun/ascii-char9193.9 (make-procedure L.fun/ascii-char9193.9.12 0 1))
          (fun/empty9200.10 (make-procedure L.fun/empty9200.10.13 0 0))
          (fun/void9202.11 (make-procedure L.fun/void9202.11.14 0 0))
          (fun/error9191.12 (make-procedure L.fun/error9191.12.15 0 1))
          (fun/error9196.13 (make-procedure L.fun/error9196.13.16 0 0))
          (fun/error9192.14 (make-procedure L.fun/error9192.14.17 0 0))
          (fun/void9201.15 (make-procedure L.fun/void9201.15.18 0 1)))
      (begin
        (unsafe-procedure-set! fun/void9197.5 0 fun/void9198.8)
        (unsafe-procedure-set! fun/error9195.6 0 fun/error9196.13)
        (unsafe-procedure-set! fun/empty9199.7 0 fun/empty9200.10)
        (unsafe-procedure-set! fun/ascii-char9193.9 0 fun/ascii-char9194.4)
        (unsafe-procedure-set! fun/error9191.12 0 fun/error9192.14)
        (unsafe-procedure-set! fun/void9201.15 0 fun/void9202.11)
        (let ((procedure0.20
               (let ((lam.73 (make-procedure L.lam.73.19 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.73 0 fun/error9191.12)
                   lam.73)))
              (ascii-char1.19
 ...
 '(module
    ...
    (let ((|-.74| (make-procedure L.-.74.7 2 0))
          ...
          (fun/ascii-char9886.11
           (make-procedure L.fun/ascii-char9886.11.20 0 1))
      ...
      (begin
        ...
        (let ((void0.18 (call L.fun/void9884.8.17 fun/void9884.8))
              ...
              (procedure2.16
               (let ((lam.75 (make-procedure L.lam.75.23 0 1)))
                 (begin
              ...
              (fixnum4.14
                ...
                *.73
                (call
                 L.*.73.8
                 *.73
                 (call L.+.72.9 |+.72| 168 24)
                 (call L.*.73.8 *.73 207 124))
                (call
                 L.*.73.8
                 *.73
                 (call L.*.73.8 *.73 127 249)
                 (call L.-.74.7 |-.74| 196 211)))))
          (call L.fun/ascii-char9892.7.16 fun/ascii-char9892.7))))))
(check-by-interp
 '(module
    (define L.lam.74.22
      (lambda (c.90)
        (let ((fun/void10281.10 (unsafe-procedure-ref c.90 0)))
          (call L.fun/void10281.10.21 fun/void10281.10))))
    (define L.fun/void10281.10.21
      (lambda (c.89)
        (let ((fun/void10282.4 (unsafe-procedure-ref c.89 0)))
          (call L.fun/void10282.4.15 fun/void10282.4))))
    (define L.fun/any10280.9.20 (lambda (c.88) (let () #f)))
    (define L.fun/vector10279.8.19
      (lambda (c.87)
        (let ((make-vector.68 (unsafe-procedure-ref c.87 0)))
          (call L.make-vector.68.14 make-vector.68 8))))
    (define L.fun/empty10283.7.18
      (lambda (c.86)
        (let ((fun/empty10284.5 (unsafe-procedure-ref c.86 0)))
          (call L.fun/empty10284.5.16 fun/empty10284.5))))
    (define L.fun/vector10278.6.17
      (lambda (c.85)
        (let ((fun/vector10279.8 (unsafe-procedure-ref c.85 0)))
          (call L.fun/vector10279.8.19 fun/vector10279.8))))
    (define L.fun/empty10284.5.16 (lambda (c.84) (let () empty)))
    (define L.fun/void10282.4.15 (lambda (c.83) (let () (void))))
    ...
    (define L.make-init-vector.1.13
      (lambda (c.81 tmp.16)
        (let ((vector-init-loop.18 (unsafe-procedure-ref c.81 0)))
    ...
    (define L.vector-init-loop.18.12
      (lambda (c.80 len.19 i.21 vec.20)
        (let ((vector-init-loop.18 (unsafe-procedure-ref c.80 0)))
          (if (eq? len.19 i.21)
            vec.20
            (begin
              ...
              (call
               ...
               (unsafe-fx+ i.21 1)
               vec.20))))))
    (define L.void?.69.11 (lambda (c.79 tmp.56) (let () (void? tmp.56))))
    (define L.+.70.10
    ...
    (let ((<=.73 (make-procedure L.<=.73.7 2 0))
          ...
          (void?.69 (make-procedure L.void?.69.11 1 0))
          (vector-init-loop.18 (make-procedure L.vector-init-loop.18.12 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.13 1 1))
          (make-vector.68 (make-procedure L.make-vector.68.14 1 1))
          (fun/void10282.4 (make-procedure L.fun/void10282.4.15 0 0))
          (fun/empty10284.5 (make-procedure L.fun/empty10284.5.16 0 0))
          (fun/vector10278.6 (make-procedure L.fun/vector10278.6.17 0 1))
          (fun/empty10283.7 (make-procedure L.fun/empty10283.7.18 0 1))
          (fun/vector10279.8 (make-procedure L.fun/vector10279.8.19 0 1))
          (fun/any10280.9 (make-procedure L.fun/any10280.9.20 0 0))
          (fun/void10281.10 (make-procedure L.fun/void10281.10.21 0 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.18 0 vector-init-loop.18)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.18)
        (unsafe-procedure-set! make-vector.68 0 make-init-vector.1)
        (unsafe-procedure-set! fun/vector10278.6 0 fun/vector10279.8)
        (unsafe-procedure-set! fun/empty10283.7 0 fun/empty10284.5)
        (unsafe-procedure-set! fun/vector10279.8 0 make-vector.68)
        (unsafe-procedure-set! fun/void10281.10 0 fun/void10282.4)
              ...
              (fixnum2.13
               (call
                ...
                (call
                 L.-.71.9
                 |-.71|
                 (call L.+.70.10 |+.70| 119 181)
                 (call L.+.70.10 |+.70| 72 105))
                (call
                 L.-.71.9
                 |-.71|
                 (call L.+.70.10 |+.70| 81 154)
                 (call L.*.72.8 *.72 141 81))))
              (procedure3.12
               (let ((lam.74 (make-procedure L.lam.74.22 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.74 0 fun/void10281.10)
                   lam.74)))
              (boolean4.11
               (call
                L.<=.73.7
                ...
                (call
                 L.*.72.8
                 *.72
                 (call L.-.71.9 |-.71| 176 127)
                 (call L.+.70.10 |+.70| 186 126))
                (call
                 L.-.71.9
                 |-.71|
                 (call L.*.72.8 *.72 75 253)
                 (call L.-.71.9 |-.71| 185 207)))))
          (call L.fun/empty10283.7.18 fun/empty10283.7))))))
(check-by-interp
 '(module
    (define L.fun/void10625.9.15
      (lambda (c.78)
        (let ((fun/void10626.6 (unsafe-procedure-ref c.78 0)))
          (call L.fun/void10626.6.12 fun/void10626.6))))
    (define L.fun/void10628.8.14 (lambda (c.77) (let () (void))))
    (define L.fun/void10627.7.13
      (lambda (c.76)
        (let ((fun/void10628.8 (unsafe-procedure-ref c.76 0)))
          (call L.fun/void10628.8.14 fun/void10628.8))))
    (define L.fun/void10626.6.12 (lambda (c.75) (let () (void))))
    (define L.fun/error10624.5.11 (lambda (c.74) (let () (error 75))))
    (define L.fun/error10623.4.10
      (lambda (c.73)
        (let ((fun/error10624.5 (unsafe-procedure-ref c.73 0)))
      ...
      (lambda (c.70 tmp.29 tmp.30)
        (let ()
          (if (fixnum? tmp.30)
            (if (fixnum? tmp.29) (unsafe-fx* tmp.29 tmp.30) (error 1))
            (error 1)))))
    (let ((*.69 (make-procedure L.*.69.7 2 0))
          (|-.68| (make-procedure L.-.68.8 2 0))
          (|+.67| (make-procedure L.+.67.9 2 0))
          (fun/error10623.4 (make-procedure L.fun/error10623.4.10 0 1))
          (fun/error10624.5 (make-procedure L.fun/error10624.5.11 0 0))
          (fun/void10626.6 (make-procedure L.fun/void10626.6.12 0 0))
          (fun/void10627.7 (make-procedure L.fun/void10627.7.13 0 1))
          (fun/void10628.8 (make-procedure L.fun/void10628.8.14 0 0))
          (fun/void10625.9 (make-procedure L.fun/void10625.9.15 0 1)))
      (begin
        (unsafe-procedure-set! fun/error10623.4 0 fun/error10624.5)
        (unsafe-procedure-set! fun/void10627.7 0 fun/void10628.8)
        (unsafe-procedure-set! fun/void10625.9 0 fun/void10626.6)
              ...
              (fixnum2.12
               (call
                ...
                (call
                 L.+.67.9
                 |+.67|
                 (call L.+.67.9 |+.67| 177 96)
                 (call L.-.68.8 |-.68| 65 207))
                (call
                 L.*.69.7
                 *.69
                 (call L.-.68.8 |-.68| 170 11)
                 (call L.*.69.7 *.69 52 179))))
              (fixnum3.11
               (call
                L.*.69.7
                *.69
                (call
                 L.+.67.9
                 |+.67|
                 (call L.-.68.8 |-.68| 72 203)
                 (call L.+.67.9 |+.67| 144 243))
                (call
                 L.-.68.8
                 |-.68|
                 (call L.-.68.8 |-.68| 179 253)
                 (call L.*.69.7 *.69 42 49))))
              (fixnum4.10
               (call
                L.-.68.8
                |-.68|
                (call
                 L.+.67.9
                 |+.67|
                 (call L.*.69.7 *.69 47 226)
                 (call L.-.68.8 |-.68| 208 124))
                (call
                 L.-.68.8
                 |-.68|
                 (call L.+.67.9 |+.67| 230 152)
                 (call L.+.67.9 |+.67| 214 219)))))
 ...
 '(module
    ...
    (let ((fixnum?.73 (make-procedure L.fixnum?.73.7 1 0))
          ...
          (fun/ascii-char10710.8
           (make-procedure L.fun/ascii-char10710.8.15 0 1))
          ...
          (fun/ascii-char10711.12
           (make-procedure L.fun/ascii-char10711.12.19 0 0))
 ...
 '(module
        ...
        (let ((|-.70| (unsafe-procedure-ref c.93 0))
          ...
          (call
           ...
           (call
            L.-.70.10
            |-.70|
            (call L.-.70.10 |-.70| 90 126)
            (call L.-.70.10 |-.70| 96 108))
           (call
            L.+.71.9
            |+.71|
    ...
    (let ((unsafe-vector-ref.3 (make-procedure L.unsafe-vector-ref.3.7 2 0))
          ...
          (fun/ascii-char10794.5
           (make-procedure L.fun/ascii-char10794.5.15 0 0))
          (fun/ascii-char10796.6
           (make-procedure L.fun/ascii-char10796.6.16 0 0))
          (fun/ascii-char10795.7
           (make-procedure L.fun/ascii-char10795.7.17 0 1))
          ...
          (fun/ascii-char10793.11
           (make-procedure L.fun/ascii-char10793.11.21 0 1)))
      (begin
        ...
        (let ((vector0.16 (call L.fun/vector10789.8.18 fun/vector10789.8))
              (procedure1.15
               (let ((lam.73 (make-procedure L.lam.73.22 0 1)))
                 (begin
              ...
              (procedure3.13
               (let ((lam.74 (make-procedure L.lam.74.23 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.74 0 fun/ascii-char10795.7)
                   lam.74)))
              (procedure4.12
               (let ((lam.75 (make-procedure L.lam.75.24 0 2)))
                 (begin
