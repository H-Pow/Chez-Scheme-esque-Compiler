 ...
 '(module
    ...
    (define L.cons.160.16
      (lambda (c.171 tmp.155 tmp.156)
        (begin
          (begin
            (set! tmp.182 (begin (set! tmp.203 (alloc 16)) (+ tmp.203 1)))
            (begin
          ...
          (if (begin
                (set! tmp.208
                  (if (begin
                    ...
                    6))
                (!= tmp.208 6))
            (if (begin (set! tmp.210 (if (>= tmp.115 0) 14 6)) (!= tmp.210 6))
              (begin
                (begin
                  (set! tmp.211
                    (begin
                        ...
                        (set! tmp.218
                          (begin
                            (set! tmp.219
                              (begin
                                (set! tmp.220
                                  (arithmetic-shift-right tmp.108 3))
                                (+ 1 tmp.220)))
                            (* tmp.219 8)))
                        (alloc tmp.218)))
                    (+ tmp.217 3)))
    ...
    (define L.vector-init-loop.110.10
      (lambda (c.165 len.111 i.113 vec.112)
        (begin
          ...
          (if (begin (set! tmp.221 (if (= len.111 i.113) 14 6)) (!= tmp.221 6))
            vec.112
            (begin
              (begin
                (set! tmp.222
              ...
              (begin
                ...
                (call
                 ...
                 vec.112)))))))
    (begin
      (set! vector-init-loop.110
        (begin
          (set! tmp.184 (begin (set! tmp.226 (alloc 24)) (+ tmp.226 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.185 (begin (set! tmp.227 (alloc 24)) (+ tmp.227 2)))
          (begin
      ...
      (set! make-vector.163
        (begin
          (set! tmp.186 (begin (set! tmp.228 (alloc 24)) (+ tmp.228 2)))
          (begin
      ...
      (set! cons.160
        (begin
          ...
          (begin
            ...
            (mset! tmp.190 6 16)
            tmp.190)))
      (set! fun/boolean8789.21
        (begin
          (set! tmp.191 (begin (set! tmp.233 (alloc 16)) (+ tmp.233 2)))
          (begin
            (mset! tmp.191 -2 L.fun/boolean8789.21.17)
            (mset! tmp.191 6 8)
            tmp.191)))
      (set! fun/boolean8790.22
        (begin
          (set! tmp.192 (begin (set! tmp.234 (alloc 16)) (+ tmp.234 2)))
          (begin
            (mset! tmp.192 -2 L.fun/boolean8790.22.18)
            (mset! tmp.192 6 16)
            tmp.192)))
      (set! fun/ascii-char8791.23
        (begin
          (set! tmp.193 (begin (set! tmp.235 (alloc 16)) (+ tmp.235 2)))
          (begin
      ...
      (set! fun/void8788.24
        (begin
          (set! tmp.194 (begin (set! tmp.236 (alloc 16)) (+ tmp.236 2)))
          (begin
      ...
      (set! fun/void8786.25
        (begin
          (set! tmp.195 (begin (set! tmp.237 (alloc 16)) (+ tmp.237 2)))
          (begin
            (mset! tmp.195 -2 L.fun/void8786.25.21)
            (mset! tmp.195 6 0)
            tmp.195)))
      (set! fun/ascii-char8785.26
        (begin
          (set! tmp.196 (begin (set! tmp.238 (alloc 16)) (+ tmp.238 2)))
          (begin
            (mset! tmp.196 -2 L.fun/ascii-char8785.26.22)
            (mset! tmp.196 6 0)
            tmp.196)))
      (set! fun/ascii-char8783.27
        (begin
          (set! tmp.197 (begin (set! tmp.239 (alloc 24)) (+ tmp.239 2)))
          (begin
      ...
      (set! fun/void8787.28
        (begin
          (set! tmp.198 (begin (set! tmp.240 (alloc 32)) (+ tmp.240 2)))
          (begin
            (mset! tmp.198 -2 L.fun/void8787.28.24)
            (mset! tmp.198 6 8)
            tmp.198)))
      (set! fun/ascii-char8784.29
        (begin
          (set! tmp.199 (begin (set! tmp.241 (alloc 24)) (+ tmp.241 2)))
          (begin
                                    ...
                                    (begin
                                      ...
                                      (if (begin
                                        ...
                                        (call
                                         ...
                                         fun/void8788.24))))))))))))))
              (begin
                (set! tmp.259 (begin (set! error0.54 38206) 50750))
                (call
                      ...
                      (set! tmp.15.70
                        (if (begin
                          ...
                          (if (!= 27182 6)
                            (if (!= 18478 6)
                              (if (!= 24878 6)
                                (if (!= 17710 6) (if (!= 26670 6) 19246 6) 6)
                                6)
                              6)
                            6)))
                      (if (!= tmp.15.70 6)
...
(check-by-interp
 '(module
                        ...
                        (set! tmp.99
                          (begin
                            (set! tmp.100
                              (begin
                                (set! tmp.101
                                  (arithmetic-shift-right tmp.27 3))
                                (+ 1 tmp.101)))
                            (* tmp.100 8)))
                        (alloc tmp.99)))
                    (+ tmp.98 3)))
    ...
    (define L.vector-init-loop.29.12
      (lambda (c.84 len.30 i.32 vec.31)
        (begin
          ...
          (if (begin (set! tmp.102 (if (= len.30 i.32) 14 6)) (!= tmp.102 6))
            vec.31
            (begin
              (begin
                (set! tmp.103
      ...
      (lambda (c.83 tmp.57 tmp.58 tmp.59)
        (begin
          ...
          (if (begin
                (set! tmp.107
                  (if (begin
                        (set! tmp.108 (bitwise-and tmp.58 7))
                        (= tmp.108 0))
                    14
                    6))
                (!= tmp.107 6))
      ...
      (lambda (c.82 tmp.33 tmp.34 tmp.35)
        (begin
          (if (begin
                (set! tmp.111
                  (if (begin
                        (set! tmp.112 (mref tmp.33 -3))
                        (< tmp.34 tmp.112))
                    14
                    6))
                (!= tmp.111 6))
            (if (begin (set! tmp.113 (if (>= tmp.34 0) 14 6)) (!= tmp.113 6))
              (begin
                (begin
                  (set! tmp.114
                    (begin
    ...
    (begin
      (set! unsafe-vector-set!.5
        (begin
          (set! tmp.89 (begin (set! tmp.117 (alloc 16)) (+ tmp.117 2)))
          (begin
      ...
      (set! vector-set!.81
        (begin
          (set! tmp.90 (begin (set! tmp.118 (alloc 24)) (+ tmp.118 2)))
          (begin
            (mset! tmp.90 -2 L.vector-set!.81.11)
            (mset! tmp.90 6 24)
            tmp.90)))
      (set! vector-init-loop.29
        (begin
          (set! tmp.91 (begin (set! tmp.119 (alloc 24)) (+ tmp.119 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.92 (begin (set! tmp.120 (alloc 24)) (+ tmp.120 2)))
          (begin
      ...
      (set! error?.79
        (begin
          ...
          (begin (mset! tmp.94 -2 L.error?.79.15) (mset! tmp.94 6 8) tmp.94)))
      (begin
        (mset! vector-set!.81 14 unsafe-vector-set!.5)
                ...
                (begin
                  (set! g43077548.9
                    (if (!= 14 6)
                      (if (!= 6 6)
                        (if (!= 6 6)
                          (if (!= 14 6) (if (!= 14 6) (if (!= 14 6) 14 6) 6) 6)
                          6)
                        6)
                      6))
                  (if (begin
 ...
 '(module
                        ...
                        (set! tmp.172
                          (begin
                            (set! tmp.173
                              (begin
                                (set! tmp.174
                                  (arithmetic-shift-right tmp.83 3))
                                (+ 1 tmp.174)))
                            (* tmp.173 8)))
                        (alloc tmp.172)))
                    (+ tmp.171 3)))
    ...
    (define L.vector-init-loop.85.13
      (lambda (c.143 len.86 i.88 vec.87)
        (begin
          ...
          (if (begin (set! tmp.175 (if (= len.86 i.88) 14 6)) (!= tmp.175 6))
            vec.87
            (begin
              (begin
                (set! tmp.176
      ...
      (lambda (c.141 tmp.89 tmp.90 tmp.91)
        (begin
          (if (begin
                (set! tmp.184
                  (if (begin
                        (set! tmp.185 (mref tmp.89 -3))
                        (< tmp.90 tmp.185))
                    14
                    6))
                (!= tmp.184 6))
            (if (begin (set! tmp.186 (if (>= tmp.90 0) 14 6)) (!= tmp.186 6))
              (begin
                (begin
                  (set! tmp.187
                    (begin
    ...
    (define L.cons.138.10
      (lambda (c.140 tmp.130 tmp.131)
        (begin
          (begin
            (set! tmp.154 (begin (set! tmp.190 (alloc 16)) (+ tmp.190 1)))
            (begin
    ...
    (begin
      (set! cons.138
        (begin
          (set! tmp.155 (begin (set! tmp.191 (alloc 16)) (+ tmp.191 2)))
          (begin
      ...
      (set! unsafe-vector-set!.5
        (begin
          (set! tmp.156 (begin (set! tmp.192 (alloc 16)) (+ tmp.192 2)))
          (begin
      ...
      (set! vector-set!.137
        (begin
          (set! tmp.157 (begin (set! tmp.193 (alloc 24)) (+ tmp.193 2)))
          (begin
            (mset! tmp.157 -2 L.vector-set!.137.12)
            (mset! tmp.157 6 24)
            tmp.157)))
      (set! vector-init-loop.85
        (begin
          (set! tmp.158 (begin (set! tmp.194 (alloc 24)) (+ tmp.194 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.159 (begin (set! tmp.195 (alloc 24)) (+ tmp.195 2)))
          (begin
      ...
      (set! make-vector.136
        (begin
          (set! tmp.160 (begin (set! tmp.196 (alloc 24)) (+ tmp.196 2)))
          (begin
      ...
      (set! error?.135
        (begin
          (set! tmp.161 (begin (set! tmp.197 (alloc 16)) (+ tmp.197 2)))
          (begin
            (mset! tmp.161 -2 L.error?.135.16)
            (mset! tmp.161 6 8)
            tmp.161)))
      (set! fun/ascii-char8840.13
        (begin
          (set! tmp.162 (begin (set! tmp.198 (alloc 16)) (+ tmp.198 2)))
          (begin
            (mset! tmp.162 -2 L.fun/ascii-char8840.13.17)
            (mset! tmp.162 6 16)
            tmp.162)))
      (set! fun/ascii-char8839.14
        (begin
          (set! tmp.163 (begin (set! tmp.199 (alloc 16)) (+ tmp.199 2)))
          (begin
            (mset! tmp.163 -2 L.fun/ascii-char8839.14.18)
            (mset! tmp.163 6 16)
            tmp.163)))
      (set! fun/ascii-char8841.15
        (begin
          (set! tmp.164 (begin (set! tmp.200 (alloc 16)) (+ tmp.200 2)))
          (begin
            (mset! tmp.164 -2 L.fun/ascii-char8841.15.19)
            (mset! tmp.164 6 16)
            tmp.164)))
      (set! fun/boolean8837.16
        (begin
          (set! tmp.165 (begin (set! tmp.201 (alloc 24)) (+ tmp.201 2)))
          (begin
            (mset! tmp.165 -2 L.fun/boolean8837.16.20)
            (mset! tmp.165 6 16)
            tmp.165)))
      (set! fun/boolean8838.17
        (begin
          (set! tmp.166 (begin (set! tmp.202 (alloc 16)) (+ tmp.202 2)))
          (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (if (begin
              ...
              g43081409.64
              (begin
                (set! g43081410.65 (if (!= 6 6) 19758 21550))
                (if (begin
                      (set! tmp.244
...
(check-by-interp
 '(module
    (begin
      (set! boolean0.7
        (begin (set! ascii-char0.9 21806) (set! error1.8 51006) 6))
 ...
 '(module
    ...
    (define L.cons.122.17
      (lambda (c.137 tmp.117 tmp.118)
        (begin
          (begin
            (set! tmp.151 (begin (set! tmp.175 (alloc 16)) (+ tmp.175 1)))
            (begin
      ...
      (lambda (c.135 tmp.84 tmp.85)
        (begin
          (if (begin
                (set! tmp.177
                  (if (begin
                        (set! tmp.178 (bitwise-and tmp.85 7))
                        (= tmp.178 0))
                    14
                    6))
                (!= tmp.177 6))
      ...
      (lambda (c.134 tmp.98)
        (begin
          ...
          (if (begin
                (set! tmp.182
                  (if (begin
                        (set! tmp.183 (bitwise-and tmp.98 7))
                        (= tmp.183 0))
                    14
                    6))
                (!= tmp.182 6))
                        ...
                        (set! tmp.185
                          (begin
                            (set! tmp.186
                              (begin
                                (set! tmp.187
                                  (arithmetic-shift-right tmp.70 3))
                                (+ 1 tmp.187)))
                            (* tmp.186 8)))
                        (alloc tmp.185)))
                    (+ tmp.184 3)))
    ...
    (define L.vector-init-loop.72.12
      (lambda (c.132 len.73 i.75 vec.74)
        (begin
          ...
          (if (begin (set! tmp.188 (if (= len.73 i.75) 14 6)) (!= tmp.188 6))
            vec.74
            (begin
              (begin
                (set! tmp.189
      ...
      (lambda (c.130 tmp.76 tmp.77 tmp.78)
        (begin
          (if (begin
                (set! tmp.197
                  (if (begin
                        (set! tmp.198 (mref tmp.76 -3))
                        (< tmp.77 tmp.198))
                    14
                    6))
                (!= tmp.197 6))
            (if (begin (set! tmp.199 (if (>= tmp.77 0) 14 6)) (!= tmp.199 6))
              (begin
                (begin
                  (set! tmp.200
                    (begin
    ...
    (begin
      (set! unsafe-vector-set!.5
        (begin
          (set! tmp.153 (begin (set! tmp.203 (alloc 16)) (+ tmp.203 2)))
          (begin
      ...
      (set! vector-set!.126
        (begin
          (set! tmp.154 (begin (set! tmp.204 (alloc 24)) (+ tmp.204 2)))
          (begin
            (mset! tmp.154 -2 L.vector-set!.126.11)
            (mset! tmp.154 6 24)
            tmp.154)))
      (set! vector-init-loop.72
        (begin
          (set! tmp.155 (begin (set! tmp.205 (alloc 24)) (+ tmp.205 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.156 (begin (set! tmp.206 (alloc 24)) (+ tmp.206 2)))
          (begin
      ...
      (set! make-vector.125
        (begin
          (set! tmp.157 (begin (set! tmp.207 (alloc 24)) (+ tmp.207 2)))
          (begin
      ...
      (set! *.124
        (begin
          (set! tmp.158 (begin (set! tmp.208 (alloc 16)) (+ tmp.208 2)))
          (begin (mset! tmp.158 -2 L.*.124.15) (mset! tmp.158 6 16) tmp.158)))
      (set! error?.123
        (begin
          (set! tmp.159 (begin (set! tmp.209 (alloc 16)) (+ tmp.209 2)))
          (begin
      ...
      (set! cons.122
        (begin
          (set! tmp.160 (begin (set! tmp.210 (alloc 16)) (+ tmp.210 2)))
          (begin
            (mset! tmp.160 -2 L.cons.122.17)
            (mset! tmp.160 6 16)
            tmp.160)))
      (set! fun/error8847.16
        (begin
          (set! tmp.161 (begin (set! tmp.211 (alloc 24)) (+ tmp.211 2)))
          (begin
            (mset! tmp.161 -2 L.fun/error8847.16.18)
            (mset! tmp.161 6 0)
            tmp.161)))
      (set! fun/error8846.17
        (begin
          (set! tmp.162 (begin (set! tmp.212 (alloc 24)) (+ tmp.212 2)))
          (begin
      ...
      (set! fun/pair8849.18
        (begin
          (set! tmp.163 (begin (set! tmp.213 (alloc 24)) (+ tmp.213 2)))
          (begin
            (mset! tmp.163 -2 L.fun/pair8849.18.20)
            (mset! tmp.163 6 8)
            tmp.163)))
      (set! fun/fixnum8851.19
        (begin
          (set! tmp.164 (begin (set! tmp.214 (alloc 16)) (+ tmp.214 2)))
          (begin
            (mset! tmp.164 -2 L.fun/fixnum8851.19.21)
            (mset! tmp.164 6 8)
            tmp.164)))
      (set! fun/fixnum8850.20
        (begin
          (set! tmp.165 (begin (set! tmp.215 (alloc 16)) (+ tmp.215 2)))
          (begin
            (mset! tmp.165 -2 L.fun/fixnum8850.20.22)
            (mset! tmp.165 6 8)
            tmp.165)))
      (set! fun/error8852.21
        (begin
          (set! tmp.166 (begin (set! tmp.216 (alloc 24)) (+ tmp.216 2)))
          (begin
            (mset! tmp.166 -2 L.fun/error8852.21.23)
            (mset! tmp.166 6 0)
            tmp.166)))
      (set! fun/error8848.22
        (begin
          (set! tmp.167 (begin (set! tmp.217 (alloc 16)) (+ tmp.217 2)))
          (begin
            (mset! tmp.167 -2 L.fun/error8848.22.24)
            (mset! tmp.167 6 0)
            tmp.167)))
      (set! fun/error8853.23
        (begin
          (set! tmp.168 (begin (set! tmp.218 (alloc 16)) (+ tmp.218 2)))
          (begin
            (mset! tmp.168 -2 L.fun/error8853.23.25)
            (mset! tmp.168 6 0)
            tmp.168)))
      (set! fun/error8854.24
        (begin
          (set! tmp.169 (begin (set! tmp.219 (alloc 16)) (+ tmp.219 2)))
          (begin
            (mset! tmp.169 -2 L.fun/error8854.24.26)
            (mset! tmp.169 6 0)
            tmp.169)))
      (set! fun/error8855.25
        (begin
          (set! tmp.170 (begin (set! tmp.220 (alloc 16)) (+ tmp.220 2)))
          (begin
        ...
        (begin
                      ...
                      (begin
                        (set! tmp.228
                          (begin
                            ...
                            (call L.cons.122.17 cons.122 848 tmp.229)))
                        (call
          ...
          (if (!= tmp.7.31 6)
            ...
            (begin
              (set! tmp.8.34
                (begin
                  (set! tmp.9.35 (if (!= 6 6) 7230 17214))
                  (if (!= tmp.9.35 6)
                    tmp.9.35
                    (begin
                      (set! tmp.10.36
 ...
 '(module
      ...
      (lambda (c.124 tmp.88 tmp.89 tmp.90)
        (begin
          ...
          (if (begin
                (set! tmp.156
                  (if (begin
                        (set! tmp.157 (bitwise-and tmp.89 7))
                        (= tmp.157 0))
                    14
                    6))
                (!= tmp.156 6))
      ...
      (lambda (c.123 tmp.64 tmp.65 tmp.66)
        (begin
          (if (begin
                (set! tmp.160
                  (if (begin
                        (set! tmp.161 (mref tmp.64 -3))
                        (< tmp.65 tmp.161))
                    14
                    6))
                (!= tmp.160 6))
            (if (begin (set! tmp.162 (if (>= tmp.65 0) 14 6)) (!= tmp.162 6))
              (begin
                (begin
                  (set! tmp.163
                    (begin
    ...
    (define L.cons.112.14
      (lambda (c.121 tmp.105 tmp.106)
        (begin
          (begin
            (set! tmp.135 (begin (set! tmp.167 (alloc 16)) (+ tmp.167 1)))
            (begin
      ...
      (lambda (c.120 tmp.86)
        (begin
          ...
          (if (begin
                (set! tmp.168
                  (if (begin
                        (set! tmp.169 (bitwise-and tmp.86 7))
                        (= tmp.169 0))
                    14
                    6))
                (!= tmp.168 6))
                        ...
                        (set! tmp.171
                          (begin
                            (set! tmp.172
                              (begin
                                (set! tmp.173
                                  (arithmetic-shift-right tmp.58 3))
                                (+ 1 tmp.173)))
                            (* tmp.172 8)))
                        (alloc tmp.171)))
                    (+ tmp.170 3)))
    ...
    (define L.vector-init-loop.60.11
      (lambda (c.118 len.61 i.63 vec.62)
        (begin
          ...
          (if (begin (set! tmp.174 (if (= len.61 i.63) 14 6)) (!= tmp.174 6))
            vec.62
            (begin
              (begin
                (set! tmp.175
      ...
      (lambda (c.117 tmp.76 tmp.77)
        (begin
          (if (begin
                (set! tmp.179
                  (if (begin
                        (set! tmp.180 (bitwise-and tmp.77 7))
                        (= tmp.180 0))
                    14
                    6))
                (!= tmp.179 6))
    ...
    (begin
      (set! |-.114|
        (begin
          (set! tmp.137 (begin (set! tmp.183 (alloc 16)) (+ tmp.183 2)))
          (begin (mset! tmp.137 -2 L.-.114.10) (mset! tmp.137 6 16) tmp.137)))
      (set! vector-init-loop.60
        (begin
          (set! tmp.138 (begin (set! tmp.184 (alloc 24)) (+ tmp.184 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.139 (begin (set! tmp.185 (alloc 24)) (+ tmp.185 2)))
          (begin
      ...
      (set! make-vector.113
        (begin
          (set! tmp.140 (begin (set! tmp.186 (alloc 24)) (+ tmp.186 2)))
          (begin
      ...
      (set! cons.112
        (begin
          (set! tmp.141 (begin (set! tmp.187 (alloc 16)) (+ tmp.187 2)))
          (begin
      ...
      (set! error?.111
        (begin
          (set! tmp.142 (begin (set! tmp.188 (alloc 16)) (+ tmp.188 2)))
          (begin
      ...
      (set! unsafe-vector-set!.5
        (begin
          (set! tmp.143 (begin (set! tmp.189 (alloc 16)) (+ tmp.189 2)))
          (begin
      ...
      (set! vector-set!.110
        (begin
          (set! tmp.144 (begin (set! tmp.190 (alloc 24)) (+ tmp.190 2)))
          (begin
            (mset! tmp.144 -2 L.vector-set!.110.17)
            (mset! tmp.144 6 24)
            tmp.144)))
      (set! fun/fixnum8859.11
        (begin
          (set! tmp.145 (begin (set! tmp.191 (alloc 16)) (+ tmp.191 2)))
          (begin
            (mset! tmp.145 -2 L.fun/fixnum8859.11.18)
            (mset! tmp.145 6 0)
            tmp.145)))
      (set! fun/fixnum8863.12
        (begin
          (set! tmp.146 (begin (set! tmp.192 (alloc 16)) (+ tmp.192 2)))
          (begin
            (mset! tmp.146 -2 L.fun/fixnum8863.12.19)
            (mset! tmp.146 6 0)
            tmp.146)))
      (set! fun/fixnum8864.13
        (begin
          (set! tmp.147 (begin (set! tmp.193 (alloc 16)) (+ tmp.193 2)))
          (begin
      ...
      (set! fun/void8861.14
        (begin
          (set! tmp.148 (begin (set! tmp.194 (alloc 24)) (+ tmp.194 2)))
          (begin
            (mset! tmp.148 -2 L.fun/void8861.14.21)
            (mset! tmp.148 6 16)
            tmp.148)))
      (set! fun/error8865.15
        (begin
          (set! tmp.149 (begin (set! tmp.195 (alloc 16)) (+ tmp.195 2)))
          (begin
            (mset! tmp.149 -2 L.fun/error8865.15.22)
            (mset! tmp.149 6 8)
            tmp.149)))
      (set! fun/fixnum8858.16
        (begin
          (set! tmp.150 (begin (set! tmp.196 (alloc 16)) (+ tmp.196 2)))
          (begin
            (mset! tmp.150 -2 L.fun/fixnum8858.16.23)
            (mset! tmp.150 6 0)
            tmp.150)))
      (set! fun/fixnum8860.17
        (begin
          (set! tmp.151 (begin (set! tmp.197 (alloc 16)) (+ tmp.197 2)))
          (begin
            (mset! tmp.151 -2 L.fun/fixnum8860.17.24)
            (mset! tmp.151 6 16)
            tmp.151)))
      (set! fun/empty8862.18
        (begin
          (set! tmp.152 (begin (set! tmp.198 (alloc 16)) (+ tmp.198 2)))
          (begin
                    ...
                    (begin
                      (set! tmp.201
                        (begin
                          ...
                          (call L.cons.112.14 cons.112 29742 tmp.202)))
 ...
 '(module
      ...
      (lambda (c.100 tmp.65)
        (begin
          ...
          (if (begin
                (set! tmp.117
                  (if (begin
                        (set! tmp.118 (bitwise-and tmp.65 7))
                        (= tmp.118 0))
                    14
                    6))
                (!= tmp.117 6))
                        ...
                        (set! tmp.120
                          (begin
                            (set! tmp.121
                              (begin
                                (set! tmp.122
                                  (arithmetic-shift-right tmp.37 3))
                                (+ 1 tmp.122)))
                            (* tmp.121 8)))
                        (alloc tmp.120)))
                    (+ tmp.119 3)))
    ...
    (define L.vector-init-loop.39.14
      (lambda (c.98 len.40 i.42 vec.41)
        (begin
          ...
          (if (begin (set! tmp.123 (if (= len.40 i.42) 14 6)) (!= tmp.123 6))
            vec.41
            (begin
              (begin
                (set! tmp.124
      ...
      (lambda (c.96 tmp.43 tmp.44 tmp.45)
        (begin
          (if (begin
                (set! tmp.132
                  (if (begin
                        (set! tmp.133 (mref tmp.43 -3))
                        (< tmp.44 tmp.133))
                    14
                    6))
                (!= tmp.132 6))
            (if (begin (set! tmp.134 (if (>= tmp.44 0) 14 6)) (!= tmp.134 6))
              (begin
                (begin
                  (set! tmp.135
                    (begin
    ...
    (define L.cons.92.10
      (lambda (c.94 tmp.84 tmp.85)
        (begin
          (begin
            (set! tmp.105 (begin (set! tmp.139 (alloc 16)) (+ tmp.139 1)))
            (begin
    ...
    (begin
      ...
      (set! vector-set!.90
        (begin
          (set! tmp.109 (begin (set! tmp.143 (alloc 24)) (+ tmp.143 2)))
          (begin
            (mset! tmp.109 -2 L.vector-set!.90.13)
            (mset! tmp.109 6 24)
            tmp.109)))
      (set! vector-init-loop.39
        (begin
      ...
      (set! make-vector.89
        (begin
          ...
          (begin
            ...
            (mset! tmp.112 6 8)
            tmp.112)))
      (set! fun/fixnum8869.14
        (begin
          (set! tmp.113 (begin (set! tmp.147 (alloc 16)) (+ tmp.147 2)))
          (begin
            (mset! tmp.113 -2 L.fun/fixnum8869.14.17)
            (mset! tmp.113 6 0)
            tmp.113)))
      (set! fun/fixnum8868.15
        (begin
              ...
              (set! procedure2.18
                (begin
                  (set! lam.93
                    (begin
                      (set! tmp.115
                        (begin (set! tmp.157 (alloc 24)) (+ tmp.157 2)))
                      (begin
 ...
 '(module
    ...
    (define L.cons.68.10
      (lambda (c.69 tmp.63 tmp.64)
        (begin
          (begin
            (set! tmp.76 (begin (set! tmp.86 (alloc 16)) (+ tmp.86 1)))
            (begin (mset! tmp.76 -1 tmp.63) (mset! tmp.76 7 tmp.64) tmp.76)))))
    (begin
      (set! cons.68
        (begin
          (set! tmp.77 (begin (set! tmp.87 (alloc 16)) (+ tmp.87 2)))
          (begin (mset! tmp.77 -2 L.cons.68.10) (mset! tmp.77 6 16) tmp.77)))
      (set! fun/fixnum8875.7
        (begin
          (set! tmp.78 (begin (set! tmp.88 (alloc 24)) (+ tmp.88 2)))
          (begin
            (mset! tmp.78 -2 L.fun/fixnum8875.7.11)
            (mset! tmp.78 6 8)
            tmp.78)))
      (set! fun/fixnum8873.8
        (begin
          (set! tmp.79 (begin (set! tmp.89 (alloc 16)) (+ tmp.89 2)))
          (begin
            (mset! tmp.79 -2 L.fun/fixnum8873.8.12)
            (mset! tmp.79 6 0)
            tmp.79)))
      (set! fun/fixnum8874.9
        (begin
          (set! tmp.80 (begin (set! tmp.90 (alloc 32)) (+ tmp.90 2)))
          (begin
            (mset! tmp.80 -2 L.fun/fixnum8874.9.13)
            (mset! tmp.80 6 0)
            tmp.80)))
      (set! fun/fixnum8872.10
        (begin
          (set! tmp.81 (begin (set! tmp.91 (alloc 24)) (+ tmp.91 2)))
          (begin
            (mset! tmp.81 -2 L.fun/fixnum8872.10.14)
            (mset! tmp.81 6 8)
            tmp.81)))
      (set! fun/fixnum8876.11
        (begin
          (set! tmp.82 (begin (set! tmp.92 (alloc 16)) (+ tmp.92 2)))
          (begin
      ...
      (set! fun/pair8877.12
        (begin
          (set! tmp.83 (begin (set! tmp.93 (alloc 24)) (+ tmp.93 2)))
          (begin
 ...
 '(module
    ...
    (define L.cons.95.16
      (lambda (c.106 tmp.90 tmp.91)
        (begin
          (begin
            (set! tmp.112 (begin (set! tmp.134 (alloc 16)) (+ tmp.134 1)))
            (begin
      ...
      (lambda (c.105 tmp.71)
        (begin
          ...
          (if (begin
                (set! tmp.135
                  (if (begin
                        (set! tmp.136 (bitwise-and tmp.71 7))
                        (= tmp.136 0))
                    14
                    6))
                (!= tmp.135 6))
                        ...
                        (set! tmp.138
                          (begin
                            (set! tmp.139
                              (begin
                                (set! tmp.140
                                  (arithmetic-shift-right tmp.43 3))
                                (+ 1 tmp.140)))
                            (* tmp.139 8)))
                        (alloc tmp.138)))
                    (+ tmp.137 3)))
    ...
    (define L.vector-init-loop.45.13
      (lambda (c.103 len.46 i.48 vec.47)
        (begin
          ...
          (if (begin (set! tmp.141 (if (= len.46 i.48) 14 6)) (!= tmp.141 6))
            vec.47
            (begin
              (begin
                (set! tmp.142
      ...
      (lambda (c.102 tmp.73 tmp.74 tmp.75)
        (begin
          ...
          (if (begin
                (set! tmp.146
                  (if (begin
                        (set! tmp.147 (bitwise-and tmp.74 7))
                        (= tmp.147 0))
                    14
                    6))
                (!= tmp.146 6))
      ...
      (lambda (c.101 tmp.49 tmp.50 tmp.51)
        (begin
          (if (begin
                (set! tmp.150
                  (if (begin
                        (set! tmp.151 (mref tmp.49 -3))
                        (< tmp.50 tmp.151))
                    14
                    6))
                (!= tmp.150 6))
            (if (begin (set! tmp.152 (if (>= tmp.50 0) 14 6)) (!= tmp.152 6))
              (begin
                (begin
                  (set! tmp.153
                    (begin
    ...
    (begin
      (set! error?.98
        (begin
          (set! tmp.114 (begin (set! tmp.157 (alloc 16)) (+ tmp.157 2)))
          (begin
      ...
      (set! vector-set!.97
        (begin
          ...
          (begin
            ...
            (mset! tmp.116 6 24)
            tmp.116)))
      (set! vector-init-loop.45
        (begin
          (set! tmp.117 (begin (set! tmp.160 (alloc 24)) (+ tmp.160 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.118 (begin (set! tmp.161 (alloc 24)) (+ tmp.161 2)))
          (begin
      ...
      (set! make-vector.96
        (begin
          (set! tmp.119 (begin (set! tmp.162 (alloc 24)) (+ tmp.162 2)))
          (begin
      ...
      (set! cons.95
        (begin
          (set! tmp.120 (begin (set! tmp.163 (alloc 16)) (+ tmp.163 2)))
          (begin
            (mset! tmp.120 -2 L.cons.95.16)
            (mset! tmp.120 6 16)
            tmp.120)))
      (set! fun/empty8882.14
        (begin
          (set! tmp.121 (begin (set! tmp.164 (alloc 24)) (+ tmp.164 2)))
          (begin
            (mset! tmp.121 -2 L.fun/empty8882.14.17)
            (mset! tmp.121 6 0)
            tmp.121)))
      (set! fun/empty8885.15
        (begin
          (set! tmp.122 (begin (set! tmp.165 (alloc 16)) (+ tmp.165 2)))
          (begin
            (mset! tmp.122 -2 L.fun/empty8885.15.18)
            (mset! tmp.122 6 16)
            tmp.122)))
      (set! fun/empty8883.16
        (begin
          (set! tmp.123 (begin (set! tmp.166 (alloc 16)) (+ tmp.166 2)))
          (begin
            (mset! tmp.123 -2 L.fun/empty8883.16.19)
            (mset! tmp.123 6 8)
            tmp.123)))
      (set! fun/empty8884.17
        (begin
          (set! tmp.124 (begin (set! tmp.167 (alloc 16)) (+ tmp.167 2)))
          (begin
 ...
 '(module
    (define L.cons.61.10
      (lambda (c.62 tmp.56 tmp.57)
        (begin
          (begin
            (set! tmp.63 (begin (set! tmp.65 (alloc 16)) (+ tmp.65 1)))
            (begin (mset! tmp.63 -1 tmp.56) (mset! tmp.63 7 tmp.57) tmp.63)))))
    (begin
      (set! cons.61
        (begin
          (set! tmp.64 (begin (set! tmp.66 (alloc 16)) (+ tmp.66 2)))
          (begin (mset! tmp.64 -2 L.cons.61.10) (mset! tmp.64 6 16) tmp.64)))
      (begin
        (set! pair0.7
          (begin
            (set! tmp.67
                      ...
                      (begin
                        (set! tmp.70
                          (begin
                            ...
                            (call L.cons.61.10 cons.61 336 tmp.71)))
                        (begin
                          (set! tmp.72
                            (begin
                              (set! tmp.73
                                (begin
                                  (set! tmp.74
                                    (begin
                                      ...
                                      (call L.cons.61.10 cons.61 1712 tmp.75)))
                                  (begin
                                    (set! tmp.76
                                      (begin
                                        (set! tmp.77
                                    ...
                                    (call
                                     ...
                                     tmp.74
                                     tmp.76))))
                              (call L.cons.61.10 cons.61 1120 tmp.73)))
                          (call L.cons.61.10 cons.61 tmp.70 tmp.72))))
      ...
      (set! fun/boolean8893.9
        (begin
          ...
          (begin
            ...
            (mset! tmp.71 6 0)
            tmp.71)))
      (set! fun/ascii-char8894.10
        (begin
          (set! tmp.72 (begin (set! tmp.76 (alloc 24)) (+ tmp.76 2)))
          (begin
...
(check-by-interp
 '(module
      ...
      (lambda (c.69)
        (begin
          ...
          (begin
            (set! tmp.76
              (begin
                (set! tmp.77 (if (!= 14 6) 17198 18734))
    ...
    (begin
      (set! fun/empty8899.7
        (begin
          (set! tmp.71 (begin (set! tmp.78 (alloc 24)) (+ tmp.78 2)))
          (begin
      ...
      (set! fun/empty8900.9
        (begin
          (set! tmp.73 (begin (set! tmp.80 (alloc 24)) (+ tmp.80 2)))
          (begin
            (mset! tmp.73 -2 L.fun/empty8900.9.12)
            (mset! tmp.73 6 0)
            tmp.73)))
      (set! fun/empty8898.10
        (begin
          (set! tmp.74 (begin (set! tmp.81 (alloc 32)) (+ tmp.81 2)))
          (begin
            (mset! tmp.74 -2 L.fun/empty8898.10.13)
            (mset! tmp.74 6 0)
            tmp.74)))
      (set! fun/empty8901.11
        (begin
 ...
 '(module
    ...
    (define L.cons.64.10
      (lambda (c.66 tmp.59 tmp.60)
        (begin
          (begin
            (set! tmp.69 (begin (set! tmp.73 (alloc 16)) (+ tmp.73 1)))
...
(check-by-interp
 '(module
    ...
    (begin
      (set! error?.71
        (begin
          (set! tmp.78 (begin (set! tmp.86 (alloc 16)) (+ tmp.86 2)))
          (begin (mset! tmp.78 -2 L.error?.71.10) (mset! tmp.78 6 8) tmp.78)))
      (set! fun/fixnum8912.7
        (begin
          (set! tmp.79 (begin (set! tmp.87 (alloc 16)) (+ tmp.87 2)))
          (begin
      ...
      (set! fun/error8911.8
        (begin
          (set! tmp.80 (begin (set! tmp.88 (alloc 16)) (+ tmp.88 2)))
          (begin
      ...
      (set! fun/empty8908.9
        (begin
          (set! tmp.81 (begin (set! tmp.89 (alloc 32)) (+ tmp.89 2)))
          (begin
            (mset! tmp.81 -2 L.fun/empty8908.9.13)
            (mset! tmp.81 6 8)
            tmp.81)))
      (set! fun/boolean8909.10
        (begin
          (set! tmp.82 (begin (set! tmp.90 (alloc 16)) (+ tmp.90 2)))
          (begin
            (mset! tmp.82 -2 L.fun/boolean8909.10.14)
            (mset! tmp.82 6 0)
            tmp.82)))
      (set! fun/empty8910.11
        (begin
          (set! tmp.83 (begin (set! tmp.91 (alloc 16)) (+ tmp.91 2)))
          (begin
 ...
 '(module
      ...
      (lambda (c.157)
        (begin
          (begin
            (set! lam.140
              (begin
                (set! tmp.159 (begin (set! tmp.179 (alloc 16)) (+ tmp.179 2)))
                (begin
    ...
    (define L.cons.135.16
      (lambda (c.147 tmp.130 tmp.131)
        (begin
          (begin
            (set! tmp.160 (begin (set! tmp.191 (alloc 16)) (+ tmp.191 1)))
            (begin
      ...
      (lambda (c.145 tmp.89 tmp.90 tmp.91)
        (begin
          (if (begin
                (set! tmp.196
                  (if (begin
                        (set! tmp.197 (mref tmp.89 -3))
                        (< tmp.90 tmp.197))
                    14
                    6))
                (!= tmp.196 6))
            (if (begin (set! tmp.198 (if (>= tmp.90 0) 14 6)) (!= tmp.198 6))
              (begin
                (begin
                  (set! tmp.199
                    (begin
    ...
    (define L.vector-init-loop.85.11
      (lambda (c.142 len.86 i.88 vec.87)
        (begin
          ...
          (if (begin (set! tmp.208 (if (= len.86 i.88) 14 6)) (!= tmp.208 6))
            vec.87
            (begin
              (begin
                (set! tmp.209
    ...
    (begin
      (set! error?.138
        (begin
          (set! tmp.162 (begin (set! tmp.214 (alloc 16)) (+ tmp.214 2)))
          (begin
      ...
      (set! vector-init-loop.85
        (begin
          (set! tmp.163 (begin (set! tmp.215 (alloc 24)) (+ tmp.215 2)))
          (begin
      ...
      (set! make-init-vector.4
        (begin
          (set! tmp.164 (begin (set! tmp.216 (alloc 24)) (+ tmp.216 2)))
          (begin
      ...
      (set! make-vector.137
        (begin
          (set! tmp.165 (begin (set! tmp.217 (alloc 24)) (+ tmp.217 2)))
          (begin
      ...
      (set! unsafe-vector-set!.5
        (begin
          (set! tmp.166 (begin (set! tmp.218 (alloc 16)) (+ tmp.218 2)))
          (begin
      ...
      (set! vector-set!.136
        (begin
          (set! tmp.167 (begin (set! tmp.219 (alloc 24)) (+ tmp.219 2)))
          (begin
      ...
      (set! cons.135
        (begin
          (set! tmp.168 (begin (set! tmp.220 (alloc 16)) (+ tmp.220 2)))
          (begin
      ...
      (set! fun/void8925.14
        (begin
          (set! tmp.169 (begin (set! tmp.221 (alloc 16)) (+ tmp.221 2)))
          (begin
            (mset! tmp.169 -2 L.fun/void8925.14.17)
            (mset! tmp.169 6 16)
            tmp.169)))
      (set! fun/fixnum8922.15
        (begin
          (set! tmp.170 (begin (set! tmp.222 (alloc 16)) (+ tmp.222 2)))
          (begin
      ...
      (set! fun/void8928.16
        (begin
          (set! tmp.171 (begin (set! tmp.223 (alloc 16)) (+ tmp.223 2)))
          (begin
            (mset! tmp.171 -2 L.fun/void8928.16.19)
            (mset! tmp.171 6 16)
            tmp.171)))
      (set! fun/fixnum8921.17
        (begin
          (set! tmp.172 (begin (set! tmp.224 (alloc 24)) (+ tmp.224 2)))
          (begin
            (mset! tmp.172 -2 L.fun/fixnum8921.17.20)
            (mset! tmp.172 6 0)
            tmp.172)))
      (set! fun/fixnum8920.18
        (begin
          (set! tmp.173 (begin (set! tmp.225 (alloc 24)) (+ tmp.225 2)))
          (begin
      ...
      (set! fun/void8924.19
        (begin
          (set! tmp.174 (begin (set! tmp.226 (alloc 16)) (+ tmp.226 2)))
          (begin
      ...
      (set! fun/void8923.20
        (begin
          (set! tmp.175 (begin (set! tmp.227 (alloc 32)) (+ tmp.227 2)))
          (begin
      ...
      (set! fun/void8926.21
        (begin
          (set! tmp.176 (begin (set! tmp.228 (alloc 16)) (+ tmp.228 2)))
          (begin
      ...
      (set! fun/void8927.22
        (begin
          (set! tmp.177 (begin (set! tmp.229 (alloc 40)) (+ tmp.229 2)))
          (begin
 ...
 '(module
    ...
    (begin
      (set! error?.63
        (begin
          (set! tmp.65 (begin (set! tmp.67 (alloc 16)) (+ tmp.67 2)))
          (begin (mset! tmp.65 -2 L.error?.63.10) (mset! tmp.65 6 8) tmp.65)))
      (if (begin
            (set! g43138756.7 6)
            (if (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fun/boolean8934.7
        (begin
          (set! tmp.63 (begin (set! tmp.66 (alloc 16)) (+ tmp.66 2)))
          (begin
            (mset! tmp.63 -2 L.fun/boolean8934.7.10)
            (mset! tmp.63 6 0)
            tmp.63)))
      (set! fun/fixnum8933.8
        (begin
          (set! tmp.64 (begin (set! tmp.67 (alloc 24)) (+ tmp.67 2)))
          (begin
...
(check-by-interp
 '(module
        ...
        (begin
          (if (!= oprand0.14 6)
            (begin
              (set! lam.67
                (begin
                  (set! tmp.77 (begin (set! tmp.85 (alloc 16)) (+ tmp.85 2)))
                  (begin
    ...
    (begin
      (set! fun/error8998.7
        (begin
          (set! tmp.79 (begin (set! tmp.87 (alloc 24)) (+ tmp.87 2)))
          (begin
      ...
      (set! fun/error8999.8
        (begin
          ...
          (begin
            ...
            (mset! tmp.80 6 0)
            tmp.80)))
      (set! fun/boolean9002.9
        (begin
          (set! tmp.81 (begin (set! tmp.89 (alloc 16)) (+ tmp.89 2)))
          (begin
            (mset! tmp.81 -2 L.fun/boolean9002.9.12)
            (mset! tmp.81 6 0)
            tmp.81)))
      (set! fun/error8997.10
        (begin
          (set! tmp.82 (begin (set! tmp.90 (alloc 24)) (+ tmp.90 2)))
          (begin
            (mset! tmp.82 -2 L.fun/error8997.10.13)
            (mset! tmp.82 6 8)
            tmp.82)))
      (set! fun/boolean9001.11
        (begin
          (set! tmp.83 (begin (set! tmp.91 (alloc 24)) (+ tmp.91 2)))
          (begin
            (mset! tmp.83 -2 L.fun/boolean9001.11.14)
            (mset! tmp.83 6 0)
            tmp.83)))
      (set! fun/procedure9000.12
        (begin
          (set! tmp.84 (begin (set! tmp.92 (alloc 16)) (+ tmp.92 2)))
          (begin
