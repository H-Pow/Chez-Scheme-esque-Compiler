    ...
    (define L.vector-init-loop.7.7
      (lambda (c.58 len.8 i.10 vec.9)
        (begin
          ...
          (if (begin (set! tmp.73 (if (= len.8 i.10) 14 6)) (!= tmp.73 6))
            vec.9
            (begin
              (begin
                (set! tmp.74
              ...
              (begin
                ...
                (call
                 ...
                 vec.9)))))))
    (begin
      (set! vector-init-loop.7
        (begin
          (set! tmp.63 (begin (set! tmp.78 (alloc 24)) (+ tmp.78 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.64 (begin (set! tmp.79 (alloc 24)) (+ tmp.79 2)))
          (begin
    ...
    (define L.vector-init-loop.11.7
      (lambda (c.62 len.12 i.14 vec.13)
        (begin
          ...
          (if (begin (set! tmp.79 (if (= len.12 i.14) 14 6)) (!= tmp.79 6))
            vec.13
            (begin
              (begin
                (set! tmp.80
              ...
              (begin
                ...
                (call
                 ...
                 vec.13)))))))
    (begin
      (set! vector-init-loop.11
        (begin
          (set! tmp.68 (begin (set! tmp.84 (alloc 24)) (+ tmp.84 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.69 (begin (set! tmp.85 (alloc 24)) (+ tmp.85 2)))
          (begin
      ...
      (set! make-vector.61
        (begin
          (set! tmp.70 (begin (set! tmp.86 (alloc 24)) (+ tmp.86 2)))
          (begin
      ...
      (set! fun/error8470.4
        (begin
          (set! tmp.71 (begin (set! tmp.87 (alloc 24)) (+ tmp.87 2)))
          (begin
      ...
      (set! fun/error8471.5
        (begin
          (set! tmp.72 (begin (set! tmp.88 (alloc 16)) (+ tmp.88 2)))
          (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fun/ascii-char8474.4
        (begin
          (set! tmp.62 (begin (set! tmp.64 (alloc 16)) (+ tmp.64 2)))
          (begin
      ...
      (set! fun/void8475.5
        (begin
          (set! tmp.63 (begin (set! tmp.65 (alloc 16)) (+ tmp.65 2)))
          (begin
 ...
 '(module
    ...
    (define L.cons.63.9
      (lambda (c.68 tmp.58 tmp.59)
        (begin
          (begin
            (set! tmp.71 (begin (set! tmp.77 (alloc 16)) (+ tmp.77 1)))
    ...
    (begin
      (set! ascii-char?.65
        (begin
          (set! tmp.72 (begin (set! tmp.84 (alloc 16)) (+ tmp.84 2)))
          (begin
      ...
      (set! *.64
        (begin
          (set! tmp.73 (begin (set! tmp.85 (alloc 16)) (+ tmp.85 2)))
          (begin (mset! tmp.73 -2 L.*.64.8) (mset! tmp.73 6 16) tmp.73)))
      (set! cons.63
        (begin
          (set! tmp.74 (begin (set! tmp.86 (alloc 16)) (+ tmp.86 2)))
          (begin (mset! tmp.74 -2 L.cons.63.9) (mset! tmp.74 6 16) tmp.74)))
      (set! fun/pair8495.4
        (begin
          (set! tmp.75 (begin (set! tmp.87 (alloc 24)) (+ tmp.87 2)))
          (begin
      ...
      (set! fun/pair8496.5
        (begin
          (set! tmp.76 (begin (set! tmp.88 (alloc 24)) (+ tmp.88 2)))
          (begin
 ...
 '(module
    ...
    (define L.cons.73.10
      (lambda (c.78 tmp.68 tmp.69)
        (begin
          (begin
            (set! tmp.85 (begin (set! tmp.97 (alloc 16)) (+ tmp.97 1)))
    ...
    (define L.vector-init-loop.23.7
      (lambda (c.75 len.24 i.26 vec.25)
        (begin
          ...
          (if (begin (set! tmp.104 (if (= len.24 i.26) 14 6)) (!= tmp.104 6))
            vec.25
            (begin
              (begin
                (set! tmp.105
    ...
    (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.88 (begin (set! tmp.110 (alloc 24)) (+ tmp.110 2)))
          (begin
      ...
      (set! make-vector.74
        (begin
          (set! tmp.89 (begin (set! tmp.111 (alloc 24)) (+ tmp.111 2)))
          (begin
      ...
      (set! cons.73
        (begin
          (set! tmp.90 (begin (set! tmp.112 (alloc 16)) (+ tmp.112 2)))
          (begin (mset! tmp.90 -2 L.cons.73.10) (mset! tmp.90 6 16) tmp.90)))
      (set! fun/pair8508.4
        (begin
          (set! tmp.91 (begin (set! tmp.113 (alloc 24)) (+ tmp.113 2)))
          (begin
      ...
      (set! fun/pair8509.5
        (begin
          (set! tmp.92 (begin (set! tmp.114 (alloc 24)) (+ tmp.114 2)))
          (begin
      ...
      (set! fun/empty8511.6
        (begin
          (set! tmp.93 (begin (set! tmp.115 (alloc 16)) (+ tmp.115 2)))
          (begin
      ...
      (set! fun/void8507.7
        (begin
          (set! tmp.94 (begin (set! tmp.116 (alloc 16)) (+ tmp.116 2)))
          (begin
      ...
      (set! fun/error8510.8
        (begin
          (set! tmp.95 (begin (set! tmp.117 (alloc 16)) (+ tmp.117 2)))
          (begin
      ...
      (set! fun/void8506.9
        (begin
          (set! tmp.96 (begin (set! tmp.118 (alloc 24)) (+ tmp.118 2)))
          (begin
 ...
 '(module
    ...
    (define L.vector-init-loop.12.9
      (lambda (c.67 len.13 i.15 vec.14)
        (begin
          ...
          (if (begin (set! tmp.89 (if (= len.13 i.15) 14 6)) (!= tmp.89 6))
            vec.14
            (begin
              (begin
                (set! tmp.90
    ...
    (define L.cons.63.8
      (lambda (c.66 tmp.57 tmp.58)
        (begin
          (begin
            (set! tmp.74 (begin (set! tmp.94 (alloc 16)) (+ tmp.94 1)))
    ...
    (begin
      (set! boolean?.64
        (begin
          (set! tmp.75 (begin (set! tmp.96 (alloc 16)) (+ tmp.96 2)))
          (begin (mset! tmp.75 -2 L.boolean?.64.7) (mset! tmp.75 6 8) tmp.75)))
      (set! cons.63
        (begin
          (set! tmp.76 (begin (set! tmp.97 (alloc 16)) (+ tmp.97 2)))
          (begin (mset! tmp.76 -2 L.cons.63.8) (mset! tmp.76 6 16) tmp.76)))
      (set! vector-init-loop.12
        (begin
          (set! tmp.77 (begin (set! tmp.98 (alloc 24)) (+ tmp.98 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.78 (begin (set! tmp.99 (alloc 24)) (+ tmp.99 2)))
          (begin
      ...
      (set! make-vector.62
        (begin
          (set! tmp.79 (begin (set! tmp.100 (alloc 24)) (+ tmp.100 2)))
          (begin
      ...
      (set! fun/empty8535.4
        (begin
          (set! tmp.80 (begin (set! tmp.101 (alloc 16)) (+ tmp.101 2)))
          (begin
      ...
      (set! fun/empty8537.5
        (begin
          (set! tmp.81 (begin (set! tmp.102 (alloc 16)) (+ tmp.102 2)))
          (begin
            (mset! tmp.81 -2 L.fun/empty8537.5.13)
            (mset! tmp.81 6 0)
            tmp.81)))
      (set! fun/vector8536.6
        (begin
          (set! tmp.82 (begin (set! tmp.103 (alloc 24)) (+ tmp.103 2)))
          (begin
 ...
 '(module
    ...
    (define L.cons.67.7
      (lambda (c.68 tmp.62 tmp.63)
        (begin
          (begin
            (set! tmp.74 (begin (set! tmp.81 (alloc 16)) (+ tmp.81 1)))
    ...
    (begin
      ...
      (set! fun/pair8561.4
        (begin
          (set! tmp.76 (begin (set! tmp.83 (alloc 24)) (+ tmp.83 2)))
          (begin
            (mset! tmp.76 -2 L.fun/pair8561.4.8)
            (mset! tmp.76 6 0)
            tmp.76)))
      (set! fun/ascii-char8562.5
        (begin
          (set! tmp.77 (begin (set! tmp.84 (alloc 24)) (+ tmp.84 2)))
          (begin
      ...
      (set! fun/pair8560.6
        (begin
          (set! tmp.78 (begin (set! tmp.85 (alloc 24)) (+ tmp.85 2)))
          (begin
            (mset! tmp.78 -2 L.fun/pair8560.6.10)
            (mset! tmp.78 6 16)
            tmp.78)))
      (set! fun/ascii-char8563.7
        (begin
          (set! tmp.79 (begin (set! tmp.86 (alloc 16)) (+ tmp.86 2)))
          (begin
      ...
      (set! fun/empty8564.8
        (begin
          (set! tmp.80 (begin (set! tmp.87 (alloc 16)) (+ tmp.87 2)))
          (begin
...
(check-by-interp
 '(module
    ...
    (define L.vector-init-loop.14.10
      (lambda (c.71 len.15 i.17 vec.16)
        (begin
          ...
          (if (begin (set! tmp.95 (if (= len.15 i.17) 14 6)) (!= tmp.95 6))
            vec.16
            (begin
              (begin
                (set! tmp.96
    ...
    (begin
      (set! |+.67|
        (begin
          (set! tmp.79 (begin (set! tmp.113 (alloc 16)) (+ tmp.113 2)))
          (begin (mset! tmp.79 -2 L.+.67.7) (mset! tmp.79 6 16) tmp.79)))
      (set! |-.66|
        (begin
          (set! tmp.80 (begin (set! tmp.114 (alloc 16)) (+ tmp.114 2)))
          (begin (mset! tmp.80 -2 L.-.66.8) (mset! tmp.80 6 16) tmp.80)))
      (set! *.65
        (begin
          (set! tmp.81 (begin (set! tmp.115 (alloc 16)) (+ tmp.115 2)))
          (begin (mset! tmp.81 -2 L.*.65.9) (mset! tmp.81 6 16) tmp.81)))
      (set! vector-init-loop.14
        (begin
          (set! tmp.82 (begin (set! tmp.116 (alloc 24)) (+ tmp.116 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.83 (begin (set! tmp.117 (alloc 24)) (+ tmp.117 2)))
          (begin
      ...
      (set! make-vector.64
        (begin
          (set! tmp.84 (begin (set! tmp.118 (alloc 24)) (+ tmp.118 2)))
          (begin
            (mset! tmp.84 -2 L.make-vector.64.12)
            (mset! tmp.84 6 8)
            tmp.84)))
      (set! fun/ascii-char8613.4
        (begin
          (set! tmp.85 (begin (set! tmp.119 (alloc 16)) (+ tmp.119 2)))
          (begin
            (mset! tmp.85 -2 L.fun/ascii-char8613.4.13)
            (mset! tmp.85 6 0)
            tmp.85)))
      (set! fun/vector8612.5
        (begin
          (set! tmp.86 (begin (set! tmp.120 (alloc 24)) (+ tmp.120 2)))
          (begin
            (mset! tmp.86 -2 L.fun/vector8612.5.14)
            (mset! tmp.86 6 0)
            tmp.86)))
      (set! fun/ascii-char8614.6
        (begin
          (set! tmp.87 (begin (set! tmp.121 (alloc 16)) (+ tmp.121 2)))
          (begin
      ...
      (set! fun/void8611.7
        (begin
          (set! tmp.88 (begin (set! tmp.122 (alloc 16)) (+ tmp.122 2)))
          (begin
...
(check-by-interp
 '(module
    ...
    (define L.vector-init-loop.15.9
      (lambda (c.71 len.16 i.18 vec.17)
        (begin
          ...
          (if (begin (set! tmp.99 (if (= len.16 i.18) 14 6)) (!= tmp.99 6))
            vec.17
            (begin
              (begin
                (set! tmp.100
    ...
    (begin
      (set! vector?.67
        (begin
          (set! tmp.81 (begin (set! tmp.106 (alloc 16)) (+ tmp.106 2)))
          (begin (mset! tmp.81 -2 L.vector?.67.7) (mset! tmp.81 6 8) tmp.81)))
      (set! error?.66
        (begin
          (set! tmp.82 (begin (set! tmp.107 (alloc 16)) (+ tmp.107 2)))
          (begin (mset! tmp.82 -2 L.error?.66.8) (mset! tmp.82 6 8) tmp.82)))
      (set! vector-init-loop.15
        (begin
          (set! tmp.83 (begin (set! tmp.108 (alloc 24)) (+ tmp.108 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.84 (begin (set! tmp.109 (alloc 24)) (+ tmp.109 2)))
          (begin
      ...
      (set! make-vector.65
        (begin
          (set! tmp.85 (begin (set! tmp.110 (alloc 24)) (+ tmp.110 2)))
          (begin
      ...
      (set! fun/any8771.4
        (begin
          (set! tmp.86 (begin (set! tmp.111 (alloc 24)) (+ tmp.111 2)))
          (begin
      ...
      (set! fun/empty8774.5
        (begin
          (set! tmp.87 (begin (set! tmp.112 (alloc 16)) (+ tmp.112 2)))
          (begin
      ...
      (set! fun/void8770.6
        (begin
          (set! tmp.88 (begin (set! tmp.113 (alloc 16)) (+ tmp.113 2)))
          (begin
      ...
      (set! fun/any8773.7
        (begin
          (set! tmp.89 (begin (set! tmp.114 (alloc 16)) (+ tmp.114 2)))
          (begin
            (mset! tmp.89 -2 L.fun/any8773.7.15)
            (mset! tmp.89 6 0)
            tmp.89)))
      (set! fun/vector8772.8
        (begin
          (set! tmp.90 (begin (set! tmp.115 (alloc 24)) (+ tmp.115 2)))
          (begin
        ...
        (begin
          ...
          (set! procedure3.9
            (begin
              (set! lam.68
                (begin
                  (set! tmp.91 (begin (set! tmp.117 (alloc 32)) (+ tmp.117 2)))
                  (begin
 ...
 '(module
    ...
    (define L.vector-init-loop.21.11
      (lambda (c.82 len.22 i.24 vec.23)
        (begin
          ...
          (if (begin (set! tmp.124 (if (= len.22 i.24) 14 6)) (!= tmp.124 6))
            vec.23
            (begin
              (begin
                (set! tmp.125
    ...
    (define L.cons.72.10
      (lambda (c.81 tmp.66 tmp.67)
        (begin
          (begin
            (set! tmp.98 (begin (set! tmp.129 (alloc 16)) (+ tmp.129 1)))
    ...
    (begin
      (set! |+.75|
        (begin
          (set! tmp.99 (begin (set! tmp.143 (alloc 16)) (+ tmp.143 2)))
          (begin (mset! tmp.99 -2 L.+.75.7) (mset! tmp.99 6 16) tmp.99)))
      (set! |-.74|
        (begin
          (set! tmp.100 (begin (set! tmp.144 (alloc 16)) (+ tmp.144 2)))
          (begin (mset! tmp.100 -2 L.-.74.8) (mset! tmp.100 6 16) tmp.100)))
      (set! *.73
        (begin
          (set! tmp.101 (begin (set! tmp.145 (alloc 16)) (+ tmp.145 2)))
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.104 (begin (set! tmp.148 (alloc 24)) (+ tmp.148 2)))
          (begin
      ...
      (set! fun/void9398.4
        (begin
          (set! tmp.106 (begin (set! tmp.150 (alloc 24)) (+ tmp.150 2)))
          (begin
      ...
      (set! fun/empty9407.5
        (begin
          (set! tmp.107 (begin (set! tmp.151 (alloc 16)) (+ tmp.151 2)))
          (begin
            (mset! tmp.107 -2 L.fun/empty9407.5.15)
            (mset! tmp.107 6 0)
            tmp.107)))
      (set! fun/ascii-char9403.6
        (begin
          (set! tmp.108 (begin (set! tmp.152 (alloc 16)) (+ tmp.152 2)))
          (begin
      ...
      (set! fun/pair9400.7
        (begin
          (set! tmp.109 (begin (set! tmp.153 (alloc 24)) (+ tmp.153 2)))
          (begin
            (mset! tmp.109 -2 L.fun/pair9400.7.17)
            (mset! tmp.109 6 0)
            tmp.109)))
      (set! fun/vector9404.8
        (begin
          (set! tmp.110 (begin (set! tmp.154 (alloc 24)) (+ tmp.154 2)))
          (begin
      ...
      (set! fun/void9399.9
        (begin
          (set! tmp.111 (begin (set! tmp.155 (alloc 16)) (+ tmp.155 2)))
          (begin
            (mset! tmp.111 -2 L.fun/void9399.9.19)
            (mset! tmp.111 6 0)
            tmp.111)))
      (set! fun/empty9406.10
        (begin
          (set! tmp.112 (begin (set! tmp.156 (alloc 24)) (+ tmp.156 2)))
          (begin
            (mset! tmp.112 -2 L.fun/empty9406.10.20)
            (mset! tmp.112 6 0)
            tmp.112)))
      (set! fun/vector9405.11
        (begin
          (set! tmp.113 (begin (set! tmp.157 (alloc 24)) (+ tmp.157 2)))
          (begin
      ...
      (set! fun/pair9401.12
        (begin
          (set! tmp.114 (begin (set! tmp.158 (alloc 24)) (+ tmp.158 2)))
          (begin
            (mset! tmp.114 -2 L.fun/pair9401.12.22)
            (mset! tmp.114 6 0)
            tmp.114)))
      (set! fun/ascii-char9402.13
        (begin
          (set! tmp.115 (begin (set! tmp.159 (alloc 24)) (+ tmp.159 2)))
          (begin
          ...
          (set! procedure4.14
            (begin
              (set! lam.77
                (begin
                  (set! tmp.117
                    (begin (set! tmp.167 (alloc 24)) (+ tmp.167 2)))
                  (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! |-.77|
        (begin
          (set! tmp.95 (begin (set! tmp.125 (alloc 16)) (+ tmp.125 2)))
          (begin (mset! tmp.95 -2 L.-.77.7) (mset! tmp.95 6 16) tmp.95)))
      (set! *.76
        (begin
          (set! tmp.96 (begin (set! tmp.126 (alloc 16)) (+ tmp.126 2)))
      ...
      (set! cons.74
        (begin
          ...
          (begin (mset! tmp.98 -2 L.cons.74.10) (mset! tmp.98 6 16) tmp.98)))
      (set! fun/empty13316.4
        (begin
      ...
      (set! fun/ascii-char13315.5
        (begin
          ...
          (begin
            ...
            (mset! tmp.100 6 0)
            tmp.100)))
      (set! fun/error13313.6
        (begin
          (set! tmp.101 (begin (set! tmp.131 (alloc 16)) (+ tmp.131 2)))
          (begin
            (mset! tmp.101 -2 L.fun/error13313.6.13)
            (mset! tmp.101 6 0)
            tmp.101)))
      (set! fun/error13308.7
        (begin
      ...
      (set! fun/empty13317.11
        (begin
          ...
          (begin
            ...
            (mset! tmp.106 6 0)
            tmp.106)))
      (set! fun/error13309.12
        (begin
          (set! tmp.107 (begin (set! tmp.137 (alloc 16)) (+ tmp.137 2)))
          (begin
            (mset! tmp.107 -2 L.fun/error13309.12.19)
            (mset! tmp.107 6 0)
            tmp.107)))
      (set! fun/ascii-char13314.13
        (begin
...
(check-by-interp
 '(module
                        ...
                        (set! tmp.109
                          (begin
                            (set! tmp.110
                              (begin
                                (set! tmp.111
                                  (arithmetic-shift-right tmp.18 3))
                                (+ 1 tmp.111)))
                            (* tmp.110 8)))
                        (alloc tmp.109)))
                    (+ tmp.108 3)))
    ...
    (define L.vector-init-loop.20.10
      (lambda (c.78 len.21 i.23 vec.22)
        (begin
          ...
          (if (begin (set! tmp.112 (if (= len.21 i.23) 14 6)) (!= tmp.112 6))
            vec.22
            (begin
              (begin
                (set! tmp.113
    ...
    (begin
      ...
      (set! |+.72|
        (begin
          (set! tmp.92 (begin (set! tmp.131 (alloc 16)) (+ tmp.131 2)))
      ...
      (set! make-vector.70
        (begin
          (set! tmp.96 (begin (set! tmp.135 (alloc 24)) (+ tmp.135 2)))
          (begin
            (mset! tmp.96 -2 L.make-vector.70.12)
            (mset! tmp.96 6 8)
            tmp.96)))
      (set! fun/error13358.4
        (begin
          (set! tmp.97 (begin (set! tmp.136 (alloc 24)) (+ tmp.136 2)))
          (begin
            (mset! tmp.97 -2 L.fun/error13358.4.13)
            (mset! tmp.97 6 0)
            tmp.97)))
      (set! fun/vector13357.5
        (begin
          (set! tmp.98 (begin (set! tmp.137 (alloc 24)) (+ tmp.137 2)))
          (begin
            (mset! tmp.98 -2 L.fun/vector13357.5.14)
            (mset! tmp.98 6 0)
            tmp.98)))
      (set! fun/vector13355.6
        (begin
          (set! tmp.99 (begin (set! tmp.138 (alloc 24)) (+ tmp.138 2)))
          (begin
            (mset! tmp.99 -2 L.fun/vector13355.6.15)
            (mset! tmp.99 6 0)
            tmp.99)))
      (set! fun/ascii-char13352.7
        (begin
          (set! tmp.100 (begin (set! tmp.139 (alloc 24)) (+ tmp.139 2)))
          (begin
            (mset! tmp.100 -2 L.fun/ascii-char13352.7.16)
            (mset! tmp.100 6 0)
            tmp.100)))
      (set! fun/vector13354.8
        (begin
          (set! tmp.101 (begin (set! tmp.140 (alloc 24)) (+ tmp.140 2)))
          (begin
            (mset! tmp.101 -2 L.fun/vector13354.8.17)
            (mset! tmp.101 6 0)
            tmp.101)))
      (set! fun/vector13356.9
        (begin
          (set! tmp.102 (begin (set! tmp.141 (alloc 24)) (+ tmp.141 2)))
          (begin
            (mset! tmp.102 -2 L.fun/vector13356.9.18)
            (mset! tmp.102 6 0)
            tmp.102)))
      (set! fun/error13359.10
        (begin
          (set! tmp.103 (begin (set! tmp.142 (alloc 16)) (+ tmp.142 2)))
          (begin
            (mset! tmp.103 -2 L.fun/error13359.10.19)
            (mset! tmp.103 6 0)
            tmp.103)))
      (set! fun/ascii-char13353.11
        (begin
          (set! tmp.104 (begin (set! tmp.143 (alloc 16)) (+ tmp.143 2)))
          (begin
          ...
          (set! procedure2.15
            (begin
              (set! lam.74
                (begin
                  (set! tmp.105
                    (begin (set! tmp.158 (alloc 24)) (+ tmp.158 2)))
                  (begin
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (set! fun/void14591.5
        (begin
          (set! tmp.92 (begin (set! tmp.118 (alloc 16)) (+ tmp.118 2)))
          (begin
      ...
      (set! fun/void14590.6
        (begin
          ...
          (begin
            ...
            (mset! tmp.93 6 0)
            tmp.93)))
      (set! fun/ascii-char14586.7
        (begin
          (set! tmp.94 (begin (set! tmp.120 (alloc 24)) (+ tmp.120 2)))
          (begin
 ...
 '(module
    ...
    (define L.vector-init-loop.24.12
      (lambda (c.85 len.25 i.27 vec.26)
        (begin
          ...
          (if (begin (set! tmp.128 (if (= len.25 i.27) 14 6)) (!= tmp.128 6))
            vec.26
            (begin
              (begin
                (set! tmp.129
    ...
    (define L.cons.75.11
      (lambda (c.84 tmp.69 tmp.70)
        (begin
          (begin
            (set! tmp.101 (begin (set! tmp.133 (alloc 16)) (+ tmp.133 1)))
            (begin
    ...
    (begin
      ...
      (set! |-.76|
        (begin
          ...
          (begin (mset! tmp.105 -2 L.-.76.10) (mset! tmp.105 6 16) tmp.105)))
      (set! cons.75
        (begin
      ...
      (set! fun/any15143.10
        (begin
          ...
          (begin
            ...
            (mset! tmp.116 6 0)
            tmp.116)))
      (set! fun/vector15137.11
        (begin
          (set! tmp.117 (begin (set! tmp.163 (alloc 24)) (+ tmp.163 2)))
          (begin
            (mset! tmp.117 -2 L.fun/vector15137.11.22)
            (mset! tmp.117 6 0)
            tmp.117)))
      (set! fun/void15146.12
        (begin
      ...
      (set! fun/void15141.14
        (begin
          ...
          (begin
            ...
            (mset! tmp.120 6 0)
            tmp.120)))
      (set! fun/ascii-char15136.15
        (begin
          (set! tmp.121 (begin (set! tmp.167 (alloc 16)) (+ tmp.167 2)))
          (begin
                      ...
                      (set! tmp.179
                        (begin
                          ...
                          (begin
                            ...
                            (call L.-.76.10 |-.76| tmp.180 tmp.181))))
...
(check-by-interp
 '(module
    ...
    (define L.vector-init-loop.26.7
      (lambda (c.78 len.27 i.29 vec.28)
        (begin
          ...
          (if (begin (set! tmp.121 (if (= len.27 i.29) 14 6)) (!= tmp.121 6))
            vec.28
            (begin
              (begin
                (set! tmp.122
    ...
    (begin
      ...
      (set! make-vector.76
        (begin
          (set! tmp.99 (begin (set! tmp.128 (alloc 24)) (+ tmp.128 2)))
          (begin
            (mset! tmp.99 -2 L.make-vector.76.9)
            (mset! tmp.99 6 8)
            tmp.99)))
      (set! fun/vector15770.4
        (begin
          (set! tmp.100 (begin (set! tmp.129 (alloc 24)) (+ tmp.129 2)))
          (begin
            (mset! tmp.100 -2 L.fun/vector15770.4.10)
            (mset! tmp.100 6 0)
            tmp.100)))
      (set! fun/empty15765.5
        (begin
      ...
      (set! fun/ascii-char15776.12
        (begin
          ...
          (begin
            ...
            (mset! tmp.108 6 0)
            tmp.108)))
      (set! fun/empty15766.13
        (begin
          (set! tmp.109 (begin (set! tmp.138 (alloc 24)) (+ tmp.138 2)))
          (begin
            (mset! tmp.109 -2 L.fun/empty15766.13.19)
            (mset! tmp.109 6 0)
            tmp.109)))
      (set! fun/empty15764.14
        (begin
          (set! tmp.110 (begin (set! tmp.139 (alloc 24)) (+ tmp.139 2)))
          (begin
            (mset! tmp.110 -2 L.fun/empty15764.14.20)
            (mset! tmp.110 6 0)
            tmp.110)))
      (set! fun/void15775.15
        (begin
          (set! tmp.111 (begin (set! tmp.140 (alloc 16)) (+ tmp.140 2)))
          (begin
            (mset! tmp.111 -2 L.fun/void15775.15.21)
            (mset! tmp.111 6 0)
            tmp.111)))
      (set! fun/ascii-char15777.16
        (begin
          (set! tmp.112 (begin (set! tmp.141 (alloc 16)) (+ tmp.141 2)))
          (begin
            (mset! tmp.112 -2 L.fun/ascii-char15777.16.22)
            (mset! tmp.112 6 0)
            tmp.112)))
      (set! fun/ascii-char15768.17
        (begin
          (set! tmp.113 (begin (set! tmp.142 (alloc 24)) (+ tmp.142 2)))
          (begin
          ...
          (set! procedure0.23
            (begin
              (set! lam.77
                (begin
                  (set! tmp.114
                    (begin (set! tmp.143 (alloc 24)) (+ tmp.143 2)))
                  (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! |+.78|
        (begin
          (set! tmp.102 (begin (set! tmp.147 (alloc 16)) (+ tmp.147 2)))
          (begin (mset! tmp.102 -2 L.+.78.7) (mset! tmp.102 6 16) tmp.102)))
      (set! *.77
        (begin
          (set! tmp.103 (begin (set! tmp.148 (alloc 16)) (+ tmp.148 2)))
          (begin (mset! tmp.103 -2 L.*.77.8) (mset! tmp.103 6 16) tmp.103)))
      (set! |-.76|
        (begin
          (set! tmp.104 (begin (set! tmp.149 (alloc 16)) (+ tmp.149 2)))
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.107 (begin (set! tmp.152 (alloc 24)) (+ tmp.152 2)))
          (begin
      ...
      (set! make-vector.74
        (begin
          (set! tmp.108 (begin (set! tmp.153 (alloc 24)) (+ tmp.153 2)))
          (begin
      ...
      (set! fun/void21848.4
        (begin
          (set! tmp.109 (begin (set! tmp.154 (alloc 16)) (+ tmp.154 2)))
          (begin
            (mset! tmp.109 -2 L.fun/void21848.4.14)
            (mset! tmp.109 6 0)
            tmp.109)))
      (set! fun/ascii-char21854.5
        (begin
          (set! tmp.110 (begin (set! tmp.155 (alloc 16)) (+ tmp.155 2)))
          (begin
            (mset! tmp.110 -2 L.fun/ascii-char21854.5.15)
            (mset! tmp.110 6 0)
            tmp.110)))
      (set! fun/vector21856.6
        (begin
          (set! tmp.111 (begin (set! tmp.156 (alloc 24)) (+ tmp.156 2)))
          (begin
      ...
      (set! fun/pair21851.7
        (begin
          (set! tmp.112 (begin (set! tmp.157 (alloc 24)) (+ tmp.157 2)))
          (begin
            (mset! tmp.112 -2 L.fun/pair21851.7.17)
            (mset! tmp.112 6 0)
            tmp.112)))
      (set! fun/vector21849.8
        (begin
          (set! tmp.113 (begin (set! tmp.158 (alloc 24)) (+ tmp.158 2)))
          (begin
            (mset! tmp.113 -2 L.fun/vector21849.8.18)
            (mset! tmp.113 6 0)
            tmp.113)))
      (set! fun/vector21850.9
        (begin
          (set! tmp.114 (begin (set! tmp.159 (alloc 24)) (+ tmp.159 2)))
          (begin
            (mset! tmp.114 -2 L.fun/vector21850.9.19)
            (mset! tmp.114 6 0)
            tmp.114)))
      (set! fun/error21846.10
        (begin
          ...
          (begin
            ...
            (mset! tmp.115 6 0)
            tmp.115)))
      (set! fun/vector21855.11
        (begin
          (set! tmp.116 (begin (set! tmp.161 (alloc 24)) (+ tmp.161 2)))
          (begin
            (mset! tmp.116 -2 L.fun/vector21855.11.21)
            (mset! tmp.116 6 0)
            tmp.116)))
      (set! fun/pair21852.12
        (begin
          (set! tmp.117 (begin (set! tmp.162 (alloc 24)) (+ tmp.162 2)))
          (begin
            (mset! tmp.117 -2 L.fun/pair21852.12.22)
            (mset! tmp.117 6 0)
            tmp.117)))
      (set! fun/error21845.13
        (begin
...
(check-by-interp
 '(module
    ...
    (define L.vector-init-loop.24.7
      (lambda (c.76 len.25 i.27 vec.26)
        (begin
          ...
          (if (begin (set! tmp.115 (if (= len.25 i.27) 14 6)) (!= tmp.115 6))
            vec.26
            (begin
              (begin
                (set! tmp.116
    ...
    (begin
      (set! vector-init-loop.24
        (begin
          (set! tmp.93 (begin (set! tmp.120 (alloc 24)) (+ tmp.120 2)))
          (begin
      ...
      (set! make-init-vector.1
        (begin
          (set! tmp.94 (begin (set! tmp.121 (alloc 24)) (+ tmp.121 2)))
          (begin
      ...
      (set! make-vector.74
        (begin
          (set! tmp.95 (begin (set! tmp.122 (alloc 24)) (+ tmp.122 2)))
          (begin
            (mset! tmp.95 -2 L.make-vector.74.9)
            (mset! tmp.95 6 8)
            tmp.95)))
      (set! fun/empty10026.4
        (begin
          (set! tmp.96 (begin (set! tmp.123 (alloc 24)) (+ tmp.123 2)))
          (begin
      ...
      (set! fun/void10033.5
        (begin
          (set! tmp.97 (begin (set! tmp.124 (alloc 16)) (+ tmp.124 2)))
          (begin
            (mset! tmp.97 -2 L.fun/void10033.5.11)
            (mset! tmp.97 6 0)
            tmp.97)))
      (set! fun/vector10030.6
        (begin
          (set! tmp.98 (begin (set! tmp.125 (alloc 24)) (+ tmp.125 2)))
          (begin
            (mset! tmp.98 -2 L.fun/vector10030.6.12)
            (mset! tmp.98 6 0)
            tmp.98)))
      (set! fun/empty10023.7
        (begin
          (set! tmp.99 (begin (set! tmp.126 (alloc 16)) (+ tmp.126 2)))
          (begin
      ...
      (set! fun/void10029.8
        (begin
          (set! tmp.100 (begin (set! tmp.127 (alloc 16)) (+ tmp.127 2)))
          (begin
            (mset! tmp.100 -2 L.fun/void10029.8.14)
            (mset! tmp.100 6 0)
            tmp.100)))
      (set! fun/vector10031.9
        (begin
          (set! tmp.101 (begin (set! tmp.128 (alloc 24)) (+ tmp.128 2)))
          (begin
            (mset! tmp.101 -2 L.fun/vector10031.9.15)
            (mset! tmp.101 6 0)
            tmp.101)))
      (set! fun/void10028.10
        (begin
          (set! tmp.102 (begin (set! tmp.129 (alloc 24)) (+ tmp.129 2)))
          (begin
            (mset! tmp.102 -2 L.fun/void10028.10.16)
            (mset! tmp.102 6 0)
            tmp.102)))
      (set! fun/empty10027.11
        (begin
          (set! tmp.103 (begin (set! tmp.130 (alloc 16)) (+ tmp.130 2)))
          (begin
            (mset! tmp.103 -2 L.fun/empty10027.11.17)
            (mset! tmp.103 6 0)
            tmp.103)))
      (set! fun/vector10025.12
        (begin
          (set! tmp.104 (begin (set! tmp.131 (alloc 24)) (+ tmp.131 2)))
          (begin
            (mset! tmp.104 -2 L.fun/vector10025.12.18)
            (mset! tmp.104 6 0)
            tmp.104)))
      (set! fun/empty10022.13
        (begin
          (set! tmp.105 (begin (set! tmp.132 (alloc 24)) (+ tmp.132 2)))
          (begin
            (mset! tmp.105 -2 L.fun/empty10022.13.19)
            (mset! tmp.105 6 0)
            tmp.105)))
      (set! fun/vector10024.14
        (begin
          (set! tmp.106 (begin (set! tmp.133 (alloc 24)) (+ tmp.133 2)))
          (begin
            (mset! tmp.106 -2 L.fun/vector10024.14.20)
            (mset! tmp.106 6 0)
            tmp.106)))
      (set! fun/void10032.15
        (begin
          (set! tmp.107 (begin (set! tmp.134 (alloc 24)) (+ tmp.134 2)))
          (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fixnum?.77
        (begin
          (set! tmp.96 (begin (set! tmp.127 (alloc 16)) (+ tmp.127 2)))
          (begin (mset! tmp.96 -2 L.fixnum?.77.7) (mset! tmp.96 6 8) tmp.96)))
      (set! *.76
        (begin
          (set! tmp.97 (begin (set! tmp.128 (alloc 16)) (+ tmp.128 2)))
          (begin (mset! tmp.97 -2 L.*.76.8) (mset! tmp.97 6 16) tmp.97)))
      (set! |+.75|
        (begin
          (set! tmp.98 (begin (set! tmp.129 (alloc 16)) (+ tmp.129 2)))
          (begin (mset! tmp.98 -2 L.+.75.9) (mset! tmp.98 6 16) tmp.98)))
      (set! |-.74|
        (begin
          (set! tmp.99 (begin (set! tmp.130 (alloc 16)) (+ tmp.130 2)))
          (begin (mset! tmp.99 -2 L.-.74.10) (mset! tmp.99 6 16) tmp.99)))
      (set! fun/any12092.4
        (begin
          (set! tmp.100 (begin (set! tmp.131 (alloc 24)) (+ tmp.131 2)))
          (begin
            (mset! tmp.100 -2 L.fun/any12092.4.11)
            (mset! tmp.100 6 0)
            tmp.100)))
      (set! fun/empty12090.5
        (begin
          (set! tmp.101 (begin (set! tmp.132 (alloc 24)) (+ tmp.132 2)))
          (begin
            (mset! tmp.101 -2 L.fun/empty12090.5.12)
            (mset! tmp.101 6 0)
            tmp.101)))
      (set! fun/error12095.6
        (begin
          (set! tmp.102 (begin (set! tmp.133 (alloc 16)) (+ tmp.133 2)))
          (begin
            (mset! tmp.102 -2 L.fun/error12095.6.13)
            (mset! tmp.102 6 0)
            tmp.102)))
      (set! fun/empty12096.7
        (begin
          (set! tmp.103 (begin (set! tmp.134 (alloc 24)) (+ tmp.134 2)))
          (begin
            (mset! tmp.103 -2 L.fun/empty12096.7.14)
            (mset! tmp.103 6 0)
            tmp.103)))
      (set! fun/empty12091.8
        (begin
          (set! tmp.104 (begin (set! tmp.135 (alloc 16)) (+ tmp.135 2)))
          (begin
      ...
      (set! fun/any12093.9
        (begin
          (set! tmp.105 (begin (set! tmp.136 (alloc 16)) (+ tmp.136 2)))
          (begin
            (mset! tmp.105 -2 L.fun/any12093.9.16)
            (mset! tmp.105 6 0)
            tmp.105)))
      (set! fun/void12099.10
        (begin
          (set! tmp.106 (begin (set! tmp.137 (alloc 16)) (+ tmp.137 2)))
          (begin
            (mset! tmp.106 -2 L.fun/void12099.10.17)
            (mset! tmp.106 6 0)
            tmp.106)))
      (set! fun/error12088.11
        (begin
          (set! tmp.107 (begin (set! tmp.138 (alloc 24)) (+ tmp.138 2)))
          (begin
            (mset! tmp.107 -2 L.fun/error12088.11.18)
            (mset! tmp.107 6 0)
            tmp.107)))
      (set! fun/empty12097.12
        (begin
          (set! tmp.108 (begin (set! tmp.139 (alloc 16)) (+ tmp.139 2)))
          (begin
            (mset! tmp.108 -2 L.fun/empty12097.12.19)
            (mset! tmp.108 6 0)
            tmp.108)))
      (set! fun/error12089.13
        (begin
          (set! tmp.109 (begin (set! tmp.140 (alloc 16)) (+ tmp.140 2)))
          (begin
            (mset! tmp.109 -2 L.fun/error12089.13.20)
            (mset! tmp.109 6 0)
            tmp.109)))
      (set! fun/error12094.14
        (begin
          (set! tmp.110 (begin (set! tmp.141 (alloc 24)) (+ tmp.141 2)))
          (begin
            (mset! tmp.110 -2 L.fun/error12094.14.21)
            (mset! tmp.110 6 0)
            tmp.110)))
      (set! fun/void12098.15
        (begin
          (set! tmp.111 (begin (set! tmp.142 (alloc 24)) (+ tmp.142 2)))
          (begin
