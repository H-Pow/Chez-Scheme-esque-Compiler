    ...
    ((locals
     ...
     (conflicts
      ((tmp-ra.95
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.95 fv0) (fun/error8470.4 fv1))))
...
(check-by-interp
 '(module
    ((locals (tmp.66 fun/void8475.5 tmp.63 tmp.71 tmp.65 tmp.62 tmp.70 tmp.64))
     (conflicts
      ((tmp-ra.69
        (rdi
         rsi
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.69 fv0) (fun/ascii-char8474.4 fv1))))
    ...
    ((locals
     ...
     (assignment
      ((fun/any8773.7 fv0)
       ...
       (fun/any8771.4 fv6))))
    (define L.lam.68.17
      ((locals (tmp.92 fun/any8773.7 c.79))
       (conflicts
       ...
       (assignment ((tmp-ra.118 fv0) (vector?.67 fv1))))
      (begin
        (set! tmp-ra.118 r15)
        (set! c.79 rdi)
