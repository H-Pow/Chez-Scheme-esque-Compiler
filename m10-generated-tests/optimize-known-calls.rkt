 ...
 '(module
    (letrec ((L.error?.65.10 (lambda (c.66 tmp.55) (let () (error? tmp.55)))))
      (cletrec
       ...
       (let ((g42027422.7 #\b))
         (if (closure-call error?.65 error?.65 g42027422.7)
           g42027422.7
           (let ((g42027423.8 #\_))
             (if (closure-call error?.65 error?.65 g42027423.8)
               g42027423.8
               (let ((g42027424.9 #\c))
                 (if (closure-call error?.65 error?.65 g42027424.9)
                   g42027424.9
                   (let ((g42027425.10 #\q))
                     (if (closure-call error?.65 error?.65 g42027425.10)
                       g42027425.10
                       (let ((g42027426.11 #\V))
                         (if (closure-call error?.65 error?.65 g42027426.11)
                           g42027426.11
                           (let ((g42027427.12 #\p))
                             (if (closure-call
                                  error?.65
    ...
    (letrec ((L.error?.60.10 (lambda (c.61 tmp.50) (let () (error? tmp.50)))))
      (cletrec
       ...
       (let ((g42031243.7 (error 172)))
         (if (closure-call error?.60 error?.60 g42031243.7)
           g42031243.7
           (error 172)))))))
(check-by-interp
 '(module
    (letrec ((L.fun/void8493.7.10 (lambda (c.60) (let () (void)))))
      (cletrec
       ...
       (closure-call fun/void8493.7 fun/void8493.7)))))
(check-by-interp
 '(module
    (letrec ((L.*.59.10
 ...
 '(module
    (letrec ((L.error?.66.10 (lambda (c.67 tmp.56) (let () (error? tmp.56)))))
      (cletrec
       ...
       (let ((g42050319.7
              (let ((g42050320.8 #\V))
                (if (closure-call error?.66 error?.66 g42050320.8)
                  g42050320.8
                  (let ((g42050321.9 #\f))
                    (if (closure-call error?.66 error?.66 g42050321.9)
                      g42050321.9
                      (let ((g42050322.10 #\E))
                        (if (closure-call error?.66 error?.66 g42050322.10)
                          g42050322.10
                          (let ((g42050323.11 #\n))
                            (if (closure-call error?.66 error?.66 g42050323.11)
                              g42050323.11
                              #\\))))))))))
         (if (closure-call error?.66 error?.66 g42050319.7)
           g42050319.7
           (let ((g42050324.12 (let () #\I)))
             (if (closure-call error?.66 error?.66 g42050324.12)
               g42050324.12
               (let ((void0.13 (void))) #\k)))))))))
(check-by-interp
 '(module
             ...
             (L.make-vector.82.15
              (lambda (c.91 tmp.58)
                (let ((make-init-vector.4 (closure-ref c.91 0)))
                  (if (fixnum? tmp.58)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.58)
                    (error 8)))))
    ...
    (letrec ((L.fun/error8516.7.10
              (lambda (c.61)
                (let ((fun/error8517.8 (closure-ref c.61 0)))
                  (closure-call fun/error8517.8 fun/error8517.8))))
      ...
      (cletrec
       ...
       (closure-call fun/error8516.7 fun/error8516.7)))))
 ...
 '(module
    (letrec ((L.fun/void8531.7.10 (lambda (c.61) (let () (void))))
      ...
      (cletrec
       ...
       (closure-call fun/void8530.8 fun/void8530.8)))))
(check-by-interp
 '(module
    (letrec ((L.error?.69.10 (lambda (c.70 tmp.59) (let () (error? tmp.59))))
      ...
      (cletrec
       ...
       (let ((g42092307.9 (let ((boolean0.10 #f)) (void))))
         (if (closure-call error?.69 error?.69 g42092307.9)
           g42092307.9
           (let ((g42092308.11 (let ((empty0.12 empty)) (void))))
             (if (closure-call error?.69 error?.69 g42092308.11)
               g42092308.11
               (let ((g42092309.13
                      (closure-call fun/void8534.7 fun/void8534.7)))
                 (if (closure-call error?.69 error?.69 g42092309.13)
                   g42092309.13
                   (let ((g42092310.14 (if #t (void) (void))))
                     (if (closure-call error?.69 error?.69 g42092310.14)
                       g42092310.14
                       (let ((g42092311.15
                              (closure-call fun/void8535.8 fun/void8535.8)))
                         (if (closure-call error?.69 error?.69 g42092311.15)
                           g42092311.15
                           (let ((g42092312.16
                                  (if (void)
                                    (if (void)
 ...
 '(module
    (letrec ((L.fun/error8546.7.10
      ...
      (cletrec
       ...
       (closure-call fun/error8546.7 fun/error8546.7)))))
(check-by-interp
 '(module
 ...
 '(module
    (letrec ((L.fun/void8553.7.10
      ...
      (cletrec
       ...
       (closure-call fun/void8552.9 fun/void8552.9 (if #f 221 247))))))
(check-by-interp
 '(module
    (letrec ((L.error?.69.10 (lambda (c.70 tmp.59) (let () (error? tmp.59))))
      ...
      (cletrec
       ...
       (if (let ((error0.8 (error 194))) (error 152))
         (let ((g42119027.9 (if #f (error 108) (error 68))))
           (if (closure-call error?.69 error?.69 g42119027.9)
             g42119027.9
             (let ((g42119028.10 (error 192)))
               (if (closure-call error?.69 error?.69 g42119028.10)
                 g42119028.10
                 (let ((g42119029.11 (if #f (error 126) (error 57))))
                   (if (closure-call error?.69 error?.69 g42119029.11)
                     g42119029.11
                     (let ((g42119030.12
                              ...
                              (if (closure-call
                                ...
                                (let ((g42119032.14 (error 219)))
                                  (if (closure-call
                                    ...
                                    g42119032.14
                                    (error 86)))))))
                       (if (closure-call error?.69 error?.69 g42119030.12)
                         g42119030.12
                         (let ((g42119033.15 (if #t (error 147) (error 181))))
                           (if (closure-call error?.69 error?.69 g42119033.15)
                             g42119033.15
                             (let ((g42119034.16
                                    (closure-call
                                     fun/error8557.7
 ...
 '(module
    (letrec ((L.cons.64.10
      ...
      (cletrec
       ...
       (if (closure-call fun/boolean8560.9 fun/boolean8560.9)
         (closure-call fun/ascii-char8561.8 fun/ascii-char8561.8 #f)
         (closure-call
          ...
          (closure-call
           ...
           cons.64
           31
           (closure-call cons.64 cons.64 309 empty))))))))
(check-by-interp
 '(module
 ...
 '(module
    (letrec ((L.fun/fixnum8570.7.10 (lambda (c.60) (let () (let () 159)))))
      (cletrec
       ...
       (closure-call fun/fixnum8570.7 fun/fixnum8570.7)))))
(check-by-interp
 '(module
    (letrec ((L.fun/void8573.7.10
      ...
      (cletrec
       ...
       (closure-call fun/void8573.7 fun/void8573.7)))))
(check-by-interp '(module (let () empty)))
(check-by-interp
 '(module
    ...
    (letrec ((L.fun/ascii-char8582.7.10 (lambda (c.61) (let () #\H))))
      (cletrec
       ...
       (let ((void0.8 (if #t (void) (void))))
         (closure-call fun/ascii-char8582.7 fun/ascii-char8582.7))))))
(check-by-interp
 '(module
    (letrec ((L.fun/ascii-char8585.7.10
      ...
      (cletrec
       ...
       (closure-call fun/ascii-char8585.7 fun/ascii-char8585.7)))))
(check-by-interp
 '(module
             ...
             (L.fun/ascii-char8591.8.16
              (lambda (c.85 oprand0.13)
                (let ((fun/ascii-char8592.9 (closure-ref c.85 0)))
                  (closure-call fun/ascii-char8592.9 fun/ascii-char8592.9))))
                  ...
                  (let ((tmp.7.14
                    ...
                    (let ((g42161003.15
                           (closure-call
                            ...
                            0
                            1)))
                      (if (closure-call error?.78 error?.78 g42161003.15)
                        g42161003.15
                        (let ((g42161004.16
                               (closure-call
                                vector-set!.77
                                ...
                                1
                                2)))
                          (if (closure-call error?.78 error?.78 g42161004.16)
                            g42161004.16
                            (let ((g42161005.17
                                   (closure-call
                                    vector-set!.77
             ...
             (L.fun/vector8593.12.20
              (lambda (c.89 oprand0.23)
                (let ((fun/vector8594.11 (closure-ref c.89 0)))
                  (closure-call fun/vector8594.11 fun/vector8594.11)))))
      (cletrec
       ...
       (closure-call
        ...
        (closure-call
         fun/vector8593.12
         fun/vector8593.12
         (closure-call fun/ascii-char8595.10 fun/ascii-char8595.10)))))))
              ...
              (let ((tmp.7.26
                     (let ((pair0.28
                            (closure-call
                             ...
                             cons.106
                             141
                             (closure-call cons.106 cons.106 498 empty)))
                           (boolean1.27 #f))
                       #\B)))
                (if tmp.7.26
                  tmp.7.26
                          ...
                          (let ((tmp.10.33
                            ...
                            (if tmp.10.33
                              ...
                              (let ((fixnum0.35 12) (ascii-char1.34 #\R))
                                #\e)))))))))))
         (if (closure-call error?.107 error?.107 g42168642.25)
           g42168642.25
           (let ((g42168644.36
                  (closure-call fun/ascii-char8603.24 fun/ascii-char8603.24)))
             (if (closure-call error?.107 error?.107 g42168644.36)
               g42168644.36
               (let ((g42168645.37
                      (let ((tmp.11.38
                             (closure-call
                                                        ...
                                                        (if tmp.20.49
                                                          ...
                                                          (let ((tmp.21.50
                                                            ...
                                                            (if tmp.21.50
                                                              tmp.21.50
                                                              #\F))))))))))))))))))))))
                 (if (closure-call error?.107 error?.107 g42168645.37)
                   g42168645.37
                   (let ((g42168646.51 (let ((fixnum0.52 45)) #\j)))
                     (if (closure-call error?.107 error?.107 g42168646.51)
                       g42168646.51
                       (let ((g42168647.53 (if #f #\A #\c)))
                         (if (closure-call error?.107 error?.107 g42168647.53)
                           g42168647.53
                           (if #f #\U #\e)))))))))))))))
(check-by-interp
 '(module
    (letrec ((L.fun/error8607.7.10
      ...
      (cletrec
       ...
       (let () (closure-call fun/error8607.7 fun/error8607.7 #t))))))
(check-by-interp
 '(module
    (letrec ((L.fun/error8610.7.10
      ...
      (cletrec
       ...
       (if (if #f #f #t)
         (let () (error 47))
         (closure-call fun/error8610.7 fun/error8610.7 6))))))
(check-by-interp
 '(module
    (letrec ((L.fun/boolean8613.7.10 (lambda (c.63 oprand0.9) (let () #t)))
      ...
      (cletrec
       ...
       (if (closure-call fun/boolean8613.7 fun/boolean8613.7 #\I)
         (if #t (void) (void))
         (closure-call fun/void8614.8 fun/void8614.8 #f))))))
(check-by-interp
 '(module
    (letrec ((L.error?.63.10 (lambda (c.64 tmp.53) (let () (error? tmp.53)))))
      (cletrec
       ...
       (let ((g42183917.7 (let ((ascii-char0.8 #\r)) #\C)))
         (if (closure-call error?.63 error?.63 g42183917.7)
           g42183917.7
           (let ((g42183918.9 (if #f #\G #\R)))
             (if (closure-call error?.63 error?.63 g42183918.9)
               g42183918.9
               (let ((g42183919.10 (let () #\t)))
                 (if (closure-call error?.63 error?.63 g42183919.10)
                   g42183919.10
                   (let () #\t)))))))))))
(check-by-interp
 '(module
    (letrec ((L.fun/error8619.7.10
      ...
      (cletrec
       ...
       (if (if #f #t #f)
         (closure-call fun/error8619.7 fun/error8619.7 #f)
    ...
    (letrec ((L.fun/ascii-char8622.7.10
              (lambda (c.62)
                (let ((fun/ascii-char8623.8 (closure-ref c.62 0)))
                  (closure-call fun/ascii-char8623.8 fun/ascii-char8623.8))))
             (L.fun/ascii-char8623.8.11
              (lambda (c.63)
                (let ((fun/ascii-char8624.9 (closure-ref c.63 0)))
                  (closure-call fun/ascii-char8624.9 fun/ascii-char8624.9))))
      ...
      (cletrec
       ...
       (closure-call fun/ascii-char8622.7 fun/ascii-char8622.7)))))
(check-by-interp
 '(module
             ...
             (L.make-vector.116.14
              (lambda (c.122 tmp.90)
                (let ((make-init-vector.4 (closure-ref c.122 0)))
                  (if (fixnum? tmp.90)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.90)
                    (error 8)))))
             (L.cons.115.15
               ...
               (if (if (let ((tmp.7.30 empty))
                     ...
                     (if (if #t empty empty)
                       (if (if empty
                             ...
                             #f)
                         (if (if #f empty empty)
                           (closure-call fun/empty8628.26 fun/empty8628.26)
                           #f)
                         #f)
                       #f)
                     #f)
                 (let ((g42195365.36
                        (closure-call fun/empty8629.25 fun/empty8629.25 #f)))
                   (if (closure-call error?.114 error?.114 g42195365.36)
                     g42195365.36
                     (let ((g42195366.37 (let ((fixnum0.38 174)) empty)))
                       (if (closure-call error?.114 error?.114 g42195366.37)
                         g42195366.37
                         (let ((g42195367.39
                                (closure-call
                                 fun/empty8630.24
    ...
    (letrec ((L.error?.62.10 (lambda (c.63 tmp.52) (let () (error? tmp.52)))))
      (cletrec
       ...
       (if (if #t #t #t)
         ...
         (let ((g42210650.8 184))
           (if (closure-call error?.62 error?.62 g42210650.8)
             g42210650.8
             (let ((g42210651.9 213))
               (if (closure-call error?.62 error?.62 g42210651.9)
                 g42210651.9
                 114)))))))))
(check-by-interp
 '(module
             ...
             (let ((tmp.8.13
                    (let ((pair0.14
                           (closure-call
                            ...
                            cons.67
                            227
                            (closure-call cons.67 cons.67 467 empty))))
                      (error 230))))
                ...
                (if tmp.7.17
                  ...
                  (let ((tmp.8.18 (if #f empty empty)))
                    (if tmp.8.18
                      tmp.8.18
                      (let ((tmp.9.19
                             (closure-call fun/empty8649.15 fun/empty8649.15)))
                        (if tmp.9.19
                          tmp.9.19
                            ...
                            (if tmp.10.20
                              ...
                              (let ((tmp.11.21 (if #t empty empty)))
                                (if tmp.11.21
                                  tmp.11.21
                                  (if #f empty empty)))))))))))))
         (if (closure-call error?.81 error?.81 g42218286.16)
           g42218286.16
           (let ((g42218287.22
                  (if (if #f empty empty)
                    (if (let () empty)
                      ...
                      #f)
                    #f)))
             (if (closure-call error?.81 error?.81 g42218287.22)
               g42218287.22
               (let ((g42218288.27
                      (closure-call fun/empty8650.14 fun/empty8650.14)))
                 (if (closure-call error?.81 error?.81 g42218288.27)
                   g42218288.27
                   (let ((g42218289.28 (if empty empty #f)))
                     (if (closure-call error?.81 error?.81 g42218289.28)
                       g42218289.28
                       (if #t empty empty)))))))))))))
(check-by-interp
 '(module
    (letrec ((L.fun/error8653.7.10
              (lambda (c.62)
                (let ((fun/error8654.8 (closure-ref c.62 0)))
                  (closure-call fun/error8654.8 fun/error8654.8))))
             (L.fun/error8654.8.11
              (lambda (c.63)
                (let ((fun/error8655.9 (closure-ref c.63 0)))
                  (closure-call fun/error8655.9 fun/error8655.9))))
      ...
      (cletrec
       ...
       (closure-call fun/error8653.7 fun/error8653.7)))))
(check-by-interp
 '(module
    (letrec ((L.error?.68.10 (lambda (c.69 tmp.58) (let () (error? tmp.58))))
             ...
             (L.fun/ascii-char8658.8.12
              (lambda (c.71)
                (let ((fun/ascii-char8659.9 (closure-ref c.71 0)))
                  (closure-call fun/ascii-char8659.9 fun/ascii-char8659.9))))
             ...
             (L.fun/ascii-char8660.10.14
              (lambda (c.73 oprand0.12)
                (let ((fun/ascii-char8661.11 (closure-ref c.73 0)))
                  (closure-call fun/ascii-char8661.11 fun/ascii-char8661.11))))
      ...
      (cletrec
       ...
       (let ((g42225918.13
              (closure-call fun/ascii-char8658.8 fun/ascii-char8658.8)))
         (if (closure-call error?.68 error?.68 g42225918.13)
           g42225918.13
           (let ((g42225919.14 (let () #\Q)))
             (if (closure-call error?.68 error?.68 g42225919.14)
               g42225919.14
               (let ((g42225920.15
                      (closure-call
                       fun/ascii-char8660.10
                       fun/ascii-char8660.10
                       empty)))
                 (if (closure-call error?.68 error?.68 g42225920.15)
                   g42225920.15
                   (closure-call
    ...
    (letrec ((L.error?.63.10 (lambda (c.65 tmp.53) (let () (error? tmp.53))))
      ...
      (cletrec
       ...
       (if (let ((g42233549.10 (let () #t)))
             (if (closure-call error?.63 error?.63 g42233549.10)
               g42233549.10
               (let () #t)))
         (closure-call
          error?.63
                          ...
                          (lambda (c.92)
                            (let ((cons.76 (closure-ref c.92 0)))
                              (closure-call
                               ...
                               cons.76
                               215
                               (closure-call cons.76 cons.76 403 empty))))))
                  (cletrec
                ...
                (let ((tmp.7.14
                  ...
                  (let ((g42237367.15
                         (closure-call
                          ...
                          0
                          0)))
                    (if (closure-call error?.79 error?.79 g42237367.15)
                      g42237367.15
                      (let ((g42237368.16
                             (closure-call
                              vector-set!.78
                              ...
                              1
                              1)))
                        (if (closure-call error?.79 error?.79 g42237368.16)
                          g42237368.16
                          (let ((g42237369.17
                                 (closure-call
                                  vector-set!.78
                                  ...
                                  2
                                  2)))
                            (if (closure-call error?.79 error?.79 g42237369.17)
                              g42237369.17
                              (let ((g42237370.18
                                     (closure-call
                                      vector-set!.78
    ...
    (letrec ((L.cons.75.10
      ...
      (cletrec
       ...
       (if (closure-call
            ...
            (if #t
              194
              (let ((tmp.7.8 (closure-call make-vector.71 make-vector.71 8)))
                (let ((g42241192.9
                       (closure-call
                        vector-set!.72
                        vector-set!.72
                        ...
                        0
                        1)))
                  (if (closure-call error?.73 error?.73 g42241192.9)
                    g42241192.9
                    (let ((g42241193.10
                           (closure-call
                            vector-set!.72
                            ...
                            1
                            2)))
                      (if (closure-call error?.73 error?.73 g42241193.10)
                        g42241193.10
                        (let ((g42241194.11
                               (closure-call
                                vector-set!.72
                                ...
                                2
                                3)))
                          (if (closure-call error?.73 error?.73 g42241194.11)
                            g42241194.11
                            (let ((g42241195.12
                                   (closure-call
                                    vector-set!.72
         ...
         (let ((pair0.17
                (closure-call
                 ...
                 cons.75
                 82
                 (closure-call cons.75 cons.75 500 empty))))
           empty)
             ...
             (L.make-vector.109.15
              (lambda (c.118 tmp.84)
                (let ((make-init-vector.4 (closure-ref c.118 0)))
                  (if (fixnum? tmp.84)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.84)
                    (error 8)))))
             (L.cons.108.16
             ...
             (L.fun/void8489.10.18
              (lambda (c.121 oprand0.20 oprand1.19)
                (let ((fun/void8490.13 (closure-ref c.121 0)))
                  (closure-call fun/void8490.13 fun/void8490.13))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        (if (closure-call
             ...
             (let ((vector0.27
                    (let ((tmp.7.28
                           (closure-call make-vector.109 make-vector.109 8)))
                      (let ((g42252645.29
                             (closure-call
                              vector-set!.110
                              vector-set!.110
                              ...
                              0
                              1)))
                        (if (closure-call error?.111 error?.111 g42252645.29)
                          g42252645.29
                          (let ((g42252646.30
                                 (closure-call
                                  vector-set!.110
          ...
          (if (if #t #\j #\G)
            (if (let ((g42252653.37
                  ...
                  (if (closure-call error?.111 error?.111 g42252653.37)
                    g42252653.37
                    (let ((g42252654.39
                           (let ((pair0.41
                                  (closure-call
                                   ...
                                   cons.108
                                   222
                                   (closure-call cons.108 cons.108 394 empty)))
                                 (error1.40 (error 102)))
                             #\E)))
                      (if (closure-call error?.111 error?.111 g42252654.39)
                        g42252654.39
                        (let ((g42252655.42
                               (let ((boolean0.45 #f)
                                     (void1.44 (void))
                                     (boolean2.43 #f))
                                 #\s)))
                          (if (closure-call error?.111 error?.111 g42252655.42)
                            g42252655.42
                            (let ((g42252656.46
                                   (let ((boolean0.49 #f)
                                         (pair1.48
        ...
        (closure-call
         ...
         (closure-call
          fun/pair8497.11
          fun/pair8497.11
          (closure-call fun/pair8498.16 fun/pair8498.16))
       ...
       (let ()
         (if (if #f empty empty)
           (if (let ((g42256477.10 empty))
                 (if (closure-call error?.65 error?.65 g42256477.10)
                   g42256477.10
                   (let ((g42256478.11 empty))
                     (if (closure-call error?.65 error?.65 g42256478.11)
                       g42256478.11
                       (let ((g42256479.12 empty))
                         (if (closure-call error?.65 error?.65 g42256479.12)
                           g42256479.12
                           empty))))))
             (closure-call
              fun/empty8501.7
       ...
       (let ((void0.7
              (let ((pair0.9
                     (closure-call
                      ...
                      cons.62
                      107
                      (closure-call cons.62 cons.62 481 empty)))
                    (boolean1.8 #t))
                (void))))
         (if #f 61 215))))))
(check-by-interp
             ...
             (L.fun/void8477.8.11
              (lambda (c.65 oprand0.10)
                (let ((fun/void8478.7 (closure-ref c.65 0)))
                  (closure-call fun/void8478.7 fun/void8478.7))))
      ...
      (cletrec
       ...
       (let ()
         (closure-call
          fun/void8477.8
          fun/void8477.8
          (closure-call fun/ascii-char8479.9 fun/ascii-char8479.9 111)))))))
(check-by-interp
 '(module
             ...
             (L.fun/error8483.7.12
              (lambda (c.72)
                (let ((fun/error8484.8 (closure-ref c.72 0)))
                  (closure-call fun/error8484.8 fun/error8484.8))))
             ...
             (L.fun/error8482.9.14
              (lambda (c.74 oprand0.10)
                (let ((fun/error8483.7 (closure-ref c.74 0)))
                  (closure-call fun/error8483.7 fun/error8483.7)))))
      (cletrec
       ((error?.69 (make-closure L.error?.69.10 1))
       ...
       (closure-call
        fun/error8482.9
        fun/error8482.9
        (if (closure-call <.68 <.68 248 54)
          (let ((g42302032.11 (void)))
            (if (closure-call error?.69 error?.69 g42302032.11)
              g42302032.11
              (let ((g42302033.12 (void)))
                (if (closure-call error?.69 error?.69 g42302033.12)
                  g42302033.12
                  (let ((g42302034.13 (void)))
                    (if (closure-call error?.69 error?.69 g42302034.13)
                      g42302034.13
                      (let ((g42302035.14 (void)))
                        (if (closure-call error?.69 error?.69 g42302035.14)
                          g42302035.14
                          (void)))))))))
             ...
             (L.make-vector.87.16
              (lambda (c.97 tmp.63)
                (let ((make-init-vector.4 (closure-ref c.97 0)))
                  (if (fixnum? tmp.63)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.63)
                    (error 8)))))
             (L.fun/void8487.9.17
              ...
              (lambda (c.99 oprand0.13)
                (let ((error?.89 (closure-ref c.99 0))
                  ...
                  (closure-call
                   ...
                   3
                   (let ((tmp.7.14
                          (closure-call make-vector.87 make-vector.87 8)))
                     (let ((g42305850.15
                            (closure-call
                             vector-set!.88
                             vector-set!.88
                             ...
                             0
                             0)))
                       (if (closure-call error?.89 error?.89 g42305850.15)
                         g42305850.15
                         (let ((g42305851.16
                                (closure-call
                                 vector-set!.88
                                 ...
                                 1
                                 1)))
                           (if (closure-call error?.89 error?.89 g42305851.16)
                             g42305851.16
                             (let ((g42305852.17
                                    (closure-call
                                     vector-set!.88
         ...
         (if (let ((ascii-char0.25 #\j)
                   ...
                   (pair2.23
                    (closure-call
                     ...
                     cons.90
                     146
                     (closure-call cons.90 cons.90 308 empty))))
               (void))
           (if (closure-call fun/void8487.9 fun/void8487.9 148 (void))
             (if (closure-call
                  fun/void8488.10
                  fun/void8488.10
                  (let ((tmp.8.26
                    ...
                    (let ((g42305858.27
                           (closure-call
                            ...
                            0
                            1)))
                      (if (closure-call error?.89 error?.89 g42305858.27)
                        g42305858.27
                        (let ((g42305859.28
                               (closure-call
                                vector-set!.88
                                ...
                                1
                                2)))
                          (if (closure-call error?.89 error?.89 g42305859.28)
                            g42305859.28
                            (let ((g42305860.29
                                   (closure-call
                                    vector-set!.88
    ...
    (letrec ((L.fun/empty8491.7.10
              (lambda (c.67 oprand0.11 oprand1.10)
                (let ((fun/empty8492.8 (closure-ref c.67 0)))
                  (let () (closure-call fun/empty8492.8 fun/empty8492.8)))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        (if (let () #t)
          (let () (error 47))
          (closure-call fun/error8493.9 fun/error8493.9 #t #t)))))))
(check-by-interp
 '(module
              ...
              (lambda (c.155 oprand0.26 oprand1.25)
                (let ((cons.139 (closure-ref c.155 0)))
                  (closure-call
                   ...
                   cons.139
                   175
                   (closure-call cons.139 cons.139 296 empty)))))
              ...
              (lambda (c.160)
                (let ((cons.139 (closure-ref c.160 0)))
                  (closure-call
                   ...
                   cons.139
                   187
                   (closure-call cons.139 cons.139 408 empty)))))
        ...
        (if (closure-call
             ...
             (if #f
               (closure-call
                ...
                cons.139
                128
                (closure-call cons.139 cons.139 289 empty))
               (closure-call
                cons.139
                cons.139
                177
                (closure-call cons.139 cons.139 385 empty))))
          (if (if #f (void) (void))
        ...
        (closure-call
         ...
         (let ((g42328624.68
                (closure-call
                 ...
                 cons.139
                 234
                 (closure-call cons.139 cons.139 272 empty))))
           (if (closure-call error?.142 error?.142 g42328624.68)
             g42328624.68
             (let ((g42328625.69
                    (let ((error0.72 (error 104))
                      ...
                      (closure-call
                       ...
                       cons.139
                       43
                       (closure-call cons.139 cons.139 459 empty)))))
               (if (closure-call error?.142 error?.142 g42328625.69)
                 g42328625.69
                 (let ((g42328634.82
                        (closure-call
                         cons.139
                         cons.139
                         92
                         (closure-call cons.139 cons.139 487 empty))))
                   (if (closure-call error?.142 error?.142 g42328634.82)
                     g42328634.82
                     (let ((g42328635.83
                            (let ((g42328636.84
                                   (closure-call
                              ...
                              (if (closure-call
                                ...
                                (closure-call
                                 ...
                                 (closure-call
                                  ...
                                  314
                                  empty))))))
                       (if (closure-call error?.142 error?.142 g42328635.83)
                         g42328635.83
                         (let ((g42328637.85
                                (closure-call
                                 fun/pair8503.21
             ...
             (L.fun/empty8513.9.19
              (lambda (c.107 oprand0.18)
                (let ((fun/empty8514.10 (closure-ref c.107 0)))
                  (closure-call fun/empty8514.10 fun/empty8514.10))))
             ...
             (L.fun/fixnum8507.11.21
              (lambda (c.109 oprand0.20 oprand1.19)
                (let ((fun/fixnum8509.14 (closure-ref c.109 0))
                  ...
                  (if (if #t #t #f)
                    (closure-call fun/fixnum8508.15 fun/fixnum8508.15)
                    (closure-call fun/fixnum8509.14 fun/fixnum8509.14)))))
       ...
       (closure-call
        ...
        (if (if (closure-call
                 ...
                 (closure-call
                  ...
                  cons.91
                  54
                  (closure-call cons.91 cons.91 464 empty)))
              (if (closure-call fun/empty8511.12 fun/empty8511.12 #t 41)
                (if (if #f empty empty)
                  (if (closure-call fun/empty8512.13 fun/empty8512.13)
          ...
          #f)
        (if (closure-call <.92 <.92 93 14)
          (let ((boolean0.27 #t)
                (vector1.26
                 (let ((tmp.7.28
                        (closure-call make-vector.93 make-vector.93 8)))
                   (let ((g42336237.29
                          (closure-call
                           vector-set!.94
                           vector-set!.94
                           ...
                           0
                           1)))
                     (if (closure-call error?.95 error?.95 g42336237.29)
                       g42336237.29
                       (let ((g42336238.30
                              (closure-call
                               vector-set!.94
                               ...
                               1
                               2)))
                         (if (closure-call error?.95 error?.95 g42336238.30)
                           g42336238.30
                           (let ((g42336239.31
                                  (closure-call
                                   vector-set!.94
                ...
                (let ((tmp.7.13
                  ...
                  (let ((g42343841.14
                         (closure-call
                          ...
                          0
                          1)))
                    (if (closure-call error?.76 error?.76 g42343841.14)
                      g42343841.14
                      (let ((g42343842.15
                             (closure-call
                              vector-set!.75
                              ...
                              1
                              2)))
                        (if (closure-call error?.76 error?.76 g42343842.15)
                          g42343842.15
                          (let ((g42343843.16
                                 (closure-call
                                  vector-set!.75
                                  ...
                                  2
                                  3)))
                            (if (closure-call error?.76 error?.76 g42343843.16)
                              g42343843.16
                              (let ((g42343844.17
                                     (closure-call
                                      vector-set!.75
         ...
         (closure-call
            ...
            (let ((tmp.7.13 (closure-call make-vector.76 make-vector.76 8)))
              (let ((g42347666.14
                     (closure-call
                      ...
                      0
                      1)))
                (if (closure-call error?.78 error?.78 g42347666.14)
                  g42347666.14
                  (let ((g42347667.15
                         (closure-call
                          vector-set!.77
                          ...
                          1
                          2)))
                    (if (closure-call error?.78 error?.78 g42347667.15)
                      g42347667.15
                      (let ((g42347668.16
                             (closure-call
                              vector-set!.77
                              ...
                              2
                              3)))
                        (if (closure-call error?.78 error?.78 g42347668.16)
                          g42347668.16
                          (let ((g42347669.17
                                 (closure-call
                                  vector-set!.77
                                  ...
                                  3
                                  4)))
                            (if (closure-call error?.78 error?.78 g42347669.17)
                              g42347669.17
                              (let ((g42347670.18
                                     (closure-call
                                      vector-set!.77
          ...
          (if #f
            (closure-call
             ...
             cons.79
             25
             (closure-call cons.79 cons.79 278 empty))
            (closure-call
             cons.79
             cons.79
             168
             (closure-call cons.79 cons.79 487 empty)))))
        (if (let () #f)
          (let ((g42347674.22 232))
            (if (closure-call error?.78 error?.78 g42347674.22)
              g42347674.22
              (let ((g42347675.23 165))
                (if (closure-call error?.78 error?.78 g42347675.23)
                  g42347675.23
                  174))))
          (if #f 106 28)))))))
(check-by-interp
    ...
    (letrec ((L.fun/fixnum8525.7.10
              (lambda (c.64)
                (let ((fun/fixnum8526.9 (closure-ref c.64 0)))
                  (closure-call fun/fixnum8526.9 fun/fixnum8526.9))))
      ...
      (cletrec
       ...
       (let ((empty0.11 (closure-call fun/empty8524.8 fun/empty8524.8))
             (ascii-char1.10 (if #f #\P #\J)))
         (closure-call fun/fixnum8525.7 fun/fixnum8525.7))))))
(check-by-interp
 '(module
      ...
      (cletrec
       ...
       (if (let () #f)
         (closure-call
          ...
          (closure-call fun/fixnum8530.8 fun/fixnum8530.8))
         (if #t 68 222))))))
(check-by-interp
 '(module
    (letrec ((L.error?.89.10 (lambda (c.90 tmp.77) (let () (error? tmp.77))))
             ...
             (L.fun/empty8533.10.17
              (lambda (c.97 oprand0.13)
                (let ((fun/empty8534.11 (closure-ref c.97 0)))
                  (closure-call fun/empty8534.11 fun/empty8534.11))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        fun/empty8533.10
        (let ((ascii-char0.16
               (closure-call fun/ascii-char8535.12 fun/ascii-char8535.12))
              (void1.15 (if #t (void) (void)))
              (void2.14 (closure-call fun/void8536.9 fun/void8536.9)))
          (if #f
            (let ((tmp.7.17 (closure-call make-vector.87 make-vector.87 8)))
              (let ((g42366676.18
                     (closure-call
                      vector-set!.88
                      vector-set!.88
                      ...
                      0
                      1)))
                (if (closure-call error?.89 error?.89 g42366676.18)
                  g42366676.18
                  (let ((g42366677.19
                         (closure-call
                          vector-set!.88
                          ...
                          1
                          2)))
                    (if (closure-call error?.89 error?.89 g42366677.19)
                      g42366677.19
                      (let ((g42366678.20
                             (closure-call
                              vector-set!.88
                              ...
                              2
                              3)))
                        (if (closure-call error?.89 error?.89 g42366678.20)
                          g42366678.20
                          (let ((g42366679.21
                                 (closure-call
                                  vector-set!.88
                                  ...
                                  3
                                  4)))
                            (if (closure-call error?.89 error?.89 g42366679.21)
                              g42366679.21
                              (let ((g42366680.22
                                     (closure-call
                                      vector-set!.88
                                        ...
                                        (if (closure-call
                                          ...
                                          (let ((g42366683.25
                                            ...
                                            (if (closure-call
                                              ...
                                              g42366683.25
                                              tmp.7.17)))))))))))))))))
            (let ((tmp.8.26 (closure-call make-vector.87 make-vector.87 8)))
              (let ((g42366684.27
                     (closure-call
                      vector-set!.88
                      vector-set!.88
                      ...
                      0
                      1)))
                (if (closure-call error?.89 error?.89 g42366684.27)
                  g42366684.27
                  (let ((g42366685.28
                         (closure-call
                          vector-set!.88
                          ...
                          1
                          2)))
                    (if (closure-call error?.89 error?.89 g42366685.28)
                      g42366685.28
                      (let ((g42366686.29
                             (closure-call
                              vector-set!.88
                              ...
                              2
                              3)))
                        (if (closure-call error?.89 error?.89 g42366686.29)
                          g42366686.29
                          (let ((g42366687.30
                                 (closure-call
                                  vector-set!.88
                                  ...
                                  3
                                  4)))
                            (if (closure-call error?.89 error?.89 g42366687.30)
                              g42366687.30
                              (let ((g42366688.31
                                     (closure-call
                                      vector-set!.88
 ...
 '(module
    (letrec ((L.cons.221.10
             ...
             (L.fun/empty8544.35.19
              (lambda (c.241)
                (let ((fun/empty8545.37 (closure-ref c.241 0)))
                  (closure-call fun/empty8545.37 fun/empty8545.37))))
      ...
      (cletrec
       ...
       (let ((g42374287.48
              (if (closure-call >=.217 >=.217 2 186)
                (closure-call fun/empty8539.36 fun/empty8539.36 #t)
                (let ((procedure0.49
                       (letrec ((L.lam.229.27
                         ...
                         (cletrec
                          ...
                          lam.229))))
                  empty))))
         (if (closure-call error?.218 error?.218 g42374287.48)
           g42374287.48
           (let ((g42374288.52
                  (let ((fixnum0.55
                         (let ((tmp.7.56 131))
                    ...
                    (if empty
                      (if empty (if empty (if empty empty #f) #f) #f)
                      #f))))
             (if (closure-call error?.218 error?.218 g42374288.52)
               g42374288.52
               (let ((g42374297.71
                      (let ((void0.74
                             (closure-call fun/void8540.41 fun/void8540.41))
                            (ascii-char1.73 (let () #\t))
                            (void2.72
                             (closure-call fun/void8541.39 fun/void8541.39)))
                        (if empty (if empty empty #f) #f))))
                 (if (closure-call error?.218 error?.218 g42374297.71)
                   g42374297.71
                   (let ((g42374298.75
                          (if (if #f empty empty)
                            (if (let ((boolean0.77 #t)
                              ...
                              #f)
                            #f)))
                     (if (closure-call error?.218 error?.218 g42374298.75)
                       g42374298.75
                       (let ((g42374307.90
                                              ...
                                              (let ((g42374312.103
                                                ...
                                                (if (closure-call
                                                  ...
                                                  (if empty
                                                    empty
                                                    #f)))))))))))))
                         (if (closure-call error?.218 error?.218 g42374307.90)
                           g42374307.90
                           (let ((g42374313.104
                                  (let ((vector0.107
                                         (let ((tmp.19.108
             ...
             (L.fun/fixnum8552.7.12
              (lambda (c.76)
                (let ((fun/fixnum8553.9 (closure-ref c.76 0)))
                  (closure-call fun/fixnum8553.9 fun/fixnum8553.9 235))))
             (L.fun/boolean8550.8.13
              (lambda (c.77 oprand0.12 oprand1.11)
                (let ((fun/boolean8551.10 (closure-ref c.77 0)))
                  (closure-call fun/boolean8551.10 fun/boolean8551.10))))
       ...
       (if (closure-call
            ...
            (let ((g42378163.14
                   (closure-call
                    ...
                    cons.72
                    107
                    (closure-call cons.72 cons.72 348 empty))))
              (if (closure-call error?.73 error?.73 g42378163.14)
                g42378163.14
                (let ((g42378164.15
                       (closure-call
                        cons.72
                        cons.72
                        203
                        (closure-call cons.72 cons.72 496 empty))))
                  (if (closure-call error?.73 error?.73 g42378164.15)
                    g42378164.15
                    (let ((g42378165.16
                           (closure-call
                            cons.72
                            cons.72
                            79
                            (closure-call cons.72 cons.72 267 empty))))
                      (if (closure-call error?.73 error?.73 g42378165.16)
                        g42378165.16
                        (let ((g42378166.17
                               (closure-call
                                cons.72
                                cons.72
                                239
                                (closure-call cons.72 cons.72 409 empty))))
                          (if (closure-call error?.73 error?.73 g42378166.17)
                            g42378166.17
                            (let ((g42378167.18
                                   (closure-call
                                    cons.72
                                    cons.72
                                    77
                                    (closure-call cons.72 cons.72 484 empty))))
                              (if (closure-call
                                   error?.73
                                   error?.73
                                   g42378167.18)
                                  ...
                                  (if (closure-call
                                    ...
                                    (closure-call
                                     ...
                                     (closure-call
                                      ...
                                      469
                                      empty)))))))))))))))
         (closure-call fun/fixnum8552.7 fun/fixnum8552.7)
         (let () 134))))))
(check-by-interp
 '(module
      ...
      (cletrec
       ...
       (if (let ((pair0.12
                  (closure-call
                   ...
                   cons.67
                   177
                   (closure-call cons.67 cons.67 360 empty)))
                 (empty1.11 empty)
                 (boolean2.10 #f))
             #t)
         (let ((pair0.13
                (closure-call
                 ...
                 cons.67
                 210
                 (closure-call cons.67 cons.67 266 empty))))
           198)
         (closure-call
          fun/fixnum8556.7
          fun/fixnum8556.7
          ...
          (let ((g42381986.14
                 (closure-call
                  ...
                  cons.67
                  103
                  (closure-call cons.67 cons.67 399 empty))))
            (if (closure-call error?.68 error?.68 g42381986.14)
              g42381986.14
              (closure-call
               cons.67
               cons.67
               19
               (closure-call cons.67 cons.67 508 empty))))))))))
(check-by-interp
 '(module
    (letrec ((L.error?.86.10 (lambda (c.96 tmp.73) (let () (error? tmp.73))))
             ...
             (L.make-vector.84.15
              (lambda (c.101 tmp.59)
                (let ((make-init-vector.4 (closure-ref c.101 0)))
                  (if (fixnum? tmp.59)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.59)
                    (error 8)))))
             (L.cons.83.16
              ...
              (lambda (c.103 oprand0.14)
                (let ((cons.83 (closure-ref c.103 0)))
                  (closure-call
                   ...
                   cons.83
                   5
                   (closure-call cons.83 cons.83 421 empty)))))
      ...
      (cletrec
       ...
       (let ((vector0.15
              (let ((tmp.7.16 (closure-call make-vector.84 make-vector.84 8)))
                (let ((g42385801.17
                       (closure-call
                        vector-set!.85
                        vector-set!.85
                        ...
                        (let ((tmp.87 (let () (void))))
                          (if (procedure? tmp.87)
                            (if (eq? (unsafe-procedure-arity tmp.87) 0)
                              ...
                              (error 42))
                            (error 43))))))
                  (if (closure-call error?.86 error?.86 g42385801.17)
                    g42385801.17
                    (let ((g42385802.18
                           (closure-call
                            vector-set!.85
                            ...
                            (let ((tmp.88 (let () 84)))
                              (if (procedure? tmp.88)
                                (if (eq? (unsafe-procedure-arity tmp.88) 0)
                                  ...
                                  (error 42))
                                (error 43))))))
                      (if (closure-call error?.86 error?.86 g42385802.18)
                        g42385802.18
                        (let ((g42385803.19
                               (closure-call
                                vector-set!.85
                                ...
                                (let ((tmp.89
                                  ...
                                  (if (procedure? tmp.89)
                                    (if (eq? (unsafe-procedure-arity tmp.89) 0)
                                      ...
                                      (error 42))
                                    (error 43))))))
                          (if (closure-call error?.86 error?.86 g42385803.19)
                            g42385803.19
                            (let ((g42385804.22
                                   (closure-call
                                    vector-set!.85
    ...
    (letrec ((L.ascii-char?.102.10
             ...
             (L.make-vector.99.16
              (lambda (c.109 tmp.75)
                (let ((make-init-vector.4 (closure-ref c.109 0)))
                  (if (fixnum? tmp.75)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.75)
                    (error 8)))))
             ...
             (L.fun/any7325.15.18
              (lambda (c.111)
                (let ((vector-set!.100 (closure-ref c.111 0))
                  ...
                  (let ((tmp.7.17
                         (closure-call make-vector.99 make-vector.99 8)))
                    (let ((g42409226.18
                           (closure-call
                            vector-set!.100
                            vector-set!.100
                            ...
                            0
                            1)))
                      (if (closure-call error?.101 error?.101 g42409226.18)
                        g42409226.18
                        (let ((g42409227.19
                               (closure-call
                                vector-set!.100
                                ...
                                1
                                2)))
                          (if (closure-call error?.101 error?.101 g42409227.19)
                            g42409227.19
                            (let ((g42409228.20
                                   (closure-call
                                    vector-set!.100
      ...
      (cletrec
       ...
       (if (closure-call
            ascii-char?.102
            ascii-char?.102
            (closure-call fun/any7325.15 fun/any7325.15))
         (closure-call fun/error7326.14 fun/error7326.14)
         (let ((tmp.8.28 (if (error 73) (if (error 249) (error 226) #f) #f)))
           (if tmp.8.28
             tmp.8.28
             (let ((tmp.9.29
                    (let ((g42409234.30 (error 136)))
                      (if (closure-call error?.101 error?.101 g42409234.30)
                        g42409234.30
                        (let ((g42409235.31 (error 134)))
                          (if (closure-call error?.101 error?.101 g42409235.31)
                            g42409235.31
    ...
    (letrec ((L.error?.72.10 (lambda (c.73 tmp.62) (let () (error? tmp.62))))
      ...
      (cletrec
       ...
       (if (let ((tmp.7.11 (if #t #t #t)))
             (if tmp.7.11
               ...
               (let ((tmp.8.12 (let () #t)))
                 (if tmp.8.12
                   ...
                   (let ((tmp.9.13
                          (let ((g42413066.14 #t))
                            (if (closure-call error?.72 error?.72 g42413066.14)
                              g42413066.14
                              (let ((g42413067.15 #t))
                                (if (closure-call
                                     error?.72
         ...
         (let () #\k)
         (closure-call fun/ascii-char8478.10 fun/ascii-char8478.10))))))
(check-by-interp
 '(module
    (letrec ((L.ascii-char?.60.10
      ...
      (cletrec
       ...
       (let ((boolean0.7
              (closure-call ascii-char?.60 ascii-char?.60 (if #f #\l 229))))
         (let () (void)))))))
(check-by-interp
 '(module
             ...
             (L.fun/fixnum8484.15.12
              (lambda (c.86)
                (let ((fun/fixnum8485.13 (closure-ref c.86 0)))
                  (closure-call fun/fixnum8485.13 fun/fixnum8485.13 41)))))
      (cletrec
                                  ...
                                  (if tmp.12.24
                                    ...
                                    (letrec ((L.lam.83.19
                                      ...
                                      (cletrec
                                       ...
                                       lam.83)))))))))))))))
         (closure-call fun/fixnum8484.15 fun/fixnum8484.15)
         (if #t 109 42))))))
(check-by-interp
 '(module
              ...
              (lambda (c.95)
                (let ((cons.73 (closure-ref c.95 0)))
                  (closure-call
                   ...
                   cons.73
                   183
                   (closure-call cons.73 cons.73 488 empty)))))
             (L.fun/pair8488.9.19
              (lambda (c.96)
                (let ((cons.73 (closure-ref c.96 0)))
                  (closure-call
                   ...
                   cons.73
                   88
                   (closure-call cons.73 cons.73 319 empty))))))
      (cletrec
       ...
       (let ((ascii-char0.11 (if #t #\T #\Q))
             (vector1.10
              (let ((tmp.7.12 (closure-call make-vector.74 make-vector.74 8)))
                (let ((g42424517.13
                       (closure-call
                        vector-set!.75
                        vector-set!.75
                        ...
                        (let ((tmp.78 (let () empty)))
                          (if (procedure? tmp.78)
                            (if (eq? (unsafe-procedure-arity tmp.78) 0)
                              ...
                              (error 42))
                            (error 43))))))
                  (if (closure-call error?.76 error?.76 g42424517.13)
                    g42424517.13
                    (let ((g42424518.14
                           (closure-call
                            vector-set!.75
                            ...
                            (let ((tmp.79
                              ...
                              (if (procedure? tmp.79)
                                (if (eq? (unsafe-procedure-arity tmp.79) 0)
                                  ...
                                  (error 42))
                                (error 43))))))
                      (if (closure-call error?.76 error?.76 g42424518.14)
                        g42424518.14
                        (let ((g42424519.15
                               (closure-call
                                vector-set!.75
                                ...
                                (let ((tmp.80
                                  ...
                                  (if (procedure? tmp.80)
                                    (if (eq? (unsafe-procedure-arity tmp.80) 0)
                                      ...
                                      (error 42))
                                    (error 43))))))
                          (if (closure-call error?.76 error?.76 g42424519.15)
                            g42424519.15
                            (let ((g42424520.16
                                   (closure-call
                                    vector-set!.75
      ...
      (cletrec
       ...
       (let ((g42428345.7
              (let ((empty0.10 empty) (fixnum1.9 21) (ascii-char2.8 #\F))
                (void))))
         (if (closure-call error?.64 error?.64 g42428345.7)
           g42428345.7
           (let ((g42428346.11 (let () (void))))
             (if (closure-call error?.64 error?.64 g42428346.11)
               g42428346.11
               (if #f (void) (void))))))))))
(check-by-interp
 '(module
                ...
                (let ((fun/fixnum8498.8 (closure-ref c.67 0))
                  ...
                  (closure-call
                   ...
                   (closure-call
                    fun/procedure8496.9
                    fun/procedure8496.9
                    (closure-call fun/fixnum8498.8 fun/fixnum8498.8))))))
             ...
             (L.fun/procedure8496.9.12
              (lambda (c.69 oprand0.12)
                (let ((fun/procedure8497.10 (closure-ref c.69 0)))
                  (closure-call fun/procedure8497.10 fun/procedure8497.10))))
    ...
    (letrec ((L.fun/error8502.7.10
      ...
      (cletrec
       ...
       (closure-call
        fun/error8501.8
        fun/error8501.8
        (closure-call fun/ascii-char8504.10 fun/ascii-char8504.10))))))
(check-by-interp
 '(module
             ...
             (L.make-vector.84.15
              (lambda (c.94 tmp.60)
                (let ((make-init-vector.4 (closure-ref c.94 0)))
                  (if (fixnum? tmp.60)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.60)
                    (error 8)))))
             ...
             (L.fun/fixnum8507.9.17
              (lambda (c.96 oprand0.14 oprand1.13)
                (let ((fun/fixnum8508.10 (closure-ref c.96 0)))
                  (closure-call fun/fixnum8508.10 fun/fixnum8508.10))))
             (L.fun/fixnum8508.10.18
              (lambda (c.97)
                (let ((fun/fixnum8509.11 (closure-ref c.97 0)))
                  (closure-call fun/fixnum8509.11 fun/fixnum8509.11))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        (if (closure-call
             fun/boolean8510.12
             fun/boolean8510.12
             (let ((tmp.7.17 (closure-call make-vector.84 make-vector.84 8)))
               (let ((g42439795.18
                      (closure-call
                       vector-set!.85
                       vector-set!.85
                       ...
                       0
                       0)))
                 (if (closure-call error?.86 error?.86 g42439795.18)
                   g42439795.18
                   (let ((g42439796.19
                          (closure-call
                           vector-set!.85
                           ...
                           1
                           1)))
                     (if (closure-call error?.86 error?.86 g42439796.19)
                       g42439796.19
                       (let ((g42439797.20
                              (closure-call
                               vector-set!.85
                               ...
                               2
                               2)))
                         (if (closure-call error?.86 error?.86 g42439797.20)
                           g42439797.20
                           (let ((g42439798.21
                                  (closure-call
                                   vector-set!.85
          ...
          (let ((ascii-char0.28 #\f)
            ...
            172)
          (closure-call fun/fixnum8511.8 fun/fixnum8511.8))
        (let ()
             ...
             (L.fun/empty8514.8.12
              (lambda (c.66)
                (let ((fun/empty8515.7 (closure-ref c.66 0)))
                  (closure-call fun/empty8515.7 fun/empty8515.7)))))
      (cletrec
       ...
       (let ((boolean0.9
         ...
         (closure-call fun/empty8514.8 fun/empty8514.8))))))
(check-by-interp
 '(module
             ...
             (L.make-vector.102.15
              (lambda (c.112 tmp.77)
                (let ((make-init-vector.4 (closure-ref c.112 0)))
                  (if (fixnum? tmp.77)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.77)
                    (error 8)))))
             (L.cons.101.16
                   ...
                   (closure-call
                    ...
                    (closure-call
                     ...
                     (closure-call
                      ...
                      cons.101
                      118
                      (closure-call cons.101 cons.101 358 empty))
                     (closure-call
                      cons.101
                      cons.101
                      (closure-call
                       ...
                       cons.101
                       16
                       (closure-call cons.101 cons.101 483 empty))
                      (closure-call
                       cons.101
                       cons.101
                       empty
                       (closure-call
                        ...
                        (closure-call
                         ...
                         cons.101
                         #t
                         (closure-call cons.101 cons.101 #t empty))))))))))
             (closure-call fun/ascii-char8518.9 fun/ascii-char8518.9))
         (if (if (closure-call
                  ...
                  (if #t
                    (closure-call
                     ...
                     cons.101
                     212
                     (closure-call cons.101 cons.101 434 empty))
                    (closure-call
                     cons.101
                     cons.101
                     140
                     (closure-call cons.101 cons.101 331 empty))))
               (if (let () #\T)
                 (if (if #f #\_ #\J)
                   (let ((procedure0.23
                          (letrec ((L.lam.105.23
                         ...
                         (pair1.22
                          (closure-call
                           ...
                           cons.101
                           151
                           (closure-call cons.101 cons.101 317 empty))))
                     #\b)
                   #f)
                 #f)
               #f)
           (if (let ((boolean0.25
                 ...
                 (closure-call
                  ...
                  fun/ascii-char8520.10
                  #\g))
             (if (closure-call fun/ascii-char8521.13 fun/ascii-char8521.13)
               (if (if (let () #\k)
                     (if (let ((vector0.37
                                (let ((tmp.8.38
                                       (closure-call
    ...
    (letrec ((L.cons.71.10
             ...
             (L.fun/ascii-char8527.7.11
              (lambda (c.73)
                (let ((fun/ascii-char8528.8 (closure-ref c.73 0)))
                  (closure-call fun/ascii-char8528.8 fun/ascii-char8528.8))))
                ...
                (let ((cons.71 (closure-ref c.74 0)))
                  (let ((pair0.13
                         (closure-call
                          ...
                          cons.71
                          127
                          (closure-call cons.71 cons.71 352 empty))))
                    #\Y))))
             ...
             (L.fun/void8530.10.14
              (lambda (c.76 oprand0.16)
                (let ((fun/void8531.11 (closure-ref c.76 0)))
                  (closure-call fun/void8531.11 fun/void8531.11))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        fun/ascii-char8526.9
        (closure-call fun/ascii-char8527.7 fun/ascii-char8527.7)
        (closure-call fun/void8529.12 fun/void8529.12))))))
(check-by-interp
 '(module
             ...
             (L.fun/ascii-char8545.12.18
              (lambda (c.153)
                (let ((fun/ascii-char8546.21 (closure-ref c.153 0)))
                  (closure-call fun/ascii-char8546.21 fun/ascii-char8546.21))))
             (L.fun/ascii-char8542.13.19
              (lambda (c.154 oprand0.28 oprand1.27)
                (let ((fun/ascii-char8543.20 (closure-ref c.154 0)))
                  (closure-call fun/ascii-char8543.20 fun/ascii-char8543.20))))
             ...
             (L.fun/ascii-char8535.16.22
              (lambda (c.157)
                (let ((fun/ascii-char8536.14 (closure-ref c.157 0)))
                  (closure-call fun/ascii-char8536.14 fun/ascii-char8536.14))))
             ...
             (L.fun/boolean8547.23.29
              (lambda (c.164)
                (let ((fun/boolean8548.22 (closure-ref c.164 0)))
                  (closure-call fun/boolean8548.22 fun/boolean8548.22))))
             ...
             (L.fun/ascii-char8544.25.31
              (lambda (c.166 oprand0.34 oprand1.33)
                (let ((fun/ascii-char8545.12 (closure-ref c.166 0)))
                  (closure-call fun/ascii-char8545.12 fun/ascii-char8545.12))))
               ...
               (if #f
                 ...
                 (letrec ((L.lam.144.34 (lambda (c.169) (let () 631))))
                   (cletrec
                    ...
                    lam.144)))
               (let () empty))))
         (if (closure-call error?.132 error?.132 g42455084.37)
           g42455084.37
           (let ((g42455085.38
                  (if (let ((boolean0.40 #f) (empty1.39 empty)) #f)
                    (let ((error0.42 (error 211)) (ascii-char1.41 #\U)) #\b)
                    (let ((g42455086.43 #\f))
                      (if (closure-call error?.132 error?.132 g42455086.43)
                        g42455086.43
                        (let ((g42455087.44 #\`))
                          (if (closure-call error?.132 error?.132 g42455087.44)
                            g42455087.44
                            (let ((g42455088.45 #\a))
                              (if (closure-call
                                   error?.132
                                      ...
                                      (if (closure-call
                                        ...
                                        (let ((g42455091.48 #\O))
                                          (if (closure-call
                                            ...
                                            g42455091.48
                                            #\J)))))))))))))))
             (if (closure-call error?.132 error?.132 g42455085.38)
               g42455085.38
               (let ((g42455092.49
                      (let ((pair0.52
                             (closure-call
                              ...
                              (closure-call
                               ...
                               cons.133
                               8
                               (closure-call cons.133 cons.133 450 empty))
                              (closure-call
                               cons.133
                               cons.133
                               (closure-call
                                ...
                                cons.133
                                143
                                (closure-call cons.133 cons.133 368 empty))
                               (closure-call
                                cons.133
                                cons.133
                                110
                                                         ...
                                                         (if (closure-call
                                                           ...
                                                           (let ((g42455108.70
                                                             ...
                                                             (if (closure-call
                                                               ...
                                                               tmp.7.53))))))))))))))))))
                            (void2.50
                             (closure-call fun/void8537.18 fun/void8537.18)))
                        (closure-call
                         fun/ascii-char8538.19
                         fun/ascii-char8538.19))))
                 (if (closure-call error?.132 error?.132 g42455092.49)
                   g42455092.49
                   (let ((g42455109.71
                          (closure-call
                           ...
                           (closure-call
                            ...
                            (closure-call
                             fun/fixnum8541.24
                             fun/fixnum8541.24)))))
                     (if (closure-call error?.132 error?.132 g42455109.71)
                       g42455109.71
                       (let ((g42455110.75
                              (if (if #t #\i #\[)
                                (if (closure-call
                                  ...
                                  #f)
                                #f)))
                         (if (closure-call error?.132 error?.132 g42455110.75)
                           g42455110.75
                           (closure-call
                            fun/ascii-char8544.25
                            fun/ascii-char8544.25
    ...
    (letrec ((L.fun/empty8551.7.10
              (lambda (c.65)
                (let ((fun/empty8552.8 (closure-ref c.65 0)))
                  (closure-call fun/empty8552.8 fun/empty8552.8))))
              ...
              (letrec ((L.lam.64.12
                        (lambda (c.67 oprand0.11 oprand1.10)
                          (let ((fun/empty8551.7 (closure-ref c.67 0)))
                            (closure-call fun/empty8551.7 fun/empty8551.7)))))
                (cletrec
    ...
    (letrec ((L.error?.91.10 (lambda (c.93 tmp.79) (let () (error? tmp.79))))
      ...
      (cletrec
       ...
       (closure-call
        ...
        fun/error8560.10
        (if (if #f #f #f)
          (closure-call fun/empty8561.9 fun/empty8561.9 (void))
          (closure-call
           fun/empty8562.11
           fun/empty8562.11
           (let ((tmp.7.19 (closure-call make-vector.89 make-vector.89 8)))
             (let ((g42462740.20
                    (closure-call vector-set!.90 vector-set!.90 tmp.7.19 0 1)))
               (if (closure-call error?.91 error?.91 g42462740.20)
                 g42462740.20
                 (let ((g42462741.21
                        (closure-call
                         vector-set!.90
                         ...
                         1
                         2)))
                   (if (closure-call error?.91 error?.91 g42462741.21)
                     g42462741.21
                     (let ((g42462742.22
                            (closure-call
                             vector-set!.90
                             ...
                             2
                             3)))
                       (if (closure-call error?.91 error?.91 g42462742.22)
                         g42462742.22
                         (let ((g42462743.23
                                (closure-call
                                 vector-set!.90
                                 ...
                                 3
                                 4)))
                           (if (closure-call error?.91 error?.91 g42462743.23)
                             g42462743.23
                             (let ((g42462744.24
                                    (closure-call
                                     vector-set!.90
        ...
        (if (closure-call
             fun/boolean8563.12
             fun/boolean8563.12
             (let ((tmp.8.28 (closure-call make-vector.89 make-vector.89 8)))
               (let ((g42462748.29
                      (closure-call
                       vector-set!.90
                       vector-set!.90
                       ...
                       0
                       1)))
                 (if (closure-call error?.91 error?.91 g42462748.29)
                   g42462748.29
                   (let ((g42462749.30
                          (closure-call
                           vector-set!.90
                           ...
                           1
                           2)))
                     (if (closure-call error?.91 error?.91 g42462749.30)
                       g42462749.30
                       (let ((g42462750.31
                              (closure-call
                               vector-set!.90
                               ...
                               2
                               3)))
                         (if (closure-call error?.91 error?.91 g42462750.31)
                           g42462750.31
                           (let ((g42462751.32
                                  (closure-call
                                   vector-set!.90
    ...
    (letrec ((L.fun/fixnum8572.7.10
              (lambda (c.66)
                (let ((fun/fixnum8573.9 (closure-ref c.66 0)))
                  (closure-call fun/fixnum8573.9 fun/fixnum8573.9))))
             ...
             (L.fun/fixnum8574.10.13
              (lambda (c.69)
                (let ((fun/fixnum8575.8 (closure-ref c.69 0)))
                  (closure-call fun/fixnum8575.8 fun/fixnum8575.8)))))
      (cletrec
       ((fun/fixnum8572.7
       ...
       (let ((fixnum0.13 (closure-call fun/fixnum8572.7 fun/fixnum8572.7))
             (error1.12 (let () (error 252)))
             (empty2.11 (let () empty)))
         (closure-call fun/fixnum8574.10 fun/fixnum8574.10))))))
(check-by-interp
 '(module
             ...
             (L.fun/empty8585.7.11
              (lambda (c.73)
                (let ((fun/empty8586.9 (closure-ref c.73 0)))
                  (closure-call fun/empty8586.9 fun/empty8586.9))))
             (L.fun/empty8584.8.12
              (lambda (c.74 oprand0.10)
                (let ((fun/empty8585.7 (closure-ref c.74 0)))
                  (closure-call fun/empty8585.7 fun/empty8585.7))))
       ...
       (closure-call
        ...
        (let ((error0.12
               (let ((g42470384.13 (error 207)))
                 (if (closure-call error?.71 error?.71 g42470384.13)
                   g42470384.13
                   (let ((g42470385.14 (error 104)))
                     (if (closure-call error?.71 error?.71 g42470385.14)
                       g42470385.14
                       (let ((g42470386.15 (error 16)))
                         (if (closure-call error?.71 error?.71 g42470386.15)
                           g42470386.15
          ...
          (let ((g42470388.17 (error 161)))
            (if (closure-call error?.71 error?.71 g42470388.17)
              g42470388.17
              (let ((g42470389.18 (error 194)))
                (if (closure-call error?.71 error?.71 g42470389.18)
                  g42470389.18
                  (error 177)))))))))))
(check-by-interp
 '(module
             ...
             (L.make-vector.112.15
              (lambda (c.135 tmp.87)
                (let ((make-init-vector.4 (closure-ref c.135 0)))
                  (if (fixnum? tmp.87)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.87)
                    (error 8)))))
             (L.cons.111.16
                ...
                (let ((cons.111 (closure-ref c.138 0)))
                  (if #f
                    (closure-call
                     ...
                     cons.111
                     232
                     (closure-call cons.111 cons.111 299 empty))
                    (closure-call
                     cons.111
                     cons.111
                     190
                     (closure-call cons.111 cons.111 484 empty))))))
             (L.fun/error8589.13.19
              (lambda (c.139 oprand0.17 oprand1.16)
                (let ((fun/error8590.14 (closure-ref c.139 0)))
                  (closure-call fun/error8590.14 fun/error8590.14))))
             (L.fun/error8590.14.20
              (lambda (c.140)
                (let ((fun/error8591.11 (closure-ref c.140 0)))
                  (closure-call fun/error8591.11 fun/error8591.11)))))
      (cletrec
       ...
       (closure-call
        ...
        (let ((vector0.21
               (let ((tmp.7.22
                      (closure-call make-vector.112 make-vector.112 8)))
                 (let ((g42474204.23
                        (closure-call
                         vector-set!.113
                         vector-set!.113
                         ...
                         (let ((tmp.115 empty))
                           (if (procedure? tmp.115)
                             (if (eq? (unsafe-procedure-arity tmp.115) 0)
                               ...
                               (error 42))
                             (error 43))))))
                   (if (closure-call error?.114 error?.114 g42474204.23)
                     g42474204.23
                     (let ((g42474205.24
                            (closure-call
                             vector-set!.113
                             ...
                             (let ((tmp.116 (error 230)))
                               (if (procedure? tmp.116)
                                 (if (eq? (unsafe-procedure-arity tmp.116) 0)
                                   ...
                                   (error 42))
                                 (error 43))))))
                       (if (closure-call error?.114 error?.114 g42474205.24)
                         g42474205.24
                         (let ((g42474206.25
                                (closure-call
                                 vector-set!.113
                         ...
                         (let ((tmp.123 (error 207)))
                           (if (procedure? tmp.123)
                             (if (eq? (unsafe-procedure-arity tmp.123) 0)
                               ...
                               (error 42))
                             (error 43))))))
                   (if (closure-call error?.114 error?.114 g42474212.32)
                     g42474212.32
                     (let ((g42474213.33
                            (closure-call
                             vector-set!.113
                             ...
                             1
                             (let () 674))))
                       (if (closure-call error?.114 error?.114 g42474213.33)
                         g42474213.33
                         (let ((g42474214.34
                                (closure-call
                                 vector-set!.113
    ...
    (letrec ((L.error?.81.10 (lambda (c.82 tmp.68) (let () (error? tmp.68))))
             ...
             (L.make-vector.79.15
              (lambda (c.87 tmp.54)
                (let ((make-init-vector.4 (closure-ref c.87 0)))
                  (if (fixnum? tmp.54)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.54)
                    (error 8)))))
             (L.cons.78.16
             ...
             (L.fun/empty8599.8.17
              (lambda (c.89 oprand0.11)
                (let ((fun/empty8601.10 (closure-ref c.89 0))
                  ...
                  (if (let () #f)
                    (closure-call fun/empty8600.9 fun/empty8600.9)
                    (closure-call fun/empty8601.10 fun/empty8601.10)))))
          ...
          (let ((boolean0.14 #f)
                ...
                (pair2.12
                 (closure-call
                  ...
                  cons.78
                  41
                  (closure-call cons.78 cons.78 412 empty))))
            165)
          (let ((vector0.16
                 (let ((tmp.7.17
                        (closure-call make-vector.79 make-vector.79 8)))
                   (let ((g42478053.18
                          (closure-call
                           vector-set!.80
                           vector-set!.80
                           ...
                           0
                           1)))
                     (if (closure-call error?.81 error?.81 g42478053.18)
                       g42478053.18
                       (let ((g42478054.19
                              (closure-call
                               vector-set!.80
                               ...
                               1
                               2)))
                         (if (closure-call error?.81 error?.81 g42478054.19)
                           g42478054.19
                           (let ((g42478055.20
                                  (closure-call
                                   vector-set!.80
 ...
 '(module
    (letrec ((L.cons.77.10
             ...
             (L.fun/boolean8604.10.11
              (lambda (c.80)
                (let ((fun/boolean8605.12 (closure-ref c.80 0)))
                  (closure-call fun/boolean8605.12 fun/boolean8605.12 #f))))
      ...
      (cletrec
       ...
       (if (closure-call fun/boolean8604.10 fun/boolean8604.10)
                 ...
                 (let ((tmp.9.22
                        (closure-call
                         ...
                         (closure-call
                          ...
                          cons.77
                          124
                          (closure-call cons.77 cons.77 438 empty))
 ...
 '(module
    (letrec ((L.fun/boolean8612.7.10 (lambda (c.63 oprand0.10) (let () #f)))
             (L.fun/boolean8611.8.11
              (lambda (c.64)
                (let ((fun/boolean8612.7 (closure-ref c.64 0)))
                  (closure-call fun/boolean8612.7 fun/boolean8612.7 empty))))
      ...
      (cletrec
       ...
       (if (closure-call fun/boolean8610.9 fun/boolean8610.9)
         (closure-call fun/boolean8611.8 fun/boolean8611.8)
         (if #t #t #t))))))
(check-by-interp
 '(module
             ...
             (if tmp.8.22
               ...
               (let ((tmp.9.23
                      (closure-call
                       fun/boolean8617.13
                       fun/boolean8617.13
                       (closure-call fun/pair8619.12 fun/pair8619.12)
             ...
             (L.fun/fixnum8623.40.21
              (lambda (c.225 oprand0.48 oprand1.47)
                (let ((fun/boolean8624.39 (closure-ref c.225 0)))
                  (if (closure-call fun/boolean8624.39 fun/boolean8624.39)
                    oprand1.47
                    oprand1.47))))
       ...
       (closure-call
        ...
        (if (let ((tmp.14.74
                   (closure-call
                    ...
                    (error 175)
                    (let ((tmp.15.75
                           (closure-call make-vector.208 make-vector.208 8)))
                      (let ((g42493334.76
                             (closure-call
                              vector-set!.209
                              vector-set!.209
                              ...
                              0
                              1)))
                        (if (closure-call error?.210 error?.210 g42493334.76)
                          g42493334.76
                          (let ((g42493335.77
                                 (closure-call
                                  vector-set!.209
              ...
              (if tmp.14.74
                tmp.14.74
                (let ((tmp.16.84
                       (closure-call fun/fixnum8626.41 fun/fixnum8626.41)))
                  (if tmp.16.84
                    tmp.16.84
                    (let ((tmp.17.85
                           (closure-call fun/fixnum8627.42 fun/fixnum8627.42)))
                      (if tmp.17.85
                        tmp.17.85
          ...
          (if (if 32
                (if (closure-call
                     ...
                     (let ((tmp.19.90
                       ...
                       (let ((g42493342.91
                              (closure-call
                               ...
                               0
                               0)))
                         (if (closure-call error?.210 error?.210 g42493342.91)
                           g42493342.91
                           (let ((g42493343.92
                                  (closure-call
                                   vector-set!.209
                  ...
                  (if (let ((pair0.100
                             (closure-call
                              ...
                              cons.211
                              182
                              (closure-call cons.211 cons.211 324 empty)))
                            (error1.99 (error 85)))
                        6)
                    (if 113
            ...
            (if (if #t 60 147)
              (if (let ((g42493350.103 (if #f 74 149)))
                    (if (closure-call error?.210 error?.210 g42493350.103)
                      g42493350.103
                      (let ((g42493351.104
                             (if 18 (if 18 (if 233 (if 91 193 #f) #f) #f) #f)))
                        (if (closure-call error?.210 error?.210 g42493351.104)
                          g42493351.104
                          (let ((g42493352.105
                                 (let ((tmp.20.106 235))
                ...
                (if (closure-call
                     ...
                     |-.212|
                     (let ((void0.130 (void))
                           (pair1.129 (closure-call cons.211 cons.211 #\O #f)))
                       76)
              ...
              (lambda (c.83 oprand0.18)
                (let ((cons.76 (closure-ref c.83 0)))
                  (closure-call
                   ...
                   cons.76
                   16
                   (closure-call cons.76 cons.76 418 empty)))))
             ...
             (L.fun/fixnum8633.16.18
              (lambda (c.87 oprand0.19)
                (let ((fun/fixnum8634.13 (closure-ref c.87 0)))
                  (closure-call fun/fixnum8634.13 fun/fixnum8634.13)))))
      (cletrec
       ...
       (if (let ((tmp.7.20
                  (closure-call fun/boolean8631.11 fun/boolean8631.11 #\f)))
             (if tmp.7.20
               tmp.7.20
               (let ((tmp.8.21 (closure-call >.77 >.77 237 82)))
                 (if tmp.8.21
                   tmp.8.21
                   (let ((tmp.9.22 (let () #t)))
                     (if tmp.9.22
                       tmp.9.22
                       (let ((tmp.10.23 (closure-call <=.78 <=.78 191 13)))
                         (if tmp.10.23
                           tmp.10.23
                           (closure-call
                            fun/boolean8632.15
         ...
         (closure-call
          fun/fixnum8633.16
          fun/fixnum8633.16
          (closure-call fun/pair8635.12 fun/pair8635.12 #\F))
         (closure-call fun/fixnum8636.14 fun/fixnum8636.14))))))
(check-by-interp
 '(module
    (letrec ((L.fun/void8639.17.10
      ...
      (cletrec
       ...
       (if (if #f #t #t)
         (closure-call fun/void8639.17 fun/void8639.17 (if #t #t #t))
         (let ((tmp.7.22
                (closure-call fun/void8640.18 fun/void8640.18 #t #\I)))
           (if tmp.7.22
             tmp.7.22
      ...
      (cletrec
       ...
       (closure-call
        ...
        (closure-call
         ascii-char?.64
         ascii-char?.64
         (let ((vector0.10 (closure-call make-vector.63 make-vector.63 8)))
           146)))))))
(check-by-interp
 '(module
    (letrec ((L.>.117.10
      ...
      (cletrec
       ...
       (closure-call
        ...
        >.117
        (let ((g42516139.26
               (closure-call fun/fixnum8646.17 fun/fixnum8646.17 #\q)))
          (if (closure-call error?.111 error?.111 g42516139.26)
            g42516139.26
            (if #f 81 95)))
        (if (closure-call
             |+.112|
          ...
          (if (let ((procedure0.27
            ...
            (if (let ((tmp.7.30 (let () 226)))
                  (if tmp.7.30
                    tmp.7.30
                    (let ((tmp.8.31 (closure-call |-.113| |-.113| 94 208)))
                      (if tmp.8.31
                        tmp.8.31
              ...
              (if (let ((boolean0.55 #t)
                        (pair1.54
                         (closure-call
                          ...
                          cons.116
                          131
                          (closure-call cons.116 cons.116 435 empty)))
                        (procedure2.53
                      ...
                      (if (if #t 36 135)
                        (if (closure-call
                             ...
                             (closure-call
                              ...
                              cons.116
                              124
                              (closure-call cons.116 cons.116 432 empty))
                             82)
              ...
              (if (let ((boolean0.26 #f)
                        (pair1.25
                         (closure-call
                          ...
                          cons.139
                          247
                          (closure-call cons.139 cons.139 312 empty)))
                        (error2.24 (error 55)))
                    #f)
                (closure-call fun/void8652.10 fun/void8652.10 #\O empty)
                (let ((g42519969.27 (void)))
                  (if (closure-call error?.140 error?.140 g42519969.27)
                    g42519969.27
                    (void))))))
         (if (closure-call error?.140 error?.140 g42519968.23)
           g42519968.23
           (let ((g42519970.28
                  (if (let ((g42519971.29 #t))
                        (if (closure-call error?.140 error?.140 g42519971.29)
                          g42519971.29
                          #f))
                    (if #t (void) (void))
                    (let ((g42519972.30 (void)))
                      (if (closure-call error?.140 error?.140 g42519972.30)
                        g42519972.30
                        (let ((g42519973.31 (void)))
                          (if (closure-call error?.140 error?.140 g42519973.31)
                            g42519973.31
                                  ...
                                  (if (closure-call
                                    ...
                                    (let ((g42519976.34 (void)))
                                      (if (closure-call
                                        ...
                                        g42519976.34
                                        (void))))))))))))))
             (if (closure-call error?.140 error?.140 g42519970.28)
               g42519970.28
               (let ((g42519977.35
                      (closure-call
                       fun/void8653.14
                       ...
                       (if #t
                         (closure-call
                          ...
                          cons.139
                          38
                          (closure-call cons.139 cons.139 339 empty))
                         (closure-call
                          cons.139
                          cons.139
                          84
                          (closure-call cons.139 cons.139 401 empty)))
                       (let ((error0.37 (error 143)) (error1.36 (error 119)))
                         (error 96)))))
                 (if (closure-call error?.140 error?.140 g42519977.35)
                   g42519977.35
                   (let ((g42519978.38
                          (let ((g42519979.39
                                              ...
                                              (let ((g42520002.69
                                                ...
                                                (if (closure-call
                                                  ...
                                                  (if #f
                                                    (void)
                                                    (void))))))))))))))))
                     (if (closure-call error?.140 error?.140 g42519978.38)
                       g42519978.38
                       (let ((g42520003.70
                              (let ((void0.71
                                     (closure-call
                                      ...
                                      (pair1.72
                                       (closure-call
                                        ...
                                        (closure-call
                                         ...
                                         empty))))
                                  (void)))))
                         (if (closure-call error?.140 error?.140 g42520003.70)
                           g42520003.70
                           (closure-call
                            fun/void8656.11
                            fun/void8656.11
       ...
       (let ((void0.9 (let ((ascii-char0.10 #\s)) (void))))
         (if (if #f (void) (void))
           (if (let ((g42523829.11 (void)))
                 (if (closure-call error?.64 error?.64 g42523829.11)
                   g42523829.11
                   (void)))
             (closure-call fun/void8659.7 fun/void8659.7 #f)
             #f)
           #f))))))
(check-by-interp
 '(module
             ...
             (L.make-vector.72.14
              (lambda (c.79 tmp.48)
                (let ((make-init-vector.4 (closure-ref c.79 0)))
                  (if (fixnum? tmp.48)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.48)
                    (error 8)))))
       ...
       (if (if (let ((void0.12 (void))
         ...
         (if (let ((empty0.16
                    (let ((g42527647.17 empty))
                      (if (closure-call error?.73 error?.73 g42527647.17)
                        g42527647.17
                        (let ((g42527648.18 empty))
                          (if (closure-call error?.73 error?.73 g42527648.18)
                            g42527648.18
                    ...
                    (closure-call
                     ...
                     (closure-call
                      ...
                      (closure-call
                       ...
                       cons.74
                       154
                       (closure-call cons.74 cons.74 498 empty))
                      (closure-call
                       cons.74
                       cons.74
                       95
                        ...
                        (closure-call
                         ...
                         (closure-call
                          ...
                          (closure-call
                           ...
                           cons.74
                           118
                           (closure-call cons.74 cons.74 510 empty))
                          (closure-call
                           cons.74
                           cons.74
                           #f
                           (closure-call cons.74 cons.74 #\] empty))))))))))
               (if #t (error 132) (error 79)))
           (closure-call fun/error8662.7 fun/error8662.7)
           #f)
         #f)))))
(check-by-interp
 '(module
    (letrec ((L.error?.88.10 (lambda (c.89 tmp.76) (let () (error? tmp.76))))
             ...
             (L.make-vector.86.15
              (lambda (c.94 tmp.62)
                (let ((make-init-vector.4 (closure-ref c.94 0)))
                  (if (fixnum? tmp.62)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.62)
                    (error 8)))))
      ...
      (cletrec
       ...
       (if (let () #f)
         (closure-call
          ...
          (let ((vector0.13
                 (let ((tmp.7.14
                        (closure-call make-vector.86 make-vector.86 8)))
                   (let ((g42531467.15
                          (closure-call
                           vector-set!.87
                           vector-set!.87
                           ...
                           0
                           0)))
                     (if (closure-call error?.88 error?.88 g42531467.15)
                       g42531467.15
                       (let ((g42531468.16
                              (closure-call
                               vector-set!.87
                               ...
                               1
                               1)))
                         (if (closure-call error?.88 error?.88 g42531468.16)
                           g42531468.16
                           (let ((g42531469.17
                                  (closure-call
                                   vector-set!.87
                ...
                (let ((tmp.8.25
                  ...
                  (let ((g42531475.26
                         (closure-call
                          ...
                          0
                          1)))
                    (if (closure-call error?.88 error?.88 g42531475.26)
                      g42531475.26
                      (let ((g42531476.27
                             (closure-call
                              vector-set!.87
                              ...
                              1
                              2)))
                        (if (closure-call error?.88 error?.88 g42531476.27)
                          g42531476.27
                          (let ((g42531477.28
                                 (closure-call
                                  vector-set!.87
                                  ...
                                  2
                                  3)))
                            (if (closure-call error?.88 error?.88 g42531477.28)
                              g42531477.28
                              (let ((g42531478.29
                                     (closure-call
                                      vector-set!.87
 ...
 '(module
    (letrec ((L.error?.100.10 (lambda (c.110 tmp.87) (let () (error? tmp.87))))
             ...
             (L.make-vector.98.15
              (lambda (c.115 tmp.73)
                (let ((make-init-vector.4 (closure-ref c.115 0)))
                  (if (fixnum? tmp.73)
                    (closure-call make-init-vector.4 make-init-vector.4 tmp.73)
                    (error 8)))))
             (L.cons.97.16
              ...
              (lambda (c.118)
                (let ((cons.97 (closure-ref c.118 0)))
                  (closure-call
                   ...
                   cons.97
                   33
                   (closure-call cons.97 cons.97 355 empty)))))
      ...
      (cletrec
       ...
       (let ((vector0.14
              (let ((tmp.7.15 (closure-call make-vector.98 make-vector.98 8)))
                (let ((g42535303.16
                       (closure-call
                        vector-set!.99
                        vector-set!.99
                        ...
                        (let ((tmp.101 (let () (error 47))))
                          (if (procedure? tmp.101)
                            (if (eq? (unsafe-procedure-arity tmp.101) 0)
                              ...
                              (error 42))
                            (error 43))))))
                  (if (closure-call error?.100 error?.100 g42535303.16)
                    g42535303.16
                    (let ((g42535304.17
                           (closure-call
                            vector-set!.99
                            ...
                            (let ((tmp.102 (error 83)))
                              (if (procedure? tmp.102)
                                (if (eq? (unsafe-procedure-arity tmp.102) 0)
                                  ...
                                  (error 42))
                                (error 43))))))
                      (if (closure-call error?.100 error?.100 g42535304.17)
                        g42535304.17
                        (let ((g42535305.18
                               (closure-call
                                vector-set!.99
                                ...
                                (let ((tmp.103
                                  ...
                                  (if (procedure? tmp.103)
                                    (if (eq?
                                      ...
                                      (error 42))
                                    (error 43))))))
                          (if (closure-call error?.100 error?.100 g42535305.18)
                            g42535305.18
                            (let ((g42535306.19
                                   (closure-call
                                    vector-set!.99
    ...
    (letrec ((L.fun/error8673.7.10
      ...
      (cletrec
       ...
       (let ((fixnum0.13 (let () 133))
             (error1.12 (closure-call fun/error8673.7 fun/error8673.7))
             (procedure2.11
              (letrec ((L.lam.66.14
                        (lambda (c.71)
                          (let ((fun/error8675.9 (closure-ref c.71 0)))
                            (closure-call fun/error8675.9 fun/error8675.9)))))
                (cletrec
             ...
             (L.fun/boolean8686.10.17
              (lambda (c.102 oprand0.16)
                (let ((fun/boolean8687.9 (closure-ref c.102 0)))
                  (closure-call fun/boolean8687.9 fun/boolean8687.9))))
             ...
             (L.fun/void8681.12.19
              (lambda (c.104 oprand0.17)
                (let ((fun/void8682.14 (closure-ref c.104 0)))
                  (closure-call fun/void8682.14 fun/void8682.14))))
             (L.fun/boolean8684.13.20
              (lambda (c.105)
                (let ((fun/boolean8685.11 (closure-ref c.105 0)))
                  (closure-call fun/boolean8685.11 fun/boolean8685.11))))
             ...
             (L.fun/boolean8683.15.22
              (lambda (c.107 oprand0.19 oprand1.18)
                (let ((fun/boolean8684.13 (closure-ref c.107 0)))
                  (closure-call fun/boolean8684.13 fun/boolean8684.13)))))
      (cletrec
       ...
       (closure-call
        ...
        (closure-call
         ...
         fun/boolean8683.15
         (if #f
           (let ((tmp.7.20 (closure-call make-vector.90 make-vector.90 8)))
             (let ((g42546779.21
                    (closure-call vector-set!.91 vector-set!.91 tmp.7.20 0 1)))
               (if (closure-call error?.92 error?.92 g42546779.21)
                 g42546779.21
                 (let ((g42546780.22
                        (closure-call
                         vector-set!.91
                         ...
                         1
                         2)))
                   (if (closure-call error?.92 error?.92 g42546780.22)
                     g42546780.22
                     (let ((g42546781.23
                            (closure-call
                             vector-set!.91
                             ...
                             2
                             3)))
                       (if (closure-call error?.92 error?.92 g42546781.23)
                         g42546781.23
                         (let ((g42546782.24
                                (closure-call
                                 vector-set!.91
                                 ...
                                 3
                                 4)))
                           (if (closure-call error?.92 error?.92 g42546782.24)
                             g42546782.24
                             (let ((g42546783.25
                                    (closure-call
                                     vector-set!.91
                                       ...
                                       (if (closure-call
                                         ...
                                         (let ((g42546786.28
                                           ...
                                           (if (closure-call
                                             ...
                                             g42546786.28
                                             tmp.7.20)))))))))))))))))
           (let ((tmp.8.29 (closure-call make-vector.90 make-vector.90 8)))
             (let ((g42546787.30
                    (closure-call vector-set!.91 vector-set!.91 tmp.8.29 0 1)))
               (if (closure-call error?.92 error?.92 g42546787.30)
                 g42546787.30
                 (let ((g42546788.31
                        (closure-call
                         vector-set!.91
                         ...
                         1
                         2)))
                   (if (closure-call error?.92 error?.92 g42546788.31)
                     g42546788.31
                     (let ((g42546789.32
                            (closure-call
                             vector-set!.91
                             ...
                             2
                             3)))
                       (if (closure-call error?.92 error?.92 g42546789.32)
                         g42546789.32
                         (let ((g42546790.33
                                (closure-call
                                 vector-set!.91
                                 ...
                                 3
                                 4)))
                           (if (closure-call error?.92 error?.92 g42546790.33)
                             g42546790.33
                             (let ((g42546791.34
                                    (closure-call
                                     vector-set!.91
 ...
 '(module
    (letrec ((L.error?.69.10 (lambda (c.70 tmp.59) (let () (error? tmp.59))))
             ...
             (L.fun/empty8691.9.13
              (lambda (c.73 oprand0.13 oprand1.12)
                (let ((fun/empty8692.10 (closure-ref c.73 0)))
                  (closure-call fun/empty8692.10 fun/empty8692.10))))
      ...
      (cletrec
       ...
       (if (closure-call fun/boolean8690.8 fun/boolean8690.8)
         (let ((empty0.14 empty)) empty)
         (closure-call
          fun/empty8691.9
          fun/empty8691.9
          (closure-call fun/error8693.7 fun/error8693.7 #\r)
          (let ((g42550609.15 #\x))
            (if (closure-call error?.69 error?.69 g42550609.15)
              g42550609.15
              (let ((g42550610.16 #\U))
                (if (closure-call error?.69 error?.69 g42550610.16)
                  g42550610.16
                  #\O))))))))))
(check-by-interp
 '(module
    (letrec ((L.cons.98.10
      ...
      (cletrec
       ...
       (let ((vector0.21
              (let ((tmp.7.22 (closure-call make-vector.94 make-vector.94 8)))
                (let ((g42554425.23
                       (closure-call
                        vector-set!.95
                        vector-set!.95
                        ...
                        (let ((tmp.99
                          ...
                          (if (procedure? tmp.99)
                            (if (eq? (unsafe-procedure-arity tmp.99) 0)
                              ...
                              (error 42))
                            (error 43))))))
                  (if (closure-call error?.96 error?.96 g42554425.23)
                    g42554425.23
                    (let ((g42554426.24
                           (closure-call
                            vector-set!.95
                            ...
                            (let ((tmp.100 (let () empty)))
                              (if (procedure? tmp.100)
                                (if (eq? (unsafe-procedure-arity tmp.100) 0)
                                  ...
                                  (error 42))
                                (error 43))))))
                      (if (closure-call error?.96 error?.96 g42554426.24)
                        g42554426.24
                        (let ((g42554427.25
                               (closure-call
                                vector-set!.95
                                ...
                                (let ((tmp.101 (if #t empty empty)))
                                  (if (procedure? tmp.101)
                                    (if (eq?
                                      ...
                                      (error 42))
                                    (error 43))))))
                          (if (closure-call error?.96 error?.96 g42554427.25)
                            g42554427.25
                            (let ((g42554428.26
                                   (closure-call
                                    vector-set!.95
           ...
           (if tmp.9.34
             ...
             (let ((tmp.10.35 (let () empty)))
               (if tmp.10.35
                 tmp.10.35
                 (let ((tmp.11.36
                        (closure-call fun/empty8698.16 fun/empty8698.16)))
                   (if tmp.11.36
                     tmp.11.36
                     (let ((tmp.12.37
             ...
             (L.fun/error8702.8.11
              (lambda (c.65 oprand0.9)
                (let ((fun/error8703.7 (closure-ref c.65 0)))
                  (closure-call fun/error8703.7 fun/error8703.7)))))
      (cletrec
