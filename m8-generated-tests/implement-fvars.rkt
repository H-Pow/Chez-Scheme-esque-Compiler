...
(check-by-interp
 '(module
    ...
    (begin
      (set! r15 r15)
      (if (begin (set! r14 14) (true)) (set! r14 15934) (set! r14 45118))
      (set! rdi r14)
      (set! r15 r15)
...
(check-by-interp
 '(module
    ...
    (begin
      (set! r15 r15)
      (if (begin (set! r14 14) (true)) (set! r14 17454) (set! r14 17966))
      (set! rdi r14)
      (set! r15 r15)
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fv0 r15)
      (if (begin (set! r15 6) (false)) (set! r15 54078) (set! r15 38718))
      (begin
        (set! rbp (- rbp 8))
        (return-point L.rp.9
        ...
        (set! rbp (+ rbp 8)))
      (set! r15 rax)
      (if (begin (set! r14 6) (false)) (set! r14 30) (set! r14 30))
      (set! rsi r14)
      (set! rdi r15)
      (set! r15 fv0)
...
(check-by-interp
 '(module
    (begin
      (set! r15 r15)
      (if (begin (set! r14 6) (set! r13 1448) (set! r13 6) (false))
        (begin
          (set! r14 1104)
          (set! r13 14)
          (set! r13 64318)
    ...
    (begin
      ...
      (if (begin
            (begin
              ...
              (set! r15 rax))
            (!= r15 6))
        (if (begin (set! r15 14) (true)) (set! fv2 58942) (set! fv2 23102))
        (if (begin (set! r15 6) (false)) (set! fv2 54078) (set! fv2 19774)))
      (if (begin
            (begin
              (begin
                (set! rbp (- rbp 24))
              ...
              (set! r15 rax))
            (!= r15 6))
        (if (begin (set! r15 6) (false)) (set! r15 18478) (set! r15 19246))
        (if (begin (set! r15 14) (true)) (set! r15 26414) (set! r15 18990)))
      (set! rdx r15)
      (set! rsi fv2)
      (set! rdi fv1)
      (set! r15 fv0)
