#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../flatten-program.rkt")
...
(check-by-interp
 '(module
    (define L.__main.9 (begin (set! r15 r15) (set! r14 14) (jump L.tmp.6)))
...
(check-by-interp
 '(module
    (define L.__main.11
      (begin (set! (rbp - 0) r15) (set! r15 14) (jump L.tmp.8)))
    (define L.+.6
      (begin
        (set! r15 r15)
        (set! r13 rdi)
...
(check-by-interp
 '(module
    (define L.__main.22
      (begin (set! (rbp - 0) r15) (set! r15 14) (jump L.tmp.19)))
    (define L.-.10
      (begin
        (set! r15 r15)
        (set! r13 rdi)
