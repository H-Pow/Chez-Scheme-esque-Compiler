...
(check-by-interp
 '(module
    ((locals (tmp-ra.53))
     ...
     (assignment ()))
    (define L.cons.5
      ((locals (tmp.50 tmp.54 tmp.51 tmp.47 tmp.46 tmp-ra.52))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (ascii-char0.1 tmp-ra.51))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void0.1 tmp-ra.54))
     ...
     (assignment ()))
    (define L.cons.5
      ((locals (tmp.51 tmp.55 tmp.52 tmp.48 tmp.47 tmp-ra.53))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (void1.1 boolean0.2 tmp-ra.52))
     (conflicts
...
(check-by-interp
 '(module
    ...
    (define L.cons.5
      ((locals (tmp.52 tmp.56 tmp.53 tmp.49 tmp.48 tmp-ra.54))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (tmp.58 tmp.53 tmp-ra.56))
     (conflicts
     ...
     (assignment ()))
    (define L.cons.6
      ((locals (tmp.51 tmp.57 tmp.52 tmp.48 tmp.47 tmp-ra.54))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (boolean1.1 fixnum0.2 tmp-ra.52))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (boolean1.1 error0.2 tmp-ra.52))
     (conflicts
...
(check-by-interp
 '(module
    ...
    (define L.cons.8
      ((locals (tmp.56 tmp.65 tmp.57 tmp.53 tmp.52 tmp-ra.60))
       (conflicts
    ...
    (define L.fun/error8420.6
      ((locals (oprand1.5 oprand0.6 tmp-ra.63))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (pair2.1 error1.2 ascii-char0.3))
     (conflicts
    ...
    (define L.+.9
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.59 rbp rax)))))
    (define L.cons.8
      ((locals (tmp.53 tmp.68 tmp.58 tmp.50 tmp.49 tmp-ra.60))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (tmp.66 tmp.57 tmp.55 tmp.65 tmp.56))
     (conflicts
    ...
    (define L.empty?.8
      ((locals (tmp-ra.58 tmp.63 tmp.41 tmp.53))
       (conflicts
    ...
    (define L.cons.7
      ((locals (tmp.52 tmp.64 tmp.54 tmp.49 tmp.48 tmp-ra.59))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (boolean2.1 ascii-char1.2 ascii-char0.3))
     (conflicts
    ...
    (define L.pair?.8
      ((locals (tmp-ra.54 tmp.59 tmp.46 tmp.53))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (empty3.1 void2.2 empty0.4))
     (conflicts
    ...
    (define L.cons.9
      ((locals (tmp.54 tmp.62 tmp.55 tmp.51 tmp.50 tmp-ra.56))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (void3.1 pair2.2 void1.3 fixnum0.4 tmp.70))
     (conflicts
    ...
    (define L.*.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.73 rbp rax)))))
    (define L.cons.9
      ((locals (tmp.54 tmp.90 tmp.68 tmp.51 tmp.50 tmp-ra.74))
       (conflicts
...
(check-by-interp
 '(module
    ...
    (define L.pair?.10
      ((locals (tmp-ra.75 tmp.82 tmp.59 tmp.67))
       (conflicts
    ...
    (define L.cons.9
      ((locals (tmp.66 tmp.83 tmp.68 tmp.63 tmp.62 tmp-ra.76))
       (conflicts
    ...
    (define L.fun/ascii-char8512.4
      ((locals (oprand2.1 oprand1.2 oprand0.3 tmp-ra.77))
       (conflicts
    ...
    (define L.fun/ascii-char8510.5
      ((locals (oprand2.4 oprand1.5 oprand0.6 tmp-ra.78))
       (conflicts
    ...
    (define L.fun/ascii-char8511.6
      ((locals (oprand2.7 oprand1.8 oprand0.9 tmp-ra.79))
       (conflicts
    ...
    (define L.fun/boolean8513.7
      ((locals (oprand2.10 oprand1.11 oprand0.12 tmp-ra.80))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (empty3.1 ascii-char2.2 error0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (tmp.57 pair3.1 error2.2 error1.3 pair0.4))
     (conflicts
    ...
    (define L.void?.11
      ((locals (tmp-ra.58 tmp.66 tmp.44 tmp.55))
       (conflicts
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.58 rbp rax)))))
    (define L.cons.10
      ((locals (tmp.54 tmp.67 tmp.56 tmp.51 tmp.50 tmp-ra.59))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (void4.1 fixnum2.3 tmp.73 tmp.75 tmp.72 empty1.4 empty0.5))
     (conflicts
      ((tmp-ra.84
        (void4.1
         pair3.2
    ...
    (define L.*.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.78 rbp rax)))))
    (define L.cons.9
      ((locals (tmp.55 tmp.95 tmp.69 tmp.52 tmp.51 tmp-ra.79))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (fixnum4.1 tmp.73 tmp.75 tmp.72 empty2.3 ascii-char1.4 pair0.5))
     (conflicts
      ((tmp-ra.84
        (fixnum4.1
         tmp.73
...
(check-by-interp
 '(module
    ((locals (empty4.1 void2.3 void1.4 fixnum0.5 tmp.71 tmp.73 tmp.70))
     (conflicts
      ((tmp-ra.81
        (empty4.1
         error3.2
...
(check-by-interp
 '(module
    ((locals (fixnum4.1 tmp.73 tmp.75 tmp.72 void3.2 empty2.3 void1.4 pair0.5))
     (conflicts
      ((tmp-ra.85
        (fixnum4.1
         tmp.73
    ...
    (define L.+.11
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.78 rbp rax)))))
    (define L.cons.10
      ((locals (tmp.55 tmp.96 tmp.69 tmp.52 tmp.51 tmp-ra.79))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (void5.1 empty4.2 ascii-char3.3 ascii-char2.4 error1.5 empty0.6))
     (conflicts
      ((tmp-ra.68
        (void5.1
         empty4.2
...
(check-by-interp
 '(module
    ((locals (void5.1 error4.2 boolean3.3 tmp.59 boolean2.4 tmp.58 void1.5))
     (conflicts
      ((tmp-ra.72
        (void5.1
         error4.2
    ...
    (define L.void?.16
      ((locals (tmp-ra.60 tmp.73 tmp.46 tmp.56))
       (conflicts
    ...
    (define L.boolean?.15
      ((locals (tmp-ra.61 tmp.74 tmp.44 tmp.57))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (pair5.1 empty4.2 empty3.3 ascii-char2.4 error1.5 error0.6))
     (conflicts
      ((tmp-ra.71
    ...
    (define L.cons.17
      ((locals (tmp.56 tmp.72 tmp.57 tmp.53 tmp.52 tmp-ra.58))
       (conflicts
    ...
    ((locals
     ...
     (assignment
      ((tmp-ra.124 fv0)
       ...
       (tmp.75 fv2))))
    (define L.boolean?.15
      ((locals (tmp-ra.113 tmp.125 tmp.44 tmp.56))
       (conflicts
    ...
    (define L.-.18
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 830) (jump tmp-ra.89 rbp rax)))))
    (define L.vector?.17
      ((locals (tmp-ra.90 tmp.114 tmp.50 tmp.70))
       (conflicts
...
(check-by-interp
 '(module
    ((locals (error5.1 ascii-char3.3 void2.4 error1.5 ascii-char0.6))
     (conflicts
      ((tmp-ra.68
        (error5.1
         empty4.2
...
(check-by-interp
 '(module
    ((locals (empty5.1 pair4.2 boolean3.3 tmp.59 pair2.4 void1.5 error0.6))
     (conflicts
      ((tmp-ra.75
    ...
    (define L.error?.19
      ((locals (tmp-ra.60 tmp.76 tmp.48 tmp.57))
       (conflicts
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.60 rbp rax)))))
    (define L.cons.18
      ((locals (tmp.56 tmp.77 tmp.58 tmp.53 tmp.52 tmp-ra.61))
       (conflicts
...
(check-by-interp
 '(module
    ((locals
     ...
     (assignment ((tmp-ra.75 fv0))))
    (define L.pair?.19
      ((locals (tmp-ra.60 tmp.76 tmp.49 tmp.57))
       (conflicts
        ((tmp.57 (rbp tmp-ra.60))
