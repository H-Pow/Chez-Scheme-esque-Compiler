...
(module+ test
  ...
  (define-syntax-rule (check-by-interp p)
    (check-equal? (interp-asm-pred-lang-v6/pre-framed p) (interp-asm-pred-lang-v6/framed (allocate-frames p))))
...
(check-by-interp '(module
    ((new-frames ())
     (locals
      (tmp-ra.6 bat.3.5 tmp.8 tmp.7 bat.9.3 bat.9.4 bat.9.1 bat.8.2 tmp.9))
     (call-undead ())
     (undead-out
      ((tmp-ra.6 rbp)
       (((tmp-ra.6 rbp) (tmp-ra.6 rbp))
        ...
        ((tmp-ra.6 rbp)
         ((bat.3.5 tmp-ra.6 rbp) (bat.9.1 tmp-ra.6 rbp))
         ((tmp.8 tmp-ra.6 rbp) (tmp.8 tmp-ra.6 rbp) (bat.9.1 tmp-ra.6 rbp))))
     ...
     (conflicts
      ((tmp-ra.6
        (rax tmp.9 bat.8.2 bat.9.4 tmp.7 bat.9.3 bat.3.5 tmp.8 bat.9.1 rbp))
    ...
    (begin
      (set! tmp-ra.6 r15)
      (if (begin (set! bat.8.2 -1418594624) (false))
        (begin
          (if (begin (set! tmp.7 -1123833745) (> tmp.7 1))
            (set! bat.9.3 1)
            (set! bat.9.3 0))
          (set! bat.9.4 767736686)
          (set! bat.9.1 bat.9.4))
        (if (true)
          (begin (set! bat.3.5 1942655457) (set! bat.9.1 bat.3.5))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.9 (rax tmp.12 foobar.5.7 rbp))
    ...
    (define L.func.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.8 rbp)
         ...
         ((rax foo.7.2 bat.0.1 tmp-ra.8 rbp)
          ((foo.7.2 foobar.9.4 r8 rbp)
           (foobar.9.4 r8 rcx rbp)
           (r8 rcx rdx rbp)
           (r8 rcx rdx rsi rbp)
         ...
         (((tmp.10 foo.7.2 bat.0.1 tmp-ra.8 rbp)
           (foo.7.2 bat.0.1 tmp-ra.8 rbp))
          (((tmp.11 bat.0.1 tmp-ra.8 rbp) (bat.0.1 tmp-ra.8 rbp))
           ((tmp-ra.8 rax rbp) (rax rbp))
           ((tmp-ra.8 rax rbp) (rax rbp)))
          ((bat.0.1 tmp-ra.8 r8 rbp)
           (bat.0.1 tmp-ra.8 r8 rcx rbp)
      ...
      (begin
        ...
        (set! foo.3.6 rax)
        (if (begin (set! tmp.10 0) (!= tmp.10 9223372036854775807))
          (if (begin (set! tmp.11 1346978436) (= tmp.11 bat.0.1))
            (begin (set! rax 0) (jump tmp-ra.8 rbp rax))
            (begin (set! rax bat.0.1) (jump tmp-ra.8 rbp rax)))
          (begin
            (set! r8 foo.7.2)
    ...
    (begin
      (set! tmp-ra.9 r15)
      (if (begin (set! tmp.12 824269768) (< tmp.12 9223372036854775807))
    ...
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.2 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.2 (rax tmp.3 foo.6.1 rbp))
...
(check-by-interp '(module
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.4 rbp)
         (rsi rdx tmp-ra.4 rbp)
         (rdx tmp-ra.4 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.4 (foo.5.1 foobar.9.2 ball.6.3 rbp rdx rsi rdi))
    ...
    (begin
      (set! tmp-ra.5 r15)
      (if (begin (set! tmp.6 1) (= tmp.6 -444572554))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.5 rbp rax))
        (begin (set! rax 0) (jump tmp-ra.5 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.18 tmp-ra.16))
     (call-undead ())
     (undead-out
      ((tmp-ra.16 rbp)
       (((tmp.18 tmp-ra.16 rbp) (tmp-ra.16 rbp))
        ((tmp-ra.16 rax rbp) (rax rbp))
        ((tmp-ra.16 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.18 (rbp tmp-ra.16))
       (tmp-ra.16 (rbp tmp.18 rax))
       (rax (rbp tmp-ra.16))
    ...
    (define L.x.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.14 rbp)
         ...
         ((bat.5.1 ball.4.2 bar.7.4 bat.6.3 tmp-ra.14 rbp)
          ((bat.6.7 ball.4.2 bar.7.4 bat.6.3 tmp-ra.14 rbp)
           ...
           ((bar.7.4 bat.6.3 tmp-ra.14 rbp)
            ((tmp-ra.14 rax rbp) (rax rbp))
            ((tmp-ra.14 rax rbp) (rax rbp))))
          (((rax bar.7.4 bat.6.3 tmp-ra.14 rbp)
            ((bat.6.3 bat.5.1 r8 rbp)
             (bat.6.3 bat.5.1 r8 rcx rbp)
        ...
        ((bat.6.3
         ...
         (tmp-ra.14
          (bat.5.1
           ...
           rax))
         (ball.4.2
          (bat.5.1 rbp tmp-ra.14 bat.6.3 bar.7.4 r8 foobar.9.6 bat.6.7))
      ...
      (begin
        ...
        (if (not (<= bat.6.3 9223372036854775807))
          (begin
            ...
            (if (>= bat.6.3 ball.4.2)
              (begin (set! rax bat.6.3) (jump tmp-ra.14 rbp rax))
              (begin (set! rax bar.7.4) (jump tmp-ra.14 rbp rax))))
          (begin
            (return-point L.rp.3
              (begin
                (set! r8 0)
            ...
            (if (<= bar.7.4 -186024487)
              (begin (set! rax bat.5.8) (jump tmp-ra.14 rbp rax))
              (begin (set! rax bat.6.3) (jump tmp-ra.14 rbp rax)))))))
    (define L.func.1.2
      ((new-frames ())
       (locals
        (tmp-ra.15 bar.8.10 ball.4.9 bar.7.11 foobar.9.12 tmp.17 bat.5.13))
       (undead-out
        ((rdi rsi tmp-ra.15 rbp)
         (rsi bar.8.10 tmp-ra.15 rbp)
         (bar.8.10 tmp-ra.15 rbp)
         (bar.8.10 bar.7.11 tmp-ra.15 rbp)
         (((tmp.17 bar.8.10 bar.7.11 tmp-ra.15 rbp)
           (bar.8.10 bar.7.11 tmp-ra.15 rbp))
      ...
      (begin
        ...
        (if (begin (set! tmp.17 -1133252869) (>= tmp.17 9223372036854775807))
    ...
    (begin
      (set! tmp-ra.16 r15)
      (if (begin (set! tmp.18 1588211020) (>= tmp.18 1))
        (begin (set! rax 9223372036854775807) (jump tmp-ra.16 rbp rax))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.16 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (rdi r15 rbp)))
     (conflicts
      ((tmp-ra.9 (rdi bat.2.6 tmp.11 rbp))
       (tmp.11 (rbp tmp-ra.9))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.7 bat.9.1 tmp.10 bar.1.2))
       (undead-out
        ((rdi tmp-ra.7 rbp)
         (bat.9.1 tmp-ra.7 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.7 (rsi rdx bar.1.2 tmp.10 bat.9.1 rbp rdi))
    ...
    (define L.func.1.2
      ((new-frames ())
       (locals (tmp-ra.8 foobar.8.5 foobar.6.4 bar.1.3))
       (undead-out
        ((rdi rsi rdx tmp-ra.8 rbp)
         (rsi rdx foobar.8.5 tmp-ra.8 rbp)
         (rdx foobar.6.4 foobar.8.5 tmp-ra.8 rbp)
         (foobar.6.4 foobar.8.5 tmp-ra.8 rbp)
         ((foobar.6.4 foobar.8.5 tmp-ra.8 rbp)
          ((foobar.8.5 tmp-ra.8 rdx rbp)
           (tmp-ra.8 rdx rsi rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (bar.1.3 foobar.6.4 foobar.8.5 rbp rdi rsi rdx))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.1 rbp)
       (((tmp.2 tmp-ra.1 rbp) (tmp-ra.1 rbp))
        ((tmp-ra.1 rax rbp) (rax rbp))
        ((tmp-ra.1 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.2 (rbp tmp-ra.1))
       (tmp-ra.1 (rbp tmp.2 rax))
       (rax (rbp tmp-ra.1))
       (rbp (tmp-ra.1 tmp.2 rax))))
     (assignment ()))
    (begin
      (set! tmp-ra.1 r15)
      (if (begin (set! tmp.2 1) (>= tmp.2 -9223372036854775808))
        (begin (set! rax 234292566) (jump tmp-ra.1 rbp rax))
        (begin (set! rax -1579825632) (jump tmp-ra.1 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.8))
     ...
     (undead-out
      ((tmp-ra.8 rbp)
       ...
       (r9 r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.8 (rdi rsi rdx rcx r8 r9 rbp))
    ...
    (define L.x.0.1
      ((new-frames ())
       (locals
        (tmp.9 foo.2.6 tmp-ra.7 foobar.9.4 ball.4.3 bat.3.2 ball.5.5 bar.7.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.7 rbp)
         ...
         (((tmp.9 foobar.9.4 ball.4.3 bat.3.2 ball.5.5 foo.2.6 tmp-ra.7 rbp)
           (foobar.9.4 ball.4.3 bat.3.2 ball.5.5 foo.2.6 tmp-ra.7 rbp))
          ((foo.2.6 tmp-ra.7 r9 rbp)
           (foo.2.6 tmp-ra.7 r9 r8 rbp)
      ...
      (begin
        ...
        (set! bar.7.1 r9)
        (if (not
             (not (begin (set! tmp.9 9223372036854775807) (= tmp.9 foo.2.6))))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.21 rbp)
       ((((tmp-ra.21 rbp)
          (bar.2.15 tmp-ra.21 rbp)
          (tmp-ra.21 rbp)
          (bat.0.14 tmp-ra.21 rbp))
         ((bat.0.14 tmp-ra.21 rbp)
          ((bat.0.14 tmp-ra.21 rbp)
           ((bat.0.14 tmp.27 tmp-ra.21 rbp) (tmp-ra.21 rbp))
           (tmp-ra.21 rbp))
          ((bat.0.14 tmp-ra.21 rbp)
           (tmp-ra.21 rbp)
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.18 rbp)
         (rsi ball.9.2 tmp-ra.18 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.18 (rax tmp.22 foobar.4.3 bat.0.1 ball.9.2 rbp rsi rdi))
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (undead-out
        ((tmp-ra.19 rbp)
         (((tmp.23 tmp-ra.19 rbp) (tmp-ra.19 rbp))
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax -1098447432) (jump tmp-ra.19 rbp rax))
          (begin
            (set! tmp.24 -9223372036854775808)
            (set! tmp.24 (+ tmp.24 -9223372036854775808))
            (set! ball.9.4 tmp.24)
            (if (begin (set! tmp.25 857729561) (< tmp.25 9223372036854775807))
              (begin (set! rax 9223372036854775807) (jump tmp-ra.19 rbp rax))
      ...
      ((new-frames ())
        ...
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.20 rbp)
         ...
         ((bat.3.6 bat.5.11 foobar.4.8 bat.0.10 tmp-ra.20 rbp)
          ...
          ((bat.5.11 bat.3.6 foobar.4.8 tmp-ra.20 rbp)
           ((foobar.4.8 tmp.26 tmp-ra.20 rbp)
       ...
       (conflicts
        ((tmp-ra.20
         ...
         (fv0
          (bat.3.6 bar.7.7 foobar.4.8 ball.9.9 bat.0.10 bat.5.11 tmp-ra.20))))
       (assignment ()))
      (begin
        (set! tmp-ra.20 r15)
        (set! bat.5.11 rdi)
      ...
      (if (begin
            ...
            (if (true)
              (if (= bat.0.14 bat.0.14)
                (begin (set! tmp.27 -1195644570) (>= tmp.27 bat.0.14))
                (= bat.0.14 bat.0.14))
              (if (> bat.0.14 bat.0.14)
                (>= bat.0.14 bat.0.14)
                (begin (set! tmp.28 0) (= tmp.28 bat.0.14)))))
        (begin
          (set! fv0 0)
          (set! r9 9223372036854775807)
          (set! r8 -2036437657)
...
(check-by-interp '(module
    ((new-frames ())
     (locals
      (bat.4.1 tmp.9 tmp-ra.5 ball.6.4 bar.3.3 tmp.8 tmp.7 bar.5.2 tmp.6))
     (call-undead ())
     (undead-out
      ((tmp-ra.5 rbp)
       (((tmp.6 tmp-ra.5 rbp) (tmp-ra.5 rbp))
        ...
        ((tmp-ra.5 rbp)
         ...
         (bat.4.1 tmp-ra.5 rbp)))
       ((bat.4.1 tmp-ra.5 rbp)
        (((ball.6.4 bat.4.1 tmp-ra.5 rbp) (bat.4.1 tmp-ra.5 rbp))
         ((bat.4.1 tmp-ra.5 rbp)
          ((tmp-ra.5 rax rbp) (rax rbp))
          ((tmp-ra.5 rax rbp) (rax rbp)))
     ...
     (conflicts
      ((bat.4.1 (rbp tmp-ra.5 ball.6.4 tmp.9))
       ...
       (tmp-ra.5
        (tmp.6 tmp.7 bar.5.2 tmp.8 bar.3.3 bat.4.1 rbp ball.6.4 tmp.9 rax))
    ...
    (begin
      ...
      (if (begin
        ...
        (begin
          (if (begin (set! tmp.7 1) (!= tmp.7 9223372036854775807))
        ...
        (begin
          ...
          (set! bat.4.1 tmp.8)))
      (if (not (> bat.4.1 1))
        (if (begin (set! ball.6.4 -9223372036854775808) (>= ball.6.4 ball.6.4))
          (if (> bat.4.1 491128034)
            (begin (set! rax bat.4.1) (jump tmp-ra.5 rbp rax))
            (begin (set! rax 1) (jump tmp-ra.5 rbp rax)))
          (if (begin (set! tmp.9 1050399943) (= tmp.9 bat.4.1))
            (begin (set! rax -1604958676) (jump tmp-ra.5 rbp rax))
            (begin (set! rax bat.4.1) (jump tmp-ra.5 rbp rax))))
        (begin (set! rax bat.4.1) (jump tmp-ra.5 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (fv0 r9 r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.9 (rdi rsi rdx rcx r8 r9 fv0 rbp))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.8
         ...
         bat.8.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.8 rbp)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.21 rbp)
       ((tmp-ra.21 rbp)
        ((tmp-ra.21 rbp) (tmp-ra.21 rax rbp) (rax rbp))
        ((tmp-ra.21 fv0 rbp)
         (tmp-ra.21 fv0 r9 rbp)
         (tmp-ra.21 fv0 r9 r8 rbp)
         (tmp-ra.21 fv0 r9 r8 rcx rbp)
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.18 rbp)
         (rsi rdx rcx tmp-ra.18 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.18 (r8 bar.0.1 foo.6.2 bat.5.3 foo.8.4 rbp rcx rdx rsi rdi))
         ...
         (rcx
          (r15 rdi rsi rdx rbp r8 bar.0.1 foo.6.2 bat.5.3 foo.8.4 tmp-ra.18))
         (rbp
          (r15 rdi rsi rdx rcx r8 bar.0.1 foo.6.2 bat.5.3 foo.8.4 tmp-ra.18))
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.19 rbp)
       ...
       (conflicts
        ((tmp-ra.19
         ...
         (rdx
          (r15 rdi rsi rbp rcx r8 r9 fv0 bar.0.7 foo.8.8 bat.3.9 tmp-ra.19))
         (rcx
          (r15 rdi rsi rdx rbp r8 r9 fv0 bar.0.7 foo.8.8 bat.3.9 tmp-ra.19))
         (r8
          (r15
           rdi
           rsi
         ...
         (fv0
          (r15
           ...
           bat.4.5))
         (r9
          (r15 rdi rsi rdx rcx r8 rbp fv0 tmp-ra.19 bar.0.7 foo.8.8 foo.9.6))
         (r15 (rbp rdi rsi rdx rcx r8 r9 fv0))))
       (assignment ()))
      (begin
        (set! tmp-ra.19 r15)
      ...
      ((new-frames ())
       ...
       (conflicts
        ((tmp-ra.20
         ...
         (bat.5.14
          (foo.6.10 foo.2.11 foo.8.12 bat.4.13 rbp tmp-ra.20 fv0 r9 r8 rcx))
         ...
         (fv0
          (foo.2.11 foo.8.12 bat.4.13 bat.5.14 bat.3.15 foo.7.16 tmp-ra.20))
         (rbp
          (rax
           foo.6.10
           foo.2.11
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.19 rbp) (tmp-ra.19 rbp) (tmp-ra.19 rax rbp) (rax rbp)))
     (conflicts
      ((tmp-ra.19 (rax ball.1.15 rbp))
       (ball.1.15 (rbp tmp-ra.19))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.16
         ...
         ball.5.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.16 rbp)
    ...
    (define L.func.1.2
      ((new-frames ())
       (locals (tmp-ra.17 ball.1.10 ball.5.9 bar.8.8))
       (undead-out
        ((rdi rsi rdx tmp-ra.17 rbp)
         (rsi rdx tmp-ra.17 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.17 (bar.8.8 ball.5.9 ball.1.10 rbp rdx rsi rdi))
    ...
    (define L.fn.2.3
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.18 rbp)
         (rsi rdx bar.8.13 tmp-ra.18 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.18 (ball.5.14 ball.5.11 ball.0.12 bar.8.13 rbp rdx rsi rdi))
         ...
         (rbp
          (r15 rdi rsi rdx ball.5.14 ball.5.11 ball.0.12 bar.8.13 tmp-ra.18))
         (r15 (rbp rdi rsi rdx))))
       (assignment ()))
      (begin
        (set! tmp-ra.18 r15)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.9 (rdi rsi rdx rcx r8 rbp))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.8 rbp)
         ...
         ((foo.9.5 tmp-ra.8 rbp)
          ((((tmp.10 foo.9.5 tmp-ra.8 rbp) (foo.9.5 tmp-ra.8 rbp))
            (tmp-ra.8 rbp)
            (tmp-ra.8 rbp))
           (tmp-ra.8 rbp)
           (tmp-ra.8 rax rbp)
      ...
      (begin
        ...
        (if (false)
          (begin
            (if (begin (set! tmp.10 -9223372036854775808) (!= tmp.10 0))
              (set! ball.3.6 1)
              (set! ball.3.6 foo.9.5))
            (set! foo.9.7 9223372036854775807)
            (set! rax 9223372036854775807)
            (jump tmp-ra.8 rbp rax))
          (begin (set! rax 1) (jump tmp-ra.8 rbp rax)))))
    (begin
      (set! tmp-ra.9 r15)
      (set! r8 1653803490)
      (set! rcx 1918330809)
...
(check-by-interp '(module
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((foobar.1.3 (rbp tmp-ra.7 bat.6.1 bat.8.2))
      ...
      (begin
        ...
        (set! bat.8.2 rdi)
        (set! bat.6.1 rsi)
        (if (begin (set! foobar.1.3 559317709) (not (= foobar.1.3 bat.8.2)))
          (begin
            (set! rdx -675648818)
            (set! rsi -9223372036854775808)
            (set! rdi bat.6.1)
            (set! r15 tmp-ra.7)
            (jump L.func.1.2 rbp r15 rdi rsi rdx))
          (begin (set! r15 tmp-ra.7) (jump L.tmp.2.3 rbp r15)))))
    (define L.func.1.2
      ((new-frames ())
       (locals (tmp-ra.8 foobar.1.6 foo.0.5 foo.5.4))
       (undead-out
        ((rdi rsi rdx tmp-ra.8 rbp)
         (rsi rdx tmp-ra.8 rbp)
         (rdx tmp-ra.8 rbp)
         (tmp-ra.8 rbp)
         (r15 rbp)
         (r15 rbp)))
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (foo.5.4 foo.0.5 foobar.1.6 rbp rdx rsi rdi))
    ...
    (define L.tmp.2.3
      ((new-frames ())
       ...
       (assignment ()))
      (begin (set! tmp-ra.9 r15) (set! r15 tmp-ra.9) (jump L.tmp.2.3 rbp r15)))
    (begin (set! tmp-ra.10 r15) (set! rax 1) (jump tmp-ra.10 rbp rax)))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.9))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.15 rbp)
       ...
       (rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.15 (rdi rsi rbp))
       (rbp (r15 rdi rsi tmp-ra.15))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.12
         ...
         ball.3.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.12 rbp)
       ...
       (conflicts
        ((tmp-ra.12
         ...
         (fv0
          (bat.9.2 foobar.7.3 foobar.6.4 bat.0.5 ball.1.6 foo.4.7 tmp-ra.12))
         (rbp
          (r15
           rdi
           rsi
    ...
    (define L.x.1.2
       ...
       (undead-out
        ((rdi rsi tmp-ra.13 rbp)
         ...
         ((rax foobar.7.9 bat.9.8 tmp-ra.13 rbp)
          ((bat.9.8 foobar.7.9 nfv.14 rbp)
           (bat.9.8 foobar.7.9 nfv.14 r9 rbp)
        ...
        ((tmp.17 (rbp tmp-ra.13 ball.8.10 bat.9.8))
         ...
         (tmp-ra.13
          (ball.3.11
           ...
           rax))
         (foobar.7.9
          (ball.8.10 rdx r8 r9 nfv.14 rax bat.9.8 rbp tmp-ra.13 rsi))
      ...
      (begin
        ...
        (if (begin (set! tmp.17 -9223372036854775808) (= tmp.17 bat.9.8))
          (begin (set! rax ball.8.10) (jump tmp-ra.13 rbp rax))
          (begin (set! rax -19487548) (jump tmp-ra.13 rbp rax)))))
    (begin
      (set! tmp-ra.15 r15)
      (set! rsi 169577204)
      (set! rdi 1130382988)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.17 rbp)
       ((((tmp.19 tmp-ra.17 rbp) (tmp.19 tmp-ra.17 rbp) (tmp-ra.17 rbp))
         (tmp-ra.17 rbp))
        ((tmp-ra.17 rbp)
         ((tmp-ra.17 rbp)
          ((tmp-ra.17 rcx rbp)
           (tmp-ra.17 rcx rdx rbp)
         ...
         (((tmp.20 tmp-ra.17 rbp) (tmp-ra.17 rbp))
          (((tmp.21 tmp-ra.17 rbp) (tmp-ra.17 rbp))
     ...
     (conflicts
      ((foo.6.13 (rbp tmp-ra.17))
       ...
       (tmp-ra.17
        (rbp tmp.19 foo.6.13 bar.1.14 tmp.20 tmp.21 rax rdi rsi rdx rcx r8 r9))
      ...
      ((new-frames ())
       (locals
        (ball.5.3
         ...
         ball.7.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.15 rbp)
         ...
         ((bat.4.2 bar.8.5 ball.5.3 tmp-ra.15 rbp)
          ((tmp.18 ball.5.3 tmp-ra.15 rbp)
           (tmp.18 ball.5.3 tmp-ra.15 rbp)
           (ball.5.3 tmp-ra.15 rbp)
           (ball.5.3 tmp-ra.15 rbp)
           (tmp-ra.15 rax rbp)
           (rax rbp))
          ((bar.8.5 bat.4.2 tmp-ra.15 r9 rbp)
           (bar.8.5 bat.4.2 tmp-ra.15 r9 r8 rbp)
       ...
       (conflicts
        ((ball.5.3
         ...
         (bar.8.5
          (ball.7.1 bat.4.2 ball.5.3 foobar.2.4 rbp tmp-ra.15 r9 rcx rdx r8))
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.16 rbp)
         (rsi rdx rcx tmp-ra.16 rbp)
       ...
       (conflicts
        ((tmp-ra.16
          (ball.5.9 bat.4.10 bar.1.11 foobar.2.12 rbp rcx rdx rsi rdi))
        ...
        (if (true)
          (if (true)
            (begin
              ...
              (set! r15 tmp-ra.17)
              (jump L.func.1.2 rbp r15 rdi rsi rdx rcx))
            (begin (set! bar.1.14 1) (set! rax 1) (jump tmp-ra.17 rbp rax)))
          (if (not
               (begin
            ...
            (if (begin
                  ...
                  (>= tmp.21 -753552692))
              (begin (set! rax 1) (jump tmp-ra.17 rbp rax))
              (begin (set! rax 9223372036854775807) (jump tmp-ra.17 rbp rax)))
            (begin
              (set! r9 -1972468042)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.12 rbp)
       ...
       (r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.12 (rdi rsi rdx rcx r8 rbp))
       (rbp (r15 rdi rsi rdx rcx r8 tmp-ra.12))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.10 rbp)
         (rsi rdx tmp-ra.10 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.10 (rcx r8 bar.4.1 ball.5.2 bar.9.3 rbp rdx rsi rdi))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals
        (tmp-ra.11 ball.8.8 bar.2.7 bar.9.6 bat.0.5 foo.1.4 foo.6.9 tmp.13))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.11 rbp)
         (rsi rdx rcx r8 tmp-ra.11 rbp)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.10 rbp)
       ...
       (rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.10 (rdi rsi rdx rcx rbp))
       (rbp (r15 rdi rsi rdx rcx tmp-ra.10))
    ...
    (define L.x.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (rcx foo.4.1 foo.3.2 bar.1.3 rbp rdx rsi rdi))
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.9 rbp)
         (rsi rdx rcx tmp-ra.9 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (foo.8.4 bar.0.5 foo.3.6 bar.1.7 rbp rcx rdx rsi rdi))
...
(check-by-interp '(module
    ((new-frames (()))
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ((tmp-ra.9 rbp)
        (((((tmp.10 tmp-ra.9 rbp) (tmp-ra.9 rbp))
           ((tmp.11 tmp-ra.9 rbp) (tmp-ra.9 rbp))
           ((tmp.12 tmp-ra.9 rbp) (tmp-ra.9 rbp)))
          (((rax tmp-ra.9 rbp)
            ((rcx rbp)
             (rcx rdx rbp)
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (bar.8.1 ball.5.2 foobar.9.3 bar.4.4 rbp rcx rdx rsi rdi))
         ...
         (rbp
          (r15 rdi rsi rdx rcx bar.8.1 ball.5.2 foobar.9.3 bar.4.4 tmp-ra.8))
         (r15 (rbp rdi rsi rdx rcx))))
       (assignment ()))
      (begin
        (set! tmp-ra.8 r15)
      ...
      (if (false)
        (begin
          (if (if (begin
                    ...
                    (> tmp.10 1428972274))
                (begin (set! tmp.11 0) (!= tmp.11 479631559))
                (begin (set! tmp.12 0) (>= tmp.12 1284385619)))
            (begin
              (return-point L.rp.2
                (begin
                  (set! rcx 1)
          ...
          (if (if (begin (set! tmp.13 0) (<= tmp.13 bar.7.5))
                (!= bar.7.5 2009350954)
                (begin (set! tmp.14 1170635915) (!= tmp.14 bar.7.5)))
            (begin
            ...
            (begin
              ...
              (jump tmp-ra.9 rbp rax))))
        (if (false)
          (begin (set! rax 0) (jump tmp-ra.9 rbp rax))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.4 foo.5.2 foo.5.3 foo.7.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.4 rbp)
       (foo.5.2 tmp-ra.4 rbp)
       (foo.5.3 tmp-ra.4 rbp)
       (foo.7.1 tmp-ra.4 rbp)
       (tmp-ra.4 rax rbp)
       (rax rbp)))
     (conflicts
      ((tmp-ra.4 (rax foo.7.1 foo.5.3 foo.5.2 rbp))
...
(check-by-interp '(module
    ((new-frames (() ()))
      ...
      ((tmp-ra.15 rbp)
       ...
       ((((tmp.20 foobar.3.10 tmp-ra.15 rbp) (foobar.3.10 tmp-ra.15 rbp))
        ...
        (((tmp.22 foobar.3.10 tmp-ra.15 rbp) (foobar.3.10 tmp-ra.15 rbp))
         ((foobar.3.10 tmp.23 tmp-ra.15 rbp)
          (tmp.23 tmp-ra.15 rbp)
          (tmp-ra.15 rax rbp)
          (rax rbp))
         ((bat.8.11 tmp-ra.15 rbp) (tmp-ra.15 rax rbp) (rax rbp)))
        (((rax foobar.3.10 tmp-ra.15 rbp)
          ((rdx rbp)
           (rdx rsi rbp)
           (rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
     ...
     (conflicts
      ((tmp.20 (rbp tmp-ra.15 foobar.3.10))
       (foobar.3.10
        (rbp tmp-ra.15 tmp.20 tmp.21 tmp.22 tmp.23 tmp.24 bat.8.12 rax))
    ...
    (define L.func.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.13 rbp)
         ...
         ((rax bar.2.1 tmp-ra.13 rbp)
          ((ball.4.4 rdx rbp)
           (ball.4.4 rdx rsi rbp)
           (rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp)))
         (bar.2.1 tmp-ra.13 rbp)
      ...
      (begin
        ...
        (set! bat.8.5 rax)
        (if (begin (set! tmp.17 1981945067) (= tmp.17 bar.2.1))
          (begin (set! rax -195961595) (jump tmp-ra.13 rbp rax))
          (begin (set! rax 9223372036854775807) (jump tmp-ra.13 rbp rax)))))
    (define L.fn.1.2
      ((new-frames (()))
       ...
       (conflicts
        ((tmp-ra.14
          (tmp.19 foobar.1.9 rax bar.9.7 foobar.1.8 tmp.18 bat.8.6 rbp rdi))
    ...
    (begin
      ...
      (set! foobar.3.10 rax)
      (if (not
           (if (begin (set! tmp.20 -9223372036854775808) (= tmp.20 649827574))
             (begin (set! tmp.21 -9223372036854775808) (< tmp.21 foobar.3.10))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.20 rbp)
       ...
       (r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.20 (rdi rsi rdx rcx r8 rbp))
       (rbp (r15 rdi rsi rdx rcx r8 tmp-ra.20))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.17 (rdi rsi rdx rcx r8 rbp))
    ...
    (define L.tmp.1.2
        ...
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.18 rbp)
         ...
         (((bar.9.6 foobar.2.1 ball.4.4 foobar.5.2 bar.0.5 tmp-ra.18 rbp)
          ...
          ((foobar.5.2 bar.0.5 tmp-ra.18 rbp)
           (foobar.5.2 bar.0.5 tmp-ra.18 rbp))
          ((foobar.2.1 foobar.5.2 bar.0.5 tmp-ra.18 rbp)
           (foobar.5.2 bar.0.5 tmp-ra.18 rbp)
           (foobar.5.2 bar.0.5 tmp-ra.18 rbp)))
        ...
        ((tmp-ra.18
         ...
         (foobar.5.2
          (r8
           ...
           fv0))
         (foobar.2.1
          (ball.4.9 rbp tmp-ra.18 bar.0.5 foobar.5.2 ball.4.4 bar.9.6 foo.7.7))
         (foo.3.10 (rbp tmp-ra.18 bar.0.5 foobar.5.2))
         (foo.3.8 (rbp tmp-ra.18 bar.0.5 foobar.5.2))
         (ball.4.9
          (rbp tmp-ra.18 bar.0.5 foobar.5.2 ball.4.4 foobar.2.1 bar.9.6))
         (rdi (r15 rbp rsi rdx rcx r8 tmp-ra.18))
      ...
      (begin
        ...
        (set! foobar.5.2 r9)
        (set! foobar.2.1 fv0)
        (if (begin (set! ball.4.9 foo.7.7) (< bar.9.6 0))
          (begin (set! foo.3.10 ball.4.4) (set! foo.3.8 -224488027))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.11 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.11 (rax tmp.15 rbp))
       (tmp.15 (rbp tmp-ra.11))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.9 rbp)
         (rsi rdx tmp-ra.9 rbp)
         (rdx tmp-ra.9 rbp)
         (tmp-ra.9 rbp)
         (tmp.12 tmp-ra.9 rbp)
         (tmp.12 tmp-ra.9 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (rax tmp.12 foobar.8.1 foo.1.2 bat.7.3 rbp rdx rsi rdi))
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.10 rbp)
         ...
         (((bar.3.5 tmp.14 bat.0.4 bat.7.6 foobar.4.8 tmp-ra.10 rbp)
          ...
          ((bat.7.6 foobar.4.8 tmp-ra.10 rbp)
       ...
       (conflicts
        ((tmp.14 (rbp tmp-ra.10 foobar.4.8 bat.7.6 bat.0.4 bar.3.5))
         ...
         (bat.0.4
          (foobar.4.8 tmp.13 rbp tmp-ra.10 bat.7.6 bar.3.5 foobar.9.7 tmp.14))
         (bat.7.6
          (foobar.4.8
           tmp.13
           bat.0.4
           ...
           tmp.14))
         (foobar.9.7
          (tmp.13 bat.0.4 bar.3.5 bat.7.6 rbp tmp-ra.10 rcx rdx rsi))
      ...
      (begin
        ...
        (if (begin (set! tmp.14 9223372036854775807) (> tmp.14 bar.3.5))
          (if (< bat.7.6 bat.0.4)
            (begin (set! rax foobar.4.8) (jump tmp-ra.10 rbp rax))
            (begin (set! rax bat.7.6) (jump tmp-ra.10 rbp rax)))
    ...
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.6 rbp)
       ...
       (rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.6 (rdi rsi rdx rbp))
       (rbp (r15 rdi rsi rdx tmp-ra.6))
      ...
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.5 rbp)
         ...
         ((rax foobar.8.3 foo.9.1 foobar.1.2 tmp-ra.5 rbp)
          ((rdx rbp)
           (rdx rsi rbp)
           (rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
         ...
         (((tmp.7 foobar.8.3 foo.9.1 foobar.1.2 tmp-ra.5 rbp)
           (foobar.8.3 foo.9.1 foobar.1.2 tmp-ra.5 rbp))
          ((foobar.1.2 tmp-ra.5 rdx rbp)
           (tmp-ra.5 rdx rsi rbp)
           (tmp-ra.5 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp))
          ((foobar.8.3 tmp-ra.5 rbp)
           ((tmp-ra.5 rax rbp) (rax rbp))
           ((tmp-ra.5 rax rbp) (rax rbp))))))
       ...
       (conflicts
        ((tmp.7 (rbp tmp-ra.5 foobar.1.2 foo.9.1 foobar.8.3))
         (tmp-ra.5
          (bar.6.4 foo.9.1 foobar.1.2 foobar.8.3 rbp tmp.7 rdi rsi rdx rax))
         (foobar.1.2 (bar.6.4 rax foo.9.1 rbp tmp-ra.5 foobar.8.3 rdx tmp.7))
         (foobar.8.3
          (bar.6.4 rax foo.9.1 foobar.1.2 rbp tmp-ra.5 rdx rsi tmp.7))
         ...
         (r15 (rbp rdi rsi rdx))))
       (assignment
        ((tmp-ra.5 fv0) (foobar.1.2 fv1) (foo.9.1 fv2) (foobar.8.3 fv3))))
      (begin
        (set! tmp-ra.5 r15)
        (set! foobar.8.3 rdi)
        (set! foobar.1.2 rsi)
        ...
        (return-point L.rp.2
          (begin
            ...
            (jump L.func.0.1 rbp r15 rdi rsi rdx)))
        (set! bar.6.4 rax)
        (if (begin (set! tmp.7 9223372036854775807) (= tmp.7 0))
          (begin
            (set! rdx foobar.1.2)
            (set! rsi foobar.1.2)
            (set! rdi 719591632)
          ...
          (if (>= foo.9.1 1396041917)
            (begin (set! rax -1711968134) (jump tmp-ra.5 rbp rax))
            (begin (set! rax foobar.8.3) (jump tmp-ra.5 rbp rax))))))
    (begin
      (set! tmp-ra.6 r15)
      (set! rdx 0)
      (set! rsi 9223372036854775807)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.11 rbp) (tmp-ra.11 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
     (conflicts
      ((tmp-ra.11 (rdi rbp))
       (rbp (r15 rdi tmp-ra.11))
    ...
    (define L.x.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((tmp-ra.8 rbp)
         (((tmp.12 tmp-ra.8 rbp) (tmp-ra.8 rbp))
          (((rax tmp-ra.8 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (tmp-ra.8 rbp)
           (tmp-ra.8 rbp)
           (tmp-ra.8 rax rbp)
           (rax rbp))
      ...
      (begin
        (set! tmp-ra.8 r15)
        (if (begin (set! tmp.12 0) (<= tmp.12 1773437967))
          (begin
            (return-point L.rp.4
              (begin
                (set! rdi 1456910402)
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (bat.1.3 foo.9.4 foobar.3.5 bat.6.6 rbp rcx rdx rsi rdi))
    ...
    (define L.tmp.2.3
      ((new-frames ())
       ...
       (undead-out
        ((rdi tmp-ra.10 rbp)
         (bat.1.7 tmp-ra.10 rbp)
         (tmp-ra.10 rax rbp)
         (rax rbp)))
       (call-undead ())
       (conflicts
        ((tmp-ra.10 (rax bat.1.7 rbp rdi))
         (bat.1.7 (rbp tmp-ra.10))
         (rdi (tmp-ra.10))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.18 bat.0.14 tmp.22 foo.6.15 foo.5.13))
     (call-undead ())
     (undead-out
      ((tmp-ra.18 rbp)
       (((tmp.22 tmp-ra.18 rbp) (tmp-ra.18 rbp))
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.18 (rax foo.5.13 foo.6.15 tmp.22 bat.0.14 rbp))
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.16 rbp)
         (rsi foobar.4.2 tmp-ra.16 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.16 (bat.1.3 tmp.19 foo.5.4 foo.5.1 foobar.4.2 rbp rsi rdi))
         ...
         (rbp
          (r15 rdi rsi bat.1.3 tmp.19 foo.5.4 foo.5.1 foobar.4.2 tmp-ra.16))
         (r15 (rbp rdi rsi))))
       (assignment ()))
      (begin
        (set! tmp-ra.16 r15)
      ...
      ((new-frames ())
       (locals
        (bat.0.9
         ...
         bat.1.6))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.17 rbp)
         ...
         (((foo.2.8 bat.1.6 bat.9.5 bat.0.9 foobar.4.7 tmp-ra.17 rbp)
           ...
           ((foo.2.8 bat.1.6 bat.9.5 bat.0.9 foobar.4.7 tmp-ra.17 rbp)
            ((tmp.20 foo.2.8 bat.1.6 bat.9.5 bat.0.9 foobar.4.7 tmp-ra.17 rbp)
             (foo.2.8 bat.1.6 bat.9.5 bat.0.9 foobar.4.7 tmp-ra.17 rbp))))
          ((((bat.0.9 tmp.21 foobar.4.7 tmp-ra.17 rbp)
          ...
          (((bat.1.6 bat.0.9 foobar.4.7 foo.2.8 tmp-ra.17 rbp)
           ...
           ((foo.2.8 tmp-ra.17 rbp)
            ((tmp-ra.17 rax rbp) (rax rbp))
            ((tmp-ra.17 rax rbp) (rax rbp)))
           ((bat.0.9 tmp-ra.17 rsi rbp)
            (tmp-ra.17 rsi rdi rbp)
            (rsi rdi r15 rbp)
            (rsi rdi r15 rbp))))))
       (call-undead ())
       (conflicts
        ((bat.0.9
          (bat.9.5
           ...
           rsi))
         (bat.9.5
          (rbp tmp-ra.17 foobar.4.7 bat.0.9 bat.1.6 foo.2.8 bar.7.10 tmp.20))
      ...
      (begin
        ...
        (if (if (true)
              ...
              (begin
                ...
                (begin (set! tmp.20 0) (<= tmp.20 -508327908))))
          (begin
            (if (begin (set! tmp.21 167876306) (<= tmp.21 bat.0.9))
          ...
          (if (begin (set! foobar.3.12 bat.9.5) (= bat.1.6 0))
            (if (< foobar.4.7 foobar.4.7)
              (begin (set! rax foo.2.8) (jump tmp-ra.17 rbp rax))
              (begin (set! rax -727094500) (jump tmp-ra.17 rbp rax)))
            (begin
              (set! rsi -9223372036854775808)
              (set! rdi bat.0.9)
              (set! r15 tmp-ra.17)
    ...
    (begin
      (set! tmp-ra.18 r15)
      (if (begin (set! tmp.22 9223372036854775807) (<= tmp.22 0))
        (set! bat.0.14 0)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.6 rbp)
       ...
       (((bar.7.1 tmp-ra.6 rbp)
         ((tmp.7 bar.7.1 tmp-ra.6 rbp) (bar.7.1 tmp-ra.6 rbp)))
        ((tmp-ra.6 rax rbp) (rax rbp))
        ((tmp-ra.6 rbp) (tmp-ra.6 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.7 (rbp tmp-ra.6 bar.7.1))
    ...
    (begin
      ...
      (if (begin
            (set! foo.0.4 bar.7.1)
            (begin (set! tmp.7 1) (<= tmp.7 -9223372036854775808)))
        (begin (set! rax bar.7.1) (jump tmp-ra.6 rbp rax))
        (begin
...
(check-by-interp '(module
    ...
    (define L.x.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.6 rbp)
         (rsi rdx foobar.5.3 tmp-ra.6 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.6 (foobar.6.1 foo.8.2 foobar.5.3 rbp rdx rsi rdi))
      ...
      (if (begin
            (begin
              (return-point L.rp.2
                (begin
                  ...
                  (jump L.x.0.1 rbp r15 rdi rsi rdx)))
              (set! ball.3.4 rax))
            (begin (set! tmp.8 9223372036854775807) (< tmp.8 ball.3.4)))
        (begin
          (set! rdx 1)
          (set! rsi -9223372036854775808)
          (set! rdi 1)
        ...
        (begin
          ...
          (if (= foobar.6.5 foobar.6.5)
            (begin (set! rax 9223372036854775807) (jump tmp-ra.7 rbp rax))
            (begin (set! rax 9223372036854775807) (jump tmp-ra.7 rbp rax)))))))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.12 rbp) (tmp-ra.12 rbp) (tmp-ra.12 rax rbp) (rax rbp)))
     (conflicts
      ((tmp-ra.12 (rax foo.1.10 rbp))
       (foo.1.10 (rbp tmp-ra.12))
      ...
      ((new-frames ())
       (locals
        (foo.1.8
         ...
         bat.6.7))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.11 rbp)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.8 rbp)
       ...
       ((foo.5.5 tmp-ra.8 rbp)
        (((foo.5.5 tmp-ra.8 rbp) (tmp-ra.8 rbp) (tmp-ra.8 rbp))
         (tmp-ra.8 rax rbp)
         (rax rbp))
        ((tmp.10 tmp-ra.8 rbp)
         (tmp.10 tmp-ra.8 rbp)
         ...
         (rax rbp)))))
     (conflicts
      ((foo.5.5 (rbp tmp-ra.8))
       (foobar.4.6 (rbp tmp-ra.8))
    ...
    (define L.func.0.1
      ((new-frames ())
        ...
        ((rdi rsi rdx tmp-ra.7 rbp)
         ...
         ((((tmp.9 ball.0.1 ball.2.3 foo.5.2 tmp-ra.7 rbp)
           ...
           ((ball.2.3 foo.5.2 tmp-ra.7 rbp)
            (ball.2.3 foo.5.2 tmp-ra.7 rbp)
            (ball.2.3 foo.5.2 tmp-ra.7 rbp)))
          ((foo.5.2 tmp-ra.7 rdx rbp)
           (foo.5.2 tmp-ra.7 rdx rsi rbp)
           (tmp-ra.7 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp))
       ...
       (conflicts
        ((tmp.9 (rbp tmp-ra.7 foo.5.2 ball.2.3 ball.0.1))
         ...
         (tmp-ra.7
          (ball.0.1 foo.5.2 ball.2.3 rbp tmp.9 rax foo.5.4 rdi rsi rdx))
      ...
      (begin
        ...
        (set! foo.5.2 rsi)
        (set! ball.0.1 rdx)
        (if (if (begin (set! tmp.9 0) (= tmp.9 ball.2.3))
              (false)
...
(check-by-interp '(module
    ((new-frames (()))
     ...
     (undead-out
      ((tmp-ra.8 rbp)
       ((((tmp.9 tmp-ra.8 rbp) (tmp-ra.8 rbp))
         ((tmp.10 tmp-ra.8 rbp) (tmp-ra.8 rbp))
       ...
       (((foo.2.6 tmp-ra.8 rbp)
        ...
        ((foo.2.6 tmp-ra.8 rdx rbp)
         (foo.2.6 tmp-ra.8 rdx rsi rbp)
         (tmp-ra.8 rdx rsi rdi rbp)
         (rdx rsi rdi r15 rbp)
         (rdx rsi rdi r15 rbp))
        ((tmp-ra.8 rdx rbp)
     ...
     (conflicts
      ((foo.2.6 (rbp tmp-ra.8 tmp.13 rdx))
       ...
       (tmp-ra.8
        (tmp.9 tmp.10 tmp.11 rax tmp.12 foo.2.6 rbp tmp.13 rdi rsi rdx))
       (tmp.12 (rbp tmp-ra.8))
       (tmp.11 (rbp tmp-ra.8))
       (tmp.10 (rbp tmp-ra.8))
       (tmp.9 (rbp tmp-ra.8))
    ...
    (define L.tmp.0.1
      ((new-frames (()))
       ...
       (conflicts
        ((tmp-ra.7
          (ball.4.4 rax foo.6.5 foo.2.1 ball.3.2 foo.8.3 rbp rdx rsi rdi))
    ...
    (begin
      (set! tmp-ra.8 r15)
      (if (if (begin (set! tmp.9 1) (!= tmp.9 0))
            (begin
              (set! tmp.10 -9223372036854775808)
              (<= tmp.10 9223372036854775807))
            (begin (set! tmp.11 0) (= tmp.11 0)))
        (begin
          (return-point L.rp.3
            (begin
              (set! rdx 1)
      ...
      (if (if (!= foo.2.6 foo.2.6)
            (< foo.2.6 foo.2.6)
            (begin (set! tmp.13 -1823864705) (= tmp.13 -2078605817)))
        (begin
          (set! rdx 1739531838)
          (set! rsi foo.2.6)
          (set! rdi foo.2.6)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.12 rbp) (bat.1.8 tmp-ra.12 rbp) (tmp-ra.12 rax rbp) (rax rbp)))
     (conflicts
      ((tmp-ra.12 (rax bat.1.8 rbp))
       (bat.1.8 (rbp tmp-ra.12))
       (rbp (rax bat.1.8 tmp-ra.12))
       (rax (rbp tmp-ra.12))))
     (assignment ()))
    (define L.tmp.0.1
      ((new-frames ())
       (locals (tmp-ra.9 bar.0.3 bar.4.2 bar.9.1))
       (undead-out
        ((rdi rsi rdx tmp-ra.9 rbp)
         (rsi rdx tmp-ra.9 rbp)
         (rdx tmp-ra.9 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (bar.9.1 bar.4.2 bar.0.3 rbp rdx rsi rdi))
    ...
    (define L.fn.1.2
      ((new-frames ())
       (locals (tmp.13 tmp-ra.10 bar.9.4 tmp.14))
       (undead-out
        ((rdi tmp-ra.10 rbp)
         (bar.9.4 tmp-ra.10 rbp)
         (((tmp.13 bar.9.4 tmp-ra.10 rbp) (bar.9.4 tmp-ra.10 rbp))
          ((bar.9.4 tmp-ra.10 rdx rbp)
           (bar.9.4 tmp-ra.10 rdx rsi rbp)
           (tmp-ra.10 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp))
          (((bar.9.4 tmp-ra.10 rbp)
            (bar.9.4 tmp-ra.10 rbp)
            ((tmp.14 bar.9.4 tmp-ra.10 rbp) (bar.9.4 tmp-ra.10 rbp)))
           ((bar.9.4 tmp-ra.10 rdx rbp)
            (tmp-ra.10 rdx rsi rbp)
            (tmp-ra.10 rdx rsi rdi rbp)
            (rdx rsi rdi r15 rbp)
            (rdx rsi rdi r15 rbp))
           ((tmp-ra.10 rax rbp) (rax rbp))))))
      ...
      (begin
        (set! tmp-ra.10 r15)
        (set! bar.9.4 rdi)
        (if (begin (set! tmp.13 1) (> tmp.13 1))
          (begin
            (set! rdx -9223372036854775808)
            (set! rsi -9223372036854775808)
            (set! rdi bar.9.4)
          ...
          (if (if (> bar.9.4 9223372036854775807)
                (<= bar.9.4 2069349298)
                (begin (set! tmp.14 327435684) (= tmp.14 bar.9.4)))
            (begin
              (set! rdx bar.9.4)
              (set! rsi bar.9.4)
              (set! rdi 937688474)
    ...
    (define L.x.2.3
      ((new-frames ())
       (locals (tmp-ra.11 foobar.6.7 ball.8.6 bar.4.5))
       (undead-out
        ((rdi rsi rdx tmp-ra.11 rbp)
         (rsi rdx foobar.6.7 tmp-ra.11 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.11 (bar.4.5 ball.8.6 foobar.6.7 rbp rdx rsi rdi))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.21 tmp.24 ball.3.17))
     (call-undead ())
     (undead-out
      ((tmp-ra.21 rbp)
       ...
       (r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.21 (rdi rsi rdx rcx r8 ball.3.17 tmp.24 rbp))
        ...
        ((rdi rsi rdx rcx r8 tmp-ra.18 rbp)
         ...
         ((foobar.6.3 foobar.4.5 bat.1.1 tmp-ra.18 rbp)
          (((foobar.6.3 foobar.4.5 bat.1.1 tmp-ra.18 rbp)
           ...
           ((tmp-ra.18 rsi rbp)
            (tmp-ra.18 rsi rdi rbp)
            (rsi rdi r15 rbp)
            (rsi rdi r15 rbp))
           ((foobar.4.5 tmp-ra.18 rbp) (tmp-ra.18 rax rbp) (rax rbp)))
          ((foobar.4.5 tmp-ra.18 rbp)
           (((tmp.23 tmp-ra.18 rbp) (tmp-ra.18 rbp))
            ((tmp-ra.18 rax rbp) (rax rbp))
            ((tmp-ra.18 rax rbp) (rax rbp)))
           ((tmp-ra.18 rax rbp) (rax rbp))))))
       (call-undead ())
       (conflicts
        ((bat.1.1 (rbp tmp-ra.18 foobar.4.5 foobar.6.3 bar.9.6 tmp.22))
      ...
      (begin
        ...
        (if (false)
          (if (begin
                ...
                (begin (set! tmp.22 0) (< tmp.22 foobar.6.3)))
            (begin
              (set! rsi -9223372036854775808)
              (set! rdi 0)
              (set! r15 tmp-ra.18)
            ...
            (begin
              ...
              (jump tmp-ra.18 rbp rax)))
          (if (true)
            (if (begin (set! tmp.23 -9223372036854775808) (!= tmp.23 1))
              (begin (set! rax 0) (jump tmp-ra.18 rbp rax))
              (begin (set! rax 849007740) (jump tmp-ra.18 rbp rax)))
            (begin (set! rax foobar.4.5) (jump tmp-ra.18 rbp rax))))))
    (define L.x.1.2
      ((new-frames ())
       (locals (tmp-ra.19 foobar.6.9 bar.0.8 foobar.4.10))
       (undead-out
        ((rdi rsi tmp-ra.19 rbp)
         (rsi foobar.6.9 tmp-ra.19 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.19 (rdx rcx r8 foobar.4.10 bar.0.8 foobar.6.9 rbp rsi rdi))
         ...
         (rbp
          (r15 rdi rsi rdx rcx r8 foobar.4.10 bar.0.8 foobar.6.9 tmp-ra.19))
    ...
    (define L.x.2.3
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.20 rbp)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.9 (rdi rsi rbp))
       (rbp (r15 rdi rsi tmp-ra.9))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       (locals (tmp-ra.7 bat.8.2 bar.7.1))
       (undead-out
        ((rdi rsi tmp-ra.7 rbp)
         (rsi bat.8.2 tmp-ra.7 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.7 (rdx rcx bar.7.1 bat.8.2 rbp rsi rdi))
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (bat.8.3 bar.9.4 foobar.6.5 bar.3.6 rbp rcx rdx rsi rdi))
...
(check-by-interp '(module
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.7 rbp)
         (rsi rdx rcx r8 tmp-ra.7 rbp)
    ...
    (begin
      ...
      (set! foo.5.6 rax)
      (if (begin (set! tmp.9 -9223372036854775808) (= tmp.9 175566669))
        (begin (set! rax -1855219983) (jump tmp-ra.8 rbp rax))
        (begin (set! rax foo.5.6) (jump tmp-ra.8 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames (()))
     ...
     (undead-out
      ((tmp-ra.14 rbp)
       ((tmp-ra.14 rbp)
        (((rax tmp-ra.14 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
         (bat.3.8 tmp-ra.14 rbp)
         (tmp-ra.14 rbp)
         (tmp-ra.14 rax rbp)
         (rax rbp))
        ((bar.5.10 tmp-ra.14 rbp)
         (tmp-ra.14 rdi rbp)
         (rdi r15 rbp)
         (rdi r15 rbp)))))
     (conflicts
      ((bar.7.9 (rbp tmp-ra.14))
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi tmp-ra.11 rbp)
         ...
         (((ball.1.1 tmp-ra.11 rbp)
           ((tmp.15 ball.1.1 tmp-ra.11 rbp) (ball.1.1 tmp-ra.11 rbp)))
          ((tmp.16 tmp-ra.11 rbp)
           (tmp.16 tmp-ra.11 rbp)
           (bar.2.2 tmp-ra.11 rbp))
      ...
      (begin
        ...
        (if (begin
              ...
              (begin (set! tmp.15 9223372036854775807) (= tmp.15 -194099637)))
          (begin
            (set! tmp.16 ball.1.1)
            (set! tmp.16 (- tmp.16 -1702731989))
            (set! bar.2.2 tmp.16))
          (begin (set! bar.2.4 ball.1.1) (set! bar.2.2 ball.1.1)))
        (if (not (begin (set! tmp.17 -9223372036854775808) (= tmp.17 bar.2.2)))
          (begin (set! bar.6.5 1) (set! rax bar.2.2) (jump tmp-ra.11 rbp rax))
          (begin
            (set! rdi 0)
            (set! r15 tmp-ra.11)
            (jump L.proc.0.1 rbp r15 rdi)))))
    (define L.fn.1.2
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.12 (rax tmp.18 rbp))
         (tmp.18 (rbp tmp-ra.12))
    ...
    (define L.fn.2.3
      ((new-frames ())
       (locals (tmp-ra.13 bat.9.6 tmp.19 bar.6.7))
       (undead-out
        ((rdi tmp-ra.13 rbp)
         (tmp-ra.13 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.13 (bar.6.7 tmp.19 bat.9.6 rbp rdi))
    ...
    (begin
      ...
      (if (true)
        (begin
          (return-point L.rp.4
            (begin (set! rdi 1) (set! r15 L.rp.4) (jump L.fn.2.3 rbp r15 rdi)))
          (set! bat.3.8 rax)
          (set! bar.7.9 bat.3.8)
          (set! rax 1)
          (jump tmp-ra.14 rbp rax))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.20 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.20 (rax tmp.26 rbp))
       (tmp.26 (rbp tmp-ra.20))
    ...
    (define L.x.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.17 rbp)
         ...
         ((bat.3.6 foobar.7.2 tmp-ra.17 rbp)
          ((foobar.7.2 tmp.22 tmp-ra.17 rbp)
           (tmp.22 tmp-ra.17 rbp)
           (tmp-ra.17 rax rbp)
           (rax rbp))
          (((bat.3.6 tmp.23 foobar.7.2 tmp-ra.17 rbp)
            (foobar.7.2 tmp-ra.17 rbp))
           ((tmp-ra.17 rax rbp) (rax rbp))
           ((tmp-ra.17 rax rbp) (rax rbp))))))
      ...
      (begin
        ...
        (if (true)
          ...
          (if (begin (set! tmp.23 -9223372036854775808) (!= tmp.23 bat.3.6))
            (begin (set! rax foobar.7.2) (jump tmp-ra.17 rbp rax))
            (begin (set! rax 0) (jump tmp-ra.17 rbp rax))))))
    (define L.fn.1.2
      ((new-frames ())
       (locals
        (tmp.24
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.18 rbp)
         ...
         ((ball.4.9 foo.8.10 foobar.1.11 tmp-ra.18 rbp)
          ((((tmp.24 foobar.1.11 tmp-ra.18 rbp) (foobar.1.11 tmp-ra.18 rbp))
            (tmp-ra.18 rbp)
            (tmp-ra.18 rbp))
           (tmp-ra.18 rax rbp)
           (rax rbp))
          ((foo.8.10 ball.4.9 tmp-ra.18 rbp)
           ((ball.4.9 tmp-ra.18 rbp)
            ((tmp-ra.18 rax rbp) (rax rbp))
            ((tmp-ra.18 rax rbp) (rax rbp)))
           ((tmp-ra.18 rbp) (tmp-ra.18 rax rbp) (rax rbp))))))
       (call-undead ())
       (conflicts
        ((tmp.24 (rbp tmp-ra.18 foobar.1.11))
         (foo.8.13 (rbp tmp-ra.18))
         (foobar.1.11
          (foobar.7.8 ball.4.9 foo.8.10 rbp tmp-ra.18 r8 rcx rdx tmp.24))
         (tmp-ra.18
          (foobar.7.8
           ball.4.9
           foo.8.10
      ...
      (begin
        ...
        (if (false)
          ...
          (if (false)
            (if (= foo.8.10 1)
              (begin (set! rax ball.4.9) (jump tmp-ra.18 rbp rax))
              (begin (set! rax 9223372036854775807) (jump tmp-ra.18 rbp rax)))
            (begin
    ...
    (define L.tmp.2.3
      ((new-frames ())
        ...
        ((tmp-ra.19 rbp)
         ...
         ((((tmp.25 foobar.5.15 tmp-ra.19 rbp) (foobar.5.15 tmp-ra.19 rbp))
          ...
          ((foobar.5.15 tmp-ra.19 rbp)
           ((tmp-ra.19 rax rbp) (rax rbp))
           ((tmp-ra.19 rax rbp) (rax rbp)))
          ((foobar.5.15 tmp-ra.19 r8 rbp)
           (foobar.5.15 tmp-ra.19 r8 rcx rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp.25 (rbp tmp-ra.19 foobar.5.15))
         ...
         (rbp
          (foobar.5.15 foo.8.16 tmp-ra.19 tmp.25 rax r15 rdi rsi rdx rcx r8))
      ...
      (begin
        ...
        (if (if (begin
          ...
          (if (> foobar.5.15 foobar.5.15)
            (begin (set! rax 1) (jump tmp-ra.19 rbp rax))
            (begin (set! rax foobar.5.15) (jump tmp-ra.19 rbp rax)))
          (begin
            (set! r8 9223372036854775807)
            (set! rcx foobar.5.15)
            (set! rdx foobar.5.15)
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.16 ball.3.13 tmp.21))
     (call-undead ())
     (undead-out
      ((tmp-ra.16 rbp)
       (((tmp.21 tmp-ra.16 rbp) (tmp-ra.16 rbp))
       ...
       (r9 r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.16 (rdi rsi rdx rcx r8 r9 tmp.21 ball.3.13 rbp))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals
        (tmp.17
         ...
         bar.0.4))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.14 rbp)
       ...
       (conflicts
        ((tmp.17 (rbp tmp-ra.14 bar.4.6 ball.8.1 foo.7.3 foobar.5.5 ball.3.2))
         (foo.7.3
          (ball.8.1 ball.3.2 rbp tmp-ra.14 bar.4.6 foobar.5.5 tmp.17 r8 r9))
         (ball.8.1
          (rbp
           tmp-ra.14
           bar.4.6
         ...
         (bar.4.6
          (ball.8.1
           ...
           tmp.18))
         (ball.3.2
          (ball.8.1 rbp tmp-ra.14 bar.4.6 foo.7.3 foobar.5.5 tmp.17 r9))
         ...
         (rcx
          (bar.0.4
           ...
           ball.8.1))
         (rdx
          (foobar.5.5 bar.4.6 r15 rdi rsi rbp rcx r8 r9 tmp-ra.14 ball.8.1))
      ...
      (begin
        ...
        (set! ball.8.1 r9)
        (if (not
             (if (begin (set! tmp.17 0) (> tmp.17 701262944))
               (!= foo.7.3 9223372036854775807)
               (< ball.8.1 ball.8.1)))
          (if (true)
            (if (begin (set! tmp.18 1779018832) (= tmp.18 ball.8.1))
              (begin (set! rax -9223372036854775808) (jump tmp-ra.14 rbp rax))
              (begin (set! rax bar.4.6) (jump tmp-ra.14 rbp rax)))
            (begin
              (set! bar.0.7 foo.7.3)
              (set! rax foobar.5.5)
              (jump tmp-ra.14 rbp rax)))
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.15 rbp)
         ...
         (((tmp.19 bar.1.10 ball.8.9 tmp-ra.15 rbp)
           (bar.1.10 ball.8.9 tmp-ra.15 rbp))
          ((tmp.20 bar.1.10 ball.8.9 tmp-ra.15 rbp)
           (tmp.20 bar.1.10 ball.8.9 tmp-ra.15 rbp)
           (bar.1.10 ball.8.9 tmp-ra.15 rbp))
          ((bar.4.12 bar.1.10 ball.8.9 tmp-ra.15 rbp)
           (bar.1.10 ball.8.9 tmp-ra.15 rbp)))
        ...
        ((tmp-ra.15
         ...
         (bar.1.10
          (tmp.19
           ...
           rsi))
         (ball.8.9
          (rsi tmp.19 tmp.20 ball.3.11 foobar.2.8 rbp tmp-ra.15 bar.1.10 rdx))
      ...
      (begin
        ...
        (set! ball.8.9 rsi)
        (set! foobar.2.8 rdx)
        (if (begin (set! tmp.19 -408033154) (<= tmp.19 bar.1.10))
          (begin
            (set! tmp.20 ball.8.9)
            (set! tmp.20 (+ tmp.20 bar.1.10))
            (set! ball.3.11 tmp.20))
          (begin (set! bar.4.12 ball.8.9) (set! ball.3.11 bar.4.12)))
        (set! rdx ball.8.9)
        (set! rsi bar.1.10)
        (set! rdi ball.8.9)
        (set! r15 tmp-ra.15)
    ...
    (begin
      (set! tmp-ra.16 r15)
      (if (begin (set! tmp.21 1) (<= tmp.21 899234556))
        (set! ball.3.13 0)
        (set! ball.3.13 0))
      (set! r9 -9223372036854775808)
      (set! r8 1792291800)
...
(check-by-interp '(module
    ((new-frames ())
     (locals
      (bat.8.9 tmp-ra.15 foo.4.10 bat.9.11 bat.2.13 tmp.18 bat.9.12 tmp.17))
     (call-undead ())
     (undead-out
      ((tmp-ra.15 rbp)
       ((tmp-ra.15 rbp)
        (bat.8.9 tmp-ra.15 rbp)
        ((tmp.17 tmp-ra.15 rbp)
         (tmp.17 tmp-ra.15 rbp)
         (bat.8.9 tmp-ra.15 rbp)))
       ((bat.8.9 tmp-ra.15 rbp)
        ((tmp-ra.15 rbp)
         (foo.4.10 tmp-ra.15 rbp)
         (tmp-ra.15 rcx rbp)
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.14 rbp)
         ...
         (((foo.3.2 foo.0.3 tmp-ra.14 rbp)
           ((tmp.16 foo.3.2 foo.0.3 tmp-ra.14 rbp)
            (foo.3.2 foo.0.3 tmp-ra.14 rbp)))
          ((foo.3.2 foo.0.3 tmp-ra.14 rbp)
         ...
         ((foo.3.2 foo.0.3 ball.7.5 tmp-ra.14 rbp)
          ...
          ((foo.3.2 tmp-ra.14 rcx rbp)
           (foo.3.2 tmp-ra.14 rcx rdx rbp)
        ...
        ((ball.7.5 (rbp tmp-ra.14 foo.0.3 foo.3.8))
         ...
         (tmp-ra.14
          (ball.1.6
           ...
           rcx))
         (foo.3.2
          (ball.1.6 tmp.16 foo.0.7 foo.4.1 rbp tmp-ra.14 foo.0.3 rdx rcx))
      ...
      (begin
        ...
        (if (begin
              ...
              (begin
                ...
                (<= tmp.16 -1549190542)))
          (begin (set! foo.0.7 1) (set! ball.7.5 foo.3.2))
    ...
    (begin
      ...
      (if (= bat.8.9 0)
        (begin
          ...
          (set! r15 tmp-ra.15)
          (jump L.x.0.1 rbp r15 rdi rsi rdx rcx))
        (if (begin (set! bat.9.12 1) (>= bat.8.9 1434817833))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.11 rbp)
       (((tmp.13 tmp-ra.11 rbp) (tmp-ra.11 rbp))
        ((bar.8.9 tmp-ra.11 rbp) (tmp-ra.11 rax rbp) (rax rbp))
        ((tmp-ra.11 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.13 (rbp tmp-ra.11))
       (bar.8.9 (rbp tmp-ra.11))
    ...
    (define L.func.0.1
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.10 rbp)
         ...
         (((tmp.12 ball.0.5 foo.5.3 ball.2.2 foo.9.4 foo.6.6 tmp-ra.10 rbp)
           (ball.0.5 foo.5.3 ball.2.2 foo.9.4 foo.6.6 tmp-ra.10 rbp))
          (((foo.5.3 ball.2.2 foo.9.4 foo.6.6 tmp-ra.10 rbp)
            (foo.9.4 foo.6.6 tmp-ra.10 rbp)
            (foo.9.4 foo.6.6 tmp-ra.10 rbp))
           ((foo.9.4 foo.6.6 tmp-ra.10 fv0 rbp)
            (foo.9.4 foo.6.6 tmp-ra.10 fv0 r9 rbp)
           ...
           ((tmp-ra.10 rbp)
            ((tmp-ra.10 rax rbp) (rax rbp))
            ((tmp-ra.10 rax rbp) (rax rbp))))
          ((foo.6.6 tmp-ra.10 rbp)
           (foo.6.6 tmp-ra.10 fv0 rbp)
        ...
        ((tmp.12 (rbp tmp-ra.10 foo.6.6 foo.9.4 ball.2.2 foo.5.3 ball.0.5))
         ...
         (foo.5.3
          (foo.4.1
           ...
           tmp.12))
         (ball.2.2
          (foo.4.1 rbp tmp-ra.10 foo.6.6 foo.9.4 foo.5.3 ball.0.5 fv0 tmp.12))
         (ball.0.5
          (foo.4.1
           ball.2.2
           foo.5.3
         ...
         (r8
          (ball.0.5
           ...
           tmp-ra.10))
         (rcx
          (ball.0.5 bat.1.7 foo.6.6 r15 rdi rsi rdx rbp r8 r9 fv0 tmp-ra.10))
      ...
      (begin
        ...
        (set! ball.2.2 r9)
        (set! foo.4.1 fv0)
        (if (begin (set! tmp.12 9223372036854775807) (> tmp.12 -1225978347))
          (if (if (> ball.0.5 1)
    ...
    (begin
      (set! tmp-ra.11 r15)
      (if (begin (set! tmp.13 1) (>= tmp.13 9223372036854775807))
        (begin (set! bar.8.9 1) (set! rax bar.8.9) (jump tmp-ra.11 rbp rax))
        (begin (set! rax -32529780) (jump tmp-ra.11 rbp rax)))))
)
    ;;;
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.13 rbp)
       ((((tmp.14 tmp-ra.13 rbp) (tmp-ra.13 rbp))
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.11 (rdi rsi rbp))
         (rbp (r15 rdi rsi tmp-ra.11))
    ...
    (define L.proc.2.3
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.12 rbp)
         (rsi foo.6.9 tmp-ra.12 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.12 (rdx rcx r8 r9 fv0 bat.8.8 foo.6.9 rbp rsi rdi))
    ...
    (begin
      ...
      (if (if (begin
            ...
            (begin (set! tmp.15 692968731) (< tmp.15 0))
            (begin (set! tmp.16 -1490931083) (<= tmp.16 -14809197)))
        (begin (set! rax 1275113131) (jump tmp-ra.13 rbp rax))
        (if (begin (set! tmp.17 -1702177019) (<= tmp.17 -9223372036854775808))
          (begin (set! rax 0) (jump tmp-ra.13 rbp rax))
          (begin (set! rax 1843455920) (jump tmp-ra.13 rbp rax))))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.12 bat.6.10 foobar.4.9 ball.0.8))
     (call-undead ())
     (undead-out
      ((tmp-ra.12 rbp)
       (tmp-ra.12 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.12 (rax ball.0.8 foobar.4.9 bat.6.10 rbp))
    ...
    (define L.fn.0.1
      ((new-frames ())
       (locals
        (tmp-ra.11 bat.5.7 foo.2.6 bar.9.5 foo.8.4 foobar.4.3 bat.3.2 bat.7.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.11 rbp)
       ...
       (conflicts
        ((tmp-ra.11
         ...
         (bat.3.2
          (rsi rdx rcx r8 r9 bat.7.1 rbp tmp-ra.11 bat.5.7 foo.8.4 fv0))
         ...
         (rdx
          (r15 rdi rsi rbp rcx r8 r9 fv0 bat.3.2 foo.2.6 bat.5.7 tmp-ra.11))
         (rcx
          (r15
           rdi
           rsi
...
(check-by-interp '(module
      ...
      ((new-frames (()))
        ...
        ((rdi rsi rdx rcx r8 tmp-ra.11 rbp)
         ...
         ((bar.2.5 foo.9.3 foobar.5.2 foo.6.1 tmp-ra.11 rbp)
          ((foo.9.3 foobar.5.2 foo.6.1 tmp-ra.11 rbp)
           ((rax foo.6.1 tmp-ra.11 rbp)
            ((foobar.5.2 foo.9.3 rdx rbp)
             (foo.9.3 rdx rsi rbp)
             (rdx rsi rdi rbp)
             (rdx rsi rdi r15 rbp)
             (rdx rsi rdi r15 rbp)))
           ...
           (tmp-ra.11 rax rbp)
           (rax rbp))
          ((foobar.5.2 foo.6.1 tmp-ra.11 rdx rbp)
           (foo.6.1 tmp-ra.11 rdx rsi rbp)
           (tmp-ra.11 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp)))))
       ...
       (conflicts
        ((tmp.14 (rbp tmp-ra.11 bat.0.6))
         ...
         (foo.9.3
          (foo.6.1 foobar.5.2 rbp tmp-ra.11 bar.2.5 r8 rcx rsi rdx foo.9.7))
         (foo.9.7 (rbp tmp-ra.11 foo.6.1 foobar.5.2 foo.9.3))
         (bar.2.5
          (foo.6.1 foobar.5.2 foo.9.3 ball.4.4 rbp tmp-ra.11 r8 rcx rdx rsi))
         (tmp-ra.11
          (foo.6.1
           foobar.5.2
           foo.9.3
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.12 rbp)
         ...
         (((tmp.15 foo.6.9 foo.9.8 bat.0.10 tmp-ra.12 rbp)
           (foo.6.9 foo.9.8 bat.0.10 tmp-ra.12 rbp))
          ((foo.9.8 bat.0.10 tmp-ra.12 rbp)
           ((bat.0.10 tmp-ra.12 rbp)
            ((tmp-ra.12 rax rbp) (rax rbp))
            ((tmp-ra.12 rax rbp) (rax rbp)))
           ((foo.9.8 bat.0.10 tmp-ra.12 rdx rbp)
            (bat.0.10 tmp-ra.12 rdx rsi rbp)
            (tmp-ra.12 rdx rsi rdi rbp)
            (rdx rsi rdi r15 rbp)
            (rdx rsi rdi r15 rbp)))
          ((foo.6.9 tmp.16 tmp-ra.12 rbp)
           (tmp.16 tmp-ra.12 rbp)
           (tmp-ra.12 rax rbp)
           (rax rbp)))))
       (call-undead ())
       (conflicts
        ((tmp.15 (rbp tmp-ra.12 bat.0.10 foo.9.8 foo.6.9))
         (foo.9.8 (rbp tmp-ra.12 bat.0.10 foo.6.9 tmp.15))
         (bat.0.10 (foo.9.8 foo.6.9 rbp tmp-ra.12 tmp.15 rsi rdx))
         (tmp-ra.12
          (foo.9.8 foo.6.9 bat.0.10 rbp tmp.15 rdi rsi rdx rax tmp.16))
      ...
      (begin
        ...
        (set! foo.6.9 rsi)
        (set! foo.9.8 rdx)
        (if (begin (set! tmp.15 9223372036854775807) (!= tmp.15 -47909185))
          (if (false)
            (if (< foo.9.8 foo.9.8)
              (begin (set! rax bat.0.10) (jump tmp-ra.12 rbp rax))
              (begin (set! rax -9223372036854775808) (jump tmp-ra.12 rbp rax)))
            (begin
              (set! rdx foo.9.8)
              (set! rsi foo.9.8)
              (set! rdi bat.0.10)
    ...
    (begin
      ...
      (if (begin
        ...
        (begin (set! rax -877748660) (jump tmp-ra.13 rbp rax))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.13 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.13 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.13 (rax bar.7.9 bat.9.10 rbp))
       (bat.9.10 (rbp tmp-ra.13))
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.11 rbp)
         (rsi foo.2.2 tmp-ra.11 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.11 (rdx rcx r8 r9 ball.6.1 foo.2.2 rbp rsi rdi))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals
        (tmp-ra.12 ball.0.8 foo.4.7 foobar.1.6 ball.5.5 foo.2.4 bar.7.3))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.12 rbp)
         (rsi rdx rcx r8 r9 tmp-ra.12 rbp)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.18 rbp)
       ((tmp-ra.18 rbp)
        ((tmp.20 tmp-ra.18 rbp)
         (tmp.20 tmp-ra.18 rbp)
         (tmp-ra.18 rax rbp)
         (rax rbp))
        ((tmp-ra.18 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))))
     (conflicts
      ((tmp.20 (rbp tmp-ra.18))
       (tmp-ra.18 (rbp rax tmp.20 rdi))
    ...
    (define L.func.0.1
      ((new-frames ())
       (locals
        (bar.9.1 tmp-ra.15 bat.0.2 ball.4.4 bat.0.5 bar.9.6 bat.2.3 tmp.19))
       (undead-out
        ((rdi tmp-ra.15 rbp)
       ...
       (conflicts
        ((bar.9.1 (rbp tmp-ra.15 bat.0.2 bat.2.3 tmp.19))
         (tmp-ra.15
          (bar.9.1 rbp rdi bat.0.2 ball.4.4 bat.0.5 bar.9.6 bat.2.3 tmp.19))
    ...
    (define L.tmp.1.2
      ((new-frames ())
       (locals (tmp-ra.16 bat.8.9 bat.3.8 bat.5.7))
       (undead-out
        ((rdi rsi rdx tmp-ra.16 rbp)
         (rsi rdx bat.8.9 tmp-ra.16 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.16 (bat.5.7 bat.3.8 bat.8.9 rbp rdx rsi rdi))
      ...
      ((new-frames (()))
       ...
       (undead-out
        ((rdi tmp-ra.17 rbp)
         ...
         (((bar.9.11 tmp-ra.17 rbp)
           ...
           (bar.9.11 tmp-ra.17 rbp))
          ((bar.9.11 tmp-ra.17 rdx rbp)
           (bar.9.11 tmp-ra.17 rdx rsi rbp)
           (tmp-ra.17 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp))
       ...
       (conflicts
        ((ball.7.12 (rbp tmp-ra.17))
         ...
         (tmp-ra.17
          (bar.9.11 rax bar.9.10 rbp ball.7.12 bat.8.13 foo.1.14 rsi rdx rdi))
...
(check-by-interp '(module
    ...
    (begin
      ...
      (if (begin (set! tmp.2 1) (<= tmp.2 -9223372036854775808))
        (if (false)
          (begin (set! rax -9223372036854775808) (jump tmp-ra.1 rbp rax))
          (begin (set! rax 2012039291) (jump tmp-ra.1 rbp rax)))
        (begin (set! rax 9223372036854775807) (jump tmp-ra.1 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.25))
    ...
    (define L.func.0.1
      ((new-frames ())
       (locals
        (tmp-ra.22 foo.2.6 ball.1.5 foo.4.4 foobar.7.3 foo.5.2 foo.9.1 tmp.26))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.22 rbp)
       ...
       (conflicts
        ((tmp-ra.22
         ...
         (foo.4.4
          (tmp.26 foo.9.1 foo.5.2 foobar.7.3 rbp tmp-ra.22 foo.2.6 r9 r8 rcx))
    ...
    (define L.proc.1.2
      ((new-frames (()))
       (locals
        (tmp.27 foo.6.10 foobar.7.9 foo.2.8 foo.4.13 foobar.7.12 foo.6.11))
       (undead-out
        ((tmp-ra.23 rbp)
         (tmp.27 tmp-ra.23 rbp)
         (tmp.27 tmp-ra.23 rbp)
         (foo.6.7 tmp-ra.23 rbp)
         ((rax foo.6.7 tmp-ra.23 rbp)
          ((foo.6.7 r9 rbp)
           (foo.6.7 r9 r8 rbp)
      ...
      (begin
        ...
        (if (>= foo.6.7 foo.6.7) (set! foo.2.8 foo.6.7) (set! foo.2.8 foo.6.7))
    ...
    (define L.func.2.3
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.24 rbp)
         ...
         (foo.6.14 foo.9.18 bar.0.17 foobar.7.16 tmp-ra.24 rbp)
         (foo.6.14 foo.9.18 bar.0.17 foobar.7.16 tmp-ra.24 rbp)
         ((bar.0.17 foobar.7.16 tmp-ra.24 rbp)
          ((tmp-ra.24 rax rbp) (rax rbp))
          ((tmp-ra.24 rax rbp) (rax rbp)))))
       (call-undead ())
       (conflicts
        ((foo.9.18
          (foo.4.19 foo.9.20 foo.6.21 rbp tmp-ra.24 bar.0.17 foo.6.14))
         (foo.6.14 (foo.4.19 foo.9.18 rbp tmp-ra.24 foobar.7.16 bar.0.17))
         (foobar.7.16
          (foo.9.20 foo.6.21 foo.6.14 foo.4.15 rbp tmp-ra.24 bar.0.17 rcx rdx))
         (tmp-ra.24
          (foo.4.19
           foo.9.20
           foo.6.21
      ...
      (begin
        ...
        (if (>= foo.9.18 foo.6.14)
          (begin (set! rax foobar.7.16) (jump tmp-ra.24 rbp rax))
          (begin (set! rax bar.0.17) (jump tmp-ra.24 rbp rax)))))
    (begin
      (set! tmp-ra.25 r15)
      (set! rcx 9223372036854775807)
      (set! rdx -1735352110)
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.22 tmp-ra.19))
     (call-undead ())
     (undead-out
      ((tmp-ra.19 rbp)
       (((tmp.22 tmp-ra.19 rbp) (tmp-ra.19 rbp))
        ((tmp-ra.19 rax rbp) (rax rbp))
        ((tmp-ra.19 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.22 (rbp tmp-ra.19))
       (tmp-ra.19 (rbp tmp.22 rax))
       (rax (rbp tmp-ra.19))
    ...
    (define L.x.0.1
      ((new-frames ((nfv.17)))
       (locals
        (tmp.20 ball.1.8 tmp.21 bat.9.7 ball.1.5 bar.0.2 foobar.8.1 nfv.17))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.16 rbp)
         ...
         (((tmp.20 foo.2.4 foobar.7.6 ball.6.3 ball.1.8 tmp-ra.16 rbp)
           (foo.2.4 foobar.7.6 ball.6.3 ball.1.8 tmp-ra.16 rbp))
          ((ball.1.8 tmp.21 tmp-ra.16 rbp)
           (tmp.21 tmp-ra.16 rbp)
           (tmp-ra.16 rax rbp)
           (rax rbp))
          ((foobar.7.6 foo.2.4 tmp-ra.16 rbp)
           ((tmp-ra.16 rax rbp) (rax rbp))
           ((tmp-ra.16 rax rbp) (rax rbp))))))
       ...
       (assignment
        ((tmp-ra.16 fv1) (ball.6.3 fv2) (foobar.7.6 fv3) (foo.2.4 fv4))))
      (begin
        (set! tmp-ra.16 r15)
        (set! bat.9.7 rdi)
        (set! foobar.7.6 rsi)
        ...
        (set! ball.1.8 rax)
        (if (not (begin (set! tmp.20 0) (< tmp.20 -9223372036854775808)))
          (begin
            (set! tmp.21 ball.6.3)
          ...
          (if (<= foo.2.4 0)
            (begin (set! rax foo.2.4) (jump tmp-ra.16 rbp rax))
            (begin (set! rax foobar.7.6) (jump tmp-ra.16 rbp rax))))))
    (define L.fn.1.2
      ((new-frames ())
       (locals
        (tmp-ra.18
       ...
       (conflicts
        ((tmp-ra.18
         ...
         (foobar.7.10
          (rdx rcx r9 foobar.8.9 rbp tmp-ra.18 ball.6.12 bar.0.14 fv0))
    ...
    (begin
      (set! tmp-ra.19 r15)
      (if (begin (set! tmp.22 -9223372036854775808) (>= tmp.22 -637253177))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.19 rbp rax))
        (begin (set! rax 0) (jump tmp-ra.19 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.1))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.33 bar.3.27 foo.7.26 foo.0.25))
     (call-undead ())
     (undead-out
      ((tmp-ra.33 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.33 (rax foo.0.25 foo.7.26 bar.3.27 rbp))
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.28 rbp)
    ...
    (define L.tmp.1.2
      ((new-frames ((nfv.31) (nfv.30) ()))
       (locals
        (nfv.30 bat.5.15 bar.3.14 nfv.31 ball.4.12 tmp.34 ball.9.17 bat.8.16))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.29 rbp)
         ...
         ((rax ball.9.8 bat.8.9 foo.0.10 bat.6.11 foo.7.7 tmp-ra.29 rbp)
          ((bat.6.11 foo.7.7 ball.9.8 r8 rbp)
           (bat.6.11 foo.7.7 ball.9.8 r8 rcx rbp)
         ...
         ((rax bat.8.9 foo.0.10 foo.0.13 bat.6.11 foo.7.7 tmp-ra.29 rbp)
          ((bat.8.9 ball.9.8 foo.7.7 foo.0.10 nfv.30 rbp)
           (ball.9.8 foo.7.7 foo.0.10 nfv.30 r9 rbp)
         ...
         ((rax foo.0.13 bat.6.11 foo.7.7 tmp-ra.29 rbp)
          ((foo.0.10 bat.8.9 foo.7.7 bat.6.11 nfv.31 rbp)
           (bat.8.9 foo.7.7 bat.6.11 nfv.31 r9 rbp)
         ...
         (fv0 r9 r8 rcx rdx rsi rdi r15 rbp)))
       (call-undead
        (foo.0.13 ball.9.8 bat.8.9 foo.0.10 bat.6.11 foo.7.7 tmp-ra.29))
       (conflicts
        ((tmp-ra.29
          (r9
           fv0
         ...
         (rbp
          (fv0
           ...
           tmp-ra.29))
         (rax
          (foo.0.13 rbp tmp-ra.29 foo.7.7 bat.6.11 foo.0.10 bat.8.9 ball.9.8))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.32
         ...
         ball.4.18))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.32 rbp)
       ...
       (conflicts
        ((tmp-ra.32
         ...
         (bar.3.20
          (rsi rdx rcx r8 ball.4.18 bat.1.19 rbp tmp-ra.32 foo.0.21 fv0 r9))
         ...
         (rdx
          (r15 rdi rsi rbp rcx r8 r9 fv0 bar.3.20 bat.5.23 foo.2.24 tmp-ra.32))
         (rcx
          (r15
           rdi
           rsi
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (conflicts
      ((tmp-ra.24
        (rdi rsi rdx rcx r8 r9 bat.7.18 tmp.25 bat.8.21 bat.6.19 bar.2.20 rbp))
    ...
    (define L.func.0.1
      ((new-frames (()))
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.22 rbp)
         ...
         (((foo.4.5 bat.3.2 bar.2.3 ball.5.4 bar.1.1 tmp-ra.22 rbp)
           ...
           (((rax bat.3.2 bar.2.3 ball.5.4 bar.1.1 tmp-ra.22 rbp)
             ((foo.4.5 bar.2.3 r8 rbp)
              (foo.4.5 bar.2.3 r8 rcx rbp)
      ...
      ((new-frames ())
       (locals
        (bat.3.10
         ...
         foobar.9.9))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.23 rbp)
         ...
         (((ball.5.12 bat.7.13 bar.0.11 bar.1.14 bat.3.10 tmp-ra.23 rbp)
           ...
           (bat.7.13 bar.0.11 bar.1.14 bat.3.10 tmp-ra.23 rbp))
          ((bar.1.14 bat.3.10 tmp-ra.23 rbp)
           (bar.1.14 bat.3.10 tmp-ra.23 rbp)
           (bat.3.10 tmp-ra.23 rbp)
           (tmp-ra.23 rax rbp)
           (rax rbp))
          ((bat.7.13 bar.0.11 tmp-ra.23 rbp)
        ...
        ((bat.3.10
         ...
         (tmp-ra.23
          (foobar.9.9
           ...
           rax))
         (foobar.9.9
          (rbp tmp-ra.23 bat.3.10 bar.1.14 bar.0.11 bat.7.13 ball.5.12))
         (rax (rbp tmp-ra.23))
         (rbp
          (foobar.9.9
           bat.3.10
      ...
      (begin
        ...
        (if (if (>= bat.3.10 bar.1.14)
          ...
          (if (< bat.3.10 bar.1.14)
            (begin (set! rax bar.0.11) (jump tmp-ra.23 rbp rax))
            (begin (set! rax bat.7.13) (jump tmp-ra.23 rbp rax))))))
    (begin
      (set! tmp-ra.24 r15)
      (set! bar.2.20 405359082)
      (if (not (begin (set! tmp.25 -915730633) (>= tmp.25 0)))
        (begin (set! bat.8.21 -532660031) (set! bat.6.19 -248685178))
        (set! bat.6.19 0))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.23 bar.0.18 foo.8.17))
     (call-undead ())
     (undead-out
      ((tmp-ra.23 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.23 (rax foo.8.17 bar.0.18 rbp))
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.20 rbp)
         (rsi foobar.3.7 tmp-ra.20 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.20 (rdx rcx r8 foo.1.6 foobar.3.7 rbp rsi rdi))
    ...
    (define L.x.2.3
      ((new-frames ((nfv.22)))
        ...
        ((tmp-ra.21
         ...
         (foobar.7.8
          (rsi
           ...
           foo.1.9))
         (nfv.22
          (r15 rdi rsi rdx rcx r8 r9 rbp foo.8.12 bat.6.10 bar.4.11 foo.1.9))
         ...
         (rsi
          (fv0 foobar.7.8 r15 rdi rbp rdx rcx r8 r9 nfv.22 bar.0.14 tmp-ra.21))
         (rdx
          (fv0
           bar.4.11
           r15
       ...
       (assignment
        ((tmp-ra.21 fv1) (foobar.7.8 fv2) (bar.4.11 fv3) (bar.0.14 fv4))))
      (begin
        (set! tmp-ra.21 r15)
        (set! bar.0.14 rdi)
        (set! foobar.9.13 rsi)
...
(check-by-interp '(module
    ((new-frames ())
     (locals
      (bat.2.2 foobar.0.1 bar.8.3 bat.1.4 ball.5.5 tmp.7 tmp.8 tmp-ra.6))
     (call-undead ())
     (undead-out
      ((tmp-ra.6 rbp)
     ...
     (conflicts
      ((bat.2.2 (foobar.0.1 rbp tmp-ra.6))
       ...
       (tmp.8 (rbp tmp-ra.6))
       (tmp-ra.6
        (rbp foobar.0.1 bat.2.2 bar.8.3 bat.1.4 ball.5.5 tmp.7 tmp.8 rax))
       (rax (rbp tmp-ra.6))
       (rbp
        (tmp-ra.6
         foobar.0.1
    ...
    (begin
      ...
      (if (if (begin
            ...
            (begin
              ...
              (<= ball.5.5 ball.5.5))
            (begin (begin (set! tmp.7 -1879829070) (!= tmp.7 1981475003))))
        (begin
          (set! tmp.8 -634246165)
          (set! tmp.8 (- tmp.8 -684848771))
          (set! rax tmp.8)
          (jump tmp-ra.6 rbp rax))
        (begin (set! rax 0) (jump tmp-ra.6 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.10 rbp) (bar.9.7 tmp-ra.10 rbp) (tmp-ra.10 rax rbp) (rax rbp)))
     (conflicts
      ((tmp-ra.10 (rax bar.9.7 rbp))
       (bar.9.7 (rbp tmp-ra.10))
       (rbp (rax bar.9.7 tmp-ra.10))
       (rax (rbp tmp-ra.10))))
     (assignment ()))
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.8 bat.2.3 foo.3.2 bar.6.1))
       (undead-out
        ((rdi rsi rdx tmp-ra.8 rbp)
         (rsi rdx bat.2.3 tmp-ra.8 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (bar.6.1 foo.3.2 bat.2.3 rbp rdx rsi rdi))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.9 foo.3.6 ball.0.5 bat.1.4))
       (undead-out
        ((rdi rsi rdx tmp-ra.9 rbp)
         (rsi rdx tmp-ra.9 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (bat.1.4 ball.0.5 foo.3.6 rbp rdx rsi rdi))
    ...
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.6 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.6 (rax tmp.7 ball.0.1 bar.6.2 foobar.7.3 ball.0.4 bat.2.5 rbp))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.15 ball.9.13 foo.1.12))
     (call-undead ())
     (undead-out
      ((tmp-ra.15 rbp)
       (tmp-ra.15 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.15 (rax foo.1.12 ball.9.13 rbp))
    ...
    (define L.proc.0.1
      ((new-frames (() () () () ()))
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.14 rbp)
         ...
         ((ball.9.5 bar.3.6 bar.6.4 foo.1.1 tmp-ra.14 rbp)
          ((bar.6.4 foo.1.1 tmp-ra.14 rbp)
           ((tmp-ra.14 rax rbp) (rax rbp))
           ((tmp-ra.14 rax rbp) (rax rbp)))
          ((bar.3.6 ball.9.5 tmp-ra.14 rbp)
           (ball.9.5 tmp-ra.14 rbp)
           (tmp-ra.14 rax rbp)
           (rax rbp)))))
       (call-undead
        (bar.3.6 ball.2.9 ball.9.5 bar.6.3 bar.3.2 foo.1.1 tmp-ra.14))
       (conflicts
        ((bar.6.4 (rbp tmp-ra.14 foo.1.1 bar.3.6 ball.9.5))
         ...
         (bar.3.2
          (ball.2.9 ball.9.5 bar.3.6 rax foo.1.1 rbp tmp-ra.14 bar.6.3 rdx))
         (ball.2.9
          (foo.8.7
           rax
           ball.9.8
         ...
         (rbp
          (bar.6.4
           ...
           ball.4.11))
         (rax
          (ball.2.9 ball.9.5 bar.3.6 foo.1.1 bar.3.2 bar.6.3 rbp tmp-ra.14))
         (rdi (r15 rbp rsi rdx tmp-ra.14))
      ...
      (begin
        ...
        (if (> bar.6.4 foo.1.1)
          (if (>= bar.3.6 bar.3.6)
            (begin (set! rax foo.1.1) (jump tmp-ra.14 rbp rax))
            (begin (set! rax bar.6.4) (jump tmp-ra.14 rbp rax)))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.20 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.20 (rax bat.4.16 tmp.23 rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi tmp-ra.17 rbp)
         ...
         ((bar.0.1 tmp-ra.17 rbp)
          ((bar.0.1 tmp-ra.17 rcx rbp)
           (bar.0.1 tmp-ra.17 rcx rdx rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.17 (bar.0.1 rbp rdi rsi rdx rcx))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.18
         ...
         foobar.6.8))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.18 rbp)
    ...
    (define L.func.2.3
      ((new-frames ())
       ...
       (conflicts
        ((tmp-ra.19
          (r8 r9 foobar.6.12 bar.0.13 ball.8.14 ball.9.15 rbp rcx rdx rsi rdi))
         (ball.9.15
          (r8 r9 foobar.6.12 bar.0.13 ball.8.14 rbp tmp-ra.19 rcx rdx rsi))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.3 foobar.1.2 bat.0.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.3 rbp)
       (tmp-ra.3 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.3 (rax bat.0.1 foobar.1.2 rbp))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.9 rbp)
       ...
       (r9 r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.9 (rdi rsi rdx rcx r8 r9 rbp))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.7 (rdi rsi rdx rcx r8 r9 rbp))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals
        (tmp-ra.8 tmp.10 bat.9.1 bat.7.6 bar.2.3 foobar.1.2 bat.3.4 ball.5.5))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.8 rbp)
         ...
         ((bat.3.4 bat.9.1 bat.7.6 foobar.1.2 bar.2.3 tmp-ra.8 rbp)
          (((bat.9.1 bat.7.6 foobar.1.2 bar.2.3 tmp-ra.8 rbp)
            (foobar.1.2 bar.2.3 tmp-ra.8 rbp)
            (foobar.1.2 bar.2.3 tmp-ra.8 rbp))
           ((bar.2.3 tmp.10 tmp-ra.8 rbp)
            (tmp.10 tmp-ra.8 rbp)
            (tmp-ra.8 rax rbp)
            (rax rbp))
           ((r15 rbp) (r15 rbp)))
        ...
        ((tmp-ra.8
         ...
         (bat.7.6
          (bat.9.1
           ...
           rsi))
         (bar.2.3
          (bat.9.1 foobar.1.2 rbp tmp-ra.8 bat.7.6 bat.3.4 r9 tmp.10 rcx r8))
         (foobar.1.2
          (bat.9.1 rbp tmp-ra.8 bar.2.3 bat.7.6 bat.3.4 rdx rcx r8 r9))
         (bat.3.4
          (bat.9.1 foobar.1.2 bar.2.3 rbp tmp-ra.8 bat.7.6 rsi rdx rcx r8 r9))
        ...
        (if (true)
          (if (if (>= foobar.1.2 foobar.1.2)
            ...
            (begin
              ...
              (set! rax tmp.10)
              (jump tmp-ra.8 rbp rax))
            (begin (set! r15 tmp-ra.8) (jump L.func.0.1 rbp r15)))
          (begin
            (set! r9 bar.2.3)
            (set! r8 bat.9.1)
            (set! rcx bat.9.1)
...
(check-by-interp '(module
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx tmp-ra.8 rbp)
         (rsi rdx rcx foo.4.4 tmp-ra.8 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.8 (foo.9.1 foo.3.2 foo.7.3 foo.4.4 rbp rcx rdx rsi rdi))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.9 foo.9.7 bat.5.6 foo.7.5 tmp.11))
       (undead-out
        ((rdi rsi rdx tmp-ra.9 rbp)
         (rsi rdx tmp-ra.9 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.9 (rax tmp.11 foo.7.5 bat.5.6 foo.9.7 rbp rdx rsi rdi))
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.3 ball.3.2 foobar.9.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.3 rbp)
       (tmp-ra.3 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.3 (rax foobar.9.1 ball.3.2 rbp))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.2 rbp)
       ((tmp-ra.2 rbp)
        ((((tmp.3 tmp-ra.2 rbp) (tmp-ra.2 rbp))
          ((tmp.4 tmp-ra.2 rbp) (tmp-ra.2 rbp))
          ((tmp.5 tmp-ra.2 rbp) (tmp-ra.2 rbp)))
         (((tmp.6 tmp-ra.2 rbp) (tmp-ra.2 rbp))
    ...
    (begin
      (set! tmp-ra.2 r15)
      (if (false)
        (if (if (begin (set! tmp.3 9223372036854775807) (< tmp.3 1646335033))
              (begin (set! tmp.4 9223372036854775807) (>= tmp.4 1))
              (begin (set! tmp.5 9223372036854775807) (!= tmp.5 1)))
          (if (begin
                (set! tmp.6 -9223372036854775808)
                (!= tmp.6 -9223372036854775808))
            (begin (set! rax -9223372036854775808) (jump tmp-ra.2 rbp rax))
            (begin (set! rax 1282320164) (jump tmp-ra.2 rbp rax)))
          (begin
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.19 tmp-ra.17))
     (call-undead ())
     (undead-out
      ((tmp-ra.17 rbp)
       (((tmp.19 tmp-ra.17 rbp) (tmp-ra.17 rbp))
        ((tmp-ra.17 rax rbp) (rax rbp))
        ((tmp-ra.17 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.19 (rbp tmp-ra.17))
       (tmp-ra.17 (rbp tmp.19 rax))
       (rax (rbp tmp-ra.17))
      ...
      ((new-frames (() ()))
       ...
       (conflicts
        ((tmp-ra.15
         ...
         (r15 (rbp rdi rsi rdx rcx))))
       (assignment
        ((tmp-ra.15 fv0) (bat.6.3 fv1) (bar.1.4 fv2) (bar.0.1 fv3))))
      (begin
        (set! tmp-ra.15 r15)
        (set! bar.1.4 rdi)
        (set! bat.6.3 rsi)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.16 rbp)
         ...
         ((bar.3.14 foobar.8.13 bat.6.12 tmp-ra.16 rbp)
          ((bat.6.12 tmp-ra.16 rdx rbp)
           (tmp-ra.16 rdx rsi rbp)
           (tmp-ra.16 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp))
          ((bat.6.12 bar.3.14 foobar.8.13 tmp-ra.16 rbp)
           ((bar.3.14 foobar.8.13 tmp-ra.16 rcx rbp)
            (bar.3.14 foobar.8.13 tmp-ra.16 rcx rdx rbp)
            (foobar.8.13 tmp-ra.16 rcx rdx rsi rbp)
            (tmp-ra.16 rcx rdx rsi rdi rbp)
            (rcx rdx rsi rdi r15 rbp)
            (rcx rdx rsi rdi r15 rbp))
           ((bat.6.12 tmp-ra.16 rdx rbp)
            (bat.6.12 tmp-ra.16 rdx rsi rbp)
            (tmp-ra.16 rdx rsi rdi rbp)
            (rdx rsi rdi r15 rbp)
            (rdx rsi rdi r15 rbp))))))
       (call-undead ())
       (conflicts
        ((tmp-ra.16 (bat.6.12 foobar.8.13 bar.3.14 rbp rcx rdi rsi rdx))
    ...
    (begin
      ...
      (if (begin
        ...
        (begin (set! rax -1677147892) (jump tmp-ra.17 rbp rax))
        (begin (set! rax 874915829) (jump tmp-ra.17 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.31 tmp-ra.29))
     (call-undead ())
     (undead-out
      ((tmp-ra.29 rbp)
       (((tmp.31 tmp-ra.29 rbp) (tmp-ra.29 rbp))
        ((tmp-ra.29 rax rbp) (rax rbp))
        ((tmp-ra.29 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.31 (rbp tmp-ra.29))
       (tmp-ra.29 (rbp tmp.31 rax))
       (rax (rbp tmp-ra.29))
    ...
    (define L.proc.0.1
      ((new-frames (() (nfv.26)))
         ...
         ((ball.7.4
          ...
          ((ball.7.4
           ...
           ((rax foo.1.6 ball.0.2 tmp-ra.25 rbp)
            ((foobar.3.3 foo.2.7 ball.4.5 r9 rbp)
             (foobar.3.3 foo.2.7 ball.4.5 r9 r8 rbp)
       ...
       (call-undead
        (ball.4.5 foo.2.7 foobar.3.3 foo.6.1 foo.1.6 ball.0.2 tmp-ra.25))
       (conflicts
        ((foo.6.1
          (rbp
           tmp-ra.25
         ...
         (ball.7.9
          (rbp tmp-ra.25 ball.0.2 foo.1.6 foo.6.1 foobar.3.3 foo.2.7 ball.4.5))
         (nfv.26
          (r15 rdi rsi rdx rcx r8 r9 rbp foo.1.6 foobar.3.3 ball.4.5 ball.7.4))
         (ball.7.4
          (foo.6.1
           ball.0.2
           foobar.3.3
         ...
         (tmp-ra.25
          (foo.6.1
           ...
           rax))
         (rax
          (ball.0.2 foo.1.6 foo.6.1 foobar.3.3 foo.2.7 ball.4.5 rbp tmp-ra.25))
         (rbp
          (foo.6.1
           ball.0.2
           foobar.3.3
         ...
         (fv0
          (ball.0.2 foobar.3.3 ball.7.4 ball.4.5 foo.1.6 foo.2.7 tmp-ra.25))))
       (assignment
        ((tmp-ra.25 fv1)
         (ball.0.2 fv2)
         (foo.1.6 fv3)
      ...
      (begin
        ...
        (if (not (> foo.6.1 -727829088))
          ...
          (begin (set! rax -774243080) (jump tmp-ra.25 rbp rax)))))
    (define L.fn.1.2
      ((new-frames ())
       (locals
        (foobar.3.13
         ...
         tmp.30))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.27 rbp)
        ...
        ((foobar.3.13
         ...
         (foo.1.15
          (ball.7.12
           ...
           tmp.30))
         (ball.7.12
          (rbp tmp-ra.27 foo.1.15 ball.4.16 foobar.3.13 foo.5.17 ball.9.14 r9))
         (tmp-ra.27
          (ball.7.12
           foobar.3.13
           ball.9.14
         ...
         (rdx
          (ball.4.16
           ...
           foobar.3.13))
         (rsi
          (foo.5.17 ball.9.18 r15 rdi rbp rdx rcx r8 r9 tmp-ra.27 ball.9.14))
      ...
      ((new-frames ())
       ...
       (conflicts
        ((tmp-ra.28
         ...
         (rdx
          (r15 rdi rsi rbp rcx r8 r9 foo.6.20 foo.1.23 foobar.8.24 tmp-ra.28))
         (rcx
          (r15
           rdi
           rsi
    ...
    (begin
      (set! tmp-ra.29 r15)
      (if (begin (set! tmp.31 -534391580) (< tmp.31 9223372036854775807))
        (begin (set! rax 0) (jump tmp-ra.29 rbp rax))
        (begin (set! rax 0) (jump tmp-ra.29 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.4 ball.7.3 ball.8.2 foobar.1.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.4 rbp)
       (tmp-ra.4 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.4 (rax foobar.1.1 ball.8.2 ball.7.3 rbp))
...
(check-by-interp '(module
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals
        (tmp-ra.7 foobar.0.6 ball.2.5 ball.3.4 ball.5.3 bar.4.2 foobar.8.1))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.7 rbp)
       ...
       (conflicts
        ((tmp-ra.7
         ...
         (rcx
          (r15 rdi rsi rdx rbp r8 r9 ball.3.4 ball.2.5 foobar.0.6 tmp-ra.7))
         (r8
          (r15
           rdi
           rsi
    ...
    (begin
      (set! tmp-ra.8 r15)
      (if (begin (set! tmp.9 1038395452) (!= tmp.9 1))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.8 rbp rax))
        (begin (set! rax 717010255) (jump tmp-ra.8 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
      ...
      ((tmp-ra.4 rbp)
       ((tmp-ra.4 rbp)
        (((tmp.5 tmp-ra.4 rbp) (tmp-ra.4 rbp))
         (((tmp.6 tmp-ra.4 rbp) (tmp-ra.4 rbp))
          ((tmp-ra.4 rax rbp) (rax rbp))
          ((tmp-ra.4 rax rbp) (rax rbp)))
         (((tmp.7 tmp-ra.4 rbp) (tmp-ra.4 rbp))
          ((tmp-ra.4 rax rbp) (rax rbp))
          ((tmp-ra.4 rax rbp) (rax rbp))))
        ((tmp-ra.4 rbp)
         ((foo.5.2 tmp-ra.4 rbp)
    ...
    (begin
      (set! tmp-ra.4 r15)
      (if (true)
        (if (not (begin (set! tmp.5 0) (= tmp.5 1)))
          (if (begin (set! tmp.6 -9223372036854775808) (>= tmp.6 -1744096882))
            (begin (set! rax 0) (jump tmp-ra.4 rbp rax))
            (begin (set! rax 9223372036854775807) (jump tmp-ra.4 rbp rax)))
          (if (begin (set! tmp.7 -9223372036854775808) (< tmp.7 0))
...
(check-by-interp '(module
    ...
    (begin
      (set! tmp-ra.1 r15)
      (if (begin (set! tmp.2 0) (< tmp.2 9223372036854775807))
        (begin (set! rax 1620518798) (jump tmp-ra.1 rbp rax))
        (if (begin (set! tmp.3 0) (!= tmp.3 9223372036854775807))
          (begin (set! rax 0) (jump tmp-ra.1 rbp rax))
          (begin (set! rax -9223372036854775808) (jump tmp-ra.1 rbp rax))))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.16 tmp-ra.15))
     (call-undead ())
     (undead-out
      ((tmp-ra.15 rbp)
       (((tmp.16 tmp-ra.15 rbp) (tmp-ra.15 rbp))
        ((tmp-ra.15 rax rbp) (rax rbp))
        ((tmp-ra.15 rax rbp) (rax rbp)))))
     (conflicts
      ((tmp.16 (rbp tmp-ra.15))
       (tmp-ra.15 (rbp tmp.16 rax))
       (rax (rbp tmp-ra.15))
       (rbp (tmp-ra.15 tmp.16 rax))))
     (assignment ()))
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.12 foobar.2.2 ball.0.1))
       (undead-out
        ((rdi rsi tmp-ra.12 rbp)
         (rsi foobar.2.2 tmp-ra.12 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.12 (rdx ball.0.1 foobar.2.2 rbp rsi rdi))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx tmp-ra.13 rbp)
         ...
         ((foo.6.3 foobar.2.4 ball.5.5 tmp-ra.13 rbp)
          ((foobar.2.4 ball.5.5 tmp-ra.13 r9 rbp)
           (foobar.2.4 ball.5.5 tmp-ra.13 r9 r8 rbp)
           ...
           (r9 r8 rcx rdx rsi rdi r15 rbp)
           (r9 r8 rcx rdx rsi rdi r15 rbp))
          ((foobar.2.4 tmp-ra.13 rdx rbp)
           (foobar.2.4 tmp-ra.13 rdx rsi rbp)
           (tmp-ra.13 rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp)))))
       (call-undead ())
       (conflicts
        ((tmp-ra.13 (foo.6.3 foobar.2.4 ball.5.5 rbp rcx r8 r9 rdi rsi rdx))
         ...
         (rbp
          (foo.6.3 foobar.2.4 ball.5.5 tmp-ra.13 rcx r8 r9 r15 rdi rsi rdx))
    ...
    (define L.tmp.2.3
      ((new-frames ())
       (locals
        (tmp-ra.14 foobar.2.11 foo.6.10 foobar.7.9 ball.5.8 bar.1.7 bat.9.6))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.14 rbp)
    ...
    (begin
      ...
      (if (begin
        ...
        (begin (set! rax 9223372036854775807) (jump tmp-ra.15 rbp rax))
        (begin (set! rax 1) (jump tmp-ra.15 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.7))
     ...
     (conflicts
      ((tmp-ra.7 (rax rbp)) (rbp (rax tmp-ra.7)) (rax (rbp tmp-ra.7))))
     (assignment ()))
    (define L.fn.0.1
      ((new-frames ())
       (locals (tmp-ra.6 ball.2.5 ball.4.4 ball.0.3 foo.1.2 foo.8.1))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.6 rbp)
       ...
       (conflicts
        ((tmp-ra.6
          (foo.8.1 foo.1.2 ball.0.3 ball.4.4 ball.2.5 rbp r8 rcx rdx rsi rdi))
         (ball.2.5
          (foo.8.1 foo.1.2 ball.0.3 ball.4.4 rbp tmp-ra.6 r8 rcx rdx rsi))
         ...
         (rcx
          (r15 rdi rsi rdx rbp r8 foo.8.1 ball.0.3 ball.4.4 ball.2.5 tmp-ra.6))
         (r8
          (r15
           rdi
           rsi
    ...
    (begin (set! tmp-ra.7 r15) (set! rax -167685894) (jump tmp-ra.7 rbp rax)))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.23 tmp.25))
     (call-undead ())
     (undead-out
      ((tmp-ra.23 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.23 (rax tmp.25 rbp))
       (tmp.25 (rbp tmp-ra.23))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.20 (rdx rcx r8 r9 foobar.8.1 bar.0.2 rbp rsi rdi))
      ...
      ((new-frames ())
       (locals
        (tmp-ra.21
         ...
         bar.0.8))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.21 rbp)
        ...
        ((tmp-ra.21
         ...
         (foobar.5.3
          (rcx
           ...
           foobar.2.6))
         (foobar.7.10
          (foobar.2.9 tmp.24 rbp tmp-ra.21 bat.3.4 foobar.1.5 foobar.2.6))
         (tmp.24
          (foobar.1.5 rbp tmp-ra.21 bat.3.4 foobar.5.3 foobar.7.10 foobar.2.6))
         (foobar.2.9
          (bar.0.13 rbp tmp-ra.21 bat.3.4 foobar.5.3 foobar.1.5 foobar.7.10))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (call-undead ())
     (undead-out
      ((tmp-ra.3 rbp) (tmp-ra.3 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
     (conflicts
      ((tmp-ra.3 (rdi rbp))
       (rbp (r15 rdi tmp-ra.3))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((bat.0.1 (rbp tmp-ra.2 tmp.4))
         (tmp.4 (rbp tmp-ra.2 bat.0.1))
      ...
      (begin
        ...
        (if (if (true)
              (not (> bat.0.1 bat.0.1))
              (begin (set! tmp.4 2020417677) (>= tmp.4 -9223372036854775808)))
          (if (true)
            (if (= bat.0.1 bat.0.1)
              (begin (set! rax bat.0.1) (jump tmp-ra.2 rbp rax))
              (begin (set! rax bat.0.1) (jump tmp-ra.2 rbp rax)))
            (begin
              (set! rdi bat.0.1)
              (set! r15 tmp-ra.2)
...
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.25 ball.3.21 foo.8.20 foobar.7.19))
     (call-undead ())
     (undead-out
      ((tmp-ra.25 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.25 (rax foobar.7.19 foo.8.20 ball.3.21 rbp))
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (conflicts
        ((tmp-ra.22
          (r8 foobar.1.1 foobar.4.2 foo.8.3 ball.3.4 rbp rcx rdx rsi rdi))
      ...
      ((new-frames ())
       ...
       (conflicts
        ((tmp-ra.23
         ...
         (rbp
          (r15 rdi foobar.4.5 bat.6.6 bar.2.7 foobar.7.8 bat.0.9 tmp-ra.23))
         (r15 (rbp rdi))))
       (assignment ()))
      (begin
        (set! tmp-ra.23 r15)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (conflicts
      ((tmp-ra.13 (rax rbp)) (rbp (rax tmp-ra.13)) (rax (rbp tmp-ra.13))))
     (assignment ()))
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.10 foobar.0.5 foo.5.4 bat.6.3 bat.3.2 bar.7.1))
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.10 rbp)
         (rsi rdx rcx r8 tmp-ra.10 rbp)
    ...
    (define L.func.1.2
      ((new-frames (()))
       ...
       (conflicts
        ((tmp-ra.11 (foobar.4.6 rax bat.3.7 bat.2.8 tmp.14 rbp))
      ...
      (begin
        ...
        (set! bat.3.7 0)
        (return-point L.rp.4
          (begin (set! r15 L.rp.4) (jump L.func.1.2 rbp r15)))
        (set! foobar.4.6 rax)
        (set! rax bat.3.7)
        (jump tmp-ra.11 rbp rax)))
    (define L.x.2.3
      ((new-frames ())
       (locals (tmp-ra.12 bar.8.9))
       (undead-out ((rdi tmp-ra.12 rbp) (tmp-ra.12 rbp) (r15 rbp) (r15 rbp)))
       (call-undead ())
       (conflicts
        ((tmp-ra.12 (bar.8.9 rbp rdi))
         (bar.8.9 (rbp tmp-ra.12))
         (rdi (tmp-ra.12))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.14 rbp)
       (((tmp.15 tmp-ra.14 rbp) (tmp-ra.14 rbp))
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((foobar.0.7 (rbp tmp-ra.13 foobar.4.8 r9))
      ...
      (begin
        ...
        (if (<= foobar.0.7 -9223372036854775808)
          (begin
            ...
            (set! r15 tmp-ra.13)
            (jump L.x.0.1 rbp r15 rdi rsi rdx rcx r8 r9))
          (begin (set! rax foobar.0.7) (jump tmp-ra.13 rbp rax)))))
    (begin
      (set! tmp-ra.14 r15)
      (if (not (begin (set! tmp.15 0) (= tmp.15 -844906965)))
        (begin
          ...
          (set! rax foo.3.11)
          (jump tmp-ra.14 rbp rax))
        (if (begin (set! tmp.16 894536270) (> tmp.16 1910216157))
          (begin (set! rax 1) (jump tmp-ra.14 rbp rax))
          (begin (set! rax 1) (jump tmp-ra.14 rbp rax))))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.24 tmp-ra.21))
     (call-undead ())
     (undead-out
      ((tmp-ra.21 rbp)
       (((tmp.24 tmp-ra.21 rbp) (tmp-ra.21 rbp))
         ...
         ((bat.2.4 foo.1.1 bat.6.5 foobar.8.3 bar.3.2 tmp-ra.19 rbp)
          ((bat.2.4 foo.1.1 bat.6.5 foobar.8.3 bar.3.2 tmp-ra.19 rbp)
           ...
           ((foo.1.1 bar.3.2 foobar.8.3 bat.2.4 tmp-ra.19 fv0 rbp)
            ...
            (fv0 r9 r8 rcx rdx rsi rdi r15 rbp)
            (fv0 r9 r8 rcx rdx rsi rdi r15 rbp)))
          ((bat.6.5 foobar.8.3 tmp-ra.19 rbp)
           (foobar.8.3 tmp-ra.19 rbp)
        ...
        ((bat.2.4
         ...
         (rdx
          (bat.2.4
           ...
           foobar.8.3))
         (rsi
          (bat.6.5 bar.3.2 r15 rdi rbp rdx rcx r8 r9 fv0 tmp-ra.19 bat.2.4))
         (rdi (r15 rbp rsi rdx rcx r8 r9 fv0 tmp-ra.19))
         (r15 (rbp rdi rsi rdx rcx r8 r9 fv0))))
       (assignment ()))
      (begin
    ...
    (define L.tmp.1.2
        ...
        ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.20 rbp)
         ...
         (((tmp.22
          ...
          (((rax bat.2.11 bat.6.9 foo.1.14 foobar.7.10 tmp-ra.20 rbp)
            ((bat.0.12 foobar.7.10 bat.2.11 r8 rbp)
             (bat.0.12 foobar.7.10 bat.2.11 r8 rcx rbp)
          ...
          (((rax bat.2.11 bat.6.9 foo.1.14 foobar.7.10 tmp-ra.20 rbp)
            ((bat.0.12 foo.1.14 foobar.8.13 r8 rbp)
             (foo.1.14 foobar.8.13 r8 rcx rbp)
         ...
         (fv0 r9 r8 rcx rdx rsi rdi r15 rbp)))
       (call-undead
        (foobar.8.18 bat.2.11 bat.6.9 foo.1.14 foobar.7.10 tmp-ra.20))
       (conflicts
        ((tmp-ra.20
          (bar.3.16
           bat.0.17
         ...
         (tmp.22
          (rbp
           ...
           foobar.8.13))
         (tmp.23
          (bat.6.9 rbp tmp-ra.20 foobar.7.10 foo.1.14 foobar.8.18 bat.2.11))
         (bat.0.17
          (rbp tmp-ra.20 foobar.7.10 foo.1.14 bat.6.9 foobar.8.18 bat.2.11))
         (bar.3.16
          (r8 r9 fv0 rbp tmp-ra.20 foobar.7.10 foo.1.14 bat.6.9 foobar.8.18))
         ...
         (rbp
          (r9
           ...
           tmp-ra.20))
         (rax
          (foobar.8.18 rbp tmp-ra.20 foobar.7.10 foo.1.14 bat.6.9 bat.2.11))
      ...
      (begin
        ...
        (set! foobar.7.10 r9)
        (set! bat.6.9 fv0)
        (if (not (begin (set! tmp.22 1242010444) (> tmp.22 foobar.8.13)))
          (begin
            (return-point L.rp.3
              (begin
                (set! r8 foobar.7.10)
    ...
    (begin
      (set! tmp-ra.21 r15)
      (if (not (begin (set! tmp.24 1973720366) (< tmp.24 1864083813)))
        (begin (set! rax 9223372036854775807) (jump tmp-ra.21 rbp rax))
        (begin
          (set! fv0 379193781)
          (set! r9 726597669)
          (set! r8 -264137160)
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.4 rbp)
       ...
       ((ball.8.3 bat.6.2 foo.5.1 tmp-ra.4 rbp)
        ((bat.6.2 foo.5.1 tmp-ra.4 rbp)
         ((tmp-ra.4 rax rbp) (rax rbp))
         ((tmp-ra.4 rax rbp) (rax rbp)))
        ((bat.6.2 tmp-ra.4 rbp)
         ((tmp-ra.4 rax rbp) (rax rbp))
         ((tmp-ra.4 rax rbp) (rax rbp))))))
     (conflicts
      ((tmp-ra.4 (foo.5.1 bat.6.2 ball.8.3 rbp rax))
    ...
    (begin
      ...
      (if (false)
        (if (!= bat.6.2 bat.6.2)
          (begin (set! rax foo.5.1) (jump tmp-ra.4 rbp rax))
          (begin (set! rax bat.6.2) (jump tmp-ra.4 rbp rax)))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (conflicts
      ((tmp-ra.4 (rax rbp)) (rbp (rax tmp-ra.4)) (rax (rbp tmp-ra.4))))
     (assignment ()))
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.3 bat.7.2 bat.8.1))
       (undead-out
        ((rdi rsi tmp-ra.3 rbp)
         (rsi tmp-ra.3 rbp)
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.3 (bat.8.1 bat.7.2 rbp rsi rdi))
      ...
      (begin
        ...
        (set! r15 tmp-ra.3)
        (jump L.func.0.1 rbp r15 rdi rsi)))
    (begin (set! tmp-ra.4 r15) (set! rax 0) (jump tmp-ra.4 rbp rax)))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp.2 tmp-ra.1))
    ...
    (begin
      (set! tmp-ra.1 r15)
      (if (begin (set! tmp.2 -9223372036854775808) (> tmp.2 526950868))
        (begin (set! rax -9223372036854775808) (jump tmp-ra.1 rbp rax))
        (begin (set! rax 9223372036854775807) (jump tmp-ra.1 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.18 rbp)
       ...
       (r9 r8 rcx rdx rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.18 (rdi rsi rdx rcx r8 r9 rbp))
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi rdx rcx r8 tmp-ra.16 rbp)
       ...
       (conflicts
        ((tmp-ra.16
         ...
         (rdx
          (r15 rdi rsi rbp rcx r8 r9 bat.4.1 ball.3.4 foobar.6.5 tmp-ra.16))
         (rcx
          (r15 rdi rsi rdx rbp r8 r9 ball.9.3 ball.3.4 foobar.6.5 tmp-ra.16))
         (r8
          (r15
           rdi
           rsi
    ...
    (define L.func.1.2
      ((new-frames ())
       (locals
        (foo.8.7
         ...
         ball.3.15))
       (undead-out
        ((rdi rsi rdx rcx r8 r9 tmp-ra.17 rbp)
        ...
        ((foo.8.7
         ...
         (ball.3.6
          (rbp
           ...
           ball.3.15))
         (tmp.21
          (rbp tmp-ra.17 ball.3.6 bat.4.10 ball.1.11 foo.5.9 ball.9.8 foo.8.7))
         ...
         (rdx
          (bat.4.10
           ...
           ball.1.14))
         (rsi
          (ball.1.11 foo.5.9 r15 rdi rbp rdx rcx r8 r9 tmp-ra.17 ball.1.14))
         (rdi (r15 rbp rsi rdx rcx r8 r9 tmp-ra.17))
         (r15 (rbp rdi rsi rdx rcx r8 r9))
         (rax (rbp tmp-ra.17))))
       (assignment ()))
      (begin
        ...
        (if (if (if (< foo.8.7 foo.8.7)
                  ...
                  (!= bat.4.10 foo.8.7))
              (= ball.3.6 0)
              (if (begin (set! tmp.19 0) (> tmp.19 ball.3.6))
                (begin (set! tmp.20 1) (<= tmp.20 ball.9.8))
                (begin (set! tmp.21 529266316) (>= tmp.21 foo.8.7))))
          (if (begin (set! bat.4.12 foo.5.9) (<= ball.9.8 bat.4.12))
            (begin
...
(check-by-interp '(module
    ((new-frames ())
     (locals
      (tmp.6 tmp.7 bar.8.1 tmp.8 bat.2.2 bat.2.3 tmp-ra.5 tmp.9 bar.9.4))
     (call-undead ())
     (undead-out
      ((tmp-ra.5 rbp)
       ((((tmp.6 tmp-ra.5 rbp) (tmp-ra.5 rbp))
     ...
     (conflicts
      ((tmp.6 (rbp tmp-ra.5))
       ...
       (tmp-ra.5
        (rbp tmp.6 tmp.7 bar.8.1 tmp.8 bat.2.2 bat.2.3 bar.9.4 tmp.9 rax))
       (tmp.9 (rbp tmp-ra.5))
    ...
    (begin
      (set! tmp-ra.5 r15)
      (if (if (begin (set! tmp.6 9223372036854775807) (!= tmp.6 2124101395))
            (true)
            (not (begin (set! tmp.7 9223372036854775807) (<= tmp.7 0))))
        (begin
        ...
        (begin
          ...
          (set! bar.9.4 tmp.9)
          (if (> bar.9.4 bar.9.4)
            (begin (set! rax bar.9.4) (jump tmp-ra.5 rbp rax))
            (begin (set! rax bar.9.4) (jump tmp-ra.5 rbp rax)))))))
)
(check-by-interp '(module
    ((new-frames ())
    ...
    (begin
      (set! tmp-ra.1 r15)
      (if (begin (set! tmp.2 1069510162) (>= tmp.2 -9223372036854775808))
        (begin (set! rax 1) (jump tmp-ra.1 rbp rax))
        (begin (set! rax 323863587) (jump tmp-ra.1 rbp rax)))))
)
(check-by-interp '(module
    ((new-frames ())
     (locals (tmp-ra.1 tmp.2))
...
(check-by-interp '(module
    ((new-frames ())
     ...
     (conflicts
      ((tmp-ra.1 (rax rbp)) (rbp (rax tmp-ra.1)) (rax (rbp tmp-ra.1))))
     (assignment ()))
    (begin (set! tmp-ra.1 r15) (set! rax 0) (jump tmp-ra.1 rbp rax)))
)
(check-by-interp '(module
    ((new-frames ())
     ...
     (undead-out
      ((tmp-ra.6 rbp)
       ...
       (rax rbp)))
     (conflicts
      ((tmp-ra.6 (rax bat.0.3 foo.5.4 ball.3.5 bat.0.1 bat.2.2 tmp.7 rbp))
       (tmp.7 (rbp tmp-ra.6))
