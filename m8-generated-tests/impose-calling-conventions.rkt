...
(require cpsc411/compiler-lib
         cpsc411/langs/v8
         (only-in "../impose-calling-conventions.rkt"))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.60 (call L.fun/empty8468.6 tmp.61 tmp.62))))
    ...
    (begin
      (begin
        ...
        (begin
          ...
          (set! tmp.62 (call L.-.5 tmp.63 tmp.64))))
      (begin
        (begin
          ...
          (begin
            (begin
              ...
              (set! empty2.1 22)
              (set! tmp.67 608))
            (set! tmp.65 (call L.-.5 tmp.66 tmp.67))))
 ...
 '(module
    ...
    (if (begin
          (begin
            ...
            (set! tmp.63 (call L.vector?.6 tmp.64)))
          (!= tmp.63 6))
      (begin
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.2 (call L.-.8 tmp.69 tmp.70))))
 ...
 '(module
    ...
    (begin
      (if (begin
        ...
        (set! tmp.74 (call L.fun/empty9034.4 4158 59454 14)))
      (begin
        (begin
          ...
          (set! tmp.76 (call L.fixnum?.15 30)))
        (begin
          (begin
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.2 (call L.-.9 tmp.63 tmp.64))))
    ...
    (begin
      (begin
        ...
        (begin
          ...
          (set! fixnum0.5 (call L.-.10 tmp.68 tmp.71))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean1.4 (call L.ascii-char?.9 tmp.64)))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.65 (call L.-.11 tmp.66 tmp.67))))
        (begin
          (begin
          ...
          (set! fixnum3.2 (call L.+.10 tmp.65 tmp.68))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.3 (call L.-.12 tmp.68 tmp.71))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.64 (call L.-.11 tmp.65 tmp.66))))
        (begin
          (begin
            (set! tmp.68 (call L.*.10 1672 1944))
            (begin
              (set! tmp.69 (call L.-.11 1184 1864))
              (set! tmp.67 (call L.-.11 tmp.68 tmp.69))))
          (set! fixnum0.5 (call L.*.10 tmp.64 tmp.67))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.72 (call L.*.8 tmp.73 tmp.74))))
          (set! fixnum1.4 (call L.-.10 tmp.69 tmp.72))))
      (begin
        (begin
          (set! tmp.76 (call L.*.8 56 1408))
          (begin
            (set! tmp.77 (call L.*.8 8 528))
            (set! tmp.75 (call L.*.8 tmp.76 tmp.77))))
        (begin
          (begin
            (set! tmp.79 (call L.+.9 472 376))
            (begin
              (set! tmp.80 (call L.-.10 1000 656))
              (set! tmp.78 (call L.*.8 tmp.79 tmp.80))))
          (set! fixnum2.3 (call L.*.8 tmp.75 tmp.78))))
      (begin
        (begin
          (set! tmp.82 (call L.*.8 1064 464))
          (begin
            (set! tmp.83 (call L.*.8 1088 1504))
            (set! tmp.81 (call L.*.8 tmp.82 tmp.83))))
        (begin
          (begin
            (set! tmp.85 (call L.+.9 1328 1048))
            (begin
              (set! tmp.86 (call L.*.8 1832 560))
              (set! tmp.84 (call L.*.8 tmp.85 tmp.86))))
          (set! fixnum3.2 (call L.+.9 tmp.81 tmp.84))))
      (begin
        (set! tmp.87 (call L.fun/any16026.6))
        (set! boolean4.1 (call L.fixnum?.11 tmp.87)))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.74 (call L.-.11 tmp.75 tmp.76))))
        (begin
          (begin
          ...
          (set! fixnum4.1 (call L.-.11 tmp.74 tmp.77))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.63 (call L.-.10 tmp.64 tmp.65))))
        (begin
          (begin
            (set! tmp.67 (call L.-.10 160 888))
            (begin
              (set! tmp.68 (call L.-.10 1968 1920))
              (set! tmp.66 (call L.+.9 tmp.67 tmp.68))))
          (set! fixnum2.3 (call L.-.10 tmp.63 tmp.66))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum4.2 (call L.+.16 tmp.69 tmp.76))))
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (begin
        (set! tmp.71 (call L.fun/any43337.6))
        (set! boolean2.4 (call L.void?.15 tmp.71)))
      (begin
        (begin
          (begin
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.76 (call L.+.18 tmp.77 tmp.78))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.79 (call L.*.16 tmp.80 tmp.83))))
          (set! fixnum3.3 (call L.+.18 tmp.72 tmp.79))))
      (set! empty4.2 (call L.fun/empty43338.10))
      (begin
        (set! tmp.86 (call L.fun/any43340.7))
        (set! boolean5.1 (call L.error?.19 tmp.86)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.84 (call L.-.17 tmp.85 tmp.86))))
          (begin
            (begin
        ...
        (begin
          (begin
            (begin
              ...
              (set! tmp.91 (call L.*.15 fixnum4.2 tmp.92)))
            (set! tmp.90 (call L.*.15 fixnum4.2 tmp.91)))
 ...
 '(module
    ...
    (begin
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.70 (call L.-.12 tmp.71 tmp.74))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.78 (call L.*.13 tmp.79 tmp.80))))
            (begin
              (begin
                (set! tmp.82 (call L.-.12 1000 1904))
                (begin
                  (set! tmp.83 (call L.*.13 528 448))
                  (set! tmp.81 (call L.-.12 tmp.82 tmp.83))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.91 (call L.+.14 tmp.92 tmp.95))))
          (set! fixnum1.5 (call L.*.13 tmp.84 tmp.91))))
      ...
      (begin
        ...
        (set! boolean5.1 (call L.fixnum?.15 tmp.98)))
      ascii-char4.2)))
(check-by-interp
 '(module
    (define L.void?.13
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.74 (call L.*.10 tmp.75 tmp.76))))
            (set! tmp.70 (call L.+.11 tmp.71 tmp.74))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.78 (call L.-.12 tmp.79 tmp.80))))
            (begin
              (begin
                (set! tmp.82 (call L.*.10 1096 1008))
                (begin
                  (set! tmp.83 (call L.+.11 416 416))
                  (set! tmp.81 (call L.*.10 tmp.82 tmp.83))))
              (set! tmp.77 (call L.+.11 tmp.78 tmp.81))))
          (set! fixnum0.6 (call L.+.11 tmp.70 tmp.77))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.85 (call L.+.11 tmp.86 tmp.87))))
          (begin
            (begin
            ...
            (set! tmp.84 (call L.-.12 tmp.85 tmp.88))))
        (begin
          (begin
            (begin
            ...
            (begin
              ...
              (set! tmp.91 (call L.*.10 tmp.92 tmp.95))))
          (set! fixnum2.4 (call L.-.12 tmp.84 tmp.91))))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.99 (call L.+.11 tmp.100 tmp.101))))
          (begin
            (begin
              (set! tmp.103 (call L.-.12 1336 256))
              (begin
                (set! tmp.104 (call L.*.10 2000 1576))
                (set! tmp.102 (call L.*.10 tmp.103 tmp.104))))
            (set! tmp.98 (call L.*.10 tmp.99 tmp.102))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.106 (call L.+.11 tmp.107 tmp.108))))
            (begin
              (begin
                (set! tmp.110 (call L.+.11 512 2032))
                (begin
                  (set! tmp.111 (call L.*.10 1032 360))
                  (set! tmp.109 (call L.*.10 tmp.110 tmp.111))))
              (set! tmp.105 (call L.*.10 tmp.106 tmp.109))))
          (set! fixnum3.3 (call L.-.12 tmp.98 tmp.105))))
      (begin
        (set! tmp.112 (call L.fun/any63954.8))
        (set! boolean4.2 (call L.void?.13 tmp.112)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.76 (call L.-.17 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.*.16 tmp.69 tmp.76))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.90 (call L.-.14 tmp.91 tmp.94))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum1.5 (call L.+.17 tmp.69 tmp.76))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.79 (call L.-.13 tmp.80 tmp.81))))
            (begin
              (begin
                (set! tmp.83 (call L.*.14 208 296))
                (begin
                  (set! tmp.84 (call L.*.14 800 32))
                  (set! tmp.82 (call L.*.14 tmp.83 tmp.84))))
              (set! tmp.78 (call L.-.13 tmp.79 tmp.82))))
          (set! fixnum1.5 (call L.-.13 tmp.71 tmp.78))))
      (begin
        (set! tmp.85 (call L.fun/any78094.7))
        (set! boolean2.4 (call L.boolean?.16 tmp.85)))
      (begin
        (set! tmp.86 (call L.fun/any78095.4))
        (set! boolean3.3 (call L.ascii-char?.17 tmp.86)))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.88 (call L.+.15 tmp.89 tmp.90))))
          (begin
            (begin
            ...
            (set! tmp.87 (call L.+.15 tmp.88 tmp.91))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.95 (call L.-.13 tmp.96 tmp.97))))
            (begin
              (begin
              ...
              (set! tmp.94 (call L.+.15 tmp.95 tmp.98))))
          (set! fixnum4.2 (call L.-.13 tmp.87 tmp.94))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.70 (call L.*.15 tmp.71 tmp.74))))
        (begin
          (begin
            (begin
            ...
            (begin
              ...
              (set! tmp.77 (call L.-.16 tmp.78 tmp.81))))
          (set! fixnum0.6 (call L.+.14 tmp.70 tmp.77))))
      (begin
        (set! tmp.84 (call L.fun/any101991.10))
        (set! boolean1.5 (call L.boolean?.17 tmp.84)))
 ...
 '(module
    ...
    (begin
      (begin
        ...
        (set! boolean0.6 (call L.boolean?.16 tmp.70)))
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.4 (call L.-.17 tmp.71 tmp.78))))
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.+.17 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.17 tmp.77 tmp.80))))
          (set! fixnum5.1 (call L.*.18 tmp.69 tmp.76))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean1.5 (call L.pair?.14 tmp.70)))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.72 (call L.-.15 tmp.73 tmp.74))))
          (begin
            (begin
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.79 (call L.-.15 tmp.80 tmp.81))))
            (begin
              (begin
              ...
              (set! tmp.78 (call L.*.16 tmp.79 tmp.82))))
          (set! fixnum2.4 (call L.+.17 tmp.71 tmp.78))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.86 (call L.-.15 tmp.87 tmp.88))))
          (set! tmp.85 (call L.*.16 fixnum2.4 tmp.86)))
    ...
    (begin
      ...
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.84 (call L.*.13 tmp.85 tmp.86))))
          (begin
            (begin
        ...
        (begin
          ...
          (set! fixnum1.5 (call L.-.15 tmp.83 tmp.90))))
