  ...
  (define (value->fx^! value [k identity])
    (match value
      ...
      [`(call ,triv ,opand* ...)
       ...
       (make-begin-effect `((return-point
                             ,rp
                             ,(make-begin (generate-sets loc* opand*)
                                          (make-begin-effect
                                           `((set! ,ra ,rp)
                                             (jump ,triv ,rbp ,ra ,@loc*)
                                             ))))
                            ,(k rv)))]
    ...
    (match tail
      [`(call ,triv ,opand* ...)
       ...
       (make-begin
        ...
        (make-begin `((set! ,ra ,return-point))
                    `(jump ,triv ,rbp ,ra ,@loc*)))]
      [`(begin
          ,fx* ...
          ,tail)
      ...
      [value
       ...
       (make-begin
        `((set! ,rv ,(impose-non-calling-value value)))
        `(jump ,return-point ,rbp ,rv))]))
  ...
  (define (impose-p p)
    (match p
      [`(module (define ,(? label? label*)
       ...
       `(module
            ,(info-set '() 'new-frames nfs)
          ,@(map impose-define label* aloc** entry*)
          ,entry+)]))
...
(module+ test
  ...
  (check-by-interp-v6 '(module
    (begin
      (begin (set! bat.9.2 -422317085) (set! foobar.3.1 bat.9.2))
  ...
  (check-by-interp-v6 '(module
    (begin
      (if (begin (set! bat.8.2 -1418594624) (false))
        (begin
          (if (> -1123833745 1) (set! bat.9.3 1) (set! bat.9.3 0))
          (begin (set! bat.9.4 767736686) (set! bat.9.1 bat.9.4)))
        (if (true)
    ...
    (define L.x.0.1
      (lambda (ball.3.5 bar.7.4 bat.6.3 ball.4.2 bat.5.1)
        (if (not (<= bat.6.3 9223372036854775807))
          (begin
            (begin (set! bat.6.7 -18835826) (set! foobar.9.6 bat.6.7))
  ...
  (check-by-interp-v6 '(module
    ...
    (if (begin
          (begin
            (begin (set! bar.2.16 1) (set! bar.2.15 -9223372036854775808))
            (begin
    ...
    (define L.x.0.1
      (lambda (bar.3.4 ball.0.3 bat.2.2 bat.9.1)
        (begin
          ...
          (begin
            (begin (set! bar.3.7 0) (set! foobar.7.6 bar.3.7))
            (- bar.3.4 0)))))
  ...
  (check-by-interp-v6 '(module
    (begin
      (begin
        (set! foo.5.2 1)
        (begin (set! foo.5.3 foo.5.2) (set! foo.7.1 foo.5.3)))
      foo.7.1)))
  (check-by-interp-v6 '(module
    (define L.func.0.1
  ...
  (check-by-interp-v6 '(module
    ...
    (begin
      (begin
        ...
        (begin (set! foo.6.15 bat.0.14) (set! foo.5.13 foo.6.15)))
      foo.5.13)))
  (check-by-interp-v6 '(module
    (begin
      (begin
        (set! bat.1.2 -9223372036854775808)
        (begin (set! foobar.4.3 0) (set! bar.7.1 foobar.4.3)))
  ...
  (check-by-interp-v6 '(module
    ...
    (define L.tmp.2.3
      (lambda ()
        (begin
          (begin (set! foo.8.16 1) (set! foobar.5.15 foo.8.16))
  ...
  (check-by-interp-v6 '(module
    ...
    (begin
      (if (<= 1 899234556) (set! ball.3.13 0) (set! ball.3.13 0))
      (call
        L.proc.0.1
        ball.3.13
        ball.3.13
  ...
  (check-by-interp-v6 '(module
    ...
    (begin
      (if (true) (set! bat.8.9 480297521) (set! bat.8.9 (- 1 0)))
      (if (= bat.8.9 0)
        (begin
          (begin (set! bat.9.11 bat.8.9) (set! foo.4.10 0))
    ...
    (define L.tmp.0.1
      (lambda (bar.1.4 bat.6.3 ball.4.2 bar.0.1)
        (begin
          ...
          (begin (set! ball.4.5 (- bat.6.3 bar.0.1)))
          (begin
            (begin
  ...
  (check-by-interp-v6 '(module
    ...
    (define L.fn.1.2
      (lambda (foo.6.7 foobar.2.6 foobar.1.5 bat.3.4 foobar.5.3)
        (begin
          (begin
            (begin (set! foobar.7.10 foobar.5.3))
    ...
    (define L.x.2.3
      (lambda (foobar.7.10)
        (begin
          (begin
            (set! bat.0.12
              (call L.proc.0.1 foobar.7.10 foobar.7.10 foobar.7.10 foobar.7.10))
  ...
  (check-by-interp-v6 '(module
    (begin
      ...
      (begin (set! bat.6.2 -9223372036854775808))
        ...
        (if (if (if (< foo.8.7 foo.8.7)
          ...
          (if (begin (set! bat.4.12 foo.5.9) (<= ball.9.8 bat.4.12))
            ...
            (call
              ...
              ball.3.6))
          (begin
            (begin (set! ball.3.15 foo.5.9) (set! ball.1.14 ball.3.15))
            (call
              L.func.1.2
              ball.1.14
              ball.3.6
  ...
  (check-by-interp '(module
    ...
    (define L.L.func.2.3.6
      (lambda ()
        (begin
          (if (true)
            (begin (set! foo.2.3.7 1) (set! bar.4.2.6 foo.2.3.7))
    ...
    (define L.fn.0.1
      (lambda ()
        (begin
          (if (false)
            (set! bat.9.1 1)
            (begin (set! foo.5.2 1) (set! bat.9.1 1)))
          (if (if (>= 9223372036854775807 -9223372036854775808)
    ...
    (define L.fn.0.1
      (lambda ()
        (begin
          ...
          (begin
            (begin (set! foo.1.3 bar.2.1) (set! foo.8.2 foo.1.3))
            bar.2.1))))
    (define L.func.1.2
      (lambda ()
        (begin
          (if (begin (set! foo.8.5 1) (< 1 foo.8.5))
            (begin (set! foo.1.6 406779451) (set! ball.3.4 1200977699))
            (begin (set! foo.8.7 0) (set! ball.3.4 foo.8.7)))
          (* ball.3.4 ball.3.4))))
    ...
    (define L.tmp.1.2
      (lambda ()
        (if (if (if (<= -765445006 0)
              ...
              (true))
          (begin
            (begin (set! bar.5.4 -9223372036854775808) (set! ball.4.3 bar.5.4))
  ...
  (check-by-interp '(module
    (define L.proc.0.1
      (lambda (bar.8.1)
        (begin
          (if (false)
            (begin (set! bat.4.3 bar.8.1) (set! bat.7.2 1733388107))
            (begin (set! foobar.2.4 -818241658) (set! bat.7.2 foobar.2.4)))
          (begin
  ...
  (check-by-interp '(module
    ...
    (begin
      (begin (set! ball.1.5 453798193) (set! foobar.4.4 ball.1.5))
  ...
  (check-by-interp '(module
    ...
    (define L.x.1.2
      (lambda (bar.0.3)
        (begin
          (begin
            (begin (set! bat.2.6 1757280127) (set! bat.9.5 bat.2.6))
            (begin (set! ball.5.7 1) (set! ball.1.4 -1128483887)))
  ...
  (check-by-interp '(module
    (begin
      (begin (set! ball.2.2 9223372036854775807) (set! bar.5.1 -546026276))
      ...
      (lambda (bat.2.6)
        (begin
          (begin
            ...
            (begin (set! bat.2.9 1) (set! foobar.3.7 -9223372036854775808)))
          (* -152436426 0))))
    (define L.proc.2.3
    ...
    (define L.proc.0.1
      (lambda (foobar.1.6 bar.0.5 foobar.2.4 ball.8.3 bat.3.2 bar.5.1)
        (begin
          ...
          (begin
            (begin (set! foo.4.10 ball.8.3) (set! ball.6.9 1))
      ...
      (lambda (foo.6.25 foo.3.24 foobar.4.23 bar.9.22 foobar.1.21 foobar.5.20)
        (begin
          (begin
            ...
            (begin (set! foo.6.28 foo.3.24) (set! foobar.5.26 foobar.1.27)))
