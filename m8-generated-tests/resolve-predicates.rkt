 ...
 '(module
    (define L.__main.7
      (begin
        (set! r15 r15)
        (set! r14 14)
        (if (true) (jump L.__nested.5) (jump L.__nested.6))))
    (define L.__nested.5 (begin (set! rax 17214) (jump r15)))
    (define L.__nested.6 (begin (set! rax 9790) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.5
...
(check-by-interp
 '(module
    ...
    (define L.__nested.6 (begin (set! rax 14398) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.9
      (begin
...
(check-by-interp
 '(module
    ...
    (define L.__nested.6 (begin (set! rax 13118) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.8
      (begin
...
(check-by-interp
 '(module
    ...
    (define L.__nested.10 (begin (set! rax 25390) (jump (rbp - 0))))
...
(check-by-interp
 '(module
    ...
    (define L.tmp.21
      (begin (set! r15 14) (if (true) (jump L.tmp.17) (jump L.tmp.18))))
    (define L.tmp.17
      (begin (set! r15 6) (if (false) (jump L.tmp.14) (jump L.tmp.15))))
    (define L.tmp.18
      (begin (set! r15 6) (if (false) (jump L.tmp.14) (jump L.tmp.15))))
    (define L.rp.13
 ...
 '(module
    (define L.__main.13
      (begin
        ...
        (set! r15 28222)
        (set! r15 6)
        (if (false) (jump L.__nested.8) (jump L.__nested.9))))
    (define L.-.6
      (begin
        (set! r15 r15)
        (set! r13 rdi)
 ...
 '(module
    (define L.__main.13
      (begin
        (set! r15 r15)
        (set! r14 14)
        (if (true) (jump L.tmp.11) (jump L.tmp.12))))
    (define L.tmp.11
      (begin
        (set! r14 6)
    ...
    (define L.tmp.12
      (begin
        (set! r14 14)
        (if (true) (jump L.__nested.5) (jump L.__nested.6))))
    (define L.__nested.7 (begin (set! rax 46654) (jump r15)))
    (define L.__nested.8 (begin (set! rax 42046) (jump r15)))
    (define L.__nested.9 (begin (set! rax 33598) (jump r15)))
    (define L.__nested.10 (begin (set! rax 58174) (jump r15)))
    (define L.__nested.5
      (begin
        (set! r14 6)
        (if (false) (jump L.__nested.7) (jump L.__nested.8))))
    (define L.__nested.6
      (begin
        (set! r14 14)
        (if (true) (jump L.__nested.9) (jump L.__nested.10))))))
(check-by-interp
 '(module
    (define L.__main.16
      (begin
...
(check-by-interp
 '(module
    ...
    (define L.tmp.14 (begin (set! r15 1200) (jump L.tmp.15)))
    (define L.tmp.15
      (begin (set! r14 14) (if (true) (jump L.tmp.10) (jump L.tmp.11))))
    (define L.tmp.10 (begin (set! r14 1000) (jump L.tmp.12)))
    (define L.tmp.11 (begin (set! r14 1256) (jump L.tmp.12)))
    (define L.tmp.12
      (begin (set! rsi r14) (set! rdi r15) (set! r15 (rbp - 0)) (jump L.*.6)))
    (define L.tmp.19 (begin (set! r15 1464) (jump L.tmp.21)))
    (define L.tmp.20 (begin (set! r15 360) (jump L.tmp.21)))
    (define L.tmp.21
      (begin (set! r14 14) (if (true) (jump L.tmp.16) (jump L.tmp.17))))
    (define L.tmp.16 (begin (set! r14 72) (jump L.tmp.18)))
    (define L.tmp.17 (begin (set! r14 816) (jump L.tmp.18)))
    (define L.tmp.18
      (begin (set! rsi r14) (set! rdi r15) (set! r15 (rbp - 0)) (jump L.*.6)))
    (define L.__nested.8
      (begin (set! r15 14) (if (true) (jump L.tmp.13) (jump L.tmp.14))))
    (define L.__nested.9
