...
(check-by-interp
 '(module
    ((locals (empty2.1 fixnum1.2 fixnum0.3))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (tmp.60 tmp.67 tmp.62 tmp.61 error2.7 empty1.8 ascii-char0.9))
     (conflicts
      ((tmp-ra.66
        (rdi
         rsi
...
(check-by-interp
 '(module
    ((locals (tmp.81 tmp.65 tmp.66 tmp.80 tmp.64 tmp.63))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (ascii-char3.1 void2.2 void1.3 void0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void3.1 fixnum2.2 tmp.70 fixnum1.3 tmp.68 empty0.4))
     (conflicts
      ((tmp-ra.77
        (void3.1
         fixnum2.2
...
(check-by-interp
 '(module
    ((locals (ascii-char3.1 void1.3 error0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (tmp.55 error3.1 error2.2 error1.3 empty0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void3.1 ascii-char2.2 empty0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (ascii-char3.1 fixnum2.2 tmp.64 ascii-char1.3))
     (conflicts
      ((tmp-ra.70
...
(check-by-interp
 '(module
    ((locals
      (void4.1 fixnum3.2 tmp.68 tmp.70 tmp.67 boolean1.4 tmp.64 ascii-char0.5))
     (conflicts
      ((tmp-ra.78
        (void4.1
         fixnum3.2
...
(check-by-interp
 '(module
    ((locals (ascii-char4.1 error2.3 ascii-char1.4 ascii-char0.5))
     (conflicts
      ((tmp-ra.60
...
(check-by-interp
 '(module
    ((locals (error4.1 void3.2 ascii-char2.3 void1.4 error0.5))
     (conflicts
...
(check-by-interp
 '(module
    ((locals
      (error4.1 void3.2 fixnum2.3 tmp.71 tmp.73 tmp.70 empty1.4 error0.5))
     (conflicts
      ((tmp-ra.82
        (error4.1
         void3.2
...
(check-by-interp
 '(module
    ((locals
      (error4.1 void3.2 empty2.3 empty1.4 fixnum0.5 tmp.67 tmp.69 tmp.66))
     (conflicts
      ((tmp-ra.77
        (error4.1
         void3.2
...
(check-by-interp
 '(module
    ((locals (void4.1 void3.2 fixnum2.3 tmp.66 tmp.68 tmp.65 ascii-char0.5))
     (conflicts
      ((tmp-ra.75
        (void4.1
         void3.2
...
(check-by-interp
 '(module
    ((locals (empty4.1 error3.2 empty2.3 empty1.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals
      (tmp.71 tmp.73 tmp.70 void4.1 ascii-char3.2 void2.3 void1.4 empty0.5))
     (conflicts
      ((tmp-ra.82
        (rdi
         rsi
...
(check-by-interp
 '(module
    ((locals (ascii-char4.1 void3.2 void2.3 empty1.4 void0.5))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void5.1 void4.2 void3.3 empty2.4 void0.6))
     (conflicts
