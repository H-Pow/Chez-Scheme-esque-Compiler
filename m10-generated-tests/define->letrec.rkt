...
(check-by-interp
 '(module
    (define fun/void8493.7 (lambda () (void)))
 ...
 '(module
    ...
    (define vector-set!.83
      (lambda (tmp.60 tmp.61 tmp.62)
        (if (fixnum? tmp.61)
          (if (vector? tmp.60)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.60 tmp.61 tmp.62)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.30)
        (let ((tmp.31 (unsafe-make-vector tmp.30)))
          (unsafe-procedure-call vector-init-loop.32 tmp.30 0 tmp.31))))
    ...
    (let ((tmp.7.15
           (let ((procedure0.16
                  (lambda ()
                    (let ((tmp.8.17 (unsafe-procedure-call make-vector.82 8)))
                      (let ((g42054139.18
                             (unsafe-procedure-call
                              vector-set!.83
                              tmp.8.17
                        ...
                        (if (unsafe-procedure-call error?.84 g42054139.18)
                          ...
                          (let ((g42054140.19
                                 (unsafe-procedure-call
                                  ...
                                  1
                                  2)))
                            (if (unsafe-procedure-call error?.84 g42054140.19)
                              g42054140.19
                              (let ((g42054141.20
                                     (unsafe-procedure-call
                                      vector-set!.83
...
(check-by-interp
 '(module
    ...
    (define fun/void8530.8 (lambda () (unsafe-procedure-call fun/void8531.7)))
...
(check-by-interp
 '(module
    ...
    (define fun/void8538.8 (lambda () (unsafe-procedure-call fun/void8539.7)))
...
(check-by-interp
 '(module
    (define fun/void8553.7 (lambda () (unsafe-procedure-call fun/void8554.8)))
    (define fun/void8554.8 (lambda () (void)))
    (define fun/void8552.9
                      ...
                      (let ((g42119033.15 (if #t (error 147) (error 181))))
                        (if (unsafe-procedure-call error?.69 g42119033.15)
                          ...
                          (let ((g42119034.16
                            ...
                            (if (unsafe-procedure-call error?.69 g42119034.16)
                              g42119034.16
                              (error 211)))))))))))))
      #f)))
(check-by-interp
...
(check-by-interp
 '(module
    ...
    (define fun/ascii-char8591.8
      (lambda (oprand0.13) (unsafe-procedure-call fun/ascii-char8592.9)))
        ...
        (let ((tmp.7.14 (unsafe-procedure-call make-vector.76 8)))
          (let ((g42161003.15
            ...
            (if (unsafe-procedure-call error?.78 g42161003.15)
              g42161003.15
              (let ((g42161004.16
                     (unsafe-procedure-call vector-set!.77 tmp.7.14 1 2)))
                (if (unsafe-procedure-call error?.78 g42161004.16)
                  g42161004.16
                  (let ((g42161005.17
                         (unsafe-procedure-call vector-set!.77 tmp.7.14 2 3)))
                    (if (unsafe-procedure-call error?.78 g42161005.17)
                      ...
                      (let ((g42161006.18
                             (unsafe-procedure-call
                              ...
                              3
                              4)))
                        (if (unsafe-procedure-call error?.78 g42161006.18)
                          g42161006.18
                          (let ((g42161007.19
                                 (unsafe-procedure-call
                                  vector-set!.77
                                  ...
                                  4
                                  5)))
                            (if (unsafe-procedure-call error?.78 g42161007.19)
                              g42161007.19
                              (let ((g42161008.20
                                     (unsafe-procedure-call
                                      vector-set!.77
...
(check-by-interp
 '(module
    (define fun/ascii-char8622.7
      (lambda () (unsafe-procedure-call fun/ascii-char8623.8)))
    (define fun/ascii-char8623.8
 ...
 '(module
    ...
    (define vector-set!.117
      (lambda (tmp.92 tmp.93 tmp.94)
        (if (fixnum? tmp.93)
          (if (vector? tmp.92)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.92 tmp.93 tmp.94)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.62)
        (let ((tmp.63 (unsafe-make-vector tmp.62)))
          (unsafe-procedure-call vector-init-loop.64 tmp.62 0 tmp.63))))
          ...
          (if (if #t empty empty)
            (if (if (let ((tmp.7.30 empty))
                  ...
                  (if (if #t empty empty)
                    ...
                    #f)
                  #f)
              (let ((g42195365.36 (unsafe-procedure-call fun/empty8629.25 #f)))
                                       ...
                                       (if tmp.14.42
                                         ...
                                         (let ((tmp.15.43 empty))
                                           (if tmp.15.43
                                             tmp.15.43
                                             empty))))))))
                            (if (unsafe-procedure-call error?.114 g42195368.40)
                              g42195368.40
                              (let ((g42195369.44
                                     (let ((pair0.46
                                            (unsafe-procedure-call
                     ...
                     (if (let ((procedure0.26
                                (lambda ()
                                  (unsafe-procedure-call
                                   cons.82
                                   98
                                   (unsafe-procedure-call cons.82 276 empty))))
                               (boolean1.25 #f))
                           empty)
                       (if #t empty empty)
                       #f)
...
(check-by-interp
 '(module
    (define fun/error8653.7
      (lambda () (unsafe-procedure-call fun/error8654.8)))
    (define fun/error8654.8
                         ...
                         (if (unsafe-procedure-call error?.79 g42237369.17)
                           ...
                           (let ((g42237370.18
                                  (unsafe-procedure-call
                                   ...
                                   3
                                   3)))
                             (if (unsafe-procedure-call error?.79 g42237370.18)
                               g42237370.18
                               (let ((g42237371.19
                                      (unsafe-procedure-call
                                       vector-set!.78
 ...
 '(module
    ...
    (define vector-set!.110
      (lambda (tmp.86 tmp.87 tmp.88)
        (if (fixnum? tmp.87)
          (if (vector? tmp.86)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.86 tmp.87 tmp.88)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.56)
        (let ((tmp.57 (unsafe-make-vector tmp.56)))
          (unsafe-procedure-call vector-init-loop.58 tmp.56 0 tmp.57))))
    ...
    (define fun/void8489.10
      (lambda (oprand0.20 oprand1.19) (unsafe-procedure-call fun/void8490.13)))
    ...
    (define fun/void8495.12
      (lambda (oprand0.24 oprand1.23) (unsafe-procedure-call fun/void8496.15)))
    (define fun/void8490.13
                       ...
                       (if (unsafe-procedure-call error?.111 g42252655.42)
                         ...
                         (let ((g42252656.46
                                (let ((boolean0.49 #f)
                                      ...
                                      (fixnum2.47 165))
                                  #\k)))
                           (if (unsafe-procedure-call error?.111 g42252656.46)
                             g42252656.46
                             (let ((g42252657.50
                                    (unsafe-procedure-call
 ...
 '(module
    ...
    (define vector-set!.88
      (lambda (tmp.65 tmp.66 tmp.67)
        (if (fixnum? tmp.66)
          (if (vector? tmp.65)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.65 tmp.66 tmp.67)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.35)
        (let ((tmp.36 (unsafe-make-vector tmp.35)))
          (unsafe-procedure-call vector-init-loop.37 tmp.35 0 tmp.36))))
         ...
         (let ((tmp.7.14 (unsafe-procedure-call make-vector.87 8)))
           (let ((g42305850.15
             ...
             (if (unsafe-procedure-call error?.89 g42305850.15)
               g42305850.15
               (let ((g42305851.16
                      (unsafe-procedure-call vector-set!.88 tmp.7.14 1 1)))
                 (if (unsafe-procedure-call error?.89 g42305851.16)
                   g42305851.16
                   (let ((g42305852.17
                          (unsafe-procedure-call vector-set!.88 tmp.7.14 2 2)))
                     (if (unsafe-procedure-call error?.89 g42305852.17)
                       ...
                       (let ((g42305853.18
                              (unsafe-procedure-call
                               ...
                               3
                               3)))
                         (if (unsafe-procedure-call error?.89 g42305853.18)
                           g42305853.18
                           (let ((g42305854.19
                                  (unsafe-procedure-call
                                   vector-set!.88
                                   ...
                                   4
                                   4)))
                             (if (unsafe-procedure-call error?.89 g42305854.19)
                               g42305854.19
                               (let ((g42305855.20
                                      (unsafe-procedure-call
                                       vector-set!.88
    ...
    (define make-init-vector.4
      (lambda (tmp.87)
        (let ((tmp.88 (unsafe-make-vector tmp.87)))
          (unsafe-procedure-call vector-init-loop.89 tmp.87 0 tmp.88))))
                  ...
                  (let ((g42328635.83
                         (let ((g42328636.84
                                (unsafe-procedure-call
                                 cons.139
                                 23
                                 (unsafe-procedure-call cons.139 399 empty))))
                           (if (unsafe-procedure-call error?.142 g42328636.84)
                             g42328636.84
                             (unsafe-procedure-call
                              cons.139
                              163
                          ...
                          (let ((g42328638.86
                                 (if #t
                                   (unsafe-procedure-call
                                    cons.139
                                    59
                                    (unsafe-procedure-call cons.139 331 empty))
                                   (unsafe-procedure-call
                                    cons.139
                                    18
                                    (unsafe-procedure-call
                                     ...
                                     310
                                     empty)))))
                            (if (unsafe-procedure-call error?.142 g42328638.86)
                              g42328638.86
                              (unsafe-procedure-call
                               fun/pair8504.16
                               (void)
             ...
             (let ((tmp.7.13 (unsafe-procedure-call make-vector.74 8)))
               (let ((g42343841.14
                 ...
                 (if (unsafe-procedure-call error?.76 g42343841.14)
                   g42343841.14
                   (let ((g42343842.15
                          (unsafe-procedure-call vector-set!.75 tmp.7.13 1 2)))
                         ...
                         (if (unsafe-procedure-call error?.76 g42343843.16)
                           ...
                           (let ((g42343844.17
                                  (unsafe-procedure-call
                                   ...
                                   3
                                   4)))
                             (if (unsafe-procedure-call error?.76 g42343844.17)
                               g42343844.17
                               (let ((g42343845.18
                                      (unsafe-procedure-call
                                       vector-set!.75
             ...
             (if (unsafe-procedure-call error?.78 g42347666.14)
               ...
               (let ((g42347667.15
                 ...
                 (if (unsafe-procedure-call error?.78 g42347667.15)
                   g42347667.15
                   (let ((g42347668.16
                          (unsafe-procedure-call vector-set!.77 tmp.7.13 2 3)))
                         ...
                         (if (unsafe-procedure-call error?.78 g42347669.17)
                           ...
                           (let ((g42347670.18
                                  (unsafe-procedure-call
                                   ...
                                   4
                                   5)))
                             (if (unsafe-procedure-call error?.78 g42347670.18)
                               g42347670.18
                               (let ((g42347671.19
                                      (unsafe-procedure-call
                                       vector-set!.77
             ...
             (if (unsafe-procedure-call error?.89 g42366676.18)
               ...
               (let ((g42366677.19
                 ...
                 (if (unsafe-procedure-call error?.89 g42366677.19)
                   g42366677.19
                   (let ((g42366678.20
                          (unsafe-procedure-call vector-set!.88 tmp.7.17 2 3)))
                         ...
                         (if (unsafe-procedure-call error?.89 g42366679.21)
                           ...
                           (let ((g42366680.22
                                  (unsafe-procedure-call
                                   ...
                                   4
                                   5)))
                             (if (unsafe-procedure-call error?.89 g42366680.22)
                               g42366680.22
                               (let ((g42366681.23
                                      (unsafe-procedure-call
                                       vector-set!.88
             ...
             (if (unsafe-procedure-call error?.89 g42366684.27)
               ...
               (let ((g42366685.28
                 ...
                 (if (unsafe-procedure-call error?.89 g42366685.28)
                   g42366685.28
                   (let ((g42366686.29
                          (unsafe-procedure-call vector-set!.88 tmp.8.26 2 3)))
                         ...
                         (if (unsafe-procedure-call error?.89 g42366687.30)
                           ...
                           (let ((g42366688.31
                                  (unsafe-procedure-call
                                   ...
                                   4
                                   5)))
                             (if (unsafe-procedure-call error?.89 g42366688.31)
                               g42366688.31
                               (let ((g42366689.32
                                      (unsafe-procedure-call
                                       vector-set!.88
    ...
    (define make-init-vector.4
      (lambda (tmp.165)
        (let ((tmp.166 (unsafe-make-vector tmp.165)))
          (unsafe-procedure-call vector-init-loop.167 tmp.165 0 tmp.166))))
                      ...
                      (if (unsafe-procedure-call error?.218 g42374307.90)
                        ...
                        (let ((g42374313.104
                               (let ((vector0.107
                                 ...
                                 empty)))
                          (if (unsafe-procedure-call error?.218 g42374313.104)
                            g42374313.104
                            (let ((g42374322.117
                                   (let ((g42374323.118
 ...
 '(module
    ...
    (define vector-set!.85
      (lambda (tmp.61 tmp.62 tmp.63)
        (if (fixnum? tmp.62)
          (if (vector? tmp.61)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.61 tmp.62 tmp.63)
            (error 10))
          (error 10))))
 ...
 '(module
    ...
    (define vector-set!.100
      (lambda (tmp.77 tmp.78 tmp.79)
        (if (fixnum? tmp.78)
          (if (vector? tmp.77)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.77 tmp.78 tmp.79)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.47)
        (let ((tmp.48 (unsafe-make-vector tmp.47)))
          (unsafe-procedure-call vector-init-loop.49 tmp.47 0 tmp.48))))
        ...
        (let ((tmp.7.17 (unsafe-procedure-call make-vector.99 8)))
          (let ((g42409226.18
            ...
            (if (unsafe-procedure-call error?.101 g42409226.18)
              g42409226.18
              (let ((g42409227.19
                     (unsafe-procedure-call vector-set!.100 tmp.7.17 1 2)))
                (if (unsafe-procedure-call error?.101 g42409227.19)
                  g42409227.19
                  (let ((g42409228.20
                         (unsafe-procedure-call vector-set!.100 tmp.7.17 2 3)))
                    (if (unsafe-procedure-call error?.101 g42409228.20)
                      ...
                      (let ((g42409229.21
                             (unsafe-procedure-call
                              ...
                              3
                              4)))
                        (if (unsafe-procedure-call error?.101 g42409229.21)
                          g42409229.21
                          (let ((g42409230.22
                                 (unsafe-procedure-call
                                  vector-set!.100
                                  ...
                                  4
                                  5)))
                            (if (unsafe-procedure-call error?.101 g42409230.22)
                              g42409230.22
                              (let ((g42409231.23
                                     (unsafe-procedure-call
                                      vector-set!.100
                     ...
                     (let ((g42409235.31 (error 134)))
                       (if (unsafe-procedure-call error?.101 g42409235.31)
                         ...
                         (let ((g42409236.32 (error 216)))
                           (if (unsafe-procedure-call error?.101 g42409236.32)
                             g42409236.32
                             (error 132)))))))))
            (if tmp.9.29
              tmp.9.29
                      ...
                      (let ((tmp.13.44 (let ((fixnum0.45 172)) (error 184))))
                        (if tmp.13.44
                          ...
                          (let ((g42409245.46 (error 89)))
                            (if (unsafe-procedure-call error?.101 g42409245.46)
                              g42409245.46
                              (error 219))))))))))))))))
(check-by-interp
 '(module
                ...
                (let ((tmp.9.13
                       (let ((g42413066.14 #t))
                         (if (unsafe-procedure-call error?.72 g42413066.14)
                           g42413066.14
                           (let ((g42413067.15 #t))
                             (if (unsafe-procedure-call error?.72 g42413067.15)
                               g42413067.15
                               (let ((g42413068.16 #f))
                                 (if (unsafe-procedure-call
                                      error?.72
                       ...
                       (if (unsafe-procedure-call error?.76 g42424519.15)
                         ...
                         (let ((g42424520.16
                                (unsafe-procedure-call
                                 ...
                                 tmp.7.12
                                 3
                                 (let ((tmp.81 (if #t (error 221) (error 62))))
                                   (if (procedure? tmp.81)
                                     (if (eq?
...
(check-by-interp
 '(module
    ...
    (define fun/procedure8496.9
      (lambda (oprand0.12) (unsafe-procedure-call fun/procedure8497.10)))
...
(check-by-interp
 '(module
    (define fun/error8502.7
      (lambda () (unsafe-procedure-call fun/error8503.9)))
    (define fun/error8501.8
 ...
 '(module
    ...
    (define vector-set!.85
      (lambda (tmp.62 tmp.63 tmp.64)
        (if (fixnum? tmp.63)
          (if (vector? tmp.62)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.62 tmp.63 tmp.64)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.32)
        (let ((tmp.33 (unsafe-make-vector tmp.32)))
          (unsafe-procedure-call vector-init-loop.34 tmp.32 0 tmp.33))))
    (define make-vector.84
      (lambda (tmp.60)
        (if (fixnum? tmp.60)
 ...
 '(module
    ...
    (define vector-set!.103
      (lambda (tmp.79 tmp.80 tmp.81)
        (if (fixnum? tmp.80)
          (if (vector? tmp.79)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.79 tmp.80 tmp.81)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.49)
        (let ((tmp.50 (unsafe-make-vector tmp.49)))
          (unsafe-procedure-call vector-init-loop.51 tmp.49 0 tmp.50))))
        ...
        (if (let ((boolean0.25
                   (let ((empty0.27 empty)
                         (procedure1.26
                          (lambda ()
                            (let ((tmp.7.28
                                   (unsafe-procedure-call make-vector.102 8)))
                              (let ((g42447437.29
                                     (unsafe-procedure-call
                                      vector-set!.103
                                      tmp.7.28
    ...
    (define make-init-vector.4
      (lambda (tmp.80)
        (let ((tmp.81 (unsafe-make-vector tmp.80)))
          (unsafe-procedure-call vector-init-loop.82 tmp.80 0 tmp.81))))
                   ...
                   (if (unsafe-procedure-call error?.132 g42455086.43)
                     ...
                     (let ((g42455087.44 #\`))
                       (if (unsafe-procedure-call error?.132 g42455087.44)
                         g42455087.44
                         (let ((g42455088.45 #\a))
                           (if (unsafe-procedure-call error?.132 g42455088.45)
                             g42455088.45
                             (let ((g42455089.46 #\O))
                               (if (unsafe-procedure-call
                                    error?.132
                          ...
                          (let ((tmp.7.53
                            ...
                            (let ((g42455093.54
                                   (unsafe-procedure-call
                                    ...
                                    tmp.7.53
                                    0
                                    (unsafe-procedure-call (lambda () 902)))))
                              (if (unsafe-procedure-call
                                   error?.132
                                   g42455093.54)
                                g42455093.54
            ...
            (if (unsafe-procedure-call error?.91 g42462740.20)
              ...
              (let ((g42462741.21
                ...
                (if (unsafe-procedure-call error?.91 g42462741.21)
                  g42462741.21
                  (let ((g42462742.22
                         (unsafe-procedure-call vector-set!.90 tmp.7.19 2 3)))
                        ...
                        (if (unsafe-procedure-call error?.91 g42462743.23)
                          ...
                          (let ((g42462744.24
                                 (unsafe-procedure-call
                                  ...
                                  4
                                  5)))
                            (if (unsafe-procedure-call error?.91 g42462744.24)
                              g42462744.24
                              (let ((g42462745.25
                                     (unsafe-procedure-call
                                      vector-set!.90
...
(check-by-interp
 '(module
    ...
    (define fun/empty8585.7
      (lambda () (unsafe-procedure-call fun/empty8586.9)))
    (define fun/empty8584.8
 ...
 '(module
    ...
    (define vector-set!.113
      (lambda (tmp.89 tmp.90 tmp.91)
        (if (fixnum? tmp.90)
          (if (vector? tmp.89)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.89 tmp.90 tmp.91)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.59)
        (let ((tmp.60 (unsafe-make-vector tmp.59)))
          (unsafe-procedure-call vector-init-loop.61 tmp.59 0 tmp.60))))
                                  ...
                                  (let ((tmp.118
                                    ...
                                    (if (procedure? tmp.118)
                                      (if (eq?
                                        ...
                                        (error 42))
                                      (error 43))))))
                            (if (unsafe-procedure-call error?.114 g42474207.26)
                              g42474207.26
                              (let ((g42474208.27
                                     (unsafe-procedure-call
                                      vector-set!.113
                                      ...
                                      (let ((tmp.119 (void)))
                                        (if (procedure? tmp.119)
                                          (if (eq?
                                               (unsafe-procedure-arity tmp.119)
                                               0)
                                  ...
                                  (let ((tmp.125
                                    ...
                                    (if (procedure? tmp.125)
                                      (if (eq?
                                        ...
                                        (error 42))
                                      (error 43))))))
                            (if (unsafe-procedure-call error?.114 g42474223.44)
                              g42474223.44
                              (let ((g42474232.54
                                     (unsafe-procedure-call
                                      vector-set!.113
                                      ...
                                      (let ((tmp.126 #f))
                                        (if (procedure? tmp.126)
                                          (if (eq?
                                               (unsafe-procedure-arity tmp.126)
                                               0)
 ...
 '(module
    ...
    (define vector-set!.80
      (lambda (tmp.56 tmp.57 tmp.58)
        (if (fixnum? tmp.57)
          (if (vector? tmp.56)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.56 tmp.57 tmp.58)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.26)
        (let ((tmp.27 (unsafe-make-vector tmp.26)))
          (unsafe-procedure-call vector-init-loop.28 tmp.26 0 tmp.27))))
 ...
 '(module
    ...
    (define make-init-vector.4
      (lambda (tmp.156)
        (let ((tmp.157 (unsafe-make-vector tmp.156)))
          (unsafe-procedure-call vector-init-loop.158 tmp.156 0 tmp.157))))
    ...
    (define fun/fixnum8623.40
      (lambda (oprand0.48 oprand1.47)
        (if (unsafe-procedure-call fun/boolean8624.39) oprand1.47 oprand1.47)))
    ...
    (unsafe-procedure-call
     ...
     (if (let ((tmp.14.74
       ...
       (if (if 32
             (if (unsafe-procedure-call
                  fun/fixnum8628.37
                  (let ((tmp.19.90 (unsafe-procedure-call make-vector.208 8)))
                    (let ((g42493342.91
                           (unsafe-procedure-call
                            vector-set!.209
                            tmp.19.90
                     ...
                     (let ((g42519973.31 (void)))
                       (if (unsafe-procedure-call error?.140 g42519973.31)
                         ...
                         (let ((g42519974.32 (void)))
                           (if (unsafe-procedure-call error?.140 g42519974.32)
                             g42519974.32
 ...
 '(module
    ...
    (define vector-set!.87
      (lambda (tmp.64 tmp.65 tmp.66)
        (if (fixnum? tmp.65)
          (if (vector? tmp.64)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.64 tmp.65 tmp.66)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.34)
        (let ((tmp.35 (unsafe-make-vector tmp.34)))
          (unsafe-procedure-call vector-init-loop.36 tmp.34 0 tmp.35))))
             ...
             (let ((tmp.8.25 (unsafe-procedure-call make-vector.86 8)))
               (let ((g42531475.26
                 ...
                 (if (unsafe-procedure-call error?.88 g42531475.26)
                   g42531475.26
                   (let ((g42531476.27
                          (unsafe-procedure-call vector-set!.87 tmp.8.25 1 2)))
                         ...
                         (if (unsafe-procedure-call error?.88 g42531477.28)
                           ...
                           (let ((g42531478.29
                                  (unsafe-procedure-call
                                   ...
                                   3
                                   4)))
                             (if (unsafe-procedure-call error?.88 g42531478.29)
                               g42531478.29
                               (let ((g42531479.30
                                      (unsafe-procedure-call
                                       vector-set!.87
 ...
 '(module
    ...
    (define vector-set!.99
      (lambda (tmp.75 tmp.76 tmp.77)
        (if (fixnum? tmp.76)
          (if (vector? tmp.75)
            (unsafe-procedure-call unsafe-vector-set!.5 tmp.75 tmp.76 tmp.77)
            (error 10))
          (error 10))))
    ...
    (define make-init-vector.4
      (lambda (tmp.45)
        (let ((tmp.46 (unsafe-make-vector tmp.45)))
          (unsafe-procedure-call vector-init-loop.47 tmp.45 0 tmp.46))))
                                 ...
                                 (let ((tmp.104
                                   ...
                                   (if (procedure? tmp.104)
                                     (if (eq?
                                       ...
                                       (error 42))
                                     (error 43))))))
                           (if (unsafe-procedure-call error?.100 g42535306.19)
                             g42535306.19
                             (let ((g42535325.40
                                    (unsafe-procedure-call
                                     vector-set!.99
...
(check-by-interp
 '(module
    ...
    (let ((fixnum0.13 (let () 133))
          ...
          (procedure2.11 (lambda () (unsafe-procedure-call fun/error8675.9))))
      (if #t 142 249))))
(check-by-interp
 '(module
            ...
            (if (unsafe-procedure-call error?.92 g42546779.21)
              ...
              (let ((g42546780.22
                ...
                (if (unsafe-procedure-call error?.92 g42546780.22)
                  g42546780.22
                  (let ((g42546781.23
                         (unsafe-procedure-call vector-set!.91 tmp.7.20 2 3)))
                        ...
                        (if (unsafe-procedure-call error?.92 g42546782.24)
                          ...
                          (let ((g42546783.25
                                 (unsafe-procedure-call
                                  ...
                                  4
                                  5)))
                            (if (unsafe-procedure-call error?.92 g42546783.25)
                              g42546783.25
                              (let ((g42546784.26
                                     (unsafe-procedure-call
                                      vector-set!.91
            ...
            (if (unsafe-procedure-call error?.92 g42546787.30)
              ...
              (let ((g42546788.31
                ...
                (if (unsafe-procedure-call error?.92 g42546788.31)
                  g42546788.31
                  (let ((g42546789.32
                         (unsafe-procedure-call vector-set!.91 tmp.8.29 2 3)))
                        ...
                        (if (unsafe-procedure-call error?.92 g42546790.33)
                          ...
                          (let ((g42546791.34
                                 (unsafe-procedure-call
                                  ...
                                  4
                                  5)))
                            (if (unsafe-procedure-call error?.92 g42546791.34)
                              g42546791.34
                              (let ((g42546792.35
                                     (unsafe-procedure-call
                                      vector-set!.91
...
(check-by-interp
 '(module
    ...
    (define fun/void8713.8 (lambda () (unsafe-procedure-call fun/void8714.7)))
