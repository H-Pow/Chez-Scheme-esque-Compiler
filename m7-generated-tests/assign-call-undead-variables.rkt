...
(require rackunit
         cpsc411/langs/v7
         (only-in "../assign-call-undead-variables.rkt" assign-call-undead-variables))

(define (check-asm-pred-lang-v7/conflicts p)
  (if (asm-pred-lang-v7/conflicts? p) p #f))

(define (check-asm-pred-lang-v7/pre-framed p)
  (if (asm-pred-lang-v7/pre-framed? p) p #f))

(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-asm-pred-lang-v7/conflicts (check-asm-pred-lang-v7/conflicts p))
                (interp-asm-pred-lang-v7/pre-framed
                 (check-asm-pred-lang-v7/pre-framed (assign-call-undead-variables p)))))

;;; Added by Trevor on 2026-03-19

(check-by-interp '(module ((new-frames ()) (locals (tmp-ra.24))
                                           (call-undead ())
                                           (undead-out ((tmp-ra.24 rbp) (tmp-ra.24 rax rbp)
                                                                        (rax rbp)))
                                           (conflicts ((tmp-ra.24 (rax rbp)) (rbp (rax tmp-ra.24))
                                                                             (rax (rbp tmp-ra.24)))))
                          (begin
                            (set! tmp-ra.24 r15)
                            (set! rax 0)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.29))
                           (call-undead ())
                           (undead-out ((tmp-ra.29 rbp) (tmp-ra.29 rsi rbp)
                                                        (tmp-ra.29 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.29 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.29))
          ...
          (define L.+.1
            ((new-frames ())
             ...
             (undead-out
              ((rdi rsi tmp-ra.28 rbp)
               (rsi tmp.3 tmp-ra.28 rbp)
               (tmp.3 tmp.4 tmp-ra.28 rbp)
               ((((((tmp.30 tmp.3 tmp.4 tmp-ra.28 rbp) (tmp.30 tmp.3 tmp.4 tmp-ra.28 rbp)
                                                       (tmp.25 tmp.3 tmp.4 tmp-ra.28 rbp))
                   (tmp.3 tmp.4 tmp-ra.28 rbp))
                  (tmp.24 tmp.3 tmp.4 tmp-ra.28 rbp)
                  (tmp.24 tmp.3 tmp.4 tmp-ra.28 rbp))
                 (tmp.3 tmp.4 tmp-ra.28 rbp))
                ((((((tmp.31 tmp.3 tmp.4 tmp-ra.28 rbp) (tmp.31 tmp.3 tmp.4 tmp-ra.28 rbp)
                                                        (tmp.27 tmp.3 tmp.4 tmp-ra.28 rbp))
                    (tmp.3 tmp.4 tmp-ra.28 rbp))
                   (tmp.26 tmp.3 tmp.4 tmp-ra.28 rbp)
                   (tmp.26 tmp.3 tmp.4 tmp-ra.28 rbp))
                  (tmp.3 tmp.4 tmp-ra.28 rbp))
                 ((tmp.4 tmp.32 tmp-ra.28 rbp) (tmp.32 tmp-ra.28 rbp) (tmp-ra.28 rax rbp) (rax rbp))
                 ((tmp-ra.28 rax rbp) (rax rbp)))
                ((tmp-ra.28 rax rbp) (rax rbp)))))
             (call-undead ())
             (conflicts
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.25))
           (call-undead ())
           (undead-out ((tmp-ra.25 rbp) (tmp-ra.25 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.25 (rdi rbp)) (rbp (r15 rdi tmp-ra.25))
                                             (rdi (r15 rbp tmp-ra.25))
                                             (r15 (rbp rdi)))))
          (define L.not.1
            ((new-frames ())
             (locals (tmp-ra.24 tmp.23))
             (undead-out ((rdi tmp-ra.24 rbp) (tmp.23 tmp-ra.24 rbp)
                                              ((tmp-ra.24 rbp) ((tmp-ra.24 rax rbp) (rax rbp))
...
(check-by-interp
 '(module ((new-frames ())
    ...
    (begin
      ...
      (jump L.not.1 rbp r15 rdi))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.24 tmp.25))
                           (call-undead ())
                           (undead-out ((tmp-ra.24 rbp) (((tmp.25 tmp-ra.24 rbp) (tmp-ra.24 rbp))
                                                         ((tmp-ra.24 rax rbp) (rax rbp))
                                                         ((tmp-ra.24 rax rbp) (rax rbp)))))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.26))
           (call-undead ())
           (undead-out ((tmp-ra.26 rbp) (tmp-ra.26 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.26 (rdi rbp)) (rbp (r15 rdi tmp-ra.26))
                                             (rdi (r15 rbp tmp-ra.26))
                                             (r15 (rbp rdi)))))
          (define L.fixnum?.1
            ((new-frames ())
             (locals (tmp-ra.25 tmp.27 tmp.17 tmp.24))
             (undead-out ((rdi tmp-ra.25 rbp) (tmp.17 tmp-ra.25 rbp)
                                              ((((tmp.27 tmp-ra.25 rbp) (tmp.27 tmp-ra.25 rbp)
                                                                        (tmp.24 tmp-ra.25 rbp))
                                                (tmp-ra.25 rbp))
 ...
 '(module ((new-frames ())
          ...
          (define L.error?.1
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.25 rbp) (tmp.22 tmp-ra.25 rbp)
                                              ((((tmp.27 tmp-ra.25 rbp) (tmp.27 tmp-ra.25 rbp)
                                                                        (tmp.24 tmp-ra.25 rbp))
                                                (tmp-ra.25 rbp))
                                               ((tmp-ra.25 rax rbp) (rax rbp))
 ...
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.1
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.25 rbp) (tmp.21 tmp-ra.25 rbp)
                                              ((((tmp.27 tmp-ra.25 rbp) (tmp.27 tmp-ra.25 rbp)
                                                                        (tmp.24 tmp-ra.25 rbp))
                                                (tmp-ra.25 rbp))
                                               ((tmp-ra.25 rax rbp) (rax rbp))
 ...
 '(module ((new-frames ())
          ...
          (define L.boolean?.1
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.25 rbp) (tmp.18 tmp-ra.25 rbp)
                                              ((((tmp.27 tmp-ra.25 rbp) (tmp.27 tmp-ra.25 rbp)
                                                                        (tmp.24 tmp-ra.25 rbp))
                                                (tmp-ra.25 rbp))
                                               ((tmp-ra.25 rax rbp) (rax rbp))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (foobar.8.1 tmp-ra.25))
           (call-undead ())
           (undead-out ((tmp-ra.25 rbp) (foobar.8.1 tmp-ra.25 rbp) (tmp-ra.25 rax rbp) (rax rbp)))
...
(check-by-interp '(module ((new-frames ()) (locals (bat.1.1 foobar.2.2 tmp-ra.26))
                                           (call-undead ())
                                           (undead-out ((tmp-ra.26 rbp) (foobar.2.2 tmp-ra.26 rbp)
                                                                        (foobar.2.2 tmp-ra.26 rbp)
                                                                        (tmp-ra.26 rax rbp)
                                                                        (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.27))
           (call-undead ())
           (undead-out ((tmp-ra.27 rbp) (tmp-ra.27 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.27 (rdi rbp)) (rbp (r15 rdi tmp-ra.27))
                                             (rdi (r15 rbp tmp-ra.27))
                                             (r15 (rbp rdi)))))
          (define L.void?.2
            ((new-frames ())
             (locals (tmp-ra.25 tmp.28 tmp.20 tmp.24))
             (undead-out ((rdi tmp-ra.25 rbp) (tmp.20 tmp-ra.25 rbp)
                                              ((((tmp.28 tmp-ra.25 rbp) (tmp.28 tmp-ra.25 rbp)
                                                                        (tmp.24 tmp-ra.25 rbp))
                                                (tmp-ra.25 rbp))
                                               ((tmp-ra.25 rax rbp) (rax rbp))
                                               ((tmp-ra.25 rax rbp) (rax rbp)))))
    ...
    (define L.proc.0.1
      ((new-frames ()) (locals (tmp-ra.26))
                       (undead-out ((tmp-ra.26 rbp) (tmp-ra.26 rax rbp) (rax rbp)))
                       (call-undead ())
                       (conflicts ((tmp-ra.26 (rax rbp)) (rbp (rax tmp-ra.26))
                                                         (rax (rbp tmp-ra.26)))))
      (begin
        (set! tmp-ra.26 r15)
        (set! rax 14)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (tmp-ra.31 rsi rbp)
                                                        (tmp-ra.31 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.31 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.31))
          ...
          (define L.<=.2
            ((new-frames ())
             ...
             (undead-out
              ((rdi rsi tmp-ra.29 rbp)
               (rsi tmp.10 tmp-ra.29 rbp)
               (tmp.11 tmp.10 tmp-ra.29 rbp)
               ((((((tmp.32 tmp.11 tmp.10 tmp-ra.29 rbp) (tmp.32 tmp.11 tmp.10 tmp-ra.29 rbp)
                                                         (tmp.26 tmp.11 tmp.10 tmp-ra.29 rbp))
                   (tmp.11 tmp.10 tmp-ra.29 rbp))
                  (tmp.25 tmp.11 tmp.10 tmp-ra.29 rbp)
                  (tmp.25 tmp.11 tmp.10 tmp-ra.29 rbp))
                 (tmp.11 tmp.10 tmp-ra.29 rbp))
                ((((((tmp.33 tmp.11 tmp.10 tmp-ra.29 rbp) (tmp.33 tmp.11 tmp.10 tmp-ra.29 rbp)
                                                          (tmp.28 tmp.11 tmp.10 tmp-ra.29 rbp))
                    (tmp.11 tmp.10 tmp-ra.29 rbp))
                   (tmp.27 tmp.11 tmp.10 tmp-ra.29 rbp)
                   (tmp.27 tmp.11 tmp.10 tmp-ra.29 rbp))
                  (tmp.11 tmp.10 tmp-ra.29 rbp))
                 ((tmp-ra.29 rbp) ((tmp-ra.29 rax rbp) (rax rbp)) ((tmp-ra.29 rax rbp) (rax rbp)))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.30 rbp) (tmp-ra.30 rbp) (tmp-ra.30 rax rbp) (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (foo.5.1 foo.2.2 foobar.1.3 tmp-ra.27))
                           (call-undead ())
                           (undead-out ((tmp-ra.27 rbp) (tmp-ra.27 rbp)
                                                        (tmp-ra.27 rbp)
                                                        (tmp-ra.27 rbp)
                                                        (tmp-ra.27 rax rbp)
                                                        (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.30))
                           (call-undead ())
                           (undead-out ((tmp-ra.30 rbp) (tmp-ra.30 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.30 (rax rbp)) (rbp (rax tmp-ra.30))
                                                             (rax (rbp tmp-ra.30)))))
          (define L.x.0.1
            ((new-frames ())
             (locals (ball.5.1 ball.3.2 foo.8.3 ball.9.4 foo.4.5 tmp-ra.29))
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.29 rbp) (rsi rdx rcx r8 tmp-ra.29 rbp)
                                                             (rdx rcx r8 tmp-ra.29 rbp)
                                                             (rcx r8 tmp-ra.29 rbp)
                                                             (r8 tmp-ra.29 rbp)
                                                             (tmp-ra.29 rbp)
                                                             (tmp-ra.29 rax rbp)
                                                             (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (tmp-ra.31 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.31 (rax rbp)) (rbp (rax tmp-ra.31))
                                                             (rax (rbp tmp-ra.31)))))
          (define L.func.0.1
            ((new-frames ())
             (locals (foo.1.1 ball.0.2 bar.8.3 bat.5.4 foobar.9.5 foobar.2.6 tmp-ra.30))
             (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.30 rbp) (rsi rdx rcx r8 r9 tmp-ra.30 rbp)
                                                                (rdx rcx r8 r9 tmp-ra.30 rbp)
                                                                (rcx r8 r9 tmp-ra.30 rbp)
                                                                (r8 r9 tmp-ra.30 rbp)
                                                                (r9 tmp-ra.30 rbp)
                                                                (tmp-ra.30 rbp)
                                                                (tmp-ra.30 rax rbp)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.27))
                           (call-undead ())
                           (undead-out ((tmp-ra.27 rbp) (tmp-ra.27 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.27 (rax rbp)) (rbp (rax tmp-ra.27))
                                                             (rax (rbp tmp-ra.27)))))
          (define L.fn.0.1
            ((new-frames ())
             (locals (foo.5.1 tmp-ra.25))
             (undead-out ((rdi tmp-ra.25 rbp) (tmp-ra.25 rbp) (tmp-ra.25 rax rbp) (rax rbp)))
             (call-undead ())
    ...
    (begin
      ...
      (jump tmp-ra.27 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.29 tmp.30))
                           (call-undead ())
                           (undead-out ((tmp-ra.29 rbp) (((tmp.30 tmp-ra.29 rbp) (tmp-ra.29 rbp))
                                                         ((tmp-ra.29 rax rbp) (rax rbp))
                                                         ((tmp-ra.29 rax rbp) (rax rbp)))))
          ...
          (define L.func.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx tmp-ra.28 rbp) (rsi rdx rcx tmp-ra.28 rbp)
                                                          (rdx rcx tmp-ra.28 rbp)
                                                          (rcx tmp-ra.28 rbp)
                                                          (tmp-ra.28 rbp)
                                                          (tmp-ra.28 rax rbp)
                                                          (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.30))
                           (call-undead ())
                           (undead-out ((tmp-ra.30 rbp) (tmp-ra.30 rsi rbp)
                                                        (tmp-ra.30 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.30 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.30))
          ...
          (define L.eq?.2
            ((new-frames ())
             ...
             (undead-out ((rdi rsi tmp-ra.28 rbp) (rsi tmp.19 tmp-ra.28 rbp)
                                                  (tmp.20 tmp.19 tmp-ra.28 rbp)
                                                  ((tmp-ra.28 rbp) ((tmp-ra.28 rax rbp) (rax rbp))
                                                                   ((tmp-ra.28 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.29 rbp) (rsi rdx rcx tmp-ra.29 rbp)
                                                    (rdx rcx bar.4.3 tmp-ra.29 rbp)
                                                    (rcx bar.4.3 tmp-ra.29 rbp)
                                                    (bar.4.3 tmp-ra.29 rbp)
                                                    (tmp-ra.29 rax rbp)
                                                    (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.36))
                           (call-undead ())
                           (undead-out ((tmp-ra.36 rbp) (tmp-ra.36 rsi rbp)
                                                        (tmp-ra.36 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.36 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.36))
          ...
          (define L.*.2
            ((new-frames ())
             ...
             (undead-out ((rdi rsi tmp-ra.34 rbp)
                          (rsi tmp.6 tmp-ra.34 rbp)
                          (tmp.7 tmp.6 tmp-ra.34 rbp)
                          ((((((tmp.37 tmp.7 tmp.6 tmp-ra.34 rbp) (tmp.37 tmp.7 tmp.6 tmp-ra.34 rbp)
                                                                  (tmp.30 tmp.7 tmp.6 tmp-ra.34 rbp))
                              (tmp.7 tmp.6 tmp-ra.34 rbp))
                             (tmp.29 tmp.7 tmp.6 tmp-ra.34 rbp)
                             (tmp.29 tmp.7 tmp.6 tmp-ra.34 rbp))
                            (tmp.7 tmp.6 tmp-ra.34 rbp))
                           ((((((tmp.38 tmp.7 tmp.6 tmp-ra.34 rbp) (tmp.38 tmp.7 tmp.6 tmp-ra.34 rbp)
                                                                   (tmp.32 tmp.7 tmp.6 tmp-ra.34 rbp))
                               (tmp.7 tmp.6 tmp-ra.34 rbp))
                              (tmp.31 tmp.7 tmp.6 tmp-ra.34 rbp)
                              (tmp.31 tmp.7 tmp.6 tmp-ra.34 rbp))
                             (tmp.7 tmp.6 tmp-ra.34 rbp))
                            ((tmp.39 tmp.6 tmp-ra.34 rbp) (tmp.39 tmp.6 tmp-ra.34 rbp)
                                                          (tmp.6 tmp.33 tmp-ra.34 rbp)
                                                          (tmp.33 tmp.40 tmp-ra.34 rbp)
                                                          (tmp.40 tmp-ra.34 rbp)
                                                          (tmp-ra.34 rax rbp)
                                                          (rax rbp))
                            ((tmp-ra.34 rax rbp) (rax rbp)))
                           ((tmp-ra.34 rax rbp) (rax rbp)))))
             (call-undead ())
             (conflicts
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.35 rbp) (rsi rdx rcx r8 tmp-ra.35 rbp)
                                                       (rdx rcx r8 tmp-ra.35 rbp)
                                                       (rcx r8 tmp-ra.35 rbp)
                                                       (r8 ball.0.2 tmp-ra.35 rbp)
                                                       (ball.0.2 tmp-ra.35 rbp)
                                                       (tmp-ra.35 rax rbp)
                                                       (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
                           (call-undead ())
                           (undead-out ((tmp-ra.32 rbp) (tmp-ra.32 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.32 (rax rbp)) (rbp (rax tmp-ra.32))
                                                             (rax (rbp tmp-ra.32)))))
          (define L.proc.0.1
            ((new-frames ())
             (locals (foobar.0.1 bat.4.2 foobar.8.3 ball.1.4 foo.5.5 foo.7.6 bar.6.7 tmp-ra.31))
             (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.31 rbp)
                          (rsi rdx rcx r8 r9 fv0 tmp-ra.31 rbp)
                          (rdx rcx r8 r9 fv0 tmp-ra.31 rbp)
                          (rcx r8 r9 fv0 tmp-ra.31 rbp)
                          (r8 r9 fv0 tmp-ra.31 rbp)
                          (r9 fv0 tmp-ra.31 rbp)
                          (fv0 tmp-ra.31 rbp)
                          (foobar.0.1 tmp-ra.31 rbp)
                          (tmp-ra.31 rax rbp)
                          (rax rbp)))
             (call-undead ())
             (conflicts
...
(check-by-interp '(module ((new-frames ()) (locals (tmp-ra.30))
                                           (call-undead ())
                                           (undead-out ((tmp-ra.30 rbp) (tmp-ra.30 rax rbp)
                                                                        (rax rbp)))
                                           (conflicts ((tmp-ra.30 (rax rbp)) (rbp (rax tmp-ra.30))
                                                                             (rax (rbp tmp-ra.30)))))
                          (define L.fn.0.1
                            ((new-frames ()) (locals (bar.9.1 bat.3.2 tmp-ra.28))
                                             (undead-out ((rdi rsi tmp-ra.28 rbp) (rsi tmp-ra.28 rbp)
                                                                                  (tmp-ra.28 rbp)
                                                                                  (tmp-ra.28 rax rbp)
                                                                                  (rax rbp)))
                                             (call-undead ())
                    ...
                    (define L.func.1.2
                      ((new-frames ()) (locals (bar.8.3 foobar.4.4 tmp-ra.29))
                                       (undead-out ((rdi rsi tmp-ra.29 rbp) (rsi tmp-ra.29 rbp)
                                                                            (bar.8.3 tmp-ra.29 rbp)
                                                                            (tmp-ra.29 rax rbp)
                                                                            (rax rbp)))
                                       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
                           (call-undead ())
                           (undead-out ((tmp-ra.32 rbp) (tmp-ra.32 rsi rbp)
                                                        (tmp-ra.32 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.32 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.32))
          ...
          (define L.eq?.2
            ((new-frames ())
             ...
             (undead-out ((rdi rsi tmp-ra.30 rbp) (rsi tmp.21 tmp-ra.30 rbp)
                                                  (tmp.22 tmp.21 tmp-ra.30 rbp)
                                                  ((tmp-ra.30 rbp) ((tmp-ra.30 rax rbp) (rax rbp))
                                                                   ((tmp-ra.30 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.31 rbp) (rsi rdx rcx r8 r9 tmp-ra.31 rbp)
                                                          (rdx rcx r8 r9 tmp-ra.31 rbp)
                                                          (rcx r8 r9 tmp-ra.31 rbp)
                                                          (r8 r9 tmp-ra.31 rbp)
                                                          (r9 tmp-ra.31 rbp)
                                                          (tmp-ra.31 rbp)
                                                          (tmp-ra.31 rax rbp)
 ...
 '(module ((new-frames ()) (locals (tmp-ra.31))
    ...
    (define L.func.1.2
      ((new-frames ()) (locals (foobar.2.3 bar.1.4 bat.6.5 tmp-ra.30))
                       (undead-out ((rdi rsi rdx tmp-ra.30 rbp) (rsi rdx tmp-ra.30 rbp)
                                                                (rdx tmp-ra.30 rbp)
                                                                (tmp-ra.30 rbp)
                                                                (tmp-ra.30 rax rbp)
                                                                (rax rbp)))
    ...
    (begin
      ...
      (jump tmp-ra.31 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (foo.1.4 ball.4.5 bar.3.6 tmp-ra.31))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rax rbp)
                                                        (rax rbp)))
          ...
          (define L.func.0.1
            ((new-frames ()) (locals (foo.8.1 ball.4.2 foobar.0.3 tmp-ra.30))
                             (undead-out ((rdi rsi rdx tmp-ra.30 rbp) (rsi rdx tmp-ra.30 rbp)
                                                                      (rdx ball.4.2 tmp-ra.30 rbp)
                                                                      (ball.4.2 tmp-ra.30 rbp)
                                                                      (tmp-ra.30 rax rbp)
                                                                      (rax rbp)))
                             (call-undead ())
 ...
 '(module ((new-frames ()) (locals (tmp-ra.32))
          ...
          (define L.func.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.30 rbp) (rsi rdx rcx r8 tmp-ra.30 rbp)
                                                             (rdx rcx r8 tmp-ra.30 rbp)
                                                             (rcx r8 tmp-ra.30 rbp)
                                                             (r8 tmp-ra.30 rbp)
                                                             (tmp-ra.30 rbp)
                                                             (tmp-ra.30 rax rbp)
                                                             (rax rbp)))
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.31 rbp) (bar.6.6 tmp-ra.31 rbp) (tmp-ra.31 rax rbp) (rax rbp)))
       (call-undead ())
    ...
    (begin
      ...
      (jump tmp-ra.32 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (foo.5.3 foobar.2.4 bar.9.5 bar.3.6 tmp-ra.31))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
          ...
          (define L.fn.0.1
            ((new-frames ()) (locals (foobar.4.1 bat.7.2 tmp-ra.30))
                             (undead-out ((rdi rsi tmp-ra.30 rbp) (rsi tmp-ra.30 rbp)
                                                                  (foobar.4.1 tmp-ra.30 rbp)
                                                                  (tmp-ra.30 rax rbp)
                                                                  (rax rbp)))
                             (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.33))
                           (call-undead ())
                           (undead-out ((tmp-ra.33 rbp) (tmp-ra.33 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.33 (rax rbp)) (rbp (rax tmp-ra.33))
                                                             (rax (rbp tmp-ra.33)))))
          (define L.x.0.1
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.32 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.32 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.32 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.32 rbp)
                                                              (r8 r9 fv0 tmp-ra.32 rbp)
                                                              (r9 fv0 tmp-ra.32 rbp)
                                                              (fv0 tmp-ra.32 rbp)
                                                              (tmp-ra.32 rbp)
                                                              (tmp-ra.32 rax rbp)
                                                              (rax rbp)))
 ...
 '(module ((new-frames ()) (locals (tmp-ra.33))
          ...
          (define L.proc.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.31 rbp) (rsi rdx rcx r8 tmp-ra.31 rbp)
                                                             (rdx rcx r8 bat.0.4 tmp-ra.31 rbp)
                                                             (rcx r8 bat.0.4 tmp-ra.31 rbp)
                                                             (r8 bat.0.4 tmp-ra.31 rbp)
                                                             (bat.0.4 tmp-ra.31 rbp)
                                                             (tmp-ra.31 rax rbp)
                                                             (rax rbp)))
             (call-undead ())
             (conflicts
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.32 rbp) (rsi tmp-ra.32 rbp) (tmp-ra.32 rbp) (tmp-ra.32 rax rbp) (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32 tmp.33))
                           (call-undead ())
                           (undead-out ((tmp-ra.32 rbp) (((tmp.33 tmp-ra.32 rbp) (tmp-ra.32 rbp))
                                                         ((tmp-ra.32 rax rbp) (rax rbp))
                                                         ((tmp-ra.32 rax rbp) (rax rbp)))))
          ...
          (define L.tmp.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.30 rbp) (rsi rdx rcx r8 tmp-ra.30 rbp)
                                                             (rdx rcx r8 foobar.3.4 tmp-ra.30 rbp)
                                                             (rcx r8 foobar.3.4 tmp-ra.30 rbp)
                                                             (r8 foobar.3.4 tmp-ra.30 rbp)
                                                             (foobar.3.4 tmp-ra.30 rbp)
                                                             (tmp-ra.30 rax rbp)
                                                             (rax rbp)))
             (call-undead ())
             (conflicts
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.31 rbp) (tmp-ra.31 rbp) (tmp-ra.31 rax rbp) (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.36))
           (call-undead ())
           (undead-out ((tmp-ra.36 rbp) (tmp-ra.36 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.36 (rdi rbp)) (rbp (r15 rdi tmp-ra.36))
                                             (rdi (r15 rbp tmp-ra.36))
                                             (r15 (rbp rdi)))))
          (define L.void?.3
            ((new-frames ())
             (locals (tmp-ra.33 tmp.37 tmp.28 tmp.32))
             (undead-out ((rdi tmp-ra.33 rbp) (tmp.28 tmp-ra.33 rbp)
                                              ((((tmp.37 tmp-ra.33 rbp) (tmp.37 tmp-ra.33 rbp)
                                                                        (tmp.32 tmp-ra.33 rbp))
                                                (tmp-ra.33 rbp))
                                               ((tmp-ra.33 rax rbp) (rax rbp))
                                               ((tmp-ra.33 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.x.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.34 rbp) (ball.0.1 tmp-ra.34 rbp) (tmp-ra.34 rax rbp) (rax rbp)))
       (call-undead ())
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.35 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.35 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.35 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.35 rbp)
                                                              (r8 r9 fv0 tmp-ra.35 rbp)
                                                              (r9 fv0 tmp-ra.35 rbp)
                                                              (fv0 tmp-ra.35 rbp)
                                                              (tmp-ra.35 rbp)
                                                              (tmp-ra.35 rax rbp)
                                                              (rax rbp)))
 ...
 '(module ((new-frames ()) (locals (tmp-ra.32))
          ...
          (define L.fn.0.1
            ((new-frames ()) (locals (tmp-ra.29))
                             (undead-out ((tmp-ra.29 rbp) (tmp-ra.29 rax rbp) (rax rbp)))
                             (call-undead ())
                             (conflicts ((tmp-ra.29 (rax rbp)) (rbp (rax tmp-ra.29))
                                                               (rax (rbp tmp-ra.29)))))
            (begin
              (set! tmp-ra.29 r15)
              (set! rax 30)
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.30 rbp) (rsi rdx rcx tmp-ra.30 rbp)
                                                    (rdx rcx tmp-ra.30 rbp)
                                                    (rcx tmp-ra.30 rbp)
                                                    (foo.4.1 tmp-ra.30 rbp)
                                                    (tmp-ra.30 rax rbp)
                                                    (rax rbp)))
       (call-undead ())
    ...
    (define L.tmp.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.31 rbp) (bat.2.5 tmp-ra.31 rbp) (tmp-ra.31 rax rbp) (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.34))
                           (call-undead ())
                           (undead-out ((tmp-ra.34 rbp) (tmp-ra.34 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.34 (rax rbp)) (rbp (rax tmp-ra.34))
                                                             (rax (rbp tmp-ra.34)))))
          (define L.func.0.1
            ((new-frames ())
             (locals (ball.9.1 foobar.8.2 ball.1.3 ball.2.4 foobar.3.5 tmp-ra.32))
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.32 rbp) (rsi rdx rcx r8 tmp-ra.32 rbp)
                                                             (rdx rcx r8 tmp-ra.32 rbp)
                                                             (rcx r8 tmp-ra.32 rbp)
                                                             (r8 tmp-ra.32 rbp)
                                                             (tmp-ra.32 rbp)
                                                             (tmp-ra.32 rax rbp)
                                                             (rax rbp)))
    ...
    (define L.func.1.2
      ((new-frames ()) (locals (ball.5.6 foobar.8.7 ball.0.8 tmp-ra.33))
                       (undead-out ((rdi rsi rdx tmp-ra.33 rbp) (rsi rdx tmp-ra.33 rbp)
                                                                (rdx tmp-ra.33 rbp)
                                                                (tmp-ra.33 rbp)
                                                                (tmp-ra.33 rax rbp)
                                                                (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.35))
           (call-undead ())
           (undead-out ((tmp-ra.35 rbp) (tmp-ra.35 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.35 (rdi rbp)) (rbp (r15 rdi tmp-ra.35))
                                             (rdi (r15 rbp tmp-ra.35))
                                             (r15 (rbp rdi)))))
          (define L.boolean?.3
            ((new-frames ())
             (locals (tmp-ra.32 tmp.36 tmp.25 tmp.31))
             (undead-out ((rdi tmp-ra.32 rbp) (tmp.25 tmp-ra.32 rbp)
                                              ((((tmp.36 tmp-ra.32 rbp) (tmp.36 tmp-ra.32 rbp)
                                                                        (tmp.31 tmp-ra.32 rbp))
                                                (tmp-ra.32 rbp))
                                               ((tmp-ra.32 rax rbp) (rax rbp))
                                               ((tmp-ra.32 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.33 rbp) (rsi tmp-ra.33 rbp) (tmp-ra.33 rbp) (tmp-ra.33 rax rbp) (rax rbp)))
       (call-undead ())
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.34 rbp) (rsi rdx rcx r8 tmp-ra.34 rbp)
                                                       (rdx rcx r8 tmp-ra.34 rbp)
                                                       (rcx r8 tmp-ra.34 rbp)
                                                       (r8 tmp-ra.34 rbp)
                                                       (tmp-ra.34 rbp)
                                                       (tmp-ra.34 rax rbp)
                                                       (rax rbp)))
...
(check-by-interp
 '(module ((new-frames (()))
           (locals (tmp.33 ball.5.4 ball.5.1 foobar.1.2 foo.4.3 tmp-ra.31))
           (call-undead (tmp-ra.31))
           (undead-out
            ((tmp-ra.31 rbp)
             ((rax tmp-ra.31 rbp) ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
             (foo.4.3 tmp-ra.31 rbp)
             (foo.4.3 tmp-ra.31 rbp)
             (foo.4.3 tmp-ra.31 rbp)
             (((tmp.33 foo.4.3 tmp-ra.31 rbp) (foo.4.3 tmp-ra.31 rbp)) (ball.5.4 tmp-ra.31 rbp)
                                                                       (ball.5.4 tmp-ra.31 rbp))
             (tmp-ra.31 rdi rbp)
             (rdi r15 rbp)
             (rdi r15 rbp)))
          ...
          (define L.ascii-char?.2
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.29 rbp) (tmp.25 tmp-ra.29 rbp)
                                              ((((tmp.32 tmp-ra.29 rbp) (tmp.32 tmp-ra.29 rbp)
                                                                        (tmp.28 tmp-ra.29 rbp))
                                                (tmp-ra.29 rbp))
                                               ((tmp-ra.29 rax rbp) (rax rbp))
                                               ((tmp-ra.29 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.eq?.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi tmp-ra.30 rbp) (rsi tmp.19 tmp-ra.30 rbp)
                                            (tmp.20 tmp.19 tmp-ra.30 rbp)
                                            ((tmp-ra.30 rbp) ((tmp-ra.30 rax rbp) (rax rbp))
                                                             ((tmp-ra.30 rax rbp) (rax rbp)))))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31 tmp.32))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (((tmp.32 tmp-ra.31 rbp) (tmp-ra.31 rbp))
                                                         ((tmp-ra.31 rax rbp) (rax rbp))
                                                         ((tmp-ra.31 rax rbp) (rax rbp)))))
          ...
          (define L.fn.0.1
            ((new-frames ()) (locals (bat.6.1 bat.8.2 foo.4.3 tmp-ra.28))
                             (undead-out ((rdi rsi rdx tmp-ra.28 rbp) (rsi rdx tmp-ra.28 rbp)
                                                                      (rdx bat.8.2 tmp-ra.28 rbp)
                                                                      (bat.8.2 tmp-ra.28 rbp)
                                                                      (tmp-ra.28 rax rbp)
                                                                      (rax rbp)))
                             (call-undead ())
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.29 rbp) (tmp-ra.29 rbp) (tmp-ra.29 rax rbp) (rax rbp)))
       (call-undead ())
 ...
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.3
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.32 rbp) (tmp.28 tmp-ra.32 rbp)
                                              ((((tmp.36 tmp-ra.32 rbp) (tmp.36 tmp-ra.32 rbp)
                                                                        (tmp.31 tmp-ra.32 rbp))
                                                (tmp-ra.32 rbp))
                                               ((tmp-ra.32 rax rbp) (rax rbp))
    ...
    (define L.func.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.33 rbp) (rsi rdx rcx r8 tmp-ra.33 rbp)
                                                       (rdx rcx r8 tmp-ra.33 rbp)
                                                       (rcx r8 tmp-ra.33 rbp)
                                                       (r8 tmp-ra.33 rbp)
                                                       (tmp-ra.33 rbp)
                                                       (tmp-ra.33 rax rbp)
                                                       (rax rbp)))
    ...
    (define L.func.1.2
      ((new-frames ()) (locals (foo.1.6 foobar.2.7 tmp-ra.34))
                       (undead-out ((rdi rsi tmp-ra.34 rbp) (rsi foobar.2.7 tmp-ra.34 rbp)
                                                            (foobar.2.7 tmp-ra.34 rbp)
                                                            (tmp-ra.34 rax rbp)
                                                            (rax rbp)))
                       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.38))
                           (call-undead ())
                           (undead-out ((tmp-ra.38 rbp) (tmp-ra.38 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.38 (rax rbp)) (rbp (rax tmp-ra.38))
                                                             (rax (rbp tmp-ra.38)))))
          (define L.proc.0.1
            ((new-frames ())
             (locals (ball.8.1 foobar.0.2 bat.3.3 bar.9.4 foo.6.5 foobar.7.6 ball.4.7 tmp-ra.36))
             (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.36 rbp)
                          (rsi rdx rcx r8 r9 fv0 tmp-ra.36 rbp)
                          (rdx rcx r8 r9 fv0 tmp-ra.36 rbp)
                          (rcx r8 r9 fv0 tmp-ra.36 rbp)
                          (r8 r9 fv0 tmp-ra.36 rbp)
                          (r9 fv0 tmp-ra.36 rbp)
                          (fv0 tmp-ra.36 rbp)
                          (tmp-ra.36 rbp)
                          (tmp-ra.36 rax rbp)
                          (rax rbp)))
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.37 rbp) (rsi rdx rcx r8 tmp-ra.37 rbp)
                                                       (rdx rcx r8 tmp-ra.37 rbp)
                                                       (rcx r8 foo.1.10 tmp-ra.37 rbp)
                                                       (r8 foo.1.10 tmp-ra.37 rbp)
                                                       (foo.1.10 tmp-ra.37 rbp)
                                                       (tmp-ra.37 rax rbp)
                                                       (rax rbp)))
       (call-undead ())
       (conflicts
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.37))
           (call-undead ())
           (undead-out ((tmp-ra.37 rbp) (tmp-ra.37 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.37 (rdi rbp)) (rbp (r15 rdi tmp-ra.37))
                                             (rdi (r15 rbp tmp-ra.37))
                                             (r15 (rbp rdi)))))
          (define L.ascii-char?.3
            ((new-frames ())
             (locals (tmp-ra.34 tmp.38 tmp.30 tmp.33))
             (undead-out ((rdi tmp-ra.34 rbp) (tmp.30 tmp-ra.34 rbp)
                                              ((((tmp.38 tmp-ra.34 rbp) (tmp.38 tmp-ra.34 rbp)
                                                                        (tmp.33 tmp-ra.34 rbp))
                                                (tmp-ra.34 rbp))
                                               ((tmp-ra.34 rax rbp) (rax rbp))
                                               ((tmp-ra.34 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.func.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.36 rbp) (rsi rdx rcx tmp-ra.36 rbp)
                                                    (rdx rcx tmp-ra.36 rbp)
                                                    (rcx tmp-ra.36 rbp)
                                                    (tmp-ra.36 rbp)
                                                    (tmp-ra.36 rax rbp)
                                                    (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (foobar.2.7 bat.7.8 tmp-ra.34))
           (call-undead ())
           (undead-out
            ((tmp-ra.34 rbp) (tmp-ra.34 rbp) (tmp-ra.34 rbp) (tmp-ra.34 rax rbp) (rax rbp)))
          ...
          (define L.x.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.32 rbp) (tmp-ra.32 rbp) (tmp-ra.32 rax rbp) (rax rbp)))
             (call-undead ())
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.33 rbp) (rsi rdx rcx r8 tmp-ra.33 rbp)
                                                       (rdx rcx r8 tmp-ra.33 rbp)
                                                       (rcx r8 foobar.5.4 tmp-ra.33 rbp)
                                                       (r8 foobar.5.4 tmp-ra.33 rbp)
                                                       (foobar.5.4 tmp-ra.33 rbp)
                                                       (tmp-ra.33 rax rbp)
                                                       (rax rbp)))
       (call-undead ())
       (conflicts
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.40))
           (call-undead ())
           (undead-out ((tmp-ra.40 rbp) (tmp-ra.40 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.40 (rdi rbp)) (rbp (r15 rdi tmp-ra.40))
                                             (rdi (r15 rbp tmp-ra.40))
                                             (r15 (rbp rdi)))))
          (define L.boolean?.3
            ((new-frames ())
             (locals (tmp-ra.37 tmp.41 tmp.30 tmp.36))
             (undead-out ((rdi tmp-ra.37 rbp) (tmp.30 tmp-ra.37 rbp)
                                              ((((tmp.41 tmp-ra.37 rbp) (tmp.41 tmp-ra.37 rbp)
                                                                        (tmp.36 tmp-ra.37 rbp))
                                                (tmp-ra.37 rbp))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.38 rbp) (rsi rdx rcx r8 tmp-ra.38 rbp)
                                                       (rdx rcx r8 tmp-ra.38 rbp)
                                                       (rcx r8 tmp-ra.38 rbp)
                                                       (r8 tmp-ra.38 rbp)
                                                       (bar.5.1 tmp-ra.38 rbp)
                                                       (tmp-ra.38 rax rbp)
                                                       (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.39 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (r8 r9 fv0 tmp-ra.39 rbp)
                                                              (r9 fv0 tmp-ra.39 rbp)
                                                              (fv0 tmp-ra.39 rbp)
                                                              (tmp-ra.39 rbp)
                                                              (tmp-ra.39 rax rbp)
                                                              (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.39))
           (call-undead ())
           (undead-out ((tmp-ra.39 rbp) (tmp-ra.39 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.39 (rdi rbp)) (rbp (r15 rdi tmp-ra.39))
                                             (rdi (r15 rbp tmp-ra.39))
                                             (r15 (rbp rdi)))))
          (define L.ascii-char?.3
            ((new-frames ())
             (locals (tmp-ra.36 tmp.40 tmp.32 tmp.35))
             (undead-out ((rdi tmp-ra.36 rbp) (tmp.32 tmp-ra.36 rbp)
                                              ((((tmp.40 tmp-ra.36 rbp) (tmp.40 tmp-ra.36 rbp)
                                                                        (tmp.35 tmp-ra.36 rbp))
                                                (tmp-ra.36 rbp))
                                               ((tmp-ra.36 rax rbp) (rax rbp))
                                               ((tmp-ra.36 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.x.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.37 rbp) (rsi rdx rcx tmp-ra.37 rbp)
                                                    (rdx rcx tmp-ra.37 rbp)
                                                    (rcx tmp-ra.37 rbp)
                                                    (ball.7.1 tmp-ra.37 rbp)
                                                    (tmp-ra.37 rax rbp)
                                                    (rax rbp)))
       (call-undead ())
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.38 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.38 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.38 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.38 rbp)
                                                              (r8 r9 fv0 tmp-ra.38 rbp)
                                                              (r9 fv0 tmp-ra.38 rbp)
                                                              (fv0 tmp-ra.38 rbp)
                                                              (tmp-ra.38 rbp)
                                                              (tmp-ra.38 rax rbp)
                                                              (rax rbp)))
    ...
    (begin
      ...
      (jump L.ascii-char?.3 rbp r15 rdi))))
(check-by-interp
 '(module ((new-frames ()) (locals (foo.9.8 tmp-ra.41))
                           (call-undead ())
                           (undead-out ((tmp-ra.41 rbp) (tmp-ra.41 rbp)
                                                        (tmp-ra.41 rsi rbp)
                                                        (tmp-ra.41 rsi rdi rbp)
                                                        (rsi rdi r15 rbp)
                                                        (rsi rdi r15 rbp)))
                           (conflicts ((tmp-ra.41 (rdi rsi foo.9.8 rbp))
                                       (foo.9.8 (rbp tmp-ra.41))
          ...
          (define L.*.4
            ((new-frames ())
             ...
             (undead-out
              ((rdi rsi tmp-ra.37 rbp)
               (rsi tmp.9 tmp-ra.37 rbp)
               (tmp.10 tmp.9 tmp-ra.37 rbp)
               ((((((tmp.42 tmp.10 tmp.9 tmp-ra.37 rbp) (tmp.42 tmp.10 tmp.9 tmp-ra.37 rbp)
                                                        (tmp.33 tmp.10 tmp.9 tmp-ra.37 rbp))
                   (tmp.10 tmp.9 tmp-ra.37 rbp))
                  (tmp.32 tmp.10 tmp.9 tmp-ra.37 rbp)
                  (tmp.32 tmp.10 tmp.9 tmp-ra.37 rbp))
                 (tmp.10 tmp.9 tmp-ra.37 rbp))
                ((((((tmp.43 tmp.10 tmp.9 tmp-ra.37 rbp) (tmp.43 tmp.10 tmp.9 tmp-ra.37 rbp)
                                                         (tmp.35 tmp.10 tmp.9 tmp-ra.37 rbp))
                    (tmp.10 tmp.9 tmp-ra.37 rbp))
                   (tmp.34 tmp.10 tmp.9 tmp-ra.37 rbp)
                   (tmp.34 tmp.10 tmp.9 tmp-ra.37 rbp))
                  (tmp.10 tmp.9 tmp-ra.37 rbp))
                 ((tmp.44 tmp.9 tmp-ra.37 rbp) (tmp.44 tmp.9 tmp-ra.37 rbp)
                                               (tmp.9 tmp.36 tmp-ra.37 rbp)
                                               (tmp.36 tmp.45 tmp-ra.37 rbp)
                                               (tmp.45 tmp-ra.37 rbp)
                                               (tmp-ra.37 rax rbp)
                                               (rax rbp))
                 ((tmp-ra.37 rax rbp) (rax rbp)))
                ((tmp-ra.37 rax rbp) (rax rbp)))))
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.38 rbp) (rsi tmp-ra.38 rbp) (tmp-ra.38 rbp) (tmp-ra.38 rax rbp) (rax rbp)))
       (call-undead ())
    ...
    (define L.fn.1.2
      ((new-frames ()) (locals (bat.7.3 bat.1.4 bat.3.5 tmp-ra.39))
                       (undead-out ((rdi rsi rdx tmp-ra.39 rbp) (rsi rdx tmp-ra.39 rbp)
                                                                (rdx bat.1.4 tmp-ra.39 rbp)
                                                                (bat.1.4 tmp-ra.39 rbp)
                                                                (tmp-ra.39 rax rbp)
                                                                (rax rbp)))
                       (call-undead ())
    ...
    (define L.func.2.3
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.40 rbp) (rsi tmp-ra.40 rbp) (tmp-ra.40 rbp) (tmp-ra.40 rax rbp) (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.40))
                           (call-undead ())
                           (undead-out ((tmp-ra.40 rbp) (tmp-ra.40 rax rbp) (rax rbp)))
                           (conflicts ((tmp-ra.40 (rax rbp)) (rbp (rax tmp-ra.40))
                                                             (rax (rbp tmp-ra.40)))))
          (define L.proc.0.1
            ((new-frames ())
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.38 rbp) (tmp-ra.38 rbp) (tmp-ra.38 rax rbp) (rax rbp)))
       (call-undead ())
 ...
 '(module ((new-frames ()) (locals (tmp-ra.38))
          ...
          (define L.fn.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.35 rbp) (rsi rdx rcx r8 r9 tmp-ra.35 rbp)
                                                                (rdx rcx r8 r9 tmp-ra.35 rbp)
                                                                (rcx r8 r9 tmp-ra.35 rbp)
                                                                (r8 r9 tmp-ra.35 rbp)
                                                                (r9 tmp-ra.35 rbp)
                                                                (tmp-ra.35 rbp)
                                                                (tmp-ra.35 rax rbp)
    ...
    (define L.proc.1.2
      ((new-frames ()) (locals (bar.0.7 foo.3.8 foo.7.9 tmp-ra.36))
                       (undead-out ((rdi rsi rdx tmp-ra.36 rbp) (rsi rdx tmp-ra.36 rbp)
                                                                (rdx tmp-ra.36 rbp)
                                                                (tmp-ra.36 rbp)
                                                                (tmp-ra.36 rax rbp)
                                                                (rax rbp)))
    ...
    (define L.x.2.3
      ((new-frames ()) (locals (bar.8.10 foobar.2.11 tmp-ra.37))
                       (undead-out ((rdi rsi tmp-ra.37 rbp) (rsi foobar.2.11 tmp-ra.37 rbp)
                                                            (foobar.2.11 tmp-ra.37 rbp)
                                                            (tmp-ra.37 rax rbp)
                                                            (rax rbp)))
                       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.42))
           (call-undead ())
           (undead-out ((tmp-ra.42 rbp) (tmp-ra.42 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.42 (rdi rbp)) (rbp (r15 rdi tmp-ra.42))
                                             (rdi (r15 rbp tmp-ra.42))
                                             (r15 (rbp rdi)))))
          (define L.empty?.3
            ((new-frames ())
             (locals (tmp-ra.39 tmp.43 tmp.33 tmp.38))
             (undead-out ((rdi tmp-ra.39 rbp) (tmp.33 tmp-ra.39 rbp)
                                              ((((tmp.43 tmp-ra.39 rbp) (tmp.43 tmp-ra.39 rbp)
                                                                        (tmp.38 tmp-ra.39 rbp))
                                                (tmp-ra.39 rbp))
                                               ((tmp-ra.39 rax rbp) (rax rbp))
                                               ((tmp-ra.39 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.40 rbp)
                    (rsi rdx rcx r8 r9 fv0 tmp-ra.40 rbp)
                    (rdx rcx r8 r9 fv0 foobar.0.6 tmp-ra.40 rbp)
                    (rcx r8 r9 fv0 foobar.0.6 tmp-ra.40 rbp)
                    (r8 r9 fv0 foobar.0.6 tmp-ra.40 rbp)
                    (r9 fv0 foobar.0.6 tmp-ra.40 rbp)
                    (fv0 foobar.0.6 tmp-ra.40 rbp)
                    (foobar.0.6 tmp-ra.40 rbp)
                    (tmp-ra.40 rax rbp)
                    (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.41 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.41 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.41 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.41 rbp)
                                                              (r8 r9 fv0 tmp-ra.41 rbp)
                                                              (r9 fv0 tmp-ra.41 rbp)
                                                              (fv0 tmp-ra.41 rbp)
                                                              (tmp-ra.41 rbp)
                                                              (tmp-ra.41 rax rbp)
                                                              (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.37 tmp.38))
                           (call-undead ())
                           (undead-out ((tmp-ra.37 rbp) (((tmp.38 tmp-ra.37 rbp) (tmp-ra.37 rbp))
                                                         ((tmp-ra.37 rax rbp) (rax rbp))
                                                         ((tmp-ra.37 rax rbp) (rax rbp)))))
          ...
          (define L.proc.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.34 rbp)
                          (rsi rdx rcx r8 r9 fv0 tmp-ra.34 rbp)
                          (rdx rcx r8 r9 fv0 tmp-ra.34 rbp)
                          (rcx r8 r9 fv0 tmp-ra.34 rbp)
                          (r8 r9 fv0 tmp-ra.34 rbp)
                          (r9 fv0 tmp-ra.34 rbp)
                          (fv0 tmp-ra.34 rbp)
                          (tmp-ra.34 rbp)
                          (tmp-ra.34 rax rbp)
                          (rax rbp)))
    ...
    (define L.func.1.2
      ((new-frames ()) (locals (tmp-ra.35))
                       (undead-out ((tmp-ra.35 rbp) (tmp-ra.35 rax rbp) (rax rbp)))
                       (call-undead ())
                       (conflicts ((tmp-ra.35 (rax rbp)) (rbp (rax tmp-ra.35))
                                                         (rax (rbp tmp-ra.35)))))
      (begin
        (set! tmp-ra.35 r15)
        (set! rax 14)
    ...
    (define L.fn.2.3
      ((new-frames ()) (locals (foobar.0.8 ball.1.9 foobar.7.10 tmp-ra.36))
                       (undead-out ((rdi rsi rdx tmp-ra.36 rbp) (rsi rdx tmp-ra.36 rbp)
                                                                (rdx ball.1.9 tmp-ra.36 rbp)
                                                                (ball.1.9 tmp-ra.36 rbp)
                                                                (tmp-ra.36 rax rbp)
                                                                (rax rbp)))
                       (call-undead ())
 ...
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.4
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.36 rbp) (tmp.32 tmp-ra.36 rbp)
                                              ((((tmp.41 tmp-ra.36 rbp) (tmp.41 tmp-ra.36 rbp)
                                                                        (tmp.35 tmp-ra.36 rbp))
                                                (tmp-ra.36 rbp))
                                               ((tmp-ra.36 rax rbp) (rax rbp))
                                               ((tmp-ra.36 rax rbp) (rax rbp)))))
    ...
    (define L.fn.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.37 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.37 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.37 rbp)
                                                              (rcx r8 r9 fv0 bat.6.5 tmp-ra.37 rbp)
                                                              (r8 r9 fv0 bat.6.5 tmp-ra.37 rbp)
                                                              (r9 fv0 bat.6.5 tmp-ra.37 rbp)
                                                              (fv0 bat.6.5 tmp-ra.37 rbp)
                                                              (bat.6.5 tmp-ra.37 rbp)
                                                              (tmp-ra.37 rax rbp)
                                                              (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi tmp-ra.38 rbp) (ball.1.8 tmp-ra.38 rbp) (tmp-ra.38 rax rbp) (rax rbp)))
       (call-undead ())
 ...
 '(module ((new-frames ())
          ...
          (define L.boolean?.4
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.38 rbp) (tmp.31 tmp-ra.38 rbp)
                                              ((((tmp.43 tmp-ra.38 rbp) (tmp.43 tmp-ra.38 rbp)
                                                                        (tmp.37 tmp-ra.38 rbp))
                                                (tmp-ra.38 rbp))
                                               ((tmp-ra.38 rax rbp) (rax rbp))
                                               ((tmp-ra.38 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.tmp.0.1
      ((new-frames ()) (locals (foobar.0.1 bar.6.2 foo.4.3 tmp-ra.39))
                       (undead-out ((rdi rsi rdx tmp-ra.39 rbp) (rsi rdx tmp-ra.39 rbp)
                                                                (rdx bar.6.2 tmp-ra.39 rbp)
                                                                (bar.6.2 tmp-ra.39 rbp)
                                                                (tmp-ra.39 rax rbp)
                                                                (rax rbp)))
                       (call-undead ())
    ...
    (define L.fn.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.40 rbp) (rsi rdx rcx foo.1.7 tmp-ra.40 rbp)
                                                    (rdx rcx foo.1.7 tmp-ra.40 rbp)
                                                    (rcx foo.1.7 tmp-ra.40 rbp)
                                                    (foo.1.7 tmp-ra.40 rbp)
                                                    (tmp-ra.40 rax rbp)
                                                    (rax rbp)))
       (call-undead ())
    ...
    (define L.x.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.41 rbp) (rsi rdx rcx r8 r9 tmp-ra.41 rbp)
                                                          (rdx rcx r8 r9 tmp-ra.41 rbp)
                                                          (rcx r8 r9 tmp-ra.41 rbp)
                                                          (r8 r9 tmp-ra.41 rbp)
                                                          (r9 tmp-ra.41 rbp)
                                                          (tmp-ra.41 rbp)
                                                          (tmp-ra.41 rax rbp)
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.45))
           (call-undead ())
           (undead-out ((tmp-ra.45 rbp) (tmp-ra.45 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.45 (rdi rbp)) (rbp (r15 rdi tmp-ra.45))
                                             (rdi (r15 rbp tmp-ra.45))
                                             (r15 (rbp rdi)))))
          (define L.ascii-char?.4
            ((new-frames ())
             (locals (tmp-ra.41 tmp.46 tmp.37 tmp.40))
             (undead-out ((rdi tmp-ra.41 rbp) (tmp.37 tmp-ra.41 rbp)
                                              ((((tmp.46 tmp-ra.41 rbp) (tmp.46 tmp-ra.41 rbp)
                                                                        (tmp.40 tmp-ra.41 rbp))
                                                (tmp-ra.41 rbp))
                                               ((tmp-ra.41 rax rbp) (rax rbp))
                                               ((tmp-ra.41 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.tmp.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.42 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.42 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.42 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.42 rbp)
                                                              (r8 r9 fv0 tmp-ra.42 rbp)
                                                              (r9 fv0 tmp-ra.42 rbp)
                                                              (fv0 bar.5.2 tmp-ra.42 rbp)
                                                              (bar.5.2 tmp-ra.42 rbp)
                                                              (tmp-ra.42 rax rbp)
                                                              (rax rbp)))
       (call-undead ())
    ...
    (define L.x.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.43 rbp) (rsi rdx rcx r8 tmp-ra.43 rbp)
                                                       (rdx rcx r8 tmp-ra.43 rbp)
                                                       (rcx r8 tmp-ra.43 rbp)
                                                       (r8 tmp-ra.43 rbp)
                                                       (tmp-ra.43 rbp)
                                                       (tmp-ra.43 rax rbp)
                                                       (rax rbp)))
    ...
    (define L.func.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.44 rbp) (rsi rdx rcx tmp-ra.44 rbp)
                                                    (rdx rcx tmp-ra.44 rbp)
                                                    (rcx tmp-ra.44 rbp)
                                                    (tmp-ra.44 rbp)
                                                    (tmp-ra.44 rax rbp)
                                                    (rax rbp)))
...
(check-by-interp
 '(module ((new-frames (()))
           (locals (bat.5.13 tmp-ra.46))
           (call-undead (tmp-ra.46))
           (undead-out ((tmp-ra.46 rbp) ((rax tmp-ra.46 rbp) ((rsi rbp) (rsi rdi rbp)
                                                                        (rsi rdi r15 rbp)
                                                                        (rsi rdi r15 rbp)))
                                        (tmp-ra.46 rbp)
                                        (tmp-ra.46 rsi rbp)
                                        (tmp-ra.46 rsi rdi rbp)
                                        (rsi rdi r15 rbp)
                                        (rsi rdi r15 rbp)))
           (conflicts ((tmp-ra.46 (rdi rsi bat.5.13 rax rbp))
          ...
          (define L.<.5
            ((new-frames ())
             ...
             (undead-out
              ((rdi rsi tmp-ra.41 rbp)
               (rsi tmp.20 tmp-ra.41 rbp)
               (tmp.21 tmp.20 tmp-ra.41 rbp)
               ((((((tmp.47 tmp.21 tmp.20 tmp-ra.41 rbp) (tmp.47 tmp.21 tmp.20 tmp-ra.41 rbp)
                                                         (tmp.38 tmp.21 tmp.20 tmp-ra.41 rbp))
                   (tmp.21 tmp.20 tmp-ra.41 rbp))
                  (tmp.37 tmp.21 tmp.20 tmp-ra.41 rbp)
                  (tmp.37 tmp.21 tmp.20 tmp-ra.41 rbp))
                 (tmp.21 tmp.20 tmp-ra.41 rbp))
                ((((((tmp.48 tmp.21 tmp.20 tmp-ra.41 rbp) (tmp.48 tmp.21 tmp.20 tmp-ra.41 rbp)
                                                          (tmp.40 tmp.21 tmp.20 tmp-ra.41 rbp))
                    (tmp.21 tmp.20 tmp-ra.41 rbp))
                   (tmp.39 tmp.21 tmp.20 tmp-ra.41 rbp)
                   (tmp.39 tmp.21 tmp.20 tmp-ra.41 rbp))
                  (tmp.21 tmp.20 tmp-ra.41 rbp))
                 ((tmp-ra.41 rbp) ((tmp-ra.41 rax rbp) (rax rbp)) ((tmp-ra.41 rax rbp) (rax rbp)))
                 ((tmp-ra.41 rax rbp) (rax rbp)))
                ((tmp-ra.41 rax rbp) (rax rbp)))))
             (call-undead ())
             (conflicts
    ...
    (define L.eq?.4
      ((new-frames ())
       ...
       (undead-out ((rdi rsi tmp-ra.42 rbp) (rsi tmp.28 tmp-ra.42 rbp)
                                            (tmp.29 tmp.28 tmp-ra.42 rbp)
                                            ((tmp-ra.42 rbp) ((tmp-ra.42 rax rbp) (rax rbp))
                                                             ((tmp-ra.42 rax rbp) (rax rbp)))))
       (call-undead ())
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.43 rbp) (rsi rdx rcx tmp-ra.43 rbp)
                                                    (rdx rcx tmp-ra.43 rbp)
                                                    (rcx tmp-ra.43 rbp)
                                                    (tmp-ra.43 rbp)
                                                    (tmp-ra.43 rax rbp)
                                                    (rax rbp)))
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.44 rbp) (rsi rdx rcx r8 tmp-ra.44 rbp)
                                                       (rdx rcx r8 tmp-ra.44 rbp)
                                                       (rcx r8 tmp-ra.44 rbp)
                                                       (r8 tmp-ra.44 rbp)
                                                       (tmp-ra.44 rbp)
                                                       (tmp-ra.44 rax rbp)
                                                       (rax rbp)))
    ...
    (define L.x.2.3
      ((new-frames ()) (locals (bar.9.10 foobar.3.11 bar.4.12 tmp-ra.45))
                       (undead-out ((rdi rsi rdx tmp-ra.45 rbp) (rsi rdx tmp-ra.45 rbp)
                                                                (rdx tmp-ra.45 rbp)
                                                                (tmp-ra.45 rbp)
                                                                (tmp-ra.45 rax rbp)
                                                                (rax rbp)))
...
(check-by-interp
 '(module ((new-frames (()))
           (locals (tmp-ra.45 ball.1.16 tmp.47))
           (call-undead (tmp-ra.45))
           (undead-out ((tmp-ra.45 rbp) (((tmp.47 tmp-ra.45 rbp) (tmp-ra.45 rbp))
                                         (((rax tmp-ra.45 rbp) ((rdi rbp) (rdi r15 rbp)
                                                                          (rdi r15 rbp)))
                                          (ball.1.16 tmp-ra.45 rbp)
                                          (tmp-ra.45 rax rbp)
                                          (rax rbp))
                                         ((tmp-ra.45 rax rbp) (rax rbp)))))
          ...
          (define L.empty?.4
            ((new-frames ())
             ...
             (undead-out ((rdi tmp-ra.41 rbp) (tmp.35 tmp-ra.41 rbp)
                                              ((((tmp.46 tmp-ra.41 rbp) (tmp.46 tmp-ra.41 rbp)
                                                                        (tmp.40 tmp-ra.41 rbp))
                                                (tmp-ra.41 rbp))
                                               ((tmp-ra.41 rax rbp) (rax rbp))
    ...
    (define L.proc.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.42 rbp) (rsi rdx rcx r8 r9 tmp-ra.42 rbp)
                                                          (rdx rcx r8 r9 tmp-ra.42 rbp)
                                                          (rcx r8 r9 tmp-ra.42 rbp)
                                                          (r8 r9 tmp-ra.42 rbp)
                                                          (r9 tmp-ra.42 rbp)
                                                          (tmp-ra.42 rbp)
                                                          (tmp-ra.42 rax rbp)
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.43 rbp) (rsi tmp-ra.43 rbp) (tmp-ra.43 rbp) (tmp-ra.43 rax rbp) (rax rbp)))
       (call-undead ())
    ...
    (define L.fn.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.44 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.44 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.44 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.44 rbp)
                                                              (r8 r9 fv0 tmp-ra.44 rbp)
                                                              (r9 fv0 tmp-ra.44 rbp)
                                                              (fv0 tmp-ra.44 rbp)
                                                              (tmp-ra.44 rbp)
                                                              (tmp-ra.44 rax rbp)
                                                              (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.49))
           (call-undead ())
           (undead-out ((tmp-ra.49 rbp) (tmp-ra.49 rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
           (conflicts ((tmp-ra.49 (rdi rbp)) (rbp (r15 rdi tmp-ra.49))
                                             (rdi (r15 rbp tmp-ra.49))
                                             (r15 (rbp rdi)))))
          (define L.fixnum?.4
            ((new-frames ())
             (locals (tmp-ra.45 tmp.50 tmp.37 tmp.44))
             (undead-out ((rdi tmp-ra.45 rbp) (tmp.37 tmp-ra.45 rbp)
                                              ((((tmp.50 tmp-ra.45 rbp) (tmp.50 tmp-ra.45 rbp)
                                                                        (tmp.44 tmp-ra.45 rbp))
                                                (tmp-ra.45 rbp))
                                               ((tmp-ra.45 rax rbp) (rax rbp))
                                               ((tmp-ra.45 rax rbp) (rax rbp)))))
             (call-undead ())
    ...
    (define L.x.0.1
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.46 rbp)
                    (rsi rdx rcx r8 r9 fv0 bar.0.7 tmp-ra.46 rbp)
                    (rdx rcx r8 r9 fv0 bar.0.7 tmp-ra.46 rbp)
                    (rcx r8 r9 fv0 bar.0.7 tmp-ra.46 rbp)
                    (r8 r9 fv0 bar.0.7 tmp-ra.46 rbp)
                    (r9 fv0 bar.0.7 tmp-ra.46 rbp)
                    (fv0 bar.0.7 tmp-ra.46 rbp)
                    (bar.0.7 tmp-ra.46 rbp)
                    (tmp-ra.46 rax rbp)
                    (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.tmp.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.47 rbp) (rsi rdx rcx r8 r9 tmp-ra.47 rbp)
                                                          (rdx rcx r8 r9 tmp-ra.47 rbp)
                                                          (rcx r8 r9 tmp-ra.47 rbp)
                                                          (r8 r9 tmp-ra.47 rbp)
                                                          (r9 tmp-ra.47 rbp)
                                                          (tmp-ra.47 rbp)
                                                          (tmp-ra.47 rax rbp)
    ...
    (define L.tmp.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.48 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.48 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.48 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.48 rbp)
                                                              (r8 r9 fv0 tmp-ra.48 rbp)
                                                              (r9 fv0 tmp-ra.48 rbp)
                                                              (fv0 tmp-ra.48 rbp)
                                                              (tmp-ra.48 rbp)
                                                              (tmp-ra.48 rax rbp)
                                                              (rax rbp)))
...
(check-by-interp
 '(module ((new-frames ()) (locals (foo.0.16 ball.6.17 foobar.8.18 tmp-ra.45))
                           (call-undead ())
                           (undead-out ((tmp-ra.45 rbp) (tmp-ra.45 rbp)
                                                        (tmp-ra.45 rbp)
                                                        (tmp-ra.45 rbp)
                                                        (tmp-ra.45 rax rbp)
                                                        (rax rbp)))
          ...
          (define L.tmp.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.42 rbp)
                          (rsi rdx rcx r8 r9 foo.3.6 tmp-ra.42 rbp)
                          (rdx rcx r8 r9 foo.3.6 tmp-ra.42 rbp)
                          (rcx r8 r9 foo.3.6 tmp-ra.42 rbp)
                          (r8 r9 foo.3.6 tmp-ra.42 rbp)
                          (r9 foo.3.6 tmp-ra.42 rbp)
                          (foo.3.6 tmp-ra.42 rbp)
                          (tmp-ra.42 rax rbp)
                          (rax rbp)))
             (call-undead ())
             (conflicts
    ...
    (define L.tmp.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx tmp-ra.44 rbp) (rsi rdx rcx ball.6.15 tmp-ra.44 rbp)
                                                    (rdx rcx ball.6.15 tmp-ra.44 rbp)
                                                    (rcx ball.6.15 tmp-ra.44 rbp)
                                                    (ball.6.15 tmp-ra.44 rbp)
                                                    (tmp-ra.44 rax rbp)
                                                    (rax rbp)))
       (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (ball.6.21 foo.2.22 foobar.5.23 ball.3.24 tmp-ra.51))
                           (call-undead ())
                           (undead-out ((tmp-ra.51 rbp) (tmp-ra.51 rbp)
                                                        (tmp-ra.51 rbp)
                                                        (tmp-ra.51 rbp)
                                                        (ball.6.21 tmp-ra.51 rbp)
                                                        (tmp-ra.51 rax rbp)
                                                        (rax rbp)))
          ...
          (define L.fn.0.1
            ((new-frames ())
             ...
             (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.48 rbp)
                          (rsi rdx rcx r8 r9 fv0 tmp-ra.48 rbp)
                          (rdx rcx r8 r9 fv0 tmp-ra.48 rbp)
                          (rcx r8 r9 fv0 tmp-ra.48 rbp)
                          (r8 r9 fv0 tmp-ra.48 rbp)
                          (r9 fv0 tmp-ra.48 rbp)
    ...
    (define L.proc.1.2
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.49 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.49 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.49 rbp)
                                                              (rcx r8 r9 fv0 ball.7.12 tmp-ra.49 rbp)
                                                              (r8 r9 fv0 ball.7.12 tmp-ra.49 rbp)
                                                              (r9 fv0 ball.7.12 tmp-ra.49 rbp)
                                                              (fv0 ball.7.12 tmp-ra.49 rbp)
                                                              (ball.7.12 tmp-ra.49 rbp)
                                                              (tmp-ra.49 rax rbp)
                                                              (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.x.2.3
      ((new-frames ())
       ...
       (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.50 rbp) (rsi rdx rcx r8 r9 tmp-ra.50 rbp)
                                                          (rdx rcx r8 r9 tmp-ra.50 rbp)
                                                          (rcx r8 r9 tmp-ra.50 rbp)
                                                          (r8 r9 tmp-ra.50 rbp)
                                                          (r9 tmp-ra.50 rbp)
                                                          (tmp-ra.50 rbp)
                                                          (tmp-ra.50 rax rbp)
