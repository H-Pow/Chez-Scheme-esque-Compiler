...
(module+ test
  ...
  (undead-out ((x.1 r15) (x.1 y.2 r15)
  ((x.1 y.2 r15) ((r15) ()) ((r15) ())))))
  (begin (set! x.1 3) (set! y.2 x.1)
  (if (> y.2 x.1) (begin (set! rax x.1)
  (jump r15)) (begin (set! rax y.2) (jump r15))))))
  ...
  (check-equal?
   (undead-analysis '(module ((new-frames ()) (locals (tmp-ra.2)))
                             (define L.swap.1
   ...
   `(module ((new-frames ()) (locals (tmp-ra.2))
                             (call-undead ())
                             (undead-out ((tmp-ra.2 rbp) (tmp-ra.2 rsi rbp)
                                                         (tmp-ra.2 rsi rdi rbp)
                                                         (rsi rdi r15 rbp)
                                                         (rsi rdi r15 rbp))))
            (define L.swap.1
              ((new-frames (())) (locals (z.3 tmp-ra.1 x.1 y.2))
                                 (undead-out ((rdi rsi tmp-ra.1 rbp)
                                              (rsi x.1 tmp-ra.1 rbp)
                                              (y.2 x.1 tmp-ra.1 rbp)
                                              ((y.2 x.1 tmp-ra.1 rbp)
                                               ((tmp-ra.1 rax rbp) (rax rbp))
                                               (((rax tmp-ra.1 rbp) ((y.2 rsi rbp) (rsi rdi rbp)
                                                                                   (rsi rdi r15 rbp)
                                                                                   (rsi rdi r15 rbp)))
                                                (z.3 tmp-ra.1 rbp)
                                                (tmp-ra.1 rax rbp)
...
(module+ test
      ...
      (begin
        ...
        (if (begin
            ...
            (begin
              (set! rax -9223372036854775808)
              (jump tmp-ra.13 rbp rax))))))
  (check-by-interp '(module ((new-frames ()) (locals (tmp.2 tmp-ra.1)))
                            (begin
                              (set! tmp-ra.1 r15)
      ...
      (begin
        ...
        (if (true)
            ...
            (begin
              ...
              (set! r15 tmp-ra.18)
              (jump L.func.0.1 rbp r15 rdi))))))
  (check-by-interp '(module ((new-frames ()) (locals (tmp-ra.1 tmp.2)))
                            (begin
                              (set! tmp-ra.1 r15)
                              (if (begin
                                    (set! tmp.2 1)
  ...
  (check-by-interp '(module ((new-frames ()) (locals (bar.9.7 tmp-ra.10)))
                            (define L.func.0.1
  ...
  (check-by-interp '(module ((new-frames ()) (locals (foo.1.12 ball.9.13 tmp-ra.15)))
                            (define L.proc.0.1
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.9)))
      ...
      (begin
        ...
        (set! r15 tmp-ra.9)
        (jump L.x.1.2 rbp r15 rdi rsi rdx rcx r8 r9))))
  (check-by-interp '(module ((new-frames ()) (locals (tmp-ra.10)))
                            (define L.func.0.1
  ...
  (check-by-interp '(module ((new-frames ()) (locals (tmp-ra.17 tmp.19)))
                            (define L.tmp.0.1
      ...
      (begin
        ...
        (if (begin
            ...
            (begin
              (set! rax 0)
              (jump tmp-ra.29 rbp rax))))))
  (check-by-interp '(module ((new-frames ()) (locals (foobar.1.1 ball.8.2 ball.7.3 tmp-ra.4)))
                            (begin
                              (set! tmp-ra.4 r15)
  ...
  (check-by-interp '(module ((new-frames ()) (locals (tmp.3 tmp-ra.1 tmp.2)))
                            (begin
                              (set! tmp-ra.1 r15)
                              (if (begin
                                    (set! tmp.2 0)
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp.25 tmp-ra.23)))
      ...
      (begin
        ...
        (set! rax tmp.25)
        (jump tmp-ra.23 rbp rax))))
  (check-by-interp '(module ((new-frames ()) (locals (tmp-ra.3)))
                            (define L.func.0.1
      ...
      (begin
        ...
        (if (not (begin
            ...
            (begin
              ...
              (set! r15 tmp-ra.21)
              (jump L.tmp.1.2 rbp r15 rdi rsi rdx rcx r8 r9 fv0))))))
  (check-by-interp '(module ((new-frames ()) (locals (ball.8.3 bat.6.2 foo.5.1 tmp-ra.4)))
                            (begin
                              (set! tmp-ra.4 r15)
  ...
  (check-by-interp '(module ((new-frames ()) (locals (foobar.1.10 foobar.3.11
                                                                  foobar.1.2
                                                                  tmp.13
                                                                  foo.8.3
                                                                  foobar.3.4
  ...
  (check-by-interp '(module ((new-frames ()) (locals (tmp-ra.4)))
                            (define L.func.0.1
