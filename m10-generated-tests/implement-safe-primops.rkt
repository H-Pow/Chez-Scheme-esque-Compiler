...
(check-by-interp
 '(module
    ...
    (let ((g42771912.10 (if #f (void) (void))))
      (if (call error? g42771912.10)
        g42771912.10
        (let ((g42771913.11 (call fun/void8513.9)))
          (if (call error? g42771913.11)
            g42771913.11
            (let ((g42771914.12
                   (let ((vector0.13
                          (let ((tmp.7.14 (call make-vector 8)))
                            (let ((g42771915.15
                                   (call vector-set! tmp.7.14 0 0)))
                              (if (call error? g42771915.15)
                                g42771915.15
                                (let ((g42771916.16
                                       (call vector-set! tmp.7.14 1 1)))
                                  (if (call error? g42771916.16)
                                    g42771916.16
                                    (let ((g42771917.17
                                           (call vector-set! tmp.7.14 2 2)))
                                      (if (call error? g42771917.17)
                                        g42771917.17
                                        (let ((g42771918.18
                                               (call
                                                vector-set!
                                                      ...
                                                      (if (call
                                                        ...
                                                        (let ((g42771922.22
                                                          ...
                                                          (if (call
                                                            ...
                                                            tmp.7.14)))))))))))))))))))
                     (void))))
              (if (call error? g42771914.12)
                g42771914.12
                (let ((g42771923.23
                       (let ((g42771924.24 (void)))
                         (if (call error? g42771924.24)
                           g42771924.24
                           (let ((g42771925.25 (void)))
                             (if (call error? g42771925.25)
                               g42771925.25
                               (let ((g42771926.26 (void)))
                                 (if (call error? g42771926.26)
                                   g42771926.26
                                   (void)))))))))
                  (if (call error? g42771923.23)
                    g42771923.23
                    (let ((g42771927.27 (let () (void))))
                      (if (call error? g42771927.27)
                        g42771927.27
                        (let ((g42771928.28 (let () (void))))
                          (if (call error? g42771928.28)
                            g42771928.28
                            (call fun/void8514.8)))))))))))))))
            ...
            (if (if #f (error 148) (error 136))
              (if (let ((procedure0.17 (lambda () (error 109)))) (error 64))
                (let ((g42798643.18 (error 54)))
                  (if (call error? g42798643.18)
                    g42798643.18
                    (let ((g42798644.19 (error 109)))
                      (if (call error? g42798644.19)
                        g42798644.19
                        (error 200)))))
                #f)
              #f)
...
(check-by-interp
 '(module
    (let ((vector0.9
           (let ((tmp.7.10 (call make-vector 8)))
             (let ((g42836815.11
                    (call vector-set! tmp.7.10 0 (call make-vector 8))))
               (if (call error? g42836815.11)
                 g42836815.11
                 (let ((g42836816.12
                        (call
                         vector-set!
                   ...
                   (if (call error? g42836816.12)
                     ...
                     (let ((g42836817.13
                       ...
                       (if (call error? g42836817.13)
                         g42836817.13
                         (let ((g42836818.14
                                (call vector-set! tmp.7.10 3 #\l)))
                           (if (call error? g42836818.14)
                             g42836818.14
                             (let ((g42836819.15
                                    (call
                                     vector-set!
                               ...
                               (if (call error? g42836819.15)
                                 g42836819.15
                                 (let ((g42836820.16
                                        (call vector-set! tmp.7.10 5 (void))))
                                   (if (call error? g42836820.16)
                                     g42836820.16
                                     (let ((g42836821.17
                                            (call
                                             vector-set!
                                       ...
                                       (if (call error? g42836821.17)
                                         ...
                                         (let ((g42836822.18
                                                (call
                                                 ...
                                                 7
                                                 #f)))
                                           (if (call error? g42836822.18)
                                             g42836822.18
                                             tmp.7.10))))))))))))))))))
          (void1.8
           (let ((g42836823.19 (void)))
             (if (call error? g42836823.19)
               g42836823.19
               (let ((g42836824.20 (void)))
                 (if (call error? g42836824.20)
                   g42836824.20
                   (let ((g42836825.21 (void)))
                     (if (call error? g42836825.21)
                       g42836825.21
                       (let ((g42836826.22 (void)))
                         (if (call error? g42836826.22)
                           g42836826.22
                           (void)))))))))))
      (let () 170))))
(check-by-interp
 '(module
    ...
    (if (call fun/boolean8574.7 (call make-vector 8))
      (if #t #\C #\])
      (let ((void0.10 (void)) (pair1.9 (call cons 184 (call cons 385 empty))))
        #\Y))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    (define fun/vector8584.8
      (lambda ()
        (let ((tmp.7.11 (call make-vector 8)))
          (let ((g42848275.12 (call vector-set! tmp.7.11 0 1)))
            (if (call error? g42848275.12)
              g42848275.12
              (let ((g42848276.13 (call vector-set! tmp.7.11 1 2)))
                (if (call error? g42848276.13)
                  g42848276.13
                  (let ((g42848277.14 (call vector-set! tmp.7.11 2 3)))
                    (if (call error? g42848277.14)
                      g42848277.14
                      (let ((g42848278.15 (call vector-set! tmp.7.11 3 4)))
                        (if (call error? g42848278.15)
                          g42848278.15
                          (let ((g42848279.16 (call vector-set! tmp.7.11 4 5)))
                            (if (call error? g42848279.16)
                              g42848279.16
                              (let ((g42848280.17
                                     (call vector-set! tmp.7.11 5 6)))
                                (if (call error? g42848280.17)
                                  g42848280.17
                                  (let ((g42848281.18
                                         (call vector-set! tmp.7.11 6 7)))
                                    (if (call error? g42848281.18)
                                      g42848281.18
                                      (let ((g42848282.19
                                             (call vector-set! tmp.7.11 7 8)))
                                        (if (call error? g42848282.19)
                                          g42848282.19
                                          tmp.7.11)))))))))))))))))))
    ...
    (call
     >=
     (call * (let () 78) (call fun/fixnum8582.9))
                          ...
                          (if tmp.18.35
                            ...
                            (call
                             ...
                             (let ((g42852100.36 203))
                               (if (call error? g42852100.36)
                                 g42852100.36
                                 (let ((g42852101.37 29))
                                   (if (call error? g42852101.37)
                                     g42852101.37
                                     (let ((g42852102.38 74))
                                       (if (call error? g42852102.38)
                                         g42852102.38
                                         (let ((g42852103.39 228))
                                           (if (call error? g42852103.39)
                                             g42852103.39
                                             185)))))))))))))))))))))))
(check-by-interp
 '(module
    ...
    (let ((g42855921.19
           (let ((pair0.21 (call cons 253 (call cons 358 empty)))
                 (pair1.20 (call cons 169 (call cons 295 empty))))
             empty)))
      (if (call error? g42855921.19)
        g42855921.19
        (let ((g42855922.22
                     ...
                     (if tmp.8.24
                       ...
                       (let ((tmp.9.25
                              (let ((g42855923.26 empty))
                                (if (call error? g42855923.26)
                                  g42855923.26
                                  (let ((g42855924.27 empty))
                                    (if (call error? g42855924.27)
                                      g42855924.27
                                      (let ((g42855925.28 empty))
                                        (if (call error? g42855925.28)
                                          g42855925.28
                                          (let ((g42855926.29 empty))
                                            (if (call error? g42855926.29)
                                              g42855926.29
                                              (let ((g42855927.30 empty))
                                                (if (call error? g42855927.30)
                                                  g42855927.30
                                                  empty))))))))))))
                         (if tmp.9.25
                           tmp.9.25
          ...
          (if (call error? g42855922.22)
            g42855922.22
            (let ((g42855928.32 (call fun/empty8592.11)))
              (if (call error? g42855928.32)
                g42855928.32
                (let ((g42855929.33
                       (call
                        fun/empty8593.13
                        (let ((pair0.34 (call cons 112 (call cons 452 empty))))
                          (error 248)))))
                  (if (call error? g42855929.33)
                    g42855929.33
                    (let ((g42855930.35 (call fun/empty8594.12 (error 149))))
                      (if (call error? g42855930.35)
                        g42855930.35
                        (let ((g42855931.36 (let () empty)))
                          (if (call error? g42855931.36)
                            g42855931.36
...
(check-by-interp
 '(module
    ...
    (let ((g42859749.9 (call fun/fixnum8598.7)))
      (if (call error? g42859749.9)
        g42859749.9
        (let ((g42859750.10 (let () 107)))
          (if (call error? g42859750.10)
            g42859750.10
            (let ((g42859751.11 (call fun/fixnum8599.8)))
              (if (call error? g42859751.11)
                g42859751.11
                (if #t 192 15)))))))))
(check-by-interp
 '(module
                         ...
                         (if tmp.11.22
                           ...
                           (let ((tmp.12.23
                                  (let ((g42867385.24 (error 171)))
                                    (if (call error? g42867385.24)
                                      g42867385.24
                                      (let ((g42867386.25 (error 153)))
                                        (if (call error? g42867386.25)
                                          g42867386.25
                                          (let ((g42867387.26 (error 111)))
                                            (if (call error? g42867387.26)
                                              g42867387.26
                                              (let ((g42867388.27 (error 206)))
                                                (if (call error? g42867388.27)
                                                  g42867388.27
                                                  (error 173)))))))))))
                             (if tmp.12.23
                               tmp.12.23
         ...
         (let ((tmp.8.19 (if #f #f #t)))
           (if tmp.8.19
             ...
             (let ((tmp.9.20
                    (call
                     fun/boolean8626.14
                     (let ((tmp.10.21 (call make-vector 8)))
                       (let ((g42890275.22 (call vector-set! tmp.10.21 0 0)))
                         (if (call error? g42890275.22)
                           g42890275.22
                           (let ((g42890276.23
                                  (call vector-set! tmp.10.21 1 1)))
                             (if (call error? g42890276.23)
                               g42890276.23
                               (let ((g42890277.24
                                      (call vector-set! tmp.10.21 2 2)))
                                 (if (call error? g42890277.24)
                                   g42890277.24
                                   (let ((g42890278.25
                                          (call vector-set! tmp.10.21 3 3)))
                                     (if (call error? g42890278.25)
                                       g42890278.25
                                       (let ((g42890279.26
                                              (call
                                               vector-set!
               ...
               (if tmp.9.20
                 ...
                 (let ((tmp.11.30
                        (let ((procedure0.32
                               (lambda ()
                                 (let ((tmp.12.33 (call make-vector 8)))
                                   (let ((g42890283.34
                                          (call vector-set! tmp.12.33 0 0)))
                                     (if (call error? g42890283.34)
                                       g42890283.34
                                       (let ((g42890284.35
                                              (call
                                               vector-set!
                   ...
                   (if tmp.11.30
                     ...
                     (let ((ascii-char0.43 #\B)
                           (procedure1.42
                            (lambda ()
                              (let ((tmp.13.44 (call make-vector 8)))
                                (let ((g42890291.45
                                       (call vector-set! tmp.13.44 0 1)))
                                  (if (call error? g42890291.45)
                                    g42890291.45
                                    (let ((g42890292.46
                                           (call vector-set! tmp.13.44 1 2)))
                                      (if (call error? g42890292.46)
                                        g42890292.46
                                        (let ((g42890293.47
                                               (call
                                                vector-set!
...
(check-by-interp
 '(module
    ...
    (call
     fun/empty8631.7
     (let ((error0.9 (error 175))) (call cons 187 (call cons 430 empty))))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    (define fun/vector8638.8
      (lambda ()
        (let ((tmp.7.11 (call make-vector 8)))
          (let ((g42905563.12 (call vector-set! tmp.7.11 0 0)))
            (if (call error? g42905563.12)
              g42905563.12
              (let ((g42905564.13 (call vector-set! tmp.7.11 1 1)))
                (if (call error? g42905564.13)
                  g42905564.13
                  (let ((g42905565.14 (call vector-set! tmp.7.11 2 2)))
                    (if (call error? g42905565.14)
                      g42905565.14
                      (let ((g42905566.15 (call vector-set! tmp.7.11 3 3)))
                        (if (call error? g42905566.15)
                          g42905566.15
                          (let ((g42905567.16 (call vector-set! tmp.7.11 4 4)))
                            (if (call error? g42905567.16)
                              g42905567.16
                              (let ((g42905568.17
                                     (call vector-set! tmp.7.11 5 5)))
                                (if (call error? g42905568.17)
                                  g42905568.17
                                  (let ((g42905569.18
                                         (call vector-set! tmp.7.11 6 6)))
                                    (if (call error? g42905569.18)
                                      g42905569.18
                                      (let ((g42905570.19
                                             (call vector-set! tmp.7.11 7 7)))
                                        (if (call error? g42905570.19)
                                          g42905570.19
                                          tmp.7.11)))))))))))))))))))
...
(check-by-interp
 '(module
    (let ((vector0.8
           (let ((tmp.7.9 (call make-vector 8)))
             (let ((g42913205.10 (call vector-set! tmp.7.9 0 112)))
               (if (call error? g42913205.10)
                 g42913205.10
                 (let ((g42913206.11
                        (call vector-set! tmp.7.9 1 (lambda () 928))))
                   (if (call error? g42913206.11)
                     g42913206.11
                     (let ((g42913207.12 (call vector-set! tmp.7.9 2 empty)))
                       (if (call error? g42913207.12)
                         g42913207.12
                         (let ((g42913208.13 (call vector-set! tmp.7.9 3 #f)))
                           (if (call error? g42913208.13)
                             g42913208.13
                             (let ((g42913209.14
                                    (call vector-set! tmp.7.9 4 (void))))
                               (if (call error? g42913209.14)
                                 g42913209.14
                                 (let ((g42913210.15
                                        (call vector-set! tmp.7.9 5 #\t)))
                                   (if (call error? g42913210.15)
                                     g42913210.15
                                     (let ((g42913211.16
                                            (call
                                             vector-set!
      ...
      (lambda ()
        (let ((vector0.16
               (let ((tmp.7.17 (call make-vector 8)))
                 (let ((g42917032.18 (call vector-set! tmp.7.17 0 0)))
                   (if (call error? g42917032.18)
                     g42917032.18
                     (let ((g42917033.19 (call vector-set! tmp.7.17 1 1)))
                       (if (call error? g42917033.19)
                         g42917033.19
                         (let ((g42917034.20 (call vector-set! tmp.7.17 2 2)))
                           (if (call error? g42917034.20)
                             g42917034.20
                             (let ((g42917035.21
                                    (call vector-set! tmp.7.17 3 3)))
                               (if (call error? g42917035.21)
                                 g42917035.21
                                 (let ((g42917036.22
                                        (call vector-set! tmp.7.17 4 4)))
                                   (if (call error? g42917036.22)
                                     g42917036.22
                                     (let ((g42917037.23
                                            (call vector-set! tmp.7.17 5 5)))
                                       (if (call error? g42917037.23)
                                         g42917037.23
                                         (let ((g42917038.24
                                                (call
                                                 vector-set!
...
(check-by-interp
 '(module
    ...
    (let ((vector0.10
           (let ((tmp.7.11 (call make-vector 8)))
             (let ((g42920858.12 (call vector-set! tmp.7.11 0 empty)))
               (if (call error? g42920858.12)
                 g42920858.12
                 (let ((g42920859.13
                        (call
                         vector-set!
                         tmp.7.11
                         1
                         (let ((tmp.8.14 (call make-vector 8)))
                           (let ((g42920860.15
                                  (call vector-set! tmp.8.14 0 1)))
                             (if (call error? g42920860.15)
                               g42920860.15
                               (let ((g42920861.16
                                      (call vector-set! tmp.8.14 1 2)))
                                 (if (call error? g42920861.16)
                                   g42920861.16
                                   (let ((g42920862.17
                                          (call vector-set! tmp.8.14 2 3)))
                                     (if (call error? g42920862.17)
                                       g42920862.17
                                       (let ((g42920863.18
                                              (call vector-set! tmp.8.14 3 4)))
                                         (if (call error? g42920863.18)
                                           g42920863.18
                                           (let ((g42920864.19
                                                  (call
                                                   vector-set!
                                                     ...
                                                     (if (call
                                                       ...
                                                       (let ((g42920867.22
                                                         ...
                                                         (if (call
                                                           ...
                                                           g42920867.22
                                                           tmp.8.14))))))))))))))))))))
                   (if (call error? g42920859.13)
                     g42920859.13
                     (let ((g42920868.23 (call vector-set! tmp.7.11 2 (void))))
                       (if (call error? g42920868.23)
                         g42920868.23
                         (let ((g42920869.24
                                (call vector-set! tmp.7.11 3 (error 187))))
                           (if (call error? g42920869.24)
                             g42920869.24
                             (let ((g42920870.25
                                    (call vector-set! tmp.7.11 4 #t)))
                               (if (call error? g42920870.25)
                                 g42920870.25
                                 (let ((g42920871.26
                                        (call
                                         vector-set!
                                         ...
                                         5
                                         (error 0))))
                                   (if (call error? g42920871.26)
                                     g42920871.26
                                     (let ((g42920872.27
                                            (call vector-set! tmp.7.11 6 #\A)))
                                       (if (call error? g42920872.27)
                                         g42920872.27
                                         (let ((g42920873.28
                                                (call
                                                 vector-set!
 ...
 '(module
    ...
    (if (if #t 75 131)
      (if (let ((g42936134.9 219))
            (if (call error? g42936134.9)
              g42936134.9
              (let ((g42936135.10 29))
                (if (call error? g42936135.10)
                  g42936135.10
                  (let ((g42936136.11 199))
                    (if (call error? g42936136.11)
                      g42936136.11
                      (let ((g42936137.12 203))
                        (if (call error? g42936137.12) g42936137.12 163))))))))
        (call fun/fixnum8664.7 (call cons 205 (call cons 453 empty)))
        #f)
      #f)))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    ...
    (let ((g42943766.11
      ...
      (if (call error? g42943766.11) g42943766.11 (call fun/empty8671.10)))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    ...
    (let ((boolean0.12 (call fixnum? (call fun/any8677.9)))
          (pair1.11
           (call
            cons
            #t
          ...
          (vector2.10
           (let ((tmp.7.13 (call make-vector 8)))
             (let ((g42951404.14
               ...
               (if (call error? g42951404.14)
                 g42951404.14
                 (let ((g42951405.15
                        (call vector-set! tmp.7.13 1 (let () (error 49)))))
                   (if (call error? g42951405.15)
                     g42951405.15
                     (let ((g42951406.16
                            (call
                             vector-set!
 ...
 '(module
    ...
    (let ((pair0.22
          ...
          (procedure2.20
           (lambda ()
             (let ()
               (let ((tmp.7.23 (call make-vector 8)))
                 (let ((g42955226.24 (call vector-set! tmp.7.23 0 0)))
                   (if (call error? g42955226.24)
                     g42955226.24
                     (let ((g42955227.25 (call vector-set! tmp.7.23 1 1)))
                       (if (call error? g42955227.25)
                         g42955227.25
                         (let ((g42955228.26 (call vector-set! tmp.7.23 2 2)))
                           (if (call error? g42955228.26)
                             g42955228.26
                             (let ((g42955229.27
                                    (call vector-set! tmp.7.23 3 3)))
                               (if (call error? g42955229.27)
                                 g42955229.27
                                 (let ((g42955230.28
                                        (call vector-set! tmp.7.23 4 4)))
                                   (if (call error? g42955230.28)
                                     g42955230.28
                                     (let ((g42955231.29
                                            (call vector-set! tmp.7.23 5 5)))
                                       (if (call error? g42955231.29)
                                         g42955231.29
                                         (let ((g42955232.30
                                                (call
                                                 vector-set!
                                           ...
                                           (if (call error? g42955232.30)
                                             ...
                                             (let ((g42955233.31
                                                    (call
                                                     ...
                                                     7
                                                     7)))
                                               (if (call error? g42955233.31)
                                                 g42955233.31
                                                 tmp.7.23)))))))))))))))))))))
      (let ((tmp.8.32 (if #f #f #t)))
        (if tmp.8.32
          tmp.8.32
          (let ((tmp.9.33 (call procedure? (error 58))))
            (if tmp.9.33
              tmp.9.33
                ...
                (if tmp.10.34
                  ...
                  (let ((tmp.11.35 (call fun/boolean8684.19)))
                    (if tmp.11.35
                      ...
                      (let ((tmp.12.36
                             (let ((g42955234.37 #f))
                               (if (call error? g42955234.37)
                                 g42955234.37
                                 (let ((g42955235.38 #t))
                                   (if (call error? g42955235.38)
                                     g42955235.38
                                     #t))))))
                        (if tmp.12.36
                          tmp.12.36
 ...
 '(module
    ...
    (let ((tmp.7.19
      ...
      (if tmp.7.19
        tmp.7.19
        (let ((tmp.10.23
               (let ((pair0.24 (call cons 29 (call cons 492 empty))))
                 (error 235))))
          (if tmp.10.23
            tmp.10.23
            (let ((tmp.11.25 (if #f (error 222) (error 127))))
              (if tmp.11.25
                ...
                (let ((tmp.12.26
                       (let ((vector0.27
                              (let ((tmp.13.28 (call make-vector 8)))
                                (let ((g42959050.29
                                       (call vector-set! tmp.13.28 0 1)))
                                  (if (call error? g42959050.29)
                                    g42959050.29
                                    (let ((g42959051.30
                                           (call vector-set! tmp.13.28 1 2)))
                                      (if (call error? g42959051.30)
                                        g42959051.30
                                        (let ((g42959052.31
                                               (call
                                                vector-set!
...
(check-by-interp
 '(module
    ...
    (if (let ((tmp.7.19
               (let ((pair0.21 (call cons 214 (call cons 273 empty)))
                     (error1.20 (error 15)))
                 #t)))
          (if tmp.7.19
            tmp.7.19
            (let ((tmp.8.22 (call boolean? #\^)))
              (if tmp.8.22
                tmp.8.22
                (let ((tmp.9.23 (call fun/boolean8691.13)))
                  (if tmp.9.23
                    tmp.9.23
                    (let ((tmp.10.24 (call error? #f)))
      ...
      (call
       fun/void8693.12
       (let ((g42962877.28 26))
         (if (call error? g42962877.28)
           g42962877.28
           (let ((g42962878.29 21))
             (if (call error? g42962878.29)
               g42962878.29
               (let ((g42962879.30 162))
                 (if (call error? g42962879.30)
                   g42962879.30
                   (let ((g42962880.31 104))
                     (if (call error? g42962880.31) g42962880.31 106))))))))
 ...
 '(module
    ...
    (define fun/void8711.29
      (lambda (oprand0.36 oprand1.35)
        (call vector-set! oprand1.35 5 oprand0.36)))
      ...
      (if (if (if #f (void) (void))
            (if (let ((tmp.7.39 (if (void) (void) #f)))
              ...
              (if (call
                   ...
                   (if #f (void) (void)))
                (if (let ((vector0.48
                           (let ((tmp.13.49 (call make-vector 8)))
                             (let ((g42974327.50
                                    (call vector-set! tmp.13.49 0 0)))
                               (if (call error? g42974327.50)
                                 g42974327.50
                                 (let ((g42974328.51
                                        (call vector-set! tmp.13.49 1 1)))
                                   (if (call error? g42974328.51)
                                     g42974328.51
                                     (let ((g42974329.52
                                            (call vector-set! tmp.13.49 2 2)))
                                       (if (call error? g42974329.52)
                                         g42974329.52
                                         (let ((g42974330.53
                                                (call
                                                 vector-set!
                          ...
                          (ascii-char1.47 #\n)
                          (vector2.46
                           (let ((tmp.14.58 (call make-vector 8)))
                             (let ((g42974335.59
                                    (call vector-set! tmp.14.58 0 0)))
                               (if (call error? g42974335.59)
                                 g42974335.59
                                 (let ((g42974336.60
                                        (call vector-set! tmp.14.58 1 1)))
                                   (if (call error? g42974336.60)
                                     g42974336.60
                                     (let ((g42974337.61
                                            (call vector-set! tmp.14.58 2 2)))
                                       (if (call error? g42974337.61)
                                         g42974337.61
                                         (let ((g42974338.62
                                                (call
                                                 vector-set!
        ...
        (if (if (let ((boolean0.69 #f)) #t)
          ...
          (if (let ()
                (call
                 fun/void8711.29
                 (lambda () 1012)
                 (let ((tmp.16.70 (call make-vector 8)))
                   (let ((g42974343.71 (call vector-set! tmp.16.70 0 1)))
                     (if (call error? g42974343.71)
                       g42974343.71
                       (let ((g42974344.72 (call vector-set! tmp.16.70 1 2)))
                         (if (call error? g42974344.72)
                           g42974344.72
                           (let ((g42974345.73
                                  (call vector-set! tmp.16.70 2 3)))
                             (if (call error? g42974345.73)
                               g42974345.73
                               (let ((g42974346.74
                                      (call vector-set! tmp.16.70 3 4)))
                                 (if (call error? g42974346.74)
                                   g42974346.74
                                   (let ((g42974347.75
                                          (call vector-set! tmp.16.70 4 5)))
                                     (if (call error? g42974347.75)
                                       g42974347.75
                                       (let ((g42974348.76
                                              (call
                                               vector-set!
                                             ...
                                             (if (call error? g42974349.77)
                                               ...
                                               (let ((g42974350.78
                                                      (call
                                                       ...
                                                       7
                                                       8)))
                                                 (if (call error? g42974350.78)
                                                   g42974350.78
                                                   tmp.16.70)))))))))))))))))))
            (if (if (call fun/boolean8712.27)
                  (let ((pair0.81 (call cons 164 (call cons 281 empty)))
                        (vector1.80
                         (let ((tmp.17.82 (call make-vector 8)))
                           (let ((g42974351.83
                                  (call vector-set! tmp.17.82 0 1)))
                             (if (call error? g42974351.83)
                               g42974351.83
                               (let ((g42974352.84
                                      (call vector-set! tmp.17.82 1 2)))
                                 (if (call error? g42974352.84)
                                   g42974352.84
                                   (let ((g42974353.85
                                          (call vector-set! tmp.17.82 2 3)))
                                     (if (call error? g42974353.85)
                                       g42974353.85
                                       (let ((g42974354.86
                                              (call
                                               vector-set!
    ...
    (define fun/fixnum8721.8
      (lambda ()
        (if (call fun/boolean8722.7)
          ...
          (let ((pair0.11 (call cons 87 (call cons 424 empty)))
                (fixnum1.10 124))
            132))))
 ...
 '(module
    ...
    (let ((g42981987.10
           (let ((g42981988.11 (call fun/ascii-char8725.9)))
             (if (call error? g42981988.11)
               g42981988.11
               (let ((g42981989.12 (if #f #\k #\i)))
                 (if (call error? g42981989.12)
                   g42981989.12
                   (if #t #\C #\E)))))))
      (if (call error? g42981987.10)
        g42981987.10
        (let ((g42981990.13 (call fun/ascii-char8726.8)))
          (if (call error? g42981990.13)
            g42981990.13
            (let ((vector0.14
                   (let ((tmp.7.15 (call make-vector 8)))
                     (let ((g42981991.16
                            (call
                             ...
                             0
                             (call make-vector 8))))
                       (if (call error? g42981991.16)
                         g42981991.16
                         (let ((g42981992.17
                                (call vector-set! tmp.7.15 1 #\\)))
                           (if (call error? g42981992.17)
                             g42981992.17
                             (let ((g42981993.18
                                    (call
                                     vector-set!
                                     ...
                                     2
                                     (lambda () 1020))))
                               (if (call error? g42981993.18)
                                 g42981993.18
                                 (let ((g42981994.19
                                        (call vector-set! tmp.7.15 3 231)))
                                   (if (call error? g42981994.19)
                                     g42981994.19
                                     (let ((g42981995.20
                                            (call
                                             vector-set!
    ...
    (let ((tmp.7.26
           (let ()
             (let ((g42985819.27 empty))
               (if (call error? g42985819.27) g42985819.27 empty)))))
      (if tmp.7.26
        tmp.7.26
        (let ((tmp.8.28
               (call
          ...
          (if tmp.8.28
            ...
            (let ((tmp.9.29
                   (let ((vector0.32
                          (let ((tmp.10.33 (call make-vector 8)))
                            (let ((g42985820.34
                                   (call
                                    vector-set!
                                    tmp.10.33
                                    0
                                    (let ((tmp.11.35 (call make-vector 8)))
                                      (let ((g42985821.36
                                             (call vector-set! tmp.11.35 0 1)))
                                        (if (call error? g42985821.36)
                                          g42985821.36
                                          (let ((g42985822.37
                                                 (call
                                                  vector-set!
                                                                ...
                                                                (if (call
                                                                  ...
                                                                  (let ((g42985828.43
                                                                    ...
                                                                    (if (call
                                                                      ...
                                                                      g42985828.43
                                                                      tmp.11.35))))))))))))))))))))
                              (if (call error? g42985820.34)
                                g42985820.34
                                (let ((g42985829.44
                                       (call vector-set! tmp.10.33 1 #t)))
                                  (if (call error? g42985829.44)
                                    g42985829.44
                                    (let ((g42985830.45
                                           (call
                                            vector-set!
              ...
              (if tmp.9.29
                ...
                (let ((tmp.12.51
                       (if (let ((error0.54 (error 40))
                                 (vector1.53
                                  (let ((tmp.13.55 (call make-vector 8)))
                                    (let ((g42985836.56
                                           (call vector-set! tmp.13.55 0 1)))
                                      (if (call error? g42985836.56)
                                        g42985836.56
                                        (let ((g42985837.57
                                               (call
                                                vector-set!
                         ...
                         (let ((g42985844.70 empty))
                           (if (call error? g42985844.70)
                             g42985844.70
                             (let ((g42985845.71 empty))
                               (if (call error? g42985845.71)
                                 g42985845.71
                                 empty)))))))
                  (if tmp.12.51
                    tmp.12.51
 ...
 '(module
    ...
    (let ()
      (let ((g42993474.15 (call fun/void8740.12 191 72)))
        (if (call error? g42993474.15)
          g42993474.15
          (let ((g42993475.16
                 (let ((g42993476.17 (void)))
                   (if (call error? g42993476.17)
                     g42993476.17
                     (let ((g42993477.18 (void)))
                       (if (call error? g42993477.18)
                         g42993477.18
                         (let ((g42993478.19 (void)))
                           (if (call error? g42993478.19)
                             g42993478.19
                             (let ((g42993479.20 (void)))
                               (if (call error? g42993479.20)
                                 g42993479.20
                                 (let ((g42993480.21 (void)))
                                   (if (call error? g42993480.21)
                                     g42993480.21
                                     (void)))))))))))))
            (if (call error? g42993475.16)
              g42993475.16
              (let ((g42993481.22 (call fun/void8741.11)))
                (if (call error? g42993481.22)
                  g42993481.22
                  (let ((g42993482.23 (let () (void))))
                    (if (call error? g42993482.23)
                      g42993482.23
                      (let ((g42993483.24
                             (let ((tmp.7.25 (void)))
                               (if tmp.7.25
...
(check-by-interp
 '(module
    ...
    (define fun/vector8748.10
      (lambda ()
        (let ((tmp.7.14 (call make-vector 8)))
          (let ((g42997298.15 (call vector-set! tmp.7.14 0 0)))
            (if (call error? g42997298.15)
              g42997298.15
              (let ((g42997299.16 (call vector-set! tmp.7.14 1 1)))
                (if (call error? g42997299.16)
                  g42997299.16
                  (let ((g42997300.17 (call vector-set! tmp.7.14 2 2)))
                    (if (call error? g42997300.17)
                      g42997300.17
                      (let ((g42997301.18 (call vector-set! tmp.7.14 3 3)))
                        (if (call error? g42997301.18)
                          g42997301.18
                          (let ((g42997302.19 (call vector-set! tmp.7.14 4 4)))
                            (if (call error? g42997302.19)
                              g42997302.19
                              (let ((g42997303.20
                                     (call vector-set! tmp.7.14 5 5)))
                                (if (call error? g42997303.20)
                                  g42997303.20
                                  (let ((g42997304.21
                                         (call vector-set! tmp.7.14 6 6)))
                                    (if (call error? g42997304.21)
                                      g42997304.21
                                      (let ((g42997305.22
                                             (call vector-set! tmp.7.14 7 7)))
                                        (if (call error? g42997305.22)
                                          g42997305.22
                                          tmp.7.14)))))))))))))))))))
    ...
    (call
     fun/empty8744.9
     (let ((fixnum0.24 (call + 209 230)) (fixnum1.23 (let () 196)))
...
(check-by-interp
 '(module
    ...
    (if (let ((ascii-char0.14 #\q) (void1.13 (void)) (boolean2.12 #t)) #t)
      ...
      (let ((tmp.7.18 (call ascii-char? (lambda () 526))))
        (if tmp.7.18
          tmp.7.18
            ...
            (if tmp.8.19
              ...
              (let ((tmp.9.20 (call fun/boolean8753.10 195)))
                (if tmp.9.20
                  tmp.9.20
                  (let ((g43004938.21 #f))
                    (if (call error? g43004938.21)
                      g43004938.21
                      (let ((g43004939.22 #f))
                        (if (call error? g43004939.22)
                          g43004939.22
                          (let ((g43004940.23 #t))
                            (if (call error? g43004940.23)
                              g43004940.23
                              (let ((g43004941.24 #t))
                                (if (call error? g43004941.24)
                                  g43004941.24
                                  (let ((g43004942.25 #t))
                                    (if (call error? g43004942.25)
                                      g43004942.25
                                      (let ((g43004943.26 #t))
                                        (if (call error? g43004943.26)
                                          g43004943.26
                                          #f)))))))))))))))))))))
(check-by-interp
 '(module
    ...
    (if (call
         ...
         (let ((void0.12 (void)))
           (let ((tmp.7.13 (call make-vector 8)))
             (let ((g43008758.14 (call vector-set! tmp.7.13 0 1)))
               (if (call error? g43008758.14)
                 g43008758.14
                 (let ((g43008759.15 (call vector-set! tmp.7.13 1 2)))
                   (if (call error? g43008759.15)
                     g43008759.15
                     (let ((g43008760.16 (call vector-set! tmp.7.13 2 3)))
                       (if (call error? g43008760.16)
                         g43008760.16
                         (let ((g43008761.17 (call vector-set! tmp.7.13 3 4)))
                           (if (call error? g43008761.17)
                             g43008761.17
                             (let ((g43008762.18
                                    (call vector-set! tmp.7.13 4 5)))
                               (if (call error? g43008762.18)
                                 g43008762.18
                                 (let ((g43008763.19
                                        (call vector-set! tmp.7.13 5 6)))
                                   (if (call error? g43008763.19)
                                     g43008763.19
                                     (let ((g43008764.20
                                            (call vector-set! tmp.7.13 6 7)))
                                       (if (call error? g43008764.20)
                                         g43008764.20
                                         (let ((g43008765.21
                                                (call
                                                 vector-set!
...
(check-by-interp
 '(module
    ...
    (let ((empty0.12
          ...
          (empty1.11 (let () empty)))
      (if (let ((pair0.15 (call cons 164 (call cons 328 empty)))) #\Z)
...
(check-by-interp
 '(module
    ...
    (if (call
      ...
      (let ((vector0.18
             (let ((tmp.8.19 (call make-vector 8)))
               (let ((g43016397.20 (call vector-set! tmp.8.19 0 1)))
                 (if (call error? g43016397.20)
                   g43016397.20
                   (let ((g43016398.21 (call vector-set! tmp.8.19 1 2)))
                     (if (call error? g43016398.21)
                       g43016398.21
                       (let ((g43016399.22 (call vector-set! tmp.8.19 2 3)))
                         (if (call error? g43016399.22)
                           g43016399.22
                           (let ((g43016400.23
                                  (call vector-set! tmp.8.19 3 4)))
                             (if (call error? g43016400.23)
                               g43016400.23
                               (let ((g43016401.24
                                      (call vector-set! tmp.8.19 4 5)))
                                 (if (call error? g43016401.24)
                                   g43016401.24
                                   (let ((g43016402.25
                                          (call vector-set! tmp.8.19 5 6)))
                                     (if (call error? g43016402.25)
                                       g43016402.25
                                       (let ((g43016403.26
                                              (call vector-set! tmp.8.19 6 7)))
                                         (if (call error? g43016403.26)
                                           g43016403.26
                                           (let ((g43016404.27
                                                  (call
                                                   vector-set!
    ...
    (call
     ...
     (if (let () 213)
       (if (call fun/fixnum8771.8)
         (if (if #t 219 12)
           (if (if #f 137 140)
             (if (call fun/fixnum8773.7 (call * 130 63)) (let () 156) #f)
             #f)
           #f)
         #f)
       #f)
     (if (let ((fixnum0.17 100)
               (pair1.16 (call cons 19 (call cons 454 empty)))
               (pair2.15 (call cons 5 (call cons 453 empty))))
           #f)
       (call + 124 32)
       (call fun/fixnum8775.9 (call cons 111 (call cons 440 empty)))))))
        ...
        (if (if #t empty empty)
          (if (if #t empty empty)
            (if (call fun/empty8780.8)
              (if (let ((pair0.11 (call cons 18 (call cons 445 empty)))
                        (vector1.10
                         (let ((tmp.7.12 (call make-vector 8)))
                           (let ((g43031664.13
                                  (call vector-set! tmp.7.12 0 1)))
                             (if (call error? g43031664.13)
                               g43031664.13
                               (let ((g43031665.14
                                      (call vector-set! tmp.7.12 1 2)))
                                 (if (call error? g43031665.14)
                                   g43031665.14
                                   (let ((g43031666.15
                                          (call vector-set! tmp.7.12 2 3)))
                                     (if (call error? g43031666.15)
                                       g43031666.15
                                       (let ((g43031667.16
                                              (call vector-set! tmp.7.12 3 4)))
                                         (if (call error? g43031667.16)
                                           g43031667.16
                                           (let ((g43031668.17
                                                  (call
                                                   vector-set!
                                                     ...
                                                     (if (call
                                                       ...
                                                       (let ((g43031671.20
                                                         ...
                                                         (if (call
                                                           ...
                                                           g43031671.20
                                                           tmp.7.12))))))))))))))))))
                        (pair2.9 (call cons 194 (call cons 316 empty))))
                    empty)
                (if #t empty empty)
                #f)
              #f)
 ...
 '(module
    ...
    (let ((tmp.7.37
                ...
                (let ((g43035490.39
                       (if (void)
                         (if (void)
                           ...
                           #f)
                         #f)))
                  (if (call error? g43035490.39)
                    g43035490.39
                    (let ((g43035491.40 (void)))
                      (if (call error? g43035491.40)
                        g43035491.40
                        (let ((g43035492.41
                               (let ((g43035493.42 (void)))
                                 (if (call error? g43035493.42)
                                   g43035493.42
                                   (void)))))
                          (if (call error? g43035492.41)
                            g43035492.41
                            (let ((g43035494.43 (call fun/void8786.25)))
                              (if (call error? g43035494.43)
                                g43035494.43
                                (let ((g43035495.44
                                       (call
                                        fun/void8787.28
                                        (let ((tmp.8.45 (call make-vector 8)))
                                          (let ((g43035496.46
                                                 (call
                                                  vector-set!
                                                  tmp.8.45
      ...
      (if tmp.7.37
        ...
        (let ((tmp.9.55
               (let ((vector0.56
                      (let ((tmp.10.57 (call make-vector 8)))
                        (let ((g43035504.58
                               (call vector-set! tmp.10.57 0 empty)))
                          (if (call error? g43035504.58)
                            g43035504.58
                            (let ((g43035505.59
                                   (call vector-set! tmp.10.57 1 #\Y)))
                              (if (call error? g43035505.59)
                                g43035505.59
                                (let ((g43035506.60
                                       (call vector-set! tmp.10.57 2 211)))
                                  (if (call error? g43035506.60)
                                    g43035506.60
                                    (let ((g43035507.61
                                           (call
                                            vector-set!
                  ...
                  (if tmp.15.70
                    ...
                    (call
                     ...
                     (let ((tmp.16.71
                            (if #t
                              (call make-vector 8)
                              (let ((tmp.17.72 (call make-vector 8)))
                                (let ((g43035512.73
                                       (call vector-set! tmp.17.72 0 1)))
                                  (if (call error? g43035512.73)
                                    g43035512.73
                                    (let ((g43035513.74
                                           (call vector-set! tmp.17.72 1 2)))
                                      (if (call error? g43035513.74)
                                        g43035513.74
                                        (let ((g43035514.75
                                               (call
                                                vector-set!
                       ...
                       (if tmp.16.71
                         tmp.16.71
                         (if (let ((tmp.18.81 (call make-vector 8)))
                               (let ((g43035520.82
                                      (call vector-set! tmp.18.81 0 1)))
                                 (if (call error? g43035520.82)
                                   g43035520.82
                                   (let ((g43035521.83
                                          (call vector-set! tmp.18.81 1 2)))
                                     (if (call error? g43035521.83)
                                       g43035521.83
                                       (let ((g43035522.84
                                              (call
                                               vector-set!
                                                         ...
                                                         (if (call
                                                           ...
                                                           (let ((g43035527.89
                                                             ...
                                                             (if (call
                                                               ...
                                                               g43035527.89
                                                               tmp.18.81)))))))))))))))))
                           (if (let ((tmp.19.90 (call make-vector 8)))
                                 (let ((g43035528.91
                                        (call vector-set! tmp.19.90 0 1)))
                                   (if (call error? g43035528.91)
                                     g43035528.91
                                     (let ((g43035529.92
                                            (call vector-set! tmp.19.90 1 2)))
                                       (if (call error? g43035529.92)
                                         g43035529.92
                                         (let ((g43035530.93
                                                (call
                                                 vector-set!
                                                           ...
                                                           (if (call
                                                             ...
                                                             (let ((g43035535.98
                                                               ...
                                                               (if (call
                                                                 ...
                                                                 g43035535.98
                                                                 tmp.19.90)))))))))))))))))
                             (let ((tmp.20.99 (call make-vector 8)))
                               (let ((g43035536.100
                                      (call vector-set! tmp.20.99 0 1)))
                                 (if (call error? g43035536.100)
                                   g43035536.100
                                   (let ((g43035537.101
                                          (call vector-set! tmp.20.99 1 2)))
                                     (if (call error? g43035537.101)
                                       g43035537.101
                                       (let ((g43035538.102
                                              (call
                                               vector-set!
          ...
          (if tmp.8.24
            ...
            (let ((tmp.9.26
                   (call
                    ...
                    (call
                     fun/boolean8796.14
                     (let ((tmp.10.27 (call make-vector 8)))
                       (let ((g43039358.28 (call vector-set! tmp.10.27 0 0)))
                         (if (call error? g43039358.28)
                           g43039358.28
                           (let ((g43039359.29
                                  (call vector-set! tmp.10.27 1 1)))
                             (if (call error? g43039359.29)
                               g43039359.29
                               (let ((g43039360.30
                                      (call vector-set! tmp.10.27 2 2)))
                                 (if (call error? g43039360.30)
                                   g43039360.30
                                   (let ((g43039361.31
                                          (call vector-set! tmp.10.27 3 3)))
                                     (if (call error? g43039361.31)
                                       g43039361.31
                                       (let ((g43039362.32
                                              (call
                                               vector-set!
...
(check-by-interp
 '(module
    ...
    (if (call fixnum? (call fun/any8804.8 empty (void)))
       ...
       (let ((void0.15 (void))
             (vector1.14
              (let ((tmp.7.16 (call make-vector 8)))
                (let ((g43047001.17 (call vector-set! tmp.7.16 0 1)))
                  (if (call error? g43047001.17)
                    g43047001.17
                    (let ((g43047002.18 (call vector-set! tmp.7.16 1 2)))
                      (if (call error? g43047002.18)
                        g43047002.18
                        (let ((g43047003.19 (call vector-set! tmp.7.16 2 3)))
                          (if (call error? g43047003.19)
                            g43047003.19
                            (let ((g43047004.20
                                   (call vector-set! tmp.7.16 3 4)))
                              (if (call error? g43047004.20)
                                g43047004.20
                                (let ((g43047005.21
                                       (call vector-set! tmp.7.16 4 5)))
                                  (if (call error? g43047005.21)
                                    g43047005.21
                                    (let ((g43047006.22
                                           (call vector-set! tmp.7.16 5 6)))
                                      (if (call error? g43047006.22)
                                        g43047006.22
                                        (let ((g43047007.23
                                               (call
                                                vector-set!
...
(check-by-interp
 '(module
    (define fun/fixnum8807.7
      (lambda () (let ((pair0.8 (call cons #\j (error 63)))) 37)))
 ...
 '(module
    (let ((empty0.10 (let ((tmp.7.11 empty)) (if tmp.7.11 tmp.7.11 empty)))
          (ascii-char1.9
           (let ((g43062278.12
                  (let ((g43062279.13 #\_))
                    (if (call error? g43062279.13)
                      g43062279.13
                      (let ((g43062280.14 #\Z))
                        (if (call error? g43062280.14)
                          g43062280.14
                          (let ((g43062281.15 #\u))
                            (if (call error? g43062281.15)
                              g43062281.15
                              #\Q))))))))
             (if (call error? g43062278.12)
               g43062278.12
               (let ((g43062282.16 (let () #\^)))
                 (if (call error? g43062282.16)
                   g43062282.16
                   (let ((g43062283.17 (let () #\l)))
                     (if (call error? g43062283.17)
                       g43062283.17
                       (let () #\m))))))))
...
(check-by-interp
 '(module
    ...
    (define fun/ascii-char8823.8
      (lambda ()
        (if (call fun/boolean8824.10 (call cons 112 (call cons 300 empty)))
...
(check-by-interp
 '(module
    (if (let ((g43077547.8 (let () #t)))
          (if (call error? g43077547.8)
            g43077547.8
            (let ((g43077548.9
                   (if #t
                     (if #f (if #f (if #t (if #t (if #t #t #f) #f) #f) #f) #f)
                     #f)))
              (if (call error? g43077548.9)
                g43077548.9
                (let ((g43077549.10 (if #t #f #f)))
                  (if (call error? g43077549.10)
                    g43077549.10
                    (let ((g43077550.11 (if #f #f #t)))
                      (if (call error? g43077550.11)
                        g43077550.11
                        (let () #f)))))))))
      (let ((error0.14 (error 211)) (boolean1.13 #f) (boolean2.12 #t)) (void))
      (let ((ascii-char0.17 #\F)
            (vector1.16
             (let ((tmp.7.18 (call make-vector 8)))
               (let ((g43077551.19 (call vector-set! tmp.7.18 0 1)))
                 (if (call error? g43077551.19)
                   g43077551.19
                   (let ((g43077552.20 (call vector-set! tmp.7.18 1 2)))
                     (if (call error? g43077552.20)
                       g43077552.20
                       (let ((g43077553.21 (call vector-set! tmp.7.18 2 3)))
                         (if (call error? g43077553.21)
                           g43077553.21
                           (let ((g43077554.22
                                  (call vector-set! tmp.7.18 3 4)))
                             (if (call error? g43077554.22)
                               g43077554.22
                               (let ((g43077555.23
                                      (call vector-set! tmp.7.18 4 5)))
                                 (if (call error? g43077555.23)
                                   g43077555.23
                                   (let ((g43077556.24
                                          (call vector-set! tmp.7.18 5 6)))
                                     (if (call error? g43077556.24)
                                       g43077556.24
                                       (let ((g43077557.25
                                              (call vector-set! tmp.7.18 6 7)))
                                         (if (call error? g43077557.25)
                                           g43077557.25
                                           (let ((g43077558.26
                                                  (call
                                                   vector-set!
 ...
 '(module
    ...
    (if (call
         ...
         (let ((g43081376.26 (error 9)))
           (if (call error? g43081376.26)
             g43081376.26
             (let ((g43081377.27 (error 98)))
               (if (call error? g43081377.27)
                 g43081377.27
                 (let ((g43081378.28 (error 17)))
                   (if (call error? g43081378.28) g43081378.28 (error 22)))))))
         (let ((g43081379.29
                (let ((tmp.7.30 (call make-vector 8)))
                  (let ((g43081380.31 (call vector-set! tmp.7.30 0 0)))
                    (if (call error? g43081380.31)
                      g43081380.31
                      (let ((g43081381.32 (call vector-set! tmp.7.30 1 1)))
                        (if (call error? g43081381.32)
                          g43081381.32
                          (let ((g43081382.33 (call vector-set! tmp.7.30 2 2)))
                            (if (call error? g43081382.33)
                              g43081382.33
                              (let ((g43081383.34
                                     (call vector-set! tmp.7.30 3 3)))
                                (if (call error? g43081383.34)
                                  g43081383.34
                                  (let ((g43081384.35
                                         (call vector-set! tmp.7.30 4 4)))
                                    (if (call error? g43081384.35)
                                      g43081384.35
                                      (let ((g43081385.36
                                             (call vector-set! tmp.7.30 5 5)))
                                        (if (call error? g43081385.36)
                                          g43081385.36
                                          (let ((g43081386.37
                                                 (call
                                                  vector-set!
                                            ...
                                            (if (call error? g43081386.37)
                                              ...
                                              (let ((g43081387.38
                                                     (call
                                                      ...
                                                      7
                                                      7)))
                                                (if (call error? g43081387.38)
                                                  g43081387.38
                                                  tmp.7.30)))))))))))))))))))
           (if (call error? g43081379.29)
             g43081379.29
             (let ((g43081388.39
                    (let ((tmp.8.40 (call make-vector 8)))
                      (let ((g43081389.41 (call vector-set! tmp.8.40 0 1)))
                        (if (call error? g43081389.41)
                          g43081389.41
                          (let ((g43081390.42 (call vector-set! tmp.8.40 1 2)))
                            (if (call error? g43081390.42)
                              g43081390.42
                              (let ((g43081391.43
                                     (call vector-set! tmp.8.40 2 3)))
                                (if (call error? g43081391.43)
                                  g43081391.43
                                  (let ((g43081392.44
                                         (call vector-set! tmp.8.40 3 4)))
                                    (if (call error? g43081392.44)
                                      g43081392.44
                                      (let ((g43081393.45
                                             (call vector-set! tmp.8.40 4 5)))
                                        (if (call error? g43081393.45)
                                          g43081393.45
                                          (let ((g43081394.46
                                                 (call
                                                  vector-set!
                                                ...
                                                (if (call error? g43081395.47)
                                                  ...
                                                  (let ((g43081396.48
                                                    ...
                                                    (if (call
                                                      ...
                                                      g43081396.48
                                                      tmp.8.40)))))))))))))))))))
               (if (call error? g43081388.39)
                 g43081388.39
                 (let ((tmp.9.49 (call make-vector 8)))
                   (let ((g43081397.50 (call vector-set! tmp.9.49 0 1)))
                     (if (call error? g43081397.50)
                       g43081397.50
                       (let ((g43081398.51 (call vector-set! tmp.9.49 1 2)))
                         (if (call error? g43081398.51)
                           g43081398.51
                           (let ((g43081399.52
                                  (call vector-set! tmp.9.49 2 3)))
                             (if (call error? g43081399.52)
                               g43081399.52
                               (let ((g43081400.53
                                      (call vector-set! tmp.9.49 3 4)))
                                 (if (call error? g43081400.53)
                                   g43081400.53
                                   (let ((g43081401.54
                                          (call vector-set! tmp.9.49 4 5)))
                                     (if (call error? g43081401.54)
                                       g43081401.54
                                       (let ((g43081402.55
                                              (call vector-set! tmp.9.49 5 6)))
                                         (if (call error? g43081402.55)
                                           g43081402.55
                                           (let ((g43081403.56
                                                  (call
                                                   vector-set!
                                             ...
                                             (if (call error? g43081403.56)
                                               ...
                                               (let ((g43081404.57
                                                      (call
                                                       ...
                                                       7
                                                       8)))
                                                 (if (call error? g43081404.57)
                                                   g43081404.57
                                                   tmp.9.49))))))))))))))))))))))
      (if (if #t #\D #\R)
        (if (let ((g43081405.58 #\X))
              (if (call error? g43081405.58)
                g43081405.58
                (let ((g43081406.59 #\b))
                  (if (call error? g43081406.59)
                    g43081406.59
                    (let ((g43081407.60 #\B))
                      (if (call error? g43081407.60)
                        g43081407.60
                        (let ((g43081408.61 #\o))
                          (if (call error? g43081408.61)
                            g43081408.61
                            #\t))))))))
          (if (call fun/ascii-char8839.14 empty (call make-vector 8))
            (if (if #f #\B #\R)
              (if (call fun/ascii-char8840.13 (void) #f)
                (let ((pair0.63 (call cons 60 (call cons 439 empty)))
                      (empty1.62 empty))
                  #\F)
                #f)
              #f)
      ...
      (let ((g43081409.64 (if #\N (if #\V (if #\y #\d #f) #f) #f)))
        (if (call error? g43081409.64)
          g43081409.64
          (let ((g43081410.65 (if #f #\M #\T)))
            (if (call error? g43081410.65)
              g43081410.65
              (let ((g43081411.66
                     (let ((g43081412.67 #\s))
                       (if (call error? g43081412.67)
                         g43081412.67
                         (let ((g43081413.68 #\t))
                           (if (call error? g43081413.68)
                             g43081413.68
                             (let ((g43081414.69 #\r))
                               (if (call error? g43081414.69)
                                 g43081414.69
                                 #\W))))))))
                (if (call error? g43081411.66)
                  g43081411.66
                  (let ((g43081415.70
                    ...
                    (if (call error? g43081415.70)
                      ...
                      (let ((g43081416.74
                        ...
                        (if (call error? g43081416.74)
                          g43081416.74
                          (let ((g43081417.78
                                 (let ((g43081418.79 #\L))
                                   (if (call error? g43081418.79)
                                     g43081418.79
                                     (let ((g43081419.80 #\K))
                                       (if (call error? g43081419.80)
                                         g43081419.80
                                         (let ((g43081420.81 #\S))
                                           (if (call error? g43081420.81)
                                             g43081420.81
                                             (let ((g43081421.82 #\W))
                                               (if (call error? g43081421.82)
                                                 g43081421.82
                                                 #\W))))))))))
                            (if (call error? g43081417.78)
                              g43081417.78
                              (call
...
(check-by-interp
 '(module
    ...
    (define fun/pair8849.18
      (lambda (oprand0.28) (call cons 200 (call cons 421 empty))))
    ...
    (let ((tmp.7.31
           (call
            fun/error8846.17
            (let ((g43089053.32
                   (let ((g43089054.33 (call cons 116 (call cons 426 empty))))
                     (if (call error? g43089054.33)
                       g43089054.33
                       (call cons 249 (call cons 432 empty))))))
              (if (call error? g43089053.32)
                g43089053.32
                (call fun/pair8849.18 #f)))
            (call
             *
             (call fun/fixnum8850.20 (call cons 106 (call cons 289 empty)))
                   ...
                   (let ((tmp.10.36 (call fun/error8852.21)))
                     (if tmp.10.36
                       ...
                       (if (let ((boolean0.39 #f)
                                 (vector1.38
                                  (let ((tmp.11.40 (call make-vector 8)))
                                    (let ((g43089055.41
                                           (call vector-set! tmp.11.40 0 0)))
                                      (if (call error? g43089055.41)
                                        g43089055.41
                                        (let ((g43089056.42
                                               (call
                                                vector-set!
                                                              ...
                                                              (if (call
                                                                ...
                                                                (let ((g43089062.48
                                                                  ...
                                                                  (if (call
                                                                    ...
                                                                    tmp.11.40))))))))))))))))))
                                 (pair2.37
                                  (call cons 223 (call cons 355 empty))))
                             (error 185))
                ...
                (let ((tmp.13.54
                       (let ((error0.57 (call fun/error8855.25))
                             (vector1.56
                              (let ((tmp.14.58 (call make-vector 8)))
                                (let ((g43089063.59
                                       (call vector-set! tmp.14.58 0 #\P)))
                                  (if (call error? g43089063.59)
                                    g43089063.59
                                    (let ((g43089064.60
                                           (call vector-set! tmp.14.58 1 #t)))
                                      (if (call error? g43089064.60)
                                        g43089064.60
                                        (let ((g43089065.61
                                               (call
                                                vector-set!
    ...
    (define fun/void8861.14
      (lambda (oprand0.21 oprand1.20)
        (call
         ...
         oprand1.20
         5
         (call vector-set! oprand1.20 3 oprand0.21))))
                   ...
                   (let ((g43092888.36
                          (call
                           ...
                           (call
                            fun/void8861.14
                            #\J
                            (let ((tmp.9.37 (call make-vector 8)))
                              (let ((g43092889.38
                                     (call vector-set! tmp.9.37 0 1)))
                                (if (call error? g43092889.38)
                                  g43092889.38
                                  (let ((g43092890.39
                                         (call vector-set! tmp.9.37 1 2)))
                                    (if (call error? g43092890.39)
                                      g43092890.39
                                      (let ((g43092891.40
                                             (call vector-set! tmp.9.37 2 3)))
                                        (if (call error? g43092891.40)
                                          g43092891.40
                                          (let ((g43092892.41
                                                 (call
                                                  vector-set!
                     ...
                     (if (call error? g43092888.36)
                       ...
                       (let ((g43092897.46
                         ...
                         (if (call error? g43092897.46)
                           g43092897.46
                           (let ((g43092898.47
                                  (let ((fixnum0.49 208) (fixnum1.48 116))
                                    46)))
                             (if (call error? g43092898.47)
                               g43092898.47
                               (let ((g43092899.50
                                      (let ((empty0.52 empty) (boolean1.51 #f))
                                        65)))
                                 (if (call error? g43092899.50)
                                   g43092899.50
                                   (let ((g43092900.53 (if #f 71 196)))
                                     (if (call error? g43092900.53)
                                       g43092900.53
                                       (let ((void0.56 (void))
                                             (error1.55 (error 115))
                                             (pair2.54
...
(check-by-interp
 '(module
    ...
    (if (let ((empty0.20 empty)
              (vector1.19
               (let ((tmp.7.21 (call make-vector 8)))
                 (let ((g43096720.22 (call vector-set! tmp.7.21 0 1)))
                   (if (call error? g43096720.22)
                     g43096720.22
                     (let ((g43096721.23 (call vector-set! tmp.7.21 1 2)))
                       (if (call error? g43096721.23)
                         g43096721.23
                         (let ((g43096722.24 (call vector-set! tmp.7.21 2 3)))
                           (if (call error? g43096722.24)
                             g43096722.24
                             (let ((g43096723.25
                                    (call vector-set! tmp.7.21 3 4)))
                               (if (call error? g43096723.25)
                                 g43096723.25
                                 (let ((g43096724.26
                                        (call vector-set! tmp.7.21 4 5)))
                                   (if (call error? g43096724.26)
                                     g43096724.26
                                     (let ((g43096725.27
                                            (call vector-set! tmp.7.21 5 6)))
                                       (if (call error? g43096725.27)
                                         g43096725.27
                                         (let ((g43096726.28
                                                (call
                                                 vector-set!
                                           ...
                                           (if (call error? g43096726.28)
                                             ...
                                             (let ((g43096727.29
                                                    (call
                                                     ...
                                                     7
                                                     8)))
                                               (if (call error? g43096727.29)
                                                 g43096727.29
                                                 tmp.7.21))))))))))))))))))
              (procedure2.18
               (lambda () (call cons 148 (call cons 308 empty)))))
          #f)
      (if #f 51 196)
      (call
       fun/fixnum8868.15
       ...
       (let ((g43096728.36 #f))
         (if (call error? g43096728.36) g43096728.36 #t))))))
(check-by-interp
 '(module
    ...
    (define fun/pair8877.12
      (lambda (oprand0.15) (call cons 28 (call cons 385 empty))))
      ...
      (if (call fun/empty8884.17)
        (if empty
          (if (call
            ...
            (if (let ((pair0.22 (call cons 87 (call cons 285 empty)))
                      (procedure1.21
                       (lambda ()
                         (let ((tmp.7.23 (call make-vector 8)))
                           (let ((g43108180.24
                                  (call vector-set! tmp.7.23 0 0)))
                             (if (call error? g43108180.24)
                               g43108180.24
                               (let ((g43108181.25
                                      (call vector-set! tmp.7.23 1 1)))
                                 (if (call error? g43108181.25)
                                   g43108181.25
                                   (let ((g43108182.26
                                          (call vector-set! tmp.7.23 2 2)))
                                     (if (call error? g43108182.26)
                                       g43108182.26
                                       (let ((g43108183.27
                                              (call vector-set! tmp.7.23 3 3)))
                                         (if (call error? g43108183.27)
                                           g43108183.27
                                           (let ((g43108184.28
                                                  (call
                                                   vector-set!
              ...
              (if (let ((tmp.8.32 empty))
                ...
                (if (let ((error0.38 (error 188))) empty)
                  (let ((g43108188.39 empty))
                    (if (call error? g43108188.39)
                      g43108188.39
                      (let ((g43108189.40 empty))
                        (if (call error? g43108189.40)
                          g43108189.40
                          (let ((g43108190.41 empty))
                            (if (call error? g43108190.41)
                              g43108190.41
                              (let ((g43108191.42 empty))
                                (if (call error? g43108191.42)
                                  g43108191.42
                                  empty))))))))
                  #f)
                #f)
     ...
     (call
      ...
      (call
       ...
       (let ((g43127270.17 193))
         (if (call error? g43127270.17)
           g43127270.17
           (let ((g43127271.18 248))
             (if (call error? g43127271.18) g43127271.18 139))))
       (if #f #f #t))
      (if #f 172 187)))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    ...
    (define fun/void8927.22
      (lambda ()
        (let ((vector0.30
               (let ((tmp.7.31 (call make-vector 8)))
                 (let ((g43134900.32 (call vector-set! tmp.7.31 0 1)))
                   (if (call error? g43134900.32)
                     g43134900.32
                     (let ((g43134901.33 (call vector-set! tmp.7.31 1 2)))
                       (if (call error? g43134901.33)
                         g43134901.33
                         (let ((g43134902.34 (call vector-set! tmp.7.31 2 3)))
                           (if (call error? g43134902.34)
                             g43134902.34
                             (let ((g43134903.35
                                    (call vector-set! tmp.7.31 3 4)))
                               (if (call error? g43134903.35)
                                 g43134903.35
                                 (let ((g43134904.36
                                        (call vector-set! tmp.7.31 4 5)))
                                   (if (call error? g43134904.36)
                                     g43134904.36
                                     (let ((g43134905.37
                                            (call vector-set! tmp.7.31 5 6)))
                                       (if (call error? g43134905.37)
                                         g43134905.37
                                         (let ((g43134906.38
                                                (call
                                                 vector-set!
    ...
    (call
     ...
     (call
      ...
      (if #t
        (let ((tmp.8.40 (call make-vector 8)))
          (let ((g43134908.41 (call vector-set! tmp.8.40 0 1)))
            (if (call error? g43134908.41)
              g43134908.41
              (let ((g43134909.42 (call vector-set! tmp.8.40 1 2)))
                (if (call error? g43134909.42)
                  g43134909.42
                  (let ((g43134910.43 (call vector-set! tmp.8.40 2 3)))
                    (if (call error? g43134910.43)
                      g43134910.43
                      (let ((g43134911.44 (call vector-set! tmp.8.40 3 4)))
                        (if (call error? g43134911.44)
                          g43134911.44
                          (let ((g43134912.45 (call vector-set! tmp.8.40 4 5)))
                            (if (call error? g43134912.45)
                              g43134912.45
                              (let ((g43134913.46
                                     (call vector-set! tmp.8.40 5 6)))
                                (if (call error? g43134913.46)
                                  g43134913.46
                                  (let ((g43134914.47
                                         (call vector-set! tmp.8.40 6 7)))
                                    (if (call error? g43134914.47)
                                      g43134914.47
                                      (let ((g43134915.48
                                             (call vector-set! tmp.8.40 7 8)))
                                        (if (call error? g43134915.48)
                                          g43134915.48
                                          tmp.8.40)))))))))))))))))
        (let ((tmp.9.49 (call make-vector 8)))
          (let ((g43134916.50 (call vector-set! tmp.9.49 0 0)))
            (if (call error? g43134916.50)
              g43134916.50
              (let ((g43134917.51 (call vector-set! tmp.9.49 1 1)))
                (if (call error? g43134917.51)
                  g43134917.51
                  (let ((g43134918.52 (call vector-set! tmp.9.49 2 2)))
                    (if (call error? g43134918.52)
                      g43134918.52
                      (let ((g43134919.53 (call vector-set! tmp.9.49 3 3)))
                        (if (call error? g43134919.53)
                          g43134919.53
                          (let ((g43134920.54 (call vector-set! tmp.9.49 4 4)))
                            (if (call error? g43134920.54)
                              g43134920.54
                              (let ((g43134921.55
                                     (call vector-set! tmp.9.49 5 5)))
                                (if (call error? g43134921.55)
                                  g43134921.55
                                  (let ((g43134922.56
                                         (call vector-set! tmp.9.49 6 6)))
                                    (if (call error? g43134922.56)
                                      g43134922.56
                                      (let ((g43134923.57
                                             (call vector-set! tmp.9.49 7 7)))
                                        (if (call error? g43134923.57)
                                          g43134923.57
                                          tmp.9.49)))))))))))))))))))
     (let ((tmp.10.58
            (let ((g43134924.59 (call fun/void8924.19)))
              (if (call error? g43134924.59)
                g43134924.59
                (let ((g43134925.60
                       (if (void)
                         (if (void)
                           ...
                           #f)
                         #f)))
                  (if (call error? g43134925.60)
                    g43134925.60
                    (let ((g43134926.61
                           (let ((pair0.64
                                  (call cons 23 (call cons 408 empty)))
                                 (vector1.63
                                  (let ((tmp.11.65 (call make-vector 8)))
                                    (let ((g43134927.66
                                           (call vector-set! tmp.11.65 0 1)))
                                      (if (call error? g43134927.66)
                                        g43134927.66
                                        (let ((g43134928.67
                                               (call
                                                vector-set!
                             ...
                             (void))))
                      (if (call error? g43134926.61)
                        g43134926.61
                        (let ((g43134935.74
                               (call fun/void8925.14 (void) empty)))
                          (if (call error? g43134935.74)
                            g43134935.74
                            (let ((g43134936.75
                                   (let ((ascii-char0.77 #\p)
                                         (error1.76 (error 127)))
                                     (void))))
                              (if (call error? g43134936.75)
                                g43134936.75
...
(check-by-interp
 '(module
    (if (let ((g43138756.7 #f))
          (if (call error? g43138756.7)
            g43138756.7
            (let ((g43138757.8 #f))
              (if (call error? g43138757.8)
                g43138757.8
                (let ((g43138758.9 #f))
                  (if (call error? g43138758.9)
                    g43138758.9
                    (let ((g43138759.10 #f))
                      (if (call error? g43138759.10) g43138759.10 #t))))))))
      (void)
      (if #t (void) (void)))))
(check-by-interp
 '(module
 ...
 '(module
    ...
    (if (call
         ...
         (let ((procedure0.18 (lambda (oprand0.19) (lambda () 1019)))
               (pair1.17 (call cons 69 (call cons 333 empty))))
           (error 189)))
      (call
       fun/void8949.12
       (if #t 226 18)
       (let ((g43150205.20 #\Y))
         (if (call error? g43150205.20)
           g43150205.20
           (let ((g43150206.21 #\t))
             (if (call error? g43150206.21)
               g43150206.21
               (let ((g43150207.22 #\l))
                 (if (call error? g43150207.22)
                   g43150207.22
                   (let ((g43150208.23 #\s))
                     (if (call error? g43150208.23)
                       g43150208.23
                       (let ((g43150209.24 #\g))
                         (if (call error? g43150209.24)
                           g43150209.24
                           (let ((g43150210.25 #\V))
                             (if (call error? g43150210.25)
                               g43150210.25
                               #\A)))))))))))))
      (let ((tmp.7.26
             (let ((pair0.28 (call cons 202 (call cons 321 empty)))
                   (pair1.27 (call cons 143 (call cons 414 empty))))
               (void))))
        (if tmp.7.26
          tmp.7.26
                      ...
                      (let ((tmp.13.27
                        ...
                        (if tmp.13.27
                          ...
                          (call
                           ...
                           (let ((tmp.14.28 (call make-vector 8)))
                             (let ((g43165470.29
                                    (call vector-set! tmp.14.28 0 0)))
                               (if (call error? g43165470.29)
                                 g43165470.29
                                 (let ((g43165471.30
                                        (call vector-set! tmp.14.28 1 1)))
                                   (if (call error? g43165471.30)
                                     g43165471.30
                                     (let ((g43165472.31
                                            (call vector-set! tmp.14.28 2 2)))
                                       (if (call error? g43165472.31)
                                         g43165472.31
                                         (let ((g43165473.32
                                                (call
                                                 vector-set!
...
(check-by-interp
 '(module
    ...
    (if (let ((void0.20 (call fun/void8977.12))
              (boolean1.19 (call pair? (call cons 70 (call cons 501 empty))))
      ...
      (if (if (call fun/boolean8978.9 #\P)
        ...
        (call
         ...
         (let ((fixnum0.23 64) (empty1.22 empty))
           (let ((tmp.8.24 (call make-vector 8)))
             (let ((g43176926.25 (call vector-set! tmp.8.24 0 1)))
               (if (call error? g43176926.25)
                 g43176926.25
                 (let ((g43176927.26 (call vector-set! tmp.8.24 1 2)))
                   (if (call error? g43176927.26)
                     g43176927.26
                     (let ((g43176928.27 (call vector-set! tmp.8.24 2 3)))
                       (if (call error? g43176928.27)
                         g43176928.27
                         (let ((g43176929.28 (call vector-set! tmp.8.24 3 4)))
                           (if (call error? g43176929.28)
                             g43176929.28
                             (let ((g43176930.29
                                    (call vector-set! tmp.8.24 4 5)))
                               (if (call error? g43176930.29)
                                 g43176930.29
                                 (let ((g43176931.30
                                        (call vector-set! tmp.8.24 5 6)))
                                   (if (call error? g43176931.30)
                                     g43176931.30
                                     (let ((g43176932.31
                                            (call vector-set! tmp.8.24 6 7)))
                                       (if (call error? g43176932.31)
                                         g43176932.31
                                         (let ((g43176933.32
                                                (call
                                                 vector-set!
...
(check-by-interp
 '(module
    ...
    (if (call
         >
         (call fun/fixnum8985.7 (call cons 175 (call cons 398 empty)))
         (let ((g43180749.9 21))
           (if (call error? g43180749.9)
             g43180749.9
             (let ((g43180750.10 243))
               (if (call error? g43180750.10)
                 g43180750.10
                 (let ((g43180751.11 246))
                   (if (call error? g43180751.11)
                     g43180751.11
                     (let ((g43180752.12 134))
                       (if (call error? g43180752.12)
                         g43180752.12
                         (let ((g43180753.13 143))
                           (if (call error? g43180753.13)
                             g43180753.13
                             (let ((g43180754.14 161))
                               (if (call error? g43180754.14)
                                 g43180754.14
                                 37)))))))))))))
      (let ((pair0.15 (call cons 131 (call cons 509 empty)))) (void))
      (let ((procedure0.18 (lambda () #\v))
            (fixnum1.17 181)
            (pair2.16 (call cons 38 (call cons 400 empty))))
        (void)))))
(check-by-interp
 '(module
    (define fun/void8988.7
      (lambda ()
        (if (call fun/boolean8989.8 (call cons 233 (call cons 346 empty)))
