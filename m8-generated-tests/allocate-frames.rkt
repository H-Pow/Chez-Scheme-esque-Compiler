#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../allocate-frames.rkt")
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.52 empty0.2 empty1.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.52 rbp)
       (tmp-ra.52 rbp)
    ...
    ((new-frames (()))
     ...
     (conflicts
      ((tmp-ra.63
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.63 fv0) (tmp.58 fv1))))
    (define L.fun/error8463.4
      ((new-frames ())
       (locals (tmp-ra.62 oprand0.2 oprand1.1))
       (undead-out
    ...
    ((new-frames (() () ()))
     ...
     (conflicts
      ((tmp-ra.56 (ascii-char2.1 empty1.2 void0.3 rax rbp))
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.56 fv0) (void0.3 fv1))))
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp.67 void0.5 error1.4 empty2.3 tmp-ra.62))
     (call-undead ())
     (undead-out
      ((tmp-ra.62 rbp)
       (((tmp-ra.62 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp.62 void0.3 ascii-char1.2 fixnum2.1 tmp-ra.58))
     (call-undead ())
     (undead-out
      ((tmp-ra.58 rbp)
       (((tmp-ra.58 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (boolean0.3 void1.2 fixnum2.1))
    ...
    (define L.pair?.7
      ((new-frames ())
       (locals (tmp.57 tmp.46 tmp.66 tmp-ra.59))
       (undead-out
        ((rdi tmp-ra.59 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (empty0.3 boolean1.2 fixnum2.1))
    ...
    (define L.error?.6
      ((new-frames ())
       (locals (tmp.57 tmp.45 tmp.65 tmp-ra.59))
       (undead-out
        ((rdi tmp-ra.59 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (void0.4 empty1.3 tmp.64 fixnum2.2 void3.1))
     ...
     (conflicts
      ((tmp-ra.70 (void3.1 fixnum2.2 tmp.64 tmp.63 empty1.3 void0.4 rax rbp))
       ...
       (rdi (r15 rbp rsi))))
     (assignment ((tmp-ra.70 fv0) (tmp.63 fv1))))
    (define L.*.9
      ((new-frames ())
       (locals
        (tmp.54
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (empty0.4 tmp.64 fixnum1.3 empty2.2 void3.1))
     ...
     (conflicts
      ((tmp-ra.71 (void3.1 empty2.2 fixnum1.3 tmp.64 tmp.63 empty0.4 rax rbp))
       ...
       (rsi (tmp.63 r15 rdi rbp))
       (rdi (r15 rbp rsi))))
     (assignment ((tmp-ra.71 fv0) (tmp.63 fv1))))
    (define L.-.10
      ((new-frames ())
       (locals
        (tmp.54
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     ...
     (conflicts
      ((tmp-ra.100
       ...
       (r15 (rbp rdi rsi rdx))))
     (assignment
      ((tmp-ra.100 fv0) (tmp.92 fv1) (tmp.91 fv2) (tmp.89 fv3) (tmp.84 fv4))))
    (define L.-.10
      ((new-frames ())
       (locals
        (tmp.71
    ...
    (define L.fun/void10119.4
      ((new-frames ())
       (locals (tmp-ra.97 oprand0.3 oprand1.2 oprand2.1))
       (undead-out
    ...
    (define L.fun/fixnum10117.5
      ((new-frames ())
       (locals (tmp-ra.98 oprand0.6 oprand1.5 oprand2.4))
       (undead-out
    ...
    (define L.fun/fixnum10118.6
      ((new-frames ())
       (locals (tmp-ra.99 oprand0.9 oprand1.8 oprand2.7))
       (undead-out
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ()))
     (locals (error0.4 tmp.68 fixnum1.3 tmp.70 fixnum3.1))
     ...
     (conflicts
      ((tmp-ra.76
       ...
       (rdi (r15 rbp rsi))))
     (assignment ((tmp-ra.76 fv0) (tmp.67 fv1) (tmp.69 fv1) (error2.2 fv2))))
    (define L.+.9
      ((new-frames ())
       (locals
        (tmp.54
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (empty0.5 ascii-char1.4 empty2.3 error3.2 ascii-char4.1))
     (call-undead (tmp-ra.61))
     (undead-out
      ((tmp-ra.61 rbp)
       ((rax tmp-ra.61 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals
      (empty0.5 ascii-char1.4 ascii-char2.3 tmp.56 boolean3.2 ascii-char4.1))
    ...
    (define L.boolean?.11
      ((new-frames ())
       (locals (tmp.55 tmp.43 tmp.65 tmp-ra.57))
       (undead-out
        ((rdi tmp-ra.57 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (ascii-char0.5 empty1.4 void2.3 empty3.2 void4.1))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (ascii-char0.5 void1.4 error2.3 error3.2 empty4.1))
     (call-undead (tmp-ra.60))
     (undead-out
      ((tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (error0.5 error1.4 void2.3 error3.2 empty4.1))
     (call-undead (tmp-ra.61))
     (undead-out
      ((tmp-ra.61 rbp)
       ((rax tmp-ra.61 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals (void1.4 void2.3 empty3.2 tmp.70 tmp.73 tmp.71 fixnum4.1))
     ...
     (conflicts
      ((tmp-ra.81
       ...
       (rdi (r15 rbp rsi))))
     (assignment
      ((tmp-ra.81 fv0) (tmp.72 fv1) (tmp.68 fv2) (tmp.69 fv1) (void0.5 fv3))))
    (define L.-.11
      ((new-frames ())
       (locals
        (tmp.55
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () ()))
     ...
     (assignment ((tmp-ra.84 fv0) (tmp.74 fv1) (tmp.70 fv2) (tmp.71 fv1))))
    (define L.-.12
      ((new-frames ())
       (locals
        (tmp.55
    ...
    (define L.ascii-char?.9
      ((new-frames ())
       (locals (tmp.68 tmp.46 tmp.95 tmp-ra.79))
       (undead-out
        ((rdi tmp-ra.79 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () ()))
     ...
     (assignment ((tmp-ra.82 fv0) (tmp.68 fv1) (tmp.67 fv1) (tmp.71 fv2))))
    (define L.vector?.12
      ((new-frames ())
       (locals (tmp.55 tmp.49 tmp.83 tmp-ra.74))
       (undead-out
        ((rdi tmp-ra.74 rbp)
    ...
    (define L.empty?.9
      ((new-frames ())
       (locals (tmp.65 tmp.44 tmp.91 tmp-ra.77))
       (undead-out
        ((rdi tmp-ra.77 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () ()))
     ...
     (conflicts
      ((tmp-ra.83
       ...
       (rdi (rsi r15 rbp))
       (rsi (tmp.67 tmp.71 tmp.68 r15 rdi rbp))))
     (assignment ((tmp-ra.83 fv0) (tmp.71 fv1) (tmp.67 fv2) (tmp.68 fv1))))
    (define L.boolean?.13
      ((new-frames ())
       (locals (tmp.55 tmp.43 tmp.84 tmp-ra.74))
       (undead-out
        ((rdi tmp-ra.74 rbp)
    ...
    (define L.fixnum?.10
      ((new-frames ())
       (locals (tmp.65 tmp.42 tmp.92 tmp-ra.77))
       (undead-out
        ((rdi tmp-ra.77 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals (error0.5 tmp.65 tmp.68 tmp.66 fixnum1.4 error3.2 ascii-char4.1))
     ...
     (conflicts
      ((tmp-ra.75
       ...
       (rdi (r15 rbp rsi))))
     (assignment
      ((tmp-ra.75 fv0) (tmp.64 fv1) (tmp.63 fv1) (void2.3 fv1) (tmp.67 fv2))))
    (define L.-.10
      ((new-frames ())
       (locals
        (tmp.55
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals (ascii-char0.5 void2.3 tmp.57 boolean3.2 tmp.58 boolean4.1))
     ...
     (conflicts
      ((tmp-ra.66
       ...
       (r15 (rdi rbp))
       (rdi (r15 rbp))))
     (assignment ((tmp-ra.66 fv0) (ascii-char1.4 fv1))))
    (define L.ascii-char?.11
      ((new-frames ())
       (locals (tmp.55 tmp.46 tmp.67 tmp-ra.59))
       (undead-out
        ((rdi tmp-ra.59 rbp)
         (tmp.46 tmp-ra.59 rbp)
    ...
    (define L.void?.10
      ((new-frames ())
       (locals (tmp.56 tmp.45 tmp.68 tmp-ra.60))
       (undead-out
        ((rdi tmp-ra.60 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals (empty0.5 error1.4 empty2.3 void3.2 void4.1 tmp.70 tmp.73 tmp.71))
     ...
     (assignment ((tmp-ra.82 fv0) (tmp.69 fv1) (tmp.68 fv1) (tmp.72 fv2))))
    (define L.*.12
      ((new-frames ())
       (locals
        (tmp.55
    ...
    ((new-frames (() () () () () () () () () () () () ()))
     ...
     (conflicts
      ((tmp-ra.86
       ...
       (rdi (tmp-ra.86 r15 rbp rsi))))
     (assignment ((tmp-ra.86 fv0) (tmp.70 fv1) (tmp.69 fv1) (tmp.73 fv2))))
    (define L.empty?.13
      ((new-frames ())
       (locals (tmp.55 tmp.44 tmp.87 tmp-ra.77))
       (undead-out
        ((rdi tmp-ra.77 rbp)
         (tmp.44 tmp-ra.77 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.empty?.8
      ((new-frames ())
       (locals (tmp.68 tmp.44 tmp.100 tmp-ra.85))
       (undead-out
        ((rdi tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ()))
     ...
     (conflicts
      ((tmp-ra.74
       ...
       (r15 (rdi rbp))
       (rdi (r15 rbp))))
     (assignment ((tmp-ra.74 fv0))))
    (define L.empty?.18
      ((new-frames ())
       (locals (tmp.56 tmp.45 tmp.75 tmp-ra.60))
       (undead-out
        ((rdi tmp-ra.60 rbp)
         (tmp.45 tmp-ra.60 rbp)
    ...
    (define L.ascii-char?.17
      ((new-frames ())
       (locals (tmp.57 tmp.47 tmp.76 tmp-ra.61))
       (undead-out
        ((rdi tmp-ra.61 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.empty?.17
      ((new-frames ())
       (locals (tmp.56 tmp.45 tmp.99 tmp-ra.85))
       (undead-out
        ((rdi tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (void0.6 error1.5 error2.4 void3.3 ascii-char4.2 error5.1))
...
(check-by-interp
 '(module
    ...
    (define L.void?.17
      ((new-frames ())
       (locals (tmp.56 tmp.46 tmp.101 tmp-ra.87))
       (undead-out
        ((rdi tmp-ra.87 rbp)
    ...
    (define L.fixnum?.16
      ((new-frames ())
       (locals (tmp.57 tmp.43 tmp.102 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.void?.15
      ((new-frames ())
       (locals (tmp.56 tmp.46 tmp.111 tmp-ra.99))
       (undead-out
        ((rdi tmp-ra.99 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.boolean?.14
      ((new-frames ())
       (locals (tmp.69 tmp.44 tmp.109 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.boolean?.14
      ((new-frames ())
       (locals (tmp.69 tmp.44 tmp.111 tmp-ra.90))
       (undead-out
        ((rdi tmp-ra.90 rbp)
    ...
    (define L.void?.13
      ((new-frames ())
       (locals (tmp.70 tmp.46 tmp.112 tmp-ra.91))
       (undead-out
        ((rdi tmp-ra.91 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (void0.6 error1.5 ascii-char2.4 error4.2 ascii-char5.1))
     ...
     (conflicts
      ((tmp-ra.68
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.68 fv0) (empty3.3 fv1))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (empty0.6 empty1.5 void2.4 ascii-char3.3 empty4.2 empty5.1))
     (call-undead (tmp-ra.70))
     (undead-out
      ((tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ...
    (define L.empty?.16
      ((new-frames ())
       (locals (tmp.69 tmp.45 tmp.111 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals
      (ascii-char1.5 ascii-char2.4 ascii-char3.3 ascii-char4.2 error5.1))
     ...
     (conflicts
      ((tmp-ra.68
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.68 fv0) (empty0.6 fv1))))
...
(check-by-interp
 '(module
    ...
    (define L.vector?.17
      ((new-frames ())
       (locals (tmp.56 tmp.50 tmp.99 tmp-ra.85))
       (undead-out
        ((rdi tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals (void0.6 ascii-char1.5 ascii-char3.3 tmp.57 boolean4.2 error5.1))
     ...
     (conflicts
      ((tmp-ra.70
       ...
       (r15 (rdi rbp))
       (rdi (r15 rbp))))
     (assignment ((tmp-ra.70 fv0) (error2.4 fv1))))
    (define L.fixnum?.16
      ((new-frames ())
       (locals (tmp.56 tmp.43 tmp.71 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
 ...
 '(module
    ...
    (define L.fun/ascii-char117133.9
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.119 (rax rbp)) (rbp (rax tmp-ra.119)) (rax (rbp tmp-ra.119))))
       (assignment ()))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals (tmp.57 boolean0.6 error1.5 empty2.4 void3.3 error4.2 empty5.1))
     ...
     (conflicts
      ((tmp-ra.72
       ...
       (r15 (rdi rbp))
       (rdi (r15 rbp))))
     (assignment ((tmp-ra.72 fv0))))
    (define L.pair?.18
      ((new-frames ())
       (locals (tmp.56 tmp.49 tmp.73 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.error?.15
      ((new-frames ())
       (locals (tmp.56 tmp.48 tmp.117 tmp-ra.105))
       (undead-out
        ((rdi tmp-ra.105 rbp)
    ...
    (define L.boolean?.14
      ((new-frames ())
       (locals (tmp.57 tmp.44 tmp.118 tmp-ra.106))
       (undead-out
        ((rdi tmp-ra.106 rbp)
    ...
    (define L.void?.13
      ((new-frames ())
       (locals (tmp.58 tmp.46 tmp.119 tmp-ra.107))
       (undead-out
        ((rdi tmp-ra.107 rbp)
    ...
    (define L.fun/empty126710.4
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.111 (rax rbp)) (rbp (rax tmp-ra.111)) (rax (rbp tmp-ra.111))))
       (assignment ()))
    ...
    (define L.fun/any126713.6
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.113 (rax rbp)) (rbp (rax tmp-ra.113)) (rax (rbp tmp-ra.113))))
       (assignment ()))
    ...
    (define L.fun/any126711.7
      ((new-frames ())
       ...
       (call-undead ())
       (conflicts
        ((tmp-ra.114 (rax rbp)) (rbp (rax tmp-ra.114)) (rax (rbp tmp-ra.114))))
       (assignment ()))
...
(check-by-interp
 '(module
    ...
    (define L.vector?.18
      ((new-frames ())
       (locals (tmp.56 tmp.50 tmp.73 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
