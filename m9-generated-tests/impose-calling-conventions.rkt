    ...
    (begin
      (begin
        ...
        (begin
          ...
          (set! pair?.65 tmp.72)))
      (begin
        (begin (set! tmp.80 (alloc 16)) (set! tmp.73 (+ tmp.80 2)))
        (begin
          (mset! tmp.73 -2 L.fun/void8617.4.8)
          (mset! tmp.73 6 0)
          (set! fun/void8617.4 tmp.73)))
      (begin
        (begin (set! tmp.81 (alloc 16)) (set! tmp.74 (+ tmp.81 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.83 (alloc 16)) (set! tmp.76 (+ tmp.83 2)))
        (begin
          (mset! tmp.76 -2 L.fun/any8618.7.11)
          (mset! tmp.76 6 0)
          (set! fun/any8618.7 tmp.76)))
      (begin
        (begin (set! tmp.84 (alloc 16)) (set! tmp.77 (+ tmp.84 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! boolean1.11 (call L.pair?.65.7 pair?.65 tmp.85)))
        (set! ascii-char2.10
 ...
 '(module
    ...
    (define L.make-vector.71.12
      (lambda (c.80 tmp.47)
        (begin
          (set! make-init-vector.1 (mref c.80 14))
          (if (begin
                (if (begin (set! tmp.109 (bitwise-and tmp.47 7)) (= tmp.109 0))
                  (set! tmp.108 14)
                  (set! tmp.108 6))
                (!= tmp.108 6))
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.113 (arithmetic-shift-right tmp.19 3))
                      (set! tmp.112 (+ 1 tmp.113)))
                    (set! tmp.111 (* tmp.112 8)))
                  (set! tmp.110 (alloc tmp.111)))
                (set! tmp.91 (+ tmp.110 3)))
              (begin (mset! tmp.91 -3 tmp.19) (set! tmp.20 tmp.91)))
            (call
    ...
    (define L.-.72.9
      (lambda (c.77 tmp.37 tmp.38)
        (begin
          (if (begin
                (if (begin (set! tmp.120 (bitwise-and tmp.38 7)) (= tmp.120 0))
                  (set! tmp.119 14)
                  (set! tmp.119 6))
                (!= tmp.119 6))
            (if (begin
    ...
    (define L.*.73.8
      (lambda (c.76 tmp.33 tmp.34)
        (begin
          (if (begin
                (if (begin (set! tmp.124 (bitwise-and tmp.34 7)) (= tmp.124 0))
                  (set! tmp.123 14)
                  (set! tmp.123 6))
                (!= tmp.123 6))
            (if (begin
    ...
    (define L.+.74.7
      (lambda (c.75 tmp.35 tmp.36)
        (begin
          (if (begin
                (if (begin (set! tmp.129 (bitwise-and tmp.36 7)) (= tmp.129 0))
                  (set! tmp.128 14)
                  (set! tmp.128 6))
                (!= tmp.128 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.132 (alloc 16)) (set! tmp.92 (+ tmp.132 2)))
        (begin
          (mset! tmp.92 -2 L.+.74.7)
          (mset! tmp.92 6 16)
          (set! |+.74| tmp.92)))
      (begin
        (begin (set! tmp.133 (alloc 16)) (set! tmp.93 (+ tmp.133 2)))
        (begin
          (mset! tmp.93 -2 L.*.73.8)
          (mset! tmp.93 6 16)
          (set! *.73 tmp.93)))
      (begin
        (begin (set! tmp.134 (alloc 16)) (set! tmp.94 (+ tmp.134 2)))
        (begin
          (mset! tmp.94 -2 L.-.72.9)
          (mset! tmp.94 6 16)
          (set! |-.72| tmp.94)))
      (begin
        (begin (set! tmp.135 (alloc 24)) (set! tmp.95 (+ tmp.135 2)))
        (begin
          (mset! tmp.95 -2 L.vector-init-loop.21.10)
          (mset! tmp.95 6 24)
          (set! vector-init-loop.21 tmp.95)))
      (begin
        (begin (set! tmp.136 (alloc 24)) (set! tmp.96 (+ tmp.136 2)))
        (begin
          (mset! tmp.96 -2 L.make-init-vector.1.11)
          (mset! tmp.96 6 8)
          (set! make-init-vector.1 tmp.96)))
      (begin
        (begin (set! tmp.137 (alloc 24)) (set! tmp.97 (+ tmp.137 2)))
        (begin
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.148 (call L.+.74.7 |+.74| tmp.149 tmp.150))))
            (begin
              (begin
                (set! tmp.152 (call L.+.74.7 |+.74| 280 1096))
                (begin
                  (set! tmp.153 (call L.+.74.7 |+.74| 1328 424))
                  (set! tmp.151 (call L.*.73.8 *.73 tmp.152 tmp.153))))
              (set! fixnum1.17 (call L.*.73.8 *.73 tmp.148 tmp.151))))
...
(check-by-interp
 '(module
    ...
    (begin
      (begin
        (begin (set! tmp.98 (alloc 16)) (set! tmp.85 (+ tmp.98 2)))
        (begin
          (mset! tmp.85 -2 L.vector?.72.7)
          (mset! tmp.85 6 8)
          (set! vector?.72 tmp.85)))
      (begin
        (begin (set! tmp.99 (alloc 24)) (set! tmp.86 (+ tmp.99 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.102 (alloc 16)) (set! tmp.89 (+ tmp.102 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            ...
            (set! boolean1.18 (call L.vector?.72.7 vector?.72 tmp.110)))
          (set! ascii-char2.17
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.71.11
      (lambda (c.79 tmp.47)
        (begin
          ...
          (if (begin
                (if (begin (set! tmp.110 (bitwise-and tmp.47 7)) (= tmp.110 0))
                  (set! tmp.109 14)
                  (set! tmp.109 6))
                (!= tmp.109 6))
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.114 (arithmetic-shift-right tmp.19 3))
                      (set! tmp.113 (+ 1 tmp.114)))
                    (set! tmp.112 (* tmp.113 8)))
                  (set! tmp.111 (alloc tmp.112)))
                (set! tmp.91 (+ tmp.111 3)))
              (begin (mset! tmp.91 -3 tmp.19) (set! tmp.20 tmp.91)))
            (call
    ...
    (begin
      (begin
        (begin (set! tmp.122 (alloc 16)) (set! tmp.92 (+ tmp.122 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.128 (alloc 24)) (set! tmp.98 (+ tmp.128 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.132 (alloc 16)) (set! tmp.102 (+ tmp.132 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.135 (alloc 16)) (set! tmp.105 (+ tmp.135 2)))
        (begin
      ...
      (begin
        ...
        (begin
          (begin
            ...
            (set! boolean0.18 (call L.void?.72.8 void?.72 tmp.137)))
          (begin
            (begin
              (begin (set! tmp.138 (alloc 32)) (set! tmp.107 (+ tmp.138 2)))
              (begin
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.73.9
      (lambda (c.76 tmp.49)
        (begin
          ...
          (if (begin
                (if (begin (set! tmp.106 (bitwise-and tmp.49 7)) (= tmp.106 0))
                  (set! tmp.105 14)
                  (set! tmp.105 6))
                (!= tmp.105 6))
            (call L.make-init-vector.1.8 make-init-vector.1 tmp.49)
    ...
    (begin
      (begin
        (begin (set! tmp.116 (alloc 24)) (set! tmp.90 (+ tmp.116 2)))
        (begin
          (mset! tmp.90 -2 L.vector-init-loop.23.7)
          (mset! tmp.90 6 24)
          (set! vector-init-loop.23 tmp.90)))
      (begin
        (begin (set! tmp.117 (alloc 24)) (set! tmp.91 (+ tmp.117 2)))
        (begin
          (mset! tmp.91 -2 L.make-init-vector.1.8)
          (mset! tmp.91 6 8)
          (set! make-init-vector.1 tmp.91)))
      (begin
        (begin (set! tmp.118 (alloc 24)) (set! tmp.92 (+ tmp.118 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.120 (alloc 16)) (set! tmp.94 (+ tmp.120 2)))
        (begin
 ...
 '(module
    ...
    (define L.-.74.9
      (lambda (c.80 tmp.40 tmp.41)
        (begin
          (if (begin
                (if (begin (set! tmp.111 (bitwise-and tmp.41 7)) (= tmp.111 0))
                  (set! tmp.110 14)
                  (set! tmp.110 6))
                (!= tmp.110 6))
            (if (begin
    ...
    (define L.+.75.8
      (lambda (c.79 tmp.38 tmp.39)
        (begin
          (if (begin
                (if (begin (set! tmp.115 (bitwise-and tmp.39 7)) (= tmp.115 0))
                  (set! tmp.114 14)
                  (set! tmp.114 6))
                (!= tmp.114 6))
            (if (begin
    ...
    (define L.*.76.7
      (lambda (c.78 tmp.36 tmp.37)
        (begin
          (if (begin
                (if (begin (set! tmp.119 (bitwise-and tmp.37 7)) (= tmp.119 0))
                  (set! tmp.118 14)
                  (set! tmp.118 6))
                (!= tmp.118 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.123 (alloc 16)) (set! tmp.94 (+ tmp.123 2)))
        (begin
          (mset! tmp.94 -2 L.*.76.7)
          (mset! tmp.94 6 16)
          (set! *.76 tmp.94)))
      (begin
        (begin (set! tmp.124 (alloc 16)) (set! tmp.95 (+ tmp.124 2)))
        (begin
          (mset! tmp.95 -2 L.+.75.8)
          (mset! tmp.95 6 16)
          (set! |+.75| tmp.95)))
      (begin
        (begin (set! tmp.125 (alloc 16)) (set! tmp.96 (+ tmp.125 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.128 (alloc 16)) (set! tmp.99 (+ tmp.128 2)))
        (begin
          (mset! tmp.99 -2 L.fun/void11007.6.12)
          (mset! tmp.99 6 0)
          (set! fun/void11007.6 tmp.99)))
      (begin
        (begin (set! tmp.129 (alloc 16)) (set! tmp.100 (+ tmp.129 2)))
        (begin
              ...
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.142 (call L.-.74.9 |-.74| tmp.143 tmp.144))))
                (set! tmp.138 (call L.-.74.9 |-.74| tmp.139 tmp.142))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.146 (call L.-.74.9 |-.74| tmp.147 tmp.148))))
                (begin
                  (begin
                    (set! tmp.150 (call L.-.74.9 |-.74| 1592 1080))
                    (begin
                      (set! tmp.151 (call L.-.74.9 |-.74| 128 760))
                      (set! tmp.149 (call L.*.76.7 *.76 tmp.150 tmp.151))))
                  (set! tmp.145 (call L.+.75.8 |+.75| tmp.146 tmp.149))))
              (set! fixnum0.21 (call L.+.75.8 |+.75| tmp.138 tmp.145))))
          (set! void1.20 (call L.fun/void11006.4.10 fun/void11006.4))
          (begin
            (begin
              (begin (set! tmp.152 (alloc 24)) (set! tmp.109 (+ tmp.152 2)))
              (begin
 ...
 '(module
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.105 (call L.*.73.8 *.73 tmp.106 tmp.107))))
              (begin
                (begin
                  (set! tmp.109 (call L.+.74.7 |+.74| 1704 736))
                  (begin
                    (set! tmp.110 (call L.+.74.7 |+.74| 328 480))
                    (set! tmp.108 (call L.+.74.7 |+.74| tmp.109 tmp.110))))
                (set! tmp.104 (call L.+.74.7 |+.74| tmp.105 tmp.108))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.112 (call L.+.74.7 |+.74| tmp.113 tmp.114))))
                (begin
                  (begin
                    (set! tmp.116 (call L.*.73.8 *.73 1824 1352))
                    (begin
                      (set! tmp.117 (call L.+.74.7 |+.74| 1584 344))
                      (set! tmp.115 (call L.-.72.9 |-.72| tmp.116 tmp.117))))
                  (set! tmp.111 (call L.*.73.8 *.73 tmp.112 tmp.115))))
    ...
    (define L.-.72.9
      (lambda (c.78 tmp.38 tmp.39)
        (begin
          (if (begin
                (if (begin (set! tmp.119 (bitwise-and tmp.39 7)) (= tmp.119 0))
                  (set! tmp.118 14)
                  (set! tmp.118 6))
                (!= tmp.118 6))
            (if (begin
    ...
    (define L.+.74.7
      (lambda (c.76 tmp.36 tmp.37)
        (begin
          (if (begin
                (if (begin (set! tmp.128 (bitwise-and tmp.37 7)) (= tmp.128 0))
                  (set! tmp.127 14)
                  (set! tmp.127 6))
                (!= tmp.127 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.131 (alloc 16)) (set! tmp.90 (+ tmp.131 2)))
        (begin
          (mset! tmp.90 -2 L.+.74.7)
          (mset! tmp.90 6 16)
          (set! |+.74| tmp.90)))
      (begin
        (begin (set! tmp.132 (alloc 16)) (set! tmp.91 (+ tmp.132 2)))
        (begin
          (mset! tmp.91 -2 L.*.73.8)
          (mset! tmp.91 6 16)
          (set! *.73 tmp.91)))
      (begin
        (begin (set! tmp.133 (alloc 16)) (set! tmp.92 (+ tmp.133 2)))
        (begin
          (mset! tmp.92 -2 L.-.72.9)
          (mset! tmp.92 6 16)
          (set! |-.72| tmp.92)))
      (begin
        (begin (set! tmp.134 (alloc 16)) (set! tmp.93 (+ tmp.134 2)))
        (begin
          (mset! tmp.93 -2 L.fun/error11878.4.10)
          (mset! tmp.93 6 0)
          (set! fun/error11878.4 tmp.93)))
      (begin
        (begin (set! tmp.135 (alloc 24)) (set! tmp.94 (+ tmp.135 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.139 (alloc 16)) (set! tmp.98 (+ tmp.139 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.143 (alloc 24)) (set! tmp.102 (+ tmp.143 2)))
        (begin
      ...
      (begin
        ...
        (begin
          (begin
            (begin
              (begin (set! tmp.144 (alloc 40)) (set! tmp.103 (+ tmp.144 2)))
              (begin
            ...
            (begin
              (begin
                ...
                (begin
                  (if (begin
                        (if (begin
                              (set! tmp.150 (bitwise-and procedure0.19 7))
                              (= tmp.150 2))
                          (set! tmp.149 14)
                          (set! tmp.149 6))
                        (!= tmp.149 6))
                    (if (begin
                      ...
                      (begin
                        ...
                        (set! tmp.148 (call tmp.153 procedure0.19)))
                      (set! tmp.148 10814))
                    (set! tmp.148 11070))
                  (set! tmp.146 (call L.+.74.7 |+.74| tmp.147 tmp.148))))
              (begin
                (if (begin
                      (if (begin
                  ...
                  (if (begin
                    ...
                    (begin
                      ...
                      (set! tmp.154 (call tmp.159 procedure0.19)))
                    (set! tmp.154 10814))
                  (set! tmp.154 11070))
                (set! tmp.145 (call L.-.72.9 |-.72| tmp.146 tmp.154))))
            (begin
              (if (begin
                    (if (begin
                ...
                (if (begin
                  ...
                  (begin
                    ...
                    (set! tmp.160 (call tmp.165 procedure0.19)))
                  (set! tmp.160 10814))
                (set! tmp.160 11070))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! cons.76 tmp.96)))
      (begin
        (begin (set! tmp.115 (alloc 24)) (set! tmp.97 (+ tmp.115 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.118 (alloc 24)) (set! tmp.100 (+ tmp.118 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.121 (alloc 16)) (set! tmp.103 (+ tmp.121 2)))
        (begin
          (mset! tmp.103 -2 L.fun/error12697.10.15)
          (mset! tmp.103 6 0)
          (set! fun/error12697.10 tmp.103)))
      (begin
        (begin (set! tmp.122 (alloc 24)) (set! tmp.104 (+ tmp.122 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.125 (alloc 16)) (set! tmp.107 (+ tmp.125 2)))
        (begin
          (mset! tmp.107 -2 L.fun/ascii-char12705.14.19)
          (mset! tmp.107 6 0)
          (set! fun/ascii-char12705.14 tmp.107)))
      (begin
        (begin (set! tmp.126 (alloc 16)) (set! tmp.108 (+ tmp.126 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            ...
            (set! boolean5.18 (call L.empty?.77.7 empty?.77 tmp.129)))
 ...
 '(module
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.111 (call L.*.75.8 *.75 tmp.112 tmp.113))))
              (begin
                (begin
                  (set! tmp.115 (call L.+.76.7 |+.76| 1568 992))
                  (begin
                    (set! tmp.116 (call L.-.74.9 |-.74| 232 1656))
                    (set! tmp.114 (call L.-.74.9 |-.74| tmp.115 tmp.116))))
                (set! tmp.110 (call L.+.76.7 |+.76| tmp.111 tmp.114))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.118 (call L.+.76.7 |+.76| tmp.119 tmp.120))))
                (begin
                  (begin
                    (set! tmp.122 (call L.+.76.7 |+.76| 736 1392))
                    (begin
                      (set! tmp.123 (call L.*.75.8 *.75 1768 1576))
                      (set! tmp.121 (call L.-.74.9 |-.74| tmp.122 tmp.123))))
                  (set! tmp.117 (call L.*.75.8 *.75 tmp.118 tmp.121))))
    ...
    (define L.-.74.9
      (lambda (c.80 tmp.40 tmp.41)
        (begin
          (if (begin
                (if (begin (set! tmp.125 (bitwise-and tmp.41 7)) (= tmp.125 0))
                  (set! tmp.124 14)
                  (set! tmp.124 6))
                (!= tmp.124 6))
            (if (begin
    ...
    (define L.*.75.8
      (lambda (c.79 tmp.36 tmp.37)
        (begin
          (if (begin
                (if (begin (set! tmp.129 (bitwise-and tmp.37 7)) (= tmp.129 0))
                  (set! tmp.128 14)
                  (set! tmp.128 6))
                (!= tmp.128 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.137 (alloc 16)) (set! tmp.94 (+ tmp.137 2)))
        (begin
          (mset! tmp.94 -2 L.+.76.7)
          (mset! tmp.94 6 16)
          (set! |+.76| tmp.94)))
      (begin
        ...
        (begin
          ...
          (set! *.75 tmp.95)))
      (begin
        (begin (set! tmp.139 (alloc 16)) (set! tmp.96 (+ tmp.139 2)))
        (begin
          (mset! tmp.96 -2 L.-.74.9)
          (mset! tmp.96 6 16)
          (set! |-.74| tmp.96)))
      (begin
        (begin (set! tmp.140 (alloc 16)) (set! tmp.97 (+ tmp.140 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.142 (alloc 16)) (set! tmp.99 (+ tmp.142 2)))
        (begin
          (mset! tmp.99 -2 L.fun/ascii-char12713.6.12)
          (mset! tmp.99 6 0)
          (set! fun/ascii-char12713.6 tmp.99)))
      (begin
        (begin (set! tmp.143 (alloc 24)) (set! tmp.100 (+ tmp.143 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            (begin
              (begin (set! tmp.152 (alloc 40)) (set! tmp.109 (+ tmp.152 2)))
              (begin
                (mset! tmp.109 -2 L.lam.77.22)
                (mset! tmp.109 6 0)
                (set! lam.77 tmp.109)))
 ...
 '(module
    ...
    (define L.*.72.9
      (lambda (c.77 tmp.34 tmp.35)
        (begin
          (if (begin
                (if (begin (set! tmp.102 (bitwise-and tmp.35 7)) (= tmp.102 0))
                  (set! tmp.101 14)
                  (set! tmp.101 6))
                (!= tmp.101 6))
            (if (begin
    ...
    (define L.-.73.8
      (lambda (c.76 tmp.38 tmp.39)
        (begin
          (if (begin
                (if (begin (set! tmp.107 (bitwise-and tmp.39 7)) (= tmp.107 0))
                  (set! tmp.106 14)
                  (set! tmp.106 6))
                (!= tmp.106 6))
            (if (begin
    ...
    (define L.+.74.7
      (lambda (c.75 tmp.36 tmp.37)
        (begin
          (if (begin
                (if (begin (set! tmp.111 (bitwise-and tmp.37 7)) (= tmp.111 0))
                  (set! tmp.110 14)
                  (set! tmp.110 6))
                (!= tmp.110 6))
            (if (begin
    ...
    (begin
      ...
      (begin
        (begin (set! tmp.122 (alloc 16)) (set! tmp.96 (+ tmp.122 2)))
        (begin
          (mset! tmp.96 -2 L.fun/ascii-char14517.9.15)
          (mset! tmp.96 6 0)
          (set! fun/ascii-char14517.9 tmp.96)))
      (begin
        (begin (set! tmp.123 (alloc 24)) (set! tmp.97 (+ tmp.123 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.125 (alloc 24)) (set! tmp.99 (+ tmp.125 2)))
        (begin
          (mset! tmp.99 -2 L.fun/error14512.12.18)
          (mset! tmp.99 6 0)
          (set! fun/error14512.12 tmp.99)))
      (begin
        (begin (set! tmp.126 (alloc 16)) (set! tmp.100 (+ tmp.126 2)))
        (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.128 (call L.+.74.7 |+.74| tmp.129 tmp.130))))
              (begin
                (begin
                  (set! tmp.132 (call L.*.72.9 *.72 976 520))
                  (begin
                    (set! tmp.133 (call L.*.72.9 *.72 472 392))
                    (set! tmp.131 (call L.*.72.9 *.72 tmp.132 tmp.133))))
                (set! tmp.127 (call L.+.74.7 |+.74| tmp.128 tmp.131))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.135 (call L.*.72.9 *.72 tmp.136 tmp.137))))
                (begin
                  (begin
                    (set! tmp.139 (call L.*.72.9 *.72 1320 1216))
                    (begin
                      (set! tmp.140 (call L.*.72.9 *.72 272 1872))
                      (set! tmp.138 (call L.-.73.8 |-.73| tmp.139 tmp.140))))
                  (set! tmp.134 (call L.-.73.8 |-.73| tmp.135 tmp.138))))
              (set! fixnum1.18 (call L.+.74.7 |+.74| tmp.127 tmp.134))))
          (begin
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.142 (call L.*.72.9 *.72 tmp.143 tmp.144))))
              (begin
                (begin
                  (set! tmp.146 (call L.-.73.8 |-.73| 264 344))
                  (begin
                    (set! tmp.147 (call L.*.72.9 *.72 1872 1848))
                    (set! tmp.145 (call L.*.72.9 *.72 tmp.146 tmp.147))))
                (set! tmp.141 (call L.-.73.8 |-.73| tmp.142 tmp.145))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.149 (call L.-.73.8 |-.73| tmp.150 tmp.151))))
                (begin
                  (begin
                  ...
                  (set! tmp.148 (call L.+.74.7 |+.74| tmp.149 tmp.152))))
              (set! fixnum2.17 (call L.-.73.8 |-.73| tmp.141 tmp.148))))
          (set! ascii-char3.16
...
(check-by-interp
 '(module
    ...
    (begin
      (begin
        (begin (set! tmp.101 (alloc 16)) (set! tmp.88 (+ tmp.101 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.104 (alloc 24)) (set! tmp.91 (+ tmp.104 2)))
        (begin
          (mset! tmp.91 -2 L.fun/error14882.7.10)
          (mset! tmp.91 6 0)
          (set! fun/error14882.7 tmp.91)))
      (begin
        (begin (set! tmp.105 (alloc 16)) (set! tmp.92 (+ tmp.105 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.110 (alloc 24)) (set! tmp.97 (+ tmp.110 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.112 (alloc 16)) (set! tmp.99 (+ tmp.112 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            (begin
              (begin (set! tmp.113 (alloc 24)) (set! tmp.100 (+ tmp.113 2)))
              (begin
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.76.10
      (lambda (c.83 tmp.52)
        (begin
          ...
          (if (begin
                (if (begin (set! tmp.123 (bitwise-and tmp.52 7)) (= tmp.123 0))
                  (set! tmp.122 14)
                  (set! tmp.122 6))
                (!= tmp.122 6))
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.127 (arithmetic-shift-right tmp.24 3))
                      (set! tmp.126 (+ 1 tmp.127)))
                    (set! tmp.125 (* tmp.126 8)))
                  (set! tmp.124 (alloc tmp.125)))
                (set! tmp.100 (+ tmp.124 3)))
              (begin (mset! tmp.100 -3 tmp.24) (set! tmp.25 tmp.100)))
            (call
    ...
    (begin
      (begin
        (begin (set! tmp.134 (alloc 16)) (set! tmp.101 (+ tmp.134 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.138 (alloc 24)) (set! tmp.105 (+ tmp.138 2)))
        (begin
          (mset! tmp.105 -2 L.fun/empty15196.4.11)
          (mset! tmp.105 6 0)
          (set! fun/empty15196.4 tmp.105)))
      (begin
        (begin (set! tmp.139 (alloc 24)) (set! tmp.106 (+ tmp.139 2)))
        (begin
          (mset! tmp.106 -2 L.fun/empty15206.5.12)
          (mset! tmp.106 6 0)
          (set! fun/empty15206.5 tmp.106)))
      (begin
        (begin (set! tmp.140 (alloc 24)) (set! tmp.107 (+ tmp.140 2)))
        (begin
      ...
      (begin
        ...
        (begin
          (begin
            (begin
              (begin (set! tmp.152 (alloc 24)) (set! tmp.119 (+ tmp.152 2)))
              (begin
          ...
          (begin
            (begin
              (begin (set! tmp.153 (alloc 32)) (set! tmp.120 (+ tmp.153 2)))
              (begin
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.76.9
      (lambda (c.79 tmp.52)
        (begin
          (set! make-init-vector.1 (mref c.79 14))
          (if (begin
                (if (begin (set! tmp.113 (bitwise-and tmp.52 7)) (= tmp.113 0))
                  (set! tmp.112 14)
                  (set! tmp.112 6))
                (!= tmp.112 6))
            (call L.make-init-vector.1.8 make-init-vector.1 tmp.52)
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.117 (arithmetic-shift-right tmp.24 3))
                      (set! tmp.116 (+ 1 tmp.117)))
                    (set! tmp.115 (* tmp.116 8)))
                  (set! tmp.114 (alloc tmp.115)))
                (set! tmp.94 (+ tmp.114 3)))
              (begin (mset! tmp.94 -3 tmp.24) (set! tmp.25 tmp.94)))
            (call
             L.vector-init-loop.26.7
             vector-init-loop.26
             tmp.24
    ...
    (begin
      ...
      (begin
        (begin (set! tmp.132 (alloc 24)) (set! tmp.104 (+ tmp.132 2)))
        (begin
 ...
 '(module
    ...
    (define L.make-vector.74.12
      (lambda (c.84 tmp.50)
        (begin
          (set! make-init-vector.1 (mref c.84 14))
          (if (begin
                (if (begin (set! tmp.119 (bitwise-and tmp.50 7)) (= tmp.119 0))
                  (set! tmp.118 14)
                  (set! tmp.118 6))
                (!= tmp.118 6))
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.123 (arithmetic-shift-right tmp.22 3))
                      (set! tmp.122 (+ 1 tmp.123)))
                    (set! tmp.121 (* tmp.122 8)))
                  (set! tmp.120 (alloc tmp.121)))
                (set! tmp.98 (+ tmp.120 3)))
              (begin (mset! tmp.98 -3 tmp.22) (set! tmp.23 tmp.98)))
            (call
    ...
    (define L.-.75.9
      (lambda (c.81 tmp.40 tmp.41)
        (begin
          (if (begin
                (if (begin (set! tmp.130 (bitwise-and tmp.41 7)) (= tmp.130 0))
                  (set! tmp.129 14)
                  (set! tmp.129 6))
                (!= tmp.129 6))
            (if (begin
    ...
    (define L.*.77.7
      (lambda (c.79 tmp.36 tmp.37)
        (begin
          (if (begin
                (if (begin (set! tmp.138 (bitwise-and tmp.37 7)) (= tmp.138 0))
                  (set! tmp.137 14)
                  (set! tmp.137 6))
                (!= tmp.137 6))
            (if (begin
    ...
    (begin
      ...
      (begin
        (begin (set! tmp.146 (alloc 24)) (set! tmp.103 (+ tmp.146 2)))
        (begin
          (mset! tmp.103 -2 L.make-init-vector.1.11)
          (mset! tmp.103 6 8)
          (set! make-init-vector.1 tmp.103)))
      (begin
        (begin (set! tmp.147 (alloc 24)) (set! tmp.104 (+ tmp.147 2)))
        (begin
          (mset! tmp.104 -2 L.make-vector.74.12)
          (mset! tmp.104 6 8)
          (set! make-vector.74 tmp.104)))
      (begin
        (begin (set! tmp.148 (alloc 16)) (set! tmp.105 (+ tmp.148 2)))
        (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.162 (call L.+.76.8 |+.76| tmp.163 tmp.164))))
              (begin
                (begin
                  (set! tmp.166 (call L.*.77.7 *.77 1416 1208))
                  (begin
                    (set! tmp.167 (call L.+.76.8 |+.76| 16 912))
                    (set! tmp.165 (call L.-.75.9 |-.75| tmp.166 tmp.167))))
                (set! tmp.161 (call L.-.75.9 |-.75| tmp.162 tmp.165))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.169 (call L.-.75.9 |-.75| tmp.170 tmp.171))))
                (begin
                  (begin
                    (set! tmp.173 (call L.+.76.8 |+.76| 952 808))
                    (begin
                      (set! tmp.174 (call L.+.76.8 |+.76| 416 1232))
                      (set! tmp.172 (call L.+.76.8 |+.76| tmp.173 tmp.174))))
                  (set! tmp.168 (call L.+.76.8 |+.76| tmp.169 tmp.172))))
              (set! fixnum3.18 (call L.*.77.7 *.77 tmp.161 tmp.168))))
          (set! ascii-char4.17
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.161 (call L.-.75.9 |-.75| tmp.162 tmp.163))))
              (begin
                (begin
                  (set! tmp.165 (call L.-.75.9 |-.75| 1264 616))
                  (begin
                    (set! tmp.166 (call L.+.76.8 |+.76| 1776 1232))
                    (set! tmp.164 (call L.*.77.7 *.77 tmp.165 tmp.166))))
                (set! tmp.160 (call L.+.76.8 |+.76| tmp.161 tmp.164))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.168 (call L.-.75.9 |-.75| tmp.169 tmp.170))))
                (begin
                  (begin
                    (set! tmp.172 (call L.*.77.7 *.77 1648 1840))
                    (begin
                      (set! tmp.173 (call L.+.76.8 |+.76| 936 1512))
                      (set! tmp.171 (call L.*.77.7 *.77 tmp.172 tmp.173))))
                  (set! tmp.167 (call L.+.76.8 |+.76| tmp.168 tmp.171))))
              (set! fixnum1.20 (call L.*.77.7 *.77 tmp.160 tmp.167))))
          (begin
            (begin
              (begin (set! tmp.174 (alloc 24)) (set! tmp.117 (+ tmp.174 2)))
              (begin
                (mset! tmp.117 -2 L.lam.78.25)
                (mset! tmp.117 6 0)
                (set! lam.78 tmp.117)))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          (begin
            (begin
              (begin (set! tmp.126 (alloc 24)) (set! tmp.109 (+ tmp.126 2)))
              (begin
                (mset! tmp.109 -2 L.lam.77.22)
                (mset! tmp.109 6 0)
                (set! lam.77 tmp.109)))
 ...
 '(module
    ...
    (define L.make-vector.74.14
      (lambda (c.87 tmp.50)
        (begin
          (set! make-init-vector.1 (mref c.87 14))
          (if (begin
                (if (begin (set! tmp.122 (bitwise-and tmp.50 7)) (= tmp.122 0))
                  (set! tmp.121 14)
                  (set! tmp.121 6))
                (!= tmp.121 6))
            (call L.make-init-vector.1.13 make-init-vector.1 tmp.50)
            ...
            (begin
              (begin
                (begin
                  (begin
                    (begin
                      (set! tmp.126 (arithmetic-shift-right tmp.22 3))
                      (set! tmp.125 (+ 1 tmp.126)))
                    (set! tmp.124 (* tmp.125 8)))
                  (set! tmp.123 (alloc tmp.124)))
                (set! tmp.100 (+ tmp.123 3)))
              (begin (mset! tmp.100 -3 tmp.22) (set! tmp.23 tmp.100)))
            (call
             L.vector-init-loop.24.12
             vector-init-loop.24
    ...
    (define L.-.76.10
      (lambda (c.83 tmp.40 tmp.41)
        (begin
          (if (begin
                (if (begin (set! tmp.134 (bitwise-and tmp.41 7)) (= tmp.134 0))
                  (set! tmp.133 14)
                  (set! tmp.133 6))
                (!= tmp.133 6))
            (if (begin
    ...
    (define L.+.78.8
      (lambda (c.81 tmp.38 tmp.39)
        (begin
          (if (begin
                (if (begin (set! tmp.143 (bitwise-and tmp.39 7)) (= tmp.143 0))
                  (set! tmp.142 14)
                  (set! tmp.142 6))
                (!= tmp.142 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.147 (alloc 16)) (set! tmp.101 (+ tmp.147 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.152 (alloc 24)) (set! tmp.106 (+ tmp.152 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! make-vector.74 tmp.108)))
      (begin
        (begin (set! tmp.155 (alloc 16)) (set! tmp.109 (+ tmp.155 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.160 (alloc 24)) (set! tmp.114 (+ tmp.160 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.164 (alloc 24)) (set! tmp.118 (+ tmp.164 2)))
        (begin
          (mset! tmp.118 -2 L.fun/vector21158.13.24)
          (mset! tmp.118 6 0)
          (set! fun/vector21158.13 tmp.118)))
      (begin
        (begin (set! tmp.165 (alloc 16)) (set! tmp.119 (+ tmp.165 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            ...
            (set! boolean2.19 (call L.empty?.75.11 empty?.75 tmp.167)))
          (begin
            (begin
              (begin
              ...
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.172 (call L.*.77.9 *.77 tmp.173 tmp.174))))
                (set! tmp.168 (call L.+.78.8 |+.78| tmp.169 tmp.172))))
            (begin
              (begin
                (begin
 ...
 '(module
    ...
    (define L.cons.74.12
      (lambda (c.85 tmp.69 tmp.70)
        (begin
          (begin
            (begin (set! tmp.117 (alloc 16)) (set! tmp.98 (+ tmp.117 1)))
    ...
    (define L.+.77.9
      (lambda (c.82 tmp.38 tmp.39)
        (begin
          (if (begin
                (if (begin (set! tmp.121 (bitwise-and tmp.39 7)) (= tmp.121 0))
                  (set! tmp.120 14)
                  (set! tmp.120 6))
                (!= tmp.120 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.133 (alloc 16)) (set! tmp.99 (+ tmp.133 2)))
        (begin
          (mset! tmp.99 -2 L.-.79.7)
          (mset! tmp.99 6 16)
          (set! |-.79| tmp.99)))
      (begin
        (begin (set! tmp.134 (alloc 16)) (set! tmp.100 (+ tmp.134 2)))
        (begin
          (mset! tmp.100 -2 L.*.78.8)
          (mset! tmp.100 6 16)
          (set! *.78 tmp.100)))
      (begin
        (begin (set! tmp.135 (alloc 16)) (set! tmp.101 (+ tmp.135 2)))
        (begin
          (mset! tmp.101 -2 L.+.77.9)
          (mset! tmp.101 6 16)
          (set! |+.77| tmp.101)))
      (begin
        (begin (set! tmp.136 (alloc 16)) (set! tmp.102 (+ tmp.136 2)))
        (begin
          (mset! tmp.102 -2 L.boolean?.76.10)
          (mset! tmp.102 6 8)
          (set! boolean?.76 tmp.102)))
      (begin
        (begin (set! tmp.137 (alloc 16)) (set! tmp.103 (+ tmp.137 2)))
        (begin
          (mset! tmp.103 -2 L.pair?.75.11)
          (mset! tmp.103 6 8)
          (set! pair?.75 tmp.103)))
      (begin
        (begin (set! tmp.138 (alloc 16)) (set! tmp.104 (+ tmp.138 2)))
        (begin
          (mset! tmp.104 -2 L.cons.74.12)
          (mset! tmp.104 6 16)
          (set! cons.74 tmp.104)))
      (begin
        (begin (set! tmp.139 (alloc 24)) (set! tmp.105 (+ tmp.139 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.141 (alloc 24)) (set! tmp.107 (+ tmp.141 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.143 (alloc 16)) (set! tmp.109 (+ tmp.143 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.147 (alloc 24)) (set! tmp.113 (+ tmp.147 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.149 (alloc 16)) (set! tmp.115 (+ tmp.149 2)))
        (begin
          (mset! tmp.115 -2 L.fun/ascii-char23226.14.23)
          (mset! tmp.115 6 0)
          (set! fun/ascii-char23226.14 tmp.115)))
      (begin
        (begin (set! tmp.150 (alloc 24)) (set! tmp.116 (+ tmp.150 2)))
        (begin
      ...
      (begin
        ...
        (begin
          (begin
            ...
            (set! boolean0.21 (call L.pair?.75.11 pair?.75 tmp.151)))
          ...
          (begin
            ...
            (set! boolean3.18 (call L.boolean?.76.10 boolean?.76 tmp.152)))
          (begin
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.154 (call L.*.78.8 *.78 tmp.155 tmp.156))))
              (begin
                (begin
                  (set! tmp.158 (call L.+.77.9 |+.77| 344 1728))
                  (begin
                    (set! tmp.159 (call L.+.77.9 |+.77| 96 904))
                    (set! tmp.157 (call L.+.77.9 |+.77| tmp.158 tmp.159))))
                (set! tmp.153 (call L.*.78.8 *.78 tmp.154 tmp.157))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.161 (call L.-.79.7 |-.79| tmp.162 tmp.163))))
                (begin
                  (begin
                    (set! tmp.165 (call L.+.77.9 |+.77| 1296 928))
                    (begin
                      (set! tmp.166 (call L.-.79.7 |-.79| 1640 1760))
                      (set! tmp.164 (call L.-.79.7 |-.79| tmp.165 tmp.166))))
                  (set! tmp.160 (call L.-.79.7 |-.79| tmp.161 tmp.164))))
              (set! fixnum4.17 (call L.*.78.8 *.78 tmp.153 tmp.160))))
 ...
 '(module
    ...
    (define L.cons.72.12
      (lambda (c.84 tmp.67 tmp.68)
        (begin
          (begin
            (begin (set! tmp.115 (alloc 16)) (set! tmp.96 (+ tmp.115 1)))
    ...
    (define L.*.75.9
      (lambda (c.81 tmp.34 tmp.35)
        (begin
          (if (begin
                (if (begin (set! tmp.122 (bitwise-and tmp.35 7)) (= tmp.122 0))
                  (set! tmp.121 14)
                  (set! tmp.121 6))
                (!= tmp.121 6))
            (if (begin
    ...
    (begin
      (begin
        (begin (set! tmp.131 (alloc 16)) (set! tmp.97 (+ tmp.131 2)))
        (begin
          (mset! tmp.97 -2 L.empty?.77.7)
          (mset! tmp.97 6 8)
          (set! empty?.77 tmp.97)))
      (begin
        (begin (set! tmp.132 (alloc 16)) (set! tmp.98 (+ tmp.132 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.140 (alloc 24)) (set! tmp.106 (+ tmp.140 2)))
        (begin
      ...
      (begin
        (begin (set! tmp.142 (alloc 24)) (set! tmp.108 (+ tmp.142 2)))
        (begin
      ...
      (begin
        ...
        (begin
          ...
          (begin
            (begin
              (begin (set! tmp.147 (alloc 32)) (set! tmp.113 (+ tmp.147 2)))
              (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.149 (call L.*.75.9 *.75 tmp.150 tmp.151))))
              (begin
                (begin
                  (set! tmp.153 (call L.+.76.8 |+.76| 752 360))
                  (begin
                    (set! tmp.154 (call L.*.75.9 *.75 272 1632))
                    (set! tmp.152 (call L.+.76.8 |+.76| tmp.153 tmp.154))))
                (set! tmp.148 (call L.+.76.8 |+.76| tmp.149 tmp.152))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.156 (call L.+.76.8 |+.76| tmp.157 tmp.158))))
                (begin
                  (begin
                    (set! tmp.160 (call L.-.74.10 |-.74| 968 368))
                    (begin
                      (set! tmp.161 (call L.+.76.8 |+.76| 40 1216))
                      (set! tmp.159 (call L.*.75.9 *.75 tmp.160 tmp.161))))
                  (set! tmp.155 (call L.-.74.10 |-.74| tmp.156 tmp.159))))
              (set! fixnum2.17 (call L.*.75.9 *.75 tmp.148 tmp.155))))
          (begin
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.163 (call L.+.76.8 |+.76| tmp.164 tmp.165))))
              (begin
                (begin
                  (set! tmp.167 (call L.+.76.8 |+.76| 352 1240))
                  (begin
                    (set! tmp.168 (call L.*.75.9 *.75 984 320))
                    (set! tmp.166 (call L.-.74.10 |-.74| tmp.167 tmp.168))))
                (set! tmp.162 (call L.-.74.10 |-.74| tmp.163 tmp.166))))
            (begin
              (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.170 (call L.+.76.8 |+.76| tmp.171 tmp.172))))
                (begin
                  (begin
                    (set! tmp.174 (call L.+.76.8 |+.76| 616 800))
                    (begin
                      (set! tmp.175 (call L.-.74.10 |-.74| 528 464))
                      (set! tmp.173 (call L.*.75.9 *.75 tmp.174 tmp.175))))
                  (set! tmp.169 (call L.*.75.9 *.75 tmp.170 tmp.173))))
              (set! fixnum3.16 (call L.*.75.9 *.75 tmp.162 tmp.169))))
          (begin
            (set! tmp.176 (call L.fun/any24032.12.21 fun/any24032.12))
            (set! boolean4.15 (call L.empty?.77.7 empty?.77 tmp.176)))
