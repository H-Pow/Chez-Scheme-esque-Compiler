 ...
 '(module
    ...
    (begin
      (begin
        ...
        (set! tmp.55 (call L.empty?.8 tmp.56)))
      (begin
    ...
    (begin
      (begin
        ...
        (begin
          ...
          (set! fixnum0.4 (call L.+.12 tmp.69 tmp.70))))
 ...
 '(module
    ...
    (begin
      (if (begin
            ...
            (set! error3.13 28222)
            (!= 14 6))
        (set! tmp.69 (call L.fun/ascii-char8511.6 28974 23870 12078))
        (set! tmp.69 (call L.fun/ascii-char8512.4 25134 13102 11838)))
      (begin
        (if (begin
              (begin
                (set! tmp.72 (call L.cons.9 688 3600))
                (set! tmp.71 (call L.pair?.10 tmp.72)))
              (!= tmp.71 6))
 ...
 '(module
    ...
    (begin
      (begin
        ...
        (set! tmp.57 (call L.fun/any8685.4)))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.3 (call L.-.11 tmp.70 tmp.73))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.79 (call L.-.11 tmp.80 tmp.81))))
          (set! fixnum2.3 (call L.+.10 tmp.76 tmp.79))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.73 (call L.-.11 tmp.74 tmp.75))))
          (set! fixnum4.1 (call L.*.12 tmp.70 tmp.73))))
      error3.2)))
(check-by-interp
 '(module
    (define L.*.11
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum2.3 (call L.+.10 tmp.70 tmp.73))))
      (begin
        (begin
          (set! tmp.77 (call L.*.11 216 992))
          (begin
            (set! tmp.78 (call L.*.11 168 568))
            (set! tmp.76 (call L.+.10 tmp.77 tmp.78))))
        (begin
          (begin
          ...
          (set! fixnum3.2 (call L.*.11 tmp.76 tmp.79))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean2.4 (call L.boolean?.15 tmp.58)))
      (begin
        (set! tmp.59 (call L.fun/any18974.4))
        (set! boolean3.3 (call L.void?.16 tmp.59)))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum1.5 (call L.+.12 tmp.70 tmp.77))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.88 (call L.+.12 tmp.89 tmp.90))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.91 (call L.*.13 tmp.92 tmp.95))))
          (set! fixnum3.3 (call L.-.14 tmp.84 tmp.91))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.99 (call L.-.14 tmp.100 tmp.101))))
          (begin
            (begin
              (set! tmp.103 (call L.-.14 640 1256))
              (begin
                (set! tmp.104 (call L.+.12 712 1904))
                (set! tmp.102 (call L.*.13 tmp.103 tmp.104))))
            (set! tmp.98 (call L.-.14 tmp.99 tmp.102))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.106 (call L.+.12 tmp.107 tmp.108))))
            (begin
              (begin
                (set! tmp.110 (call L.*.13 1720 416))
                (begin
                  (set! tmp.111 (call L.-.14 1344 1112))
                  (set! tmp.109 (call L.-.14 tmp.110 tmp.111))))
              (set! tmp.105 (call L.+.12 tmp.106 tmp.109))))
          (set! fixnum5.1 (call L.*.13 tmp.98 tmp.105))))
      (begin
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.78 (call L.-.18 tmp.79 tmp.82))))
          (set! fixnum5.1 (call L.+.16 tmp.71 tmp.78))))
      error0.6)))
(check-by-interp
 '(module
    (define L.*.20
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean2.4 (call L.vector?.17 tmp.72)))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.74 (call L.+.19 tmp.75 tmp.76))))
          (begin
            (begin
              (set! tmp.78 (call L.+.19 1808 464))
              (begin
                (set! tmp.79 (call L.-.18 104 520))
                (set! tmp.77 (call L.*.20 tmp.78 tmp.79))))
            (set! tmp.73 (call L.-.18 tmp.74 tmp.77))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.81 (call L.+.19 tmp.82 tmp.83))))
            (begin
              (begin
                (set! tmp.85 (call L.+.19 1664 320))
                (begin
                  (set! tmp.86 (call L.*.20 1296 112))
                  (set! tmp.84 (call L.+.19 tmp.85 tmp.86))))
              (set! tmp.80 (call L.*.20 tmp.81 tmp.84))))
          (set! fixnum3.3 (call L.+.19 tmp.73 tmp.80))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.+.13 tmp.78 tmp.79))))
            (begin
              (begin
          ...
          (set! fixnum1.5 (call L.-.15 tmp.69 tmp.76))))
      ...
      (begin
        (begin
          (begin
            ...
            (set! tmp.98 (call L.-.15 tmp.99 fixnum4.2)))
          (begin
            (begin
              (set! tmp.101 (call L.*.14 144 fixnum1.5))
              (set! tmp.100 (call L.*.14 fixnum1.5 tmp.101)))
            (set! tmp.97 (call L.+.13 tmp.98 tmp.100))))
        (begin
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean3.3 (call L.error?.19 tmp.59)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.86 (call L.+.16 tmp.87 tmp.88))))
          (begin
            (begin
              (set! tmp.90 (call L.-.15 1880 1592))
              (begin
                (set! tmp.91 (call L.*.14 1080 1824))
                (set! tmp.89 (call L.+.16 tmp.90 tmp.91))))
            (set! tmp.85 (call L.*.14 tmp.86 tmp.89))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.93 (call L.-.15 tmp.94 tmp.95))))
            (begin
              (begin
                (set! tmp.97 (call L.*.14 608 408))
                (begin
                  (set! tmp.98 (call L.-.15 16 904))
                  (set! tmp.96 (call L.-.15 tmp.97 tmp.98))))
              (set! tmp.92 (call L.-.15 tmp.93 tmp.96))))
          (set! fixnum1.5 (call L.*.14 tmp.85 tmp.92))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.100 (call L.*.14 tmp.101 tmp.102))))
          (begin
            (begin
              (set! tmp.104 (call L.-.15 1016 784))
              (begin
                (set! tmp.105 (call L.*.14 240 2016))
                (set! tmp.103 (call L.-.15 tmp.104 tmp.105))))
            (set! tmp.99 (call L.*.14 tmp.100 tmp.103))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.107 (call L.-.15 tmp.108 tmp.109))))
            (begin
              (begin
                (set! tmp.111 (call L.*.14 880 992))
                (begin
                  (set! tmp.112 (call L.-.15 1176 1000))
                  (set! tmp.110 (call L.-.15 tmp.111 tmp.112))))
              (set! tmp.106 (call L.*.14 tmp.107 tmp.110))))
          (set! fixnum5.1 (call L.+.16 tmp.99 tmp.106))))
      ...
      (begin
        (begin
          (begin
            ...
            (set! tmp.84 (call L.-.15 fixnum4.2 tmp.85)))
          (begin
            (begin
              (set! tmp.87 (call L.+.16 184 fixnum4.2))
              (set! tmp.86 (call L.+.16 fixnum4.2 tmp.87)))
            (set! tmp.83 (call L.*.17 tmp.84 tmp.86))))
        (begin
          (begin
            (begin
              (set! tmp.90 (call L.-.15 920 912))
              (set! tmp.89 (call L.+.16 tmp.90 fixnum4.2)))
            (begin
              (begin
                (set! tmp.92 (call L.-.15 792 1752))
                (set! tmp.91 (call L.-.15 tmp.92 fixnum4.2)))
              (set! tmp.88 (call L.-.15 tmp.89 tmp.91))))
 ...
 '(module
    ...
    (begin
      (begin
        ...
        (set! boolean0.6 (call L.pair?.19 tmp.59)))
