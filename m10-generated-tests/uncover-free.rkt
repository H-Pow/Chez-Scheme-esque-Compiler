...
(define-syntax-rule
 (check-by-interp p)
 (check-equal?
  (interp-lam-opticon-lang-v9 p)
  (interp-lam-free-lang-v9 (fail-if-invalid (uncover-free p)))))
...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8485.7 (lambda () 60)))
      (unsafe-procedure-call fun/fixnum8485.7))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8488.7 (lambda () #\A)))
      (unsafe-procedure-call fun/ascii-char8488.7))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8491.7 (lambda () #\Z)))
...
(check-by-interp
 '(module
    (letrec ((fun/empty8500.7 (lambda () empty)))
...
(check-by-interp
 '(module
    (letrec ((unsafe-vector-set!.5
             ...
             (fun/void8514.8 (lambda () (void)))
             (fun/void8513.9 (lambda () (void))))
            ...
            (if (unsafe-procedure-call fun/error8535.12)
              (if (if #f (error 148) (error 136))
                (if (let ((procedure0.17
                           (letrec ((lam.73 (lambda () (error 109)))) lam.73)))
                      (error 64))
...
(check-by-interp
 '(module
    (letrec ((fun/void8538.7 (lambda () (void))))
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8568.7
             ...
             (fun/ascii-char8569.8 (lambda () #\X)))
      (unsafe-procedure-call fun/ascii-char8568.7 (if #t 65 125)))))
(check-by-interp
 '(module
    (letrec ((cons.78 (lambda (tmp.70 tmp.71) (cons tmp.70 tmp.71)))
             (error?.77 (lambda (tmp.65) (error? tmp.65)))
             (unsafe-vector-set!.5
...
(check-by-interp
 '(module
    (letrec ((cons.64 (lambda (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             (vector-init-loop.13
             ...
             (make-vector.63
              (lambda (tmp.39)
                (if (fixnum? tmp.39)
                  ...
                  (error 8))))
             (fun/boolean8574.7 (lambda (oprand0.8) #f)))
      (if (unsafe-procedure-call
           fun/boolean8574.7
...
(check-by-interp
 '(module
    (letrec ((fun/empty8578.7
             ...
             (fun/empty8579.8 (lambda () empty))
             (fun/empty8577.9 (lambda (oprand0.10) (if #f empty empty))))
      (if (let ((ascii-char0.11 #\^)) empty)
        (if (unsafe-procedure-call
             fun/empty8577.9
             (if empty (if empty (if empty empty #f) #f) #f))
          (if (let () empty)
            (if (let ((procedure0.13 (letrec ((lam.66 (lambda () #f))) lam.66))
                      (fixnum1.12 204))
                  empty)
             ...
             (*.76
              (lambda (tmp.35 tmp.36)
                (if (fixnum? tmp.36)
                  ...
                  (error 1))))
             (error?.75 (lambda (tmp.63) (error? tmp.63)))
             (unsafe-vector-set!.5
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42848282.19
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  g42848282.19
                                                  tmp.7.11)))))))))))))))))))
             (fun/fixnum8582.9 (lambda () 234))
             (fun/fixnum8583.10 (lambda (oprand0.20) (if #f 70 77))))
      (unsafe-procedure-call
       >=.77
       (unsafe-procedure-call
        *.76
...
(check-by-interp
 '(module
    (letrec ((error?.92 (lambda (tmp.82) (error? tmp.82)))
             (fun/empty8588.19 (lambda (oprand0.21) (let () empty)))
             (fun/empty8587.20 (lambda () empty)))
...
(check-by-interp
 '(module
    (letrec ((error?.90 (lambda (tmp.79) (error? tmp.79)))
             (cons.89 (lambda (tmp.84 tmp.85) (cons tmp.84 tmp.85)))
             (fun/empty8592.11 (lambda () (if #t empty empty)))
             (fun/empty8594.12 (lambda (oprand0.16) (if #f empty empty)))
             (fun/empty8593.13 (lambda (oprand0.17) (let () empty)))
             (fun/empty8591.14 (lambda (oprand0.18) empty))
             (fun/empty8595.15 (lambda () empty)))
      (let ((g42855921.19
             (let ((pair0.21
                    (unsafe-procedure-call
                     cons.89
...
(check-by-interp
 '(module
    (letrec ((error?.64 (lambda (tmp.54) (error? tmp.54)))
             (fun/fixnum8598.7 (lambda () 203))
             (fun/fixnum8599.8 (lambda () 64)))
...
(check-by-interp
 '(module
    (letrec ((cons.63 (lambda (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             (fun/fixnum8602.7
              (lambda (oprand0.10) (unsafe-procedure-call fun/fixnum8603.9)))
             (fun/fixnum8604.8 (lambda () 49))
             (fun/fixnum8603.9
...
(check-by-interp
 '(module
    (letrec ((error?.81 (lambda (tmp.71) (error? tmp.71)))
             (fun/error8609.14 (lambda () (error 43)))
             (fun/error8608.15 (lambda () (error 155)))
             (fun/error8607.16 (lambda (oprand0.17) oprand0.17)))
      (let ((tmp.7.18
             (let ((tmp.8.19
...
(check-by-interp
 '(module
    (letrec ((error?.107 (lambda (tmp.95) (error? tmp.95)))
             (unsafe-vector-set!.5
              (lambda (tmp.59 tmp.60 tmp.61)
             ...
             (make-vector.105
              (lambda (tmp.81)
                (if (fixnum? tmp.81)
                  ...
                  (error 8))))
             (fun/boolean8626.14 (lambda (oprand0.16) #f))
             (fun/boolean8625.15 (lambda (oprand0.17) (if #t #t #f))))
      (unsafe-procedure-call
       fun/boolean8625.15
...
(check-by-interp
 '(module
    (letrec ((cons.62 (lambda (tmp.57 tmp.58) (cons tmp.57 tmp.58)))
             (fun/empty8631.7 (lambda (oprand0.8) (if #t empty empty))))
      (unsafe-procedure-call
       fun/empty8631.7
...
(check-by-interp
 '(module
    (letrec ((fun/empty8634.7 (lambda () (if #t empty empty))))
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42905570.19
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  g42905570.19
                                                  tmp.7.11)))))))))))))))))))
             (fun/void8637.9 (lambda () (void)))
             (fun/fixnum8639.10 (lambda () 23)))
      (let ((void0.21 (unsafe-procedure-call fun/void8637.9))
            (procedure1.20
             (letrec ((lam.77
                       (lambda () (unsafe-procedure-call fun/vector8638.8))))
               lam.77)))
        (unsafe-procedure-call fun/fixnum8639.10)))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8642.7 (lambda () 171)))
      (if (let () #f)
        (if #f 157 104)
        (unsafe-procedure-call fun/fixnum8642.7)))))
(check-by-interp
 '(module
    (letrec ((error?.73 (lambda (tmp.61) (error? tmp.61)))
             (unsafe-vector-set!.5
                 ...
                 (if (unsafe-procedure-call error?.73 g42913205.10)
                   ...
                   (let ((g42913206.11
                          (unsafe-procedure-call
                           ...
                           tmp.7.9
                           1
                           (letrec ((lam.74 (lambda () 928))) lam.74))))
                                                   ...
                                                   (if (unsafe-procedure-call
                                                     ...
                                                     (let ((g42917039.25
                                                       ...
                                                       (if (unsafe-procedure-call
                                                         ...
                                                         tmp.7.17)))))))))))))))))))
                  #\])))
             (fun/ascii-char8648.15 (lambda (oprand0.26) #\u)))
...
(check-by-interp
 '(module
    (letrec ((error?.83 (lambda (tmp.71) (error? tmp.71)))
             (unsafe-vector-set!.5
              (lambda (tmp.35 tmp.36 tmp.37)
                (if (unsafe-fx< tmp.36 (unsafe-vector-length tmp.35))
                  (if (unsafe-fx>= tmp.36 0)
...
(check-by-interp
 '(module
    (letrec ((fun/void8654.7 (lambda (oprand0.8) (if #f (void) (void)))))
      (unsafe-procedure-call
       fun/void8654.7
       (let ((procedure0.9
              (letrec ((lam.63 (lambda (oprand0.10) #t))) lam.63)))
         (letrec ((lam.64 (lambda () 908))) lam.64))))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8657.7 (lambda (oprand0.8) #\^)))
      (let () (unsafe-procedure-call fun/ascii-char8657.7 (void))))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8661.7 (lambda () 122))
             (fun/empty8660.8 (lambda () empty)))
      (let ((empty0.10 (unsafe-procedure-call fun/empty8660.8))
            (boolean1.9 #f))
        (unsafe-procedure-call fun/fixnum8661.7)))))
(check-by-interp
 '(module
    (letrec ((cons.66 (lambda (tmp.60 tmp.61) (cons tmp.60 tmp.61)))
             (error?.65 (lambda (tmp.55) (error? tmp.55)))
             (fun/fixnum8664.7 (lambda (oprand0.8) 40)))
      (if (if #t 75 131)
...
(check-by-interp
 '(module
    (letrec ((error?.66 (lambda (tmp.56) (error? tmp.56)))
             (fun/empty8670.9 (lambda () empty))
             (fun/empty8671.10 (lambda () (if #f empty empty))))
      (let ((g42943766.11
...
(check-by-interp
 '(module
    (letrec ((fun/void8674.7 (lambda () (void))))
      (let () (unsafe-procedure-call fun/void8674.7)))))
(check-by-interp
 '(module
    (letrec ((error?.78 (lambda (tmp.64) (error? tmp.64)))
             (unsafe-vector-set!.5
              (lambda (tmp.28 tmp.29 tmp.30)
                (if (unsafe-fx< tmp.29 (unsafe-vector-length tmp.28))
                  (if (unsafe-fx>= tmp.29 0)
             ...
             (fixnum?.74 (lambda (tmp.59) (fixnum? tmp.59)))
             (fun/void8678.8 (lambda () (void)))
             (fun/any8677.9 (lambda () 207)))
      (let ((boolean0.12
             (unsafe-procedure-call
              fixnum?.74
                     ...
                     (if (unsafe-procedure-call error?.78 g42951405.15)
                       ...
                       (let ((g42951406.16
                              (unsafe-procedure-call
                               ...
                               2
                               (let ()
                                 (letrec ((lam.79 (lambda () 607))) lam.79)))))
...
(check-by-interp
 '(module
    (letrec ((procedure?.98 (lambda (tmp.88) (procedure? tmp.88)))
             (error?.97 (lambda (tmp.84) (error? tmp.84)))
             (unsafe-vector-set!.5
             ...
             (make-vector.95
              (lambda (tmp.70)
                (if (fixnum? tmp.70)
                  ...
                  (error 8))))
             (cons.94 (lambda (tmp.89 tmp.90) (cons tmp.89 tmp.90)))
             (fun/error8682.16 (lambda () (error 7)))
             (fun/boolean8683.17 (lambda () #f))
             (fun/error8681.18
              (lambda () (unsafe-procedure-call fun/error8682.16)))
             (fun/boolean8684.19 (lambda () #t)))
      (let ((pair0.22
             (unsafe-procedure-call
              cons.94
              (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.93 (lambda (tmp.80) (error? tmp.80)))
             (unsafe-vector-set!.5
              (lambda (tmp.44 tmp.45 tmp.46)
                (if (unsafe-fx< tmp.45 (unsafe-vector-length tmp.44))
                  (if (unsafe-fx>= tmp.45 0)
             ...
             (make-vector.91
              (lambda (tmp.66)
                (if (fixnum? tmp.66)
                  (unsafe-procedure-call make-init-vector.4 tmp.66)
                  (error 8))))
             (cons.90 (lambda (tmp.85 tmp.86) (cons tmp.85 tmp.86)))
             (fun/error8688.15 (lambda () (error 156)))
             (fun/error8687.16
...
(check-by-interp
 '(module
    (letrec ((error?.86 (lambda (tmp.74) (error? tmp.74)))
             (boolean?.85 (lambda (tmp.70) (boolean? tmp.70)))
             (cons.84 (lambda (tmp.79 tmp.80) (cons tmp.79 tmp.80)))
             (fun/void8692.11 (lambda (oprand0.16 oprand1.15) (void)))
             (fun/void8693.12 (lambda (oprand0.18 oprand1.17) (let () (void))))
             (fun/boolean8691.13 (lambda () #f))
             (fun/void8694.14 (lambda () (void))))
      (if (let ((tmp.7.19
                 (let ((pair0.21
                        (unsafe-procedure-call
                         cons.84
        ...
        (if (let ((procedure0.27
                   (letrec ((lam.87 (lambda () (error 38)))) lam.87))
                  (error1.26 (error 99))
                  (empty2.25 empty))
              (void))
          (if (let () (void))
...
(check-by-interp
 '(module
    (letrec ((cons.150 (lambda (tmp.142 tmp.143) (cons tmp.142 tmp.143)))
             (vector-init-loop.97
             ...
             (make-vector.149
              (lambda (tmp.123)
                (if (fixnum? tmp.123)
                  ...
                  (error 8))))
             (error?.148 (lambda (tmp.137) (error? tmp.137)))
             (unsafe-vector-set!.5
             ...
             (fun/void8713.22 (lambda () (void)))
             (fun/void8705.23 (lambda () (void)))
             (fun/void8708.24 (lambda (oprand0.33) (void)))
             (fun/void8709.25 (lambda () (void)))
             (fun/void8710.26 (lambda (oprand0.34) (void)))
             (fun/boolean8712.27 (lambda () #f))
             (fun/void8715.28 (lambda () (void)))
             (fun/void8711.29
              (lambda (oprand0.36 oprand1.35)
                (unsafe-procedure-call
                 ...
                 5
                 oprand0.36)))
             (fun/void8707.30 (lambda (oprand0.37) oprand0.37)))
        ...
        (if (if (if #f (void) (void))
          ...
          (if (if (let ((boolean0.69 #f)) #t)
            ...
            (if (let ()
                  (unsafe-procedure-call
                   fun/void8711.29
                   (letrec ((lam.151 (lambda () 1012))) lam.151)
             ...
             (make-vector.77
              (lambda (tmp.52)
                (if (fixnum? tmp.52)
                  ...
                  (error 8))))
             (error?.76 (lambda (tmp.66) (error? tmp.66)))
             (fun/ascii-char8726.8 (lambda () (if #t #\H #\a)))
             (fun/ascii-char8725.9 (lambda () #\s)))
      (let ((g42981987.10
...
(check-by-interp
 '(module
    (letrec ((pair?.129 (lambda (tmp.116) (pair? tmp.116)))
             (unsafe-vector-set!.5
             ...
             (make-vector.127
              (lambda (tmp.101)
                (if (fixnum? tmp.101)
                  ...
                  (error 8))))
             (error?.126 (lambda (tmp.115) (error? tmp.115)))
             (cons.125 (lambda (tmp.120 tmp.121) (cons tmp.120 tmp.121)))
             (fun/empty8731.21 (lambda () empty))
             (fun/pair8730.22
              (lambda ()
                (if #t
                  (unsafe-procedure-call
                                                        ...
                                                        (if (unsafe-procedure-call
                                                          ...
                                                          (let ((g42985835.50
                                                            ...
                                                            (if (unsafe-procedure-call
                                                              ...
                                                              tmp.10.33))))))))))))))))))
                           (procedure1.31
                            (letrec ((lam.131 (lambda () (let () empty))))
                              lam.131))
                           (empty2.30 (let () empty)))
...
(check-by-interp
 '(module
    (letrec ((fun/error8736.7
             ...
             (fun/boolean8735.8 (lambda () #f))
             (fun/error8737.9 (lambda () (error 242)))
             (fun/boolean8734.10
              (lambda () (unsafe-procedure-call fun/boolean8735.8))))
      (let ((procedure0.13 (letrec ((lam.66 (lambda () (let () #t)))) lam.66))
            (boolean1.12 (unsafe-procedure-call fun/boolean8734.10))
            (ascii-char2.11 (if #t #\z #\u)))
        (unsafe-procedure-call fun/error8736.7)))))
(check-by-interp
 '(module
    (letrec ((error?.82 (lambda (tmp.72) (error? tmp.72)))
             (fun/void8741.11 (lambda () (void)))
             (fun/void8740.12 (lambda (oprand0.14 oprand1.13) (void))))
      (let ()
    ...
    (letrec ((|+.80|
              (lambda (tmp.41 tmp.42)
                (if (fixnum? tmp.42)
                  ...
                  (error 2))))
             (error?.79 (lambda (tmp.67) (error? tmp.67)))
             (unsafe-vector-set!.5
...
(check-by-interp
 '(module
    (letrec ((error?.80 (lambda (tmp.69) (error? tmp.69)))
             (ascii-char?.79 (lambda (tmp.68) (ascii-char? tmp.68)))
             (fun/boolean8753.10 (lambda (oprand0.11) #t)))
      (if (let ((ascii-char0.14 #\q) (void1.13 (void)) (boolean2.12 #t)) #t)
        (let ((empty0.17 empty) (fixnum1.16 19) (boolean2.15 #f)) #t)
        (let ((tmp.7.18
               (unsafe-procedure-call
                ascii-char?.79
                (letrec ((lam.81 (lambda () 526))) lam.81))))
          (if tmp.7.18
            tmp.7.18
...
(check-by-interp
 '(module
    (letrec ((cons.69 (lambda (tmp.64 tmp.65) (cons tmp.64 tmp.65)))
             (fun/empty8761.9 (lambda () empty))
             (fun/empty8760.10 (lambda () empty)))
      (let ((empty0.12
...
(check-by-interp
 '(module
    (letrec ((error?.82 (lambda (tmp.70) (error? tmp.70)))
             (unsafe-vector-set!.5
             ...
             (make-vector.80
              (lambda (tmp.56)
                (if (fixnum? tmp.56)
                  ...
                  (error 8))))
             (fun/fixnum8766.9 (lambda (oprand0.12) 66))
             (fun/fixnum8765.10
              (lambda () (unsafe-procedure-call fun/fixnum8766.9 empty)))
             (fun/boolean8764.11 (lambda (oprand0.14 oprand1.13) (let () #f))))
      (if (unsafe-procedure-call
           fun/boolean8764.11
           (let ((tmp.7.15 (letrec ((lam.83 (lambda () 522))) lam.83)))
             (if tmp.7.15 tmp.7.15 (letrec ((lam.84 (lambda () 662))) lam.84)))
    ...
    (letrec ((|+.72|
              (lambda (tmp.34 tmp.35)
                (if (fixnum? tmp.35)
                  ...
                  (error 2))))
             (cons.71 (lambda (tmp.65 tmp.66) (cons tmp.65 tmp.66)))
             (*.70
             ...
             (fun/fixnum8775.9 (lambda (oprand0.13) 117))
             (fun/fixnum8774.10 (lambda () 126))
             (fun/fixnum8772.11 (lambda (oprand0.14) 87)))
      (unsafe-procedure-call
       |+.72|
       (if (let () 213)
             ...
             (make-vector.75
              (lambda (tmp.49)
                (if (fixnum? tmp.49)
                  (unsafe-procedure-call make-init-vector.4 tmp.49)
                  (error 8))))
             (cons.74 (lambda (tmp.68 tmp.69) (cons tmp.68 tmp.69)))
             (error?.73 (lambda (tmp.63) (error? tmp.63)))
             (fun/empty8780.8 (lambda () empty)))
             ...
             (make-vector.163
              (lambda (tmp.136)
                (if (fixnum? tmp.136)
                  ...
                  (error 8))))
             (error?.162 (lambda (tmp.150) (error? tmp.150)))
             (unsafe-vector-set!.5
              ...
              (lambda (tmp.138 tmp.139 tmp.140)
                (if (fixnum? tmp.139)
                  (if (vector? tmp.138)
                    ...
                    (error 10))
                  (error 10))))
             (cons.160 (lambda (tmp.155 tmp.156) (cons tmp.155 tmp.156)))
             (fun/boolean8789.21 (lambda (oprand0.30) #t))
             (fun/boolean8790.22 (lambda (oprand0.32 oprand1.31) #t))
             (fun/ascii-char8791.23 (lambda (oprand0.33) (if #t #\m #\`)))
             (fun/void8788.24 (lambda () (void)))
             (fun/void8786.25 (lambda () (void)))
             (fun/ascii-char8785.26 (lambda () #\k))
          ...
          (let ((tmp.9.55
            ...
            (if tmp.9.55
              ...
              (let ((tmp.11.66
                     (if (unsafe-procedure-call
                          fun/boolean8789.21
                          (letrec ((lam.164 (lambda () 792))) lam.164))
                       (let ((tmp.12.67 #\[))
                         (if tmp.12.67
                           tmp.12.67
                           (let ((tmp.13.68 #\W))
...
(check-by-interp
 '(module
    (letrec ((cons.97 (lambda (tmp.89 tmp.90) (cons tmp.89 tmp.90)))
             ...
             (make-vector.94
              (lambda (tmp.70)
                (if (fixnum? tmp.70)
                  (unsafe-procedure-call make-init-vector.4 tmp.70)
                  (error 8))))
             (fun/empty8795.13 (lambda (oprand0.17 oprand1.16) (let () empty)))
             (fun/boolean8796.14 (lambda (oprand0.18) #t))
             (fun/empty8794.15 (lambda (oprand0.19) empty)))
      (let ((tmp.7.20
        ...
        (if tmp.7.20
          ...
          (let ((tmp.8.24
                 (if (let ((empty0.25 empty)) empty)
                   (if (unsafe-procedure-call
                        fun/empty8794.15
                        (letrec ((lam.98 (lambda () 949))) lam.98))
                     (let () empty)
                     #f)
                   #f)))
            (if tmp.8.24
                                                   ...
                                                   (if (unsafe-procedure-call
                                                     ...
                                                     (let ((g43039365.35
                                                       ...
                                                       (if (unsafe-procedure-call
                                                         ...
                                                         tmp.10.27))))))))))))))))))
                      (if #t
                        (letrec ((lam.99 (lambda () 556))) lam.99)
                        (letrec ((lam.100 (lambda () 797))) lam.100)))))
                (if tmp.9.26
                  tmp.9.26
...
(check-by-interp
 '(module
    (letrec ((fun/void8801.7 (lambda () (void)))
             (fun/void8800.8
              (lambda () (unsafe-procedure-call fun/void8801.7)))
             (fun/void8799.9
              (lambda () (unsafe-procedure-call fun/void8800.8))))
    ...
    (letrec ((<.81
              (lambda (tmp.45 tmp.46)
                (if (fixnum? tmp.46)
                  ...
                  (error 4))))
             (error?.80 (lambda (tmp.67) (error? tmp.67)))
             (unsafe-vector-set!.5
              (lambda (tmp.31 tmp.32 tmp.33)
                (if (unsafe-fx< tmp.32 (unsafe-vector-length tmp.31))
                  (if (unsafe-fx>= tmp.32 0)
             ...
             (make-vector.78
              (lambda (tmp.53)
                (if (fixnum? tmp.53)
                  (unsafe-procedure-call make-init-vector.4 tmp.53)
                  (error 8))))
             (fixnum?.77 (lambda (tmp.62) (fixnum? tmp.62)))
             (fun/any8804.8 (lambda (oprand0.10 oprand1.9) (error 108))))
      (if (unsafe-procedure-call
           fixnum?.77
...
(check-by-interp
 '(module
    (letrec ((error?.70 (lambda (tmp.60) (error? tmp.60))))
    ...
    (letrec ((|+.61|
              (lambda (tmp.24 tmp.25)
                (if (fixnum? tmp.25)
                  ...
                  (error 2))))
             (cons.60 (lambda (tmp.55 tmp.56) (cons tmp.55 tmp.56))))
      (unsafe-procedure-call
       |+.61|
       (if #t 94 161)
       (let ((pair0.7
...
(check-by-interp
 '(module
    (letrec ((cons.64 (lambda (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             ...
             (fun/ascii-char8825.9 (lambda () #\r))
             (fun/boolean8824.10 (lambda (oprand0.11) #f)))
             ...
             (make-vector.80
              (lambda (tmp.55)
                (if (fixnum? tmp.55)
                  ...
                  (error 8))))
             (error?.79 (lambda (tmp.69) (error? tmp.69))))
...
(check-by-interp
 '(module
    (letrec ((cons.138 (lambda (tmp.130 tmp.131) (cons tmp.130 tmp.131)))
             (unsafe-vector-set!.5
             ...
             (make-vector.136
              (lambda (tmp.111)
                (if (fixnum? tmp.111)
                  ...
                  (error 8))))
             (error?.135 (lambda (tmp.125) (error? tmp.125)))
             (fun/ascii-char8840.13 (lambda (oprand0.19 oprand1.18) #\M))
             (fun/ascii-char8839.14 (lambda (oprand0.21 oprand1.20) #\q))
             (fun/ascii-char8841.15 (lambda (oprand0.23 oprand1.22) #\p))
             (fun/boolean8837.16
              (lambda (oprand0.25 oprand1.24)
                (unsafe-procedure-call fun/boolean8838.17)))
             (fun/boolean8838.17 (lambda () #f)))
      (if (unsafe-procedure-call
           fun/boolean8837.16
...
(check-by-interp
 '(module
    (letrec ((unsafe-vector-set!.5
             ...
             (*.124
              (lambda (tmp.84 tmp.85)
                (if (fixnum? tmp.85)
                  ...
                  (error 1))))
             (error?.123 (lambda (tmp.112) (error? tmp.112)))
             (cons.122 (lambda (tmp.117 tmp.118) (cons tmp.117 tmp.118)))
             (fun/error8847.16
             ...
             (fun/fixnum8851.19 (lambda (oprand0.29) 236))
             (fun/fixnum8850.20 (lambda (oprand0.30) 31))
             (fun/error8852.21
              (lambda () (unsafe-procedure-call fun/error8853.23)))
             (fun/error8848.22 (lambda () (error 200)))
             (fun/error8853.23 (lambda () (error 51)))
             (fun/error8854.24 (lambda () (if #f (error 82) (error 144))))
             (fun/error8855.25 (lambda () (error 63))))
      (let ((tmp.7.31
             (unsafe-procedure-call
              fun/error8846.17
              (let ((g43089053.32
             ...
             (make-vector.113
              (lambda (tmp.86)
                (if (fixnum? tmp.86)
                  ...
                  (error 8))))
             (cons.112 (lambda (tmp.105 tmp.106) (cons tmp.105 tmp.106)))
             (error?.111 (lambda (tmp.100) (error? tmp.100)))
             (unsafe-vector-set!.5
              ...
              (lambda (tmp.88 tmp.89 tmp.90)
                (if (fixnum? tmp.89)
                  (if (vector? tmp.88)
                    ...
                    (error 10))
                  (error 10))))
             (fun/fixnum8859.11 (lambda () 240))
             (fun/fixnum8863.12 (lambda () 189))
             (fun/fixnum8864.13 (lambda (oprand0.19) (let () 246)))
             (fun/void8861.14
              (lambda (oprand0.21 oprand1.20)
                (unsafe-procedure-call
                 ...
                 (unsafe-procedure-call
                  ...
                  3
                  oprand0.21))))
             (fun/error8865.15 (lambda (oprand0.22) (error 210)))
             (fun/fixnum8858.16 (lambda () (if #f 223 114)))
             (fun/fixnum8860.17 (lambda (oprand0.24 oprand1.23) (let () 190)))
             (fun/empty8862.18 (lambda (oprand0.25) empty)))
      (let ((g43092885.26
               ...
               (if tmp.7.27
                 ...
                 (let ((tmp.8.28 (unsafe-procedure-call fun/fixnum8858.16)))
                   (if tmp.8.28
                     tmp.8.28
                     (let ((procedure0.31
                            (letrec ((lam.115 (lambda () #\V))) lam.115))
                           (error1.30 (error 143))
                           (void2.29 (void)))
                       166)))))))
                  ...
                  (unsafe-procedure-call
                   ...
                   (let ((tmp.10.57 (error 62)))
                     (if tmp.10.57
                       ...
                       (unsafe-procedure-call
                        fun/error8865.15
                        (letrec ((lam.116 (lambda () 976)))
                          lam.116))))))))))))))
(check-by-interp
 '(module
    (letrec ((cons.92 (lambda (tmp.84 tmp.85) (cons tmp.84 tmp.85)))
             (error?.91 (lambda (tmp.79) (error? tmp.79)))
             (unsafe-vector-set!.5
...
(check-by-interp
 '(module
    (letrec ((cons.68 (lambda (tmp.63 tmp.64) (cons tmp.63 tmp.64)))
             (fun/fixnum8875.7
              (lambda (oprand0.13) (unsafe-procedure-call fun/fixnum8876.11)))
             (fun/fixnum8873.8 (lambda () (let () 155)))
             (fun/fixnum8874.9
              (lambda ()
                (unsafe-procedure-call
                 fun/fixnum8875.7
...
(check-by-interp
 '(module
    (letrec ((error?.98 (lambda (tmp.85) (error? tmp.85)))
             (unsafe-vector-set!.5
              (lambda (tmp.49 tmp.50 tmp.51)
             ...
             (make-vector.96
              (lambda (tmp.71)
                (if (fixnum? tmp.71)
                  ...
                  (error 8))))
             (cons.95 (lambda (tmp.90 tmp.91) (cons tmp.90 tmp.91)))
             (fun/empty8882.14
              (lambda () (unsafe-procedure-call fun/empty8883.16 (void))))
             (fun/empty8885.15 (lambda (oprand0.19 oprand1.18) empty))
             (fun/empty8883.16 (lambda (oprand0.20) empty))
             (fun/empty8884.17 (lambda () empty)))
      (if (if #t #t #t)
...
(check-by-interp
 '(module
    (letrec ((fun/empty8899.7
             ...
             (fun/error8902.8 (lambda (oprand0.13) (let () (error 138))))
             (fun/empty8900.9
             ...
             (fun/empty8901.11 (lambda () empty)))
      (unsafe-procedure-call fun/empty8898.10))))
(check-by-interp
 '(module
    (letrec ((cons.64 (lambda (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             (fun/empty8905.7 (lambda (oprand0.8) (let () empty))))
      (let ()
        (unsafe-procedure-call
         fun/empty8905.7
         (let ((void0.11 (void))
               (procedure1.10 (letrec ((lam.65 (lambda () #\W))) lam.65))
               (fixnum2.9 220))
           (unsafe-procedure-call
            cons.64
            141
...
(check-by-interp
 '(module
    (letrec ((error?.71 (lambda (tmp.61) (error? tmp.61)))
             (fun/fixnum8912.7 (lambda (oprand0.13 oprand1.12) oprand0.13))
             (fun/error8911.8
             ...
             (fun/boolean8909.10 (lambda () #f))
             (fun/empty8910.11 (lambda () empty)))
      (unsafe-procedure-call
       fun/empty8908.9
       (unsafe-procedure-call
        fun/error8911.8
...
(check-by-interp
 '(module
    (letrec ((fun/empty8915.7
             ...
             (fun/empty8916.8 (lambda (oprand0.10) (if #t empty empty)))
             (fun/ascii-char8917.9 (lambda (oprand0.11) #\t)))
      (unsafe-procedure-call fun/empty8915.7))))
(check-by-interp
 '(module
    (letrec ((error?.138 (lambda (tmp.125) (error? tmp.125)))
             (vector-init-loop.85
              (lambda (len.86 i.88 vec.87)
                (if (eq? len.86 i.88)
                  vec.87
              ...
              (lambda (tmp.113 tmp.114 tmp.115)
                (if (fixnum? tmp.114)
                  (if (vector? tmp.113)
                    ...
                    (error 10))
                  (error 10))))
             (cons.135 (lambda (tmp.130 tmp.131) (cons tmp.130 tmp.131)))
             (fun/void8925.14 (lambda (oprand0.24 oprand1.23) oprand0.24))
             (fun/fixnum8922.15 (lambda () 32))
             (fun/void8928.16 (lambda (oprand0.26 oprand1.25) (let () (void))))
             (fun/fixnum8921.17
              (lambda () (unsafe-procedure-call fun/fixnum8922.15)))
             (fun/fixnum8920.18
              (lambda (oprand0.28 oprand1.27)
                (unsafe-procedure-call fun/fixnum8921.17)))
             (fun/void8924.19 (lambda () (void)))
             (fun/void8923.20
              (lambda (oprand0.29)
                (let ()
                  (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((fun/boolean8934.7 (lambda () #t))
             (fun/fixnum8933.8
              (lambda ()
...
(check-by-interp
 '(module
    (letrec ((error?.87 (lambda (tmp.75) (error? tmp.75)))
             (ascii-char?.86 (lambda (tmp.74) (ascii-char? tmp.74)))
             (cons.85 (lambda (tmp.80 tmp.81) (cons tmp.80 tmp.81)))
             (fun/void8949.12 (lambda (oprand0.16 oprand1.15) (let () (void))))
             (fun/void8950.13 (lambda () (void)))
             (fun/void8951.14 (lambda () (void))))
      (if (unsafe-procedure-call
           ascii-char?.86
           (let ((procedure0.18
                  (letrec ((lam.88
                            (lambda (oprand0.19)
                              (letrec ((lam.89 (lambda () 1019))) lam.89))))
                    lam.88))
                 (pair1.17
                  (unsafe-procedure-call
                   cons.85
...
(check-by-interp
 '(module
    (letrec ((fun/error8958.7 (lambda () (if #t (error 216) (error 110))))
             (fun/error8956.8
...
(check-by-interp
 '(module
    (letrec ((cons.63 (lambda (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             ...
             (fun/error8962.8 (lambda () (error 73))))
      (let ((pair0.10
             (unsafe-procedure-call
              cons.63
              (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.93 (lambda (tmp.81) (error? tmp.81)))
             (unsafe-vector-set!.5
             ...
             (make-vector.91
              (lambda (tmp.67)
                (if (fixnum? tmp.67)
                  ...
                  (error 8))))
             (fun/ascii-char8966.15 (lambda (oprand0.18 oprand1.17) #\j))
             (fun/ascii-char8965.16 (lambda (oprand0.20 oprand1.19) #\g)))
      (if (if #t #t #f)
        (let ((tmp.7.21 (if #t #\r #\`)))
          (if tmp.7.21
            tmp.7.21
...
(check-by-interp
 '(module
    (letrec ((fun/void8969.13 (lambda () (void))))
                                           ...
                                           (if tmp.11.21
                                             ...
                                             (let ((tmp.12.22
                                               ...
                                               (if tmp.12.22
                                                 ...
                                                 (let () (void)))))))))))))))))
               lam.75))
            (procedure2.14 (letrec ((lam.76 (lambda () (let () #f)))) lam.76)))
        (if #t (error 237) (error 2))))))
(check-by-interp
 '(module
    (letrec ((fun/boolean8974.7 (lambda () #t))
             (fun/boolean8973.8
             ...
             (fun/boolean8972.9
              (lambda ()
                (unsafe-procedure-call
                 fun/boolean8973.8
                 (if #f
                   (letrec ((lam.63 (lambda () 569))) lam.63)
                   (letrec ((lam.64 (lambda () 967))) lam.64))))))
      (unsafe-procedure-call fun/boolean8972.9))))
(check-by-interp
 '(module
    (letrec ((error?.89 (lambda (tmp.75) (error? tmp.75)))
             (unsafe-vector-set!.5
             ...
             (make-vector.87
              (lambda (tmp.61)
                (if (fixnum? tmp.61)
                  ...
                  (error 8))))
             (pair?.86 (lambda (tmp.76) (pair? tmp.76)))
             (cons.85 (lambda (tmp.80 tmp.81) (cons tmp.80 tmp.81)))
             (fun/boolean8978.9 (lambda (oprand0.15) #t))
             (fun/procedure8982.10
              (lambda () (let () (letrec ((lam.90 (lambda () 845))) lam.90))))
             (fun/void8979.11
              (lambda (oprand0.17 oprand1.16)
                (unsafe-procedure-call fun/void8980.13)))
             (fun/void8977.12 (lambda () (void)))
             (fun/void8980.13
              (lambda () (unsafe-procedure-call fun/void8981.14)))
             (fun/void8981.14 (lambda () (void))))
    ...
    (letrec ((>.73
              (lambda (tmp.43 tmp.44)
                (if (fixnum? tmp.44)
                  ...
                  (error 6))))
             (error?.72 (lambda (tmp.61) (error? tmp.61)))
             (cons.71 (lambda (tmp.66 tmp.67) (cons tmp.66 tmp.67)))
             (fun/fixnum8985.7 (lambda (oprand0.8) 23)))
      (if (unsafe-procedure-call
           >.73
           (unsafe-procedure-call
            fun/fixnum8985.7
        ...
        (let ((pair0.15
          ...
          (void))
        (let ((procedure0.18 (letrec ((lam.74 (lambda () #\v))) lam.74))
              (fixnum1.17 181)
              (pair2.16
               (unsafe-procedure-call
                cons.71
             ...
             (fun/void8988.7
              (lambda ()
                (if (unsafe-procedure-call
                  ...
                  (if #f (void) (void)))))
             (fun/boolean8989.8 (lambda (oprand0.10) #f))
             (fun/void8990.9 (lambda (oprand0.11) (void))))
      (unsafe-procedure-call fun/void8988.7))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8993.7
              (lambda (oprand0.9) (unsafe-procedure-call fun/fixnum8994.8)))
             (fun/fixnum8994.8 (lambda () (if #f 82 210))))
      (unsafe-procedure-call
       fun/fixnum8993.7
       (let ()
         (let ((empty0.10 empty))
           (letrec ((lam.63 (lambda () 562))) lam.63)))))))
(check-by-interp
 '(module
    (letrec ((fun/error8998.7
              (lambda () (unsafe-procedure-call fun/error8999.8)))
             (fun/error8999.8 (lambda () (error 87)))
             (fun/boolean9002.9 (lambda () #t))
             (fun/error8997.10
             ...
             (fun/procedure9000.12
              (lambda (oprand0.14)
                (if oprand0.14
                  (letrec ((lam.67 (lambda () 608))) lam.67)
                  (letrec ((lam.68 (lambda () 525))) lam.68)))))
      (unsafe-procedure-call
       fun/error8997.10
       (unsafe-procedure-call
        fun/procedure9000.12
