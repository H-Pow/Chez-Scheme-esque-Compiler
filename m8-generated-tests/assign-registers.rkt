#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../assign-registers.rkt")
...
(check-by-interp
 '(module
    ((locals (fixnum2.1 void1.2 boolean0.3))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (fixnum2.1 boolean1.2 empty0.3))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void3.1 fixnum2.2 tmp.64 empty1.3 void0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (void3.1 empty2.2 fixnum1.3 tmp.64 empty0.4))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (fixnum3.1 tmp.70 fixnum1.3 tmp.68 error0.4))
     (conflicts
      ((tmp-ra.76
        (fixnum3.1
         tmp.70
...
(check-by-interp
 '(module
    ((locals (ascii-char4.1 error3.2 empty2.3 ascii-char1.4 empty0.5))
     (conflicts
      ((tmp-ra.61
...
(check-by-interp
 '(module
    ((locals
      (ascii-char4.1 boolean3.2 tmp.56 ascii-char2.3 ascii-char1.4 empty0.5))
     (conflicts
      ((tmp-ra.64
        (ascii-char4.1
         boolean3.2
...
(check-by-interp
 '(module
    ((locals (void4.1 empty3.2 void2.3 empty1.4 ascii-char0.5))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (empty4.1 error3.2 error2.3 void1.4 ascii-char0.5))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (empty4.1 error3.2 void2.3 error1.4 error0.5))
     (conflicts
...
(check-by-interp
 '(module
    ((locals (fixnum4.1 tmp.71 tmp.73 tmp.70 empty3.2 void2.3 void1.4))
     (conflicts
      ((tmp-ra.81
        (fixnum4.1
         tmp.71
...
(check-by-interp
 '(module
    ((locals (ascii-char4.1 error3.2 fixnum1.4 tmp.66 tmp.68 tmp.65 error0.5))
     (conflicts
      ((tmp-ra.75
        (ascii-char4.1
         error3.2
...
(check-by-interp
 '(module
    ((locals (boolean4.1 tmp.58 boolean3.2 tmp.57 void2.3 ascii-char0.5))
     (conflicts
      ((tmp-ra.66
        (boolean4.1
         tmp.58
...
(check-by-interp
 '(module
    ((locals (tmp.71 tmp.73 tmp.70 void4.1 void3.2 empty2.3 error1.4 empty0.5))
     (conflicts
      ((tmp-ra.82
        (rdi
         rsi
...
(check-by-interp
 '(module
    ((locals (error5.1 ascii-char4.2 void3.3 error2.4 error1.5 void0.6))
     (conflicts
      ((tmp-ra.70
...
(check-by-interp
 '(module
    ((locals (ascii-char5.1 error4.2 ascii-char2.4 error1.5 void0.6))
     (conflicts
      ((tmp-ra.68
        (ascii-char5.1
         error4.2
...
(check-by-interp
 '(module
    ((locals (empty5.1 empty4.2 ascii-char3.3 void2.4 empty1.5 empty0.6))
     (conflicts
      ((tmp-ra.70
...
(check-by-interp
 '(module
    ((locals
      (error5.1 ascii-char4.2 ascii-char3.3 ascii-char2.4 ascii-char1.5))
     (conflicts
      ((tmp-ra.68
        (error5.1
         ascii-char4.2
...
(check-by-interp
 '(module
    ((locals (error5.1 boolean4.2 tmp.57 ascii-char3.3 ascii-char1.5 void0.6))
     (conflicts
      ((tmp-ra.70
        (error5.1
         boolean4.2
...
(check-by-interp
 '(module
    ((locals (empty5.1 error4.2 void3.3 empty2.4 error1.5 boolean0.6 tmp.57))
     (conflicts
      ((tmp-ra.72
        (empty5.1
         error4.2
