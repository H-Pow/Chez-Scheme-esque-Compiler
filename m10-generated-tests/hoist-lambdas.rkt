             ...
             (L.fun/ascii-char8647.14.16
              (lambda (c.102)
                (let ((make-vector.90 (closure-ref c.102 0))
                  ...
                  (let ((vector0.16
                         (let ((tmp.7.17
                                (call L.make-vector.90.15 make-vector.90 8)))
                           (let ((g42917032.18
                                  (call
                                   L.vector-set!.91.12
                                   vector-set!.91
 ...
 '(module
    (letrec ((L.fun/ascii-char8657.7.10
      ...
      (cletrec
       ...
       (let ()
         (call L.fun/ascii-char8657.7.10 fun/ascii-char8657.7 (void)))))))
(check-by-interp
 '(module
             ...
             (L.fun/fixnum8807.7.11
              (lambda (c.63)
                (let ((cons.61 (closure-ref c.63 0)))
                  (let ((pair0.8 (call L.cons.61.10 cons.61 #\j (error 63))))
                    37)))))
      (cletrec
