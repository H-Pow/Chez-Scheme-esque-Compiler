...
(check-by-interp
 '(module
    (letrec ((error?.65 (lambda ((free ())) (tmp.55) (error? tmp.55))))
      (let ((g42027422.7 #\b))
...
(check-by-interp
 '(module
    (letrec ((error?.60 (lambda ((free ())) (tmp.50) (error? tmp.50))))
...
(check-by-interp
 '(module
    (letrec ((fun/void8493.7 (lambda ((free ())) () (void))))
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8498.7 (lambda ((free ())) () #\U)))
      (unsafe-procedure-call fun/ascii-char8498.7))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8501.7 (lambda ((free ())) () #\v)))
      (unsafe-procedure-call fun/ascii-char8501.7))))
(check-by-interp
 '(module
    (letrec ((error?.66 (lambda ((free ())) (tmp.56) (error? tmp.56))))
      (let ((g42050319.7
             (let ((g42050320.8 #\V))
...
(check-by-interp
 '(module
    (letrec ((error?.84 (lambda ((free ())) (tmp.72) (error? tmp.72)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.36 tmp.37 tmp.38)
                (if (unsafe-fx< tmp.37 (unsafe-vector-length tmp.36))
                  ...
                  (error 10))))
             (vector-set!.83
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.61)
                  ...
                  (error 10))))
             (vector-init-loop.32
              (lambda ((free (vector-init-loop.32)))
                (len.33 i.35 vec.34)
                (if (eq? len.33 i.35)
                  vec.34
                  (begin
              ...
              (lambda ((free (vector-init-loop.32)))
                ...
                (let ((tmp.31 (unsafe-make-vector tmp.30)))
                  (unsafe-procedure-call
                   ...
                   tmp.31))))
             (make-vector.82
              (lambda ((free (make-init-vector.4)))
                (tmp.58)
                (if (fixnum? tmp.58)
                  (unsafe-procedure-call make-init-vector.4 tmp.58)
                  (error 8))))
             (fun/ascii-char8506.13 (lambda ((free ())) () #\L))
             (fun/ascii-char8507.14 (lambda ((free ())) () #\i)))
      (let ((tmp.7.15
             (let ((procedure0.16
                    (letrec ((lam.85
                              (lambda ((free
...
(check-by-interp
 '(module
    (letrec ((fun/error8516.7
              (lambda ((free (fun/error8517.8)))
                ()
                (unsafe-procedure-call fun/error8517.8)))
             (fun/error8517.8 (lambda ((free ())) () (error 112))))
      (unsafe-procedure-call fun/error8516.7))))
(check-by-interp '(module (let () 110)))
(check-by-interp
 '(module
    (letrec ((fun/error8523.7 (lambda ((free ())) () (error 210)))
             (fun/error8522.8
              (lambda ((free (fun/error8523.7)))
                ()
                (unsafe-procedure-call fun/error8523.7))))
      (unsafe-procedure-call fun/error8522.8))))
(check-by-interp '(module (if #t (void) (void))))
(check-by-interp '(module (if #t 46 97)))
(check-by-interp
 '(module
    (letrec ((fun/void8531.7 (lambda ((free ())) () (void)))
             (fun/void8530.8
              (lambda ((free (fun/void8531.7)))
                ()
                (unsafe-procedure-call fun/void8531.7))))
      (unsafe-procedure-call fun/void8530.8))))
(check-by-interp
 '(module
    (letrec ((error?.69 (lambda ((free ())) (tmp.59) (error? tmp.59)))
             (fun/void8534.7 (lambda ((free ())) () (void)))
             (fun/void8535.8 (lambda ((free ())) () (void))))
...
(check-by-interp
 '(module
    (letrec ((fun/void8539.7 (lambda ((free ())) () (void)))
             (fun/void8538.8
              (lambda ((free (fun/void8539.7)))
                ()
                (unsafe-procedure-call fun/void8539.7))))
...
(check-by-interp
 '(module
    (letrec ((fun/error8546.7 (lambda ((free ())) () (let () (error 83)))))
      (unsafe-procedure-call fun/error8546.7))))
(check-by-interp
 '(module
    (letrec ((fun/empty8549.7 (lambda ((free ())) (oprand0.8) (let () empty))))
      (unsafe-procedure-call
       fun/empty8549.7
...
(check-by-interp
 '(module
    (letrec ((fun/void8553.7
              (lambda ((free (fun/void8554.8)))
                ()
                (unsafe-procedure-call fun/void8554.8)))
             (fun/void8554.8 (lambda ((free ())) () (void)))
             (fun/void8552.9
              (lambda ((free (fun/void8553.7)))
                (oprand0.10)
                (unsafe-procedure-call fun/void8553.7))))
      (unsafe-procedure-call fun/void8552.9 (if #f 221 247)))))
(check-by-interp
 '(module
    (letrec ((error?.69 (lambda ((free ())) (tmp.59) (error? tmp.59)))
             (fun/error8557.7 (lambda ((free ())) () (error 161))))
...
(check-by-interp
 '(module
    (letrec ((cons.64
              (lambda ((free ())) (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             (fun/ascii-char8562.7 (lambda ((free ())) (oprand0.10) #\n))
             (fun/ascii-char8561.8 (lambda ((free ())) (oprand0.11) #\l))
             (fun/boolean8560.9 (lambda ((free ())) () #f)))
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8565.7 (lambda ((free ())) () #\C)))
      (let ((procedure0.8
             (letrec ((lam.62
                       (lambda ((free (fun/ascii-char8565.7)))
                         ()
                         (unsafe-procedure-call fun/ascii-char8565.7))))
               lam.62)))
...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8570.7 (lambda ((free ())) () (let () 159))))
      (unsafe-procedure-call fun/fixnum8570.7))))
(check-by-interp
 '(module
    (letrec ((fun/void8573.7 (lambda ((free ())) () (if #f (void) (void)))))
      (unsafe-procedure-call fun/void8573.7))))
(check-by-interp '(module (let () empty)))
(check-by-interp
 '(module
    (letrec ((pair?.61 (lambda ((free ())) (tmp.52) (pair? tmp.52))))
      (unsafe-procedure-call
       pair?.61
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8582.7 (lambda ((free ())) () #\H)))
      (let ((void0.8 (if #t (void) (void))))
        (unsafe-procedure-call fun/ascii-char8582.7)))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8585.7 (lambda ((free ())) () (if #f #\r #\D))))
 ...
 '(module
    (letrec ((error?.78 (lambda ((free ())) (tmp.66) (error? tmp.66)))
             ...
             (fun/ascii-char8591.8
              (lambda ((free (fun/ascii-char8592.9)))
                (oprand0.13)
                (unsafe-procedure-call fun/ascii-char8592.9)))
             (fun/ascii-char8592.9 (lambda ((free ())) () #\L))
             (fun/ascii-char8595.10 (lambda ((free ())) () #\v))
             (fun/vector8594.11
              (lambda ((free (vector-set!.77 error?.78 make-vector.76)))
                ()
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42161010.22
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  tmp.7.14)))))))))))))))))))
             (fun/vector8593.12
              (lambda ((free (fun/vector8594.11)))
                (oprand0.23)
                (unsafe-procedure-call fun/vector8594.11))))
      (unsafe-procedure-call
       fun/ascii-char8591.8
       (unsafe-procedure-call
        fun/vector8593.12
...
(check-by-interp
 '(module
    (letrec ((error?.107 (lambda ((free ())) (tmp.96) (error? tmp.96)))
             (cons.106
              (lambda ((free ())) (tmp.101 tmp.102) (cons tmp.101 tmp.102)))
             (fun/ascii-char8602.22 (lambda ((free ())) () #\J))
             (fun/ascii-char8604.23 (lambda ((free ())) () #\_))
             (fun/ascii-char8603.24 (lambda ((free ())) () #\N)))
      (let ((g42168642.25
             (let ((tmp.7.26
                    (let ((pair0.28
                           (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((fun/error8607.7 (lambda ((free ())) (oprand0.8) (error 187))))
      (let () (unsafe-procedure-call fun/error8607.7 #t)))))
(check-by-interp
 '(module
    (letrec ((fun/error8610.7 (lambda ((free ())) (oprand0.8) (error 137))))
      (if (if #f #f #t)
        (let () (error 47))
        (unsafe-procedure-call fun/error8610.7 6)))))
(check-by-interp
 '(module
    (letrec ((fun/boolean8613.7 (lambda ((free ())) (oprand0.9) #t))
             (fun/void8614.8 (lambda ((free ())) (oprand0.10) (void))))
      (if (unsafe-procedure-call fun/boolean8613.7 #\I)
        (if #t (void) (void))
        (unsafe-procedure-call fun/void8614.8 #f)))))
(check-by-interp
 '(module
    (letrec ((error?.63 (lambda ((free ())) (tmp.53) (error? tmp.53))))
...
(check-by-interp
 '(module
    (letrec ((fun/error8619.7 (lambda ((free ())) (oprand0.8) (error 75))))
      (if (if #f #t #f)
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8622.7
              (lambda ((free (fun/ascii-char8623.8)))
                ()
                (unsafe-procedure-call fun/ascii-char8623.8)))
             (fun/ascii-char8623.8
              (lambda ((free (fun/ascii-char8624.9)))
                ()
                (unsafe-procedure-call fun/ascii-char8624.9)))
             (fun/ascii-char8624.9 (lambda ((free ())) () #\q)))
      (unsafe-procedure-call fun/ascii-char8622.7))))
(check-by-interp
 '(module
    (letrec ((unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.68 tmp.69 tmp.70)
             ...
             (vector-set!.117
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.93)
                  ...
                  (error 10))))
             (vector-init-loop.64
              (lambda ((free (vector-init-loop.64)))
                (len.65 i.67 vec.66)
                (if (eq? len.65 i.67)
                  vec.66
                  (begin
             ...
             (make-vector.116
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.90)
                  ...
                  (error 8))))
             (cons.115
              (lambda ((free ())) (tmp.109 tmp.110) (cons tmp.109 tmp.110)))
             (error?.114 (lambda ((free ())) (tmp.104) (error? tmp.104)))
             (fun/empty8627.23
              (lambda ((free ())) (oprand0.27) (if #f empty empty)))
             (fun/empty8630.24 (lambda ((free ())) () empty))
             (fun/empty8629.25 (lambda ((free ())) (oprand0.28) empty))
             (fun/empty8628.26 (lambda ((free ())) () empty)))
      (if (let () empty)
        (if (unsafe-procedure-call
             fun/empty8627.23
...
(check-by-interp
 '(module
    (if (if #t #f #t)
      ...
      (let ((procedure0.7
             (letrec ((lam.60 (lambda ((free ())) () 143))) lam.60)))
        (error 251)))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    (letrec ((error?.62 (lambda ((free ())) (tmp.52) (error? tmp.52))))
      (if (if #t #t #t)
...
(check-by-interp
 '(module
    (letrec ((cons.67
              (lambda ((free ())) (tmp.62 tmp.63) (cons tmp.62 tmp.63))))
...
(check-by-interp
 '(module
    (letrec ((cons.82
              (lambda ((free ())) (tmp.76 tmp.77) (cons tmp.76 tmp.77)))
             (error?.81 (lambda ((free ())) (tmp.71) (error? tmp.71)))
             (fun/empty8650.14 (lambda ((free ())) () (if #t empty empty)))
             (fun/empty8649.15 (lambda ((free ())) () empty)))
      (let ((g42218286.16
...
(check-by-interp
 '(module
    (letrec ((fun/error8653.7
              (lambda ((free (fun/error8654.8)))
                ()
                (unsafe-procedure-call fun/error8654.8)))
             (fun/error8654.8
              (lambda ((free (fun/error8655.9)))
                ()
                (unsafe-procedure-call fun/error8655.9)))
             (fun/error8655.9 (lambda ((free ())) () (error 74))))
      (unsafe-procedure-call fun/error8653.7))))
(check-by-interp
 '(module
    (letrec ((error?.68 (lambda ((free ())) (tmp.58) (error? tmp.58)))
             (fun/ascii-char8662.7 (lambda ((free ())) () (if #f #\i #\S)))
             (fun/ascii-char8658.8
              (lambda ((free (fun/ascii-char8659.9)))
                ()
                (unsafe-procedure-call fun/ascii-char8659.9)))
             (fun/ascii-char8659.9 (lambda ((free ())) () #\f))
             (fun/ascii-char8660.10
              (lambda ((free (fun/ascii-char8661.11)))
                (oprand0.12)
                (unsafe-procedure-call fun/ascii-char8661.11)))
             (fun/ascii-char8661.11 (lambda ((free ())) () #\C)))
...
(check-by-interp
 '(module
    (letrec ((error?.63 (lambda ((free ())) (tmp.53) (error? tmp.53)))
             (fun/any7325.7
              (lambda ((free ())) (oprand0.9 oprand1.8) (error 124))))
      (if (let ((g42233549.10 (let () #t)))
        ...
        (unsafe-procedure-call
         ...
         (unsafe-procedure-call
          fun/any7325.7
          #\K
          (letrec ((lam.64 (lambda ((free ())) () 713))) lam.64)))
        (if #f #f #t)))))
(check-by-interp
 '(module
    (letrec ((error?.79 (lambda ((free ())) (tmp.65) (error? tmp.65)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.78
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.54)
                  ...
                  (error 10))))
             (vector-init-loop.25
              (lambda ((free (vector-init-loop.25)))
                (len.26 i.28 vec.27)
                (if (eq? len.26 i.28)
                  vec.27
                  (begin
             ...
             (make-vector.77
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.51)
                  ...
                  (error 8))))
             (cons.76
              (lambda ((free ())) (tmp.70 tmp.71) (cons tmp.70 tmp.71)))
             (void?.75 (lambda ((free ())) (tmp.63) (void? tmp.63)))
             (fun/any8476.8 (lambda ((free ())) (oprand0.9) 169)))
      (if (unsafe-procedure-call
           void?.75
           (unsafe-procedure-call
            fun/any8476.8
            (letrec ((lam.80 (lambda ((free ())) () 1020))) lam.80)))
        (let ((procedure0.12
               (letrec ((lam.81
                         (lambda ((free (cons.76)))
                           ()
...
(check-by-interp
 '(module
    (letrec ((cons.75
              (lambda ((free ())) (tmp.66 tmp.67) (cons tmp.66 tmp.67)))
             (fixnum?.74 (lambda ((free ())) (tmp.56) (fixnum? tmp.56)))
             (error?.73 (lambda ((free ())) (tmp.61) (error? tmp.61)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.25 tmp.26 tmp.27)
...
(check-by-interp
 '(module
    (letrec ((fun/empty8484.7 (lambda ((free ())) () (if #t empty empty)))
             (fun/empty8483.8
              (lambda ((free (fun/empty8484.7)))
                ()
                (unsafe-procedure-call fun/empty8484.7))))
...
(check-by-interp
 '(module
    (letrec ((error?.111 (lambda ((free ())) (tmp.98) (error? tmp.98)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.62 tmp.63 tmp.64)
             ...
             (vector-set!.110
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.87)
                  ...
                  (error 10))))
             (vector-init-loop.58
              (lambda ((free (vector-init-loop.58)))
                (len.59 i.61 vec.60)
                (if (eq? len.59 i.61)
                  vec.60
                  (begin
             ...
             (make-vector.109
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.84)
                  ...
                  (error 8))))
             (cons.108
              (lambda ((free ())) (tmp.103 tmp.104) (cons tmp.103 tmp.104)))
             (fun/ascii-char8493.9 (lambda ((free ())) () #\d))
             (fun/void8489.10
              (lambda ((free (fun/void8490.13)))
                (oprand0.20 oprand1.19)
                (unsafe-procedure-call fun/void8490.13)))
             (fun/pair8497.11
              (lambda ((free (cons.108)))
                (oprand0.21)
                (let ((boolean0.22 #t))
                  (unsafe-procedure-call
                   cons.108
             ...
             (fun/void8495.12
              (lambda ((free (fun/void8496.15)))
                (oprand0.24 oprand1.23)
                (unsafe-procedure-call fun/void8496.15)))
             (fun/void8490.13
              (lambda ((free (fun/void8491.18)))
                ()
                (unsafe-procedure-call fun/void8491.18)))
             (fun/ascii-char8494.14 (lambda ((free ())) () #\e))
             (fun/void8496.15 (lambda ((free ())) () (void)))
             (fun/pair8498.16
              (lambda ((free (cons.108)))
                ()
                (unsafe-procedure-call
             ...
             (fun/ascii-char8492.17
              (lambda ((free (fun/ascii-char8493.9)))
                (oprand0.26 oprand1.25)
                (unsafe-procedure-call fun/ascii-char8493.9)))
             (fun/void8491.18 (lambda ((free ())) () (void))))
      (unsafe-procedure-call
       fun/void8489.10
       (if (unsafe-procedure-call
            fun/ascii-char8492.17
       ...
       (unsafe-procedure-call
        ...
        (let ((empty0.55 empty) (ascii-char1.54 #\d))
          (letrec ((lam.112 (lambda ((free ())) () 530))) lam.112)))))))
(check-by-interp
 '(module
    (letrec ((error?.65 (lambda ((free ())) (tmp.55) (error? tmp.55)))
             (fun/empty8501.7
              (lambda ((free ())) (oprand0.9 oprand1.8) empty)))
      (let ()
        (if (if #f empty empty)
          (if (let ((g42256477.10 empty))
            ...
            (unsafe-procedure-call
             fun/empty8501.7
             136
             (letrec ((lam.66 (lambda ((free ())) () 643))) lam.66))
            #f)
          #f)))))
(check-by-interp
 '(module
    (let ((void0.9 (let () (void)))
          (procedure1.8
           (letrec ((lam.62 (lambda ((free ())) () (let () #t)))) lam.62))
          (boolean2.7 (let () #f)))
      (if (if #f #\n #\v) (if #\E (if #\a #\b #f) #f) #f))))
(check-by-interp
 '(module
    (letrec ((cons.62
              (lambda ((free ())) (tmp.57 tmp.58) (cons tmp.57 tmp.58))))
      (let ((void0.7
             (let ((pair0.9
                    (unsafe-procedure-call
                     cons.62
...
(check-by-interp
 '(module
    (letrec ((fun/void8478.7 (lambda ((free ())) () (void)))
             (fun/void8477.8
              (lambda ((free (fun/void8478.7)))
                (oprand0.10)
                (unsafe-procedure-call fun/void8478.7)))
             (fun/ascii-char8479.9 (lambda ((free ())) (oprand0.11) #\F)))
      (let ()
        (unsafe-procedure-call
         fun/void8477.8
...
(check-by-interp
 '(module
    (letrec ((error?.69 (lambda ((free ())) (tmp.58) (error? tmp.58)))
             (<.68
              (lambda ((free ()))
                (tmp.36 tmp.37)
                (if (fixnum? tmp.37)
                  ...
                  (error 4))))
             (fun/error8483.7
              (lambda ((free (fun/error8484.8)))
                ()
                (unsafe-procedure-call fun/error8484.8)))
             (fun/error8484.8 (lambda ((free ())) () (error 156)))
             (fun/error8482.9
              (lambda ((free (fun/error8483.7)))
                (oprand0.10)
                (unsafe-procedure-call fun/error8483.7))))
      (unsafe-procedure-call
       fun/error8482.9
...
(check-by-interp
 '(module
    (letrec ((cons.90
              (lambda ((free ())) (tmp.82 tmp.83) (cons tmp.82 tmp.83)))
             (error?.89 (lambda ((free ())) (tmp.77) (error? tmp.77)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.41 tmp.42 tmp.43)
             ...
             (vector-set!.88
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.66)
                  ...
                  (error 10))))
             (vector-init-loop.37
              (lambda ((free (vector-init-loop.37)))
                (len.38 i.40 vec.39)
                (if (eq? len.38 i.40)
                  vec.39
                  (begin
             ...
             (make-vector.87
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.63)
                  ...
                  (error 8))))
             (fun/void8487.9
              (lambda ((free ())) (oprand0.12 oprand1.11) oprand1.11))
             (fun/void8488.10
              (lambda ((free (error?.89 make-vector.87 vector-set!.88)))
                (oprand0.13)
                (unsafe-procedure-call
                 vector-set!.88
                 oprand0.13
...
(check-by-interp
 '(module
    (letrec ((fun/empty8491.7
              (lambda ((free (fun/empty8492.8)))
                (oprand0.11 oprand1.10)
                (let () (unsafe-procedure-call fun/empty8492.8))))
             (fun/empty8492.8 (lambda ((free ())) () empty))
             (fun/error8493.9
              (lambda ((free ())) (oprand0.13 oprand1.12) (error 123))))
      (unsafe-procedure-call
       fun/empty8491.7
...
(check-by-interp
 '(module
    (letrec ((error?.142 (lambda ((free ())) (tmp.129) (error? tmp.129)))
             (vector-init-loop.89
              (lambda ((free (vector-init-loop.89)))
                (len.90 i.92 vec.91)
                (if (eq? len.90 i.92)
                  vec.91
                  (begin
             ...
             (vector-set!.140
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.118)
                  ...
                  (error 10))))
             (cons.139
              (lambda ((free ())) (tmp.134 tmp.135) (cons tmp.134 tmp.135)))
             (fun/pair8504.16
              (lambda ((free (cons.139)))
                (oprand0.26 oprand1.25)
                (unsafe-procedure-call
                 cons.139
                 175
                 (unsafe-procedure-call cons.139 296 empty))))
             (fun/void8499.17 (lambda ((free ())) (oprand0.27) (void)))
             (fun/void8501.18
              (lambda ((free (vector-set!.140)))
                (oprand0.29 oprand1.28)
                (unsafe-procedure-call vector-set!.140 oprand0.29 5 #\I)))
             (fun/void8498.19 (lambda ((free ())) () (void)))
             (fun/fixnum8502.20 (lambda ((free ())) (oprand0.30) (let () 229)))
             (fun/pair8503.21
              (lambda ((free (cons.139)))
                ()
                (unsafe-procedure-call
             ...
             (fun/void8497.22
              (lambda ((free ())) (oprand0.32 oprand1.31) (let () (void))))
             (fun/void8500.23 (lambda ((free ())) (oprand0.33) (void)))
             (fun/fixnum8496.24
              (lambda ((free ()))
                (oprand0.35 oprand1.34)
                (let () (if #t 39 232)))))
      (unsafe-procedure-call
       fun/fixnum8496.24
       (if (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.95 (lambda ((free ())) (tmp.81) (error? tmp.81)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.45 tmp.46 tmp.47)
             ...
             (vector-set!.94
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.70)
                  ...
                  (error 10))))
             (vector-init-loop.41
              (lambda ((free (vector-init-loop.41)))
                (len.42 i.44 vec.43)
                (if (eq? len.42 i.44)
                  vec.43
                  (begin
             ...
             (<.92
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.60)
                  ...
                  (error 4))))
             (cons.91
              (lambda ((free ())) (tmp.86 tmp.87) (cons tmp.86 tmp.87)))
             (fun/empty8510.8
              (lambda ((free ())) (oprand0.17 oprand1.16) empty))
             (fun/empty8513.9
              (lambda ((free (fun/empty8514.10)))
                (oprand0.18)
                (unsafe-procedure-call fun/empty8514.10)))
             (fun/empty8514.10 (lambda ((free ())) () empty))
             (fun/fixnum8507.11
              (lambda ((free (fun/fixnum8509.14 fun/fixnum8508.15)))
                (oprand0.20 oprand1.19)
                (if (if #t #t #f)
                  (unsafe-procedure-call fun/fixnum8508.15)
                  (unsafe-procedure-call fun/fixnum8509.14))))
             (fun/empty8511.12
              (lambda ((free ())) (oprand0.22 oprand1.21) empty))
             (fun/empty8512.13 (lambda ((free ())) () empty))
             (fun/fixnum8509.14 (lambda ((free ())) () 4))
             (fun/fixnum8508.15 (lambda ((free ())) () 17)))
      (unsafe-procedure-call
       fun/fixnum8507.11
       (if (if (unsafe-procedure-call
         ...
         (unsafe-procedure-call
          fun/empty8513.9
          (if #t
            (letrec ((lam.96 (lambda ((free ())) () 622))) lam.96)
            (letrec ((lam.97 (lambda ((free ())) () 523))) lam.97)))
         #f)
...
(check-by-interp
 '(module
    (letrec ((error?.76 (lambda ((free ())) (tmp.64) (error? tmp.64)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.28 tmp.29 tmp.30)
             ...
             (make-vector.74
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.50)
                  ...
                  (error 8))))
             (fun/boolean8517.8 (lambda ((free ())) (oprand0.9) #f)))
      (if (unsafe-procedure-call
           fun/boolean8517.8
           (letrec ((lam.77 (lambda ((free ())) () 918))) lam.77))
        #\L
        (let ((vector0.12
...
(check-by-interp
 '(module
    (letrec ((*.80
             ...
             (error?.78 (lambda ((free ())) (tmp.66) (error? tmp.66)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.30 tmp.31 tmp.32)
                (if (unsafe-fx< tmp.31 (unsafe-vector-length tmp.30))
             ...
             (fun/vector8521.8
              (lambda ((free ()))
                (oprand0.11 oprand1.10)
                (if #f oprand0.11 oprand0.11)))
             (fun/fixnum8520.9 (lambda ((free ())) (oprand0.12) (let () 69))))
      (unsafe-procedure-call
       *.80
       (unsafe-procedure-call
        fun/fixnum8520.9
...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8525.7
              (lambda ((free (fun/fixnum8526.9)))
                ()
                (unsafe-procedure-call fun/fixnum8526.9)))
             (fun/empty8524.8 (lambda ((free ())) () (if #f empty empty)))
             (fun/fixnum8526.9 (lambda ((free ())) () 54)))
      (let ((empty0.11 (unsafe-procedure-call fun/empty8524.8))
            (ascii-char1.10 (if #f #\P #\J)))
        (unsafe-procedure-call fun/fixnum8525.7)))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8529.7
              (lambda ((free ())) (oprand0.10 oprand1.9) (let () 49)))
             (fun/fixnum8530.8 (lambda ((free ())) () 148)))
      (if (let () #f)
        (unsafe-procedure-call
         fun/fixnum8529.7
...
(check-by-interp
 '(module
    (letrec ((error?.89 (lambda ((free ())) (tmp.77) (error? tmp.77)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.41 tmp.42 tmp.43)
                (if (unsafe-fx< tmp.42 (unsafe-vector-length tmp.41))
             ...
             (make-vector.87
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.63)
                  (unsafe-procedure-call make-init-vector.4 tmp.63)
                  (error 8))))
             (fun/void8536.9 (lambda ((free ())) () (void)))
             (fun/empty8533.10
              (lambda ((free (fun/empty8534.11)))
                (oprand0.13)
                (unsafe-procedure-call fun/empty8534.11)))
             (fun/empty8534.11 (lambda ((free ())) () (if #t empty empty)))
             (fun/ascii-char8535.12 (lambda ((free ())) () #\V)))
      (unsafe-procedure-call
       fun/empty8533.10
...
(check-by-interp
 '(module
    (letrec ((cons.221
              (lambda ((free ())) (tmp.212 tmp.213) (cons tmp.212 tmp.213)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.171 tmp.172 tmp.173)
             ...
             (vector-init-loop.167
              (lambda ((free (vector-init-loop.167)))
                (len.168 i.170 vec.169)
                (if (eq? len.168 i.170)
                  vec.169
                  (begin
             ...
             (make-vector.219
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.193)
                  ...
                  (error 8))))
             (error?.218 (lambda ((free ())) (tmp.207) (error? tmp.207)))
             (>=.217
              (lambda ((free ()))
                (tmp.191 tmp.192)
                (if (fixnum? tmp.192)
                  (if (fixnum? tmp.191)
                    ...
                    (error 7))
                  (error 7))))
             (fun/empty8542.34 (lambda ((free ())) (oprand0.43) empty))
             (fun/empty8544.35
              (lambda ((free (fun/empty8545.37)))
                ()
                (unsafe-procedure-call fun/empty8545.37)))
             (fun/empty8539.36 (lambda ((free ())) (oprand0.44) empty))
             (fun/empty8545.37 (lambda ((free ())) () empty))
             (fun/empty8547.38 (lambda ((free ())) () (let () empty)))
             (fun/void8541.39 (lambda ((free ())) () (void)))
             (fun/empty8546.40 (lambda ((free ())) (oprand0.45) empty))
             (fun/void8540.41 (lambda ((free ())) () (void)))
             (fun/empty8543.42
              (lambda ((free ())) (oprand0.47 oprand1.46) empty)))
      (let ((g42374287.48
...
(check-by-interp
 '(module
    (letrec ((error?.73 (lambda ((free ())) (tmp.62) (error? tmp.62)))
             (cons.72
              (lambda ((free ())) (tmp.67 tmp.68) (cons tmp.67 tmp.68)))
             (fun/fixnum8552.7
              (lambda ((free (fun/fixnum8553.9)))
                ()
                (unsafe-procedure-call fun/fixnum8553.9 235)))
             (fun/boolean8550.8
              (lambda ((free (fun/boolean8551.10)))
                (oprand0.12 oprand1.11)
                (unsafe-procedure-call fun/boolean8551.10)))
             (fun/fixnum8553.9 (lambda ((free ())) (oprand0.13) oprand0.13))
             (fun/boolean8551.10 (lambda ((free ())) () #f)))
      (if (unsafe-procedure-call
           fun/boolean8550.8
           (if #t #\C #\o)
           (let ((g42378163.14
...
(check-by-interp
 '(module
    (letrec ((error?.68 (lambda ((free ())) (tmp.57) (error? tmp.57)))
             (cons.67
              (lambda ((free ())) (tmp.62 tmp.63) (cons tmp.62 tmp.63)))
             (fun/fixnum8556.7
              (lambda ((free ())) (oprand0.9 oprand1.8) (if #t 71 190))))
      (if (let ((pair0.12
                 (unsafe-procedure-call
                  cons.67
                  177
...
(check-by-interp
 '(module
    (letrec ((error?.86 (lambda ((free ())) (tmp.73) (error? tmp.73)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.85
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.62)
                  ...
                  (error 10))))
             (vector-init-loop.33
              (lambda ((free (vector-init-loop.33)))
                (len.34 i.36 vec.35)
                (if (eq? len.34 i.36)
                  vec.35
                  (begin
             ...
             (make-vector.84
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.59)
                  ...
                  (error 8))))
             (cons.83
              (lambda ((free ())) (tmp.78 tmp.79) (cons tmp.78 tmp.79)))
             (fun/pair8560.12
              (lambda ((free (cons.83)))
                (oprand0.14)
                (unsafe-procedure-call
             ...
             (fun/procedure8559.13
              (lambda ((free ()))
                ()
                (letrec ((lam.95 (lambda ((free ())) () 550))) lam.95))))
      (let ((vector0.15
...
(check-by-interp
 '(module
    (letrec ((ascii-char?.102
              (lambda ((free ())) (tmp.88) (ascii-char? tmp.88)))
             (error?.101 (lambda ((free ())) (tmp.89) (error? tmp.89)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.53 tmp.54 tmp.55)
             ...
             (vector-set!.100
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.78)
                  ...
                  (error 10))))
             (vector-init-loop.49
              (lambda ((free (vector-init-loop.49)))
                (len.50 i.52 vec.51)
                (if (eq? len.50 i.52)
                  vec.51
                  (begin
             ...
             (make-vector.99
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.75)
                  ...
                  (error 8))))
             (fun/error7326.14
              (lambda ((free ())) () (if #f (error 41) (error 41))))
             (fun/any7325.15
              (lambda ((free (vector-set!.100 error?.101 make-vector.99)))
                ()
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42409233.25
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  tmp.7.17)))))))))))))))))))
             (fun/error7327.16
              (lambda ((free ())) (oprand0.27 oprand1.26) (error 150))))
      (if (unsafe-procedure-call
           ascii-char?.102
...
(check-by-interp
 '(module
    (letrec ((error?.72 (lambda ((free ())) (tmp.62) (error? tmp.62)))
             (fun/ascii-char8478.10 (lambda ((free ())) () (if #t #\t #\O))))
...
(check-by-interp
 '(module
    (letrec ((ascii-char?.60
              (lambda ((free ())) (tmp.49) (ascii-char? tmp.49))))
      (let ((boolean0.7
             (unsafe-procedure-call ascii-char?.60 (if #f #\l 229))))
        (let () (void))))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8485.13 (lambda ((free ())) (oprand0.16) oprand0.16))
             (fun/boolean8483.14
              (lambda ((free ())) (oprand0.18 oprand1.17) (let () #t)))
             (fun/fixnum8484.15
              (lambda ((free (fun/fixnum8485.13)))
                ()
                (unsafe-procedure-call fun/fixnum8485.13 41))))
      (if (unsafe-procedure-call
           fun/boolean8483.14
           (if #t (void) (void))
           (let ((tmp.7.19
                  (letrec ((lam.77 (lambda ((free ())) () 845))) lam.77)))
             (if tmp.7.19
               tmp.7.19
               (let ((tmp.8.20
                      (letrec ((lam.78 (lambda ((free ())) () 630))) lam.78)))
                 (if tmp.8.20
                   tmp.8.20
                   (let ((tmp.9.21
                          (letrec ((lam.79 (lambda ((free ())) () 689)))
                            lam.79)))
                     (if tmp.9.21
                       tmp.9.21
                       (let ((tmp.10.22
                              (letrec ((lam.80 (lambda ((free ())) () 943)))
                                lam.80)))
                         (if tmp.10.22
                           tmp.10.22
                           (let ((tmp.11.23
...
(check-by-interp
 '(module
    (letrec ((empty?.77 (lambda ((free ())) (tmp.60) (empty? tmp.60)))
             (error?.76 (lambda ((free ())) (tmp.63) (error? tmp.63)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.27 tmp.28 tmp.29)
             ...
             (vector-set!.75
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.52)
                  ...
                  (error 10))))
             (vector-init-loop.23
              (lambda ((free (vector-init-loop.23)))
                (len.24 i.26 vec.25)
                (if (eq? len.24 i.26)
                  vec.25
                  (begin
             ...
             (make-vector.74
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.49)
                  ...
                  (error 8))))
             (cons.73
              (lambda ((free ())) (tmp.68 tmp.69) (cons tmp.68 tmp.69)))
             (fun/pair8489.8
              (lambda ((free (cons.73)))
                ()
                (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.64 (lambda ((free ())) (tmp.54) (error? tmp.54))))
      (let ((g42428345.7
...
(check-by-interp
 '(module
    (letrec ((fun/empty8494.7
             ...
             (fun/fixnum8498.8 (lambda ((free ())) () 65))
             (fun/procedure8496.9
              (lambda ((free (fun/procedure8497.10)))
                (oprand0.12)
                (unsafe-procedure-call fun/procedure8497.10)))
             (fun/procedure8497.10
              (lambda ((free ()))
                ()
                (letrec ((lam.66 (lambda ((free ())) () 609))) lam.66)))
             (fun/empty8495.11
              (lambda ((free ())) (oprand0.13) (let () empty))))
      (unsafe-procedure-call fun/empty8494.7))))
(check-by-interp
 '(module
    (letrec ((fun/error8502.7
              (lambda ((free (fun/error8503.9)))
                ()
                (unsafe-procedure-call fun/error8503.9)))
             (fun/error8501.8
              (lambda ((free (fun/error8502.7)))
                (oprand0.11)
                (unsafe-procedure-call fun/error8502.7)))
             (fun/error8503.9 (lambda ((free ())) () (error 198)))
             (fun/ascii-char8504.10
              (lambda ((free ())) () (let ((fixnum0.12 151)) #\v))))
      (unsafe-procedure-call
       fun/error8501.8
       (unsafe-procedure-call fun/ascii-char8504.10)))))
(check-by-interp
 '(module
    (letrec ((error?.86 (lambda ((free ())) (tmp.74) (error? tmp.74)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.85
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.63)
                  ...
                  (error 10))))
             (vector-init-loop.34
              (lambda ((free (vector-init-loop.34)))
                (len.35 i.37 vec.36)
                (if (eq? len.35 i.37)
                  vec.36
                  (begin
             ...
             (make-vector.84
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.60)
                  ...
                  (error 8))))
             (fun/fixnum8511.8 (lambda ((free ())) () 138))
             (fun/fixnum8507.9
              (lambda ((free (fun/fixnum8508.10)))
                (oprand0.14 oprand1.13)
                (unsafe-procedure-call fun/fixnum8508.10)))
             (fun/fixnum8508.10
              (lambda ((free (fun/fixnum8509.11)))
                ()
                (unsafe-procedure-call fun/fixnum8509.11)))
             (fun/fixnum8509.11 (lambda ((free ())) () 2))
             (fun/boolean8510.12
              (lambda ((free ())) (oprand0.16 oprand1.15) #t)))
      (unsafe-procedure-call
       fun/fixnum8507.9
       (if (unsafe-procedure-call
            fun/boolean8510.12
    ...
    (letrec ((<=.63
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.34)
                  ...
                  (error 5))))
             (fun/empty8515.7 (lambda ((free ())) () empty))
             (fun/empty8514.8
              (lambda ((free (fun/empty8515.7)))
                ()
                (unsafe-procedure-call fun/empty8515.7))))
      (let ((boolean0.9
             (unsafe-procedure-call
              <=.63
              (let () 15)
...
(check-by-interp
 '(module
    (letrec ((error?.104 (lambda ((free ())) (tmp.91) (error? tmp.91)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.103
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.80)
                  ...
                  (error 10))))
             (vector-init-loop.51
              (lambda ((free (vector-init-loop.51)))
                (len.52 i.54 vec.53)
                (if (eq? len.52 i.54)
                  vec.53
                  (begin
             ...
             (make-vector.102
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.77)
                  ...
                  (error 8))))
             (cons.101
              (lambda ((free ())) (tmp.96 tmp.97) (cons tmp.96 tmp.97)))
             (fun/ascii-char8518.9 (lambda ((free ())) () #\C))
             (fun/ascii-char8520.10
              (lambda ((free ())) (oprand0.15) oprand0.15))
             (fun/fixnum8523.11 (lambda ((free ())) (oprand0.16) 219))
             (fun/ascii-char8522.12 (lambda ((free ())) (oprand0.17) #\]))
             (fun/ascii-char8521.13
              (lambda ((free (fun/fixnum8523.11 fun/ascii-char8522.12)))
                ()
                (unsafe-procedure-call
             ...
             (fun/ascii-char8519.14
              (lambda ((free ()))
                (oprand0.19 oprand1.18)
                (if #t oprand0.19 oprand0.19))))
 ...
 '(module
    (letrec ((cons.71
             ...
             (fun/ascii-char8527.7
              (lambda ((free (fun/ascii-char8528.8)))
                ()
                (unsafe-procedure-call fun/ascii-char8528.8)))
             ...
             (fun/ascii-char8526.9
              (lambda ((free ()))
                (oprand0.15 oprand1.14)
                (let () (let () oprand0.15))))
             (fun/void8530.10
              (lambda ((free (fun/void8531.11)))
                (oprand0.16)
                (unsafe-procedure-call fun/void8531.11)))
             (fun/void8531.11 (lambda ((free ())) () (void)))
             (fun/void8529.12
              (lambda ((free (fun/void8530.10)))
                ()
                (unsafe-procedure-call
                 fun/void8530.10
...
(check-by-interp
 '(module
    (letrec ((procedure?.136
              (lambda ((free ())) (tmp.126) (procedure? tmp.126)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.86 tmp.87 tmp.88)
             ...
             (vector-set!.135
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.111)
                  ...
                  (error 10))))
             (vector-init-loop.82
              (lambda ((free (vector-init-loop.82)))
                (len.83 i.85 vec.84)
                (if (eq? len.83 i.85)
                  vec.84
                  (begin
             ...
             (make-vector.134
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.108)
                  ...
                  (error 8))))
             (cons.133
              (lambda ((free ())) (tmp.127 tmp.128) (cons tmp.127 tmp.128)))
             (error?.132 (lambda ((free ())) (tmp.122) (error? tmp.122)))
             (fun/ascii-char8545.12
              (lambda ((free (fun/ascii-char8546.21)))
                ()
                (unsafe-procedure-call fun/ascii-char8546.21)))
             (fun/ascii-char8542.13
              (lambda ((free (fun/ascii-char8543.20)))
                (oprand0.28 oprand1.27)
                (unsafe-procedure-call fun/ascii-char8543.20)))
             (fun/ascii-char8536.14 (lambda ((free ())) () #\b))
             (fun/ascii-char8539.15
              (lambda ((free ())) (oprand0.30 oprand1.29) (let () #\l)))
             (fun/ascii-char8535.16
              (lambda ((free (fun/ascii-char8536.14)))
                ()
                (unsafe-procedure-call fun/ascii-char8536.14)))
             (fun/boolean8540.17
              (lambda ((free ())) (oprand0.32 oprand1.31) (let () #f)))
             (fun/void8537.18 (lambda ((free ())) () (void)))
             (fun/ascii-char8538.19 (lambda ((free ())) () #\J))
             (fun/ascii-char8543.20 (lambda ((free ())) () #\x))
             (fun/ascii-char8546.21 (lambda ((free ())) () #\O))
             (fun/boolean8548.22 (lambda ((free ())) () #t))
             (fun/boolean8547.23
              (lambda ((free (fun/boolean8548.22)))
                ()
                (unsafe-procedure-call fun/boolean8548.22)))
             (fun/fixnum8541.24 (lambda ((free ())) () 67))
             (fun/ascii-char8544.25
              (lambda ((free (fun/ascii-char8545.12)))
                (oprand0.34 oprand1.33)
                (unsafe-procedure-call fun/ascii-char8545.12)))
             (fun/ascii-char8534.26
              (lambda ((free (fun/ascii-char8535.16)))
                (oprand0.36 oprand1.35)
                (unsafe-procedure-call fun/ascii-char8535.16))))
      (let ((g42455084.37
             (unsafe-procedure-call
              fun/ascii-char8534.26
              (if #f
                (letrec ((lam.143 (lambda ((free ())) () 968))) lam.143)
                (letrec ((lam.144 (lambda ((free ())) () 631))) lam.144))
              (let () empty))))
...
(check-by-interp
 '(module
    (letrec ((fun/empty8551.7
              (lambda ((free (fun/empty8552.8)))
                ()
                (unsafe-procedure-call fun/empty8552.8)))
             (fun/empty8552.8 (lambda ((free ())) () empty)))
      (let ((procedure0.9
             (letrec ((lam.64
                       (lambda ((free (fun/empty8551.7)))
                         (oprand0.11 oprand1.10)
...
(check-by-interp
 '(module
    (letrec ((error?.91 (lambda ((free ())) (tmp.79) (error? tmp.79)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.90
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.68)
                  ...
                  (error 10))))
             (vector-init-loop.39
              (lambda ((free (vector-init-loop.39)))
                (len.40 i.42 vec.41)
                (if (eq? len.40 i.42)
                  vec.41
                  (begin
             ...
             (make-vector.89
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.65)
                  ...
                  (error 8))))
             (fun/empty8561.9 (lambda ((free ())) (oprand0.13) empty))
             (fun/error8560.10
              (lambda ((free ()))
                (oprand0.15 oprand1.14)
             ...
             (fun/empty8562.11
              (lambda ((free ())) (oprand0.17 oprand1.16) empty))
             (fun/boolean8563.12 (lambda ((free ())) (oprand0.18) #f)))
      (unsafe-procedure-call
       fun/error8560.10
       (if (if #f #f #f)
                                      ...
                                      (if (unsafe-procedure-call
                                        ...
                                        (let ((g42462747.27
                                          ...
                                          (if (unsafe-procedure-call
                                            ...
                                            g42462747.27
                                            tmp.7.19)))))))))))))))))
          (letrec ((lam.92 (lambda ((free ())) () 807))) lam.92)))
       (if (unsafe-procedure-call
            fun/boolean8563.12
...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8572.7
              (lambda ((free (fun/fixnum8573.9)))
                ()
                (unsafe-procedure-call fun/fixnum8573.9)))
             (fun/fixnum8575.8 (lambda ((free ())) () 182))
             (fun/fixnum8573.9 (lambda ((free ())) () 219))
             (fun/fixnum8574.10
              (lambda ((free (fun/fixnum8575.8)))
                ()
                (unsafe-procedure-call fun/fixnum8575.8))))
...
(check-by-interp
 '(module
    (letrec ((error?.71 (lambda ((free ())) (tmp.61) (error? tmp.61)))
             (fun/empty8585.7
              (lambda ((free (fun/empty8586.9)))
                ()
                (unsafe-procedure-call fun/empty8586.9)))
             (fun/empty8584.8
              (lambda ((free (fun/empty8585.7)))
                (oprand0.10)
                (unsafe-procedure-call fun/empty8585.7)))
             (fun/empty8586.9 (lambda ((free ())) () empty)))
      (unsafe-procedure-call
       fun/empty8584.8
       (let ((error0.12
...
(check-by-interp
 '(module
    (letrec ((error?.114 (lambda ((free ())) (tmp.101) (error? tmp.101)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.65 tmp.66 tmp.67)
             ...
             (vector-set!.113
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.90)
                  ...
                  (error 10))))
             (vector-init-loop.61
              (lambda ((free (vector-init-loop.61)))
                (len.62 i.64 vec.63)
                (if (eq? len.62 i.64)
                  vec.63
                  (begin
             ...
             (make-vector.112
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.87)
                  ...
                  (error 8))))
             (cons.111
              (lambda ((free ())) (tmp.106 tmp.107) (cons tmp.106 tmp.107)))
             (fun/error8591.11 (lambda ((free ())) () (error 47)))
             (fun/pair8592.12
              (lambda ((free (cons.111)))
                (oprand0.15)
                (if #f
                  (unsafe-procedure-call
                   cons.111
             ...
             (fun/error8589.13
              (lambda ((free (fun/error8590.14)))
                (oprand0.17 oprand1.16)
                (unsafe-procedure-call fun/error8590.14)))
             (fun/error8590.14
              (lambda ((free (fun/error8591.11)))
                ()
                (unsafe-procedure-call fun/error8591.11))))
      (unsafe-procedure-call
       fun/error8589.13
       (unsafe-procedure-call
        fun/pair8592.12
...
(check-by-interp
 '(module
    (letrec ((error?.81 (lambda ((free ())) (tmp.68) (error? tmp.68)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.32 tmp.33 tmp.34)
             ...
             (vector-set!.80
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.57)
                  ...
                  (error 10))))
             (vector-init-loop.28
              (lambda ((free (vector-init-loop.28)))
                (len.29 i.31 vec.30)
                (if (eq? len.29 i.31)
                  vec.30
                  (begin
             ...
             (make-vector.79
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.54)
                  ...
                  (error 8))))
             (cons.78
              (lambda ((free ())) (tmp.73 tmp.74) (cons tmp.73 tmp.74)))
             (fun/empty8599.8
              (lambda ((free (fun/empty8601.10 fun/empty8600.9)))
                (oprand0.11)
                (if (let () #f)
                  (unsafe-procedure-call fun/empty8600.9)
                  (unsafe-procedure-call fun/empty8601.10))))
             (fun/empty8600.9 (lambda ((free ())) () empty))
             (fun/empty8601.10 (lambda ((free ())) () empty)))
      (unsafe-procedure-call
       fun/empty8599.8
       (if (if #t #t #f)
         (let ((boolean0.14 #f)
...
(check-by-interp
 '(module
    (letrec ((cons.77
              (lambda ((free ())) (tmp.72 tmp.73) (cons tmp.72 tmp.73)))
             (fun/boolean8604.10
              (lambda ((free (fun/boolean8605.12)))
                ()
                (unsafe-procedure-call fun/boolean8605.12 #f)))
             (fun/ascii-char8607.11
              (lambda ((free ())) (oprand0.15 oprand1.14) #\J))
             (fun/boolean8605.12 (lambda ((free ())) (oprand0.16) oprand0.16))
             (fun/ascii-char8606.13
              (lambda ((free ())) (oprand0.18 oprand1.17) #\d)))
...
(check-by-interp
 '(module
    (letrec ((fun/boolean8612.7 (lambda ((free ())) (oprand0.10) #f))
             (fun/boolean8611.8
              (lambda ((free (fun/boolean8612.7)))
                ()
                (unsafe-procedure-call fun/boolean8612.7 empty)))
             (fun/boolean8610.9 (lambda ((free ())) () (if #f #t #f))))
      (if (unsafe-procedure-call fun/boolean8610.9)
        (unsafe-procedure-call fun/boolean8611.8)
        (if #t #t #t)))))
(check-by-interp
 '(module
    (letrec ((void?.77 (lambda ((free ())) (tmp.64) (void? tmp.64)))
             (cons.76
              (lambda ((free ())) (tmp.71 tmp.72) (cons tmp.71 tmp.72)))
             (fun/boolean8615.10
              (lambda ((free ())) (oprand0.17 oprand1.16) oprand0.17))
             (fun/boolean8620.11 (lambda ((free ())) () #t))
             (fun/pair8619.12
              (lambda ((free (cons.76)))
                ()
                (unsafe-procedure-call
             ...
             (fun/boolean8617.13
              (lambda ((free (fun/boolean8618.14)))
                (oprand0.19 oprand1.18)
                (unsafe-procedure-call fun/boolean8618.14)))
             (fun/boolean8618.14 (lambda ((free ())) () #f))
             (fun/any8616.15 (lambda ((free ())) (oprand0.20) #f)))
      (let ((tmp.7.21
             (unsafe-procedure-call
              fun/boolean8615.10
              (let () #t)
        ...
        (if tmp.7.21
          ...
          (let ((tmp.8.22
                 (unsafe-procedure-call
                  ...
                  (unsafe-procedure-call
                   fun/any8616.15
                   (letrec ((lam.78 (lambda ((free ())) () 764))) lam.78)))))
            (if tmp.8.22
              tmp.8.22
              (let ((tmp.9.23
                     (unsafe-procedure-call
    ...
    (letrec ((|-.212|
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.175)
                  ...
                  (error 3))))
             (cons.211
              (lambda ((free ())) (tmp.203 tmp.204) (cons tmp.203 tmp.204)))
             (error?.210 (lambda ((free ())) (tmp.198) (error? tmp.198)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.162 tmp.163 tmp.164)
             ...
             (vector-init-loop.158
              (lambda ((free (vector-init-loop.158)))
                (len.159 i.161 vec.160)
                (if (eq? len.159 i.161)
                  vec.160
                  (begin
             ...
             (make-vector.208
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.184)
                  ...
                  (error 8))))
             (fun/fixnum8628.37
              (lambda ((free ())) (oprand0.44 oprand1.43) 40))
             (fun/fixnum8625.38
              (lambda ((free ())) (oprand0.46 oprand1.45) 150))
             (fun/boolean8624.39 (lambda ((free ())) () #f))
             (fun/fixnum8623.40
              (lambda ((free (fun/boolean8624.39)))
                (oprand0.48 oprand1.47)
                (if (unsafe-procedure-call fun/boolean8624.39)
                  oprand1.47
                  oprand1.47)))
             (fun/fixnum8626.41 (lambda ((free ())) () 248))
             (fun/fixnum8627.42 (lambda ((free ())) () 9)))
      (unsafe-procedure-call
       fun/fixnum8623.40
             ...
             (if tmp.7.49
               ...
               (let ((tmp.8.50
                      (let ((boolean0.53 #f)
                            (ascii-char1.52 #\K)
                            (procedure2.51
                             (letrec ((lam.213 (lambda ((free ())) () 176)))
                               lam.213)))
                        (error 222))))
                 (if tmp.8.50
                   tmp.8.50
...
(check-by-interp
 '(module
    (letrec ((<=.78
             ...
             (cons.76
              (lambda ((free ())) (tmp.71 tmp.72) (cons tmp.71 tmp.72)))
             (fun/boolean8631.11 (lambda ((free ())) (oprand0.17) #t))
             (fun/pair8635.12
              (lambda ((free (cons.76)))
                (oprand0.18)
                (unsafe-procedure-call
             ...
             (fun/fixnum8634.13 (lambda ((free ())) () 33))
             (fun/fixnum8636.14 (lambda ((free ())) () (if #f 72 52)))
             (fun/boolean8632.15 (lambda ((free ())) () #t))
             (fun/fixnum8633.16
              (lambda ((free (fun/fixnum8634.13)))
                (oprand0.19)
                (unsafe-procedure-call fun/fixnum8634.13))))
...
(check-by-interp
 '(module
    (letrec ((fun/void8639.17
              (lambda ((free ())) (oprand0.19) (if #t (void) (void))))
             (fun/void8640.18
              (lambda ((free ())) (oprand0.21 oprand1.20) (void))))
      (if (if #f #t #t)
...
(check-by-interp
 '(module
    (letrec ((ascii-char?.64
              (lambda ((free ())) (tmp.52) (ascii-char? tmp.52)))
             (vector-init-loop.13
              (lambda ((free (vector-init-loop.13)))
                (len.14 i.16 vec.15)
                (if (eq? len.14 i.16)
                  vec.15
                  (begin
             ...
             (make-vector.63
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.39)
                  ...
                  (error 8))))
             (fun/empty8643.7
              (lambda ((free ())) (oprand0.9 oprand1.8) oprand0.9)))
      (unsafe-procedure-call
       fun/empty8643.7
       (if #t empty empty)
       (unsafe-procedure-call
             ...
             (|+.112|
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.76)
                  ...
                  (error 2))))
             (error?.111 (lambda ((free ())) (tmp.101) (error? tmp.101)))
             (fun/fixnum8646.17 (lambda ((free ())) (oprand0.21) 187))
             (fun/fixnum8647.18 (lambda ((free ())) () 188))
             (fun/fixnum8648.19
              (lambda ((free ())) (oprand0.23 oprand1.22) oprand1.22))
             (fun/fixnum8649.20
              (lambda ((free ())) (oprand0.25 oprand1.24) 114)))
      (unsafe-procedure-call
       >.117
         ...
         (if (let ((procedure0.27
           ...
           (if (let ((tmp.7.30 (let () 226)))
             ...
             (if (let ((boolean0.55 #t)
                       ...
                       (procedure2.53
                        (letrec ((lam.119 (lambda ((free ())) () 174)))
                          lam.119)))
                   130)
               (if (if (if #t 35 220)
                     (if (if #t 36 135)
             ...
             (make-vector.141
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.115)
                  (unsafe-procedure-call make-init-vector.4 tmp.115)
                  (error 8))))
             (error?.140 (lambda ((free ())) (tmp.129) (error? tmp.129)))
             (cons.139
              (lambda ((free ())) (tmp.134 tmp.135) (cons tmp.134 tmp.135)))
             (fun/void8652.10
              (lambda ((free ())) (oprand0.16 oprand1.15) (void)))
             (fun/void8656.11
              (lambda ((free ()))
                (oprand0.18 oprand1.17)
                (if #t (void) (void))))
             (fun/void8655.12 (lambda ((free ())) () (void)))
             (fun/void8654.13
              (lambda ((free ()))
                (oprand0.19)
                (let ((empty0.20 empty)) (void))))
             (fun/void8653.14
              (lambda ((free ())) (oprand0.22 oprand1.21) (let () (void)))))
      (let ((g42519968.23
...
(check-by-interp
 '(module
    (letrec ((error?.64 (lambda ((free ())) (tmp.54) (error? tmp.54)))
             (fun/void8659.7 (lambda ((free ())) (oprand0.8) (void))))
...
(check-by-interp
 '(module
    (letrec ((cons.74
              (lambda ((free ())) (tmp.67 tmp.68) (cons tmp.67 tmp.68)))
             (error?.73 (lambda ((free ())) (tmp.62) (error? tmp.62)))
             (vector-init-loop.22
...
(check-by-interp
 '(module
    (letrec ((error?.88 (lambda ((free ())) (tmp.76) (error? tmp.76)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.87
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.65)
                  ...
                  (error 10))))
             (vector-init-loop.36
              (lambda ((free (vector-init-loop.36)))
                (len.37 i.39 vec.38)
                (if (eq? len.37 i.39)
                  vec.38
                  (begin
...
(check-by-interp
 '(module
    (letrec ((error?.100 (lambda ((free ())) (tmp.87) (error? tmp.87)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.51 tmp.52 tmp.53)
             ...
             (vector-set!.99
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.76)
                  ...
                  (error 10))))
             (vector-init-loop.47
              (lambda ((free (vector-init-loop.47)))
                (len.48 i.50 vec.49)
                (if (eq? len.48 i.50)
                  vec.49
                  (begin
             ...
             (make-vector.98
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.73)
                  ...
                  (error 8))))
             (cons.97
              (lambda ((free ())) (tmp.92 tmp.93) (cons tmp.92 tmp.93)))
             (fun/fixnum8668.10 (lambda ((free ())) () 84))
             (fun/pair8669.11
              (lambda ((free (cons.97)))
                ()
                (unsafe-procedure-call
             ...
             (fun/fixnum8670.12 (lambda ((free ())) () 116)))
      (let ((vector0.14
            ...
            (empty1.13 (let () empty)))
        (let ((procedure0.44
               (letrec ((lam.109 (lambda ((free ())) () empty))) lam.109)))
          (void))))))
(check-by-interp
 '(module
    (letrec ((fun/error8673.7
              (lambda ((free (fun/error8674.8)))
                ()
                (unsafe-procedure-call fun/error8674.8)))
             (fun/error8674.8 (lambda ((free ())) () (error 213)))
             (fun/error8675.9
              (lambda ((free (fun/error8676.10)))
                ()
                (unsafe-procedure-call fun/error8676.10)))
             (fun/error8676.10 (lambda ((free ())) () (error 24))))
      (let ((fixnum0.13 (let () 133))
            (error1.12 (unsafe-procedure-call fun/error8673.7))
            (procedure2.11
             (letrec ((lam.66
                       (lambda ((free (fun/error8675.9)))
                         ()
                         (unsafe-procedure-call fun/error8675.9))))
               lam.66)))
        (if #t 142 249)))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    (letrec ((error?.92 (lambda ((free ())) (tmp.80) (error? tmp.80)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.44 tmp.45 tmp.46)
             ...
             (vector-set!.91
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.69)
                  ...
                  (error 10))))
             (vector-init-loop.40
              (lambda ((free (vector-init-loop.40)))
                (len.41 i.43 vec.42)
                (if (eq? len.41 i.43)
                  vec.42
                  (begin
             ...
             (make-vector.90
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.66)
                  ...
                  (error 8))))
             (fun/boolean8687.9 (lambda ((free ())) () #f))
             (fun/boolean8686.10
              (lambda ((free (fun/boolean8687.9)))
                (oprand0.16)
                (unsafe-procedure-call fun/boolean8687.9)))
             (fun/boolean8685.11 (lambda ((free ())) () #f))
             (fun/void8681.12
              (lambda ((free (fun/void8682.14)))
                (oprand0.17)
                (unsafe-procedure-call fun/void8682.14)))
             (fun/boolean8684.13
              (lambda ((free (fun/boolean8685.11)))
                ()
                (unsafe-procedure-call fun/boolean8685.11)))
             (fun/void8682.14 (lambda ((free ())) () (if #f (void) (void))))
             (fun/boolean8683.15
              (lambda ((free (fun/boolean8684.13)))
                (oprand0.19 oprand1.18)
      ...
      (unsafe-procedure-call
       ...
       (unsafe-procedure-call
        ...
        (unsafe-procedure-call
         fun/boolean8686.10
         (if #t
           (letrec ((lam.93 (lambda ((free ())) () 628))) lam.93)
           (letrec ((lam.94 (lambda ((free ())) () 577))) lam.94))))))))
(check-by-interp
 '(module
    (letrec ((error?.69 (lambda ((free ())) (tmp.59) (error? tmp.59)))
             (fun/error8693.7 (lambda ((free ())) (oprand0.11) (error 130)))
             (fun/boolean8690.8 (lambda ((free ())) () (if #f #f #f)))
             (fun/empty8691.9
              (lambda ((free (fun/empty8692.10)))
                (oprand0.13 oprand1.12)
                (unsafe-procedure-call fun/empty8692.10)))
             (fun/empty8692.10 (lambda ((free ())) () empty)))
...
(check-by-interp
 '(module
    (letrec ((cons.98
              (lambda ((free ())) (tmp.89 tmp.90) (cons tmp.89 tmp.90)))
             (void?.97 (lambda ((free ())) (tmp.82) (void? tmp.82)))
             (error?.96 (lambda ((free ())) (tmp.84) (error? tmp.84)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.48 tmp.49 tmp.50)
             ...
             (vector-set!.95
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.73)
                  ...
                  (error 10))))
             (vector-init-loop.44
              (lambda ((free (vector-init-loop.44)))
                (len.45 i.47 vec.46)
                (if (eq? len.45 i.47)
                  vec.46
                  (begin
             ...
             (make-vector.94
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.70)
                  ...
                  (error 8))))
             (fun/empty8699.15 (lambda ((free ())) () empty))
             (fun/empty8698.16 (lambda ((free ())) () empty))
             (fun/ascii-char8697.17 (lambda ((free ())) () #\Y))
             (fun/procedure8696.18
              (lambda ((free ()))
                ()
                (letrec ((lam.107 (lambda ((free ())) () 758))) lam.107))))
      (let ((vector0.21
...
(check-by-interp
 '(module
    (letrec ((fun/error8703.7 (lambda ((free ())) () (error 178)))
             (fun/error8702.8
              (lambda ((free (fun/error8703.7)))
                (oprand0.9)
                (unsafe-procedure-call fun/error8703.7))))
      (let ()
        (unsafe-procedure-call
         fun/error8702.8
         (if #t
           (letrec ((lam.62 (lambda ((free ())) () 781))) lam.62)
           (letrec ((lam.63 (lambda ((free ())) () 718))) lam.63)))))))
(check-by-interp
 '(module
    (letrec ((error?.77 (lambda ((free ())) (tmp.67) (error? tmp.67)))
             (fun/ascii-char8706.13 (lambda ((free ())) () #\D)))
...
(check-by-interp
 '(module
    (letrec ((fun/void8714.7
              (lambda ((free ())) () (let ((void0.9 (void))) (void))))
             (fun/void8713.8
              (lambda ((free (fun/void8714.7)))
                ()
                (unsafe-procedure-call fun/void8714.7))))
