#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../undead-analysis.rkt")
...
(check-by-interp
 '(module
    ((new-frames (())) (locals (tmp.56 tmp.63 tmp.55 tmp-ra.59)))
    (define L.+.6
      ((new-frames ())
       (locals
        (tmp.53
...
(check-by-interp
 '(module
    ((new-frames (())) (locals (tmp.56 tmp-ra.59)))
    (define L.*.6
      ((new-frames ())
       (locals
        (tmp.53
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (empty1.1 empty0.2 tmp-ra.52)))
    (begin
      (set! tmp-ra.52 r15)
      (set! empty0.2 22)
      (set! empty1.1 22)
...
(check-by-interp
 '(module
    ...
    (define L.fun/error8463.4
      ((new-frames ()) (locals (oprand1.1 oprand0.2 tmp-ra.62)))
      (begin
        (set! tmp-ra.62 r15)
        (set! oprand0.2 rdi)
        (set! oprand1.1 rsi)
...
(check-by-interp
 '(module
    ((new-frames (())) (locals (tmp-ra.63 tmp.59)))
    (define L.*.7
      ((new-frames ())
       (locals
        (tmp.56
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (tmp-ra.62 empty2.3 error1.4 void0.5 tmp.67)))
    (define L.*.6
      ((new-frames ())
       (locals
        (tmp.57
...
(check-by-interp
 '(module
    ((new-frames (() () ())) (locals (fixnum2.1 void1.2 boolean0.3 tmp-ra.62)))
    (define L.+.8
      ((new-frames ())
       (locals
        (tmp.55
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.58 rbp rax)))))
    (define L.pair?.7
      ((new-frames ()) (locals (tmp-ra.59 tmp.66 tmp.46 tmp.57)))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    (define L.+.7
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.58 rbp rax)))))
    (define L.error?.6
      ((new-frames ()) (locals (tmp-ra.59 tmp.65 tmp.45 tmp.57)))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.45 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ...
    (define L.fun/void10119.4
      ((new-frames ()) (locals (oprand2.1 oprand1.2 oprand0.3 tmp-ra.97)))
      (begin
        (set! tmp-ra.97 r15)
        (set! oprand0.3 rdi)
        (set! oprand1.2 rsi)
    ...
    (define L.fun/fixnum10117.5
      ((new-frames ()) (locals (oprand2.4 oprand1.5 oprand0.6 tmp-ra.98)))
      (begin
        (set! tmp-ra.98 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
    ...
    (define L.fun/fixnum10118.6
      ((new-frames ()) (locals (oprand2.7 oprand1.8 oprand0.9 tmp-ra.99)))
      (begin
        (set! tmp-ra.99 r15)
        (set! oprand0.9 rdi)
        (set! oprand1.8 rsi)
    ...
    ((new-frames (() () () () () ()))
     (locals
      (ascii-char4.1
       ...
       tmp-ra.64)))
    (define L.boolean?.11
      ((new-frames ()) (locals (tmp-ra.57 tmp.65 tmp.43 tmp.55)))
      (begin
        (set! tmp-ra.57 r15)
        (set! tmp.43 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ...
    (define L.ascii-char?.9
      ((new-frames ()) (locals (tmp-ra.79 tmp.95 tmp.46 tmp.68)))
      (begin
        (set! tmp-ra.79 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () () () () () () () ()))
     (locals
      (error4.1
       ...
       tmp-ra.82)))
    (define L.vector?.12
      ((new-frames ()) (locals (tmp-ra.74 tmp.83 tmp.49 tmp.55)))
      (begin
        (set! tmp-ra.74 r15)
        (set! tmp.49 rdi)
        (if (begin
    ...
    (define L.*.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.76 rbp rax)))))
    (define L.empty?.9
      ((new-frames ()) (locals (tmp-ra.77 tmp.91 tmp.44 tmp.65)))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.44 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () () () () () () () ()))
     (locals
      (boolean4.1
       ...
       tmp-ra.83)))
    (define L.boolean?.13
      ((new-frames ()) (locals (tmp-ra.74 tmp.84 tmp.43 tmp.55)))
      (begin
        (set! tmp-ra.74 r15)
        (set! tmp.43 rdi)
        (if (begin
    ...
    (define L.-.11
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 830) (jump tmp-ra.76 rbp rax)))))
    (define L.fixnum?.10
      ((new-frames ()) (locals (tmp-ra.77 tmp.92 tmp.42 tmp.65)))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.42 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ...
    (define L.ascii-char?.11
      ((new-frames ()) (locals (tmp-ra.59 tmp.67 tmp.46 tmp.55)))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.46 rdi)
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.59 rbp rax)))))
    (define L.void?.10
      ((new-frames ()) (locals (tmp-ra.60 tmp.68 tmp.45 tmp.56)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.45 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () () () () () () () ()))
     (locals
      (tmp.76
       ...
       tmp-ra.86)))
    (define L.empty?.13
      ((new-frames ()) (locals (tmp-ra.77 tmp.87 tmp.44 tmp.55)))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.44 rdi)
        (if (begin
    ...
    (define L.+.9
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.84 rbp rax)))))
    (define L.empty?.8
      ((new-frames ()) (locals (tmp-ra.85 tmp.100 tmp.44 tmp.68)))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.44 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ()))
     (locals
      (empty5.1
       ...
       tmp-ra.74)))
    (define L.empty?.18
      ((new-frames ()) (locals (tmp-ra.60 tmp.75 tmp.45 tmp.56)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.45 rdi)
        (if (begin
    ...
    (define L.ascii-char?.17
      ((new-frames ()) (locals (tmp-ra.61 tmp.76 tmp.47 tmp.57)))
      (begin
        (set! tmp-ra.61 r15)
        (set! tmp.47 rdi)
        (if (begin
    ...
    ((new-frames
     ...
     (locals
      (void5.1
       ...
       tmp-ra.98)))
    (define L.empty?.17
      ((new-frames ()) (locals (tmp-ra.85 tmp.99 tmp.45 tmp.56)))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.45 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
      (void5.1
       ...
       tmp-ra.100)))
    (define L.void?.17
      ((new-frames ()) (locals (tmp-ra.87 tmp.101 tmp.46 tmp.56)))
      (begin
        (set! tmp-ra.87 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    (define L.fixnum?.16
      ((new-frames ()) (locals (tmp-ra.88 tmp.102 tmp.43 tmp.57)))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.43 rdi)
        (if (begin
    ...
    ((new-frames
     ...
     (locals
      (boolean5.1
       ...
       tmp-ra.110)))
    (define L.void?.15
      ((new-frames ()) (locals (tmp-ra.99 tmp.111 tmp.46 tmp.56)))
      (begin
        (set! tmp-ra.99 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    (define L.*.15
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.87 rbp rax)))))
    (define L.boolean?.14
      ((new-frames ()) (locals (tmp-ra.88 tmp.109 tmp.44 tmp.69)))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.44 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ...
    (define L.-.15
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 830) (jump tmp-ra.89 rbp rax)))))
    (define L.boolean?.14
      ((new-frames ()) (locals (tmp-ra.90 tmp.111 tmp.44 tmp.69)))
      (begin
        (set! tmp-ra.90 r15)
        (set! tmp.44 rdi)
        (if (begin
    ...
    (define L.void?.13
      ((new-frames ()) (locals (tmp-ra.91 tmp.112 tmp.46 tmp.70)))
      (begin
        (set! tmp-ra.91 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    (define L.*.17
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.87 rbp rax)))))
    (define L.empty?.16
      ((new-frames ()) (locals (tmp-ra.88 tmp.111 tmp.45 tmp.69)))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.45 rdi)
        (if (begin
    ...
    ((new-frames
     ...
     (locals
      (ascii-char5.1
       ...
       tmp-ra.98)))
    (define L.vector?.17
      ((new-frames ()) (locals (tmp-ra.85 tmp.99 tmp.50 tmp.56)))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.50 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () ()))
     (locals
      (error5.1
       ...
       tmp-ra.70)))
    (define L.fixnum?.16
      ((new-frames ()) (locals (tmp-ra.58 tmp.71 tmp.43 tmp.56)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.43 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () ()))
     (locals
      (empty5.1
       ...
       tmp-ra.72)))
    (define L.pair?.18
      ((new-frames ()) (locals (tmp-ra.58 tmp.73 tmp.49 tmp.56)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.49 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
      (tmp.103
       ...
       tmp-ra.116)))
    (define L.error?.15
      ((new-frames ()) (locals (tmp-ra.105 tmp.117 tmp.48 tmp.56)))
      (begin
        (set! tmp-ra.105 r15)
        (set! tmp.48 rdi)
        (if (begin
    ...
    (define L.boolean?.14
      ((new-frames ()) (locals (tmp-ra.106 tmp.118 tmp.44 tmp.57)))
      (begin
        (set! tmp-ra.106 r15)
        (set! tmp.44 rdi)
        (if (begin
    ...
    (define L.void?.13
      ((new-frames ()) (locals (tmp-ra.107 tmp.119 tmp.46 tmp.58)))
      (begin
        (set! tmp-ra.107 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    ((new-frames (() () () () () () ()))
     (locals
      (empty5.1
       ...
       tmp-ra.72)))
    (define L.vector?.18
      ((new-frames ()) (locals (tmp-ra.58 tmp.73 tmp.50 tmp.56)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.50 rdi)
        (if (begin
