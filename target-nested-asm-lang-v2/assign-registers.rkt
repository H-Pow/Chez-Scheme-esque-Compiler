...
;; Performs graph-colouring register allocation. Compiles asm-pred-lang-v6/framed to
;; asm-pred-lang-v6/spilled by decorating programs with their register assignments
...
(module+ test
      ...
      (begin
        ...
        (if (begin
            ...
            (begin
              ...
              (jump tmp-ra.16 rbp rax))))))
  (check-by-interp
   '(module ((locals (bat.2.6 tmp.11 tmp-ra.9))
             ...
             (assignment ()))
            (define L.proc.0.1
              ((locals (bar.1.2 tmp.10 bat.9.1 tmp-ra.7))
      ...
      (define L.func.1.2
        ((locals (bar.1.3 foobar.6.4 foobar.8.5 tmp-ra.8))
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.8)) (conflicts ((tmp-ra.8 (rdi rsi rdx rcx r8 r9 rbp))
      ...
      (begin
        ...
        (if (begin
            ...
            (begin
              ...
              (jump L.fn.0.1 rbp r15 rdi rsi))))))
  (check-by-interp
   '(module ((locals (tmp.6 bar.5.2 tmp.7 tmp.8 bar.3.3 ball.6.4 tmp-ra.5 tmp.9 bat.4.1))
             (conflicts
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.9)) (conflicts ((tmp-ra.9 (rdi rsi rdx rcx r8 r9 fv0 rbp))
      ...
      (begin
        ...
        (jump L.tmp.0.1 rbp r15 rdi rsi rdx rcx r8 r9 fv0))))
  (check-by-interp
   '(module ((locals (tmp-ra.21 foo.9.17))
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.15)) (conflicts ((tmp-ra.15 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.15))
      ...
      (define L.x.1.2
        ((locals (ball.3.11 tmp.16 ball.8.10 tmp.17))
         (conflicts
         ...
         (assignment ((tmp-ra.13 fv0) (bat.9.8 fv1) (foobar.7.9 fv2) (nfv.14 fv3))))
        (begin
          (set! tmp-ra.13 r15)
          (set! foobar.7.9 rdi)
          (set! bat.9.8 rsi)
      ...
      (begin
        ...
        (jump L.x.1.2 rbp r15 rdi rsi))))
  (check-by-interp
   '(module ((locals (bar.1.14 tmp-ra.17 tmp.21 tmp.20 tmp.19 foo.6.13))
             (conflicts
      ...
      (define L.func.1.2
        ((locals (ball.5.9 bat.4.10 bar.1.11 foobar.2.12 tmp-ra.16))
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.10))
             ...
             (assignment ()))
            (define L.x.0.1
              ((locals (foo.4.1 foo.3.2 bar.1.3 tmp-ra.8))
      ...
      (define L.x.1.2
        ((locals (foo.8.4 bar.0.5 foo.3.6 bar.1.7 tmp-ra.9))
  ...
  (check-by-interp
   '(module ((locals (bat.8.12 tmp.24 tmp.22 tmp.23 bat.8.11 tmp.21 tmp.20))
             (conflicts
            ...
            (define L.func.0.1
              ((locals (bat.8.5 ball.4.4 tmp.16 bat.7.2 foobar.3.3 tmp.17))
               (conflicts
              ...
              (begin
                ...
                (if (begin
                    ...
                    (begin
                      ...
                      (jump tmp-ra.13 rbp rax)))))
      (define L.fn.1.2
        ((locals (tmp.19 foobar.1.9 bar.9.7 foobar.1.8 tmp.18 bat.8.6))
         (conflicts
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.20))
             ...
             (assignment ()))
            (define L.tmp.0.1
              ((locals (tmp-ra.17)) (conflicts ((tmp-ra.17 (rdi rsi rdx rcx r8 rbp))
  ...
  (check-by-interp
   '(module ((locals (tmp-ra.11)) (conflicts ((tmp-ra.11 (rdi rbp)) (rbp (r15 rdi tmp-ra.11))
      ...
      (begin
        ...
        (jump L.tmp.2.3 rbp r15 rdi))))
  (check-by-interp
   '(module ((locals (foo.5.13 foo.6.15 tmp.22 bat.0.14 tmp-ra.18))
      ...
      (begin
        ...
        (jump tmp-ra.18 rbp rax))))
  (check-by-interp
   '(module ((locals (foobar.4.3 bat.1.2 foobar.4.5 tmp-ra.6 foo.0.4 bar.7.1 tmp.7))
  ...
  (check-by-interp
   '(module ((locals (foobar.6.5 ball.3.4 tmp.8))
            ...
            (define L.x.0.1
              ((locals (foobar.6.1 foo.8.2 foobar.5.3 tmp-ra.6))
      ...
      (begin
        ...
        (if (not (not (< foo.5.5 foo.5.5)))
            ...
            (begin
              ...
              (jump tmp-ra.8 rbp rax))))))
  (check-by-interp
   '(module ((locals (tmp.9 tmp.10 tmp.11 tmp.12 tmp.13 foo.2.6))
             (conflicts
             ...
             (assignment ((tmp-ra.8 fv0))))
            (define L.tmp.0.1
              ((locals (ball.4.4 foo.6.5 foo.8.3))
               (conflicts
  ...
  (check-by-interp
   '(module ((locals (ball.3.17 tmp.24 tmp-ra.21))
      ...
      (begin
        ...
        (jump L.x.0.1 rbp r15 rdi rsi rdx rcx r8))))
  (check-by-interp
   '(module ((locals (tmp-ra.9)) (conflicts ((tmp-ra.9 (rdi rsi rbp)) (rbp (r15 rdi rsi tmp-ra.9))
                                                                      (rsi (r15 rdi rbp tmp-ra.9))
                                                                      (rdi (r15 rbp rsi tmp-ra.9))
                                                                      (r15 (rbp rdi rsi))))
                                 (assignment ()))
            (define L.tmp.0.1
              ((locals (bar.7.1 bat.8.2 tmp-ra.7))
      ...
      (define L.fn.1.2
        ((locals (bat.8.3 bar.9.4 foobar.6.5 bar.3.6 tmp-ra.8))
