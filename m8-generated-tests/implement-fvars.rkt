#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../implement-fvars.rkt")
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fv0 r15)
      (if (begin (set! r15 14) (true)) (set! fv1 592) (set! fv1 776))
      (begin
        (set! rbp (- rbp 16))
        (return-point L.rp.7
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! rbp (+ rbp 40)))
      (set! fv4 rax)
      (if (begin (set! r15 6) (false)) (set! fv3 760) (set! fv3 424))
      (begin
        (set! rbp (- rbp 40))
        (return-point L.rp.12
          (begin
