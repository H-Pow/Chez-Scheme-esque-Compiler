...
(check-by-interp
 '(module
    ((new-frames ()) (locals (cons.56 tmp.59 tmp.65 tmp.61 tmp-ra.63)))
    (define L.cons.56.7
      ((new-frames ())
       (locals (tmp.58 tmp.64 tmp.60 tmp.52 tmp.51 c.57 tmp-ra.62)))
      (begin
        (set! tmp-ra.62 r15)
        (set! c.57 rdi)
        (set! tmp.51 rsi)
    ...
    (begin
      (set! tmp-ra.63 r15)
      (begin (set! tmp.61 r12) (set! r12 (+ r12 16)))
      (set! tmp.65 tmp.61)
      (set! tmp.65 (+ tmp.65 2))
      (set! tmp.59 tmp.65)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (fun/error8439.4 tmp.58 tmp.62 tmp.59 tmp-ra.61)))
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (fun/error8442.4 tmp.58 tmp.62 tmp.59 tmp-ra.61)))
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (fun/error8445.4 tmp.58 tmp.62 tmp.59 tmp-ra.61)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/pair8448.4.8
      ((new-frames ()) (locals (cons.57 c.59 tmp-ra.66)))
      (begin
        (set! tmp-ra.66 r15)
        (set! c.59 rdi)
    ...
    (define L.cons.57.7
      ((new-frames ())
       (locals (tmp.60 tmp.69 tmp.63 tmp.53 tmp.52 c.58 tmp-ra.67)))
      (begin
        (set! tmp-ra.67 r15)
        (set! c.58 rdi)
        (set! tmp.52 rsi)
        (set! tmp.53 rdx)
        (begin (set! tmp.63 r12) (set! r12 (+ r12 16)))
        (set! tmp.69 tmp.63)
        (set! tmp.69 (+ tmp.69 1))
        (set! tmp.60 tmp.69)
    ...
    (begin
      ...
      (mset! tmp.61 6 16)
      (set! cons.57 tmp.61)
      (begin (set! tmp.65 r12) (set! r12 (+ r12 24)))
      (set! tmp.71 tmp.65)
      (set! tmp.71 (+ tmp.71 2))
      (set! tmp.62 tmp.71)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (void1.4 ascii-char0.5 tmp-ra.58)))
    (begin
      (set! tmp-ra.58 r15)
...
(check-by-interp
 '(module
    ((new-frames (()))
     (locals
      (procedure1.4
       ...
       tmp-ra.88)))
    (define L.lam.59.10
      ((new-frames ()) (locals (c.63 tmp-ra.84)))
      (begin
        (set! tmp-ra.84 r15)
        (set! c.63 rdi)
        (set! rax 576)
    ...
    (define L.make-vector.58.9
      ((new-frames ())
       (locals
        (c.62 make-init-vector.1 tmp-ra.85 tmp.70 tmp.34 tmp.89 tmp.69)))
      (begin
        (set! tmp-ra.85 r15)
        (set! c.62 rdi)
        (set! tmp.34 rsi)
    ...
    (define L.make-init-vector.1.8
      ...
      (begin
        ...
        (set! tmp.74 tmp.90)
        (set! tmp.91 1)
        (set! tmp.91 (+ tmp.91 tmp.74))
        (set! tmp.73 tmp.91)
        (set! tmp.92 tmp.73)
        (set! tmp.92 (* tmp.92 8))
        (set! tmp.72 tmp.92)
        (begin (set! tmp.71 r12) (set! r12 (+ r12 tmp.72)))
        (set! tmp.93 tmp.71)
        (set! tmp.93 (+ tmp.93 3))
        (set! tmp.64 tmp.93)
        (mset! tmp.64 -3 tmp.6)
    ...
    (define L.vector-init-loop.8.7
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.94 i.11)
            (set! tmp.94 (arithmetic-shift-right tmp.94 3))
            (set! tmp.78 tmp.94)
            (set! tmp.95 tmp.78)
            (set! tmp.95 (* tmp.95 8))
            (set! tmp.77 tmp.95)
    ...
    (begin
      ...
      (begin (set! tmp.82 r12) (set! r12 (+ r12 24)))
      (set! tmp.100 tmp.82)
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8457.5.9
      ((new-frames ()) (locals (fun/empty8458.4 oprand0.6 c.62 tmp-ra.72)))
      (begin
        (set! tmp-ra.72 r15)
        (set! c.62 rdi)
        (set! oprand0.6 rsi)
    ...
    (define L.fun/empty8458.4.8
      ((new-frames ()) (locals (c.61 tmp-ra.73)))
      (begin
        (set! tmp-ra.73 r15)
        (set! c.61 rdi)
        (set! rax 22)
    ...
    (define L.cons.59.7
      ((new-frames ())
       (locals (tmp.63 tmp.76 tmp.67 tmp.55 tmp.54 c.60 tmp-ra.74)))
      (begin
        (set! tmp-ra.74 r15)
        (set! c.60 rdi)
        (set! tmp.54 rsi)
        (set! tmp.55 rdx)
        (begin (set! tmp.67 r12) (set! r12 (+ r12 16)))
        (set! tmp.76 tmp.67)
        (set! tmp.76 (+ tmp.76 1))
        (set! tmp.63 tmp.76)
    ...
    (begin
      ...
      (begin (set! tmp.70 r12) (set! r12 (+ r12 24)))
      (set! tmp.79 tmp.70)
      (set! tmp.79 (+ tmp.79 2))
      (set! tmp.66 tmp.79)
...
(check-by-interp
 '(module
    ...
    (begin
      (set! tmp-ra.56 r15)
      (if (begin (set! tmp.57 6) (!= tmp.57 6))
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.56.9
      ((new-frames ())
       (locals
        (c.59 make-init-vector.1 tmp-ra.78 tmp.65 tmp.32 tmp.82 tmp.64)))
      (begin
        (set! tmp-ra.78 r15)
        (set! c.59 rdi)
        (set! tmp.32 rsi)
    ...
    (define L.make-init-vector.1.8
      ...
      (begin
        ...
        (set! tmp.69 tmp.83)
        (set! tmp.84 1)
        (set! tmp.84 (+ tmp.84 tmp.69))
        (set! tmp.68 tmp.84)
        (set! tmp.85 tmp.68)
        (set! tmp.85 (* tmp.85 8))
        (set! tmp.67 tmp.85)
        (begin (set! tmp.66 r12) (set! r12 (+ r12 tmp.67)))
        (set! tmp.86 tmp.66)
        (set! tmp.86 (+ tmp.86 3))
        (set! tmp.60 tmp.86)
        (mset! tmp.60 -3 tmp.4)
    ...
    (begin
      (set! tmp-ra.81 r15)
      (begin (set! tmp.75 r12) (set! r12 (+ r12 24)))
      (set! tmp.91 tmp.75)
      (set! tmp.91 (+ tmp.91 2))
      (set! tmp.61 tmp.91)
      ...
      (begin (set! tmp.76 r12) (set! r12 (+ r12 24)))
      (set! tmp.92 tmp.76)
      (set! tmp.92 (+ tmp.92 2))
      (set! tmp.62 tmp.92)
      ...
      (begin (set! tmp.77 r12) (set! r12 (+ r12 24)))
      (set! tmp.93 tmp.77)
      (set! tmp.93 (+ tmp.93 2))
      (set! tmp.63 tmp.93)
      ...
      (if (begin (set! tmp.94 6) (!= tmp.94 6))
        (begin
          (set! rsi 64)
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8466.6.10
      ((new-frames ()) (locals (c.65 tmp-ra.78)))
      (begin
        (set! tmp-ra.78 r15)
        (set! c.65 rdi)
        (set! rax 22)
    ...
    (define L.fun/empty8465.5.9
      ((new-frames ()) (locals (fun/empty8466.6 oprand0.8 c.64 tmp-ra.79)))
      (begin
        (set! tmp-ra.79 r15)
        (set! c.64 rdi)
        (set! oprand0.8 rsi)
    ...
    (define L.fun/error8467.4.8
      ((new-frames ()) (locals (oprand0.7 c.63 tmp-ra.80)))
      (begin
        (set! tmp-ra.80 r15)
        (set! c.63 rdi)
        (set! oprand0.7 rsi)
    ...
    (define L.cons.61.7
      ((new-frames ())
       (locals (tmp.66 tmp.83 tmp.71 tmp.57 tmp.56 c.62 tmp-ra.81)))
      (begin
        (set! tmp-ra.81 r15)
        (set! c.62 rdi)
        (set! tmp.56 rsi)
    ...
    (begin
      (set! tmp-ra.82 r15)
      (begin (set! tmp.72 r12) (set! r12 (+ r12 16)))
      (set! tmp.84 tmp.72)
      (set! tmp.84 (+ tmp.84 2))
      (set! tmp.67 tmp.84)
      ...
      (mset! tmp.67 6 16)
      (set! cons.61 tmp.67)
      (begin (set! tmp.73 r12) (set! r12 (+ r12 16)))
      (set! tmp.85 tmp.73)
      (set! tmp.85 (+ tmp.85 2))
      (set! tmp.68 tmp.85)
      ...
      (begin (set! tmp.74 r12) (set! r12 (+ r12 24)))
      (set! tmp.86 tmp.74)
      (set! tmp.86 (+ tmp.86 2))
      (set! tmp.69 tmp.86)
      ...
      (begin (set! tmp.75 r12) (set! r12 (+ r12 16)))
      (set! tmp.87 tmp.75)
      (set! tmp.87 (+ tmp.87 2))
      (set! tmp.70 tmp.87)
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8483.6.10
      ((new-frames ())
       (locals (fun/void8484.4 oprand1.9 oprand0.10 c.67 tmp-ra.84)))
      (begin
        (set! tmp-ra.84 r15)
        (set! c.67 rdi)
        (set! oprand0.10 rsi)
    ...
    (define L.fun/ascii-char8485.5.9
      ((new-frames ()) (locals (oprand1.7 oprand0.8 c.66 tmp-ra.85)))
      (begin
        (set! tmp-ra.85 r15)
        (set! c.66 rdi)
        (set! oprand0.8 rsi)
    ...
    (define L.fun/void8484.4.8
      ((new-frames ()) (locals (c.65 tmp-ra.86)))
      (begin
        (set! tmp-ra.86 r15)
        (set! c.65 rdi)
        (set! rax 30)
    ...
    (begin
      (set! tmp-ra.88 r15)
      (begin (set! tmp.76 r12) (set! r12 (+ r12 16)))
      (set! tmp.92 tmp.76)
      (set! tmp.92 (+ tmp.92 2))
      (set! tmp.68 tmp.92)
      ...
      (begin (set! tmp.78 r12) (set! r12 (+ r12 16)))
      (set! tmp.94 tmp.78)
      (set! tmp.94 (+ tmp.94 2))
      (set! tmp.70 tmp.94)
      ...
      (return-point L.rp.13
        (begin
          ...
          (jump L.fun/ascii-char8485.5.9 rbp r15 rdi rsi rdx)))
      (set! tmp.80 rax)
      (if (begin (set! tmp.96 14) (!= tmp.96 6))
        (set! tmp.83 960)
        (set! tmp.83 528))
      (set! rdx tmp.83)
      (set! rsi tmp.80)
...
(check-by-interp
 '(module
    ...
    (begin
      (set! tmp-ra.59 r15)
      (if (if (begin (set! tmp.60 14) (!= tmp.60 6))
            (begin (set! tmp.61 14) (!= tmp.61 6))
            (begin (set! tmp.62 6) (!= tmp.62 6)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8491.6.13
      ((new-frames ()) (locals (c.70 tmp-ra.99)))
      (begin
        (set! tmp-ra.99 r15)
        (set! c.70 rdi)
        (set! rax 30)
    ...
    (define L.fun/void8490.5.12
      ((new-frames ()) (locals (c.69 tmp-ra.100)))
      (begin
        (set! tmp-ra.100 r15)
        (set! c.69 rdi)
        (set! rax 30)
    ...
    (define L.fun/error8492.4.11
      ((new-frames ()) (locals (c.68 tmp-ra.101)))
      (begin
        (set! tmp-ra.101 r15)
        (set! c.68 rdi)
        (set! rax 19774)
    ...
    (define L.make-vector.62.10
      ((new-frames ())
       (locals
        (c.67 make-init-vector.1 tmp-ra.102 tmp.80 tmp.38 tmp.107 tmp.79)))
      (begin
        (set! tmp-ra.102 r15)
        (set! c.67 rdi)
        (set! tmp.38 rsi)
    ...
    (define L.make-init-vector.1.9
      ...
      (begin
        ...
        (set! tmp.84 tmp.108)
        (set! tmp.109 1)
        (set! tmp.109 (+ tmp.109 tmp.84))
        (set! tmp.83 tmp.109)
        (set! tmp.110 tmp.83)
        (set! tmp.110 (* tmp.110 8))
        (set! tmp.82 tmp.110)
        (begin (set! tmp.81 r12) (set! r12 (+ r12 tmp.82)))
        (set! tmp.111 tmp.81)
        (set! tmp.111 (+ tmp.111 3))
        (set! tmp.71 tmp.111)
        (mset! tmp.71 -3 tmp.10)
        (set! tmp.11 tmp.71)
        (set! rcx tmp.11)
        (set! rdx 0)
        (set! rsi tmp.10)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.88 tmp.112)
            (set! tmp.113 tmp.88)
            (set! tmp.113 (* tmp.113 8))
            (set! tmp.87 tmp.113)
            (set! tmp.114 tmp.87)
            (set! tmp.114 (+ tmp.114 5))
            (set! tmp.86 tmp.114)
            (mset! vec.14 tmp.86 0)
            (set! tmp.115 i.15)
            (set! tmp.115 (+ tmp.115 8))
            (set! tmp.89 tmp.115)
            (set! rcx vec.14)
            (set! rdx tmp.89)
            (set! rsi len.13)
    ...
    (define L.vector?.63.7
      ((new-frames ()) (locals (c.64 tmp-ra.105 tmp.116 tmp.54 tmp.90)))
      (begin
        (set! tmp-ra.105 r15)
        (set! c.64 rdi)
        (set! tmp.54 rsi)
    ...
    (begin
      (set! tmp-ra.106 r15)
      (begin (set! tmp.91 r12) (set! r12 (+ r12 16)))
      (set! tmp.117 tmp.91)
      (set! tmp.117 (+ tmp.117 2))
      (set! tmp.72 tmp.117)
      (mset! tmp.72 -2 L.vector?.63.7)
      (mset! tmp.72 6 8)
      (set! vector?.63 tmp.72)
      (begin (set! tmp.92 r12) (set! r12 (+ r12 24)))
      (set! tmp.118 tmp.92)
      (set! tmp.118 (+ tmp.118 2))
      (set! tmp.73 tmp.118)
      (mset! tmp.73 -2 L.vector-init-loop.12.8)
      (mset! tmp.73 6 24)
      (set! vector-init-loop.12 tmp.73)
      (begin (set! tmp.93 r12) (set! r12 (+ r12 24)))
      (set! tmp.119 tmp.93)
      (set! tmp.119 (+ tmp.119 2))
      (set! tmp.74 tmp.119)
      (mset! tmp.74 -2 L.make-init-vector.1.9)
      (mset! tmp.74 6 8)
      (set! make-init-vector.1 tmp.74)
      (begin (set! tmp.94 r12) (set! r12 (+ r12 24)))
      (set! tmp.120 tmp.94)
      (set! tmp.120 (+ tmp.120 2))
      (set! tmp.75 tmp.120)
      (mset! tmp.75 -2 L.make-vector.62.10)
      (mset! tmp.75 6 8)
      (set! make-vector.62 tmp.75)
      (begin (set! tmp.95 r12) (set! r12 (+ r12 16)))
      (set! tmp.121 tmp.95)
      (set! tmp.121 (+ tmp.121 2))
      (set! tmp.76 tmp.121)
...
(check-by-interp
 '(module
    ...
    (define L.fun/error8495.4.10
      ((new-frames ()) (locals (oprand1.5 oprand0.6 c.63 tmp-ra.85)))
      (begin
        (set! tmp-ra.85 r15)
        (set! c.63 rdi)
        (set! oprand0.6 rsi)
    ...
    (define L.make-vector.59.9
      ((new-frames ())
       (locals
        (c.62 make-init-vector.1 tmp-ra.86 tmp.70 tmp.35 tmp.90 tmp.69)))
      (begin
        (set! tmp-ra.86 r15)
        (set! c.62 rdi)
        (set! tmp.35 rsi)
    ...
    (begin
      ...
      (if (if (begin (set! tmp.103 14) (!= tmp.103 6))
            (begin (set! tmp.104 14) (!= tmp.104 6))
            (begin (set! tmp.105 6) (!= tmp.105 6)))
        (if (begin (set! tmp.106 14) (!= tmp.106 6))
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char8529.5.10
      ((new-frames ()) (locals (c.66 tmp-ra.80)))
      (begin
        (set! tmp-ra.80 r15)
        (set! c.66 rdi)
        (set! rax 22318)
    ...
    (define L.fun/error8528.4.9
      ((new-frames ()) (locals (c.65 tmp-ra.81)))
      (begin
        (set! tmp-ra.81 r15)
        (set! c.65 rdi)
        (set! rax 55102)
        (jump tmp-ra.81 rbp rax)))
    (define L.empty?.61.8
      ((new-frames ()) (locals (c.64 tmp-ra.82 tmp.85 tmp.48 tmp.71)))
      (begin
        (set! tmp-ra.82 r15)
        (set! c.64 rdi)
        (set! tmp.48 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.fun/pair8538.5.9
      ((new-frames ()) (locals (cons.62 oprand1.8 oprand0.9 c.65 tmp-ra.75)))
      (begin
        (set! tmp-ra.75 r15)
        (set! c.65 rdi)
        (set! oprand0.9 rsi)
    ...
    (define L.fun/pair8539.4.8
      ((new-frames ()) (locals (oprand1.6 oprand0.7 c.64 tmp-ra.76)))
      (begin
        (set! tmp-ra.76 r15)
        (set! c.64 rdi)
        (set! oprand0.7 rsi)
    ...
    (define L.cons.62.7
      ((new-frames ())
       (locals (tmp.66 tmp.79 tmp.70 tmp.58 tmp.57 c.63 tmp-ra.77)))
      (begin
        (set! tmp-ra.77 r15)
        (set! c.63 rdi)
        (set! tmp.57 rsi)
    ...
    (begin
      ...
      (begin (set! tmp.73 r12) (set! r12 (+ r12 24)))
      (set! tmp.82 tmp.73)
      (set! tmp.82 (+ tmp.82 2))
      (set! tmp.69 tmp.82)
      ...
      (if (if (begin (set! tmp.83 14) (!= tmp.83 6))
            (begin (set! tmp.84 6) (!= tmp.84 6))
            (begin (set! tmp.85 6) (!= tmp.85 6)))
        (begin
          (set! rdx 6)
          (set! rsi 1976)
...
(check-by-interp
 '(module
    ...
    (define L.fun/boolean8542.5.12
      ((new-frames ()) (locals (oprand1.8 oprand0.9 c.69 tmp-ra.99)))
      (begin
        (set! tmp-ra.99 r15)
        (set! c.69 rdi)
        (set! oprand0.9 rsi)
    ...
    (define L.fun/ascii-char8543.4.11
      ((new-frames ()) (locals (oprand1.6 oprand0.7 c.68 tmp-ra.100)))
      (begin
        (set! tmp-ra.100 r15)
        (set! c.68 rdi)
        (set! oprand0.7 rsi)
    ...
    (define L.make-vector.62.10
      ((new-frames ())
       (locals
        (c.67 make-init-vector.1 tmp-ra.101 tmp.79 tmp.38 tmp.106 tmp.78)))
      (begin
        (set! tmp-ra.101 r15)
        (set! c.67 rdi)
        (set! tmp.38 rsi)
    ...
    (define L.make-init-vector.1.9
      ...
      (begin
        ...
        (set! tmp.83 tmp.107)
        (set! tmp.108 1)
        (set! tmp.108 (+ tmp.108 tmp.83))
        (set! tmp.82 tmp.108)
        (set! tmp.109 tmp.82)
        (set! tmp.109 (* tmp.109 8))
        (set! tmp.81 tmp.109)
        (begin (set! tmp.80 r12) (set! r12 (+ r12 tmp.81)))
        (set! tmp.110 tmp.80)
        (set! tmp.110 (+ tmp.110 3))
        (set! tmp.70 tmp.110)
        (mset! tmp.70 -3 tmp.10)
        (set! tmp.11 tmp.70)
        (set! rcx tmp.11)
        (set! rdx 0)
        (set! rsi tmp.10)
    ...
    (define L.cons.63.7
      ((new-frames ())
       (locals (tmp.71 tmp.115 tmp.89 tmp.58 tmp.57 c.64 tmp-ra.104)))
      (begin
        (set! tmp-ra.104 r15)
        (set! c.64 rdi)
        (set! tmp.57 rsi)
        (set! tmp.58 rdx)
        (begin (set! tmp.89 r12) (set! r12 (+ r12 16)))
        (set! tmp.115 tmp.89)
    ...
    (begin
      (set! tmp-ra.105 r15)
      (begin (set! tmp.90 r12) (set! r12 (+ r12 16)))
      (set! tmp.116 tmp.90)
      (set! tmp.116 (+ tmp.116 2))
      (set! tmp.72 tmp.116)
      (mset! tmp.72 -2 L.cons.63.7)
      (mset! tmp.72 6 16)
      (set! cons.63 tmp.72)
      (begin (set! tmp.91 r12) (set! r12 (+ r12 24)))
      (set! tmp.117 tmp.91)
      (set! tmp.117 (+ tmp.117 2))
      (set! tmp.73 tmp.117)
      (mset! tmp.73 -2 L.vector-init-loop.12.8)
      ...
      (if (begin
        ...
        (if (begin (set! tmp.122 6) (!= tmp.122 6))
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.150 tmp.26)
              (set! tmp.150 (arithmetic-shift-right tmp.150 3))
              (set! tmp.109 tmp.150)
              (set! tmp.151 tmp.25)
              (set! tmp.151 (* tmp.151 tmp.109))
              (set! rax tmp.151)
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (mset! tmp.59 6 16)
      (set! cons.56 tmp.59)
      (if (if (begin (set! tmp.66 14) (!= tmp.66 6))
            (begin (set! tmp.67 14) (!= tmp.67 6))
            (begin (set! tmp.68 6) (!= tmp.68 6)))
        (if (begin (set! tmp.69 14) (!= tmp.69 6))
          (begin
            (set! rdx 3360)
            (set! rsi 408)
            (set! rdi cons.56)
          ...
          (begin
            ...
            (set! r15 tmp-ra.63)
            (jump L.cons.56.7 rbp r15 rdi rsi rdx)))
        (if (begin (set! tmp.70 14) (!= tmp.70 6))
          (begin
            (set! rdx 2800)
            (set! rsi 1928)
            (set! rdi cons.56)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals
      (procedure3.9
       ...
       tmp.92
       tmp.79
       fun/ascii-char8689.4
       tmp.72
       tmp.91
       tmp.78
       tmp-ra.90)))
    (define L.lam.65.12
      ((new-frames ()) (locals (fun/error8691.5 c.71 tmp-ra.84)))
      (begin
        (set! tmp-ra.84 r15)
        (set! c.71 rdi)
    ...
    (define L.fun/void8690.8.11
      ((new-frames ()) (locals (c.70 tmp-ra.85)))
      (begin
        (set! tmp-ra.85 r15)
        (set! c.70 rdi)
        (set! rax 30)
    ...
    (define L.fun/ascii-char8688.7.10
      ((new-frames ()) (locals (c.69 tmp-ra.86)))
      (begin
        (set! tmp-ra.86 r15)
        (set! c.69 rdi)
        (set! rax 27182)
    ...
    (define L.fun/empty8692.6.9
      ((new-frames ()) (locals (c.68 tmp-ra.87)))
      (begin
        (set! tmp-ra.87 r15)
        (set! c.68 rdi)
        (set! rax 22)
    ...
    (define L.fun/error8691.5.8
      ((new-frames ()) (locals (c.67 tmp-ra.88)))
      (begin
        (set! tmp-ra.88 r15)
        (set! c.67 rdi)
        (set! rax 31806)
    ...
    (define L.fun/ascii-char8689.4.7
      ((new-frames ()) (locals (c.66 tmp-ra.89)))
      (begin
        (set! tmp-ra.89 r15)
        (set! c.66 rdi)
        (set! rax 18734)
...
(check-by-interp
 '(module
    ...
    (define L.fun/any8764.8.16
      ((new-frames ()) (locals (c.77 tmp-ra.114)))
      (begin
        (set! tmp-ra.114 r15)
        (set! c.77 rdi)
        (set! rax 14142)
    ...
    (define L.fun/void8763.7.15
      ((new-frames ()) (locals (c.76 tmp-ra.115)))
      (begin
        (set! tmp-ra.115 r15)
        (set! c.76 rdi)
        (set! rax 30)
    ...
    (define L.fun/any8762.6.14
      ((new-frames ()) (locals (c.75 tmp-ra.116)))
      (begin
        (set! tmp-ra.116 r15)
        (set! c.75 rdi)
        (set! rax 30)
    ...
    (define L.fun/ascii-char8761.5.13
      ((new-frames ()) (locals (c.74 tmp-ra.117)))
      (begin
        (set! tmp-ra.117 r15)
        (set! c.74 rdi)
        (set! rax 27438)
    ...
    (define L.fun/vector8765.4.12
      ((new-frames ()) (locals (make-vector.65 c.73 tmp-ra.118)))
      (begin
        (set! tmp-ra.118 r15)
        (set! c.73 rdi)
    ...
    (define L.make-vector.65.11
      ((new-frames ())
       (locals
        (c.72 make-init-vector.1 tmp-ra.119 tmp.90 tmp.41 tmp.125 tmp.89)))
      (begin
        (set! tmp-ra.119 r15)
        (set! c.72 rdi)
        (set! tmp.41 rsi)
    ...
    (define L.make-init-vector.1.10
      ...
      (begin
        ...
        (set! tmp.94 tmp.126)
        (set! tmp.127 1)
        (set! tmp.127 (+ tmp.127 tmp.94))
        (set! tmp.93 tmp.127)
        (set! tmp.128 tmp.93)
        (set! tmp.128 (* tmp.128 8))
        (set! tmp.92 tmp.128)
        (begin (set! tmp.91 r12) (set! r12 (+ r12 tmp.92)))
        (set! tmp.129 tmp.91)
        (set! tmp.129 (+ tmp.129 3))
        (set! tmp.78 tmp.129)
        (mset! tmp.78 -3 tmp.13)
        (set! tmp.14 tmp.78)
        (set! rcx tmp.14)
        (set! rdx 0)
        (set! rsi tmp.13)
    ...
    (define L.vector-init-loop.15.9
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.130 i.18)
            (set! tmp.130 (arithmetic-shift-right tmp.130 3))
            (set! tmp.98 tmp.130)
            (set! tmp.131 tmp.98)
            (set! tmp.131 (* tmp.131 8))
            (set! tmp.97 tmp.131)
            (set! tmp.132 tmp.97)
            (set! tmp.132 (+ tmp.132 5))
            (set! tmp.96 tmp.132)
    ...
    (define L.vector?.66.8
      ((new-frames ()) (locals (c.69 tmp-ra.122 tmp.134 tmp.57 tmp.100)))
      (begin
        (set! tmp-ra.122 r15)
        (set! c.69 rdi)
        (set! tmp.57 rsi)
    ...
    (define L.boolean?.67.7
      ((new-frames ()) (locals (c.68 tmp-ra.123 tmp.135 tmp.51 tmp.101)))
      (begin
        (set! tmp-ra.123 r15)
        (set! c.68 rdi)
        (set! tmp.51 rsi)
        (if (begin
              (begin
                (set! tmp.135 tmp.51)
                (set! tmp.135 (bitwise-and tmp.135 247))
                (set! tmp.101 tmp.135))
              (= tmp.101 6))
    ...
    (begin
      ...
      (begin (set! tmp.103 r12) (set! r12 (+ r12 16)))
      (set! tmp.137 tmp.103)
      ...
      (begin (set! tmp.106 r12) (set! r12 (+ r12 24)))
      (set! tmp.140 tmp.106)
      ...
      (begin (set! tmp.107 r12) (set! r12 (+ r12 24)))
      (set! tmp.141 tmp.107)
      ...
      (begin (set! tmp.108 r12) (set! r12 (+ r12 16)))
      (set! tmp.142 tmp.108)
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
       ...
       *.109
       ...
       tmp-ra.241)))
    (define L.lam.110.27
      ((new-frames ()) (locals (c.131 tmp-ra.220)))
      (begin
        (set! tmp-ra.220 r15)
        (set! c.131 rdi)
        (set! rax 22574)
    ...
    (define L.fun/pair8798.16.26
      ((new-frames ()) (locals (cons.105 c.130 tmp-ra.221)))
      (begin
        (set! tmp-ra.221 r15)
        (set! c.130 rdi)
    ...
    (define L.fun/error8800.14.24
      ((new-frames ())
       (locals (oprand2.35 oprand1.36 oprand0.37 c.128 tmp-ra.223)))
      (begin
        (set! tmp-ra.223 r15)
        (set! c.128 rdi)
        (set! oprand0.37 rsi)
        ...
        (set! oprand2.35 rcx)
        (set! rax oprand2.35)
        (jump tmp-ra.223 rbp rax)))
    (define L.fun/fixnum8792.13.23
      ((new-frames ()) (locals (c.127 tmp-ra.224)))
      (begin
        (set! tmp-ra.224 r15)
        (set! c.127 rdi)
        (set! rax 1480)
        (jump tmp-ra.224 rbp rax)))
    (define L.fun/ascii-char8795.12.22
      ((new-frames ()) (locals (c.126 tmp-ra.225)))
      (begin
        (set! tmp-ra.225 r15)
        (set! c.126 rdi)
        (set! rax 19246)
    ...
    (define L.fun/fixnum8796.11.21
      ((new-frames ())
       (locals (oprand2.32 oprand1.33 oprand0.34 c.125 tmp-ra.226)))
      (begin
        (set! tmp-ra.226 r15)
        (set! c.125 rdi)
        (set! oprand0.34 rsi)
        ...
        (set! oprand2.32 rcx)
        (set! rax 2032)
        (jump tmp-ra.226 rbp rax)))
    (define L.fun/pair8790.10.20
      ((new-frames ()) (locals (cons.105 c.124 tmp-ra.227)))
      (begin
        (set! tmp-ra.227 r15)
        (set! c.124 rdi)
    ...
    (define L.fun/empty8793.9.19
      ((new-frames ())
       (locals (oprand2.29 oprand1.30 oprand0.31 c.123 tmp-ra.228)))
      (begin
        (set! tmp-ra.228 r15)
        (set! c.123 rdi)
        (set! oprand0.31 rsi)
        ...
        (set! oprand2.29 rcx)
        (set! rax 22)
        (jump tmp-ra.228 rbp rax)))
    (define L.fun/pair8788.8.18
      ((new-frames ())
       (locals
        (fun/pair8789.7 oprand2.26 oprand1.27 oprand0.28 c.122 tmp-ra.229)))
      (begin
        (set! tmp-ra.229 r15)
        (set! c.122 rdi)
        (set! oprand0.28 rsi)
    ...
    (define L.fun/pair8789.7.17
      ((new-frames ()) (locals (fun/pair8790.10 c.121 tmp-ra.230)))
      (begin
        (set! tmp-ra.230 r15)
        (set! c.121 rdi)
    ...
    (define L.fun/error8799.6.16
      ((new-frames ())
       (locals (oprand2.23 oprand1.24 oprand0.25 c.120 tmp-ra.231)))
      (begin
        (set! tmp-ra.231 r15)
        (set! c.120 rdi)
        (set! oprand0.25 rsi)
        ...
        (set! oprand2.23 rcx)
        (set! rax 40510)
        (jump tmp-ra.231 rbp rax)))
    (define L.fun/pair8797.5.15
      ((new-frames ())
       (locals
        (fun/pair8798.16 oprand2.20 oprand1.21 oprand0.22 c.119 tmp-ra.232)))
      (begin
        (set! tmp-ra.232 r15)
        (set! c.119 rdi)
        (set! oprand0.22 rsi)
    ...
    (define L.fun/fixnum8791.4.14
      ((new-frames ())
       (locals
        (fun/fixnum8792.13 oprand2.17 oprand1.18 oprand0.19 c.118 tmp-ra.233)))
      (begin
        (set! tmp-ra.233 r15)
        (set! c.118 rdi)
        (set! oprand0.19 rsi)
    ...
    (define L.cons.105.13
      ((new-frames ())
       (locals (tmp.132 tmp.242 tmp.155 tmp.101 tmp.100 c.117 tmp-ra.234)))
      (begin
        (set! tmp-ra.234 r15)
        (set! c.117 rdi)
        (set! tmp.100 rsi)
    ...
    (define L.make-vector.106.12
      ((new-frames ())
       (locals
        (c.116 make-init-vector.1 tmp-ra.235 tmp.157 tmp.81 tmp.243 tmp.156)))
      (begin
        (set! tmp-ra.235 r15)
        (set! c.116 rdi)
        (set! tmp.81 rsi)
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.243 tmp.81)
                      (set! tmp.243 (bitwise-and tmp.243 7))
                      (set! tmp.157 tmp.243))
                    (= tmp.157 0))
                (set! tmp.156 14)
                (set! tmp.156 6))
    ...
    (define L.make-init-vector.1.11
      ...
      (begin
        ...
        (set! tmp.244 tmp.53)
        (set! tmp.244 (arithmetic-shift-right tmp.244 3))
        (set! tmp.161 tmp.244)
        (set! tmp.245 1)
        (set! tmp.245 (+ tmp.245 tmp.161))
        (set! tmp.160 tmp.245)
        (set! tmp.246 tmp.160)
        (set! tmp.246 (* tmp.246 8))
        (set! tmp.159 tmp.246)
        (begin (set! tmp.158 r12) (set! r12 (+ r12 tmp.159)))
        (set! tmp.247 tmp.158)
        (set! tmp.247 (+ tmp.247 3))
        (set! tmp.133 tmp.247)
        (mset! tmp.133 -3 tmp.53)
        (set! tmp.54 tmp.133)
        (set! rcx tmp.54)
        (set! rdx 0)
        (set! rsi tmp.53)
    ...
    (define L.vector-init-loop.55.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.248 i.58)
            (set! tmp.248 (arithmetic-shift-right tmp.248 3))
            (set! tmp.165 tmp.248)
            (set! tmp.249 tmp.165)
            (set! tmp.249 (* tmp.249 8))
            (set! tmp.164 tmp.249)
            (set! tmp.250 tmp.164)
            (set! tmp.250 (+ tmp.250 5))
            (set! tmp.163 tmp.250)
            (mset! vec.57 tmp.163 0)
            (set! tmp.251 i.58)
            (set! tmp.251 (+ tmp.251 8))
            (set! tmp.166 tmp.251)
            (set! rcx vec.57)
            (set! rdx tmp.166)
            (set! rsi len.56)
    ...
    (define L.ascii-char?.107.9
      ((new-frames ()) (locals (c.113 tmp-ra.238 tmp.252 tmp.94 tmp.167)))
      (begin
        (set! tmp-ra.238 r15)
        (set! c.113 rdi)
        (set! tmp.94 rsi)
        (if (begin
              (begin
                (set! tmp.252 tmp.94)
                (set! tmp.252 (bitwise-and tmp.252 255))
                (set! tmp.167 tmp.252))
              (= tmp.167 46))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.253 tmp.78)
                      (set! tmp.253 (bitwise-and tmp.253 7))
                      (set! tmp.169 tmp.253))
                    (= tmp.169 0))
                (set! tmp.168 14)
                (set! tmp.168 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.254 tmp.77)
                        (set! tmp.254 (bitwise-and tmp.254 7))
                        (set! tmp.171 tmp.254))
                      (= tmp.171 0))
                  (set! tmp.170 14)
                  (set! tmp.170 6))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.255 tmp.68)
                      (set! tmp.255 (bitwise-and tmp.255 7))
                      (set! tmp.173 tmp.255))
                    (= tmp.173 0))
                (set! tmp.172 14)
                (set! tmp.172 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.256 tmp.67)
                        (set! tmp.256 (bitwise-and tmp.256 7))
                        (set! tmp.175 tmp.256))
                      (= tmp.175 0))
                  (set! tmp.174 14)
                  (set! tmp.174 6))
            ...
            (begin
              (set! tmp.257 tmp.68)
              (set! tmp.257 (arithmetic-shift-right tmp.257 3))
              (set! tmp.176 tmp.257)
              (set! tmp.258 tmp.67)
              (set! tmp.258 (* tmp.258 tmp.176))
              (set! rax tmp.258)
    ...
    (begin
      (set! tmp-ra.241 r15)
      (begin (set! tmp.177 r12) (set! r12 (+ r12 16)))
      (set! tmp.259 tmp.177)
      (set! tmp.259 (+ tmp.259 2))
      (set! tmp.134 tmp.259)
      (mset! tmp.134 -2 L.*.109.7)
      (mset! tmp.134 6 16)
      (set! *.109 tmp.134)
      (begin (set! tmp.178 r12) (set! r12 (+ r12 16)))
      (set! tmp.260 tmp.178)
      (set! tmp.260 (+ tmp.260 2))
      (set! tmp.135 tmp.260)
      (mset! tmp.135 -2 L.>.108.8)
      (mset! tmp.135 6 16)
      (set! >.108 tmp.135)
      (begin (set! tmp.179 r12) (set! r12 (+ r12 16)))
      (set! tmp.261 tmp.179)
      (set! tmp.261 (+ tmp.261 2))
      (set! tmp.136 tmp.261)
      (mset! tmp.136 -2 L.ascii-char?.107.9)
      (mset! tmp.136 6 8)
      (set! ascii-char?.107 tmp.136)
      (begin (set! tmp.180 r12) (set! r12 (+ r12 24)))
      (set! tmp.262 tmp.180)
      (set! tmp.262 (+ tmp.262 2))
      (set! tmp.137 tmp.262)
      (mset! tmp.137 -2 L.vector-init-loop.55.10)
      (mset! tmp.137 6 24)
      (set! vector-init-loop.55 tmp.137)
      (begin (set! tmp.181 r12) (set! r12 (+ r12 24)))
      (set! tmp.263 tmp.181)
      (set! tmp.263 (+ tmp.263 2))
      (set! tmp.138 tmp.263)
      (mset! tmp.138 -2 L.make-init-vector.1.11)
      (mset! tmp.138 6 8)
      (set! make-init-vector.1 tmp.138)
      (begin (set! tmp.182 r12) (set! r12 (+ r12 24)))
      (set! tmp.264 tmp.182)
      (set! tmp.264 (+ tmp.264 2))
      (set! tmp.139 tmp.264)
      (mset! tmp.139 -2 L.make-vector.106.12)
      (mset! tmp.139 6 8)
      (set! make-vector.106 tmp.139)
      (begin (set! tmp.183 r12) (set! r12 (+ r12 16)))
      (set! tmp.265 tmp.183)
      (set! tmp.265 (+ tmp.265 2))
      (set! tmp.140 tmp.265)
      (mset! tmp.140 -2 L.cons.105.13)
      (mset! tmp.140 6 16)
      (set! cons.105 tmp.140)
      (begin (set! tmp.184 r12) (set! r12 (+ r12 24)))
      (set! tmp.266 tmp.184)
      (set! tmp.266 (+ tmp.266 2))
      (set! tmp.141 tmp.266)
      (mset! tmp.141 -2 L.fun/fixnum8791.4.14)
      (mset! tmp.141 6 24)
      (set! fun/fixnum8791.4 tmp.141)
      (begin (set! tmp.185 r12) (set! r12 (+ r12 24)))
      (set! tmp.267 tmp.185)
      (set! tmp.267 (+ tmp.267 2))
      (set! tmp.142 tmp.267)
      (mset! tmp.142 -2 L.fun/pair8797.5.15)
      (mset! tmp.142 6 24)
      (set! fun/pair8797.5 tmp.142)
      (begin (set! tmp.186 r12) (set! r12 (+ r12 16)))
      (set! tmp.268 tmp.186)
      (set! tmp.268 (+ tmp.268 2))
      (set! tmp.143 tmp.268)
      (mset! tmp.143 -2 L.fun/error8799.6.16)
      (mset! tmp.143 6 24)
      (set! fun/error8799.6 tmp.143)
      (begin (set! tmp.187 r12) (set! r12 (+ r12 24)))
      (set! tmp.269 tmp.187)
      (set! tmp.269 (+ tmp.269 2))
      (set! tmp.144 tmp.269)
      (mset! tmp.144 -2 L.fun/pair8789.7.17)
      (mset! tmp.144 6 0)
      (set! fun/pair8789.7 tmp.144)
      (begin (set! tmp.188 r12) (set! r12 (+ r12 24)))
      (set! tmp.270 tmp.188)
      (set! tmp.270 (+ tmp.270 2))
      (set! tmp.145 tmp.270)
      (mset! tmp.145 -2 L.fun/pair8788.8.18)
      (mset! tmp.145 6 24)
      (set! fun/pair8788.8 tmp.145)
      (begin (set! tmp.189 r12) (set! r12 (+ r12 16)))
      (set! tmp.271 tmp.189)
      (set! tmp.271 (+ tmp.271 2))
      (set! tmp.146 tmp.271)
      (mset! tmp.146 -2 L.fun/empty8793.9.19)
      (mset! tmp.146 6 24)
      (set! fun/empty8793.9 tmp.146)
      (begin (set! tmp.190 r12) (set! r12 (+ r12 24)))
      (set! tmp.272 tmp.190)
      (set! tmp.272 (+ tmp.272 2))
      (set! tmp.147 tmp.272)
      ...
      (set! tmp.199 rax)
      (if (begin (set! tmp.279 6) (!= tmp.279 6))
        (set! tmp.200 22)
        (set! tmp.200 22))
      ...
      (return-point L.rp.31
        (begin
          ...
          (set! r15 L.rp.31)
          (jump L.fun/fixnum8791.4.14 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.198 rax)
      (if (begin (set! tmp.280 14) (!= tmp.280 6))
        (set! tmp.203 1456)
        (set! tmp.203 1672))
      ...
      (return-point L.rp.33
        (begin
          ...
          (jump L.make-vector.106.12 rbp r15 rdi rsi)))
      (set! vector2.42 rax)
      (begin (set! tmp.207 r12) (set! r12 (+ r12 16)))
      (set! tmp.281 tmp.207)
      (set! tmp.281 (+ tmp.281 2))
      (set! tmp.154 tmp.281)
      ...
      (return-point L.rp.34
        (begin
          ...
          (set! r15 L.rp.34)
          (jump L.fun/fixnum8796.11.21 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.208 rax)
      ...
      (set! tmp.210 rax)
      (if (begin (set! tmp.282 14) (!= tmp.282 6))
        (set! tmp.211 30)
        (set! tmp.211 30))
      ...
      (return-point L.rp.39
        (begin
          ...
          (set! r15 L.rp.39)
          (jump L.fun/ascii-char8794.15.25 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.212 rax)
      (return-point L.rp.40
        (begin
          ...
          (set! r15 L.rp.40)
          (jump L.fun/pair8797.5.15 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.209 rax)
      (if (begin (set! tmp.283 6) (!= tmp.283 6))
        (begin
      ...
      (return-point L.rp.43
        (begin
          ...
          (jump L.fun/ascii-char8794.15.25 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.204 rax)
      (if (begin (set! tmp.284 14) (!= tmp.284 6))
        (begin
      ...
      (return-point L.rp.49
        (begin
          ...
          (set! r15 L.rp.49)
          (jump L.fun/error8800.14.24 rbp r15 rdi rsi rdx rcx)))
      (set! tmp.216 rax)
      (set! rcx tmp.216)
      (set! rdx tmp.204)
      (set! rsi tmp.197)
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8928.15.18
      ((new-frames ()) (locals (c.84 tmp-ra.109)))
      (begin
        (set! tmp-ra.109 r15)
        (set! c.84 rdi)
        (set! rax 30)
    ...
    (define L.fun/error8924.14.17
      ((new-frames ()) (locals (c.83 tmp-ra.110)))
      (begin
        (set! tmp-ra.110 r15)
        (set! c.83 rdi)
        (set! rax 33342)
    ...
    (define L.fun/ascii-char8925.13.16
      ((new-frames ()) (locals (fun/ascii-char8926.5 c.82 tmp-ra.111)))
      (begin
        (set! tmp-ra.111 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/error8920.12.15
      ((new-frames ()) (locals (c.81 tmp-ra.112)))
      (begin
        (set! tmp-ra.112 r15)
        (set! c.81 rdi)
        (set! rax 47422)
    ...
    (define L.fun/empty8930.11.14
      ((new-frames ()) (locals (c.80 tmp-ra.113)))
      (begin
        (set! tmp-ra.113 r15)
        (set! c.80 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char8922.10.13
      ((new-frames ()) (locals (c.79 tmp-ra.114)))
      (begin
        (set! tmp-ra.114 r15)
        (set! c.79 rdi)
        (set! rax 27438)
    ...
    (define L.fun/error8919.9.12
      ((new-frames ()) (locals (fun/error8920.12 c.78 tmp-ra.115)))
      (begin
        (set! tmp-ra.115 r15)
        (set! c.78 rdi)
    ...
    (define L.fun/ascii-char8921.8.11
      ((new-frames ()) (locals (fun/ascii-char8922.10 c.77 tmp-ra.116)))
      (begin
        (set! tmp-ra.116 r15)
        (set! c.77 rdi)
    ...
    (define L.fun/void8927.7.10
      ((new-frames ()) (locals (fun/void8928.15 c.76 tmp-ra.117)))
      (begin
        (set! tmp-ra.117 r15)
        (set! c.76 rdi)
    ...
    (define L.fun/empty8929.6.9
      ((new-frames ()) (locals (fun/empty8930.11 c.75 tmp-ra.118)))
      (begin
        (set! tmp-ra.118 r15)
        (set! c.75 rdi)
    ...
    (define L.fun/ascii-char8926.5.8
      ((new-frames ()) (locals (c.74 tmp-ra.119)))
      (begin
        (set! tmp-ra.119 r15)
        (set! c.74 rdi)
        (set! rax 30766)
        (jump tmp-ra.119 rbp rax)))
    (define L.fun/error8923.4.7
      ((new-frames ()) (locals (fun/error8924.14 c.73 tmp-ra.120)))
      (begin
        (set! tmp-ra.120 r15)
        (set! c.73 rdi)
    ...
    (begin
      (set! tmp-ra.121 r15)
      (begin (set! tmp.97 r12) (set! r12 (+ r12 24)))
      (set! tmp.122 tmp.97)
      (set! tmp.122 (+ tmp.122 2))
      (set! tmp.85 tmp.122)
...
(check-by-interp
 '(module
    ...
    (define L.fun/void9118.9.17
      ((new-frames ()) (locals (fun/void9119.7 c.83 tmp-ra.149)))
      (begin
        (set! tmp-ra.149 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/ascii-char9122.8.16
      ((new-frames ()) (locals (fun/ascii-char9123.5 c.82 tmp-ra.150)))
      (begin
        (set! tmp-ra.150 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/void9119.7.15
      ((new-frames ()) (locals (c.81 tmp-ra.151)))
      (begin
        (set! tmp-ra.151 r15)
        (set! c.81 rdi)
        (set! rax 30)
    ...
    (define L.fun/empty9120.6.14
      ((new-frames ()) (locals (fun/empty9121.4 c.80 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.80 rdi)
    ...
    (define L.fun/ascii-char9123.5.13
      ((new-frames ()) (locals (c.79 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.79 rdi)
        (set! rax 29486)
    ...
    (define L.fun/empty9121.4.12
      ((new-frames ()) (locals (c.78 tmp-ra.154)))
      (begin
        (set! tmp-ra.154 r15)
        (set! c.78 rdi)
        (set! rax 22)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.161 tmp.34)
                      (set! tmp.161 (bitwise-and tmp.161 7))
                      (set! tmp.104 tmp.161))
                    (= tmp.104 0))
                (set! tmp.103 14)
                (set! tmp.103 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.162 tmp.33)
                        (set! tmp.162 (bitwise-and tmp.162 7))
                        (set! tmp.106 tmp.162))
                      (= tmp.106 0))
                  (set! tmp.105 14)
                  (set! tmp.105 6))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.164 tmp.30)
                      (set! tmp.164 (bitwise-and tmp.164 7))
                      (set! tmp.108 tmp.164))
                    (= tmp.108 0))
                (set! tmp.107 14)
                (set! tmp.107 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.165 tmp.29)
                        (set! tmp.165 (bitwise-and tmp.165 7))
                        (set! tmp.110 tmp.165))
                      (= tmp.110 0))
                  (set! tmp.109 14)
                  (set! tmp.109 6))
            ...
            (begin
              (set! tmp.166 tmp.30)
              (set! tmp.166 (arithmetic-shift-right tmp.166 3))
              (set! tmp.111 tmp.166)
              (set! tmp.167 tmp.29)
              (set! tmp.167 (* tmp.167 tmp.111))
              (set! rax tmp.167)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.168 tmp.32)
                      (set! tmp.168 (bitwise-and tmp.168 7))
                      (set! tmp.113 tmp.168))
                    (= tmp.113 0))
                (set! tmp.112 14)
                (set! tmp.112 6))
    ...
    (begin
      ...
      (set! empty2.12 rax)
      (begin (set! tmp.141 r12) (set! r12 (+ r12 40)))
      (set! tmp.186 tmp.141)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () ()))
     (locals
      (tmp.113
       ...
       tmp.147)))
    (define L.lam.80.23
      ((new-frames ()) (locals (fun/ascii-char9132.7 c.97 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.97 rdi)
    ...
    (define L.lam.79.22
      ((new-frames ()) (locals (fun/void9126.12 c.96 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.96 rdi)
    ...
    (define L.fun/vector9134.11.19
      ((new-frames ()) (locals (make-vector.76 c.93 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.93 rdi)
    ...
    (define L.fun/ascii-char9129.10.18
      ((new-frames ()) (locals (c.92 tmp-ra.161)))
      (begin
        (set! tmp-ra.161 r15)
        (set! c.92 rdi)
        (set! rax 20526)
    ...
    (define L.fun/empty9128.6.14
      ((new-frames ()) (locals (c.88 tmp-ra.165)))
      (begin
        (set! tmp-ra.165 r15)
        (set! c.88 rdi)
        (set! rax 22)
    ...
    (define L.fun/error9127.4.12
      ((new-frames ()) (locals (c.86 tmp-ra.167)))
      (begin
        (set! tmp-ra.167 r15)
        (set! c.86 rdi)
        (set! rax 42814)
    ...
    (define L.make-vector.76.11
      ((new-frames ())
       (locals
        (c.85 make-init-vector.1 tmp-ra.168 tmp.117 tmp.52 tmp.174 tmp.116)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.85 rdi)
        (set! tmp.52 rsi)
    ...
    (define L.make-init-vector.1.10
      ...
      (begin
        ...
        (set! tmp.121 tmp.175)
        (set! tmp.176 1)
        (set! tmp.176 (+ tmp.176 tmp.121))
        (set! tmp.120 tmp.176)
        (set! tmp.177 tmp.120)
        (set! tmp.177 (* tmp.177 8))
        (set! tmp.119 tmp.177)
        (begin (set! tmp.118 r12) (set! r12 (+ r12 tmp.119)))
        (set! tmp.178 tmp.118)
        (set! tmp.178 (+ tmp.178 3))
        (set! tmp.98 tmp.178)
        (mset! tmp.98 -3 tmp.24)
        (set! tmp.25 tmp.98)
        (set! rcx tmp.25)
        (set! rdx 0)
        (set! rsi tmp.24)
    ...
    (define L.vector-init-loop.26.9
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.179 i.29)
            (set! tmp.179 (arithmetic-shift-right tmp.179 3))
            (set! tmp.125 tmp.179)
            (set! tmp.180 tmp.125)
            (set! tmp.180 (* tmp.180 8))
            (set! tmp.124 tmp.180)
            (set! tmp.181 tmp.124)
            (set! tmp.181 (+ tmp.181 5))
            (set! tmp.123 tmp.181)
            (mset! vec.28 tmp.123 0)
            (set! tmp.182 i.29)
            (set! tmp.182 (+ tmp.182 8))
            (set! tmp.126 tmp.182)
            (set! rcx vec.28)
            (set! rdx tmp.126)
            (set! rsi len.27)
    ...
    (define L.vector?.77.8
      ((new-frames ()) (locals (c.82 tmp-ra.171 tmp.183 tmp.68 tmp.127)))
      (begin
        (set! tmp-ra.171 r15)
        (set! c.82 rdi)
        (set! tmp.68 rsi)
    ...
    (begin
      ...
      (if (begin
            (begin
              (if (begin (set! tmp.201 6) (!= tmp.201 6))
                (set! tmp.148 22)
                (set! tmp.148 30))
              (return-point L.rp.24
                (begin
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals
      (empty4.16
       ...
       tmp.128
       tmp.101
       fun/ascii-char9194.4
       tmp.87
       tmp.127
       tmp.100
       tmp-ra.126)))
    (define L.lam.73.19
      ((new-frames ()) (locals (fun/error9191.12 c.86 tmp-ra.113)))
      (begin
        (set! tmp-ra.113 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/void9201.15.18
      ((new-frames ()) (locals (fun/void9202.11 c.85 tmp-ra.114)))
      (begin
        (set! tmp-ra.114 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/error9192.14.17
      ((new-frames ()) (locals (c.84 tmp-ra.115)))
      (begin
        (set! tmp-ra.115 r15)
        (set! c.84 rdi)
        (set! rax 54590)
    ...
    (define L.fun/error9196.13.16
      ((new-frames ()) (locals (c.83 tmp-ra.116)))
      (begin
        (set! tmp-ra.116 r15)
        (set! c.83 rdi)
        (set! rax 50750)
    ...
    (define L.fun/error9191.12.15
      ((new-frames ()) (locals (fun/error9192.14 c.82 tmp-ra.117)))
      (begin
        (set! tmp-ra.117 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/void9202.11.14
      ((new-frames ()) (locals (c.81 tmp-ra.118)))
      (begin
        (set! tmp-ra.118 r15)
        (set! c.81 rdi)
        (set! rax 30)
    ...
    (define L.fun/empty9200.10.13
      ((new-frames ()) (locals (c.80 tmp-ra.119)))
      (begin
        (set! tmp-ra.119 r15)
        (set! c.80 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char9193.9.12
      ((new-frames ()) (locals (fun/ascii-char9194.4 c.79 tmp-ra.120)))
      (begin
        (set! tmp-ra.120 r15)
        (set! c.79 rdi)
    ...
    (define L.fun/void9198.8.11
      ((new-frames ()) (locals (c.78 tmp-ra.121)))
      (begin
        (set! tmp-ra.121 r15)
        (set! c.78 rdi)
        (set! rax 30)
    ...
    (define L.fun/empty9199.7.10
      ((new-frames ()) (locals (fun/empty9200.10 c.77 tmp-ra.122)))
      (begin
        (set! tmp-ra.122 r15)
        (set! c.77 rdi)
    ...
    (define L.fun/error9195.6.9
      ((new-frames ()) (locals (fun/error9196.13 c.76 tmp-ra.123)))
      (begin
        (set! tmp-ra.123 r15)
        (set! c.76 rdi)
    ...
    (define L.fun/void9197.5.8
      ((new-frames ()) (locals (fun/void9198.8 c.75 tmp-ra.124)))
      (begin
        (set! tmp-ra.124 r15)
        (set! c.75 rdi)
    ...
    (define L.fun/ascii-char9194.4.7
      ((new-frames ()) (locals (c.74 tmp-ra.125)))
      (begin
        (set! tmp-ra.125 r15)
        (set! c.74 rdi)
        (set! rax 26158)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () ()))
     (locals
       ...
       *.73
       ...
       tmp-ra.175)))
    (define L.lam.75.23
      ((new-frames ()) (locals (fun/vector9888.10 c.92 tmp-ra.158)))
      (begin
        (set! tmp-ra.158 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/vector9889.13.22
      ((new-frames ()) (locals (make-vector.71 c.91 tmp-ra.159)))
      (begin
        (set! tmp-ra.159 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/void9885.12.21
      ((new-frames ()) (locals (c.90 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.90 rdi)
        (set! rax 30)
    ...
    (define L.fun/ascii-char9886.11.20
      ((new-frames ()) (locals (fun/ascii-char9887.6 c.89 tmp-ra.161)))
      (begin
        (set! tmp-ra.161 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/vector9888.10.19
      ((new-frames ()) (locals (fun/vector9889.13 c.88 tmp-ra.162)))
      (begin
        (set! tmp-ra.162 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/void9891.9.18
      ((new-frames ()) (locals (c.87 tmp-ra.163)))
      (begin
        (set! tmp-ra.163 r15)
        (set! c.87 rdi)
        (set! rax 30)
    ...
    (define L.fun/void9884.8.17
      ((new-frames ()) (locals (fun/void9885.12 c.86 tmp-ra.164)))
      (begin
        (set! tmp-ra.164 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/ascii-char9892.7.16
      ((new-frames ()) (locals (fun/ascii-char9893.4 c.85 tmp-ra.165)))
      (begin
        (set! tmp-ra.165 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/ascii-char9887.6.15
      ((new-frames ()) (locals (c.84 tmp-ra.166)))
      (begin
        (set! tmp-ra.166 r15)
        (set! c.84 rdi)
        (set! rax 23854)
    ...
    (define L.fun/void9890.5.14
      ((new-frames ()) (locals (fun/void9891.9 c.83 tmp-ra.167)))
      (begin
        (set! tmp-ra.167 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/ascii-char9893.4.13
      ((new-frames ()) (locals (c.82 tmp-ra.168)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.82 rdi)
        (set! rax 20782)
    ...
    (define L.make-vector.71.12
      ((new-frames ())
       (locals
        (c.81 make-init-vector.1 tmp-ra.169 tmp.112 tmp.47 tmp.176 tmp.111)))
      (begin
        (set! tmp-ra.169 r15)
        (set! c.81 rdi)
        (set! tmp.47 rsi)
    ...
    (define L.make-init-vector.1.11
      ...
      (begin
        ...
        (set! tmp.116 tmp.177)
        (set! tmp.178 1)
        (set! tmp.178 (+ tmp.178 tmp.116))
        (set! tmp.115 tmp.178)
        (set! tmp.179 tmp.115)
        (set! tmp.179 (* tmp.179 8))
        (set! tmp.114 tmp.179)
        (begin (set! tmp.113 r12) (set! r12 (+ r12 tmp.114)))
        (set! tmp.180 tmp.113)
        (set! tmp.180 (+ tmp.180 3))
        (set! tmp.93 tmp.180)
        (mset! tmp.93 -3 tmp.19)
        (set! tmp.20 tmp.93)
        (set! rcx tmp.20)
        (set! rdx 0)
        (set! rsi tmp.19)
    ...
    (define L.vector-init-loop.21.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.181 i.24)
            (set! tmp.181 (arithmetic-shift-right tmp.181 3))
            (set! tmp.120 tmp.181)
            (set! tmp.182 tmp.120)
            (set! tmp.182 (* tmp.182 8))
            (set! tmp.119 tmp.182)
            (set! tmp.183 tmp.119)
            (set! tmp.183 (+ tmp.183 5))
            (set! tmp.118 tmp.183)
            (mset! vec.23 tmp.118 0)
            (set! tmp.184 i.24)
            (set! tmp.184 (+ tmp.184 8))
            (set! tmp.121 tmp.184)
            (set! rcx vec.23)
            (set! rdx tmp.121)
            (set! rsi len.22)
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.190 tmp.34)
              (set! tmp.190 (arithmetic-shift-right tmp.190 3))
              (set! tmp.130 tmp.190)
              (set! tmp.191 tmp.33)
              (set! tmp.191 (* tmp.191 tmp.130))
              (set! rax tmp.191)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () () () () () ()))
     (locals
       ...
       *.72
       ...
       tmp-ra.182)))
    (define L.lam.74.22
      ((new-frames ()) (locals (fun/void10281.10 c.90 tmp-ra.166)))
      (begin
        (set! tmp-ra.166 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/void10281.10.21
      ((new-frames ()) (locals (fun/void10282.4 c.89 tmp-ra.167)))
      (begin
        (set! tmp-ra.167 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/any10280.9.20
      ((new-frames ()) (locals (c.88 tmp-ra.168)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.88 rdi)
        (set! rax 6)
    ...
    (define L.fun/vector10279.8.19
      ((new-frames ()) (locals (make-vector.68 c.87 tmp-ra.169)))
      (begin
        (set! tmp-ra.169 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/empty10283.7.18
      ((new-frames ()) (locals (fun/empty10284.5 c.86 tmp-ra.170)))
      (begin
        (set! tmp-ra.170 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/vector10278.6.17
      ((new-frames ()) (locals (fun/vector10279.8 c.85 tmp-ra.171)))
      (begin
        (set! tmp-ra.171 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/empty10284.5.16
      ((new-frames ()) (locals (c.84 tmp-ra.172)))
      (begin
        (set! tmp-ra.172 r15)
        (set! c.84 rdi)
        (set! rax 22)
    ...
    (define L.fun/void10282.4.15
      ((new-frames ()) (locals (c.83 tmp-ra.173)))
      (begin
        (set! tmp-ra.173 r15)
        (set! c.83 rdi)
        (set! rax 30)
    ...
    (define L.make-vector.68.14
      ((new-frames ())
       (locals
        (c.82 make-init-vector.1 tmp-ra.174 tmp.109 tmp.44 tmp.183 tmp.108)))
      (begin
        (set! tmp-ra.174 r15)
        (set! c.82 rdi)
        (set! tmp.44 rsi)
    ...
    (define L.make-init-vector.1.13
      ...
      (begin
        ...
        (set! tmp.184 tmp.16)
        (set! tmp.184 (arithmetic-shift-right tmp.184 3))
        (set! tmp.113 tmp.184)
        (set! tmp.185 1)
        (set! tmp.185 (+ tmp.185 tmp.113))
        (set! tmp.112 tmp.185)
        (set! tmp.186 tmp.112)
        (set! tmp.186 (* tmp.186 8))
        (set! tmp.111 tmp.186)
        (begin (set! tmp.110 r12) (set! r12 (+ r12 tmp.111)))
        (set! tmp.187 tmp.110)
        (set! tmp.187 (+ tmp.187 3))
        (set! tmp.91 tmp.187)
        (mset! tmp.91 -3 tmp.16)
        (set! tmp.17 tmp.91)
        (set! rcx tmp.17)
        (set! rdx 0)
        (set! rsi tmp.16)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (jump L.vector-init-loop.18.12 rbp r15 rdi rsi rdx rcx)))))
    (define L.void?.69.11
      ((new-frames ()) (locals (c.79 tmp-ra.177 tmp.192 tmp.56 tmp.119)))
      (begin
        (set! tmp-ra.177 r15)
        (set! c.79 rdi)
        (set! tmp.56 rsi)
        (if (begin
              (begin
                (set! tmp.192 tmp.56)
                (set! tmp.192 (bitwise-and tmp.192 255))
                (set! tmp.119 tmp.192))
              (= tmp.119 30))
...
(check-by-interp
 '(module
    ...
    (define L.fun/void10625.9.15
      ((new-frames ()) (locals (fun/void10626.6 c.78 tmp-ra.128)))
      (begin
        (set! tmp-ra.128 r15)
        (set! c.78 rdi)
    ...
    (define L.fun/void10628.8.14
      ((new-frames ()) (locals (c.77 tmp-ra.129)))
      (begin
        (set! tmp-ra.129 r15)
        (set! c.77 rdi)
        (set! rax 30)
    ...
    (define L.fun/void10627.7.13
      ((new-frames ()) (locals (fun/void10628.8 c.76 tmp-ra.130)))
      (begin
        (set! tmp-ra.130 r15)
        (set! c.76 rdi)
    ...
    (define L.fun/error10624.5.11
      ((new-frames ()) (locals (c.74 tmp-ra.132)))
      (begin
        (set! tmp-ra.132 r15)
        (set! c.74 rdi)
        (set! rax 19262)
    ...
    (define L.fun/error10623.4.10
      ((new-frames ()) (locals (fun/error10624.5 c.73 tmp-ra.133)))
      (begin
        (set! tmp-ra.133 r15)
        (set! c.73 rdi)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.138 tmp.32)
                      (set! tmp.138 (bitwise-and tmp.138 7))
                      (set! tmp.89 tmp.138))
                    (= tmp.89 0))
                (set! tmp.88 14)
                (set! tmp.88 6))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.141 tmp.34)
                      (set! tmp.141 (bitwise-and tmp.141 7))
                      (set! tmp.93 tmp.141))
                    (= tmp.93 0))
                (set! tmp.92 14)
                (set! tmp.92 6))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.144 tmp.30)
                      (set! tmp.144 (bitwise-and tmp.144 7))
                      (set! tmp.97 tmp.144))
                    (= tmp.97 0))
                (set! tmp.96 14)
                (set! tmp.96 6))
          ...
          (if (begin
            ...
            (begin
              (set! tmp.146 tmp.30)
              (set! tmp.146 (arithmetic-shift-right tmp.146 3))
              (set! tmp.100 tmp.146)
              (set! tmp.147 tmp.29)
              (set! tmp.147 (* tmp.147 tmp.100))
              (set! rax tmp.147)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals
      (void4.15
       ...
       tmp-ra.153)))
    (define L.lam.74.22
      ((new-frames ()) (locals (fun/ascii-char10710.8 c.90 tmp-ra.137)))
      (begin
        (set! tmp-ra.137 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/void10716.14.21
      ((new-frames ()) (locals (c.89 tmp-ra.138)))
      (begin
        (set! tmp-ra.138 r15)
        (set! c.89 rdi)
        (set! rax 30)
    ...
    (define L.fun/empty10709.13.20
      ((new-frames ()) (locals (c.88 tmp-ra.139)))
      (begin
        (set! tmp-ra.139 r15)
        (set! c.88 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char10711.12.19
      ((new-frames ()) (locals (c.87 tmp-ra.140)))
      (begin
        (set! tmp-ra.140 r15)
        (set! c.87 rdi)
        (set! rax 23342)
    ...
    (define L.fun/vector10713.11.18
      ((new-frames ()) (locals (make-vector.72 c.86 tmp-ra.141)))
      (begin
        (set! tmp-ra.141 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/error10717.10.17
      ((new-frames ()) (locals (fun/error10718.4 c.85 tmp-ra.142)))
      (begin
        (set! tmp-ra.142 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/empty10708.9.16
      ((new-frames ()) (locals (fun/empty10709.13 c.84 tmp-ra.143)))
      (begin
        (set! tmp-ra.143 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/ascii-char10710.8.15
      ((new-frames ()) (locals (fun/ascii-char10711.12 c.83 tmp-ra.144)))
      (begin
        (set! tmp-ra.144 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/vector10712.7.14
      ((new-frames ()) (locals (fun/vector10713.11 c.82 tmp-ra.145)))
      (begin
        (set! tmp-ra.145 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/void10715.6.13
      ((new-frames ()) (locals (fun/void10716.14 c.81 tmp-ra.146)))
      (begin
        (set! tmp-ra.146 r15)
        (set! c.81 rdi)
    ...
    (define L.fun/any10714.5.12
      ((new-frames ()) (locals (make-vector.72 c.80 tmp-ra.147)))
      (begin
        (set! tmp-ra.147 r15)
        (set! c.80 rdi)
    ...
    (define L.fun/error10718.4.11
      ((new-frames ()) (locals (c.79 tmp-ra.148)))
      (begin
        (set! tmp-ra.148 r15)
        (set! c.79 rdi)
        (set! rax 46910)
        (jump tmp-ra.148 rbp rax)))
    (define L.make-vector.72.10
      ((new-frames ())
       (locals
        (c.78 make-init-vector.1 tmp-ra.149 tmp.109 tmp.48 tmp.154 tmp.108)))
      (begin
        (set! tmp-ra.149 r15)
        (set! c.78 rdi)
        (set! tmp.48 rsi)
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.154 tmp.48)
                      (set! tmp.154 (bitwise-and tmp.154 7))
                      (set! tmp.109 tmp.154))
                    (= tmp.109 0))
                (set! tmp.108 14)
                (set! tmp.108 6))
    ...
    (define L.make-init-vector.1.9
      ...
      (begin
        ...
        (set! tmp.155 tmp.20)
        (set! tmp.155 (arithmetic-shift-right tmp.155 3))
        (set! tmp.113 tmp.155)
        (set! tmp.156 1)
        (set! tmp.156 (+ tmp.156 tmp.113))
        (set! tmp.112 tmp.156)
        (set! tmp.157 tmp.112)
        (set! tmp.157 (* tmp.157 8))
        (set! tmp.111 tmp.157)
        (begin (set! tmp.110 r12) (set! r12 (+ r12 tmp.111)))
        (set! tmp.158 tmp.110)
        (set! tmp.158 (+ tmp.158 3))
        (set! tmp.91 tmp.158)
        (mset! tmp.91 -3 tmp.20)
        (set! tmp.21 tmp.91)
        (set! rcx tmp.21)
        (set! rdx 0)
        (set! rsi tmp.20)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.117 tmp.159)
            (set! tmp.160 tmp.117)
            (set! tmp.160 (* tmp.160 8))
            (set! tmp.116 tmp.160)
            (set! tmp.161 tmp.116)
            (set! tmp.161 (+ tmp.161 5))
            (set! tmp.115 tmp.161)
    ...
    (define L.fixnum?.73.7
      ((new-frames ()) (locals (c.75 tmp-ra.152 tmp.163 tmp.57 tmp.119)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.75 rdi)
        (set! tmp.57 rsi)
 ...
 '(module
    ...
    (define L.lam.75.24
      ...
      (begin
        ...
        (jump L.+.71.9 rbp r15 rdi rsi rdx)))
    (define L.lam.74.23
      ((new-frames ()) (locals (fun/ascii-char10795.7 c.92 tmp-ra.167)))
      (begin
        (set! tmp-ra.167 r15)
        (set! c.92 rdi)
    ...
    (define L.lam.73.22
      ((new-frames ()) (locals (fun/void10791.4 c.91 tmp-ra.168)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/ascii-char10793.11.21
      ((new-frames ()) (locals (fun/ascii-char10794.5 c.90 tmp-ra.169)))
      (begin
        (set! tmp-ra.169 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/void10792.10.20
      ((new-frames ()) (locals (c.89 tmp-ra.170)))
      (begin
        (set! tmp-ra.170 r15)
        (set! c.89 rdi)
        (set! rax 30)
    ...
    (define L.fun/vector10790.9.19
      ((new-frames ()) (locals (make-vector.69 c.88 tmp-ra.171)))
      (begin
        (set! tmp-ra.171 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/vector10789.8.18
      ((new-frames ()) (locals (fun/vector10790.9 c.87 tmp-ra.172)))
      (begin
        (set! tmp-ra.172 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/ascii-char10795.7.17
      ((new-frames ()) (locals (fun/ascii-char10796.6 c.86 tmp-ra.173)))
      (begin
        (set! tmp-ra.173 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/ascii-char10796.6.16
      ((new-frames ()) (locals (c.85 tmp-ra.174)))
      (begin
        (set! tmp-ra.174 r15)
        (set! c.85 rdi)
        (set! rax 27182)
    ...
    (define L.fun/ascii-char10794.5.15
      ((new-frames ()) (locals (c.84 tmp-ra.175)))
      (begin
        (set! tmp-ra.175 r15)
        (set! c.84 rdi)
        (set! rax 17966)
    ...
    (define L.fun/void10791.4.14
      ((new-frames ()) (locals (fun/void10792.10 c.83 tmp-ra.176)))
      (begin
        (set! tmp-ra.176 r15)
        (set! c.83 rdi)
    ...
    (define L.make-vector.69.13
      ((new-frames ())
       (locals
        (c.82 make-init-vector.1 tmp-ra.177 tmp.120 tmp.45 tmp.185 tmp.119)))
      (begin
        (set! tmp-ra.177 r15)
        (set! c.82 rdi)
        (set! tmp.45 rsi)
    ...
    (define L.make-init-vector.1.12
      ...
      (begin
        ...
        (set! tmp.124 tmp.186)
        (set! tmp.187 1)
        (set! tmp.187 (+ tmp.187 tmp.124))
        (set! tmp.123 tmp.187)
        (set! tmp.188 tmp.123)
        (set! tmp.188 (* tmp.188 8))
        (set! tmp.122 tmp.188)
        (begin (set! tmp.121 r12) (set! r12 (+ r12 tmp.122)))
        (set! tmp.189 tmp.121)
        (set! tmp.189 (+ tmp.189 3))
        (set! tmp.94 tmp.189)
        (mset! tmp.94 -3 tmp.17)
        (set! tmp.18 tmp.94)
        (set! rcx tmp.18)
        (set! rdx 0)
        (set! rsi tmp.17)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.127 tmp.191)
            (set! tmp.192 tmp.127)
            (set! tmp.192 (+ tmp.192 5))
            (set! tmp.126 tmp.192)
            (mset! vec.21 tmp.126 0)
            (set! tmp.193 i.22)
            (set! tmp.193 (+ tmp.193 8))
            (set! tmp.129 tmp.193)
            (set! rcx vec.21)
            (set! rdx tmp.129)
            (set! rsi len.20)
    ...
    (begin
      ...
      (begin (set! tmp.157 r12) (set! r12 (+ r12 16)))
      (set! tmp.214 tmp.157)
      (set! tmp.214 (+ tmp.214 2))
      (set! tmp.104 tmp.214)
      ...
      (begin (set! tmp.161 r12) (set! r12 (+ r12 16)))
      (set! tmp.218 tmp.161)
      (set! tmp.218 (+ tmp.218 2))
      (set! tmp.108 tmp.218)
      ...
      (begin (set! tmp.165 r12) (set! r12 (+ r12 32)))
      (set! tmp.222 tmp.165)
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals
      (procedure5.16
       ...
       tmp.146)))
    (define L.lam.77.24
      ((new-frames ()) (locals (fun/pair11669.5 c.95 tmp-ra.151)))
      (begin
        (set! tmp-ra.151 r15)
        (set! c.95 rdi)
    ...
    (define L.lam.76.23
      ((new-frames ()) (locals (fun/empty11659.13 c.94 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.94 rdi)
    ...
    (define L.fun/empty11664.15.22
      ((new-frames ()) (locals (c.93 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.93 rdi)
        (set! rax 22)
    ...
    (define L.fun/void11666.14.21
      ((new-frames ()) (locals (c.92 tmp-ra.154)))
      (begin
        (set! tmp-ra.154 r15)
        (set! c.92 rdi)
        (set! rax 30)
    ...
    (define L.fun/empty11659.13.20
      ((new-frames ()) (locals (fun/empty11660.10 c.91 tmp-ra.155)))
      (begin
        (set! tmp-ra.155 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/error11661.12.19
      ((new-frames ()) (locals (fun/error11662.8 c.90 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/pair11670.11.18
      ((new-frames ()) (locals (cons.75 c.89 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/vector11668.9.16
      ((new-frames ()) (locals (make-vector.74 c.87 tmp-ra.159)))
      (begin
        (set! tmp-ra.159 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/error11662.8.15
      ((new-frames ()) (locals (c.86 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.86 rdi)
        (set! rax 36414)
    ...
    (define L.fun/empty11663.7.14
      ((new-frames ()) (locals (fun/empty11664.15 c.85 tmp-ra.161)))
      (begin
        (set! tmp-ra.161 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/void11665.6.13
      ((new-frames ()) (locals (fun/void11666.14 c.84 tmp-ra.162)))
      (begin
        (set! tmp-ra.162 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/pair11669.5.12
      ((new-frames ()) (locals (fun/pair11670.11 c.83 tmp-ra.163)))
      (begin
        (set! tmp-ra.163 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/vector11667.4.11
      ((new-frames ()) (locals (fun/vector11668.9 c.82 tmp-ra.164)))
      (begin
        (set! tmp-ra.164 r15)
        (set! c.82 rdi)
    ...
    (define L.make-vector.74.10
      ((new-frames ())
       (locals
        (c.81 make-init-vector.1 tmp-ra.165 tmp.117 tmp.50 tmp.170 tmp.116)))
      (begin
        (set! tmp-ra.165 r15)
        (set! c.81 rdi)
        (set! tmp.50 rsi)
    ...
    (define L.make-init-vector.1.9
      ...
      (begin
        ...
        (set! tmp.121 tmp.171)
        (set! tmp.172 1)
        (set! tmp.172 (+ tmp.172 tmp.121))
        (set! tmp.120 tmp.172)
        (set! tmp.173 tmp.120)
        (set! tmp.173 (* tmp.173 8))
        (set! tmp.119 tmp.173)
        (begin (set! tmp.118 r12) (set! r12 (+ r12 tmp.119)))
        (set! tmp.174 tmp.118)
        (set! tmp.174 (+ tmp.174 3))
        (set! tmp.96 tmp.174)
        (mset! tmp.96 -3 tmp.22)
        (set! tmp.23 tmp.96)
        (set! rcx tmp.23)
        (set! rdx 0)
        (set! rsi tmp.22)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.125 tmp.175)
            (set! tmp.176 tmp.125)
            (set! tmp.176 (* tmp.176 8))
            (set! tmp.124 tmp.176)
            (set! tmp.177 tmp.124)
            (set! tmp.177 (+ tmp.177 5))
            (set! tmp.123 tmp.177)
    ...
    (define L.cons.75.7
      ((new-frames ())
       (locals (tmp.97 tmp.179 tmp.127 tmp.70 tmp.69 c.78 tmp-ra.168)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.78 rdi)
        (set! tmp.69 rsi)
    ...
    (begin
      ...
      (if (begin
            ...
            (!= tmp.146 6))
        (if (begin
              (if (begin (set! tmp.149 (mref procedure0.21 6)) (= tmp.149 0))
                (set! tmp.148 14)
                (set! tmp.148 6))
              (!= tmp.148 6))
          (begin
...
(check-by-interp
 '(module
    ...
    (define L.fun/error12035.15.21
      ((new-frames ()) (locals (c.91 tmp-ra.149)))
      (begin
        (set! tmp-ra.149 r15)
        (set! c.91 rdi)
        (set! rax 9790)
    ...
    (define L.fun/ascii-char12031.14.20
      ((new-frames ()) (locals (c.90 tmp-ra.150)))
      (begin
        (set! tmp-ra.150 r15)
        (set! c.90 rdi)
        (set! rax 23854)
    ...
    (define L.fun/error12029.13.19
      ((new-frames ()) (locals (c.89 tmp-ra.151)))
      (begin
        (set! tmp-ra.151 r15)
        (set! c.89 rdi)
        (set! rax 62526)
    ...
    (define L.fun/empty12027.12.18
      ((new-frames ()) (locals (c.88 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.88 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char12032.11.17
      ((new-frames ()) (locals (fun/ascii-char12033.10 c.87 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/ascii-char12033.10.16
      ((new-frames ()) (locals (c.86 tmp-ra.154)))
      (begin
        (set! tmp-ra.154 r15)
        (set! c.86 rdi)
        (set! rax 27438)
    ...
    (define L.fun/error12025.9.15
      ((new-frames ()) (locals (c.85 tmp-ra.155)))
      (begin
        (set! tmp-ra.155 r15)
        (set! c.85 rdi)
        (set! rax 48702)
    ...
    (define L.fun/error12028.8.14
      ((new-frames ()) (locals (fun/error12029.13 c.84 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/error12034.7.13
      ((new-frames ()) (locals (fun/error12035.15 c.83 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/ascii-char12030.6.12
      ((new-frames ()) (locals (fun/ascii-char12031.14 c.82 tmp-ra.158)))
      (begin
        (set! tmp-ra.158 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/error12024.5.11
      ((new-frames ()) (locals (fun/error12025.9 c.81 tmp-ra.159)))
      (begin
        (set! tmp-ra.159 r15)
        (set! c.81 rdi)
    ...
    (define L.fun/empty12026.4.10
      ((new-frames ()) (locals (fun/empty12027.12 c.80 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.80 rdi)
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.170 tmp.37)
              (set! tmp.170 (arithmetic-shift-right tmp.170 3))
              (set! tmp.115 tmp.170)
              (set! tmp.171 tmp.36)
              (set! tmp.171 (* tmp.171 tmp.115))
              (set! rax tmp.171)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals
      (void5.16
       ...
       tmp.120)))
    (define L.lam.75.20
      ((new-frames ()) (locals (fun/pair13985.9 c.89 tmp-ra.125)))
      (begin
        (set! tmp-ra.125 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/void13989.15.19
      ((new-frames ()) (locals (fun/void13990.8 c.88 tmp-ra.126)))
      (begin
        (set! tmp-ra.126 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/void13995.14.18
      ((new-frames ()) (locals (fun/void13996.7 c.87 tmp-ra.127)))
      (begin
        (set! tmp-ra.127 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/error13991.13.17
      ((new-frames ()) (locals (fun/error13992.4 c.86 tmp-ra.128)))
      (begin
        (set! tmp-ra.128 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/pair13986.12.16
      ((new-frames ()) (locals (cons.74 c.85 tmp-ra.129)))
      (begin
        (set! tmp-ra.129 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/ascii-char13988.11.15
      ((new-frames ()) (locals (c.84 tmp-ra.130)))
      (begin
        (set! tmp-ra.130 r15)
        (set! c.84 rdi)
        (set! rax 27182)
    ...
    (define L.fun/void13993.10.14
      ((new-frames ()) (locals (fun/void13994.6 c.83 tmp-ra.131)))
      (begin
        (set! tmp-ra.131 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/pair13985.9.13
      ((new-frames ()) (locals (fun/pair13986.12 c.82 tmp-ra.132)))
      (begin
        (set! tmp-ra.132 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/void13990.8.12
      ((new-frames ()) (locals (c.81 tmp-ra.133)))
      (begin
        (set! tmp-ra.133 r15)
        (set! c.81 rdi)
        (set! rax 30)
    ...
    (define L.fun/void13996.7.11
      ((new-frames ()) (locals (c.80 tmp-ra.134)))
      (begin
        (set! tmp-ra.134 r15)
        (set! c.80 rdi)
        (set! rax 30)
    ...
    (define L.fun/void13994.6.10
      ((new-frames ()) (locals (c.79 tmp-ra.135)))
      (begin
        (set! tmp-ra.135 r15)
        (set! c.79 rdi)
        (set! rax 30)
    ...
    (define L.fun/ascii-char13987.5.9
      ((new-frames ()) (locals (fun/ascii-char13988.11 c.78 tmp-ra.136)))
      (begin
        (set! tmp-ra.136 r15)
        (set! c.78 rdi)
    ...
    (define L.fun/error13992.4.8
      ((new-frames ()) (locals (c.77 tmp-ra.137)))
      (begin
        (set! tmp-ra.137 r15)
        (set! c.77 rdi)
        (set! rax 7486)
    ...
    (define L.cons.74.7
      ((new-frames ())
       (locals (tmp.90 tmp.140 tmp.105 tmp.70 tmp.69 c.76 tmp-ra.138)))
      (begin
        (set! tmp-ra.138 r15)
        (set! c.76 rdi)
        (set! tmp.69 rsi)
    ...
    (begin
      ...
      (if (begin
            (if (begin
                  (begin
                    (set! tmp.155 procedure0.21)
                    (set! tmp.155 (bitwise-and tmp.155 7))
                    (set! tmp.121 tmp.155))
                  (= tmp.121 2))
              (set! tmp.120 14)
              (set! tmp.120 6))
            (!= tmp.120 6))
        (if (begin
              (if (begin (set! tmp.123 (mref procedure0.21 6)) (= tmp.123 0))
                (set! tmp.122 14)
                (set! tmp.122 6))
              (!= tmp.122 6))
          (begin
...
(check-by-interp
 '(module
    ...
    (define L.lam.80.27
      ((new-frames (()))
       (locals (tmp.124 ascii-char?.79 fun/any14746.10 c.101 tmp-ra.187)))
      (begin
        (set! tmp-ra.187 r15)
        (set! c.101 rdi)
    ...
    (define L.fun/vector14739.15.26
      ((new-frames ()) (locals (make-vector.74 c.100 tmp-ra.188)))
      (begin
        (set! tmp-ra.188 r15)
        (set! c.100 rdi)
    ...
    (define L.fun/ascii-char14749.14.25
      ((new-frames ()) (locals (c.99 tmp-ra.189)))
      (begin
        (set! tmp-ra.189 r15)
        (set! c.99 rdi)
        (set! rax 31278)
        (jump tmp-ra.189 rbp rax)))
    (define L.fun/ascii-char14743.13.24
      ((new-frames ()) (locals (c.98 tmp-ra.190)))
      (begin
        (set! tmp-ra.190 r15)
        (set! c.98 rdi)
        (set! rax 26158)
    ...
    (define L.fun/any14741.12.23
      ((new-frames ()) (locals (make-vector.74 c.97 tmp-ra.191)))
      (begin
        (set! tmp-ra.191 r15)
        (set! c.97 rdi)
    ...
    (define L.fun/any14747.11.22
      ((new-frames ()) (locals (c.96 tmp-ra.192)))
      (begin
        (set! tmp-ra.192 r15)
        (set! c.96 rdi)
        (set! rax 22)
    ...
    (define L.fun/any14746.10.21
      ((new-frames ()) (locals (fun/any14747.11 c.95 tmp-ra.193)))
      (begin
        (set! tmp-ra.193 r15)
        (set! c.95 rdi)
    ...
    (define L.fun/ascii-char14742.9.20
      ((new-frames ()) (locals (fun/ascii-char14743.13 c.94 tmp-ra.194)))
      (begin
        (set! tmp-ra.194 r15)
        (set! c.94 rdi)
    ...
    (define L.fun/ascii-char14748.8.19
      ((new-frames ()) (locals (fun/ascii-char14749.14 c.93 tmp-ra.195)))
      (begin
        (set! tmp-ra.195 r15)
        (set! c.93 rdi)
    ...
    (define L.fun/any14740.7.18
      ((new-frames ()) (locals (fun/any14741.12 c.92 tmp-ra.196)))
      (begin
        (set! tmp-ra.196 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/vector14744.6.17
      ((new-frames ()) (locals (fun/vector14745.5 c.91 tmp-ra.197)))
      (begin
        (set! tmp-ra.197 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/vector14745.5.16
      ((new-frames ()) (locals (make-vector.74 c.90 tmp-ra.198)))
      (begin
        (set! tmp-ra.198 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/vector14738.4.15
      ((new-frames ()) (locals (fun/vector14739.15 c.89 tmp-ra.199)))
      (begin
        (set! tmp-ra.199 r15)
        (set! c.89 rdi)
    ...
    (define L.make-vector.74.14
      ((new-frames ())
       (locals
        (c.88 make-init-vector.1 tmp-ra.200 tmp.126 tmp.50 tmp.209 tmp.125)))
      (begin
        (set! tmp-ra.200 r15)
        (set! c.88 rdi)
        (set! tmp.50 rsi)
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.209 tmp.50)
                      (set! tmp.209 (bitwise-and tmp.209 7))
                      (set! tmp.126 tmp.209))
                    (= tmp.126 0))
                (set! tmp.125 14)
                (set! tmp.125 6))
    ...
    (define L.make-init-vector.1.13
      ...
      (begin
        ...
        (set! tmp.210 tmp.22)
        (set! tmp.210 (arithmetic-shift-right tmp.210 3))
        (set! tmp.130 tmp.210)
        (set! tmp.211 1)
        (set! tmp.211 (+ tmp.211 tmp.130))
        (set! tmp.129 tmp.211)
        (set! tmp.212 tmp.129)
        (set! tmp.212 (* tmp.212 8))
        (set! tmp.128 tmp.212)
        (begin (set! tmp.127 r12) (set! r12 (+ r12 tmp.128)))
        (set! tmp.213 tmp.127)
        (set! tmp.213 (+ tmp.213 3))
        (set! tmp.102 tmp.213)
        (mset! tmp.102 -3 tmp.22)
        (set! tmp.23 tmp.102)
        (set! rcx tmp.23)
        (set! rdx 0)
        (set! rsi tmp.22)
    ...
    (define L.vector-init-loop.24.12
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.214 i.27)
            (set! tmp.214 (arithmetic-shift-right tmp.214 3))
            (set! tmp.134 tmp.214)
            (set! tmp.215 tmp.134)
            (set! tmp.215 (* tmp.215 8))
            (set! tmp.133 tmp.215)
            (set! tmp.216 tmp.133)
            (set! tmp.216 (+ tmp.216 5))
            (set! tmp.132 tmp.216)
            (mset! vec.26 tmp.132 0)
            (set! tmp.217 i.27)
            (set! tmp.217 (+ tmp.217 8))
            (set! tmp.135 tmp.217)
            (set! rcx vec.26)
            (set! rdx tmp.135)
            (set! rsi len.25)
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.220 tmp.40)
              (set! tmp.220 (- tmp.220 tmp.41))
              (set! rax tmp.220)
              (jump tmp-ra.203 rbp rax))
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.223 tmp.37)
              (set! tmp.223 (arithmetic-shift-right tmp.223 3))
              (set! tmp.144 tmp.223)
              (set! tmp.224 tmp.36)
              (set! tmp.224 (* tmp.224 tmp.144))
              (set! rax tmp.224)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.225 tmp.39)
                      (set! tmp.225 (bitwise-and tmp.225 7))
                      (set! tmp.146 tmp.225))
                    (= tmp.146 0))
                (set! tmp.145 14)
                (set! tmp.145 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.226 tmp.38)
                        (set! tmp.226 (bitwise-and tmp.226 7))
                        (set! tmp.148 tmp.226))
                      (= tmp.148 0))
                  (set! tmp.147 14)
                  (set! tmp.147 6))
            ...
            (begin
              (set! tmp.227 tmp.38)
              (set! tmp.227 (+ tmp.227 tmp.39))
              (set! rax tmp.227)
              (jump tmp-ra.205 rbp rax))
            (begin (set! rax 574) (jump tmp-ra.205 rbp rax)))
          (begin (set! rax 574) (jump tmp-ra.205 rbp rax)))))
    (define L.fixnum?.78.8
      ((new-frames ()) (locals (c.82 tmp-ra.206 tmp.228 tmp.59 tmp.149)))
      (begin
        (set! tmp-ra.206 r15)
        (set! c.82 rdi)
        (set! tmp.59 rsi)
    ...
    (define L.ascii-char?.79.7
      ((new-frames ()) (locals (c.81 tmp-ra.207 tmp.229 tmp.63 tmp.150)))
      (begin
        (set! tmp-ra.207 r15)
        (set! c.81 rdi)
        (set! tmp.63 rsi)
        (if (begin
              (begin
                (set! tmp.229 tmp.63)
                (set! tmp.229 (bitwise-and tmp.229 255))
                (set! tmp.150 tmp.229))
              (= tmp.150 46))
    ...
    (begin
      ...
      (begin (set! tmp.166 r12) (set! r12 (+ r12 16)))
      (set! tmp.245 tmp.166)
      (set! tmp.245 (+ tmp.245 2))
      (set! tmp.118 tmp.245)
      ...
      (set! vector4.17 rax)
      (begin (set! tmp.186 r12) (set! r12 (+ r12 32)))
      (set! tmp.250 tmp.186)
      (set! tmp.250 (+ tmp.250 2))
      (set! tmp.123 tmp.250)
...
(check-by-interp
 '(module
    ...
    (define L.fun/any14774.13.23
      ((new-frames ()) (locals (fun/any14775.7 c.93 tmp-ra.183)))
      (begin
        (set! tmp-ra.183 r15)
        (set! c.93 rdi)
    ...
    (define L.fun/vector14776.12.22
      ((new-frames ()) (locals (fun/vector14777.9 c.92 tmp-ra.184)))
      (begin
        (set! tmp-ra.184 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/ascii-char14781.11.21
      ((new-frames ()) (locals (c.91 tmp-ra.185)))
      (begin
        (set! tmp-ra.185 r15)
        (set! c.91 rdi)
        (set! rax 23086)
    ...
    (define L.fun/empty14778.10.20
      ((new-frames ()) (locals (fun/empty14779.6 c.90 tmp-ra.186)))
      (begin
        (set! tmp-ra.186 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/vector14777.9.19
      ((new-frames ()) (locals (make-vector.72 c.89 tmp-ra.187)))
      (begin
        (set! tmp-ra.187 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/vector14773.8.18
      ((new-frames ()) (locals (make-vector.72 c.88 tmp-ra.188)))
      (begin
        (set! tmp-ra.188 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/any14775.7.17
      ((new-frames ()) (locals (c.87 tmp-ra.189)))
      (begin
        (set! tmp-ra.189 r15)
        (set! c.87 rdi)
        (set! rax 1176)
    ...
    (define L.fun/empty14779.6.16
      ((new-frames ()) (locals (c.86 tmp-ra.190)))
      (begin
        (set! tmp-ra.190 r15)
        (set! c.86 rdi)
        (set! rax 22)
    ...
    (define L.fun/vector14772.5.15
      ((new-frames ()) (locals (fun/vector14773.8 c.85 tmp-ra.191)))
      (begin
        (set! tmp-ra.191 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/ascii-char14780.4.14
      ((new-frames ()) (locals (fun/ascii-char14781.11 c.84 tmp-ra.192)))
      (begin
        (set! tmp-ra.192 r15)
        (set! c.84 rdi)
    ...
    (define L.make-vector.72.13
      ((new-frames ())
       (locals
        (c.83 make-init-vector.1 tmp-ra.193 tmp.113 tmp.48 tmp.201 tmp.112)))
      (begin
        (set! tmp-ra.193 r15)
        (set! c.83 rdi)
        (set! tmp.48 rsi)
    ...
    (define L.make-init-vector.1.12
      ...
      (begin
        ...
        (set! tmp.117 tmp.202)
        (set! tmp.203 1)
        (set! tmp.203 (+ tmp.203 tmp.117))
        (set! tmp.116 tmp.203)
        (set! tmp.204 tmp.116)
        (set! tmp.204 (* tmp.204 8))
        (set! tmp.115 tmp.204)
        (begin (set! tmp.114 r12) (set! r12 (+ r12 tmp.115)))
        (set! tmp.205 tmp.114)
        (set! tmp.205 (+ tmp.205 3))
        (set! tmp.94 tmp.205)
        (mset! tmp.94 -3 tmp.20)
        (set! tmp.21 tmp.94)
        (set! rcx tmp.21)
        (set! rdx 0)
        (set! rsi tmp.20)
    ...
    (define L.vector-init-loop.22.11
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            (set! tmp.206 i.25)
            (set! tmp.206 (arithmetic-shift-right tmp.206 3))
            (set! tmp.121 tmp.206)
            (set! tmp.207 tmp.121)
            (set! tmp.207 (* tmp.207 8))
            (set! tmp.120 tmp.207)
            (set! tmp.208 tmp.120)
            (set! tmp.208 (+ tmp.208 5))
            (set! tmp.119 tmp.208)
            (mset! vec.24 tmp.119 0)
            (set! tmp.209 i.25)
            (set! tmp.209 (+ tmp.209 8))
            (set! tmp.122 tmp.209)
            (set! rcx vec.24)
            (set! rdx tmp.122)
            (set! rsi len.23)
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.218 tmp.35)
              (set! tmp.218 (arithmetic-shift-right tmp.218 3))
              (set! tmp.135 tmp.218)
              (set! tmp.219 tmp.34)
              (set! tmp.219 (* tmp.219 tmp.135))
              (set! rax tmp.219)
              (jump tmp-ra.198 rbp rax))
            (begin (set! rax 318) (jump tmp-ra.198 rbp rax)))
          (begin (set! rax 318) (jump tmp-ra.198 rbp rax)))))
    (define L.procedure?.76.7
      ((new-frames ()) (locals (c.77 tmp-ra.199 tmp.220 tmp.66 tmp.136)))
      (begin
        (set! tmp-ra.199 r15)
        (set! c.77 rdi)
        (set! tmp.66 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.fun/error15420.17.22
      ((new-frames ()) (locals (fun/error15421.9 c.93 tmp-ra.130)))
      (begin
        (set! tmp-ra.130 r15)
        (set! c.93 rdi)
    ...
    (define L.fun/error15416.16.21
      ((new-frames ()) (locals (fun/error15417.4 c.92 tmp-ra.131)))
      (begin
        (set! tmp-ra.131 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/pair15427.15.20
      ((new-frames ()) (locals (cons.76 c.91 tmp-ra.132)))
      (begin
        (set! tmp-ra.132 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/any15414.14.19
      ((new-frames ()) (locals (fun/any15415.5 c.90 tmp-ra.133)))
      (begin
        (set! tmp-ra.133 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/error15422.12.17
      ((new-frames ()) (locals (fun/error15423.7 c.88 tmp-ra.135)))
      (begin
        (set! tmp-ra.135 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/error15419.11.16
      ((new-frames ()) (locals (c.87 tmp-ra.136)))
      (begin
        (set! tmp-ra.136 r15)
        (set! c.87 rdi)
        (set! rax 58686)
    ...
    (define L.fun/error15418.10.15
      ((new-frames ()) (locals (fun/error15419.11 c.86 tmp-ra.137)))
      (begin
        (set! tmp-ra.137 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/void15424.8.13
      ((new-frames ()) (locals (fun/void15425.13 c.84 tmp-ra.139)))
      (begin
        (set! tmp-ra.139 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/error15423.7.12
      ((new-frames ()) (locals (c.83 tmp-ra.140)))
      (begin
        (set! tmp-ra.140 r15)
        (set! c.83 rdi)
        (set! rax 22590)
    ...
    (define L.fun/pair15426.6.11
      ((new-frames ()) (locals (fun/pair15427.15 c.82 tmp-ra.141)))
      (begin
        (set! tmp-ra.141 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/error15417.4.9
      ((new-frames ()) (locals (c.80 tmp-ra.143)))
      (begin
        (set! tmp-ra.143 r15)
        (set! c.80 rdi)
        (set! rax 6718)
    ...
    (define L.ascii-char?.77.7
      ((new-frames ()) (locals (c.78 tmp-ra.145 tmp.148 tmp.65 tmp.112)))
      (begin
        (set! tmp-ra.145 r15)
        (set! c.78 rdi)
        (set! tmp.65 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char16443.15.21
      ((new-frames ()) (locals (fun/ascii-char16444.5 c.91 tmp-ra.149)))
      (begin
        (set! tmp-ra.149 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/ascii-char16441.12.18
      ((new-frames ()) (locals (fun/ascii-char16442.11 c.88 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/ascii-char16442.11.17
      ((new-frames ()) (locals (c.87 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.87 rdi)
        (set! rax 24622)
    ...
    (define L.fun/error16433.8.14
      ((new-frames ()) (locals (fun/error16434.13 c.84 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/ascii-char16437.7.13
      ((new-frames ()) (locals (fun/ascii-char16438.9 c.83 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/void16439.6.12
      ((new-frames ()) (locals (fun/void16440.14 c.82 tmp-ra.158)))
      (begin
        (set! tmp-ra.158 r15)
        (set! c.82 rdi)
    ...
    (define L.fun/ascii-char16444.5.11
      ((new-frames ()) (locals (c.81 tmp-ra.159)))
      (begin
        (set! tmp-ra.159 r15)
        (set! c.81 rdi)
        (set! rax 25902)
    ...
    (define L.fun/ascii-char16435.4.10
      ((new-frames ()) (locals (fun/ascii-char16436.10 c.80 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.80 rdi)
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.167 tmp.37)
              (set! tmp.167 (arithmetic-shift-right tmp.167 3))
              (set! tmp.111 tmp.167)
              (set! tmp.168 tmp.36)
              (set! tmp.168 (* tmp.168 tmp.111))
              (set! rax tmp.168)
              (jump tmp-ra.161 rbp rax))
...
(check-by-interp
 '(module
    ...
    (define L.fun/error16486.12.24
      ((new-frames ()) (locals (c.107 tmp-ra.190)))
      (begin
        (set! tmp-ra.190 r15)
        (set! c.107 rdi)
        (set! rax 57662)
    ...
    (define L.fun/empty16490.11.23
      ((new-frames ()) (locals (c.106 tmp-ra.191)))
      (begin
        (set! tmp-ra.191 r15)
        (set! c.106 rdi)
        (set! rax 22)
    ...
    (define L.fun/error16485.10.22
      ((new-frames ()) (locals (c.105 tmp-ra.192)))
      (begin
        (set! tmp-ra.192 r15)
        (set! c.105 rdi)
        (set! rax 60734)
    ...
    (define L.fun/empty16489.9.21
      ((new-frames ()) (locals (c.104 tmp-ra.193)))
      (begin
        (set! tmp-ra.193 r15)
        (set! c.104 rdi)
        (set! rax 22)
    ...
    (define L.fun/any16488.8.20
      ((new-frames ()) (locals (c.103 tmp-ra.194)))
      (begin
        (set! tmp-ra.194 r15)
        (set! c.103 rdi)
        (set! rax 544)
    ...
    (define L.fun/empty16487.7.19
      ((new-frames ()) (locals (c.102 tmp-ra.195)))
      (begin
        (set! tmp-ra.195 r15)
        (set! c.102 rdi)
        (set! rax 22)
    ...
    (define L.fun/vector16484.6.18
      ((new-frames ()) (locals (make-vector.83 c.101 tmp-ra.196)))
      (begin
        (set! tmp-ra.196 r15)
        (set! c.101 rdi)
    ...
    (define L.fun/empty16491.5.17
      ((new-frames ()) (locals (c.100 tmp-ra.197)))
      (begin
        (set! tmp-ra.197 r15)
        (set! c.100 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char16492.4.16
      ((new-frames ()) (locals (c.99 tmp-ra.198)))
      (begin
        (set! tmp-ra.198 r15)
        (set! c.99 rdi)
        (set! rax 26670)
    ...
    (define L.make-vector.83.15
      ((new-frames ())
       (locals
        (c.98 make-init-vector.1 tmp-ra.199 tmp.128 tmp.59 tmp.209 tmp.127)))
      (begin
        (set! tmp-ra.199 r15)
        (set! c.98 rdi)
        (set! tmp.59 rsi)
    ...
    (define L.make-init-vector.1.14
      ...
      (begin
        ...
        (set! tmp.132 tmp.210)
        (set! tmp.211 1)
        (set! tmp.211 (+ tmp.211 tmp.132))
        (set! tmp.131 tmp.211)
        (set! tmp.212 tmp.131)
        (set! tmp.212 (* tmp.212 8))
        (set! tmp.130 tmp.212)
        (begin (set! tmp.129 r12) (set! r12 (+ r12 tmp.130)))
        (set! tmp.213 tmp.129)
        (set! tmp.213 (+ tmp.213 3))
        (set! tmp.108 tmp.213)
        (mset! tmp.108 -3 tmp.31)
        (set! tmp.32 tmp.108)
        (set! rcx tmp.32)
        (set! rdx 0)
        (set! rsi tmp.31)
    ...
    (define L.boolean?.87.9
      ((new-frames ()) (locals (c.92 tmp-ra.205 tmp.226 tmp.69 tmp.150)))
      (begin
        (set! tmp-ra.205 r15)
        (set! c.92 rdi)
        (set! tmp.69 rsi)
        (if (begin
              (begin
                (set! tmp.226 tmp.69)
                (set! tmp.226 (bitwise-and tmp.226 247))
                (set! tmp.150 tmp.226))
              (= tmp.150 6))
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.227 tmp.46)
                      (set! tmp.227 (bitwise-and tmp.227 7))
                      (set! tmp.152 tmp.227))
                    (= tmp.152 0))
                (set! tmp.151 14)
                (set! tmp.151 6))
          ...
          (if (begin
            ...
            (begin
              (set! tmp.229 tmp.46)
              (set! tmp.229 (arithmetic-shift-right tmp.229 3))
              (set! tmp.155 tmp.229)
              (set! tmp.230 tmp.45)
              (set! tmp.230 (* tmp.230 tmp.155))
              (set! rax tmp.230)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.231 tmp.56)
                      (set! tmp.231 (bitwise-and tmp.231 7))
                      (set! tmp.157 tmp.231))
                    (= tmp.157 0))
                (set! tmp.156 14)
                (set! tmp.156 6))
          ...
          (if (begin
                (if (begin
                      (begin
                        (set! tmp.232 tmp.55)
                        (set! tmp.232 (bitwise-and tmp.232 7))
                        (set! tmp.159 tmp.232))
                      (= tmp.159 0))
                  (set! tmp.158 14)
                  (set! tmp.158 6))
    ...
    (begin
      ...
      (mset! tmp.110 6 16)
      (set! *.88 tmp.110)
      (begin (set! tmp.162 r12) (set! r12 (+ r12 16)))
      (set! tmp.235 tmp.162)
      (set! tmp.235 (+ tmp.235 2))
      (set! tmp.111 tmp.235)
      ...
      (begin (set! tmp.168 r12) (set! r12 (+ r12 24)))
      (set! tmp.241 tmp.168)
      (set! tmp.241 (+ tmp.241 2))
      (set! tmp.117 tmp.241)
      ...
      (begin (set! tmp.170 r12) (set! r12 (+ r12 16)))
      (set! tmp.243 tmp.170)
      (set! tmp.243 (+ tmp.243 2))
      (set! tmp.119 tmp.243)
      ...
      (begin (set! tmp.171 r12) (set! r12 (+ r12 24)))
      (set! tmp.244 tmp.171)
      (set! tmp.244 (+ tmp.244 2))
      (set! tmp.120 tmp.244)
      ...
      (begin (set! tmp.172 r12) (set! r12 (+ r12 16)))
      (set! tmp.245 tmp.172)
      (set! tmp.245 (+ tmp.245 2))
      (set! tmp.121 tmp.245)
      ...
      (begin (set! tmp.173 r12) (set! r12 (+ r12 16)))
      (set! tmp.246 tmp.173)
      (set! tmp.246 (+ tmp.246 2))
      (set! tmp.122 tmp.246)
      ...
      (begin (set! tmp.174 r12) (set! r12 (+ r12 16)))
      (set! tmp.247 tmp.174)
      (set! tmp.247 (+ tmp.247 2))
      (set! tmp.123 tmp.247)
      ...
      (begin (set! tmp.175 r12) (set! r12 (+ r12 16)))
      (set! tmp.248 tmp.175)
      (set! tmp.248 (+ tmp.248 2))
      (set! tmp.124 tmp.248)
      ...
      (begin (set! tmp.176 r12) (set! r12 (+ r12 16)))
      (set! tmp.249 tmp.176)
      (set! tmp.249 (+ tmp.249 2))
      (set! tmp.125 tmp.249)
      ...
      (if (begin
            ...
            (begin
              (begin
                ...
                (set! tmp.182 rax))
              (!= tmp.182 6)))
        (if (if (begin (set! tmp.251 14) (!= tmp.251 6))
              (begin (set! tmp.252 6) (!= tmp.252 6))
              (begin (set! tmp.253 6) (!= tmp.253 6)))
          (begin
            ...
            (set! empty5.19 22)
            (set! rax 21806)
            (jump tmp-ra.208 rbp rax))
          (if (begin (set! tmp.254 14) (!= tmp.254 6))
...
(check-by-interp
 '(module
    ...
    (define L.fun/vector16594.17.25
      ((new-frames ()) (locals (fun/vector16595.8 c.97 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.97 rdi)
    ...
    (define L.fun/void16600.16.24
      ((new-frames ()) (locals (fun/void16601.9 c.96 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.96 rdi)
    ...
    (define L.fun/ascii-char16602.15.23
      ((new-frames ()) (locals (fun/ascii-char16603.5 c.95 tmp-ra.154)))
      (begin
        (set! tmp-ra.154 r15)
        (set! c.95 rdi)
    ...
    (define L.fun/ascii-char16596.14.22
      ((new-frames ()) (locals (fun/ascii-char16597.10 c.94 tmp-ra.155)))
      (begin
        (set! tmp-ra.155 r15)
        (set! c.94 rdi)
    ...
    (define L.fun/vector16593.13.21
      ((new-frames ()) (locals (make-vector.76 c.93 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.93 rdi)
        (set! make-vector.76 (mref c.93 14))
    ...
    (define L.fun/any16599.12.20
      ((new-frames ()) (locals (cons.77 c.92 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/vector16604.11.19
      ((new-frames ()) (locals (fun/vector16605.7 c.91 tmp-ra.158)))
      (begin
        (set! tmp-ra.158 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/ascii-char16597.10.18
      ((new-frames ()) (locals (c.90 tmp-ra.159)))
      (begin
        (set! tmp-ra.159 r15)
        (set! c.90 rdi)
        (set! rax 25390)
    ...
    (define L.fun/void16601.9.17
      ((new-frames ()) (locals (c.89 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.89 rdi)
        (set! rax 30)
    ...
    (define L.fun/vector16595.8.16
      ((new-frames ()) (locals (make-vector.76 c.88 tmp-ra.161)))
      (begin
        (set! tmp-ra.161 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/vector16605.7.15
      ((new-frames ()) (locals (make-vector.76 c.87 tmp-ra.162)))
      (begin
        (set! tmp-ra.162 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/vector16592.6.14
      ((new-frames ()) (locals (fun/vector16593.13 c.86 tmp-ra.163)))
      (begin
        (set! tmp-ra.163 r15)
        (set! c.86 rdi)
    ...
    (define L.fun/ascii-char16603.5.13
      ((new-frames ()) (locals (c.85 tmp-ra.164)))
      (begin
        (set! tmp-ra.164 r15)
        (set! c.85 rdi)
        (set! rax 23854)
    ...
    (define L.fun/any16598.4.12
      ((new-frames ()) (locals (fun/any16599.12 c.84 tmp-ra.165)))
      (begin
        (set! tmp-ra.165 r15)
        (set! c.84 rdi)
    ...
    (define L.make-vector.76.11
      ((new-frames ())
       (locals
        (c.83 make-init-vector.1 tmp-ra.166 tmp.120 tmp.52 tmp.172 tmp.119)))
      (begin
        (set! tmp-ra.166 r15)
        (set! c.83 rdi)
        (set! tmp.52 rsi)
    ...
    (define L.make-init-vector.1.10
      ...
      (begin
        ...
        (set! tmp.173 tmp.24)
        (set! tmp.173 (arithmetic-shift-right tmp.173 3))
        (set! tmp.124 tmp.173)
        (set! tmp.174 1)
        (set! tmp.174 (+ tmp.174 tmp.124))
        (set! tmp.123 tmp.174)
        (set! tmp.175 tmp.123)
        (set! tmp.175 (* tmp.175 8))
        (set! tmp.122 tmp.175)
        (begin (set! tmp.121 r12) (set! r12 (+ r12 tmp.122)))
        (set! tmp.176 tmp.121)
        (set! tmp.176 (+ tmp.176 3))
        (set! tmp.98 tmp.176)
        (mset! tmp.98 -3 tmp.24)
        (set! tmp.25 tmp.98)
        (set! rcx tmp.25)
    ...
    (define L.cons.77.8
      ((new-frames ())
       (locals (tmp.99 tmp.181 tmp.130 tmp.72 tmp.71 c.80 tmp-ra.169)))
      (begin
        (set! tmp-ra.169 r15)
        (set! c.80 rdi)
        (set! tmp.71 rsi)
    ...
    (define L.procedure?.78.7
      ((new-frames ()) (locals (c.79 tmp-ra.170 tmp.182 tmp.70 tmp.131)))
      (begin
        (set! tmp-ra.170 r15)
        (set! c.79 rdi)
        (set! tmp.70 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals
      (void5.18
       ...
       tmp-ra.183)))
    (define L.lam.80.27
      ((new-frames ()) (locals (fun/empty17996.16 c.101 tmp-ra.162)))
      (begin
        (set! tmp-ra.162 r15)
        (set! c.101 rdi)
    ...
    (define L.fun/ascii-char18009.17.26
      ((new-frames ()) (locals (c.100 tmp-ra.163)))
      (begin
        (set! tmp-ra.163 r15)
        (set! c.100 rdi)
        (set! rax 18222)
    ...
    (define L.fun/empty17996.16.25
      ((new-frames ()) (locals (fun/empty17997.10 c.99 tmp-ra.164)))
      (begin
        (set! tmp-ra.164 r15)
        (set! c.99 rdi)
    ...
    (define L.fun/vector18000.15.24
      ((new-frames ()) (locals (fun/vector18001.4 c.98 tmp-ra.165)))
      (begin
        (set! tmp-ra.165 r15)
        (set! c.98 rdi)
    ...
    (define L.fun/any18003.14.23
      ((new-frames ()) (locals (cons.77 c.97 tmp-ra.166)))
      (begin
        (set! tmp-ra.166 r15)
        (set! c.97 rdi)
    ...
    (define L.fun/any18004.13.22
      ((new-frames ()) (locals (fun/any18005.11 c.96 tmp-ra.167)))
      (begin
        (set! tmp-ra.167 r15)
        (set! c.96 rdi)
    ...
    (define L.fun/void18007.12.21
      ((new-frames ()) (locals (c.95 tmp-ra.168)))
      (begin
        (set! tmp-ra.168 r15)
        (set! c.95 rdi)
        (set! rax 30)
    ...
    (define L.fun/any18005.11.20
      ((new-frames ()) (locals (c.94 tmp-ra.169)))
      (begin
        (set! tmp-ra.169 r15)
        (set! c.94 rdi)
        (set! rax 40510)
    ...
    (define L.fun/empty17997.10.19
      ((new-frames ()) (locals (c.93 tmp-ra.170)))
      (begin
        (set! tmp-ra.170 r15)
        (set! c.93 rdi)
        (set! rax 22)
    ...
    (define L.fun/any18002.9.18
      ((new-frames ()) (locals (fun/any18003.14 c.92 tmp-ra.171)))
      (begin
        (set! tmp-ra.171 r15)
        (set! c.92 rdi)
    ...
    (define L.fun/void18006.8.17
      ((new-frames ()) (locals (fun/void18007.12 c.91 tmp-ra.172)))
      (begin
        (set! tmp-ra.172 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/ascii-char18008.7.16
      ((new-frames ()) (locals (fun/ascii-char18009.17 c.90 tmp-ra.173)))
      (begin
        (set! tmp-ra.173 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/vector17998.6.15
      ((new-frames ()) (locals (fun/vector17999.5 c.89 tmp-ra.174)))
      (begin
        (set! tmp-ra.174 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/vector17999.5.14
      ((new-frames ()) (locals (make-vector.76 c.88 tmp-ra.175)))
      (begin
        (set! tmp-ra.175 r15)
        (set! c.88 rdi)
        (set! make-vector.76 (mref c.88 14))
    ...
    (define L.fun/vector18001.4.13
      ((new-frames ()) (locals (make-vector.76 c.87 tmp-ra.176)))
      (begin
        (set! tmp-ra.176 r15)
        (set! c.87 rdi)
        (set! make-vector.76 (mref c.87 14))
    ...
    (define L.make-vector.76.12
      ((new-frames ())
       (locals
        (c.86 make-init-vector.1 tmp-ra.177 tmp.126 tmp.52 tmp.184 tmp.125)))
      (begin
        (set! tmp-ra.177 r15)
        (set! c.86 rdi)
        (set! tmp.52 rsi)
    ...
    (define L.make-init-vector.1.11
      ...
      (begin
        ...
        (begin (set! tmp.127 r12) (set! r12 (+ r12 tmp.128)))
        (set! tmp.188 tmp.127)
        (set! tmp.188 (+ tmp.188 3))
        (set! tmp.102 tmp.188)
        (mset! tmp.102 -3 tmp.24)
        (set! tmp.25 tmp.102)
        (set! rcx tmp.25)
        (set! rdx 0)
        (set! rsi tmp.24)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.134 tmp.189)
            (set! tmp.190 tmp.134)
            (set! tmp.190 (* tmp.190 8))
            (set! tmp.133 tmp.190)
            (set! tmp.191 tmp.133)
            (set! tmp.191 (+ tmp.191 5))
            (set! tmp.132 tmp.191)
            (mset! vec.28 tmp.132 0)
            (set! tmp.192 i.29)
            (set! tmp.192 (+ tmp.192 8))
            (set! tmp.135 tmp.192)
            (set! rcx vec.28)
            (set! rdx tmp.135)
            (set! rsi len.27)
    ...
    (define L.cons.77.9
      ((new-frames ())
       (locals (tmp.103 tmp.193 tmp.136 tmp.72 tmp.71 c.83 tmp-ra.180)))
      (begin
        (set! tmp-ra.180 r15)
        (set! c.83 rdi)
        (set! tmp.71 rsi)
    ...
    (define L.vector?.78.8
      ((new-frames ()) (locals (c.82 tmp-ra.181 tmp.194 tmp.68 tmp.137)))
      (begin
        (set! tmp-ra.181 r15)
        (set! c.82 rdi)
        (set! tmp.68 rsi)
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.181 rbp rax)))))
    (define L.void?.79.7
      ((new-frames ()) (locals (c.81 tmp-ra.182 tmp.195 tmp.64 tmp.138)))
      (begin
        (set! tmp-ra.182 r15)
        (set! c.81 rdi)
        (set! tmp.64 rsi)
        (if (begin
              (begin
                (set! tmp.195 tmp.64)
                (set! tmp.195 (bitwise-and tmp.195 255))
                (set! tmp.138 tmp.195))
              (= tmp.138 30))
...
(check-by-interp
 '(module
    ...
    (define L.fun/void18488.14.20
      ((new-frames ()) (locals (fun/void18489.10 c.90 tmp-ra.150)))
      (begin
        (set! tmp-ra.150 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/error18496.12.18
      ((new-frames ()) (locals (fun/error18497.6 c.88 tmp-ra.152)))
      (begin
        (set! tmp-ra.152 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/empty18498.11.17
      ((new-frames ()) (locals (fun/empty18499.5 c.87 tmp-ra.153)))
      (begin
        (set! tmp-ra.153 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/void18494.9.15
      ((new-frames ()) (locals (fun/void18495.15 c.85 tmp-ra.155)))
      (begin
        (set! tmp-ra.155 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/error18491.8.14
      ((new-frames ()) (locals (c.84 tmp-ra.156)))
      (begin
        (set! tmp-ra.156 r15)
        (set! c.84 rdi)
        (set! rax 47678)
    ...
    (define L.fun/ascii-char18492.7.13
      ((new-frames ()) (locals (fun/ascii-char18493.13 c.83 tmp-ra.157)))
      (begin
        (set! tmp-ra.157 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/error18497.6.12
      ((new-frames ()) (locals (c.82 tmp-ra.158)))
      (begin
        (set! tmp-ra.158 r15)
        (set! c.82 rdi)
        (set! rax 25150)
    ...
    (define L.fun/error18490.4.10
      ((new-frames ()) (locals (fun/error18491.8 c.80 tmp-ra.160)))
      (begin
        (set! tmp-ra.160 r15)
        (set! c.80 rdi)
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char22594.17.21
      ((new-frames ()) (locals (fun/ascii-char22595.5 c.91 tmp-ra.124)))
      (begin
        (set! tmp-ra.124 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/empty22596.16.20
      ((new-frames ()) (locals (fun/empty22597.10 c.90 tmp-ra.125)))
      (begin
        (set! tmp-ra.125 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/empty22598.15.19
      ((new-frames ()) (locals (fun/empty22599.8 c.89 tmp-ra.126)))
      (begin
        (set! tmp-ra.126 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/error22592.14.18
      ((new-frames ()) (locals (fun/error22593.12 c.88 tmp-ra.127)))
      (begin
        (set! tmp-ra.127 r15)
        (set! c.88 rdi)
    ...
    (define L.fun/pair22600.13.17
      ((new-frames ()) (locals (fun/pair22601.6 c.87 tmp-ra.128)))
      (begin
        (set! tmp-ra.128 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/error22593.12.16
      ((new-frames ()) (locals (c.86 tmp-ra.129)))
      (begin
        (set! tmp-ra.129 r15)
        (set! c.86 rdi)
        (set! rax 5694)
    ...
    (define L.fun/ascii-char22588.11.15
      ((new-frames ()) (locals (fun/ascii-char22589.7 c.85 tmp-ra.130)))
      (begin
        (set! tmp-ra.130 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/empty22597.10.14
      ((new-frames ()) (locals (c.84 tmp-ra.131)))
      (begin
        (set! tmp-ra.131 r15)
        (set! c.84 rdi)
        (set! rax 22)
    ...
    (define L.fun/empty22591.9.13
      ((new-frames ()) (locals (c.83 tmp-ra.132)))
      (begin
        (set! tmp-ra.132 r15)
        (set! c.83 rdi)
        (set! rax 22)
    ...
    (define L.fun/empty22599.8.12
      ((new-frames ()) (locals (c.82 tmp-ra.133)))
      (begin
        (set! tmp-ra.133 r15)
        (set! c.82 rdi)
        (set! rax 22)
    ...
    (define L.fun/ascii-char22589.7.11
      ((new-frames ()) (locals (c.81 tmp-ra.134)))
      (begin
        (set! tmp-ra.134 r15)
        (set! c.81 rdi)
        (set! rax 23342)
    ...
    (define L.fun/pair22601.6.10
      ((new-frames ()) (locals (cons.76 c.80 tmp-ra.135)))
      (begin
        (set! tmp-ra.135 r15)
        (set! c.80 rdi)
    ...
    (define L.fun/ascii-char22595.5.9
      ((new-frames ()) (locals (c.79 tmp-ra.136)))
      (begin
        (set! tmp-ra.136 r15)
        (set! c.79 rdi)
        (set! rax 25134)
    ...
    (define L.fun/empty22590.4.8
      ((new-frames ()) (locals (fun/empty22591.9 c.78 tmp-ra.137)))
      (begin
        (set! tmp-ra.137 r15)
        (set! c.78 rdi)
    ...
    (define L.cons.76.7
      ((new-frames ())
       (locals (tmp.92 tmp.140 tmp.108 tmp.72 tmp.71 c.77 tmp-ra.138)))
      (begin
        (set! tmp-ra.138 r15)
        (set! c.77 rdi)
        (set! tmp.71 rsi)
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
       ...
       *.74
       ...
       tmp-ra.202)))
    (define L.lam.76.21
      ((new-frames ()) (locals (fun/void23352.11 c.91 tmp-ra.187)))
      (begin
        (set! tmp-ra.187 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/void23352.11.19
      ((new-frames ()) (locals (fun/void23353.10 c.89 tmp-ra.189)))
      (begin
        (set! tmp-ra.189 r15)
        (set! c.89 rdi)
    ...
    (define L.fun/void23353.10.18
      ((new-frames ()) (locals (c.88 tmp-ra.190)))
      (begin
        (set! tmp-ra.190 r15)
        (set! c.88 rdi)
        (set! rax 30)
    ...
    (define L.fun/ascii-char23346.9.17
      ((new-frames ()) (locals (fun/ascii-char23347.8 c.87 tmp-ra.191)))
      (begin
        (set! tmp-ra.191 r15)
        (set! c.87 rdi)
    ...
    (define L.fun/ascii-char23347.8.16
      ((new-frames ()) (locals (c.86 tmp-ra.192)))
      (begin
        (set! tmp-ra.192 r15)
        (set! c.86 rdi)
        (set! rax 23598)
    ...
    (define L.fun/any23350.7.15
      ((new-frames ()) (locals (fun/any23351.5 c.85 tmp-ra.193)))
      (begin
        (set! tmp-ra.193 r15)
        (set! c.85 rdi)
    ...
    (define L.fun/void23348.6.14
      ((new-frames ()) (locals (fun/void23349.4 c.84 tmp-ra.194)))
      (begin
        (set! tmp-ra.194 r15)
        (set! c.84 rdi)
    ...
    (define L.fun/any23351.5.13
      ((new-frames ()) (locals (cons.70 c.83 tmp-ra.195)))
      (begin
        (set! tmp-ra.195 r15)
        (set! c.83 rdi)
    ...
    (define L.fun/void23349.4.12
      ((new-frames ()) (locals (c.82 tmp-ra.196)))
      (begin
        (set! tmp-ra.196 r15)
        (set! c.82 rdi)
        (set! rax 30)
    ...
    (define L.cons.70.11
      ((new-frames ())
       (locals (tmp.92 tmp.203 tmp.122 tmp.66 tmp.65 c.81 tmp-ra.197)))
      (begin
        (set! tmp-ra.197 r15)
        (set! c.81 rdi)
        (set! tmp.65 rsi)
    ...
    (define L.boolean?.71.10
      ((new-frames ()) (locals (c.80 tmp-ra.198 tmp.204 tmp.56 tmp.123)))
      (begin
        (set! tmp-ra.198 r15)
        (set! c.80 rdi)
        (set! tmp.56 rsi)
        (if (begin
              (begin
                (set! tmp.204 tmp.56)
                (set! tmp.204 (bitwise-and tmp.204 247))
                (set! tmp.123 tmp.204))
              (= tmp.123 6))
      ...
      (begin
        ...
        (if (begin
          ...
          (if (begin
            ...
            (begin
              (set! tmp.213 tmp.33)
              (set! tmp.213 (arithmetic-shift-right tmp.213 3))
              (set! tmp.136 tmp.213)
              (set! tmp.214 tmp.32)
              (set! tmp.214 (* tmp.214 tmp.136))
              (set! rax tmp.214)
    ...
    (begin
      ...
      (set! boolean2.15 rax)
      (begin (set! tmp.151 r12) (set! r12 (+ r12 40)))
      (set! tmp.228 tmp.151)
      (set! tmp.228 (+ tmp.228 2))
      (set! tmp.106 tmp.228)
      ...
      (if (begin
            (if (begin
                  (begin
                    (set! tmp.230 procedure3.14)
                    (set! tmp.230 (bitwise-and tmp.230 7))
                    (set! tmp.170 tmp.230))
                  (= tmp.170 2))
              (set! tmp.169 14)
              (set! tmp.169 6))
            (!= tmp.169 6))
        (if (begin
              (if (begin (set! tmp.172 (mref procedure3.14 6)) (= tmp.172 0))
                (set! tmp.171 14)
                (set! tmp.171 6))
              (!= tmp.171 6))
          (begin
      ...
      (if (begin
            ...
            (!= tmp.175 6))
        (if (begin
              (if (begin (set! tmp.178 (mref procedure3.14 6)) (= tmp.178 0))
                (set! tmp.177 14)
                (set! tmp.177 6))
              (!= tmp.177 6))
          (begin
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () () () () () () () ()))
     (locals
       ...
       *.75
       ...
       tmp-ra.206)))
    (define L.lam.80.27
      ((new-frames ()) (locals (fun/void24631.10 c.101 tmp-ra.185)))
      (begin
        (set! tmp-ra.185 r15)
        (set! c.101 rdi)
    ...
    (define L.lam.79.26
      ((new-frames ()) (locals (fun/empty24629.7 c.100 tmp-ra.186)))
      (begin
        (set! tmp-ra.186 r15)
        (set! c.100 rdi)
    ...
    (define L.fun/vector24626.15.25
      ((new-frames ()) (locals (make-vector.74 c.99 tmp-ra.187)))
      (begin
        (set! tmp-ra.187 r15)
        (set! c.99 rdi)
    ...
    (define L.fun/any24627.14.24
      ((new-frames ()) (locals (fun/any24628.5 c.98 tmp-ra.188)))
      (begin
        (set! tmp-ra.188 r15)
        (set! c.98 rdi)
    ...
    (define L.fun/error24635.13.23
      ((new-frames ()) (locals (fun/error24636.8 c.97 tmp-ra.189)))
      (begin
        (set! tmp-ra.189 r15)
        (set! c.97 rdi)
    ...
    (define L.fun/error24634.12.22
      ((new-frames ()) (locals (c.96 tmp-ra.190)))
      (begin
        (set! tmp-ra.190 r15)
        (set! c.96 rdi)
        (set! rax 19006)
    ...
    (define L.fun/empty24630.11.21
      ((new-frames ()) (locals (c.95 tmp-ra.191)))
      (begin
        (set! tmp-ra.191 r15)
        (set! c.95 rdi)
        (set! rax 22)
    ...
    (define L.fun/void24631.10.20
      ((new-frames ()) (locals (fun/void24632.9 c.94 tmp-ra.192)))
      (begin
        (set! tmp-ra.192 r15)
        (set! c.94 rdi)
    ...
    (define L.fun/void24632.9.19
      ((new-frames ()) (locals (c.93 tmp-ra.193)))
      (begin
        (set! tmp-ra.193 r15)
        (set! c.93 rdi)
        (set! rax 30)
    ...
    (define L.fun/error24636.8.18
      ((new-frames ()) (locals (c.92 tmp-ra.194)))
      (begin
        (set! tmp-ra.194 r15)
        (set! c.92 rdi)
        (set! rax 52542)
    ...
    (define L.fun/empty24629.7.17
      ((new-frames ()) (locals (fun/empty24630.11 c.91 tmp-ra.195)))
      (begin
        (set! tmp-ra.195 r15)
        (set! c.91 rdi)
    ...
    (define L.fun/error24633.6.16
      ((new-frames ()) (locals (fun/error24634.12 c.90 tmp-ra.196)))
      (begin
        (set! tmp-ra.196 r15)
        (set! c.90 rdi)
    ...
    (define L.fun/any24628.5.15
      ((new-frames ()) (locals (c.89 tmp-ra.197)))
      (begin
        (set! tmp-ra.197 r15)
        (set! c.89 rdi)
        (set! rax 22)
    ...
    (define L.fun/vector24625.4.14
      ((new-frames ()) (locals (fun/vector24626.15 c.88 tmp-ra.198)))
      (begin
        (set! tmp-ra.198 r15)
        (set! c.88 rdi)
    ...
    (define L.make-vector.74.13
      ((new-frames ())
       (locals
        (c.87 make-init-vector.1 tmp-ra.199 tmp.125 tmp.50 tmp.207 tmp.124)))
      (begin
        (set! tmp-ra.199 r15)
        (set! c.87 rdi)
        (set! tmp.50 rsi)
    ...
    (define L.make-init-vector.1.12
      ...
      (begin
        ...
        (set! vector-init-loop.24 (mref c.86 14))
        (set! tmp.208 tmp.22)
        (set! tmp.208 (arithmetic-shift-right tmp.208 3))
        (set! tmp.129 tmp.208)
        (set! tmp.209 1)
        (set! tmp.209 (+ tmp.209 tmp.129))
        (set! tmp.128 tmp.209)
        (set! tmp.210 tmp.128)
        (set! tmp.210 (* tmp.210 8))
        (set! tmp.127 tmp.210)
        (begin (set! tmp.126 r12) (set! r12 (+ r12 tmp.127)))
        (set! tmp.211 tmp.126)
        (set! tmp.211 (+ tmp.211 3))
        (set! tmp.102 tmp.211)
        (mset! tmp.102 -3 tmp.22)
        (set! tmp.23 tmp.102)
        (set! rcx tmp.23)
      ...
      (begin
        ...
        (if (begin
          ...
          (begin
            ...
            (set! tmp.133 tmp.212)
            (set! tmp.213 tmp.133)
            (set! tmp.213 (* tmp.213 8))
            (set! tmp.132 tmp.213)
            (set! tmp.214 tmp.132)
            (set! tmp.214 (+ tmp.214 5))
            (set! tmp.131 tmp.214)
      ...
      (begin
        ...
        (if (begin
              (if (begin
                    (begin
                      (set! tmp.223 tmp.41)
                      (set! tmp.223 (bitwise-and tmp.223 7))
                      (set! tmp.145 tmp.223))
                    (= tmp.145 0))
                (set! tmp.144 14)
                (set! tmp.144 6))
          ...
          (if (begin
            ...
            (begin
              (set! tmp.225 tmp.40)
              (set! tmp.225 (- tmp.225 tmp.41))
              (set! rax tmp.225)
              (jump tmp-ra.204 rbp rax))
            (begin (set! rax 830) (jump tmp-ra.204 rbp rax)))
          (begin (set! rax 830) (jump tmp-ra.204 rbp rax)))))
    (define L.empty?.78.7
      ((new-frames ()) (locals (c.81 tmp-ra.205 tmp.226 tmp.61 tmp.148)))
      (begin
        (set! tmp-ra.205 r15)
        (set! c.81 rdi)
        (set! tmp.61 rsi)
        (if (begin
              (begin
                (set! tmp.226 tmp.61)
                (set! tmp.226 (bitwise-and tmp.226 255))
                (set! tmp.148 tmp.226))
              (= tmp.148 22))
          (begin (set! rax 14) (jump tmp-ra.205 rbp rax))
          (begin (set! rax 6) (jump tmp-ra.205 rbp rax)))))
    (begin
      ...
      (set! boolean2.19 rax)
      (begin (set! tmp.183 r12) (set! r12 (+ r12 24)))
      (set! tmp.246 tmp.183)
      (set! tmp.246 (+ tmp.246 2))
      (set! tmp.122 tmp.246)
