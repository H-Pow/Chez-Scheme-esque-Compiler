...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-asm-pred-lang-v7/pre-framed (check-asm-pred-lang-v7/pre-framed p))
                (interp-asm-pred-lang-v7/framed (check-asm-pred-lang-v7/framed (allocate-frames p)))))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.29))
          ...
          (define L.+.1
            ((new-frames ())
             (locals (tmp.24 tmp.30 tmp.4 tmp.25 tmp-ra.28 tmp.32 tmp.27 tmp.3 tmp.31 tmp.26))
             (undead-out
...
(check-by-interp
 '(module ((new-frames ())
    ...
    (begin
      ...
      (jump L.not.1 rbp r15 rdi))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp.25 tmp-ra.24))
                           (call-undead ())
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.fixnum?.1
            ((new-frames ())
             (locals (tmp.24 tmp.17 tmp.27 tmp-ra.25))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.error?.1
            ((new-frames ())
             (locals (tmp.24 tmp.22 tmp.27 tmp-ra.25))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.1
            ((new-frames ())
             (locals (tmp.24 tmp.21 tmp.27 tmp-ra.25))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.boolean?.1
            ((new-frames ())
             (locals (tmp.24 tmp.18 tmp.27 tmp-ra.25))
...
(check-by-interp '(module ((new-frames ()) (locals (tmp-ra.26 foobar.2.2 bat.1.1))
                                           (call-undead ())
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.void?.2
            ((new-frames ())
             (locals (tmp.24 tmp.20 tmp.28 tmp-ra.25))
    ...
    (define L.proc.0.1
      ((new-frames ()) (locals (tmp-ra.26))
                       ...
                       (call-undead ())
                       (conflicts ((tmp-ra.26 (rax rbp)) (rbp (rax tmp-ra.26)) (rax (rbp tmp-ra.26))))
                       (assignment ()))
      (begin
        (set! tmp-ra.26 r15)
        (set! rax 14)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31))
          ...
          (define L.<=.2
            ((new-frames ())
             (locals (tmp.25 tmp.32 tmp.11 tmp.26 tmp-ra.29 tmp.28 tmp.10 tmp.33 tmp.27))
             (undead-out
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.27 foobar.1.3 foo.2.2 foo.5.1))
                           (call-undead ())
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.30))
          ...
          (define L.x.0.1
            ((new-frames ())
             (locals (tmp-ra.29 foo.4.5 ball.9.4 foo.8.3 ball.3.2 ball.5.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31))
          ...
          (define L.func.0.1
            ((new-frames ())
             (locals (tmp-ra.30 foobar.2.6 foobar.9.5 bat.5.4 bar.8.3 ball.0.2 foo.1.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.27))
    ...
    (begin
      ...
      (jump tmp-ra.27 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp.30 tmp-ra.29))
                           (call-undead ())
          ...
          (define L.func.0.1
            ((new-frames ())
             (locals (tmp-ra.28 bar.9.4 foobar.0.3 bar.7.2 ball.1.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.30))
          ...
          (define L.eq?.2
            ((new-frames ())
             (locals (tmp.19 tmp.20 tmp-ra.28))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.29 foobar.7.4 bar.4.3 bat.2.2 foo.8.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.36))
          ...
          (define L.*.2
            ((new-frames ())
             (locals
              (tmp.29 tmp.37 tmp.7 tmp.30 tmp-ra.34 tmp.39 tmp.33 tmp.40 tmp.32 tmp.6 tmp.38 tmp.31))
    ...
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.35 bat.7.5 ball.3.4 bat.4.3 ball.0.2 bar.2.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
          ...
          (define L.proc.0.1
            ((new-frames ())
             (locals (tmp-ra.31 bar.6.7 foo.7.6 foo.5.5 ball.1.4 foobar.8.3 bat.4.2 foobar.0.1))
...
(check-by-interp '(module ((new-frames ()) (locals (tmp-ra.30))
                                           ...
                                           (assignment ()))
                          (define L.fn.0.1
                            ((new-frames ()) (locals (tmp-ra.28 bat.3.2 bar.9.1))
                            ...
                            (begin
                              ...
                              (jump tmp-ra.28 rbp rax)))
                    (define L.func.1.2
                      ((new-frames ()) (locals (tmp-ra.29 foobar.4.4 bar.8.3))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
          ...
          (define L.eq?.2
            ((new-frames ())
             (locals (tmp.21 tmp.22 tmp-ra.30))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.31 foobar.4.6 foo.8.5 bar.0.4 foobar.3.3 bar.9.2 bat.7.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31))
                           ...
                           (assignment ()))
          (define L.x.0.1
            ((new-frames ()) (locals (tmp-ra.29 bat.7.2 foobar.0.1))
                             (undead-out ((rdi rsi tmp-ra.29 rbp) (rsi tmp-ra.29 rbp)
                                                                  (tmp-ra.29 rbp)
                                                                  (tmp-ra.29 rax rbp)
                                                                  (rax rbp)))
            ...
            (begin
              ...
              (jump tmp-ra.29 rbp rax)))
    (define L.func.1.2
      ((new-frames ()) (locals (tmp-ra.30 bat.6.5 bar.1.4 foobar.2.3))
    ...
    (begin
      ...
      (jump tmp-ra.31 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31 bar.3.6 ball.4.5 foo.1.4))
                           (call-undead ())
                           ...
                           (assignment ()))
          (define L.func.0.1
            ((new-frames ()) (locals (tmp-ra.30 foobar.0.3 ball.4.2 foo.8.1))
                             (undead-out ((rdi rsi rdx tmp-ra.30 rbp) (rsi rdx tmp-ra.30 rbp)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
          ...
          (define L.func.0.1
            ((new-frames ())
             (locals (tmp-ra.30 foobar.8.5 foo.9.4 foobar.2.3 bar.6.2 foobar.0.1))
    ...
    (begin
      ...
      (jump tmp-ra.32 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.31 bar.3.6 bar.9.5 foobar.2.4 foo.5.3))
                           (call-undead ())
                           (undead-out ((tmp-ra.31 rbp) (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
                                                        (tmp-ra.31 rbp)
                           ...
                           (assignment ()))
          (define L.fn.0.1
            ((new-frames ()) (locals (tmp-ra.30 bat.7.2 foobar.4.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.33))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.32 bat.2.7 bat.4.6 ball.0.5 foobar.9.4 foo.3.3 ball.1.2 foobar.8.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.33))
          ...
          (define L.proc.0.1
            ((new-frames ())
             (locals (tmp-ra.31 bat.3.5 bat.0.4 foobar.6.3 foobar.9.2 foobar.1.1))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.32 bar.7.7 bat.0.6))
       (undead-out
    ...
    (begin
      ...
      (jump tmp-ra.33 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp.33 tmp-ra.32))
                           (call-undead ())
          ...
          (define L.tmp.0.1
            ((new-frames ())
             (locals (tmp-ra.30 ball.2.5 foobar.3.4 foo.9.3 foo.6.2 bat.4.1))
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.30 rbp) (rsi rdx rcx r8 tmp-ra.30 rbp)
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.void?.3
            ((new-frames ())
             (locals (tmp.32 tmp.28 tmp.37 tmp-ra.33))
    ...
    (define L.tmp.1.2
      ((new-frames ())
       (locals (tmp-ra.35 foo.1.8 bat.2.7 bat.9.6 foo.4.5 ball.5.4 bat.6.3 bat.7.2))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.32))
    ...
    (define L.fn.1.2
      ((new-frames ())
       (locals (tmp-ra.30 ball.8.4 foo.1.3 bar.7.2 foo.4.1))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.34))
          ...
          (define L.func.0.1
            ((new-frames ())
             (locals (tmp-ra.32 foobar.3.5 ball.2.4 ball.1.3 foobar.8.2 ball.9.1))
            ...
            (begin
              ...
              (jump tmp-ra.32 rbp rax)))
    (define L.func.1.2
      ((new-frames ()) (locals (tmp-ra.33 ball.0.8 foobar.8.7 ball.5.6))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.boolean?.3
            ((new-frames ())
             (locals (tmp.31 tmp.25 tmp.36 tmp-ra.32))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.33 ball.8.2 ball.9.1))
       (undead-out
    ...
    (define L.fn.1.2
      ((new-frames ())
       (locals (tmp-ra.34 bar.0.7 ball.3.6 ball.8.5 ball.9.4 foobar.5.3))
...
(check-by-interp
 '(module ((new-frames (()))
           (locals (foo.4.3 foobar.1.2 ball.5.1 ball.5.4 tmp.33))
          ...
          (define L.ascii-char?.2
            ((new-frames ())
             (locals (tmp.28 tmp.25 tmp.32 tmp-ra.29))
    ...
    (define L.eq?.1
      ((new-frames ())
       (locals (tmp.19 tmp.20 tmp-ra.30))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp.32 tmp-ra.31))
                           (call-undead ())
                           ...
                           (assignment ()))
          (define L.fn.0.1
            ((new-frames ()) (locals (tmp-ra.28 foo.4.3 bat.8.2 bat.6.1))
    ...
    (define L.func.2.3
      ((new-frames ()) (locals (tmp-ra.30))
                       (undead-out ((tmp-ra.30 rbp) (tmp-ra.30 rax rbp) (rax rbp)))
                       (call-undead ())
                       (conflicts ((tmp-ra.30 (rax rbp)) (rbp (rax tmp-ra.30)) (rax (rbp tmp-ra.30))))
                       (assignment ()))
      (begin
        (set! tmp-ra.30 r15)
        (set! rax 6)
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.3
            ((new-frames ())
             (locals (tmp.31 tmp.28 tmp.36 tmp-ra.32))
    ...
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.33 foobar.8.5 ball.0.4 foobar.2.3 foobar.6.2 bat.9.1))
      ...
      (begin
        ...
        (jump tmp-ra.33 rbp rax)))
    (define L.func.1.2
      ((new-frames ()) (locals (tmp-ra.34 foobar.2.7 foo.1.6))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.38))
          ...
          (define L.proc.0.1
            ((new-frames ())
             (locals (tmp-ra.36 ball.4.7 foobar.7.6 foo.6.5 bar.9.4 bat.3.3 foobar.0.2 ball.8.1))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals (tmp-ra.37 bat.3.12 bar.9.11 foo.1.10 ball.4.9 bar.5.8))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.3
            ((new-frames ())
             (locals (tmp.33 tmp.30 tmp.38 tmp-ra.34))
    ...
    (define L.func.0.1
      ((new-frames ())
       (locals (tmp-ra.35 foobar.4.5 bar.8.4 bat.7.3 bar.1.2 foo.9.1))
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.35 rbp) (rsi rdx rcx r8 tmp-ra.35 rbp)
                                                       (rdx rcx r8 tmp-ra.35 rbp)
                                                       (rcx r8 tmp-ra.35 rbp)
                                                       (r8 tmp-ra.35 rbp)
    ...
    (define L.func.1.2
      ((new-frames ())
       (locals (tmp-ra.36 foobar.3.9 foo.6.8 foobar.4.7 bar.1.6))
...
(check-by-interp
 '(module ((new-frames ())
           (locals (tmp-ra.34 bat.7.8 foobar.2.7))
           (call-undead ())
           (undead-out
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.33 bat.1.6 foobar.8.5 foobar.5.4 ball.3.3 bat.7.2))
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.33 rbp) (rsi rdx rcx r8 tmp-ra.33 rbp)
                                                       (rdx rcx r8 tmp-ra.33 rbp)
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.boolean?.3
            ((new-frames ())
             (locals (tmp.36 tmp.30 tmp.41 tmp-ra.37))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       (locals (tmp-ra.38 ball.3.5 bat.8.4 foobar.7.3 bar.6.2 bar.5.1))
    ...
    (define L.tmp.1.2
      ((new-frames ())
       (locals (tmp-ra.39 bat.2.12 foobar.4.11 bar.6.10 foobar.7.9 bar.5.8 ball.3.7 foo.9.6))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.3
            ((new-frames ())
             (locals (tmp.35 tmp.32 tmp.40 tmp-ra.36))
    ...
    (define L.x.0.1
      ((new-frames ())
       (locals (tmp-ra.37 foo.8.4 foobar.6.3 bat.0.2 ball.7.1))
    ...
    (define L.fn.1.2
      ((new-frames ())
       (locals (tmp-ra.38 bat.3.11 foobar.9.10 foobar.5.9 foo.8.8 bat.4.7 ball.7.6 foo.2.5))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.*.4
            ((new-frames ())
             (locals
              (tmp.32 tmp.42 tmp.10 tmp.33 tmp-ra.37 tmp.44 tmp.36 tmp.45 tmp.35 tmp.9 tmp.43 tmp.34))
             (undead-out
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.38 foo.9.2 foo.0.1))
       (undead-out
      ...
      (begin
        ...
        (jump tmp-ra.38 rbp rax)))
    (define L.fn.1.2
      ((new-frames ()) (locals (tmp-ra.39 bat.3.5 bat.1.4 bat.7.3))
    ...
    (define L.func.2.3
      ((new-frames ())
       (locals (tmp-ra.40 foo.2.7 foo.9.6))
       (undead-out
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.40))
          ...
          (define L.proc.0.1
            ((new-frames ())
             (locals (tmp-ra.37 foobar.1.5 foo.5.4 bat.4.3 foo.2.2 bat.0.1))
             (undead-out ((rdi rsi rdx rcx r8 tmp-ra.37 rbp) (rsi rdx rcx r8 tmp-ra.37 rbp)
                                                             (rdx rcx r8 tmp-ra.37 rbp)
    ...
    (define L.x.2.3
      ((new-frames ())
       (locals (tmp-ra.39 ball.9.13 bar.7.12 bat.4.11 foo.2.10 foobar.1.9 foo.3.8 foo.6.7))
       (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.39 rbp) (rsi rdx rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (rdx rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (rcx r8 r9 fv0 tmp-ra.39 rbp)
                                                              (r8 r9 fv0 tmp-ra.39 rbp)
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.38))
          ...
          (define L.fn.0.1
            ((new-frames ())
             (locals (tmp-ra.35 foobar.4.6 foo.3.5 bar.0.4 foo.7.3 bar.8.2 foobar.2.1))
            ...
            (begin
              ...
              (jump tmp-ra.35 rbp rax)))
    (define L.proc.1.2
      ((new-frames ()) (locals (tmp-ra.36 foo.7.9 foo.3.8 bar.0.7))
      ...
      (begin
        ...
        (jump tmp-ra.36 rbp rax)))
    (define L.x.2.3
      ((new-frames ()) (locals (tmp-ra.37 foobar.2.11 bar.8.10))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.empty?.3
            ((new-frames ())
             (locals (tmp.38 tmp.33 tmp.43 tmp-ra.39))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       (locals (tmp-ra.40 bar.2.7 foobar.0.6 foobar.9.5 ball.1.4 bat.3.3 bar.4.2 ball.8.1))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals (tmp-ra.41 foobar.0.14 bar.2.13 bar.4.12 ball.6.11 ball.5.10 bat.3.9 foobar.9.8))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp.38 tmp-ra.37))
                           (call-undead ())
          ...
          (define L.proc.0.1
            ((new-frames ())
             (locals (tmp-ra.34 foobar.8.7 foobar.2.6 bat.9.5 bar.6.4 bar.3.3 foobar.0.2 bar.4.1))
    ...
    (define L.func.1.2
      ((new-frames ()) (locals (tmp-ra.35))
                       ...
                       (call-undead ())
                       (conflicts ((tmp-ra.35 (rax rbp)) (rbp (rax tmp-ra.35)) (rax (rbp tmp-ra.35))))
                       (assignment ()))
      (begin
        (set! tmp-ra.35 r15)
        (set! rax 14)
        (jump tmp-ra.35 rbp rax)))
    (define L.fn.2.3
      ((new-frames ()) (locals (tmp-ra.36 foobar.7.10 ball.1.9 foobar.0.8))
                       (undead-out ((rdi rsi rdx tmp-ra.36 rbp) (rsi rdx tmp-ra.36 rbp)
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.4
            ((new-frames ())
             (locals (tmp.35 tmp.32 tmp.41 tmp-ra.36))
             (undead-out ((rdi tmp-ra.36 rbp) (tmp.32 tmp-ra.36 rbp)
    ...
    (define L.fn.0.1
      ((new-frames ())
       (locals (tmp-ra.37 foobar.3.7 bar.4.6 bat.6.5 foo.9.4 ball.0.3 foobar.5.2 foobar.8.1))
    ...
    (define L.tmp.1.2
      ...
      (begin
        ...
        (jump tmp-ra.38 rbp rax)))
    (define L.tmp.2.3
      ((new-frames ()) (locals (tmp-ra.39 foobar.8.11 foobar.5.10 ball.0.9))
                       (undead-out ((rdi rsi rdx tmp-ra.39 rbp) (rsi rdx tmp-ra.39 rbp)
                                                                (rdx tmp-ra.39 rbp)
                                                                (tmp-ra.39 rbp)
                                                                (tmp-ra.39 rax rbp)
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.boolean?.4
            ((new-frames ())
             (locals (tmp.37 tmp.31 tmp.43 tmp-ra.38))
            ...
            (begin
              ...
              (if (begin
                  ...
                  (begin
                    ...
                    (jump tmp-ra.38 rbp rax)))))
    (define L.tmp.0.1
      ((new-frames ()) (locals (tmp-ra.39 foo.4.3 bar.6.2 foobar.0.1))
                       (undead-out ((rdi rsi rdx tmp-ra.39 rbp) (rsi rdx tmp-ra.39 rbp)
    ...
    (define L.fn.1.2
      ((new-frames ())
       (locals (tmp-ra.40 foo.1.7 ball.9.6 foobar.3.5 bat.2.4))
    ...
    (define L.x.2.3
      ((new-frames ())
       (locals (tmp-ra.41 bar.6.13 bat.2.12 foobar.7.11 foo.1.10 ball.9.9 foobar.0.8))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.ascii-char?.4
            ((new-frames ())
             (locals (tmp.40 tmp.37 tmp.46 tmp-ra.41))
    ...
    (define L.tmp.0.1
      ((new-frames ())
       (locals (tmp-ra.42 bat.9.7 bar.0.6 bat.4.5 bar.8.4 bar.2.3 bar.5.2 ball.3.1))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals (tmp-ra.43 ball.3.12 bar.0.11 foo.7.10 bar.8.9 bar.5.8))
    ...
    (define L.func.2.3
      ((new-frames ())
       (locals (tmp-ra.44 foo.7.16 bar.2.15 bar.8.14 foobar.1.13))
...
(check-by-interp
 '(module ((new-frames (()))
          ...
          (define L.<.5
            ((new-frames ())
             (locals (tmp.37 tmp.47 tmp.21 tmp.38 tmp-ra.41 tmp.40 tmp.20 tmp.48 tmp.39))
             (undead-out
    ...
    (define L.eq?.4
      ((new-frames ())
       (locals (tmp.28 tmp.29 tmp-ra.42))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.43 bat.2.4 ball.8.3 foobar.7.2 foo.1.1))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.44 bat.5.9 foo.6.8 foobar.3.7 foobar.7.6 bat.0.5))
      ...
      (begin
        ...
        (jump tmp-ra.44 rbp rax)))
    (define L.x.2.3
      ((new-frames ()) (locals (tmp-ra.45 bar.4.12 foobar.3.11 bar.9.10))
...
(check-by-interp
 '(module ((new-frames (()))
          ...
          (define L.empty?.4
            ((new-frames ())
             (locals (tmp.40 tmp.35 tmp.46 tmp-ra.41))
    ...
    (define L.proc.0.1
      ((new-frames ())
       (locals (tmp-ra.42 foo.9.6 ball.5.5 ball.4.4 bar.8.3 ball.1.2 bat.7.1))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.43 bar.0.8 foo.6.7))
       (undead-out
    ...
    (define L.fn.2.3
      ((new-frames ())
       (locals (tmp-ra.44 ball.5.15 bar.8.14 foo.9.13 bat.7.12 ball.1.11 foo.6.10 bar.0.9))
...
(check-by-interp
 '(module ((new-frames ())
          ...
          (define L.fixnum?.4
            ((new-frames ())
             (locals (tmp.44 tmp.37 tmp.50 tmp-ra.45))
    ...
    (define L.x.0.1
      ((new-frames ())
       (locals (tmp-ra.46 bar.0.7 foobar.1.6 bat.4.5 foobar.5.4 foo.8.3 bat.9.2 bat.2.1))
    ...
    (define L.tmp.1.2
      ((new-frames ())
       (locals (tmp-ra.47 foobar.3.13 foobar.1.12 bat.9.11 foobar.5.10 bar.6.9 bat.4.8))
    ...
    (define L.tmp.2.3
      ((new-frames ())
       (locals (tmp-ra.48 bat.2.20 foobar.3.19 bar.0.18 foobar.5.17 bar.6.16 ball.7.15 foo.8.14))
...
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.45 foobar.8.18 ball.6.17 foo.0.16))
                           (call-undead ())
          ...
          (define L.tmp.0.1
            ((new-frames ())
             (locals (tmp-ra.42 foo.3.6 foo.0.5 ball.9.4 ball.1.3 ball.6.2 foobar.5.1))
    ...
    (define L.x.1.2
      ((new-frames ())
       (locals (tmp-ra.43 foobar.5.11 ball.7.10 foo.3.9 ball.1.8 ball.6.7))
       (undead-out ((rdi rsi rdx rcx r8 tmp-ra.43 rbp) (rsi rdx rcx r8 tmp-ra.43 rbp)
                                                       (rdx rcx r8 tmp-ra.43 rbp)
                                                       (rcx r8 tmp-ra.43 rbp)
                                                       (r8 tmp-ra.43 rbp)
    ...
    (define L.tmp.2.3
      ((new-frames ())
       (locals (tmp-ra.44 ball.6.15 ball.7.14 foo.2.13 foobar.5.12))
    ...
    (begin
      ...
      (jump tmp-ra.45 rbp rax))))
(check-by-interp
 '(module ((new-frames ()) (locals (tmp-ra.51 ball.3.24 foobar.5.23 foo.2.22 ball.6.21))
                           (call-undead ())
          ...
          (define L.fn.0.1
            ((new-frames ())
             (locals (tmp-ra.48 ball.6.7 bar.9.6 bat.8.5 ball.7.4 bat.4.3 bar.1.2 foobar.5.1))
    ...
    (define L.proc.1.2
      ((new-frames ())
       (locals (tmp-ra.49 foobar.5.14 bar.1.13 ball.7.12 bat.8.11 bat.4.10 ball.3.9 ball.6.8))
    ...
    (define L.x.2.3
      ((new-frames ())
       (locals (tmp-ra.50 ball.6.20 bar.9.19 ball.3.18 foobar.5.17 ball.7.16 bat.8.15))
