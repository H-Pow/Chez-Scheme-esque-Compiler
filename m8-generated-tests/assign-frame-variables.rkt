...
(require cpsc411/compiler-lib
         cpsc411/langs/v8
         (only-in "../assign-frame-variables.rkt"))
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.52 (rax ascii-char1.1 void0.2 rbp))
       ...
       (rax (rbp tmp-ra.52))))
     (assignment ((tmp-ra.52 r15) (void0.2 r14) (ascii-char1.1 r14))))
    (begin
      (set! tmp-ra.52 r15)
      (set! void0.2 30)
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.55 (rdi tmp.53 boolean1.2 ascii-char0.3 rbp))
       ...
       (r15 (rbp rdi))))
     (assignment
      ((tmp-ra.55 r15) (ascii-char0.3 r14) (boolean1.2 r14) (tmp.53 r14))))
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.54 (rax oprand0.1 rbp rdi))
         ...
         (rax (rbp tmp-ra.54))))
       (assignment ((tmp-ra.54 r15) (oprand0.1 r14))))
      (begin
        (set! tmp-ra.54 r15)
        (set! oprand0.1 rdi)
        (set! rax 30)
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.52 (rax ascii-char1.1 empty0.2 rbp))
       ...
       (rax (rbp tmp-ra.52))))
     (assignment ((tmp-ra.52 r15) (empty0.2 r14) (ascii-char1.1 r14))))
    (begin
      (set! tmp-ra.52 r15)
      (set! empty0.2 22)
      (set! ascii-char1.1 25390)
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.55 (rdi tmp.53 error1.2 void0.3 rbp))
       ...
       (rdi (r15 rbp tmp-ra.55))
       (r15 (rbp rdi))))
     (assignment ((tmp-ra.55 r15) (void0.3 r14) (error1.2 r14) (tmp.53 r14))))
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.55 (rdi tmp.53 error1.2 ascii-char0.3 rbp))
       ...
       (r15 (rbp rdi))))
     (assignment
      ((tmp-ra.55 r15) (ascii-char0.3 r14) (error1.2 r14) (tmp.53 r14))))
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.65 (empty2.1 fixnum1.2 fixnum0.3 rax rbp))
       ...
       (r15 (rbp rdi rsi))))
     (assignment
      ((tmp-ra.65 fv0) (fixnum0.3 r15) (fixnum1.2 r15) (empty2.1 r15))))
    (define L.-.8
      ((locals ())
       (conflicts
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.63 (rax oprand1.1 oprand0.2 rbp rsi rdi))
         ...
         (rax (rbp tmp-ra.63))))
       (assignment ((tmp-ra.63 r15) (oprand0.2 r14) (oprand1.1 r13))))
      (begin
        (set! tmp-ra.63 r15)
        (set! oprand0.2 rdi)
        (set! oprand1.1 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.64 (rax oprand1.3 oprand0.4 rbp rsi rdi))
         ...
         (rax (rbp tmp-ra.64))))
       (assignment ((tmp-ra.64 r15) (oprand0.4 r14) (oprand1.3 r14))))
      (begin
        (set! tmp-ra.64 r15)
        (set! oprand0.4 rdi)
        (set! oprand1.3 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.65 (rax oprand1.5 oprand0.6 rbp rsi rdi))
         ...
         (rax (rbp tmp-ra.65))))
       (assignment ((tmp-ra.65 r15) (oprand0.6 r14) (oprand1.5 r14))))
      (begin
        (set! tmp-ra.65 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp.62 (rbp tmp-ra.69))
         ...
         (rdi (tmp-ra.69))))
       (assignment ((tmp-ra.69 r15) (tmp.62 r14) (tmp.47 r14) (tmp.79 r14))))
      (begin
        (set! tmp-ra.69 r15)
        (set! tmp.47 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.70 (rax oprand2.1 oprand1.2 oprand0.3 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.70))))
       (assignment
        ((tmp-ra.70 r15) (oprand0.3 r14) (oprand1.2 r14) (oprand2.1 r14))))
      (begin
        (set! tmp-ra.70 r15)
        (set! oprand0.3 rdi)
        (set! oprand1.2 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp.67 (rbp tmp-ra.78))
         ...
         (rdi (tmp-ra.78))))
       (assignment ((tmp-ra.78 r15) (tmp.67 r14) (tmp.59 r14) (tmp.91 r14))))
      (begin
        (set! tmp-ra.78 r15)
        (set! tmp.59 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.68 (rbp tmp-ra.79))
         ...
         (rdi (tmp-ra.79))))
       (assignment ((tmp-ra.79 r15) (tmp.68 r14) (tmp.54 r14) (tmp.92 r14))))
      (begin
        (set! tmp-ra.79 r15)
        (set! tmp.54 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.73 (rbp tmp-ra.81))
         ...
         (rdi (tmp-ra.81))))
       (assignment ((tmp-ra.81 r15) (tmp.73 r14) (tmp.61 r14) (tmp.96 r14))))
      (begin
        (set! tmp-ra.81 r15)
        (set! tmp.61 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.82 (rax oprand2.1 oprand1.2 oprand0.3 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.82))))
       (assignment
        ((tmp-ra.82 r15) (oprand0.3 r14) (oprand1.2 r14) (oprand2.1 r14))))
      (begin
        (set! tmp-ra.82 r15)
        (set! oprand0.3 rdi)
        (set! oprand1.2 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.88 (oprand2.4 oprand1.5 oprand0.6 rbp rdx rsi rdi))
         ...
         (r15 (rbp))))
       (assignment
        ((tmp-ra.88 r15) (oprand0.6 r14) (oprand1.5 r14) (oprand2.4 r14))))
      (begin
        (set! tmp-ra.88 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.89 (rax oprand2.7 oprand1.8 oprand0.9 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.89))))
       (assignment
        ((tmp-ra.89 r15) (oprand0.9 r14) (oprand1.8 r14) (oprand2.7 r14))))
      (begin
        (set! tmp-ra.89 r15)
        (set! oprand0.9 rdi)
        (set! oprand1.8 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp.54 (rbp tmp-ra.56))
         ...
         (rdi (tmp-ra.56))))
       (assignment ((tmp-ra.56 r15) (tmp.54 r14) (tmp.42 r14) (tmp.63 r14))))
      (begin
        (set! tmp-ra.56 r15)
        (set! tmp.42 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.63 (rbp tmp-ra.73))
         ...
         (rdi (tmp-ra.73))))
       (assignment ((tmp-ra.73 r15) (tmp.63 r14) (tmp.46 r14) (tmp.85 r14))))
      (begin
        (set! tmp-ra.73 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.88))
         ...
         (rdi (tmp-ra.88))))
       (assignment ((tmp-ra.88 r15) (tmp.55 r14) (tmp.42 r14) (tmp.96 r14))))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.42 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.87))
         ...
         (rdi (tmp-ra.87))))
       (assignment ((tmp-ra.87 r15) (tmp.56 r14) (tmp.48 r14) (tmp.103 r14))))
      (begin
        (set! tmp-ra.87 r15)
        (set! tmp.48 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.70 (rbp tmp-ra.91))
         ...
         (rdi (tmp-ra.91))))
       (assignment ((tmp-ra.91 r15) (tmp.70 r14) (tmp.46 r14) (tmp.114 r14))))
      (begin
        (set! tmp-ra.91 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.99))
         ...
         (rdi (tmp-ra.99))))
       (assignment ((tmp-ra.99 r15) (tmp.56 r14) (tmp.43 r14) (tmp.111 r14))))
      (begin
        (set! tmp-ra.99 r15)
        (set! tmp.43 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.113))
         ...
         (rdi (tmp-ra.113))))
       (assignment ((tmp-ra.113 r15) (tmp.56 r14) (tmp.46 r14) (tmp.123 r14))))
      (begin
        (set! tmp-ra.113 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.101))
         ...
         (rdi (tmp-ra.101))))
       (assignment ((tmp-ra.101 r15) (tmp.56 r14) (tmp.47 r14) (tmp.115 r14))))
      (begin
        (set! tmp-ra.101 r15)
        (set! tmp.47 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.102))
         ...
         (rdi (tmp-ra.102))))
       (assignment ((tmp-ra.102 r15) (tmp.57 r14) (tmp.44 r14) (tmp.116 r14))))
      (begin
        (set! tmp-ra.102 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.85))
         ...
         (rdi (tmp-ra.85))))
       (assignment ((tmp-ra.85 r15) (tmp.56 r14) (tmp.44 r14) (tmp.99 r14))))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.69 (rbp tmp-ra.92))
         ...
         (rdi (tmp-ra.92))))
       (assignment ((tmp-ra.92 r15) (tmp.69 r14) (tmp.49 r14) (tmp.113 r14))))
      (begin
        (set! tmp-ra.92 r15)
        (set! tmp.49 rdi)
        (if (begin
