...
(check-by-interp
 '(module
    ((new-frames (() ()))
     ...
     (undead-out
      ((tmp-ra.59 rbp)
       ((rax tmp-ra.59 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp.55 tmp-ra.59 rbp)
       ((rax tmp.55 tmp-ra.59 rbp)
       ...
       (undead-out
        ((rdi rsi tmp-ra.57 rbp)
         ...
         ((((((tmp.60 tmp.19 tmp.20 tmp-ra.57 rbp)
              (tmp.60 tmp.19 tmp.20 tmp-ra.57 rbp)
              (tmp.52 tmp.19 tmp.20 tmp-ra.57 rbp))
             (tmp.19 tmp.20 tmp-ra.57 rbp))
            (tmp.51 tmp.19 tmp.20 tmp-ra.57 rbp)
            (tmp.51 tmp.19 tmp.20 tmp-ra.57 rbp))
           (tmp.19 tmp.20 tmp-ra.57 rbp))
          ((((((tmp.61 tmp.19 tmp.20 tmp-ra.57 rbp)
               (tmp.61 tmp.19 tmp.20 tmp-ra.57 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp.57 tmp.58 tmp.59 tmp-ra.56 void2.3 fixnum1.4 fixnum0.5))
     (call-undead ())
     (undead-out
      ((tmp-ra.56 rbp)
       ((((tmp.57 tmp-ra.56 rbp) (tmp-ra.56 rbp))
         ((tmp.58 tmp-ra.56 rbp) (tmp-ra.56 rbp))
         ((tmp.59 tmp-ra.56 rbp) (tmp-ra.56 rbp)))
        ((tmp-ra.56 rsi rbp)
         (tmp-ra.56 rsi rdi rbp)
         (rsi rdi r15 rbp)
         (rsi rdi r15 rbp))
        ((tmp-ra.56 rbp)
         (tmp-ra.56 rbp)
    ...
    (define L.fun/ascii-char8442.4
      ((new-frames ())
       (locals (tmp-ra.55 oprand0.2 oprand1.1))
       (undead-out
        ((rdi rsi tmp-ra.55 rbp)
         (rsi tmp-ra.55 rbp)
         (tmp-ra.55 rbp)
         (tmp-ra.55 rax rbp)
         (rax rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (fixnum0.3 ascii-char1.2 void2.1))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.58 rbp)
         (rsi tmp.17 tmp-ra.58 rbp)
         (tmp.18 tmp.17 tmp-ra.58 rbp)
         ((((((tmp.63 tmp.18 tmp.17 tmp-ra.58 rbp)
              (tmp.63 tmp.18 tmp.17 tmp-ra.58 rbp)
              (tmp.54 tmp.18 tmp.17 tmp-ra.58 rbp))
             (tmp.18 tmp.17 tmp-ra.58 rbp))
            (tmp.53 tmp.18 tmp.17 tmp-ra.58 rbp)
            (tmp.53 tmp.18 tmp.17 tmp-ra.58 rbp))
           (tmp.18 tmp.17 tmp-ra.58 rbp))
          ((((((tmp.64 tmp.18 tmp.17 tmp-ra.58 rbp)
               (tmp.64 tmp.18 tmp.17 tmp-ra.58 rbp)
               (tmp.56 tmp.18 tmp.17 tmp-ra.58 rbp))
              (tmp.18 tmp.17 tmp-ra.58 rbp))
             (tmp.55 tmp.18 tmp.17 tmp-ra.58 rbp)
             (tmp.55 tmp.18 tmp.17 tmp-ra.58 rbp))
            (tmp.18 tmp.17 tmp-ra.58 rbp))
           ((tmp.65 tmp.17 tmp-ra.58 rbp)
            (tmp.65 tmp.17 tmp-ra.58 rbp)
            (tmp.17 tmp.57 tmp-ra.58 rbp)
            (tmp.57 tmp.66 tmp-ra.58 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (empty0.3 fixnum2.1))
     (call-undead (error1.2 tmp-ra.60))
     (undead-out
      ((tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (error1.2 tmp-ra.60 rbp)
       ((rax error1.2 tmp-ra.60 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (error1.2 tmp-ra.60 rbp)
       (tmp-ra.60 rax rbp)
       (rax rbp)))
    ...
    (define L.-.7
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.57 rbp)
         (rsi tmp.21 tmp-ra.57 rbp)
         (tmp.21 tmp.22 tmp-ra.57 rbp)
         ((((((tmp.61 tmp.21 tmp.22 tmp-ra.57 rbp)
              (tmp.61 tmp.21 tmp.22 tmp-ra.57 rbp)
              (tmp.54 tmp.21 tmp.22 tmp-ra.57 rbp))
             (tmp.21 tmp.22 tmp-ra.57 rbp))
            (tmp.53 tmp.21 tmp.22 tmp-ra.57 rbp)
            (tmp.53 tmp.21 tmp.22 tmp-ra.57 rbp))
           (tmp.21 tmp.22 tmp-ra.57 rbp))
          ((((((tmp.62 tmp.21 tmp.22 tmp-ra.57 rbp)
               (tmp.62 tmp.21 tmp.22 tmp-ra.57 rbp)
               (tmp.56 tmp.21 tmp.22 tmp-ra.57 rbp))
              (tmp.21 tmp.22 tmp-ra.57 rbp))
             (tmp.55 tmp.21 tmp.22 tmp-ra.57 rbp)
             (tmp.55 tmp.21 tmp.22 tmp-ra.57 rbp))
            (tmp.21 tmp.22 tmp-ra.57 rbp))
           ((tmp.22 tmp.63 tmp-ra.57 rbp)
...
(check-by-interp
 '(module
    ((new-frames (()))
     (locals (tmp.54 tmp.58))
     (call-undead (tmp-ra.57))
     (undead-out
      ((tmp-ra.57 rbp)
       (((((rax tmp-ra.57 rbp)
           ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
          (tmp.54 tmp-ra.57 rbp))
         (tmp-ra.57 rbp))
        (((tmp.58 tmp-ra.57 rbp) (tmp-ra.57 rbp))
         ((tmp-ra.57 rax rbp) (rax rbp))
         ((tmp-ra.57 rax rbp) (rax rbp)))
        ((tmp-ra.57 rsi rbp)
         (tmp-ra.57 rsi rdi rbp)
         (rsi rdi r15 rbp)
         (rsi rdi r15 rbp)))))
     (conflicts
    ...
    (define L.fun/ascii-char8598.5
      ((new-frames ())
       (locals (tmp-ra.56 oprand0.4 oprand1.3))
       (undead-out
        ((rdi rsi tmp-ra.56 rbp)
         (rsi tmp-ra.56 rbp)
         (tmp-ra.56 rbp)
         (tmp-ra.56 rax rbp)
         (rax rbp)))
...
(check-by-interp
 '(module
       ...
       (((((rax tmp-ra.78 rbp)
        ...
        (((rax tmp-ra.78 rbp)
          ((rdx rbp)
           ...
           (rdx rsi rdi r15 rbp)))
         (tmp.70 tmp-ra.78 rbp)))
       ((((tmp.82 tmp.70 tmp-ra.78 rbp) (tmp.70 tmp-ra.78 rbp))
         ((tmp.83 tmp.70 tmp-ra.78 rbp) (tmp.70 tmp-ra.78 rbp))
         ((tmp.84 tmp.70 tmp-ra.78 rbp) (tmp.70 tmp-ra.78 rbp)))
        ((tmp.70 tmp-ra.78 rbp)
         (tmp.70 tmp-ra.78 rbp)
         (fixnum2.14 tmp.70 tmp-ra.78 rbp)
         (fixnum2.14 tmp.70 tmp-ra.78 rbp)
         (tmp.72 tmp.70 tmp-ra.78 rbp))
        (((rax tmp.70 tmp-ra.78 rbp)
          ((rdx rbp)
           (rdx rsi rbp)
           (rdx rsi rdi rbp)
           (rdx rsi rdi r15 rbp)
           (rdx rsi rdi r15 rbp)))
         (tmp.72 tmp.70 tmp-ra.78 rbp)))
       (tmp.70 tmp-ra.78 rsi rbp)
       (tmp-ra.78 rsi rdi rbp)
       (rsi rdi r15 rbp)
       (rsi rdi r15 rbp)))
     (conflicts
      ((tmp-ra.78
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.73 rbp)
         (rsi tmp.32 tmp-ra.73 rbp)
         (tmp.32 tmp.33 tmp-ra.73 rbp)
         ((((((tmp.79 tmp.32 tmp.33 tmp-ra.73 rbp)
              (tmp.79 tmp.32 tmp.33 tmp-ra.73 rbp)
              (tmp.67 tmp.32 tmp.33 tmp-ra.73 rbp))
             (tmp.32 tmp.33 tmp-ra.73 rbp))
            (tmp.66 tmp.32 tmp.33 tmp-ra.73 rbp)
            (tmp.66 tmp.32 tmp.33 tmp-ra.73 rbp))
           (tmp.32 tmp.33 tmp-ra.73 rbp))
          ((((((tmp.80 tmp.32 tmp.33 tmp-ra.73 rbp)
               (tmp.80 tmp.32 tmp.33 tmp-ra.73 rbp)
               (tmp.69 tmp.32 tmp.33 tmp-ra.73 rbp))
              (tmp.32 tmp.33 tmp-ra.73 rbp))
             (tmp.68 tmp.32 tmp.33 tmp-ra.73 rbp)
             (tmp.68 tmp.32 tmp.33 tmp-ra.73 rbp))
            (tmp.32 tmp.33 tmp-ra.73 rbp))
           ((tmp.33 tmp.81 tmp-ra.73 rbp)
            (tmp.81 tmp-ra.73 rbp)
            (tmp-ra.73 rax rbp)
            (rax rbp))
    ...
    (define L.fun/fixnum9203.4
      ((new-frames ())
       (locals (tmp-ra.74 oprand0.3 oprand1.2 oprand2.1))
       (undead-out
        ((rdi rsi rdx tmp-ra.74 rbp)
         (rsi rdx tmp-ra.74 rbp)
         (rdx tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
         (tmp-ra.74 rax rbp)
         (rax rbp)))
    ...
    (define L.fun/fixnum9202.5
      ((new-frames ())
       (locals (tmp-ra.75 oprand0.6 oprand1.5 oprand2.4))
       (undead-out
        ((rdi rsi rdx tmp-ra.75 rbp)
         (rsi rdx tmp-ra.75 rbp)
         (rdx tmp-ra.75 rbp)
         (tmp-ra.75 rbp)
         (tmp-ra.75 rax rbp)
         (rax rbp)))
    ...
    (define L.fun/fixnum9204.6
      ((new-frames ())
       (locals (tmp-ra.76 oprand0.9 oprand1.8 oprand2.7))
       (undead-out
        ((rdi rsi rdx tmp-ra.76 rbp)
         (rsi rdx tmp-ra.76 rbp)
         (rdx tmp-ra.76 rbp)
         (oprand2.7 tmp-ra.76 rbp)
         (tmp-ra.76 rax rbp)
         (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.fun/boolean9201.7
      ((new-frames ())
       (locals (tmp-ra.77 oprand0.12 oprand1.11 oprand2.10))
       (undead-out
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (tmp.68 fixnum0.4 ascii-char1.3 ascii-char2.2 void3.1))
     (call-undead (tmp.67 tmp-ra.76))
     (undead-out
      ((tmp-ra.76 rbp)
       ((rax tmp-ra.76 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.69 rbp)
         (rsi tmp.22 tmp-ra.69 rbp)
         (tmp.22 tmp.23 tmp-ra.69 rbp)
         ((((((tmp.77 tmp.22 tmp.23 tmp-ra.69 rbp)
              (tmp.77 tmp.22 tmp.23 tmp-ra.69 rbp)
              (tmp.55 tmp.22 tmp.23 tmp-ra.69 rbp))
             (tmp.22 tmp.23 tmp-ra.69 rbp))
            (tmp.54 tmp.22 tmp.23 tmp-ra.69 rbp)
            (tmp.54 tmp.22 tmp.23 tmp-ra.69 rbp))
           (tmp.22 tmp.23 tmp-ra.69 rbp))
          ((((((tmp.78 tmp.22 tmp.23 tmp-ra.69 rbp)
               (tmp.78 tmp.22 tmp.23 tmp-ra.69 rbp)
               (tmp.57 tmp.22 tmp.23 tmp-ra.69 rbp))
              (tmp.22 tmp.23 tmp-ra.69 rbp))
             (tmp.56 tmp.22 tmp.23 tmp-ra.69 rbp)
             (tmp.56 tmp.22 tmp.23 tmp-ra.69 rbp))
            (tmp.22 tmp.23 tmp-ra.69 rbp))
           ((tmp.23 tmp.79 tmp-ra.69 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.70 rbp)
         (rsi tmp.20 tmp-ra.70 rbp)
         (tmp.20 tmp.21 tmp-ra.70 rbp)
         ((((((tmp.80 tmp.20 tmp.21 tmp-ra.70 rbp)
              (tmp.80 tmp.20 tmp.21 tmp-ra.70 rbp)
              (tmp.59 tmp.20 tmp.21 tmp-ra.70 rbp))
             (tmp.20 tmp.21 tmp-ra.70 rbp))
            (tmp.58 tmp.20 tmp.21 tmp-ra.70 rbp)
            (tmp.58 tmp.20 tmp.21 tmp-ra.70 rbp))
           (tmp.20 tmp.21 tmp-ra.70 rbp))
          ((((((tmp.81 tmp.20 tmp.21 tmp-ra.70 rbp)
               (tmp.81 tmp.20 tmp.21 tmp-ra.70 rbp)
               (tmp.61 tmp.20 tmp.21 tmp-ra.70 rbp))
              (tmp.20 tmp.21 tmp-ra.70 rbp))
             (tmp.60 tmp.20 tmp.21 tmp-ra.70 rbp)
             (tmp.60 tmp.20 tmp.21 tmp-ra.70 rbp))
            (tmp.20 tmp.21 tmp-ra.70 rbp))
           ((tmp.21 tmp.82 tmp-ra.70 rbp)
            (tmp.82 tmp-ra.70 rbp)
            (tmp-ra.70 rax rbp)
            (rax rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.71 rbp)
         ...
         ((((((tmp.83 tmp.19 tmp.18 tmp-ra.71 rbp)
              (tmp.83 tmp.19 tmp.18 tmp-ra.71 rbp)
              (tmp.63 tmp.19 tmp.18 tmp-ra.71 rbp))
             (tmp.19 tmp.18 tmp-ra.71 rbp))
            (tmp.62 tmp.19 tmp.18 tmp-ra.71 rbp)
            (tmp.62 tmp.19 tmp.18 tmp-ra.71 rbp))
           (tmp.19 tmp.18 tmp-ra.71 rbp))
          ((((((tmp.84 tmp.19 tmp.18 tmp-ra.71 rbp)
               (tmp.84 tmp.19 tmp.18 tmp-ra.71 rbp)
               (tmp.65 tmp.19 tmp.18 tmp-ra.71 rbp))
              (tmp.19 tmp.18 tmp-ra.71 rbp))
             (tmp.64 tmp.19 tmp.18 tmp-ra.71 rbp)
             (tmp.64 tmp.19 tmp.18 tmp-ra.71 rbp))
            (tmp.19 tmp.18 tmp-ra.71 rbp))
           ((tmp.85 tmp.18 tmp-ra.71 rbp)
            (tmp.85 tmp.18 tmp-ra.71 rbp)
            (tmp.18 tmp.66 tmp-ra.71 rbp)
            (tmp.66 tmp.86 tmp-ra.71 rbp)
            (tmp.86 tmp-ra.71 rbp)
            (tmp-ra.71 rax rbp)
            (rax rbp))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () ()))
     (locals (tmp.64 fixnum0.4 tmp.66 fixnum1.3 error2.2 tmp.68 fixnum3.1))
     (call-undead (tmp.63 tmp.67 tmp.65 tmp-ra.73))
     (undead-out
      ((tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.63 tmp-ra.73 rbp)
       ((rax tmp.63 tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.63 tmp.64 tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((tmp.63 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.65 tmp-ra.73 rbp)
       ((rax tmp.65 tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.65 tmp.66 tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((tmp.65 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.67 tmp-ra.73 rbp)
       ((rax tmp.67 tmp-ra.73 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.67 tmp.68 tmp-ra.73 rbp)
       ((rax tmp-ra.73 rbp)
        ((tmp.67 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.73 rbp)
       (r15 rbp)
    ...
    (define L.*.8
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.69 rbp)
         (rsi tmp.18 tmp-ra.69 rbp)
         (tmp.19 tmp.18 tmp-ra.69 rbp)
         ((((((tmp.74 tmp.19 tmp.18 tmp-ra.69 rbp)
              (tmp.74 tmp.19 tmp.18 tmp-ra.69 rbp)
              (tmp.55 tmp.19 tmp.18 tmp-ra.69 rbp))
             (tmp.19 tmp.18 tmp-ra.69 rbp))
            (tmp.54 tmp.19 tmp.18 tmp-ra.69 rbp)
            (tmp.54 tmp.19 tmp.18 tmp-ra.69 rbp))
           (tmp.19 tmp.18 tmp-ra.69 rbp))
          ((((((tmp.75 tmp.19 tmp.18 tmp-ra.69 rbp)
               (tmp.75 tmp.19 tmp.18 tmp-ra.69 rbp)
               (tmp.57 tmp.19 tmp.18 tmp-ra.69 rbp))
              (tmp.19 tmp.18 tmp-ra.69 rbp))
             (tmp.56 tmp.19 tmp.18 tmp-ra.69 rbp)
             (tmp.56 tmp.19 tmp.18 tmp-ra.69 rbp))
            (tmp.19 tmp.18 tmp-ra.69 rbp))
           ((tmp.76 tmp.18 tmp-ra.69 rbp)
            (tmp.76 tmp.18 tmp-ra.69 rbp)
            (tmp.18 tmp.58 tmp-ra.69 rbp)
            (tmp.58 tmp.77 tmp-ra.69 rbp)
    ...
    (define L.-.7
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.70 rbp)
         (rsi tmp.22 tmp-ra.70 rbp)
         (tmp.22 tmp.23 tmp-ra.70 rbp)
         ((((((tmp.78 tmp.22 tmp.23 tmp-ra.70 rbp)
              (tmp.78 tmp.22 tmp.23 tmp-ra.70 rbp)
              (tmp.60 tmp.22 tmp.23 tmp-ra.70 rbp))
             (tmp.22 tmp.23 tmp-ra.70 rbp))
            (tmp.59 tmp.22 tmp.23 tmp-ra.70 rbp)
            (tmp.59 tmp.22 tmp.23 tmp-ra.70 rbp))
           (tmp.22 tmp.23 tmp-ra.70 rbp))
          ((((((tmp.79 tmp.22 tmp.23 tmp-ra.70 rbp)
               (tmp.79 tmp.22 tmp.23 tmp-ra.70 rbp)
               (tmp.62 tmp.22 tmp.23 tmp-ra.70 rbp))
              (tmp.22 tmp.23 tmp-ra.70 rbp))
             (tmp.61 tmp.22 tmp.23 tmp-ra.70 rbp)
             (tmp.61 tmp.22 tmp.23 tmp-ra.70 rbp))
            (tmp.22 tmp.23 tmp-ra.70 rbp))
           ((tmp.23 tmp.80 tmp-ra.70 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (tmp.68 fixnum1.3 empty2.2 empty3.1))
     (call-undead (void0.4 tmp.67 tmp-ra.75))
     (undead-out
      ((tmp-ra.75 rbp)
       ((rax tmp-ra.75 rbp) ((r15 rbp) (r15 rbp)))
       (void0.4 tmp-ra.75 rbp)
       ((rax void0.4 tmp-ra.75 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.67 void0.4 tmp-ra.75 rbp)
       ((rax tmp.67 void0.4 tmp-ra.75 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.67 tmp.68 void0.4 tmp-ra.75 rbp)
       ((rax void0.4 tmp-ra.75 rbp)
        ((tmp.67 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void0.4 tmp-ra.75 rbp)
       ((rax void0.4 tmp-ra.75 rbp) ((r15 rbp) (r15 rbp)))
       (void0.4 tmp-ra.75 rbp)
       ((rax void0.4 tmp-ra.75 rbp) ((r15 rbp) (r15 rbp)))
       (void0.4 tmp-ra.75 rbp)
       (tmp-ra.75 rax rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.69 rbp)
         (rsi tmp.22 tmp-ra.69 rbp)
         (tmp.22 tmp.23 tmp-ra.69 rbp)
         ((((((tmp.76 tmp.22 tmp.23 tmp-ra.69 rbp)
              (tmp.76 tmp.22 tmp.23 tmp-ra.69 rbp)
              (tmp.55 tmp.22 tmp.23 tmp-ra.69 rbp))
             (tmp.22 tmp.23 tmp-ra.69 rbp))
            (tmp.54 tmp.22 tmp.23 tmp-ra.69 rbp)
    ...
    (define L.*.9
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.70 rbp)
         (rsi tmp.18 tmp-ra.70 rbp)
         (tmp.19 tmp.18 tmp-ra.70 rbp)
         ((((((tmp.79 tmp.19 tmp.18 tmp-ra.70 rbp)
              (tmp.79 tmp.19 tmp.18 tmp-ra.70 rbp)
              (tmp.59 tmp.19 tmp.18 tmp-ra.70 rbp))
             (tmp.19 tmp.18 tmp-ra.70 rbp))
            (tmp.58 tmp.19 tmp.18 tmp-ra.70 rbp)
            (tmp.58 tmp.19 tmp.18 tmp-ra.70 rbp))
           (tmp.19 tmp.18 tmp-ra.70 rbp))
          ((((((tmp.80 tmp.19 tmp.18 tmp-ra.70 rbp)
               (tmp.80 tmp.19 tmp.18 tmp-ra.70 rbp)
               (tmp.61 tmp.19 tmp.18 tmp-ra.70 rbp))
              (tmp.19 tmp.18 tmp-ra.70 rbp))
             (tmp.60 tmp.19 tmp.18 tmp-ra.70 rbp)
             (tmp.60 tmp.19 tmp.18 tmp-ra.70 rbp))
            (tmp.19 tmp.18 tmp-ra.70 rbp))
           ((tmp.81 tmp.18 tmp-ra.70 rbp)
            (tmp.81 tmp.18 tmp-ra.70 rbp)
            (tmp.18 tmp.62 tmp-ra.70 rbp)
            (tmp.62 tmp.82 tmp-ra.70 rbp)
            (tmp.82 tmp-ra.70 rbp)
            (tmp-ra.70 rax rbp)
            (rax rbp))
           ((tmp-ra.70 rax rbp) (rax rbp)))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.71 rbp)
         ...
         ((((((tmp.83 tmp.20 tmp.21 tmp-ra.71 rbp)
              (tmp.83 tmp.20 tmp.21 tmp-ra.71 rbp)
              (tmp.64 tmp.20 tmp.21 tmp-ra.71 rbp))
             (tmp.20 tmp.21 tmp-ra.71 rbp))
            (tmp.63 tmp.20 tmp.21 tmp-ra.71 rbp)
            (tmp.63 tmp.20 tmp.21 tmp-ra.71 rbp))
           (tmp.20 tmp.21 tmp-ra.71 rbp))
          ((((((tmp.84 tmp.20 tmp.21 tmp-ra.71 rbp)
               (tmp.84 tmp.20 tmp.21 tmp-ra.71 rbp)
               (tmp.66 tmp.20 tmp.21 tmp-ra.71 rbp))
              (tmp.20 tmp.21 tmp-ra.71 rbp))
             (tmp.65 tmp.20 tmp.21 tmp-ra.71 rbp)
             (tmp.65 tmp.20 tmp.21 tmp-ra.71 rbp))
            (tmp.20 tmp.21 tmp-ra.71 rbp))
           ((tmp.21 tmp.85 tmp-ra.71 rbp)
            (tmp.85 tmp-ra.71 rbp)
            (tmp-ra.71 rax rbp)
            (rax rbp))
           ((tmp-ra.71 rax rbp) (rax rbp)))
          ((tmp-ra.71 rax rbp) (rax rbp)))))
...
(check-by-interp
 '(module
     ...
     (undead-out
      ((tmp-ra.74 rbp)
       (((tmp-ra.74 rbp)
         ...
         (tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
         ((tmp.78 tmp-ra.74 rbp) (tmp-ra.74 rbp)))
        ((tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
         (tmp.69 tmp-ra.74 rbp)
         ((rax tmp.69 tmp-ra.74 rbp)
          ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
         (tmp.70 tmp.69 tmp-ra.74 rbp)
         (((tmp.79 tmp.70 tmp.69 tmp-ra.74 rbp) (tmp.70 tmp.69 tmp-ra.74 rbp))
          (tmp.71 tmp.70 tmp.69 tmp-ra.74 rbp)
          (tmp.71 tmp.70 tmp.69 tmp-ra.74 rbp))
         (tmp.70 tmp.69 tmp-ra.74 rdx rbp)
         (tmp.69 tmp-ra.74 rdx rsi rbp)
         (tmp-ra.74 rdx rsi rdi rbp)
         (rdx rsi rdi r15 rbp)
         (rdx rsi rdi r15 rbp))
        ((tmp-ra.74 rbp)
         (tmp-ra.74 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.72 rbp)
         (rsi tmp.33 tmp-ra.72 rbp)
         (tmp.33 tmp.34 tmp-ra.72 rbp)
         ((((((tmp.75 tmp.33 tmp.34 tmp-ra.72 rbp)
              (tmp.75 tmp.33 tmp.34 tmp-ra.72 rbp)
              (tmp.66 tmp.33 tmp.34 tmp-ra.72 rbp))
             (tmp.33 tmp.34 tmp-ra.72 rbp))
            (tmp.65 tmp.33 tmp.34 tmp-ra.72 rbp)
            (tmp.65 tmp.33 tmp.34 tmp-ra.72 rbp))
           (tmp.33 tmp.34 tmp-ra.72 rbp))
          ((((((tmp.76 tmp.33 tmp.34 tmp-ra.72 rbp)
               (tmp.76 tmp.33 tmp.34 tmp-ra.72 rbp)
               (tmp.68 tmp.33 tmp.34 tmp-ra.72 rbp))
              (tmp.33 tmp.34 tmp-ra.72 rbp))
             (tmp.67 tmp.33 tmp.34 tmp-ra.72 rbp)
             (tmp.67 tmp.33 tmp.34 tmp-ra.72 rbp))
            (tmp.33 tmp.34 tmp-ra.72 rbp))
           ((tmp.34 tmp.77 tmp-ra.72 rbp)
            (tmp.77 tmp-ra.72 rbp)
            (tmp-ra.72 rax rbp)
            (rax rbp))
    ...
    (define L.fun/ascii-char9530.4
      ((new-frames ())
       (locals (tmp-ra.73 oprand0.3 oprand1.2 oprand2.1))
       (undead-out
        ((rdi rsi rdx tmp-ra.73 rbp)
         (rsi rdx tmp-ra.73 rbp)
         (rdx tmp-ra.73 rbp)
         (tmp-ra.73 rbp)
         (tmp-ra.73 rax rbp)
         (rax rbp)))
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp.51 tmp.52 tmp.53 tmp-ra.50 tmp.54 tmp.55))
     (call-undead ())
     (undead-out
      ((tmp-ra.50 rbp)
       ((((tmp.51 tmp-ra.50 rbp) (tmp-ra.50 rbp))
         ((tmp.52 tmp-ra.50 rbp) (tmp-ra.50 rbp))
         ((tmp.53 tmp-ra.50 rbp) (tmp-ra.50 rbp)))
        (((tmp.54 tmp-ra.50 rbp) (tmp-ra.50 rbp))
         ((tmp-ra.50 rax rbp) (rax rbp))
         ((tmp-ra.50 rax rbp) (rax rbp)))
        (((tmp.55 tmp-ra.50 rbp) (tmp-ra.50 rbp))
         ((tmp-ra.50 rax rbp) (rax rbp))
         ((tmp-ra.50 rax rbp) (rax rbp))))))
     (conflicts
      ((tmp.51 (rbp tmp-ra.50))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (empty0.4 error2.2 tmp.64 fixnum3.1))
     (call-undead (tmp.63 void1.3 tmp-ra.70))
     (undead-out
      ((tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (void1.3 tmp-ra.70 rbp)
       ((rax void1.3 tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (void1.3 tmp-ra.70 rbp)
       ((rax void1.3 tmp-ra.70 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.63 void1.3 tmp-ra.70 rbp)
       ((rax tmp.63 void1.3 tmp-ra.70 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.63 tmp.64 void1.3 tmp-ra.70 rbp)
       ((rax void1.3 tmp-ra.70 rbp)
        ((tmp.63 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void1.3 tmp-ra.70 rbp)
       (tmp-ra.70 rax rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (error0.4 tmp.55 boolean1.3 error2.2 error3.1))
     (call-undead (tmp-ra.62))
     (undead-out
      ((tmp-ra.62 rbp)
       ((rax tmp-ra.62 rbp) ((r15 rbp) (r15 rbp)))
    ...
    (define L.void?.10
      ((new-frames ())
       (locals (tmp.54 tmp.44 tmp.63 tmp-ra.56))
       (undead-out
        ((rdi tmp-ra.56 rbp)
         (tmp.44 tmp-ra.56 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (ascii-char0.5 tmp.56 boolean1.4 void2.3 error3.2 void4.1))
     (call-undead (tmp-ra.63))
     (undead-out
      ((tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.56 tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
    ...
    (define L.ascii-char?.10
      ((new-frames ())
       (locals (tmp.55 tmp.46 tmp.64 tmp-ra.57))
       (undead-out
        ((rdi tmp-ra.57 rbp)
         (tmp.46 tmp-ra.57 rbp)
         ((((tmp.64 tmp-ra.57 rbp)
            (tmp.64 tmp-ra.57 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (error0.5 error1.4 ascii-char3.2 error4.1))
     (call-undead (empty2.3 tmp-ra.60))
     (undead-out
      ((tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.60 rbp)
       ...
       (tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (empty2.3 tmp-ra.60 rbp)
       ((rax empty2.3 tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (empty2.3 tmp-ra.60 rbp)
       ((rax empty2.3 tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (empty2.3 tmp-ra.60 rbp)
       (tmp-ra.60 rax rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () ()))
     (locals
      (void0.5
       ...
       error3.2
       error4.1))
     (call-undead (tmp.74 tmp.70 tmp.71 tmp-ra.84))
     (undead-out
      ((tmp-ra.84 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.77 rbp)
         (rsi tmp.21 tmp-ra.77 rbp)
         (tmp.21 tmp.22 tmp-ra.77 rbp)
         ((((((tmp.88 tmp.21 tmp.22 tmp-ra.77 rbp)
              (tmp.88 tmp.21 tmp.22 tmp-ra.77 rbp)
              (tmp.60 tmp.21 tmp.22 tmp-ra.77 rbp))
             (tmp.21 tmp.22 tmp-ra.77 rbp))
            (tmp.59 tmp.21 tmp.22 tmp-ra.77 rbp)
            (tmp.59 tmp.21 tmp.22 tmp-ra.77 rbp))
           (tmp.21 tmp.22 tmp-ra.77 rbp))
          ((((((tmp.89 tmp.21 tmp.22 tmp-ra.77 rbp)
               (tmp.89 tmp.21 tmp.22 tmp-ra.77 rbp)
               (tmp.62 tmp.21 tmp.22 tmp-ra.77 rbp))
              (tmp.21 tmp.22 tmp-ra.77 rbp))
             (tmp.61 tmp.21 tmp.22 tmp-ra.77 rbp)
             (tmp.61 tmp.21 tmp.22 tmp-ra.77 rbp))
            (tmp.21 tmp.22 tmp-ra.77 rbp))
           ((tmp.22 tmp.90 tmp-ra.77 rbp)
       ...
       (undead-out
        ((rdi rsi tmp-ra.78 rbp)
         ...
         ((((((tmp.91 tmp.20 tmp.19 tmp-ra.78 rbp)
             ...
             (tmp.20 tmp.19 tmp-ra.78 rbp))
            (tmp.63 tmp.20 tmp.19 tmp-ra.78 rbp)
            (tmp.63 tmp.20 tmp.19 tmp-ra.78 rbp))
           (tmp.20 tmp.19 tmp-ra.78 rbp))
          ((((((tmp.92 tmp.20 tmp.19 tmp-ra.78 rbp)
           ...
           ((tmp.93 tmp.19 tmp-ra.78 rbp)
            (tmp.93 tmp.19 tmp-ra.78 rbp)
            (tmp.19 tmp.67 tmp-ra.78 rbp)
            (tmp.67 tmp.94 tmp-ra.78 rbp)
    ...
    (define L.empty?.9
      ((new-frames ())
       (locals (tmp.68 tmp.44 tmp.95 tmp-ra.79))
       (undead-out
        ((rdi tmp-ra.79 rbp)
         (tmp.44 tmp-ra.79 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () () () () () () ()))
     (locals
      (tmp.71
       ...
       boolean3.2
       empty4.1))
     (call-undead (tmp.70 tmp.69 tmp.76 tmp.75 tmp.79 tmp.73 tmp-ra.90))
     (undead-out
      ((tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       ...
       ((rax tmp.70 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.71 tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp-ra.90 rbp)
       ((rax tmp.69 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.69 tmp-ra.90 rbp)
       ((rax tmp.73 tmp.69 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.74 tmp.69 tmp-ra.90 rbp)
       ((rax tmp.69 tmp-ra.90 rbp)
        ((tmp.73 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.72 tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp)
       ...
       ((rax tmp.76 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.76 tmp.77 tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp)
        ((tmp.76 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 tmp-ra.90 rbp)
       ((rax tmp.75 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.75 tmp-ra.90 rbp)
       ((rax tmp.79 tmp.75 tmp-ra.90 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.80 tmp.75 tmp-ra.90 rbp)
       ((rax tmp.75 tmp-ra.90 rbp)
        ((tmp.79 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 tmp.78 tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp)
        ((tmp.75 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.81 tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.90 rbp)
       ((rax tmp-ra.90 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.90 rbp)
       (r15 rbp)
    ...
    (define L.pair?.12
      ((new-frames ())
       (locals (tmp.55 tmp.48 tmp.91 tmp-ra.82))
       (undead-out
        ((rdi tmp-ra.82 rbp)
         (tmp.48 tmp-ra.82 rbp)
         ((((tmp.91 tmp-ra.82 rbp)
            (tmp.91 tmp-ra.82 rbp)
            (tmp.55 tmp-ra.82 rbp))
           (tmp-ra.82 rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.83 rbp)
         ...
         ((((((tmp.92 tmp.21 tmp.22 tmp-ra.83 rbp)
              (tmp.92 tmp.21 tmp.22 tmp-ra.83 rbp)
              (tmp.57 tmp.21 tmp.22 tmp-ra.83 rbp))
             (tmp.21 tmp.22 tmp-ra.83 rbp))
            (tmp.56 tmp.21 tmp.22 tmp-ra.83 rbp)
            (tmp.56 tmp.21 tmp.22 tmp-ra.83 rbp))
           (tmp.21 tmp.22 tmp-ra.83 rbp))
          ((((((tmp.93 tmp.21 tmp.22 tmp-ra.83 rbp)
               (tmp.93 tmp.21 tmp.22 tmp-ra.83 rbp)
               (tmp.59 tmp.21 tmp.22 tmp-ra.83 rbp))
              (tmp.21 tmp.22 tmp-ra.83 rbp))
             (tmp.58 tmp.21 tmp.22 tmp-ra.83 rbp)
             (tmp.58 tmp.21 tmp.22 tmp-ra.83 rbp))
            (tmp.21 tmp.22 tmp-ra.83 rbp))
           ((tmp.22 tmp.94 tmp-ra.83 rbp)
            (tmp.94 tmp-ra.83 rbp)
            (tmp-ra.83 rax rbp)
            (rax rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.84 rbp)
         ...
         ((((((tmp.95 tmp.23 tmp.24 tmp-ra.84 rbp)
              (tmp.95 tmp.23 tmp.24 tmp-ra.84 rbp)
              (tmp.61 tmp.23 tmp.24 tmp-ra.84 rbp))
             (tmp.23 tmp.24 tmp-ra.84 rbp))
            (tmp.60 tmp.23 tmp.24 tmp-ra.84 rbp)
            (tmp.60 tmp.23 tmp.24 tmp-ra.84 rbp))
           (tmp.23 tmp.24 tmp-ra.84 rbp))
          ((((((tmp.96 tmp.23 tmp.24 tmp-ra.84 rbp)
               (tmp.96 tmp.23 tmp.24 tmp-ra.84 rbp)
               (tmp.63 tmp.23 tmp.24 tmp-ra.84 rbp))
              (tmp.23 tmp.24 tmp-ra.84 rbp))
             (tmp.62 tmp.23 tmp.24 tmp-ra.84 rbp)
             (tmp.62 tmp.23 tmp.24 tmp-ra.84 rbp))
            (tmp.23 tmp.24 tmp-ra.84 rbp))
           ((tmp.24 tmp.97 tmp-ra.84 rbp)
            (tmp.97 tmp-ra.84 rbp)
            (tmp-ra.84 rax rbp)
            (rax rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.85 rbp)
         (rsi tmp.19 tmp-ra.85 rbp)
         (tmp.20 tmp.19 tmp-ra.85 rbp)
         ((((((tmp.98 tmp.20 tmp.19 tmp-ra.85 rbp)
              (tmp.98 tmp.20 tmp.19 tmp-ra.85 rbp)
              (tmp.65 tmp.20 tmp.19 tmp-ra.85 rbp))
             (tmp.20 tmp.19 tmp-ra.85 rbp))
            (tmp.64 tmp.20 tmp.19 tmp-ra.85 rbp)
            (tmp.64 tmp.20 tmp.19 tmp-ra.85 rbp))
           (tmp.20 tmp.19 tmp-ra.85 rbp))
          ((((((tmp.99 tmp.20 tmp.19 tmp-ra.85 rbp)
               (tmp.99 tmp.20 tmp.19 tmp-ra.85 rbp)
               (tmp.67 tmp.20 tmp.19 tmp-ra.85 rbp))
              (tmp.20 tmp.19 tmp-ra.85 rbp))
             (tmp.66 tmp.20 tmp.19 tmp-ra.85 rbp)
             (tmp.66 tmp.20 tmp.19 tmp-ra.85 rbp))
            (tmp.20 tmp.19 tmp-ra.85 rbp))
           ((tmp.100 tmp.19 tmp-ra.85 rbp)
            (tmp.100 tmp.19 tmp-ra.85 rbp)
            (tmp.19 tmp.68 tmp-ra.85 rbp)
            (tmp.68 tmp.101 tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () ()))
     (locals
      (tmp.71
       ...
       ascii-char3.2
       error4.1))
     (call-undead (ascii-char0.5 tmp.73 tmp.69 tmp.70 tmp-ra.84))
     (undead-out
      ((tmp-ra.84 rbp)
       ((rax tmp-ra.84 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char0.5 tmp-ra.84 rbp)
       ((rax ascii-char0.5 tmp-ra.84 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 ascii-char0.5 tmp-ra.84 rbp)
       ((rax tmp.70 ascii-char0.5 tmp-ra.84 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.71 ascii-char0.5 tmp-ra.84 rbp)
       ((rax ascii-char0.5 tmp-ra.84 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 ascii-char0.5 tmp-ra.84 rbp)
       ((rax tmp.69 ascii-char0.5 tmp-ra.84 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.69 ascii-char0.5 tmp-ra.84 rbp)
       ((rax tmp.73 tmp.69 ascii-char0.5 tmp-ra.84 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.74 tmp.69 ascii-char0.5 tmp-ra.84 rbp)
       ((rax tmp.69 ascii-char0.5 tmp-ra.84 rbp)
        ((tmp.73 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.72 ascii-char0.5 tmp-ra.84 rbp)
       ((rax ascii-char0.5 tmp-ra.84 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (ascii-char0.5 tmp-ra.84 rbp)
       ((rax ascii-char0.5 tmp-ra.84 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.75 ascii-char0.5 tmp-ra.84 rbp)
       ((rax ascii-char0.5 tmp-ra.84 rbp)
    ...
    (define L.fixnum?.12
      ((new-frames ())
       (locals (tmp.55 tmp.42 tmp.85 tmp-ra.76))
       (undead-out
        ((rdi tmp-ra.76 rbp)
         (tmp.42 tmp-ra.76 rbp)
         ((((tmp.85 tmp-ra.76 rbp)
            (tmp.85 tmp-ra.76 rbp)
            (tmp.55 tmp-ra.76 rbp))
           (tmp-ra.76 rbp))
          ((tmp-ra.76 rax rbp) (rax rbp))
          ((tmp-ra.76 rax rbp) (rax rbp)))))
       (call-undead ())
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.77 rbp)
         (rsi tmp.21 tmp-ra.77 rbp)
         (tmp.21 tmp.22 tmp-ra.77 rbp)
         ((((((tmp.86 tmp.21 tmp.22 tmp-ra.77 rbp)
              (tmp.86 tmp.21 tmp.22 tmp-ra.77 rbp)
              (tmp.57 tmp.21 tmp.22 tmp-ra.77 rbp))
             (tmp.21 tmp.22 tmp-ra.77 rbp))
            (tmp.56 tmp.21 tmp.22 tmp-ra.77 rbp)
            (tmp.56 tmp.21 tmp.22 tmp-ra.77 rbp))
           (tmp.21 tmp.22 tmp-ra.77 rbp))
          ((((((tmp.87 tmp.21 tmp.22 tmp-ra.77 rbp)
               (tmp.87 tmp.21 tmp.22 tmp-ra.77 rbp)
               (tmp.59 tmp.21 tmp.22 tmp-ra.77 rbp))
              (tmp.21 tmp.22 tmp-ra.77 rbp))
             (tmp.58 tmp.21 tmp.22 tmp-ra.77 rbp)
             (tmp.58 tmp.21 tmp.22 tmp-ra.77 rbp))
            (tmp.21 tmp.22 tmp-ra.77 rbp))
           ((tmp.22 tmp.88 tmp-ra.77 rbp)
            (tmp.88 tmp-ra.77 rbp)
            (tmp-ra.77 rax rbp)
            (rax rbp))
           ((tmp-ra.77 rax rbp) (rax rbp)))
          ((tmp-ra.77 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.78 rbp)
         (rsi tmp.19 tmp-ra.78 rbp)
         (tmp.20 tmp.19 tmp-ra.78 rbp)
         ((((((tmp.89 tmp.20 tmp.19 tmp-ra.78 rbp)
              (tmp.89 tmp.20 tmp.19 tmp-ra.78 rbp)
              (tmp.61 tmp.20 tmp.19 tmp-ra.78 rbp))
             (tmp.20 tmp.19 tmp-ra.78 rbp))
            (tmp.60 tmp.20 tmp.19 tmp-ra.78 rbp)
            (tmp.60 tmp.20 tmp.19 tmp-ra.78 rbp))
           (tmp.20 tmp.19 tmp-ra.78 rbp))
          ((((((tmp.90 tmp.20 tmp.19 tmp-ra.78 rbp)
               (tmp.90 tmp.20 tmp.19 tmp-ra.78 rbp)
               (tmp.63 tmp.20 tmp.19 tmp-ra.78 rbp))
              (tmp.20 tmp.19 tmp-ra.78 rbp))
             (tmp.62 tmp.20 tmp.19 tmp-ra.78 rbp)
             (tmp.62 tmp.20 tmp.19 tmp-ra.78 rbp))
            (tmp.20 tmp.19 tmp-ra.78 rbp))
           ((tmp.91 tmp.19 tmp-ra.78 rbp)
            (tmp.91 tmp.19 tmp-ra.78 rbp)
            (tmp.19 tmp.64 tmp-ra.78 rbp)
            (tmp.64 tmp.92 tmp-ra.78 rbp)
            (tmp.92 tmp-ra.78 rbp)
            (tmp-ra.78 rax rbp)
            (rax rbp))
           ((tmp-ra.78 rax rbp) (rax rbp)))
          ((tmp-ra.78 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.79 rbp)
         (rsi tmp.23 tmp-ra.79 rbp)
         (tmp.23 tmp.24 tmp-ra.79 rbp)
         ((((((tmp.93 tmp.23 tmp.24 tmp-ra.79 rbp)
              (tmp.93 tmp.23 tmp.24 tmp-ra.79 rbp)
              (tmp.66 tmp.23 tmp.24 tmp-ra.79 rbp))
             (tmp.23 tmp.24 tmp-ra.79 rbp))
            (tmp.65 tmp.23 tmp.24 tmp-ra.79 rbp)
            (tmp.65 tmp.23 tmp.24 tmp-ra.79 rbp))
           (tmp.23 tmp.24 tmp-ra.79 rbp))
          ((((((tmp.94 tmp.23 tmp.24 tmp-ra.79 rbp)
               (tmp.94 tmp.23 tmp.24 tmp-ra.79 rbp)
               (tmp.68 tmp.23 tmp.24 tmp-ra.79 rbp))
              (tmp.23 tmp.24 tmp-ra.79 rbp))
             (tmp.67 tmp.23 tmp.24 tmp-ra.79 rbp)
             (tmp.67 tmp.23 tmp.24 tmp-ra.79 rbp))
            (tmp.23 tmp.24 tmp-ra.79 rbp))
           ((tmp.24 tmp.95 tmp-ra.79 rbp)
            (tmp.95 tmp-ra.79 rbp)
            (tmp-ra.79 rax rbp)
            (rax rbp))
           ((tmp-ra.79 rax rbp) (rax rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (ascii-char0.5 error2.3 tmp.56 boolean3.2 ascii-char4.1))
     (call-undead (void1.4 tmp-ra.63))
     (undead-out
      ((tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.63 rbp)
       ((rax tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (void1.4 tmp-ra.63 rbp)
       ((rax void1.4 tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (void1.4 tmp-ra.63 rbp)
       ((rax void1.4 tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.56 void1.4 tmp-ra.63 rbp)
       ((rax void1.4 tmp-ra.63 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (void1.4 tmp-ra.63 rbp)
       ((rax void1.4 tmp-ra.63 rbp) ((r15 rbp) (r15 rbp)))
       (void1.4 tmp-ra.63 rbp)
       (tmp-ra.63 rax rbp)
    ...
    ((new-frames (() () () () () () () () () () () () () () () () ()))
     (locals
      (ascii-char0.5
       ...
       fixnum4.1))
     (call-undead
      (tmp.72 tmp.75 tmp.74 tmp.78 empty3.2 tmp.68 tmp.69 tmp-ra.86))
     (undead-out
      ((tmp-ra.86 rbp)
       ...
       (tmp-ra.86 rbp)
       ((rax tmp-ra.86 rbp) ((r15 rbp) (r15 rbp)))
       (empty3.2 tmp-ra.86 rbp)
       ((rax empty3.2 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 empty3.2 tmp-ra.86 rbp)
       ((rax tmp.75 empty3.2 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 tmp.76 empty3.2 tmp-ra.86 rbp)
       ((rax empty3.2 tmp-ra.86 rbp)
        ((tmp.75 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 empty3.2 tmp-ra.86 rbp)
       ((rax tmp.74 empty3.2 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.74 empty3.2 tmp-ra.86 rbp)
       ((rax tmp.78 tmp.74 empty3.2 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.74 empty3.2 tmp-ra.86 rbp)
       ((rax tmp.74 empty3.2 tmp-ra.86 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.77 empty3.2 tmp-ra.86 rbp)
       ((rax empty3.2 tmp-ra.86 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (empty3.2 tmp-ra.86 rbp)
       (tmp-ra.86 rax rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (void0.5 ascii-char1.4 empty2.3 ascii-char4.1))
     (call-undead (empty3.2 tmp-ra.60))
     (undead-out
      ((tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.60 rbp)
       ...
       (tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (empty3.2 tmp-ra.60 rbp)
       ((rax empty3.2 tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (empty3.2 tmp-ra.60 rbp)
       (tmp-ra.60 rax rbp)
       (rax rbp)))
     (conflicts
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () ()))
     (locals
      (tmp.72
       ...
       boolean3.2
       void4.1))
     (call-undead (tmp.71 tmp.70 tmp.74 tmp-ra.87))
     (undead-out
      ((tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp-ra.87 rbp)
       ((rax tmp.71 tmp-ra.87 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.72 tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp-ra.87 rbp)
       ((rax tmp.70 tmp-ra.87 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.70 tmp-ra.87 rbp)
       ((rax tmp.74 tmp.70 tmp-ra.87 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.75 tmp.70 tmp-ra.87 rbp)
       ((rax tmp.70 tmp-ra.87 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.73 tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.76 tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.77 tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.87 rbp)
       ((rax tmp-ra.87 rbp) ((r15 rbp) (r15 rbp)))
       (void4.1 tmp-ra.87 rbp)
       (tmp-ra.87 rax rbp)
       (rax rbp)))
     (conflicts
      ((tmp-ra.87
    ...
    (define L.empty?.13
      ((new-frames ())
       (locals (tmp.55 tmp.44 tmp.88 tmp-ra.78))
       (undead-out
        ((rdi tmp-ra.78 rbp)
         (tmp.44 tmp-ra.78 rbp)
         ((((tmp.88 tmp-ra.78 rbp)
            (tmp.88 tmp-ra.78 rbp)
            (tmp.55 tmp-ra.78 rbp))
           (tmp-ra.78 rbp))
          ((tmp-ra.78 rax rbp) (rax rbp))
          ((tmp-ra.78 rax rbp) (rax rbp)))))
       (call-undead ())
    ...
    (define L.ascii-char?.12
      ((new-frames ())
       (locals (tmp.56 tmp.46 tmp.89 tmp-ra.79))
       (undead-out
        ((rdi tmp-ra.79 rbp)
         (tmp.46 tmp-ra.79 rbp)
         ((((tmp.89 tmp-ra.79 rbp)
            (tmp.89 tmp-ra.79 rbp)
            (tmp.56 tmp-ra.79 rbp))
           (tmp-ra.79 rbp))
          ((tmp-ra.79 rax rbp) (rax rbp))
          ((tmp-ra.79 rax rbp) (rax rbp)))))
       (call-undead ())
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.80 rbp)
         ...
         ((((((tmp.90 tmp.20 tmp.19 tmp-ra.80 rbp)
              (tmp.90 tmp.20 tmp.19 tmp-ra.80 rbp)
            ...
            (tmp.57 tmp.20 tmp.19 tmp-ra.80 rbp))
           (tmp.20 tmp.19 tmp-ra.80 rbp))
          ((((((tmp.91 tmp.20 tmp.19 tmp-ra.80 rbp)
               (tmp.91 tmp.20 tmp.19 tmp-ra.80 rbp)
               (tmp.60 tmp.20 tmp.19 tmp-ra.80 rbp))
              (tmp.20 tmp.19 tmp-ra.80 rbp))
             (tmp.59 tmp.20 tmp.19 tmp-ra.80 rbp)
             (tmp.59 tmp.20 tmp.19 tmp-ra.80 rbp))
            (tmp.20 tmp.19 tmp-ra.80 rbp))
           ((tmp.92 tmp.19 tmp-ra.80 rbp)
            (tmp.92 tmp.19 tmp-ra.80 rbp)
            (tmp.19 tmp.61 tmp-ra.80 rbp)
            (tmp.61 tmp.93 tmp-ra.80 rbp)
            (tmp.93 tmp-ra.80 rbp)
            (tmp-ra.80 rax rbp)
            (rax rbp))
           ((tmp-ra.80 rax rbp) (rax rbp)))
          ((tmp-ra.80 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.81 rbp)
         (rsi tmp.23 tmp-ra.81 rbp)
         (tmp.23 tmp.24 tmp-ra.81 rbp)
         ((((((tmp.94 tmp.23 tmp.24 tmp-ra.81 rbp)
              (tmp.94 tmp.23 tmp.24 tmp-ra.81 rbp)
            ...
            (tmp.62 tmp.23 tmp.24 tmp-ra.81 rbp))
           (tmp.23 tmp.24 tmp-ra.81 rbp))
          ((((((tmp.95 tmp.23 tmp.24 tmp-ra.81 rbp)
               (tmp.95 tmp.23 tmp.24 tmp-ra.81 rbp)
               (tmp.65 tmp.23 tmp.24 tmp-ra.81 rbp))
              (tmp.23 tmp.24 tmp-ra.81 rbp))
             (tmp.64 tmp.23 tmp.24 tmp-ra.81 rbp)
             (tmp.64 tmp.23 tmp.24 tmp-ra.81 rbp))
            (tmp.23 tmp.24 tmp-ra.81 rbp))
           ((tmp.24 tmp.96 tmp-ra.81 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.82 rbp)
         ...
         ((((((tmp.97 tmp.21 tmp.22 tmp-ra.82 rbp)
              (tmp.97 tmp.21 tmp.22 tmp-ra.82 rbp)
            ...
            (tmp.66 tmp.21 tmp.22 tmp-ra.82 rbp))
           (tmp.21 tmp.22 tmp-ra.82 rbp))
          ((((((tmp.98 tmp.21 tmp.22 tmp-ra.82 rbp)
               (tmp.98 tmp.21 tmp.22 tmp-ra.82 rbp)
               (tmp.69 tmp.21 tmp.22 tmp-ra.82 rbp))
              (tmp.21 tmp.22 tmp-ra.82 rbp))
             (tmp.68 tmp.21 tmp.22 tmp-ra.82 rbp)
             (tmp.68 tmp.21 tmp.22 tmp-ra.82 rbp))
            (tmp.21 tmp.22 tmp-ra.82 rbp))
           ((tmp.22 tmp.99 tmp-ra.82 rbp)
            (tmp.99 tmp-ra.82 rbp)
            (tmp-ra.82 rax rbp)
            (rax rbp))
           ((tmp-ra.82 rax rbp) (rax rbp)))
          ((tmp-ra.82 rax rbp) (rax rbp)))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (ascii-char0.5 empty1.4 empty3.2 ascii-char4.1))
     (call-undead (error2.3 tmp-ra.60))
     (undead-out
      ((tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.60 rbp)
       ...
       (tmp-ra.60 rbp)
       ((rax tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (error2.3 tmp-ra.60 rbp)
       ((rax error2.3 tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (error2.3 tmp-ra.60 rbp)
       ((rax error2.3 tmp-ra.60 rbp) ((r15 rbp) (r15 rbp)))
       (error2.3 tmp-ra.60 rbp)
       (tmp-ra.60 rax rbp)
    ...
    ((new-frames (() () () () () () () () () () () () () () () () ()))
     (locals
      (tmp.70
       ...
       fixnum4.1))
     (call-undead
      (void0.5 tmp.72 tmp.75 tmp.74 tmp.78 tmp.68 tmp.69 tmp-ra.86))
     (undead-out
      ((tmp-ra.86 rbp)
       ((rax tmp-ra.86 rbp) ((r15 rbp) (r15 rbp)))
       (void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 void0.5 tmp-ra.86 rbp)
       ((rax tmp.69 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.70 void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.68 void0.5 tmp-ra.86 rbp)
       ((rax tmp.68 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.68 void0.5 tmp-ra.86 rbp)
       ((rax tmp.72 tmp.68 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.73 tmp.68 void0.5 tmp-ra.86 rbp)
       ((rax tmp.68 void0.5 tmp-ra.86 rbp)
        ((tmp.72 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.68 tmp.71 void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((tmp.68 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp) ((r15 rbp) (r15 rbp)))
       (void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp) ((r15 rbp) (r15 rbp)))
       (void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 void0.5 tmp-ra.86 rbp)
       ((rax tmp.75 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.75 tmp.76 void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((tmp.75 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 void0.5 tmp-ra.86 rbp)
       ((rax tmp.74 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.74 void0.5 tmp-ra.86 rbp)
       ((rax tmp.78 tmp.74 void0.5 tmp-ra.86 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.74 void0.5 tmp-ra.86 rbp)
       ((rax tmp.74 void0.5 tmp-ra.86 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.77 void0.5 tmp-ra.86 rbp)
       ((rax void0.5 tmp-ra.86 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void0.5 tmp-ra.86 rbp)
       (tmp-ra.86 rax rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals
      (void0.5 empty1.4 empty2.3 void3.2 tmp.70 tmp.73 tmp.71 fixnum4.1))
     (call-undead (tmp.69 tmp.68 tmp.72 tmp-ra.82))
     (undead-out
      ((tmp-ra.82 rbp)
       ((rax tmp-ra.82 rbp) ((r15 rbp) (r15 rbp)))
       ...
       (undead-out
        ((rdi rsi tmp-ra.75 rbp)
         ...
         ((((((tmp.86 tmp.20 tmp.19 tmp-ra.75 rbp)
            ...
            (tmp.59 tmp.20 tmp.19 tmp-ra.75 rbp))
           (tmp.20 tmp.19 tmp-ra.75 rbp))
          ((((((tmp.87 tmp.20 tmp.19 tmp-ra.75 rbp)
               (tmp.87 tmp.20 tmp.19 tmp-ra.75 rbp)
             ...
             (tmp.61 tmp.20 tmp.19 tmp-ra.75 rbp))
            (tmp.20 tmp.19 tmp-ra.75 rbp))
           ((tmp.88 tmp.19 tmp-ra.75 rbp)
            (tmp.88 tmp.19 tmp-ra.75 rbp)
            (tmp.19 tmp.63 tmp-ra.75 rbp)
            (tmp.63 tmp.89 tmp-ra.75 rbp)
...
(check-by-interp
 '(module
     ...
     (undead-out
      ((tmp-ra.69 rbp)
       ((((tmp-ra.69 rbp)
          ...
          ((rax tmp-ra.69 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
          (tmp.61 tmp-ra.69 rbp))
         (tmp-ra.69 rbp))
        ((((tmp.75 tmp-ra.69 rbp) (tmp-ra.69 rbp))
          (tmp.63 tmp-ra.69 rbp)
          (tmp.63 tmp-ra.69 rbp))
         (((tmp.76 tmp.63 tmp-ra.69 rbp) (tmp.63 tmp-ra.69 rbp))
          (tmp.64 tmp.63 tmp-ra.69 rbp)
          (tmp.64 tmp.63 tmp-ra.69 rbp))
         (tmp.63 tmp-ra.69 rsi rbp)
         (tmp-ra.69 rsi rdi rbp)
         (rsi rdi r15 rbp)
         (rsi rdi r15 rbp))
        ((((tmp.77 tmp-ra.69 rbp) (tmp-ra.69 rbp))
          (tmp.65 tmp-ra.69 rbp)
          (tmp.65 tmp-ra.69 rbp))
         (((tmp.78 tmp.65 tmp-ra.69 rbp) (tmp.65 tmp-ra.69 rbp))
          (tmp.66 tmp.65 tmp-ra.69 rbp)
          (tmp.66 tmp.65 tmp-ra.69 rbp))
         (tmp.65 tmp-ra.69 rsi rbp)
         (tmp-ra.69 rsi rdi rbp)
         (rsi rdi r15 rbp)
         (rsi rdi r15 rbp)))))
     (conflicts
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.67 rbp)
         (rsi tmp.19 tmp-ra.67 rbp)
         (tmp.20 tmp.19 tmp-ra.67 rbp)
         ((((((tmp.70 tmp.20 tmp.19 tmp-ra.67 rbp)
              (tmp.70 tmp.20 tmp.19 tmp-ra.67 rbp)
              (tmp.56 tmp.20 tmp.19 tmp-ra.67 rbp))
             (tmp.20 tmp.19 tmp-ra.67 rbp))
            (tmp.55 tmp.20 tmp.19 tmp-ra.67 rbp)
            (tmp.55 tmp.20 tmp.19 tmp-ra.67 rbp))
           (tmp.20 tmp.19 tmp-ra.67 rbp))
          ((((((tmp.71 tmp.20 tmp.19 tmp-ra.67 rbp)
               (tmp.71 tmp.20 tmp.19 tmp-ra.67 rbp)
               (tmp.58 tmp.20 tmp.19 tmp-ra.67 rbp))
              (tmp.20 tmp.19 tmp-ra.67 rbp))
             (tmp.57 tmp.20 tmp.19 tmp-ra.67 rbp)
             (tmp.57 tmp.20 tmp.19 tmp-ra.67 rbp))
            (tmp.20 tmp.19 tmp-ra.67 rbp))
           ((tmp.72 tmp.19 tmp-ra.67 rbp)
            (tmp.72 tmp.19 tmp-ra.67 rbp)
            (tmp.19 tmp.59 tmp-ra.67 rbp)
            (tmp.59 tmp.73 tmp-ra.67 rbp)
            (tmp.73 tmp-ra.67 rbp)
            (tmp-ra.67 rax rbp)
            (rax rbp))
    ...
    (define L.void?.5
      ((new-frames ())
       (locals (tmp.60 tmp.45 tmp.74 tmp-ra.68))
       (undead-out
        ((rdi tmp-ra.68 rbp)
         (tmp.45 tmp-ra.68 rbp)
         ((((tmp.74 tmp-ra.68 rbp)
            (tmp.74 tmp-ra.68 rbp)
            (tmp.60 tmp-ra.68 rbp))
           (tmp-ra.68 rbp))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals (empty0.5 void1.4 void2.3 tmp.70 tmp.73 tmp.71 fixnum4.1))
     (call-undead (tmp.69 tmp.68 tmp.72 ascii-char3.2 tmp-ra.81))
     (undead-out
      ((tmp-ra.81 rbp)
       ...
       (tmp-ra.81 rbp)
       ((rax tmp-ra.81 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char3.2 tmp-ra.81 rbp)
       ((rax ascii-char3.2 tmp-ra.81 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 ascii-char3.2 tmp-ra.81 rbp)
       ((rax tmp.69 ascii-char3.2 tmp-ra.81 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.70 ascii-char3.2 tmp-ra.81 rbp)
       ((rax ascii-char3.2 tmp-ra.81 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.68 ascii-char3.2 tmp-ra.81 rbp)
       ((rax tmp.68 ascii-char3.2 tmp-ra.81 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.68 ascii-char3.2 tmp-ra.81 rbp)
       ((rax tmp.72 tmp.68 ascii-char3.2 tmp-ra.81 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.73 tmp.68 ascii-char3.2 tmp-ra.81 rbp)
       ((rax tmp.68 ascii-char3.2 tmp-ra.81 rbp)
        ((tmp.72 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.68 tmp.71 ascii-char3.2 tmp-ra.81 rbp)
       ((rax ascii-char3.2 tmp-ra.81 rbp)
        ((tmp.68 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (ascii-char3.2 tmp-ra.81 rbp)
       (tmp-ra.81 rax rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.74 rbp)
         (rsi tmp.21 tmp-ra.74 rbp)
         (tmp.21 tmp.22 tmp-ra.74 rbp)
         ((((((tmp.82 tmp.21 tmp.22 tmp-ra.74 rbp)
              (tmp.82 tmp.21 tmp.22 tmp-ra.74 rbp)
              (tmp.56 tmp.21 tmp.22 tmp-ra.74 rbp))
             (tmp.21 tmp.22 tmp-ra.74 rbp))
            (tmp.55 tmp.21 tmp.22 tmp-ra.74 rbp)
        ...
        ((rdi rsi tmp-ra.75 rbp)
         ...
         ((((((tmp.85 tmp.23 tmp.24 tmp-ra.75 rbp)
          ...
          ((((((tmp.86 tmp.23 tmp.24 tmp-ra.75 rbp)
             ...
             (tmp.61 tmp.23 tmp.24 tmp-ra.75 rbp))
            (tmp.23 tmp.24 tmp-ra.75 rbp))
           ((tmp.24 tmp.87 tmp-ra.75 rbp)
            (tmp.87 tmp-ra.75 rbp)
            (tmp-ra.75 rax rbp)
            (rax rbp))
           ((tmp-ra.75 rax rbp) (rax rbp)))
          ((tmp-ra.75 rax rbp) (rax rbp)))))
        ...
        ((rdi rsi tmp-ra.76 rbp)
         ...
         ((((((tmp.88 tmp.20 tmp.19 tmp-ra.76 rbp)
          ...
          ((((((tmp.89 tmp.20 tmp.19 tmp-ra.76 rbp)
             ...
             (tmp.65 tmp.20 tmp.19 tmp-ra.76 rbp))
            (tmp.20 tmp.19 tmp-ra.76 rbp))
           ((tmp.90 tmp.19 tmp-ra.76 rbp)
            (tmp.90 tmp.19 tmp-ra.76 rbp)
            (tmp.19 tmp.67 tmp-ra.76 rbp)
            (tmp.67 tmp.91 tmp-ra.76 rbp)
    ...
    ((new-frames (() () () () () () () () () () () () () () () () () () () ()))
     (locals
      (tmp.72
       ...
       void5.1))
     (call-undead
      (tmp.71 tmp.70 tmp.69 tmp.81 error2.4 tmp.77 tmp.78 tmp.74 tmp-ra.96))
     (undead-out
      ((tmp-ra.96 rbp)
       ((rax tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       ...
       (tmp-ra.96 rbp)
       ((rax tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error2.4 tmp-ra.96 rbp)
       ((rax error2.4 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error2.4 tmp-ra.96 rbp)
       ((rax error2.4 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error2.4 tmp-ra.96 rbp)
       ((rax error2.4 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (ascii-char0.6 error1.5 ascii-char2.4 void3.3 error5.1))
     (call-undead (void4.2 tmp-ra.68))
     (undead-out
      ((tmp-ra.68 rbp)
       ...
       (tmp-ra.68 rbp)
       ((rax tmp-ra.68 rbp) ((r15 rbp) (r15 rbp)))
       (void4.2 tmp-ra.68 rbp)
       ((rax void4.2 tmp-ra.68 rbp) ((r15 rbp) (r15 rbp)))
       (void4.2 tmp-ra.68 rbp)
       (tmp-ra.68 rax rbp)
       (rax rbp)))
     (conflicts
    ...
    ((new-frames (() () () () () () () () () () () () () () () () () () () ()))
     (locals
      (empty0.6
       ...
       fixnum4.2
       void5.1))
     (call-undead (tmp.71 tmp.70 tmp.69 tmp.81 tmp.77 tmp.78 tmp.74 tmp-ra.96))
     (undead-out
      ((tmp-ra.96 rbp)
       ((rax tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.96 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.85 rbp)
         ...
         ((((((tmp.104 tmp.24 tmp.25 tmp-ra.85 rbp)
              (tmp.104 tmp.24 tmp.25 tmp-ra.85 rbp)
              (tmp.66 tmp.24 tmp.25 tmp-ra.85 rbp))
             (tmp.24 tmp.25 tmp-ra.85 rbp))
            (tmp.65 tmp.24 tmp.25 tmp-ra.85 rbp)
            (tmp.65 tmp.24 tmp.25 tmp-ra.85 rbp))
           (tmp.24 tmp.25 tmp-ra.85 rbp))
          ((((((tmp.105 tmp.24 tmp.25 tmp-ra.85 rbp)
               (tmp.105 tmp.24 tmp.25 tmp-ra.85 rbp)
               (tmp.68 tmp.24 tmp.25 tmp-ra.85 rbp))
              (tmp.24 tmp.25 tmp-ra.85 rbp))
             (tmp.67 tmp.24 tmp.25 tmp-ra.85 rbp)
             (tmp.67 tmp.24 tmp.25 tmp-ra.85 rbp))
            (tmp.24 tmp.25 tmp-ra.85 rbp))
           ((tmp.25 tmp.106 tmp-ra.85 rbp)
            (tmp.106 tmp-ra.85 rbp)
            (tmp-ra.85 rax rbp)
            (rax rbp))
           ((tmp-ra.85 rax rbp) (rax rbp)))
    ...
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp-ra.120 rbp)
       ((rax tmp.71 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.72 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp-ra.120 rbp)
       ((rax tmp.70 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.70 tmp-ra.120 rbp)
       ((rax tmp.74 tmp.70 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.75 tmp.70 tmp-ra.120 rbp)
       ((rax tmp.70 tmp-ra.120 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.73 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp-ra.120 rbp)
       ((rax tmp.69 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.78 tmp.69 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.69 tmp-ra.120 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.77 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.81 tmp.77 tmp.69 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.82 tmp.77 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.120 rbp)
        ((tmp.81 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.80 tmp.69 tmp-ra.120 rbp)
       ((rax tmp.69 tmp-ra.120 rbp)
        ((tmp.77 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.76 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp-ra.120 rbp)
       ((rax tmp.85 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.86 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp-ra.120 rbp)
       ((rax tmp.84 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.84 tmp-ra.120 rbp)
       ((rax tmp.88 tmp.84 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.89 tmp.84 tmp-ra.120 rbp)
       ((rax tmp.84 tmp-ra.120 rbp)
        ((tmp.88 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.87 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp-ra.120 rbp)
       ((rax tmp.83 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.92 tmp.83 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.93 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.83 tmp-ra.120 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.91 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.95 tmp.91 tmp.83 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.96 tmp.91 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.120 rbp)
        ((tmp.95 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.94 tmp.83 tmp-ra.120 rbp)
       ((rax tmp.83 tmp-ra.120 rbp)
        ((tmp.91 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.90 tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp)
       ...
       (tmp-ra.120 rbp)
       ((rax tmp-ra.120 rbp) ((r15 rbp) (r15 rbp)))
       (void3.3 tmp-ra.120 rbp)
       ((rax void3.3 tmp-ra.120 rbp) ((r15 rbp) (r15 rbp)))
       (void3.3 tmp-ra.120 rbp)
       ((rax void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 void3.3 tmp-ra.120 rbp)
       ((rax tmp.99 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 tmp.100 void3.3 tmp-ra.120 rbp)
       ((rax void3.3 tmp-ra.120 rbp)
        ((tmp.99 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 void3.3 tmp-ra.120 rbp)
       ((rax tmp.98 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.98 void3.3 tmp-ra.120 rbp)
       ((rax tmp.102 tmp.98 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.103 tmp.98 void3.3 tmp-ra.120 rbp)
       ((rax tmp.98 void3.3 tmp-ra.120 rbp)
        ((tmp.102 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 tmp.101 void3.3 tmp-ra.120 rbp)
       ((rax void3.3 tmp-ra.120 rbp)
        ((tmp.98 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.97 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.106 tmp.97 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.107 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.97 void3.3 tmp-ra.120 rbp)
        ((tmp.106 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.109 tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.110 tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.105 tmp.97 void3.3 tmp-ra.120 rbp)
        ((tmp.109 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.108 tmp.97 void3.3 tmp-ra.120 rbp)
       ((rax tmp.97 void3.3 tmp-ra.120 rbp)
        ((tmp.105 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp.104 void3.3 tmp-ra.120 rbp)
       ((rax void3.3 tmp-ra.120 rbp)
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.110 rbp)
       ...
       (tmp-ra.110 rbp)
       ((rax tmp-ra.110 rbp) ((r15 rbp) (r15 rbp)))
       (void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.86 void3.3 tmp-ra.110 rbp)
       ((rax tmp.86 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.86 tmp.87 void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp)
        ((tmp.86 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 void3.3 tmp-ra.110 rbp)
       ((rax tmp.85 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.89 tmp.85 void3.3 tmp-ra.110 rbp)
       ((rax tmp.89 tmp.85 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.89 tmp.90 tmp.85 void3.3 tmp-ra.110 rbp)
       ((rax tmp.85 void3.3 tmp-ra.110 rbp)
        ((tmp.89 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.88 void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.84 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.93 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.93 tmp.84 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.93 tmp.94 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.84 void3.3 tmp-ra.110 rbp)
        ((tmp.93 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.96 tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.96 tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.96 tmp.97 tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.92 tmp.84 void3.3 tmp-ra.110 rbp)
        ((tmp.96 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.95 tmp.84 void3.3 tmp-ra.110 rbp)
       ((rax tmp.84 void3.3 tmp-ra.110 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.91 void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.98 void3.3 tmp-ra.110 rbp)
       ((rax void3.3 tmp-ra.110 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (void3.3 tmp-ra.110 rbp)
       (tmp-ra.110 rax rbp)
       (rax rbp)))
     (conflicts
    ...
    (define L.pair?.15
      ((new-frames ())
       (locals (tmp.56 tmp.49 tmp.111 tmp-ra.99))
       (undead-out
        ((rdi tmp-ra.99 rbp)
         (tmp.49 tmp-ra.99 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.100 rbp)
         (rsi tmp.24 tmp-ra.100 rbp)
         (tmp.24 tmp.25 tmp-ra.100 rbp)
         ((((((tmp.112 tmp.24 tmp.25 tmp-ra.100 rbp)
              (tmp.112 tmp.24 tmp.25 tmp-ra.100 rbp)
              (tmp.58 tmp.24 tmp.25 tmp-ra.100 rbp))
             (tmp.24 tmp.25 tmp-ra.100 rbp))
            (tmp.57 tmp.24 tmp.25 tmp-ra.100 rbp)
            (tmp.57 tmp.24 tmp.25 tmp-ra.100 rbp))
           (tmp.24 tmp.25 tmp-ra.100 rbp))
          ((((((tmp.113 tmp.24 tmp.25 tmp-ra.100 rbp)
               (tmp.113 tmp.24 tmp.25 tmp-ra.100 rbp)
               (tmp.60 tmp.24 tmp.25 tmp-ra.100 rbp))
              (tmp.24 tmp.25 tmp-ra.100 rbp))
             (tmp.59 tmp.24 tmp.25 tmp-ra.100 rbp)
             (tmp.59 tmp.24 tmp.25 tmp-ra.100 rbp))
            (tmp.24 tmp.25 tmp-ra.100 rbp))
           ((tmp.25 tmp.114 tmp-ra.100 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.101 rbp)
         ...
         ((((((tmp.115 tmp.22 tmp.23 tmp-ra.101 rbp)
              (tmp.115 tmp.22 tmp.23 tmp-ra.101 rbp)
              (tmp.62 tmp.22 tmp.23 tmp-ra.101 rbp))
             (tmp.22 tmp.23 tmp-ra.101 rbp))
            (tmp.61 tmp.22 tmp.23 tmp-ra.101 rbp)
            (tmp.61 tmp.22 tmp.23 tmp-ra.101 rbp))
           (tmp.22 tmp.23 tmp-ra.101 rbp))
          ((((((tmp.116 tmp.22 tmp.23 tmp-ra.101 rbp)
             ...
             (tmp.63 tmp.22 tmp.23 tmp-ra.101 rbp))
            (tmp.22 tmp.23 tmp-ra.101 rbp))
           ((tmp.23 tmp.117 tmp-ra.101 rbp)
            (tmp.117 tmp-ra.101 rbp)
            (tmp-ra.101 rax rbp)
            (rax rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.102 rbp)
         (rsi tmp.20 tmp-ra.102 rbp)
         (tmp.21 tmp.20 tmp-ra.102 rbp)
         ((((((tmp.118 tmp.21 tmp.20 tmp-ra.102 rbp)
              (tmp.118 tmp.21 tmp.20 tmp-ra.102 rbp)
              (tmp.66 tmp.21 tmp.20 tmp-ra.102 rbp))
             (tmp.21 tmp.20 tmp-ra.102 rbp))
            (tmp.65 tmp.21 tmp.20 tmp-ra.102 rbp)
            (tmp.65 tmp.21 tmp.20 tmp-ra.102 rbp))
           (tmp.21 tmp.20 tmp-ra.102 rbp))
          ((((((tmp.119 tmp.21 tmp.20 tmp-ra.102 rbp)
               (tmp.119 tmp.21 tmp.20 tmp-ra.102 rbp)
               (tmp.68 tmp.21 tmp.20 tmp-ra.102 rbp))
              (tmp.21 tmp.20 tmp-ra.102 rbp))
             (tmp.67 tmp.21 tmp.20 tmp-ra.102 rbp)
             (tmp.67 tmp.21 tmp.20 tmp-ra.102 rbp))
            (tmp.21 tmp.20 tmp-ra.102 rbp))
           ((tmp.120 tmp.20 tmp-ra.102 rbp)
            (tmp.120 tmp.20 tmp-ra.102 rbp)
            (tmp.20 tmp.69 tmp-ra.102 rbp)
            (tmp.69 tmp.121 tmp-ra.102 rbp)
    ...
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.108 rbp)
       ...
       ((rax tmp-ra.108 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp) ((r15 rbp) (r15 rbp)))
       (fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.85 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.86 fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.84 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.84 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.88 tmp.84 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.89 tmp.84 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.84 fixnum2.4 tmp-ra.108 rbp)
        ((tmp.88 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.87 fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.92 tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.93 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.95 tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.96 tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.91 tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((tmp.95 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.94 tmp.83 fixnum2.4 tmp-ra.108 rbp)
       ((rax tmp.83 fixnum2.4 tmp-ra.108 rbp)
        ((tmp.91 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.90 fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (fixnum2.4 tmp-ra.108 rbp)
       ((rax fixnum2.4 tmp-ra.108 rbp) ((r15 rbp) (r15 rbp)))
 ...
 '(module
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.108 rbp)
       ...
       (tmp-ra.108 rbp)
       ((rax tmp-ra.108 rbp) ((r15 rbp) (r15 rbp)))
       (void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 void2.4 tmp-ra.108 rbp)
       ((rax tmp.85 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.86 void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 void2.4 tmp-ra.108 rbp)
       ((rax tmp.84 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.84 void2.4 tmp-ra.108 rbp)
       ((rax tmp.88 tmp.84 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.89 tmp.84 void2.4 tmp-ra.108 rbp)
       ((rax tmp.84 void2.4 tmp-ra.108 rbp)
        ((tmp.88 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.87 void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.83 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.92 tmp.83 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.93 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.83 void2.4 tmp-ra.108 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.95 tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.96 tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.91 tmp.83 void2.4 tmp-ra.108 rbp)
        ((tmp.95 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.94 tmp.83 void2.4 tmp-ra.108 rbp)
       ((rax tmp.83 void2.4 tmp-ra.108 rbp)
        ((tmp.91 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.90 void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp) ((r15 rbp) (r15 rbp)))
       (void2.4 tmp-ra.108 rbp)
       ((rax void2.4 tmp-ra.108 rbp) ((r15 rbp) (r15 rbp)))
       (void2.4 tmp-ra.108 rbp)
       (tmp-ra.108 rax rbp)
    ...
    (define L.*.14
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.98 rbp)
         (rsi tmp.20 tmp-ra.98 rbp)
         (tmp.21 tmp.20 tmp-ra.98 rbp)
         ((((((tmp.112 tmp.21 tmp.20 tmp-ra.98 rbp)
              (tmp.112 tmp.21 tmp.20 tmp-ra.98 rbp)
              (tmp.61 tmp.21 tmp.20 tmp-ra.98 rbp))
             (tmp.21 tmp.20 tmp-ra.98 rbp))
            (tmp.60 tmp.21 tmp.20 tmp-ra.98 rbp)
            (tmp.60 tmp.21 tmp.20 tmp-ra.98 rbp))
           (tmp.21 tmp.20 tmp-ra.98 rbp))
          ((((((tmp.113 tmp.21 tmp.20 tmp-ra.98 rbp)
               (tmp.113 tmp.21 tmp.20 tmp-ra.98 rbp)
               (tmp.63 tmp.21 tmp.20 tmp-ra.98 rbp))
              (tmp.21 tmp.20 tmp-ra.98 rbp))
             (tmp.62 tmp.21 tmp.20 tmp-ra.98 rbp)
             (tmp.62 tmp.21 tmp.20 tmp-ra.98 rbp))
            (tmp.21 tmp.20 tmp-ra.98 rbp))
           ((tmp.114 tmp.20 tmp-ra.98 rbp)
            (tmp.114 tmp.20 tmp-ra.98 rbp)
            (tmp.20 tmp.64 tmp-ra.98 rbp)
            (tmp.64 tmp.115 tmp-ra.98 rbp)
            (tmp.115 tmp-ra.98 rbp)
            (tmp-ra.98 rax rbp)
            (rax rbp))
           ((tmp-ra.98 rax rbp) (rax rbp)))
          ((tmp-ra.98 rax rbp) (rax rbp)))))
    ...
    (define L.-.13
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.99 rbp)
         (rsi tmp.24 tmp-ra.99 rbp)
         (tmp.24 tmp.25 tmp-ra.99 rbp)
         ((((((tmp.116 tmp.24 tmp.25 tmp-ra.99 rbp)
              (tmp.116 tmp.24 tmp.25 tmp-ra.99 rbp)
              (tmp.66 tmp.24 tmp.25 tmp-ra.99 rbp))
             (tmp.24 tmp.25 tmp-ra.99 rbp))
            (tmp.65 tmp.24 tmp.25 tmp-ra.99 rbp)
            (tmp.65 tmp.24 tmp.25 tmp-ra.99 rbp))
           (tmp.24 tmp.25 tmp-ra.99 rbp))
          ((((((tmp.117 tmp.24 tmp.25 tmp-ra.99 rbp)
               (tmp.117 tmp.24 tmp.25 tmp-ra.99 rbp)
               (tmp.68 tmp.24 tmp.25 tmp-ra.99 rbp))
              (tmp.24 tmp.25 tmp-ra.99 rbp))
             (tmp.67 tmp.24 tmp.25 tmp-ra.99 rbp)
             (tmp.67 tmp.24 tmp.25 tmp-ra.99 rbp))
            (tmp.24 tmp.25 tmp-ra.99 rbp))
           ((tmp.25 tmp.118 tmp-ra.99 rbp)
            (tmp.118 tmp-ra.99 rbp)
            (tmp-ra.99 rax rbp)
            (rax rbp))
           ((tmp-ra.99 rax rbp) (rax rbp)))
    ...
    (define L.fun/error51652.10
      ((new-frames ())
       (locals (tmp-ra.106))
       (undead-out ((tmp-ra.106 rbp) (r15 rbp) (r15 rbp)))
       (call-undead ())
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals (error0.6 tmp.57 boolean1.5 error2.4 error3.3 empty5.1))
     (call-undead (void4.2 tmp-ra.70))
     (undead-out
      ((tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.57 tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (void4.2 tmp-ra.70 rbp)
       ((rax void4.2 tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (void4.2 tmp-ra.70 rbp)
       (tmp-ra.70 rax rbp)
       (rax rbp)))
     (conflicts
    ...
    (define L.vector?.16
      ((new-frames ())
       (locals (tmp.56 tmp.50 tmp.71 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
...
(check-by-interp
 '(module
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.85 rbp)
         (rsi tmp.20 tmp-ra.85 rbp)
         (tmp.21 tmp.20 tmp-ra.85 rbp)
         ((((((tmp.101 tmp.21 tmp.20 tmp-ra.85 rbp)
              (tmp.101 tmp.21 tmp.20 tmp-ra.85 rbp)
              (tmp.57 tmp.21 tmp.20 tmp-ra.85 rbp))
             (tmp.21 tmp.20 tmp-ra.85 rbp))
            (tmp.56 tmp.21 tmp.20 tmp-ra.85 rbp)
            (tmp.56 tmp.21 tmp.20 tmp-ra.85 rbp))
           (tmp.21 tmp.20 tmp-ra.85 rbp))
          ((((((tmp.102 tmp.21 tmp.20 tmp-ra.85 rbp)
               (tmp.102 tmp.21 tmp.20 tmp-ra.85 rbp)
               (tmp.59 tmp.21 tmp.20 tmp-ra.85 rbp))
              (tmp.21 tmp.20 tmp-ra.85 rbp))
             (tmp.58 tmp.21 tmp.20 tmp-ra.85 rbp)
             (tmp.58 tmp.21 tmp.20 tmp-ra.85 rbp))
            (tmp.21 tmp.20 tmp-ra.85 rbp))
           ((tmp.103 tmp.20 tmp-ra.85 rbp)
            (tmp.103 tmp.20 tmp-ra.85 rbp)
            (tmp.20 tmp.60 tmp-ra.85 rbp)
            (tmp.60 tmp.104 tmp-ra.85 rbp)
            (tmp.104 tmp-ra.85 rbp)
            (tmp-ra.85 rax rbp)
            (rax rbp))
           ((tmp-ra.85 rax rbp) (rax rbp)))
          ((tmp-ra.85 rax rbp) (rax rbp)))))
       ...
       (undead-out
        ((rdi rsi tmp-ra.86 rbp)
         ...
         ((((((tmp.105 tmp.22 tmp.23 tmp-ra.86 rbp)
            ...
            (tmp.61 tmp.22 tmp.23 tmp-ra.86 rbp))
           (tmp.22 tmp.23 tmp-ra.86 rbp))
          ((((((tmp.106 tmp.22 tmp.23 tmp-ra.86 rbp)
               (tmp.106 tmp.22 tmp.23 tmp-ra.86 rbp)
               (tmp.64 tmp.22 tmp.23 tmp-ra.86 rbp))
              (tmp.22 tmp.23 tmp-ra.86 rbp))
             (tmp.63 tmp.22 tmp.23 tmp-ra.86 rbp)
             (tmp.63 tmp.22 tmp.23 tmp-ra.86 rbp))
            (tmp.22 tmp.23 tmp-ra.86 rbp))
           ((tmp.23 tmp.107 tmp-ra.86 rbp)
    ...
    (define L.boolean?.16
      ((new-frames ())
       (locals (tmp.69 tmp.44 tmp.111 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
 ...
 '(module
    ...
    (define L.*.17
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.83 rbp)
         (rsi tmp.20 tmp-ra.83 rbp)
         (tmp.21 tmp.20 tmp-ra.83 rbp)
         ((((((tmp.97 tmp.21 tmp.20 tmp-ra.83 rbp)
              (tmp.97 tmp.21 tmp.20 tmp-ra.83 rbp)
              (tmp.57 tmp.21 tmp.20 tmp-ra.83 rbp))
             (tmp.21 tmp.20 tmp-ra.83 rbp))
            (tmp.56 tmp.21 tmp.20 tmp-ra.83 rbp)
            (tmp.56 tmp.21 tmp.20 tmp-ra.83 rbp))
           (tmp.21 tmp.20 tmp-ra.83 rbp))
          ((((((tmp.98 tmp.21 tmp.20 tmp-ra.83 rbp)
               (tmp.98 tmp.21 tmp.20 tmp-ra.83 rbp)
               (tmp.59 tmp.21 tmp.20 tmp-ra.83 rbp))
              (tmp.21 tmp.20 tmp-ra.83 rbp))
             (tmp.58 tmp.21 tmp.20 tmp-ra.83 rbp)
             (tmp.58 tmp.21 tmp.20 tmp-ra.83 rbp))
            (tmp.21 tmp.20 tmp-ra.83 rbp))
           ((tmp.99 tmp.20 tmp-ra.83 rbp)
            (tmp.99 tmp.20 tmp-ra.83 rbp)
            (tmp.20 tmp.60 tmp-ra.83 rbp)
            (tmp.60 tmp.100 tmp-ra.83 rbp)
            (tmp.100 tmp-ra.83 rbp)
            (tmp-ra.83 rax rbp)
            (rax rbp))
           ((tmp-ra.83 rax rbp) (rax rbp)))
          ((tmp-ra.83 rax rbp) (rax rbp)))))
       ...
       (undead-out
        ((rdi rsi tmp-ra.84 rbp)
         ...
         ((((((tmp.101 tmp.22 tmp.23 tmp-ra.84 rbp)
            ...
            (tmp.61 tmp.22 tmp.23 tmp-ra.84 rbp))
           (tmp.22 tmp.23 tmp-ra.84 rbp))
          ((((((tmp.102 tmp.22 tmp.23 tmp-ra.84 rbp)
               (tmp.102 tmp.22 tmp.23 tmp-ra.84 rbp)
               (tmp.64 tmp.22 tmp.23 tmp-ra.84 rbp))
              (tmp.22 tmp.23 tmp-ra.84 rbp))
             (tmp.63 tmp.22 tmp.23 tmp-ra.84 rbp)
             (tmp.63 tmp.22 tmp.23 tmp-ra.84 rbp))
            (tmp.22 tmp.23 tmp-ra.84 rbp))
           ((tmp.23 tmp.103 tmp-ra.84 rbp)
            (tmp.103 tmp-ra.84 rbp)
            (tmp-ra.84 rax rbp)
            (rax rbp))
           ((tmp-ra.84 rax rbp) (rax rbp)))
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
      (ascii-char0.6
       ...
       fixnum5.1))
     (call-undead
      (tmp.73 tmp.72 tmp.71 tmp.83 tmp.79 tmp.80 tmp.76 void4.2 tmp-ra.98))
     (undead-out
      ((tmp-ra.98 rbp)
       ...
       (tmp-ra.98 rbp)
       ((rax tmp-ra.98 rbp) ((r15 rbp) (r15 rbp)))
       (void4.2 tmp-ra.98 rbp)
       ((rax void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 void4.2 tmp-ra.98 rbp)
       ((rax tmp.73 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.74 void4.2 tmp-ra.98 rbp)
       ((rax void4.2 tmp-ra.98 rbp)
        ((tmp.73 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 void4.2 tmp-ra.98 rbp)
       ((rax tmp.72 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.76 tmp.72 void4.2 tmp-ra.98 rbp)
       ((rax tmp.76 tmp.72 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.76 tmp.77 tmp.72 void4.2 tmp-ra.98 rbp)
       ((rax tmp.72 void4.2 tmp-ra.98 rbp)
        ((tmp.76 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.75 void4.2 tmp-ra.98 rbp)
       ((rax void4.2 tmp-ra.98 rbp)
        ((tmp.72 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.71 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.80 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.80 tmp.71 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.80 tmp.81 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.71 void4.2 tmp-ra.98 rbp)
        ((tmp.80 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.83 tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.84 tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.79 tmp.71 void4.2 tmp-ra.98 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.82 tmp.71 void4.2 tmp-ra.98 rbp)
       ((rax tmp.71 void4.2 tmp-ra.98 rbp)
        ((tmp.79 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.78 void4.2 tmp-ra.98 rbp)
       ((rax void4.2 tmp-ra.98 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void4.2 tmp-ra.98 rbp)
       (tmp-ra.98 rax rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.85 rbp)
         ...
         ((((((tmp.99 tmp.22 tmp.23 tmp-ra.85 rbp)
              (tmp.99 tmp.22 tmp.23 tmp-ra.85 rbp)
            ...
            (tmp.56 tmp.22 tmp.23 tmp-ra.85 rbp))
           (tmp.22 tmp.23 tmp-ra.85 rbp))
          ((((((tmp.100 tmp.22 tmp.23 tmp-ra.85 rbp)
               (tmp.100 tmp.22 tmp.23 tmp-ra.85 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.86 rbp)
         ...
         ((((((tmp.102 tmp.21 tmp.20 tmp-ra.86 rbp)
              (tmp.102 tmp.21 tmp.20 tmp-ra.86 rbp)
          ...
          ((((((tmp.103 tmp.21 tmp.20 tmp-ra.86 rbp)
             ...
             (tmp.62 tmp.21 tmp.20 tmp-ra.86 rbp))
            (tmp.21 tmp.20 tmp-ra.86 rbp))
           ((tmp.104 tmp.20 tmp-ra.86 rbp)
            (tmp.104 tmp.20 tmp-ra.86 rbp)
            (tmp.20 tmp.64 tmp-ra.86 rbp)
            (tmp.64 tmp.105 tmp-ra.86 rbp)
            (tmp.105 tmp-ra.86 rbp)
            (tmp-ra.86 rax rbp)
            (rax rbp))
           ((tmp-ra.86 rax rbp) (rax rbp)))
          ((tmp-ra.86 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.87 rbp)
         (rsi tmp.24 tmp-ra.87 rbp)
         (tmp.24 tmp.25 tmp-ra.87 rbp)
         ((((((tmp.106 tmp.24 tmp.25 tmp-ra.87 rbp)
              (tmp.106 tmp.24 tmp.25 tmp-ra.87 rbp)
              (tmp.66 tmp.24 tmp.25 tmp-ra.87 rbp))
             (tmp.24 tmp.25 tmp-ra.87 rbp))
            (tmp.65 tmp.24 tmp.25 tmp-ra.87 rbp)
            (tmp.65 tmp.24 tmp.25 tmp-ra.87 rbp))
           (tmp.24 tmp.25 tmp-ra.87 rbp))
          ((((((tmp.107 tmp.24 tmp.25 tmp-ra.87 rbp)
               (tmp.107 tmp.24 tmp.25 tmp-ra.87 rbp)
               (tmp.68 tmp.24 tmp.25 tmp-ra.87 rbp))
              (tmp.24 tmp.25 tmp-ra.87 rbp))
             (tmp.67 tmp.24 tmp.25 tmp-ra.87 rbp)
    ...
    (define L.error?.14
      ((new-frames ())
       (locals (tmp.69 tmp.48 tmp.109 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
         (tmp.48 tmp-ra.88 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.error?.16
      ((new-frames ())
       (locals (tmp.56 tmp.48 tmp.71 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
         (tmp.48 tmp-ra.58 rbp)
         ((((tmp.71 tmp-ra.58 rbp)
            (tmp.71 tmp-ra.58 rbp)
            (tmp.56 tmp-ra.58 rbp))
           (tmp-ra.58 rbp))
    ...
    ((new-frames (() () () () () () () () () () () () () () () () () () () ()))
     (locals
      (void1.5
       ...
       error5.1))
     (call-undead
      (error0.6 tmp.74 tmp.78 tmp.77 tmp.81 tmp.69 tmp.70 tmp.71 tmp-ra.96))
     (undead-out
      ((tmp-ra.96 rbp)
       ((rax tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
       (error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 error0.6 tmp-ra.96 rbp)
       ((rax tmp.71 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.72 error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 error0.6 tmp-ra.96 rbp)
       ((rax tmp.70 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.70 error0.6 tmp-ra.96 rbp)
       ((rax tmp.74 tmp.70 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.75 tmp.70 error0.6 tmp-ra.96 rbp)
       ((rax tmp.70 error0.6 tmp-ra.96 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.73 error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.69 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.78 tmp.69 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.69 error0.6 tmp-ra.96 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.81 tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.82 tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.77 tmp.69 error0.6 tmp-ra.96 rbp)
        ((tmp.81 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.80 tmp.69 error0.6 tmp-ra.96 rbp)
       ((rax tmp.69 error0.6 tmp-ra.96 rbp)
        ((tmp.77 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.76 error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (error0.6 tmp-ra.96 rbp)
       ((rax error0.6 tmp-ra.96 rbp) ((r15 rbp) (r15 rbp)))
        ...
        ((rdi rsi tmp-ra.84 rbp)
         ...
         ((((((tmp.101 tmp.24 tmp.25 tmp-ra.84 rbp)
          ...
          ((((((tmp.102 tmp.24 tmp.25 tmp-ra.84 rbp)
               (tmp.102 tmp.24 tmp.25 tmp-ra.84 rbp)
               (tmp.64 tmp.24 tmp.25 tmp-ra.84 rbp))
              (tmp.24 tmp.25 tmp-ra.84 rbp))
             (tmp.63 tmp.24 tmp.25 tmp-ra.84 rbp)
             (tmp.63 tmp.24 tmp.25 tmp-ra.84 rbp))
            (tmp.24 tmp.25 tmp-ra.84 rbp))
           ((tmp.25 tmp.103 tmp-ra.84 rbp)
            (tmp.103 tmp-ra.84 rbp)
            (tmp-ra.84 rax rbp)
            (rax rbp))
           ((tmp-ra.84 rax rbp) (rax rbp)))
 ...
 '(module
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.110 rbp)
       ...
       ((rax tmp-ra.110 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.70 tmp-ra.110 rbp)
       ((rax tmp-ra.110 rbp) ((rdi rbp) (rdi r15 rbp) (rdi r15 rbp)))
       (tmp-ra.110 rbp)
       ((rax tmp-ra.110 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.73 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.73 tmp.74 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.73 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.72 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.76 tmp.72 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.76 tmp.72 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.76 tmp.77 tmp.72 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.72 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.76 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.72 tmp.75 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.72 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.80 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.80 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.80 tmp.81 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.80 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.83 tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.84 tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.79 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.79 tmp.82 tmp.71 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.71 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.79 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.78 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.87 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.87 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.87 tmp.88 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.87 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.86 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.86 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.90 tmp.86 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.90 tmp.86 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.90 tmp.91 tmp.86 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.86 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.90 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.86 tmp.89 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.86 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.94 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.94 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.94 tmp.95 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.94 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.97 tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp.98 tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.93 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.97 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.93 tmp.96 tmp.85 ascii-char2.4 tmp-ra.110 rbp)
       ((rax tmp.85 ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.93 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.92 ascii-char2.4 tmp-ra.110 rbp)
       ((rax ascii-char2.4 tmp-ra.110 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (ascii-char2.4 tmp-ra.110 rbp)
       (tmp-ra.110 rax rbp)
    ...
    (define L.+.15
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.99 rbp)
         (rsi tmp.22 tmp-ra.99 rbp)
         (tmp.22 tmp.23 tmp-ra.99 rbp)
         ((((((tmp.111 tmp.22 tmp.23 tmp-ra.99 rbp)
              (tmp.111 tmp.22 tmp.23 tmp-ra.99 rbp)
              (tmp.57 tmp.22 tmp.23 tmp-ra.99 rbp))
             (tmp.22 tmp.23 tmp-ra.99 rbp))
            (tmp.56 tmp.22 tmp.23 tmp-ra.99 rbp)
            (tmp.56 tmp.22 tmp.23 tmp-ra.99 rbp))
           (tmp.22 tmp.23 tmp-ra.99 rbp))
          ((((((tmp.112 tmp.22 tmp.23 tmp-ra.99 rbp)
               (tmp.112 tmp.22 tmp.23 tmp-ra.99 rbp)
               (tmp.59 tmp.22 tmp.23 tmp-ra.99 rbp))
              (tmp.22 tmp.23 tmp-ra.99 rbp))
             (tmp.58 tmp.22 tmp.23 tmp-ra.99 rbp)
             (tmp.58 tmp.22 tmp.23 tmp-ra.99 rbp))
            (tmp.22 tmp.23 tmp-ra.99 rbp))
           ((tmp.23 tmp.113 tmp-ra.99 rbp)
            (tmp.113 tmp-ra.99 rbp)
            (tmp-ra.99 rax rbp)
            (rax rbp))
           ((tmp-ra.99 rax rbp) (rax rbp)))
          ((tmp-ra.99 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.100 rbp)
         ...
         ((((((tmp.114 tmp.21 tmp.20 tmp-ra.100 rbp)
              (tmp.114 tmp.21 tmp.20 tmp-ra.100 rbp)
              (tmp.61 tmp.21 tmp.20 tmp-ra.100 rbp))
             (tmp.21 tmp.20 tmp-ra.100 rbp))
            (tmp.60 tmp.21 tmp.20 tmp-ra.100 rbp)
            (tmp.60 tmp.21 tmp.20 tmp-ra.100 rbp))
           (tmp.21 tmp.20 tmp-ra.100 rbp))
          ((((((tmp.115 tmp.21 tmp.20 tmp-ra.100 rbp)
               (tmp.115 tmp.21 tmp.20 tmp-ra.100 rbp)
               (tmp.63 tmp.21 tmp.20 tmp-ra.100 rbp))
              (tmp.21 tmp.20 tmp-ra.100 rbp))
             (tmp.62 tmp.21 tmp.20 tmp-ra.100 rbp)
             (tmp.62 tmp.21 tmp.20 tmp-ra.100 rbp))
            (tmp.21 tmp.20 tmp-ra.100 rbp))
           ((tmp.116 tmp.20 tmp-ra.100 rbp)
            (tmp.116 tmp.20 tmp-ra.100 rbp)
            (tmp.20 tmp.64 tmp-ra.100 rbp)
            (tmp.64 tmp.117 tmp-ra.100 rbp)
            (tmp.117 tmp-ra.100 rbp)
            (tmp-ra.100 rax rbp)
            (rax rbp))
           ((tmp-ra.100 rax rbp) (rax rbp)))
          ((tmp-ra.100 rax rbp) (rax rbp)))))
    ...
    (define L.-.13
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.101 rbp)
         (rsi tmp.24 tmp-ra.101 rbp)
         (tmp.24 tmp.25 tmp-ra.101 rbp)
         ((((((tmp.118 tmp.24 tmp.25 tmp-ra.101 rbp)
              (tmp.118 tmp.24 tmp.25 tmp-ra.101 rbp)
              (tmp.66 tmp.24 tmp.25 tmp-ra.101 rbp))
             (tmp.24 tmp.25 tmp-ra.101 rbp))
            (tmp.65 tmp.24 tmp.25 tmp-ra.101 rbp)
            (tmp.65 tmp.24 tmp.25 tmp-ra.101 rbp))
           (tmp.24 tmp.25 tmp-ra.101 rbp))
          ((((((tmp.119 tmp.24 tmp.25 tmp-ra.101 rbp)
               (tmp.119 tmp.24 tmp.25 tmp-ra.101 rbp)
               (tmp.68 tmp.24 tmp.25 tmp-ra.101 rbp))
              (tmp.24 tmp.25 tmp-ra.101 rbp))
             (tmp.67 tmp.24 tmp.25 tmp-ra.101 rbp)
             (tmp.67 tmp.24 tmp.25 tmp-ra.101 rbp))
            (tmp.24 tmp.25 tmp-ra.101 rbp))
           ((tmp.25 tmp.120 tmp-ra.101 rbp)
            (tmp.120 tmp-ra.101 rbp)
            (tmp-ra.101 rax rbp)
            (rax rbp))
           ((tmp-ra.101 rax rbp) (rax rbp)))
          ((tmp-ra.101 rax rbp) (rax rbp)))))
    ...
    (define L.pair?.12
      ((new-frames ())
       (locals (tmp.69 tmp.49 tmp.121 tmp-ra.102))
       (undead-out
        ((rdi tmp-ra.102 rbp)
         (tmp.49 tmp-ra.102 rbp)
         ((((tmp.121 tmp-ra.102 rbp)
            (tmp.121 tmp-ra.102 rbp)
...
(check-by-interp
 '(module
       ...
       (undead-out
        ((rdi rsi tmp-ra.87 rbp)
         ...
         ((((((tmp.108 tmp.22 tmp.23 tmp-ra.87 rbp)
             ...
             (tmp.22 tmp.23 tmp-ra.87 rbp))
            (tmp.65 tmp.22 tmp.23 tmp-ra.87 rbp)
            (tmp.65 tmp.22 tmp.23 tmp-ra.87 rbp))
           (tmp.22 tmp.23 tmp-ra.87 rbp))
          ((((((tmp.109 tmp.22 tmp.23 tmp-ra.87 rbp)
               (tmp.109 tmp.22 tmp.23 tmp-ra.87 rbp)
    ...
    (define L.vector?.16
      ((new-frames ())
       (locals (tmp.69 tmp.50 tmp.111 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
         (tmp.50 tmp-ra.88 rbp)
         ((((tmp.111 tmp-ra.88 rbp)
            (tmp.111 tmp-ra.88 rbp)
            (tmp.69 tmp-ra.88 rbp))
           (tmp-ra.88 rbp))
    ...
    ((new-frames (() () () () () () () () () () () () () () () () () () () ()))
     (locals
      (empty0.6
       ...
       fixnum4.2
       empty5.1))
     (call-undead (tmp.71 tmp.70 tmp.69 tmp.81 tmp.77 tmp.78 tmp.74 tmp-ra.98))
     (undead-out
      ((tmp-ra.98 rbp)
       ((rax tmp-ra.98 rbp) ((r15 rbp) (r15 rbp)))
       (tmp-ra.98 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals
      (ascii-char0.6 error1.5 error2.4 tmp.57 boolean3.3 error4.2 void5.1))
     (call-undead (tmp-ra.70))
     (undead-out
      ((tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
    ...
    (define L.boolean?.16
      ((new-frames ())
       (locals (tmp.56 tmp.44 tmp.71 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals (tmp.57 boolean0.6 ascii-char1.5 void2.4 void3.3 ascii-char5.1))
     (call-undead (ascii-char4.2 tmp-ra.70))
     (undead-out
      ((tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (tmp.57 tmp-ra.70 rbp)
       ...
       (tmp-ra.70 rbp)
       ((rax tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char4.2 tmp-ra.70 rbp)
       ((rax ascii-char4.2 tmp-ra.70 rbp) ((r15 rbp) (r15 rbp)))
       (ascii-char4.2 tmp-ra.70 rbp)
       (tmp-ra.70 rax rbp)
       (rax rbp)))
     (conflicts
    ...
    (define L.ascii-char?.16
      ((new-frames ())
       (locals (tmp.56 tmp.47 tmp.71 tmp-ra.58))
       (undead-out
        ((rdi tmp-ra.58 rbp)
         (tmp.47 tmp-ra.58 rbp)
         ((((tmp.71 tmp-ra.58 rbp)
            (tmp.71 tmp-ra.58 rbp)
            (tmp.56 tmp-ra.58 rbp))
           (tmp-ra.58 rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.85 rbp)
         (rsi tmp.24 tmp-ra.85 rbp)
         (tmp.24 tmp.25 tmp-ra.85 rbp)
         ((((((tmp.106 tmp.24 tmp.25 tmp-ra.85 rbp)
              (tmp.106 tmp.24 tmp.25 tmp-ra.85 rbp)
              (tmp.66 tmp.24 tmp.25 tmp-ra.85 rbp))
             (tmp.24 tmp.25 tmp-ra.85 rbp))
            (tmp.65 tmp.24 tmp.25 tmp-ra.85 rbp)
            (tmp.65 tmp.24 tmp.25 tmp-ra.85 rbp))
           (tmp.24 tmp.25 tmp-ra.85 rbp))
          ((((((tmp.107 tmp.24 tmp.25 tmp-ra.85 rbp)
               (tmp.107 tmp.24 tmp.25 tmp-ra.85 rbp)
               (tmp.68 tmp.24 tmp.25 tmp-ra.85 rbp))
              (tmp.24 tmp.25 tmp-ra.85 rbp))
             (tmp.67 tmp.24 tmp.25 tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (locals
      (ascii-char0.6
       ...
       boolean5.1))
     (call-undead
      (tmp.77 tmp.81 tmp.80 tmp.84 tmp.72 tmp.73 tmp.74 tmp-ra.102))
     (undead-out
      ((tmp-ra.102 rbp)
    ...
    (define L.boolean?.19
      ((new-frames ())
       (locals (tmp.56 tmp.44 tmp.103 tmp-ra.87))
       (undead-out
        ((rdi tmp-ra.87 rbp)
         (tmp.44 tmp-ra.87 rbp)
    ...
    (define L.fixnum?.15
      ((new-frames ())
       (locals (tmp.70 tmp.43 tmp.114 tmp-ra.91))
       (undead-out
        ((rdi tmp-ra.91 rbp)
         (tmp.43 tmp-ra.91 rbp)
...
(check-by-interp
 '(module
    ((new-frames
     ...
     (undead-out
      ((tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp-ra.132 rbp)
       ((rax tmp.71 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.72 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp-ra.132 rbp)
       ((rax tmp.70 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.70 tmp-ra.132 rbp)
       ((rax tmp.74 tmp.70 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.75 tmp.70 tmp-ra.132 rbp)
       ((rax tmp.70 tmp-ra.132 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.73 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp-ra.132 rbp)
       ((rax tmp.69 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.78 tmp.69 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.69 tmp-ra.132 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.77 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.81 tmp.77 tmp.69 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.82 tmp.77 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.132 rbp)
        ((tmp.81 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.80 tmp.69 tmp-ra.132 rbp)
       ((rax tmp.69 tmp-ra.132 rbp)
        ((tmp.77 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.76 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp-ra.132 rbp)
       ((rax tmp.85 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.86 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp-ra.132 rbp)
       ((rax tmp.84 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.84 tmp-ra.132 rbp)
       ((rax tmp.88 tmp.84 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.89 tmp.84 tmp-ra.132 rbp)
       ((rax tmp.84 tmp-ra.132 rbp)
        ((tmp.88 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.87 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp-ra.132 rbp)
       ((rax tmp.83 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.92 tmp.83 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.93 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.83 tmp-ra.132 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.91 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.95 tmp.91 tmp.83 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.96 tmp.91 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.132 rbp)
        ((tmp.95 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.94 tmp.83 tmp-ra.132 rbp)
       ((rax tmp.83 tmp-ra.132 rbp)
        ((tmp.91 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.90 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 tmp-ra.132 rbp)
       ((rax tmp.99 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 tmp.100 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.99 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 tmp-ra.132 rbp)
       ((rax tmp.98 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.98 tmp-ra.132 rbp)
       ((rax tmp.102 tmp.98 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.103 tmp.98 tmp-ra.132 rbp)
       ((rax tmp.98 tmp-ra.132 rbp)
        ((tmp.102 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 tmp.101 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.98 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp-ra.132 rbp)
       ((rax tmp.97 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.106 tmp.97 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.107 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.97 tmp-ra.132 rbp)
        ((tmp.106 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.105 tmp.97 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.105 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.109 tmp.105 tmp.97 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.110 tmp.105 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.105 tmp.97 tmp-ra.132 rbp)
        ((tmp.109 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.108 tmp.97 tmp-ra.132 rbp)
       ((rax tmp.97 tmp-ra.132 rbp)
        ((tmp.105 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp.104 tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp)
        ((tmp.97 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.132 rbp)
       ((rax tmp-ra.132 rbp) ((r15 rbp) (r15 rbp)))
       (void3.3 tmp-ra.132 rbp)
       ((rax void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.113 void3.3 tmp-ra.132 rbp)
       ((rax tmp.113 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.113 tmp.114 void3.3 tmp-ra.132 rbp)
       ((rax void3.3 tmp-ra.132 rbp)
        ((tmp.113 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.112 void3.3 tmp-ra.132 rbp)
       ((rax tmp.112 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.116 tmp.112 void3.3 tmp-ra.132 rbp)
       ((rax tmp.116 tmp.112 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.116 tmp.117 tmp.112 void3.3 tmp-ra.132 rbp)
       ((rax tmp.112 void3.3 tmp-ra.132 rbp)
        ((tmp.116 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.112 tmp.115 void3.3 tmp-ra.132 rbp)
       ((rax void3.3 tmp-ra.132 rbp)
        ((tmp.112 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.111 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.120 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.120 tmp.111 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.120 tmp.121 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.111 void3.3 tmp-ra.132 rbp)
        ((tmp.120 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.123 tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.123 tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.123 tmp.124 tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.119 tmp.111 void3.3 tmp-ra.132 rbp)
        ((tmp.123 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.119 tmp.122 tmp.111 void3.3 tmp-ra.132 rbp)
       ((rax tmp.111 void3.3 tmp-ra.132 rbp)
        ((tmp.119 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.111 tmp.118 void3.3 tmp-ra.132 rbp)
       ((rax void3.3 tmp-ra.132 rbp)
        ((tmp.111 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (void3.3 tmp-ra.132 rbp)
       ((rax void3.3 tmp-ra.132 rbp) ((r15 rbp) (r15 rbp)))
       (void3.3 tmp-ra.132 rbp)
       (tmp-ra.132 rax rbp)
       (rax rbp)))
     (conflicts
      ...
      ((new-frames ())
       (locals
        (tmp.56
         ...
         tmp.58))
       (undead-out
        ((rdi rsi tmp-ra.125 rbp)
         (rsi tmp.24 tmp-ra.125 rbp)
         (tmp.24 tmp.25 tmp-ra.125 rbp)
         ((((((tmp.133 tmp.24 tmp.25 tmp-ra.125 rbp)
              (tmp.133 tmp.24 tmp.25 tmp-ra.125 rbp)
              (tmp.57 tmp.24 tmp.25 tmp-ra.125 rbp))
             (tmp.24 tmp.25 tmp-ra.125 rbp))
            (tmp.56 tmp.24 tmp.25 tmp-ra.125 rbp)
            (tmp.56 tmp.24 tmp.25 tmp-ra.125 rbp))
           (tmp.24 tmp.25 tmp-ra.125 rbp))
          ((((((tmp.134 tmp.24 tmp.25 tmp-ra.125 rbp)
               (tmp.134 tmp.24 tmp.25 tmp-ra.125 rbp)
               (tmp.59 tmp.24 tmp.25 tmp-ra.125 rbp))
              (tmp.24 tmp.25 tmp-ra.125 rbp))
             (tmp.58 tmp.24 tmp.25 tmp-ra.125 rbp)
             (tmp.58 tmp.24 tmp.25 tmp-ra.125 rbp))
            (tmp.24 tmp.25 tmp-ra.125 rbp))
           ((tmp.25 tmp.135 tmp-ra.125 rbp)
            (tmp.135 tmp-ra.125 rbp)
            (tmp-ra.125 rax rbp)
            (rax rbp))
           ((tmp-ra.125 rax rbp) (rax rbp)))
          ((tmp-ra.125 rax rbp) (rax rbp)))))
       (call-undead ())
       (conflicts
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.126 rbp)
         (rsi tmp.22 tmp-ra.126 rbp)
         (tmp.22 tmp.23 tmp-ra.126 rbp)
         ((((((tmp.136 tmp.22 tmp.23 tmp-ra.126 rbp)
              (tmp.136 tmp.22 tmp.23 tmp-ra.126 rbp)
              (tmp.61 tmp.22 tmp.23 tmp-ra.126 rbp))
             (tmp.22 tmp.23 tmp-ra.126 rbp))
            (tmp.60 tmp.22 tmp.23 tmp-ra.126 rbp)
            (tmp.60 tmp.22 tmp.23 tmp-ra.126 rbp))
           (tmp.22 tmp.23 tmp-ra.126 rbp))
          ((((((tmp.137 tmp.22 tmp.23 tmp-ra.126 rbp)
               (tmp.137 tmp.22 tmp.23 tmp-ra.126 rbp)
               (tmp.63 tmp.22 tmp.23 tmp-ra.126 rbp))
              (tmp.22 tmp.23 tmp-ra.126 rbp))
             (tmp.62 tmp.22 tmp.23 tmp-ra.126 rbp)
             (tmp.62 tmp.22 tmp.23 tmp-ra.126 rbp))
            (tmp.22 tmp.23 tmp-ra.126 rbp))
           ((tmp.23 tmp.138 tmp-ra.126 rbp)
            (tmp.138 tmp-ra.126 rbp)
            (tmp-ra.126 rax rbp)
            (rax rbp))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.127 rbp)
         (rsi tmp.20 tmp-ra.127 rbp)
         (tmp.21 tmp.20 tmp-ra.127 rbp)
         ((((((tmp.139 tmp.21 tmp.20 tmp-ra.127 rbp)
              (tmp.139 tmp.21 tmp.20 tmp-ra.127 rbp)
              (tmp.65 tmp.21 tmp.20 tmp-ra.127 rbp))
             (tmp.21 tmp.20 tmp-ra.127 rbp))
            (tmp.64 tmp.21 tmp.20 tmp-ra.127 rbp)
            (tmp.64 tmp.21 tmp.20 tmp-ra.127 rbp))
           (tmp.21 tmp.20 tmp-ra.127 rbp))
          ((((((tmp.140 tmp.21 tmp.20 tmp-ra.127 rbp)
               (tmp.140 tmp.21 tmp.20 tmp-ra.127 rbp)
               (tmp.67 tmp.21 tmp.20 tmp-ra.127 rbp))
              (tmp.21 tmp.20 tmp-ra.127 rbp))
             (tmp.66 tmp.21 tmp.20 tmp-ra.127 rbp)
             (tmp.66 tmp.21 tmp.20 tmp-ra.127 rbp))
            (tmp.21 tmp.20 tmp-ra.127 rbp))
           ((tmp.141 tmp.20 tmp-ra.127 rbp)
            (tmp.141 tmp.20 tmp-ra.127 rbp)
            (tmp.20 tmp.68 tmp-ra.127 rbp)
            (tmp.68 tmp.142 tmp-ra.127 rbp)
            (tmp.142 tmp-ra.127 rbp)
            (tmp-ra.127 rax rbp)
            (rax rbp))
    ...
    (define L.fun/void140574.4
      ((new-frames ())
       (locals (tmp-ra.128))
       (undead-out ((tmp-ra.128 rbp) (tmp-ra.128 rax rbp) (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.fun/empty140576.5
      ((new-frames ())
       (locals (tmp-ra.129))
       (undead-out ((tmp-ra.129 rbp) (tmp-ra.129 rax rbp) (rax rbp)))
       (call-undead ())
       (conflicts
    ...
    (define L.fun/empty140575.6
      ((new-frames ())
       (locals (tmp-ra.130))
       (undead-out ((tmp-ra.130 rbp) (r15 rbp) (r15 rbp)))
       (call-undead ())
    ...
    (define L.fun/void140573.7
      ((new-frames ())
       (locals (tmp-ra.131))
       (undead-out ((tmp-ra.131 rbp) (r15 rbp) (r15 rbp)))
       (call-undead ())
...
(check-by-interp
 '(module
     ...
     (undead-out
      ((tmp-ra.122 rbp)
       ...
       ((rax tmp.71 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.71 tmp.72 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.71 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp-ra.122 rbp)
       ((rax tmp.70 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.70 tmp-ra.122 rbp)
       ((rax tmp.74 tmp.70 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.74 tmp.75 tmp.70 tmp-ra.122 rbp)
       ((rax tmp.70 tmp-ra.122 rbp)
        ((tmp.74 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.70 tmp.73 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.70 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp-ra.122 rbp)
       ((rax tmp.69 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.78 tmp.69 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.78 tmp.79 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.69 tmp-ra.122 rbp)
        ((tmp.78 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.77 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.81 tmp.77 tmp.69 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.81 tmp.82 tmp.77 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.77 tmp.69 tmp-ra.122 rbp)
        ((tmp.81 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.77 tmp.80 tmp.69 tmp-ra.122 rbp)
       ((rax tmp.69 tmp-ra.122 rbp)
        ((tmp.77 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.69 tmp.76 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.69 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp-ra.122 rbp)
       ((rax tmp.85 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.85 tmp.86 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.85 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp-ra.122 rbp)
       ((rax tmp.84 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.84 tmp-ra.122 rbp)
       ((rax tmp.88 tmp.84 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.88 tmp.89 tmp.84 tmp-ra.122 rbp)
       ((rax tmp.84 tmp-ra.122 rbp)
        ((tmp.88 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.84 tmp.87 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.84 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp-ra.122 rbp)
       ((rax tmp.83 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.92 tmp.83 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.92 tmp.93 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.83 tmp-ra.122 rbp)
        ((tmp.92 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.91 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.95 tmp.91 tmp.83 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.95 tmp.96 tmp.91 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.91 tmp.83 tmp-ra.122 rbp)
        ((tmp.95 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.91 tmp.94 tmp.83 tmp-ra.122 rbp)
       ((rax tmp.83 tmp-ra.122 rbp)
        ((tmp.91 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.83 tmp.90 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.83 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.122 rbp)
       ...
       ((rax tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 tmp-ra.122 rbp)
       ((rax tmp.99 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.99 tmp.100 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.99 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 tmp-ra.122 rbp)
       ((rax tmp.98 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.98 tmp-ra.122 rbp)
       ((rax tmp.102 tmp.98 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.102 tmp.103 tmp.98 tmp-ra.122 rbp)
       ((rax tmp.98 tmp-ra.122 rbp)
        ((tmp.102 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.98 tmp.101 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.98 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp-ra.122 rbp)
       ((rax tmp.97 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.106 tmp.97 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.106 tmp.107 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.97 tmp-ra.122 rbp)
        ((tmp.106 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.105 tmp.97 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.105 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.109 tmp.105 tmp.97 tmp-ra.122 rbp)
        ((rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.109 tmp.110 tmp.105 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.105 tmp.97 tmp-ra.122 rbp)
        ((tmp.109 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.105 tmp.108 tmp.97 tmp-ra.122 rbp)
       ((rax tmp.97 tmp-ra.122 rbp)
        ((tmp.105 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp.97 tmp.104 tmp-ra.122 rbp)
       ((rax tmp-ra.122 rbp)
        ((tmp.97 rsi rbp) (rsi rdi rbp) (rsi rdi r15 rbp) (rsi rdi r15 rbp)))
       (tmp-ra.122 rbp)
       (r15 rbp)
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.111 rbp)
         (rsi tmp.24 tmp-ra.111 rbp)
         (tmp.24 tmp.25 tmp-ra.111 rbp)
         ((((((tmp.123 tmp.24 tmp.25 tmp-ra.111 rbp)
              (tmp.123 tmp.24 tmp.25 tmp-ra.111 rbp)
              (tmp.57 tmp.24 tmp.25 tmp-ra.111 rbp))
             (tmp.24 tmp.25 tmp-ra.111 rbp))
            (tmp.56 tmp.24 tmp.25 tmp-ra.111 rbp)
            (tmp.56 tmp.24 tmp.25 tmp-ra.111 rbp))
           (tmp.24 tmp.25 tmp-ra.111 rbp))
          ((((((tmp.124 tmp.24 tmp.25 tmp-ra.111 rbp)
               (tmp.124 tmp.24 tmp.25 tmp-ra.111 rbp)
               (tmp.59 tmp.24 tmp.25 tmp-ra.111 rbp))
              (tmp.24 tmp.25 tmp-ra.111 rbp))
             (tmp.58 tmp.24 tmp.25 tmp-ra.111 rbp)
             (tmp.58 tmp.24 tmp.25 tmp-ra.111 rbp))
            (tmp.24 tmp.25 tmp-ra.111 rbp))
           ((tmp.25 tmp.125 tmp-ra.111 rbp)
            (tmp.125 tmp-ra.111 rbp)
            (tmp-ra.111 rax rbp)
            (rax rbp))
           ((tmp-ra.111 rax rbp) (rax rbp)))
          ((tmp-ra.111 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.112 rbp)
         (rsi tmp.20 tmp-ra.112 rbp)
         (tmp.21 tmp.20 tmp-ra.112 rbp)
         ((((((tmp.126 tmp.21 tmp.20 tmp-ra.112 rbp)
              (tmp.126 tmp.21 tmp.20 tmp-ra.112 rbp)
              (tmp.61 tmp.21 tmp.20 tmp-ra.112 rbp))
             (tmp.21 tmp.20 tmp-ra.112 rbp))
            (tmp.60 tmp.21 tmp.20 tmp-ra.112 rbp)
            (tmp.60 tmp.21 tmp.20 tmp-ra.112 rbp))
           (tmp.21 tmp.20 tmp-ra.112 rbp))
          ((((((tmp.127 tmp.21 tmp.20 tmp-ra.112 rbp)
               (tmp.127 tmp.21 tmp.20 tmp-ra.112 rbp)
               (tmp.63 tmp.21 tmp.20 tmp-ra.112 rbp))
              (tmp.21 tmp.20 tmp-ra.112 rbp))
             (tmp.62 tmp.21 tmp.20 tmp-ra.112 rbp)
             (tmp.62 tmp.21 tmp.20 tmp-ra.112 rbp))
            (tmp.21 tmp.20 tmp-ra.112 rbp))
           ((tmp.128 tmp.20 tmp-ra.112 rbp)
            (tmp.128 tmp.20 tmp-ra.112 rbp)
            (tmp.20 tmp.64 tmp-ra.112 rbp)
            (tmp.64 tmp.129 tmp-ra.112 rbp)
            (tmp.129 tmp-ra.112 rbp)
            (tmp-ra.112 rax rbp)
            (rax rbp))
           ((tmp-ra.112 rax rbp) (rax rbp)))
          ((tmp-ra.112 rax rbp) (rax rbp)))))
      ...
      ((new-frames ())
       ...
       (undead-out
        ((rdi rsi tmp-ra.113 rbp)
         (rsi tmp.22 tmp-ra.113 rbp)
         (tmp.22 tmp.23 tmp-ra.113 rbp)
         ((((((tmp.130 tmp.22 tmp.23 tmp-ra.113 rbp)
              (tmp.130 tmp.22 tmp.23 tmp-ra.113 rbp)
              (tmp.66 tmp.22 tmp.23 tmp-ra.113 rbp))
             (tmp.22 tmp.23 tmp-ra.113 rbp))
            (tmp.65 tmp.22 tmp.23 tmp-ra.113 rbp)
            (tmp.65 tmp.22 tmp.23 tmp-ra.113 rbp))
           (tmp.22 tmp.23 tmp-ra.113 rbp))
          ((((((tmp.131 tmp.22 tmp.23 tmp-ra.113 rbp)
               (tmp.131 tmp.22 tmp.23 tmp-ra.113 rbp)
               (tmp.68 tmp.22 tmp.23 tmp-ra.113 rbp))
              (tmp.22 tmp.23 tmp-ra.113 rbp))
             (tmp.67 tmp.22 tmp.23 tmp-ra.113 rbp)
             (tmp.67 tmp.22 tmp.23 tmp-ra.113 rbp))
            (tmp.22 tmp.23 tmp-ra.113 rbp))
           ((tmp.23 tmp.132 tmp-ra.113 rbp)
            (tmp.132 tmp-ra.113 rbp)
            (tmp-ra.113 rax rbp)
            (rax rbp))
           ((tmp-ra.113 rax rbp) (rax rbp)))
          ((tmp-ra.113 rax rbp) (rax rbp)))))
    ...
    (define L.fun/ascii-char143929.5
      ((new-frames ())
       (locals (tmp-ra.115))
       (undead-out ((tmp-ra.115 rbp) (r15 rbp) (r15 rbp)))
       (call-undead ())
    ...
    (define L.fun/error143928.6
      ((new-frames ())
       (locals (tmp-ra.116))
       (undead-out ((tmp-ra.116 rbp) (tmp-ra.116 rax rbp) (rax rbp)))
       (call-undead ())
       (conflicts
