...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-imp-cmf-lang-v7 (check-imp-cmf-lang-v7 p))
                (interp-asm-pred-lang-v7 (check-asm-pred-lang-v7 (select-instructions p)))))
