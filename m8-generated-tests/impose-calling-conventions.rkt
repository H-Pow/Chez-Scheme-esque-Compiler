 ...
 '(module
    ...
    (begin
      (if (begin
            ...
            (!= tmp.71 6))
        (set! tmp.70 (call L.fun/fixnum9202.5 30 22 30))
        (set! tmp.70 (call L.fun/fixnum9203.4 22 6 6)))
      (begin
        (if (if (!= 14 6) (!= 6 6) (!= 6 6))
          (begin
            (set! boolean0.16 6)
          ...
          (set! tmp.72 (call L.fun/fixnum9204.6 30 25390 1776)))
    ...
    (begin
      (begin
        ...
        (begin
          ...
          (set! fixnum0.4 (call L.-.11 tmp.67 tmp.68))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum1.3 (call L.-.10 tmp.67 tmp.68))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! fixnum3.1 (call L.*.9 tmp.63 tmp.64))))
      void1.3)))
(check-by-interp
 '(module
    (define L.void?.10
    ...
    (begin
      ...
      (begin
        (set! tmp.55 (call L.fun/any9647.6))
        (set! boolean1.3 (call L.void?.10 tmp.55)))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean1.4 (call L.ascii-char?.10 tmp.56)))
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (begin
        (set! tmp.69 (call L.fun/any12537.5))
        (set! boolean1.4 (call L.empty?.9 tmp.69)))
      (begin
        (begin
          (set! tmp.71 (call L.*.10 784 384))
          (begin
            (set! tmp.72 (call L.+.11 104 912))
            (set! tmp.70 (call L.+.11 tmp.71 tmp.72))))
        (begin
          (begin
            (set! tmp.74 (call L.-.12 1776 1288))
            (begin
              (set! tmp.75 (call L.*.10 792 760))
              (set! tmp.73 (call L.-.12 tmp.74 tmp.75))))
          (set! fixnum2.3 (call L.-.12 tmp.70 tmp.73))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.69 (call L.-.10 tmp.70 tmp.71))))
        (begin
          (begin
            (set! tmp.73 (call L.-.10 1880 1808))
            (begin
              (set! tmp.74 (call L.*.9 2008 704))
              (set! tmp.72 (call L.-.10 tmp.73 tmp.74))))
          (set! fixnum0.5 (call L.+.11 tmp.69 tmp.72))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.75 (call L.-.10 tmp.76 tmp.77))))
        (begin
          (begin
            (set! tmp.79 (call L.*.9 24 1240))
            (begin
              (set! tmp.80 (call L.+.11 1808 1752))
              (set! tmp.78 (call L.*.9 tmp.79 tmp.80))))
          (set! fixnum2.3 (call L.-.10 tmp.75 tmp.78))))
      (begin
        (set! tmp.81 (call L.fun/any13289.4))
        (set! boolean3.2 (call L.pair?.12 tmp.81)))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.69 (call L.-.9 tmp.70 tmp.71))))
        (begin
          (begin
            (set! tmp.73 (call L.+.11 928 608))
            (begin
              (set! tmp.74 (call L.-.9 224 1288))
              (set! tmp.72 (call L.+.11 tmp.73 tmp.74))))
          (set! fixnum1.4 (call L.+.11 tmp.69 tmp.72))))
      (begin
        (set! tmp.75 (call L.fun/any13295.5))
        (set! boolean2.3 (call L.fixnum?.12 tmp.75)))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean3.2 (call L.ascii-char?.10 tmp.56)))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.68 (call L.-.9 tmp.69 tmp.70))))
        (begin
          (begin
            (set! tmp.72 (call L.-.9 1456 1872))
            (begin
              (set! tmp.73 (call L.+.10 432 624))
              (set! tmp.71 (call L.-.9 tmp.72 tmp.73))))
          (set! fixnum1.4 (call L.*.8 tmp.68 tmp.71))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.74 (call L.-.9 tmp.75 tmp.76))))
        (begin
          (begin
            (set! tmp.78 (call L.*.8 832 624))
            (begin
              (set! tmp.79 (call L.*.8 816 256))
              (set! tmp.77 (call L.+.10 tmp.78 tmp.79))))
          (set! fixnum4.1 (call L.-.9 tmp.74 tmp.77))))
      empty3.2)))
(check-by-interp
 '(module
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.68 (call L.*.10 tmp.69 tmp.70))))
        (begin
          (begin
            (set! tmp.72 (call L.+.12 1936 536))
            (begin
              (set! tmp.73 (call L.*.10 112 1704))
              (set! tmp.71 (call L.*.10 tmp.72 tmp.73))))
          (set! fixnum2.3 (call L.*.10 tmp.68 tmp.71))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.70 (call L.+.9 tmp.71 tmp.72))))
        (begin
          (begin
            (set! tmp.74 (call L.-.10 2032 1016))
            (begin
              (set! tmp.75 (call L.-.10 544 1496))
              (set! tmp.73 (call L.-.10 tmp.74 tmp.75))))
          (set! fixnum0.5 (call L.*.11 tmp.70 tmp.73))))
      (begin
        (set! tmp.76 (call L.fun/any15908.6))
        (set! boolean1.4 (call L.ascii-char?.12 tmp.76)))
      (set! ascii-char2.3 (call L.fun/ascii-char15909.7))
      (begin
        (set! tmp.77 (call L.fun/any15910.5))
        (set! boolean3.2 (call L.empty?.13 tmp.77)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.71 (call L.+.9 tmp.72 tmp.73))))
          (set! fixnum1.4 (call L.+.9 tmp.68 tmp.71))))
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.74 (call L.-.10 tmp.75 tmp.76))))
        (begin
          (begin
            (set! tmp.78 (call L.*.8 1480 400))
            (begin
              (set! tmp.79 (call L.-.10 848 1320))
              (set! tmp.77 (call L.+.9 tmp.78 tmp.79))))
          (set! fixnum4.1 (call L.-.10 tmp.74 tmp.77))))
      void0.5)))
(check-by-interp
 '(module
    (define L.+.12
      ...
      (begin
        (begin
          ...
          (begin
            ...
            (set! tmp.68 (call L.*.11 tmp.69 tmp.70))))
        (begin
          (begin
            (set! tmp.72 (call L.+.12 1936 792))
            (begin
              (set! tmp.73 (call L.*.11 472 1904))
              (set! tmp.71 (call L.*.11 tmp.72 tmp.73))))
          (set! fixnum4.1 (call L.-.10 tmp.68 tmp.71))))
    ...
    (if (begin
          (begin
            (begin
              ...
              (set! fixnum4.1 88)
              (set! tmp.62 30))
            (set! tmp.61 (call L.void?.5 tmp.62)))
          (!= tmp.61 6))
      (begin
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.71 (call L.*.9 tmp.72 tmp.73))))
          (set! fixnum4.1 (call L.*.9 tmp.68 tmp.71))))
      ascii-char3.2)))
(check-by-interp
 '(module
    (define L.-.17
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.-.17 tmp.71 tmp.72))))
          (begin
            (begin
              (set! tmp.74 (call L.*.15 1048 928))
              (begin
                (set! tmp.75 (call L.*.15 1272 224))
                (set! tmp.73 (call L.-.17 tmp.74 tmp.75))))
            (set! tmp.69 (call L.+.16 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.*.15 tmp.78 tmp.79))))
            (begin
              (begin
                (set! tmp.81 (call L.+.16 1672 320))
                (begin
                  (set! tmp.82 (call L.-.17 1352 1280))
                  (set! tmp.80 (call L.+.16 tmp.81 tmp.82))))
              (set! tmp.76 (call L.-.17 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.-.17 tmp.69 tmp.76))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.*.16 tmp.71 tmp.72))))
          (begin
            (begin
              (set! tmp.74 (call L.+.17 1008 432))
              (begin
                (set! tmp.75 (call L.+.17 760 664))
                (set! tmp.73 (call L.*.16 tmp.74 tmp.75))))
            (set! tmp.69 (call L.+.17 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.+.17 tmp.78 tmp.79))))
            (begin
              (begin
                (set! tmp.81 (call L.*.16 528 1168))
                (begin
                  (set! tmp.82 (call L.+.17 1872 1424))
                  (set! tmp.80 (call L.+.17 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.17 tmp.77 tmp.80))))
          (set! fixnum4.2 (call L.-.15 tmp.69 tmp.76))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.73 (call L.*.12 tmp.74 tmp.75))))
            (set! tmp.69 (call L.*.12 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.*.12 tmp.78 tmp.79))))
            (begin
              (begin
                (set! tmp.81 (call L.+.11 360 1792))
                (begin
                  (set! tmp.82 (call L.*.12 896 1480))
                  (set! tmp.80 (call L.+.11 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.11 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.*.12 tmp.69 tmp.76))))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.84 (call L.*.12 tmp.85 tmp.86))))
          (begin
            (begin
              (set! tmp.88 (call L.*.12 656 1432))
              (begin
                (set! tmp.89 (call L.+.11 784 208))
                (set! tmp.87 (call L.-.13 tmp.88 tmp.89))))
            (set! tmp.83 (call L.*.12 tmp.84 tmp.87))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.91 (call L.-.13 tmp.92 tmp.93))))
            (begin
              (begin
                (set! tmp.95 (call L.*.12 176 88))
                (begin
                  (set! tmp.96 (call L.*.12 912 1120))
                  (set! tmp.94 (call L.-.13 tmp.95 tmp.96))))
              (set! tmp.90 (call L.*.12 tmp.91 tmp.94))))
          (set! fixnum1.5 (call L.+.11 tmp.83 tmp.90))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.98 (call L.+.11 tmp.99 tmp.100))))
          (begin
            (begin
              (set! tmp.102 (call L.+.11 1952 1928))
              (begin
                (set! tmp.103 (call L.*.12 1552 1384))
                (set! tmp.101 (call L.+.11 tmp.102 tmp.103))))
            (set! tmp.97 (call L.+.11 tmp.98 tmp.101))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.105 (call L.+.11 tmp.106 tmp.107))))
            (begin
              (begin
                (set! tmp.109 (call L.*.12 1152 1432))
                (begin
                  (set! tmp.110 (call L.-.13 1216 832))
                  (set! tmp.108 (call L.+.11 tmp.109 tmp.110))))
              (set! tmp.104 (call L.*.12 tmp.105 tmp.108))))
          (set! fixnum5.1 (call L.*.12 tmp.97 tmp.104))))
      void3.3)))
(check-by-interp
 '(module
    (define L.pair?.15
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.71 (call L.+.13 tmp.72 tmp.73))))
          (begin
            (begin
              (set! tmp.75 (call L.-.14 608 424))
              (begin
                (set! tmp.76 (call L.*.12 1656 1016))
                (set! tmp.74 (call L.*.12 tmp.75 tmp.76))))
            (set! tmp.70 (call L.-.14 tmp.71 tmp.74))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.78 (call L.-.14 tmp.79 tmp.80))))
            (begin
              (begin
                (set! tmp.82 (call L.-.14 760 344))
                (begin
                  (set! tmp.83 (call L.+.13 704 1496))
                  (set! tmp.81 (call L.+.13 tmp.82 tmp.83))))
              (set! tmp.77 (call L.+.13 tmp.78 tmp.81))))
          (set! fixnum2.4 (call L.*.12 tmp.70 tmp.77))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.85 (call L.-.14 tmp.86 tmp.87))))
          (begin
            (begin
              (set! tmp.89 (call L.+.13 592 392))
              (begin
                (set! tmp.90 (call L.-.14 1544 520))
                (set! tmp.88 (call L.-.14 tmp.89 tmp.90))))
            (set! tmp.84 (call L.-.14 tmp.85 tmp.88))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.92 (call L.-.14 tmp.93 tmp.94))))
            (begin
              (begin
                (set! tmp.96 (call L.*.12 680 400))
                (begin
                  (set! tmp.97 (call L.+.13 664 480))
                  (set! tmp.95 (call L.-.14 tmp.96 tmp.97))))
              (set! tmp.91 (call L.*.12 tmp.92 tmp.95))))
          (set! fixnum4.2 (call L.*.12 tmp.84 tmp.91))))
      (begin
        (set! tmp.98 (call L.fun/any46567.10))
        (set! boolean5.1 (call L.pair?.15 tmp.98)))
      void3.3)))
(check-by-interp
 '(module
    (define L.+.15
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.-.14 tmp.71 tmp.72))))
          (begin
            (begin
              (set! tmp.74 (call L.+.15 1400 424))
              (begin
                (set! tmp.75 (call L.+.15 1416 1392))
                (set! tmp.73 (call L.-.14 tmp.74 tmp.75))))
            (set! tmp.69 (call L.*.13 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.-.14 tmp.78 tmp.79))))
            (begin
              (begin
                (set! tmp.81 (call L.+.15 1152 1640))
                (begin
                  (set! tmp.82 (call L.+.15 1088 312))
                  (set! tmp.80 (call L.-.14 tmp.81 tmp.82))))
              (set! tmp.76 (call L.-.14 tmp.77 tmp.80))))
          (set! fixnum2.4 (call L.+.15 tmp.69 tmp.76))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.84 (call L.-.14 tmp.85 tmp.86))))
          (begin
            (begin
              (set! tmp.88 (call L.+.15 1496 1520))
              (begin
                (set! tmp.89 (call L.-.14 304 1136))
                (set! tmp.87 (call L.-.14 tmp.88 tmp.89))))
            (set! tmp.83 (call L.-.14 tmp.84 tmp.87))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.91 (call L.-.14 tmp.92 tmp.93))))
            (begin
              (begin
                (set! tmp.95 (call L.-.14 520 1312))
                (begin
                  (set! tmp.96 (call L.*.13 120 1176))
                  (set! tmp.94 (call L.-.14 tmp.95 tmp.96))))
              (set! tmp.90 (call L.+.15 tmp.91 tmp.94))))
          (set! fixnum4.2 (call L.*.13 tmp.83 tmp.90))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.-.13 tmp.71 tmp.72))))
          (begin
            (begin
              (set! tmp.74 (call L.+.15 1632 408))
              (begin
                (set! tmp.75 (call L.-.13 632 976))
                (set! tmp.73 (call L.-.13 tmp.74 tmp.75))))
            (set! tmp.69 (call L.*.14 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.+.15 tmp.81 tmp.82))))
              (set! tmp.76 (call L.*.14 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.*.14 tmp.69 tmp.76))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.87 (call L.*.14 tmp.88 tmp.89))))
            (set! tmp.83 (call L.-.13 tmp.84 tmp.87))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.94 (call L.+.15 tmp.95 tmp.96))))
              (set! tmp.90 (call L.-.13 tmp.91 tmp.94))))
          (set! fixnum3.3 (call L.*.14 tmp.83 tmp.90))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean1.5 (call L.vector?.16 tmp.57)))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean1.5 (call L.boolean?.16 tmp.70)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.72 (call L.+.18 tmp.73 tmp.74))))
          (begin
            (begin
              (set! tmp.76 (call L.*.19 1440 1808))
              (begin
                (set! tmp.77 (call L.-.17 696 1592))
                (set! tmp.75 (call L.-.17 tmp.76 tmp.77))))
            (set! tmp.71 (call L.-.17 tmp.72 tmp.75))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.79 (call L.*.19 tmp.80 tmp.81))))
            (begin
              (begin
                (set! tmp.83 (call L.*.19 1112 1104))
                (begin
                  (set! tmp.84 (call L.+.18 992 1528))
                  (set! tmp.82 (call L.-.17 tmp.83 tmp.84))))
              (set! tmp.78 (call L.*.19 tmp.79 tmp.82))))
          (set! fixnum5.1 (call L.+.18 tmp.71 tmp.78))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.+.16 tmp.78 tmp.79))))
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.-.15 tmp.81 tmp.82))))
              (set! tmp.76 (call L.*.17 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.-.15 tmp.69 tmp.76))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean2.4 (call L.error?.14 tmp.70)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.72 (call L.+.17 tmp.73 tmp.74))))
          (begin
            (begin
              (set! tmp.76 (call L.-.15 912 192))
              (begin
                (set! tmp.77 (call L.-.15 608 88))
                (set! tmp.75 (call L.*.16 tmp.76 tmp.77))))
            (set! tmp.71 (call L.*.16 tmp.72 tmp.75))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.79 (call L.+.17 tmp.80 tmp.81))))
            (begin
              (begin
                (set! tmp.83 (call L.+.17 208 504))
                (begin
                  (set! tmp.84 (call L.+.17 1128 720))
                  (set! tmp.82 (call L.*.16 tmp.83 tmp.84))))
              (set! tmp.78 (call L.+.17 tmp.79 tmp.82))))
          (set! fixnum5.1 (call L.-.15 tmp.71 tmp.78))))
      void4.2)))
(check-by-interp
 '(module
    (define L.error?.16
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean3.3 (call L.error?.16 tmp.57)))
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.+.15 tmp.81 tmp.82))))
              (set! tmp.76 (call L.-.16 tmp.77 tmp.80))))
          (set! fixnum3.3 (call L.+.15 tmp.69 tmp.76))))
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (begin
        (set! tmp.70 (call L.fun/any95243.8))
        (set! boolean1.5 (call L.pair?.12 tmp.70)))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.72 (call L.-.13 tmp.73 tmp.74))))
          (begin
            (begin
              (set! tmp.76 (call L.*.14 1720 376))
              (begin
                (set! tmp.77 (call L.*.14 912 256))
                (set! tmp.75 (call L.-.13 tmp.76 tmp.77))))
            (set! tmp.71 (call L.-.13 tmp.72 tmp.75))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.79 (call L.*.14 tmp.80 tmp.81))))
            (begin
              (begin
                (set! tmp.83 (call L.-.13 1240 528))
                (begin
                  (set! tmp.84 (call L.+.15 1200 728))
                  (set! tmp.82 (call L.+.15 tmp.83 tmp.84))))
              (set! tmp.78 (call L.*.14 tmp.79 tmp.82))))
          (set! fixnum3.3 (call L.*.14 tmp.71 tmp.78))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.86 (call L.*.14 tmp.87 tmp.88))))
          (begin
            (begin
              (set! tmp.90 (call L.*.14 696 72))
              (begin
                (set! tmp.91 (call L.*.14 1616 128))
                (set! tmp.89 (call L.*.14 tmp.90 tmp.91))))
            (set! tmp.85 (call L.+.15 tmp.86 tmp.89))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.93 (call L.*.14 tmp.94 tmp.95))))
            (begin
              (begin
                (set! tmp.97 (call L.+.15 1360 1136))
                (begin
                  (set! tmp.98 (call L.*.14 1096 728))
                  (set! tmp.96 (call L.*.14 tmp.97 tmp.98))))
              (set! tmp.92 (call L.-.13 tmp.93 tmp.96))))
          (set! fixnum5.1 (call L.-.13 tmp.85 tmp.92))))
      ascii-char2.4)))
(check-by-interp
 '(module
    (define L.*.17
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.73 (call L.-.15 tmp.74 tmp.75))))
            (set! tmp.69 (call L.+.16 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.*.17 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.16 tmp.77 tmp.80))))
          (set! fixnum1.5 (call L.+.16 tmp.69 tmp.76))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.*.15 tmp.71 tmp.72))))
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.+.16 tmp.81 tmp.82))))
              (set! tmp.76 (call L.-.17 tmp.77 tmp.80))))
          (set! fixnum4.2 (call L.-.17 tmp.69 tmp.76))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean2.4 (call L.vector?.16 tmp.70)))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.75 (call L.*.18 tmp.76 tmp.77))))
            (set! tmp.71 (call L.*.18 tmp.72 tmp.75))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.82 (call L.-.19 tmp.83 tmp.84))))
              (set! tmp.78 (call L.-.19 tmp.79 tmp.82))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.-.18 tmp.71 tmp.72))))
          (begin
            (begin
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.77 (call L.-.18 tmp.78 tmp.79))))
            (begin
              (begin
                (set! tmp.81 (call L.*.17 208 1344))
                (begin
                  (set! tmp.82 (call L.-.18 608 1296))
                  (set! tmp.80 (call L.+.19 tmp.81 tmp.82))))
              (set! tmp.76 (call L.*.17 tmp.77 tmp.80))))
          (set! fixnum4.2 (call L.*.17 tmp.69 tmp.76))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean3.3 (call L.boolean?.16 tmp.57)))
 ...
 '(module
    ...
    (begin
      (begin
        ...
        (set! boolean0.6 (call L.ascii-char?.16 tmp.57)))
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.*.14 tmp.81 tmp.82))))
              (set! tmp.76 (call L.*.14 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.-.13 tmp.69 tmp.76))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.87 (call L.*.14 tmp.88 tmp.89))))
            (set! tmp.83 (call L.+.15 tmp.84 tmp.87))))
        (begin
          (begin
            (begin
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.70 (call L.+.19 tmp.71 tmp.72))))
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.73 (call L.-.17 tmp.74 tmp.75))))
            (set! tmp.69 (call L.*.18 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.*.18 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.19 tmp.77 tmp.80))))
          (set! fixnum4.2 (call L.*.18 tmp.69 tmp.76))))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! boolean2.4 (call L.fixnum?.15 tmp.71)))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.76 (call L.-.17 tmp.77 tmp.78))))
            (set! tmp.72 (call L.+.18 tmp.73 tmp.76))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.83 (call L.-.17 tmp.84 tmp.85))))
              (set! tmp.79 (call L.+.18 tmp.80 tmp.83))))
          (set! fixnum4.2 (call L.+.18 tmp.72 tmp.79))))
      (begin
        (set! tmp.86 (call L.fun/any139288.8))
        (set! boolean5.1 (call L.boolean?.19 tmp.86)))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.73 (call L.*.9 tmp.74 tmp.75))))
            (set! tmp.69 (call L.-.11 tmp.70 tmp.73))))
        (begin
          (begin
            (begin
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.-.11 tmp.81 tmp.82))))
              (set! tmp.76 (call L.-.11 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.*.9 tmp.69 tmp.76))))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.84 (call L.+.10 tmp.85 tmp.86))))
          (begin
            (begin
              (set! tmp.88 (call L.-.11 2032 1680))
              (begin
                (set! tmp.89 (call L.*.9 1776 328))
                (set! tmp.87 (call L.+.10 tmp.88 tmp.89))))
            (set! tmp.83 (call L.*.9 tmp.84 tmp.87))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.91 (call L.-.11 tmp.92 tmp.93))))
            (begin
              (begin
                (set! tmp.95 (call L.-.11 120 488))
                (begin
                  (set! tmp.96 (call L.-.11 1032 280))
                  (set! tmp.94 (call L.-.11 tmp.95 tmp.96))))
              (set! tmp.90 (call L.+.10 tmp.91 tmp.94))))
          (set! fixnum1.5 (call L.+.10 tmp.83 tmp.90))))
      (begin
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.98 (call L.*.9 tmp.99 tmp.100))))
          (begin
            (begin
              (set! tmp.102 (call L.+.10 504 8))
              (begin
                (set! tmp.103 (call L.*.9 512 1544))
                (set! tmp.101 (call L.+.10 tmp.102 tmp.103))))
            (set! tmp.97 (call L.-.11 tmp.98 tmp.101))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.105 (call L.+.10 tmp.106 tmp.107))))
            (begin
              (begin
                (set! tmp.109 (call L.+.10 1000 1288))
                (begin
                  (set! tmp.110 (call L.+.10 1744 48))
                  (set! tmp.108 (call L.*.9 tmp.109 tmp.110))))
              (set! tmp.104 (call L.-.11 tmp.105 tmp.108))))
          (set! fixnum2.4 (call L.*.9 tmp.97 tmp.104))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.112 (call L.-.11 tmp.113 tmp.114))))
          (begin
            (begin
              (set! tmp.116 (call L.-.11 712 1632))
              (begin
                (set! tmp.117 (call L.*.9 216 552))
                (set! tmp.115 (call L.-.11 tmp.116 tmp.117))))
            (set! tmp.111 (call L.-.11 tmp.112 tmp.115))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.119 (call L.+.10 tmp.120 tmp.121))))
            (begin
              (begin
                (set! tmp.123 (call L.+.10 1128 1744))
                (begin
                  (set! tmp.124 (call L.*.9 944 480))
                  (set! tmp.122 (call L.-.11 tmp.123 tmp.124))))
              (set! tmp.118 (call L.-.11 tmp.119 tmp.122))))
          (set! fixnum4.2 (call L.-.11 tmp.111 tmp.118))))
            ...
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.80 (call L.*.14 tmp.81 tmp.82))))
              (set! tmp.76 (call L.+.13 tmp.77 tmp.80))))
          (set! fixnum0.6 (call L.*.14 tmp.69 tmp.76))))
      (begin
        (begin
          (begin
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.91 (call L.-.15 tmp.92 tmp.93))))
            (begin
              (begin
                ...
                (begin
                  ...
                  (set! tmp.94 (call L.-.15 tmp.95 tmp.96))))
              (set! tmp.90 (call L.+.13 tmp.91 tmp.94))))
          (set! fixnum1.5 (call L.*.14 tmp.83 tmp.90))))
        ...
        (begin
          (begin
            ...
            (begin
              ...
              (set! tmp.98 (call L.-.15 tmp.99 tmp.100))))
          (begin
            (begin
              (set! tmp.102 (call L.*.14 1152 848))
              (begin
                (set! tmp.103 (call L.*.14 448 1976))
                (set! tmp.101 (call L.+.13 tmp.102 tmp.103))))
            (set! tmp.97 (call L.-.15 tmp.98 tmp.101))))
        (begin
          (begin
            (begin
              ...
              (begin
                ...
                (set! tmp.105 (call L.-.15 tmp.106 tmp.107))))
            (begin
              (begin
                (set! tmp.109 (call L.*.14 1280 472))
                (begin
                  (set! tmp.110 (call L.+.13 472 752))
                  (set! tmp.108 (call L.-.15 tmp.109 tmp.110))))
              (set! tmp.104 (call L.+.13 tmp.105 tmp.108))))
          (set! fixnum5.1 (call L.+.13 tmp.97 tmp.104))))
