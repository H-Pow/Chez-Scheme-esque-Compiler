...
(define (check-para-asm-lang-v7 p)
  (if (para-asm-lang-v7? p) p #f))

(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-block-asm-lang-v7 (check-block-asm-lang-v7 p))
                (interp-para-asm-lang-v7 (check-para-asm-lang-v7 (flatten-program p)))))
