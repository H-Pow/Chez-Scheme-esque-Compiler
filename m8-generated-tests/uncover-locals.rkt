#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../uncover-locals.rkt")
(define (fail-if-invalid p)
  (when (not (asm-pred-lang-v8/locals? p))
    (error
     (~a
      (pretty-format p)
...
(define (check-by-interp p)
  (interp-asm-pred-lang-v8 p)
  (interp-asm-pred-lang-v8/locals (fail-if-invalid (uncover-locals p))))
