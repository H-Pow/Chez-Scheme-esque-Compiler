#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../assign-frame-variables.rkt")
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.51 (rax empty0.1 rbp))
       ...
       (rax (rbp tmp-ra.51))))
     (assignment ((tmp-ra.51 r15) (empty0.1 r14))))
    (begin
      (set! tmp-ra.51 r15)
      (set! empty0.1 22)
      (set! rax 30)
...
(check-by-interp
 '(module
    ((locals ())
     ...
     (assignment ((tmp-ra.50 r15) (tmp.51 r14))))
    (begin
      (set! tmp-ra.50 r15)
...
(check-by-interp
 '(module
    ((locals ())
     ...
     (assignment ((tmp-ra.59 fv0) (tmp.55 fv1) (tmp.56 r15) (tmp.63 r15))))
    (define L.+.6
      ((locals ())
       (conflicts
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.58 (rax oprand0.1 rbp rdi))
         ...
         (rax (rbp tmp-ra.58))))
       (assignment ((tmp-ra.58 r15) (oprand0.1 r14))))
      (begin
        (set! tmp-ra.58 r15)
        (set! oprand0.1 rdi)
        (set! rax 1928)
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.59 (rdi tmp.56 rax rbp))
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.59 fv0) (tmp.56 r15))))
    (define L.*.6
      ((locals ())
       (conflicts
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.52 (rax empty1.1 empty0.2 rbp))
       ...
       (rax (rbp tmp-ra.52))))
     (assignment ((tmp-ra.52 r15) (empty0.2 r14) (empty1.1 r14))))
    (begin
      (set! tmp-ra.52 r15)
      (set! empty0.2 22)
      (set! empty1.1 22)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.62 (rax oprand1.1 oprand0.2 rbp rsi rdi))
         ...
         (rax (rbp tmp-ra.62))))
       (assignment ((tmp-ra.62 r15) (oprand0.2 r14) (oprand1.1 r14))))
      (begin
        (set! tmp-ra.62 r15)
        (set! oprand0.2 rdi)
        (set! oprand1.1 rsi)
    ...
    ((locals ())
     (conflicts
      ((tmp.59 (rbp tmp-ra.63))
       ...
       (r15 (rbp rdi rsi))
       (rax (rbp tmp-ra.63))))
     (assignment ((tmp-ra.63 fv0) (tmp.59 r15))))
    (define L.*.7
      ((locals ())
       (conflicts
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.56 (ascii-char2.1 empty1.2 void0.3 rax rbp))
       ...
       (r15 (rbp))))
     (assignment
      ((tmp-ra.56 fv0) (void0.3 fv1) (empty1.2 r15) (ascii-char2.1 r15))))
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.62 (fixnum2.1 void1.2 boolean0.3 rax rbp))
       ...
       (rsi (r15 rdi rbp))))
     (assignment
      ((tmp-ra.62 fv0) (boolean0.3 r15) (void1.2 r15) (fixnum2.1 r15))))
    (define L.+.8
      ((locals ())
       (conflicts
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.59))
         ...
         (rdi (tmp-ra.59))))
       (assignment ((tmp-ra.59 r15) (tmp.57 r14) (tmp.46 r14) (tmp.66 r14))))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    ((locals ())
     (conflicts
      ((tmp-ra.61 (fixnum2.1 boolean1.2 empty0.3 rax rbp))
       ...
       (rsi (r15 rdi rbp))))
     (assignment
      ((tmp-ra.61 fv0) (empty0.3 r15) (boolean1.2 r15) (fixnum2.1 r15))))
    (define L.+.7
      ((locals ())
       (conflicts
        ((tmp.53 (rbp tmp-ra.58 tmp.20 tmp.19))
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.59))
         ...
         (rdi (tmp-ra.59))))
       (assignment ((tmp-ra.59 r15) (tmp.57 r14) (tmp.45 r14) (tmp.65 r14))))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.45 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.97 (rax oprand2.1 oprand1.2 oprand0.3 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.97))))
       (assignment
        ((tmp-ra.97 r15) (oprand0.3 r14) (oprand1.2 r14) (oprand2.1 r14))))
      (begin
        (set! tmp-ra.97 r15)
        (set! oprand0.3 rdi)
        (set! oprand1.2 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.98 (rax oprand2.4 oprand1.5 oprand0.6 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.98))))
       (assignment
        ((tmp-ra.98 r15) (oprand0.6 r14) (oprand1.5 r14) (oprand2.4 r13))))
      (begin
        (set! tmp-ra.98 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp-ra.99 (rax oprand2.7 oprand1.8 oprand0.9 rbp rdx rsi rdi))
         ...
         (rax (rbp tmp-ra.99))))
       (assignment
        ((tmp-ra.99 r15) (oprand0.9 r14) (oprand1.8 r14) (oprand2.7 r14))))
      (begin
        (set! tmp-ra.99 r15)
        (set! oprand0.9 rdi)
        (set! oprand1.8 rsi)
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.57))
         ...
         (rdi (tmp-ra.57))))
       (assignment ((tmp-ra.57 r15) (tmp.55 r14) (tmp.43 r14) (tmp.65 r14))))
      (begin
        (set! tmp-ra.57 r15)
        (set! tmp.43 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.68 (rbp tmp-ra.79))
         ...
         (rdi (tmp-ra.79))))
       (assignment ((tmp-ra.79 r15) (tmp.68 r14) (tmp.46 r14) (tmp.95 r14))))
      (begin
        (set! tmp-ra.79 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.74))
         ...
         (rdi (tmp-ra.74))))
       (assignment ((tmp-ra.74 r15) (tmp.55 r14) (tmp.49 r14) (tmp.83 r14))))
      (begin
        (set! tmp-ra.74 r15)
        (set! tmp.49 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.65 (rbp tmp-ra.77))
         ...
         (rdi (tmp-ra.77))))
       (assignment ((tmp-ra.77 r15) (tmp.65 r14) (tmp.44 r14) (tmp.91 r14))))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.74))
         ...
         (rdi (tmp-ra.74))))
       (assignment ((tmp-ra.74 r15) (tmp.55 r14) (tmp.43 r14) (tmp.84 r14))))
      (begin
        (set! tmp-ra.74 r15)
        (set! tmp.43 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.65 (rbp tmp-ra.77))
         ...
         (rdi (tmp-ra.77))))
       (assignment ((tmp-ra.77 r15) (tmp.65 r14) (tmp.42 r14) (tmp.92 r14))))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.42 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.59))
         ...
         (rdi (tmp-ra.59))))
       (assignment ((tmp-ra.59 r15) (tmp.55 r14) (tmp.46 r14) (tmp.67 r14))))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.60))
         ...
         (rdi (tmp-ra.60))))
       (assignment ((tmp-ra.60 r15) (tmp.56 r14) (tmp.45 r14) (tmp.68 r14))))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.45 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.55 (rbp tmp-ra.77))
         ...
         (rdi (tmp-ra.77))))
       (assignment ((tmp-ra.77 r15) (tmp.55 r14) (tmp.44 r14) (tmp.87 r14))))
      (begin
        (set! tmp-ra.77 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.68 (rbp tmp-ra.85))
         ...
         (rdi (tmp-ra.85))))
       (assignment ((tmp-ra.85 r15) (tmp.68 r14) (tmp.44 r14) (tmp.100 r14))))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.60))
         ...
         (rdi (tmp-ra.60))))
       (assignment ((tmp-ra.60 r15) (tmp.56 r14) (tmp.45 r14) (tmp.75 r14))))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.45 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.61))
         ...
         (rdi (tmp-ra.61))))
       (assignment ((tmp-ra.61 r15) (tmp.57 r14) (tmp.47 r14) (tmp.76 r14))))
      (begin
        (set! tmp-ra.61 r15)
        (set! tmp.47 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.85))
         ...
         (rdi (tmp-ra.85))))
       (assignment ((tmp-ra.85 r15) (tmp.56 r14) (tmp.45 r14) (tmp.99 r14))))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.45 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.87))
         ...
         (rdi (tmp-ra.87))))
       (assignment ((tmp-ra.87 r15) (tmp.56 r14) (tmp.46 r14) (tmp.101 r14))))
      (begin
        (set! tmp-ra.87 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.88))
         ...
         (rdi (tmp-ra.88))))
       (assignment ((tmp-ra.88 r15) (tmp.57 r14) (tmp.43 r14) (tmp.102 r14))))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.43 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.99))
         ...
         (rdi (tmp-ra.99))))
       (assignment ((tmp-ra.99 r15) (tmp.56 r14) (tmp.46 r14) (tmp.111 r14))))
      (begin
        (set! tmp-ra.99 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.69 (rbp tmp-ra.88))
         ...
         (rdi (tmp-ra.88))))
       (assignment ((tmp-ra.88 r15) (tmp.69 r14) (tmp.44 r14) (tmp.109 r14))))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.69 (rbp tmp-ra.90))
         ...
         (rdi (tmp-ra.90))))
       (assignment ((tmp-ra.90 r15) (tmp.69 r14) (tmp.44 r14) (tmp.111 r14))))
      (begin
        (set! tmp-ra.90 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.70 (rbp tmp-ra.91))
         ...
         (rdi (tmp-ra.91))))
       (assignment ((tmp-ra.91 r15) (tmp.70 r14) (tmp.46 r14) (tmp.112 r14))))
      (begin
        (set! tmp-ra.91 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.69 (rbp tmp-ra.88))
         ...
         (rdi (tmp-ra.88))))
       (assignment ((tmp-ra.88 r15) (tmp.69 r14) (tmp.45 r14) (tmp.111 r14))))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.45 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.85))
         ...
         (rdi (tmp-ra.85))))
       (assignment ((tmp-ra.85 r15) (tmp.56 r14) (tmp.50 r14) (tmp.99 r14))))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.50 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.58))
         ...
         (rdi (tmp-ra.58))))
       (assignment ((tmp-ra.58 r15) (tmp.56 r14) (tmp.43 r14) (tmp.71 r14))))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.43 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.58))
         ...
         (rdi (tmp-ra.58))))
       (assignment ((tmp-ra.58 r15) (tmp.56 r14) (tmp.49 r14) (tmp.73 r14))))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.49 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.105))
         ...
         (rdi (tmp-ra.105))))
       (assignment ((tmp-ra.105 r15) (tmp.56 r14) (tmp.48 r14) (tmp.117 r14))))
      (begin
        (set! tmp-ra.105 r15)
        (set! tmp.48 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.57 (rbp tmp-ra.106))
         ...
         (rdi (tmp-ra.106))))
       (assignment ((tmp-ra.106 r15) (tmp.57 r14) (tmp.44 r14) (tmp.118 r14))))
      (begin
        (set! tmp-ra.106 r15)
        (set! tmp.44 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.58 (rbp tmp-ra.107))
         ...
         (rdi (tmp-ra.107))))
       (assignment ((tmp-ra.107 r15) (tmp.58 r14) (tmp.46 r14) (tmp.119 r14))))
      (begin
        (set! tmp-ra.107 r15)
        (set! tmp.46 rdi)
        (if (begin
      ...
      ((locals ())
       (conflicts
        ((tmp.56 (rbp tmp-ra.58))
         ...
         (rdi (tmp-ra.58))))
       (assignment ((tmp-ra.58 r15) (tmp.56 r14) (tmp.50 r14) (tmp.73 r14))))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.50 rdi)
        (if (begin
