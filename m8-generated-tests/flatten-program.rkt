...
(check-by-interp
 '(module
    (define L.__main.10 (begin (set! r15 r15) (set! r14 14) (jump L.tmp.7)))
    (define L.cons.6
      (begin
        (set! r15 r15)
        (set! r14 rdi)
...
(check-by-interp
 '(module
    (define L.__main.16
      (begin (set! (rbp - 0) r15) (set! r15 6) (jump L.tmp.14)))
    (define L.empty?.8
      (begin
        (set! r15 r15)
        (set! r14 rdi)
    ...
    (define L.tmp.15
      (begin
        ...
        (jump L.empty?.8)))
    (define L.rp.9
      (begin (set! rbp (+ rbp 8)) (set! r15 rax) (set! r14 6) (jump L.tmp.11)))
...
(check-by-interp
 '(module
    ...
    (define L.__nested.6 (begin (set! r14 14) (jump L.__nested.7)))))
(check-by-interp
 '(module
    (define L.__main.14
      (begin
...
(check-by-interp
 '(module
    ...
    (define L.tmp.28 (begin (set! (rbp - 16) 58942) (jump L.tmp.27)))
    (define L.tmp.32 (begin (set! (rbp - 16) 19774) (jump L.tmp.27)))
    (define L.tmp.25 (begin (set! r15 14) (jump L.tmp.28)))
    (define L.tmp.26 (begin (set! r15 6) (jump L.tmp.32)))
    (define L.tmp.27
      (begin
        (set! rbp (- rbp 24))
        (set! rdx 320)
    ...
    (define L.tmp.20 (begin (set! r15 19246) (jump L.tmp.18)))
    (define L.tmp.22 (begin (set! r15 26414) (jump L.tmp.18)))
    (define L.tmp.16 (begin (set! r15 6) (jump L.tmp.20)))
    (define L.tmp.17 (begin (set! r15 14) (jump L.tmp.22)))
    (define L.tmp.18
      (begin
        (set! rdx r15)
        (set! rsi (rbp - 16))
