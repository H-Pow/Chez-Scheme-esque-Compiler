#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../optimize-predicates.rkt")
...
(check-by-interp
 '(module
    ...
    (begin
      (set! r15 r15)
      (if (begin (set! r14 14) (!= r14 6)) (set! r14 928) (set! r14 1456))
      (set! rdi r14)
      (set! r15 r15)
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fv0 r15)
      (if (begin (set! r15 14) (!= r15 6)) (set! fv1 592) (set! fv1 776))
      (begin
        (set! rbp (- rbp 16))
        (return-point L.rp.7
...
(check-by-interp
 '(module
    ...
    (begin
      ...
      (set! r15 30)
      (set! r15 56894)
      (if (begin (set! r14 6) (!= r14 6)) (set! r14 318) (set! r14 37182))
      (begin
        (set! rbp (- rbp 16))
        (return-point L.rp.6
          (begin
 ...
 '(module
    ...
    (begin
      ...
      (if (begin
        ...
        (begin (set! rsi 2008) (set! rdi 1712) (set! r15 fv0) (jump L.*.7))))))
(check-by-interp
 '(module
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fv0 r15)
      (if (begin (set! r15 14) (!= r15 6)) (set! r15 27710) (set! r15 36158))
      (set! r14 30)
      (set! r14 232)
      (set! r13 14)
      (set! r13 128)
      ...
      (begin
        ...
        (set! rbp (+ rbp 40)))
      (set! fv4 rax)
      (if (begin (set! r15 6) (!= r15 6)) (set! fv3 760) (set! fv3 424))
      (begin
        (set! rbp (- rbp 40))
        (return-point L.rp.12
          (begin
