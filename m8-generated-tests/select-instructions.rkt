...
(check-by-interp
 '(module
    ...
    (begin
      (set! tmp-ra.50 r15)
      (begin (set! rax 30) (jump tmp-ra.50 rbp rax)))))
(check-by-interp
 '(module
    ((new-frames ()))
    (define L.cons.5
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.47 rsi)
          (begin
            (begin (set! tmp.51 (alloc 16)) (set! tmp.50 (+ tmp.51 1)))
            (begin
              (mset! tmp.50 -1 tmp.46)
              (mset! tmp.50 7 tmp.47)
              (begin (set! rax tmp.50) (jump tmp-ra.52 rbp rax)))))))
    (begin
      (set! tmp-ra.53 r15)
      (begin
        (set! rsi 3816)
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (begin (set! rax 22) (jump tmp-ra.51 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames ()))
    (begin
      ...
      (begin
        (set! void0.1 30)
        (begin (set! rax 31790) (jump tmp-ra.51 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames ()))
    (define L.cons.5
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.48 rsi)
          (begin
            (begin (set! tmp.52 (alloc 16)) (set! tmp.51 (+ tmp.52 1)))
            (begin
              (mset! tmp.51 -1 tmp.47)
              (mset! tmp.51 7 tmp.48)
              (begin (set! rax tmp.51) (jump tmp-ra.53 rbp rax)))))))
    (begin
      (set! tmp-ra.54 r15)
      (begin
        (set! void0.1 30)
...
(check-by-interp
 '(module
    ...
    (define L.fun/fixnum8389.4
      ...
      (begin
        (set! tmp-ra.50 r15)
        (begin (begin (set! rax 1672) (jump tmp-ra.50 rbp rax)))))
    (begin
      (set! tmp-ra.51 r15)
      (begin (set! r15 tmp-ra.51) (jump L.fun/fixnum8389.4 rbp r15)))))
(check-by-interp
 '(module
    ((new-frames ()))
    (begin
 ...
 '(module
    ...
    (define L.fun/fixnum8394.4
      ...
      (begin
        ...
        (begin
          (set! oprand0.1 rdi)
          (begin (set! rax 312) (jump tmp-ra.52 rbp rax)))))
    (begin
      (set! tmp-ra.53 r15)
      (begin
        (if (!= 14 6) (set! tmp.51 15934) (set! tmp.51 45118))
        (begin
          (set! rdi tmp.51)
          (set! r15 tmp-ra.53)
 ...
 '(module
    ...
    (define L.fun/error8401.4
      ...
      (begin
        ...
        (begin
          (set! oprand0.1 rdi)
          (begin (set! rax 1854) (jump tmp-ra.53 rbp rax)))))
    ...
    (define L.cons.5
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.49 rsi)
          (begin
            (begin (set! tmp.53 (alloc 16)) (set! tmp.52 (+ tmp.53 1)))
            (begin
              (mset! tmp.52 -1 tmp.48)
              (mset! tmp.52 7 tmp.49)
              (begin (set! rax tmp.52) (jump tmp-ra.54 rbp rax)))))))
    (begin
      (set! tmp-ra.55 r15)
      (begin
        ...
        (begin
          (return-point L.rp.6
            (begin
              ...
              (jump L.cons.5 rbp r15 rdi rsi)))
          (set! pair1.1 rax))
        (begin (set! rax ascii-char0.2) (jump tmp-ra.55 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames ()))
    (define L.cons.6
        ...
        (begin
          ...
          (begin
            ...
            (begin
              (mset! tmp.51 -1 tmp.47)
              (mset! tmp.51 7 tmp.48)
              (begin (set! rax tmp.51) (jump tmp-ra.54 rbp rax)))))))
    ...
    (begin
      (set! tmp-ra.56 r15)
      (begin
        (if (!= 14 6) (set! tmp.53 17454) (set! tmp.53 17966))
        (begin
          (set! rdi tmp.53)
          (set! r15 tmp-ra.56)
 ...
 '(module
    ...
    (begin
      ...
      (begin
        (set! fixnum0.2 1712)
        (set! boolean1.1 14)
        (begin (set! rax 1864) (jump tmp-ra.52 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames ()))
    (begin
      ...
      (begin
        (set! error0.2 13118)
        (set! boolean1.1 14)
        (begin (set! rax boolean1.1) (jump tmp-ra.52 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() ())))
    (define L.cons.8
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.53 rsi)
          (begin
            (begin (set! tmp.57 (alloc 16)) (set! tmp.56 (+ tmp.57 1)))
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.60 rbp rax)))))))
    (define L.fun/error8419.4
      ...
      (begin
        ...
        (begin
          (set! oprand0.2 rdi)
          (set! oprand1.1 rsi)
          (begin (set! rax 47678) (jump tmp-ra.61 rbp rax)))))
    ...
    (define L.fun/error8420.6
      ...
      (begin
        ...
        (begin
          (set! oprand0.6 rdi)
          (set! oprand1.5 rsi)
          (begin (set! rax 39998) (jump tmp-ra.63 rbp rax)))))
    (begin
      (set! tmp-ra.64 r15)
      (if (begin
            (begin
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.57 (bitwise-and tmp.19 7)) (= tmp.57 0))
                    ...
                    (set! tmp.56 6))
                  (!= tmp.56 6))
              (begin (set! rax (+ tmp.19 tmp.20)) (jump tmp-ra.59 rbp rax))
    ...
    (define L.cons.8
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.50 rsi)
          (begin
            (begin (set! tmp.58 (alloc 16)) (set! tmp.53 (+ tmp.58 1)))
            (begin
              (mset! tmp.53 -1 tmp.49)
              (mset! tmp.53 7 tmp.50)
              (begin (set! rax tmp.53) (jump tmp-ra.60 rbp rax)))))))
    (define L.fun/ascii-char8439.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.61 r15)
        (begin (begin (set! rax 22318) (jump tmp-ra.61 rbp rax)))))
    (define L.fun/error8440.5
      ((new-frames ()))
      (begin
        (set! tmp-ra.62 r15)
        (begin (begin (set! rax 4670) (jump tmp-ra.62 rbp rax)))))
    ...
    (define L.cons.7
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.49 rsi)
          (begin
            (begin (set! tmp.54 (alloc 16)) (set! tmp.52 (+ tmp.54 1)))
            (begin
              (mset! tmp.52 -1 tmp.48)
              (mset! tmp.52 7 tmp.49)
              (begin (set! rax tmp.52) (jump tmp-ra.59 rbp rax)))))))
    ...
    (define L.fun/pair8458.5
      ...
      (begin
        ...
        (begin
          (set! oprand0.2 rdi)
          (set! oprand1.1 rsi)
          (begin (set! r15 tmp-ra.61) (jump L.fun/pair8459.4 rbp r15)))))
    (begin
      (set! tmp-ra.62 r15)
      (begin
        (begin
          (if (!= 6 6) (set! tmp.56 54078) (set! tmp.56 38718))
          (begin
            (return-point L.rp.9
              (begin
                (set! rdi tmp.56)
            ...
            (set! tmp.55 rax)))
        (begin
          (if (!= 6 6) (set! tmp.57 30) (set! tmp.57 30))
          (begin
            (set! rsi tmp.57)
            (set! rdi tmp.55)
            (set! r15 tmp-ra.62)
 ...
 '(module
    ...
    (define L.pair?.8
      ...
      (begin
        ...
        (begin
          (set! tmp.46 rdi)
          (if (begin (set! tmp.53 (bitwise-and tmp.46 7)) (= tmp.53 1))
    ...
    (define L.fun/ascii-char8463.4
      ...
      (begin
        (set! tmp-ra.55 r15)
        (begin (begin (set! rax 22574) (jump tmp-ra.55 rbp rax)))))
    (define L.fun/ascii-char8462.5
      ((new-frames ()))
      (begin
        (set! tmp-ra.56 r15)
        (begin (begin (set! rax 10286) (jump tmp-ra.56 rbp rax)))))
    (define L.fun/error8464.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.57 r15)
        (begin (begin (set! rax 5694) (jump tmp-ra.57 rbp rax)))))
    (begin
      (set! tmp-ra.58 r15)
      (begin
        (begin
        ...
        (begin
          ...
          (set! boolean2.1 rax))
        (begin (set! r15 tmp-ra.58) (jump L.fun/error8464.6 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames ()))
    (begin
      ...
      (if (begin
        ...
        (begin
          ...
          (set! boolean1.5 14)
          (set! error2.4 64318)
          (begin (set! rax fixnum0.6) (jump tmp-ra.56 rbp rax)))
        (if (!= 14 6)
    ...
    (define L.cons.9
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.51 rsi)
          (begin
            (begin (set! tmp.55 (alloc 16)) (set! tmp.54 (+ tmp.55 1)))
            (begin
              (mset! tmp.54 -1 tmp.50)
              (mset! tmp.54 7 tmp.51)
              (begin (set! rax tmp.54) (jump tmp-ra.56 rbp rax)))))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! empty3.1 rax))
        (begin (set! rax pair1.3) (jump tmp-ra.61 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () ())))
    (define L.+.12
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.62 (bitwise-and tmp.22 7)) (= tmp.62 0))
                    ...
                    (set! tmp.61 6))
                  (!= tmp.61 6))
              (begin (set! rax (- tmp.22 tmp.23)) (jump tmp-ra.72 rbp rax))
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.18 tmp.67)) (jump tmp-ra.73 rbp rax)))
    ...
    (define L.cons.9
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.51 rsi)
          (begin
            (begin (set! tmp.68 (alloc 16)) (set! tmp.54 (+ tmp.68 1)))
            (begin
              (mset! tmp.54 -1 tmp.50)
              (mset! tmp.54 7 tmp.51)
              (begin (set! rax tmp.54) (jump tmp-ra.74 rbp rax)))))))
    (define L.fun/error8501.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.75 r15)
        (begin (begin (set! rax 1342) (jump tmp-ra.75 rbp rax)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! void3.1 rax))
        (begin (set! r15 tmp-ra.79) (jump L.fun/error8501.4 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames (() () () () ())))
    (define L.pair?.10
      ...
      (begin
        ...
        (begin
          (set! tmp.59 rdi)
          (if (begin (set! tmp.67 (bitwise-and tmp.59 7)) (= tmp.67 1))
    ...
    (define L.cons.9
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.63 rsi)
          (begin
            (begin (set! tmp.68 (alloc 16)) (set! tmp.66 (+ tmp.68 1)))
            (begin
              (mset! tmp.66 -1 tmp.62)
              (mset! tmp.66 7 tmp.63)
              (begin (set! rax tmp.66) (jump tmp-ra.76 rbp rax)))))))
    (define L.fun/ascii-char8512.4
      ...
      (begin
        ...
        (begin
          ...
          (set! oprand1.2 rsi)
          (set! oprand2.1 rdx)
          (begin (set! rax 18734) (jump tmp-ra.77 rbp rax)))))
    (define L.fun/ascii-char8510.5
      ...
      (begin
        ...
        (begin
          ...
          (set! oprand1.5 rsi)
          (set! oprand2.4 rdx)
          (begin (set! rax oprand0.6) (jump tmp-ra.78 rbp rax)))))
    (define L.fun/ascii-char8511.6
      ...
      (begin
        ...
        (begin
          ...
          (set! oprand1.8 rsi)
          (set! oprand2.7 rdx)
          (begin (set! rax 12334) (jump tmp-ra.79 rbp rax)))))
    (define L.fun/boolean8513.7
      ...
      (begin
        ...
        (begin
          ...
          (set! oprand1.11 rsi)
          (set! oprand2.10 rdx)
          (begin (set! rax 6) (jump tmp-ra.80 rbp rax)))))
    (begin
      (set! tmp-ra.81 r15)
      (begin
        (if (begin
          ...
          (if (begin
                (begin
                  ...
                  (begin
                    ...
                    (set! tmp.71 rax)))
                (!= tmp.71 6))
            (if (!= 14 6) (set! tmp.70 58942) (set! tmp.70 23102))
            (if (!= 6 6) (set! tmp.70 54078) (set! tmp.70 19774)))
          (begin
            (if (begin
                  (begin
                    (return-point L.rp.15
                    ...
                    (set! tmp.74 rax))
                  (!= tmp.74 6))
              (if (!= 6 6) (set! tmp.73 18478) (set! tmp.73 19246))
              (if (!= 14 6) (set! tmp.73 26414) (set! tmp.73 18990)))
            (begin
              (set! rdx tmp.73)
              (set! rsi tmp.70)
              (set! rdi tmp.69)
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char8546.4
      ...
      (begin
        (set! tmp-ra.54 r15)
        (begin (begin (set! rax 29486) (jump tmp-ra.54 rbp rax)))))
    ...
    (define L.fun/error8544.6
      ...
      (begin
        (set! tmp-ra.56 r15)
        (begin (begin (set! rax 17982) (jump tmp-ra.56 rbp rax)))))
    (define L.fun/ascii-char8545.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.57 r15)
        (begin (begin (set! rax 12334) (jump tmp-ra.57 rbp rax)))))
    (begin
      (set! tmp-ra.58 r15)
      (begin
        (begin
        ...
        (begin
          ...
          (set! empty3.1 rax))
        (begin (set! rax ascii-char1.3) (jump tmp-ra.58 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () ())))
    (define L.void?.11
    ...
    (define L.cons.10
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.51 rsi)
          (begin
            (begin (set! tmp.56 (alloc 16)) (set! tmp.54 (+ tmp.56 1)))
            (begin
              (mset! tmp.54 -1 tmp.50)
              (mset! tmp.54 7 tmp.51)
              (begin (set! rax tmp.54) (jump tmp-ra.59 rbp rax)))))))
    ...
    (define L.fun/error8683.6
      ...
      (begin
        (set! tmp-ra.62 r15)
        (begin (begin (set! rax 21310) (jump tmp-ra.62 rbp rax)))))
    ...
    (define L.fun/error8682.8
      ...
      (begin
        (set! tmp-ra.64 r15)
        (begin (begin (set! rax 51774) (jump tmp-ra.64 rbp rax)))))
    (begin
      (set! tmp-ra.65 r15)
      (begin
        (begin
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.63 (bitwise-and tmp.23 7)) (= tmp.63 0))
                    ...
                    (set! tmp.62 6))
                  (!= tmp.62 6))
              (begin (set! rax (- tmp.23 tmp.24)) (jump tmp-ra.77 rbp rax))
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.19 tmp.68)) (jump tmp-ra.78 rbp rax)))
    ...
    (define L.cons.9
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.52 rsi)
          (begin
            (begin (set! tmp.69 (alloc 16)) (set! tmp.55 (+ tmp.69 1)))
            (begin
              (mset! tmp.55 -1 tmp.51)
              (mset! tmp.55 7 tmp.52)
              (begin (set! rax tmp.55) (jump tmp-ra.79 rbp rax)))))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! void4.1 rax))
        (begin (set! rax pair3.2) (jump tmp-ra.84 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () () () () () ())))
    (define L.*.12
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.19 tmp.60)) (jump tmp-ra.82 rbp rax)))
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.64 (bitwise-and tmp.23 7)) (= tmp.64 0))
                    ...
                    (set! tmp.63 6))
                  (!= tmp.63 6))
              (begin (set! rax (- tmp.23 tmp.24)) (jump tmp-ra.83 rbp rax))
        ...
        (begin
          ...
          (begin
            ...
            (begin
              (mset! tmp.55 -1 tmp.51)
              (mset! tmp.55 7 tmp.52)
              (begin (set! rax tmp.55) (jump tmp-ra.85 rbp rax)))))))
    ...
    (define L.fun/error8906.5
      ...
      (begin
        (set! tmp-ra.87 r15)
        (begin (begin (set! rax 18238) (jump tmp-ra.87 rbp rax)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! pair4.1 rax))
        (begin (set! r15 tmp-ra.90) (jump L.fun/void8909.7 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ())))
    (define L.*.12
        ...
        (begin
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                (set! tmp.60 (arithmetic-shift-right tmp.20 3))
                (begin (set! rax (* tmp.19 tmp.60)) (jump tmp-ra.76 rbp rax)))
    ...
    (define L.fun/ascii-char9175.5
      ...
      (begin
        (set! tmp-ra.81 r15)
        (begin (begin (set! rax 23598) (jump tmp-ra.81 rbp rax)))))
    ...
    (define L.fun/error9177.7
      ...
      (begin
        (set! tmp-ra.83 r15)
        (begin (begin (set! rax 17470) (jump tmp-ra.83 rbp rax)))))
    (begin
      (set! tmp-ra.84 r15)
      (begin
        (begin
            ...
            (begin
              (return-point L.rp.23
                (begin
                  ...
                  (jump L.*.12 rbp r15 rdi rsi)))
              (set! fixnum4.1 rax))))
        (begin (set! rax error3.2) (jump tmp-ra.84 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ())))
    (define L.*.11
    ...
    (define L.fun/error9704.4
      ...
      (begin
        (set! tmp-ra.77 r15)
        (begin (begin (set! rax 56382) (jump tmp-ra.77 rbp rax)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! empty4.1 rax))
        (begin (set! rax error3.2) (jump tmp-ra.81 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () () () () () () ())))
    (define L.*.11
    ...
    (define L.fun/error9708.5
      ...
      (begin
        (set! tmp-ra.87 r15)
        (begin (begin (set! rax 54846) (jump tmp-ra.87 rbp rax)))))
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char9977.8
      ...
      (begin
        (set! tmp-ra.84 r15)
        (begin (begin (set! rax 20782) (jump tmp-ra.84 rbp rax)))))
    (begin
      (set! tmp-ra.85 r15)
      (begin
        (begin
            ...
            (begin
              (return-point L.rp.24
                (begin
                  ...
                  (jump L.-.12 rbp r15 rdi rsi)))
              (set! fixnum4.1 rax))))
        (begin (set! r15 tmp-ra.85) (jump L.fun/ascii-char9977.8 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () ())))
    (define L.fun/void15785.4
      ...
      (begin
        (set! tmp-ra.56 r15)
        (begin (begin (set! r15 tmp-ra.56) (jump L.fun/void15786.9 rbp r15)))))
    ...
    (define L.fun/error15778.6
      ...
      (begin
        (set! tmp-ra.58 r15)
        (begin (begin (set! rax 4670) (jump tmp-ra.58 rbp rax)))))
    (define L.fun/ascii-char15782.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.59 r15)
        (begin (begin (set! rax 29742) (jump tmp-ra.59 rbp rax)))))
    (define L.fun/error15777.8
      ((new-frames ()))
      (begin
        (set! tmp-ra.60 r15)
        (begin
          (begin (set! r15 tmp-ra.60) (jump L.fun/error15778.6 rbp r15)))))
    ...
    (define L.fun/empty15775.12
      ...
      (begin
        (set! tmp-ra.64 r15)
        (begin
          (begin (set! r15 tmp-ra.64) (jump L.fun/empty15776.15 rbp r15)))))
    (define L.fun/empty15783.13
      ((new-frames ()))
      (begin
        (set! tmp-ra.65 r15)
        (begin
          (begin (set! r15 tmp-ra.65) (jump L.fun/empty15784.5 rbp r15)))))
    (define L.fun/ascii-char15780.14
      ((new-frames ()))
      (begin
        (set! tmp-ra.66 r15)
        (begin (begin (set! rax 21038) (jump tmp-ra.66 rbp rax)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! void5.1 rax))
        (begin (set! rax void5.1) (jump tmp-ra.68 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ())))
    (define L.void?.16
    ...
    (define L.fun/void18977.5
      ...
      (begin
        (set! tmp-ra.63 r15)
        (begin
          (begin (set! r15 tmp-ra.63) (jump L.fun/void18978.12 rbp r15)))))
    (define L.fun/ascii-char18970.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.64 r15)
        (begin (begin (set! rax 23854) (jump tmp-ra.64 rbp rax)))))
    ...
    (define L.fun/error18976.8
      ...
      (begin
        (set! tmp-ra.66 r15)
        (begin (begin (set! rax 39742) (jump tmp-ra.66 rbp rax)))))
    (define L.fun/void18971.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.67 r15)
        (begin
          (begin (set! r15 tmp-ra.67) (jump L.fun/void18972.10 rbp r15)))))
    ...
    (define L.fun/error18975.11
      ...
      (begin
        (set! tmp-ra.69 r15)
        (begin
          (begin (set! r15 tmp-ra.69) (jump L.fun/error18976.8 rbp r15)))))
    (define L.fun/void18978.12
      ((new-frames ()))
      (begin
        (set! tmp-ra.70 r15)
        (begin (begin (set! rax 30) (jump tmp-ra.70 rbp rax)))))
    (define L.fun/any18973.13
      ((new-frames ()))
      (begin
        (set! tmp-ra.71 r15)
        (begin (begin (set! rax 60990) (jump tmp-ra.71 rbp rax)))))
    (begin
      (set! tmp-ra.72 r15)
      (begin
        (begin
        ...
        (begin
          ...
          (set! void5.1 rax))
        (begin (set! rax ascii-char0.6) (jump tmp-ra.72 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () ())))
    (define L.cons.17
        ...
        (begin
          ...
          (begin
            ...
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.58 rbp rax)))))))
    (define L.fun/error19375.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.59 r15)
        (begin (begin (set! rax 5438) (jump tmp-ra.59 rbp rax)))))
    ...
    (define L.fun/error19373.6
      ...
      (begin
        (set! tmp-ra.61 r15)
        (begin (begin (set! rax 1086) (jump tmp-ra.61 rbp rax)))))
    ...
    (define L.fun/ascii-char19377.8
      ...
      (begin
        (set! tmp-ra.63 r15)
        (begin (begin (set! rax 28718) (jump tmp-ra.63 rbp rax)))))
    (define L.fun/pair19382.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.64 r15)
        (begin (begin (set! r15 tmp-ra.64) (jump L.fun/pair19383.7 rbp r15)))))
    ...
    (define L.fun/empty19378.11
      ...
      (begin
        (set! tmp-ra.66 r15)
        (begin
          (begin (set! r15 tmp-ra.66) (jump L.fun/empty19379.5 rbp r15)))))
    ...
    (define L.fun/empty19380.13
      ...
      (begin
        (set! tmp-ra.68 r15)
        (begin
          (begin (set! r15 tmp-ra.68) (jump L.fun/empty19381.12 rbp r15)))))
    (define L.fun/error19372.14
      ((new-frames ()))
      (begin
        (set! tmp-ra.69 r15)
        (begin
          (begin (set! r15 tmp-ra.69) (jump L.fun/error19373.6 rbp r15)))))
    (define L.fun/error19374.15
      ((new-frames ()))
      (begin
        (set! tmp-ra.70 r15)
        (begin
          (begin (set! r15 tmp-ra.70) (jump L.fun/error19375.4 rbp r15)))))
    (begin
      (set! tmp-ra.71 r15)
      (begin
        (begin
        ...
        (begin
          ...
          (set! pair5.1 rax))
        (begin (set! rax pair5.1) (jump tmp-ra.71 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames
      (()
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.20 tmp.65)) (jump tmp-ra.115 rbp rax)))
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.69 (bitwise-and tmp.22 7)) (= tmp.69 0))
                    ...
                    (set! tmp.68 6))
                  (!= tmp.68 6))
              (begin (set! rax (+ tmp.22 tmp.23)) (jump tmp-ra.116 rbp rax))
    ...
    (define L.fun/void20854.6
      ...
      (begin
        (set! tmp-ra.119 r15)
        (begin
          (begin (set! r15 tmp-ra.119) (jump L.fun/void20855.4 rbp r15)))))
    (define L.fun/any20856.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.120 r15)
        (begin (begin (set! rax 14) (jump tmp-ra.120 rbp rax)))))
    (define L.fun/ascii-char20851.8
      ((new-frames ()))
      (begin
        (set! tmp-ra.121 r15)
        (begin (begin (set! rax 29742) (jump tmp-ra.121 rbp rax)))))
    (define L.fun/ascii-char20853.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.122 r15)
        (begin (begin (set! rax 24366) (jump tmp-ra.122 rbp rax)))))
...
(check-by-interp
 '(module
        ...
        (begin
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                (set! tmp.65 (arithmetic-shift-right tmp.21 3))
                (begin (set! rax (* tmp.20 tmp.65)) (jump tmp-ra.86 rbp rax)))
    ...
    (define L.cons.15
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.53 rsi)
          (begin
            (begin (set! tmp.70 (alloc 16)) (set! tmp.56 (+ tmp.70 1)))
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.88 rbp rax)))))))
    (define L.fun/ascii-char22195.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.89 r15)
        (begin (begin (set! rax 31278) (jump tmp-ra.89 rbp rax)))))
    ...
    (define L.fun/pair22192.7
      ...
      (begin
        (set! tmp-ra.92 r15)
        (begin (begin (set! r15 tmp-ra.92) (jump L.fun/pair22193.6 rbp r15)))))
    ...
    (define L.fun/empty22198.9
      ...
      (begin
        (set! tmp-ra.94 r15)
        (begin
          (begin (set! r15 tmp-ra.94) (jump L.fun/empty22199.8 rbp r15)))))
    (define L.fun/empty22196.10
      ((new-frames ()))
      (begin
        (set! tmp-ra.95 r15)
        (begin
          (begin (set! r15 tmp-ra.95) (jump L.fun/empty22197.5 rbp r15)))))
    (define L.fun/error22191.11
      ((new-frames ()))
      (begin
        (set! tmp-ra.96 r15)
        (begin (begin (set! rax 19262) (jump tmp-ra.96 rbp rax)))))
    (define L.fun/error22190.12
      ((new-frames ()))
      (begin
        (set! tmp-ra.97 r15)
        (begin
          (begin (set! r15 tmp-ra.97) (jump L.fun/error22191.11 rbp r15)))))
            ...
            (begin
              (return-point L.rp.38
                (begin
                  ...
                  (jump L.+.16 rbp r15 rdi rsi)))
              (set! fixnum5.1 rax))))
        (begin (set! rax error0.6) (jump tmp-ra.99 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames
      (() () () () () () () () () () () () () () () () () () () () ())))
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.20 tmp.61)) (jump tmp-ra.87 rbp rax)))
    ...
    (define L.vector?.17
      ...
      (begin
        ...
        (begin
          (set! tmp.50 rdi)
          (if (begin (set! tmp.70 (bitwise-and tmp.50 7)) (= tmp.70 3))
    ...
    (define L.cons.16
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.53 rsi)
          (begin
            (begin (set! tmp.71 (alloc 16)) (set! tmp.56 (+ tmp.71 1)))
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.91 rbp rax)))))))
    (define L.fun/pair23550.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.92 r15)
        (begin (begin (set! r15 tmp-ra.92) (jump L.fun/pair23551.8 rbp r15)))))
    ...
    (define L.fun/void23541.6
      ...
      (begin
        (set! tmp-ra.94 r15)
        (begin
          (begin (set! r15 tmp-ra.94) (jump L.fun/void23542.14 rbp r15)))))
    (define L.fun/void23548.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.95 r15)
        (begin (begin (set! r15 tmp-ra.95) (jump L.fun/void23549.5 rbp r15)))))
    ...
    (define L.fun/error23546.9
      ...
      (begin
        (set! tmp-ra.97 r15)
        (begin
          (begin (set! r15 tmp-ra.97) (jump L.fun/error23547.11 rbp r15)))))
    (define L.fun/empty23544.10
      ((new-frames ()))
      (begin
        (set! tmp-ra.98 r15)
        (begin (begin (set! rax 22) (jump tmp-ra.98 rbp rax)))))
    (define L.fun/error23547.11
      ((new-frames ()))
      (begin
        (set! tmp-ra.99 r15)
        (begin (begin (set! rax 53822) (jump tmp-ra.99 rbp rax)))))
    (define L.fun/any23545.12
      ((new-frames ()))
      (begin
        (set! tmp-ra.100 r15)
        (begin (begin (set! rax 6) (jump tmp-ra.100 rbp rax)))))
    (define L.fun/empty23543.13
      ((new-frames ()))
      (begin
        (set! tmp-ra.101 r15)
        (begin
          (begin (set! r15 tmp-ra.101) (jump L.fun/empty23544.10 rbp r15)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! void5.1 rax))
        (begin (set! r15 tmp-ra.103) (jump L.fun/pair23550.4 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames (() () () () () ())))
    (define L.fun/error24539.4
      ...
      (begin
        (set! tmp-ra.56 r15)
        (begin (begin (set! rax 15934) (jump tmp-ra.56 rbp rax)))))
    (define L.fun/ascii-char24535.5
      ((new-frames ()))
      (begin
        (set! tmp-ra.57 r15)
        (begin (begin (set! rax 18734) (jump tmp-ra.57 rbp rax)))))
    (define L.fun/ascii-char24529.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.58 r15)
        (begin (begin (set! rax 24622) (jump tmp-ra.58 rbp rax)))))
    ...
    (define L.fun/error24531.9
      ...
      (begin
        (set! tmp-ra.61 r15)
        (begin (begin (set! rax 2622) (jump tmp-ra.61 rbp rax)))))
    (define L.fun/error24538.10
      ((new-frames ()))
      (begin
        (set! tmp-ra.62 r15)
        (begin
          (begin (set! r15 tmp-ra.62) (jump L.fun/error24539.4 rbp r15)))))
    (define L.fun/empty24536.11
      ((new-frames ()))
      (begin
        (set! tmp-ra.63 r15)
        (begin
          (begin (set! r15 tmp-ra.63) (jump L.fun/empty24537.7 rbp r15)))))
    (define L.fun/void24532.12
      ((new-frames ()))
      (begin
        (set! tmp-ra.64 r15)
        (begin
          (begin (set! r15 tmp-ra.64) (jump L.fun/void24533.14 rbp r15)))))
    (define L.fun/error24530.13
      ((new-frames ()))
      (begin
        (set! tmp-ra.65 r15)
        (begin
          (begin (set! r15 tmp-ra.65) (jump L.fun/error24531.9 rbp r15)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! error5.1 rax))
        (begin (set! rax empty4.2) (jump tmp-ra.68 rbp rax))))))
(check-by-interp
 '(module
    ((new-frames
      (()
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.59 (bitwise-and tmp.24 7)) (= tmp.59 0))
                    ...
                    (set! tmp.58 6))
                  (!= tmp.58 6))
              (begin (set! rax (- tmp.24 tmp.25)) (jump tmp-ra.103 rbp rax))
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.20 tmp.64)) (jump tmp-ra.104 rbp rax)))
    ...
    (define L.fun/error24789.5
      ...
      (begin
        (set! tmp-ra.107 r15)
        (begin
          (begin (set! r15 tmp-ra.107) (jump L.fun/error24790.10 rbp r15)))))
    (define L.fun/error24786.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.108 r15)
        (begin (begin (set! rax 34622) (jump tmp-ra.108 rbp rax)))))
    (define L.fun/error24785.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.109 r15)
        (begin
          (begin (set! r15 tmp-ra.109) (jump L.fun/error24786.6 rbp r15)))))
    (define L.fun/empty24792.8
      ((new-frames ()))
      (begin
        (set! tmp-ra.110 r15)
        (begin (begin (set! rax 22) (jump tmp-ra.110 rbp rax)))))
    (define L.fun/empty24787.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.111 r15)
        (begin
          (begin (set! r15 tmp-ra.111) (jump L.fun/empty24788.4 rbp r15)))))
    (define L.fun/error24790.10
      ((new-frames ()))
      (begin
        (set! tmp-ra.112 r15)
        (begin (begin (set! rax 11070) (jump tmp-ra.112 rbp rax)))))
    (define L.fun/empty24791.11
      ((new-frames ()))
      (begin
        (set! tmp-ra.113 r15)
        (begin
          (begin (set! r15 tmp-ra.113) (jump L.fun/empty24792.8 rbp r15)))))
    (begin
      (set! tmp-ra.114 r15)
      (begin
        (begin
...
(check-by-interp
 '(module
    ...
    (define L.cons.18
      ...
      (begin
        ...
        (begin
          ...
          (set! tmp.53 rsi)
          (begin
            (begin (set! tmp.58 (alloc 16)) (set! tmp.56 (+ tmp.58 1)))
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.61 rbp rax)))))))
    (define L.fun/pair24832.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.62 r15)
        (begin
          (begin (set! r15 tmp-ra.62) (jump L.fun/pair24833.15 rbp r15)))))
    (define L.fun/error24829.5
      ((new-frames ()))
      (begin
        (set! tmp-ra.63 r15)
        (begin (begin (set! rax 2110) (jump tmp-ra.63 rbp rax)))))
    (define L.fun/pair24835.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.64 r15)
        (begin (begin (set! r15 tmp-ra.64) (jump L.fun/pair24836.7 rbp r15)))))
    ...
    (define L.fun/any24834.8
      ...
      (begin
        (set! tmp-ra.66 r15)
        (begin (begin (set! rax 40766) (jump tmp-ra.66 rbp rax)))))
    ...
    (define L.fun/void24830.11
      ...
      (begin
        (set! tmp-ra.69 r15)
        (begin
          (begin (set! r15 tmp-ra.69) (jump L.fun/void24831.10 rbp r15)))))
    (define L.fun/ascii-char24840.12
      ((new-frames ()))
      (begin
        (set! tmp-ra.70 r15)
        (begin (begin (set! rax 26414) (jump tmp-ra.70 rbp rax)))))
    (define L.fun/empty24838.13
      ((new-frames ()))
      (begin
        (set! tmp-ra.71 r15)
        (begin (begin (set! rax 22) (jump tmp-ra.71 rbp rax)))))
    (define L.fun/empty24837.14
      ((new-frames ()))
      (begin
        (set! tmp-ra.72 r15)
        (begin
          (begin (set! r15 tmp-ra.72) (jump L.fun/empty24838.13 rbp r15)))))
    ...
    (define L.fun/error24828.16
      ...
      (begin
        (set! tmp-ra.74 r15)
        (begin
          (begin (set! r15 tmp-ra.74) (jump L.fun/error24829.5 rbp r15)))))
    (begin
      (set! tmp-ra.75 r15)
      (begin
        (begin
        ...
        (begin
          ...
          (set! empty5.1 rax))
        (begin (set! r15 tmp-ra.75) (jump L.fun/ascii-char24839.9 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames
      (()
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.20 tmp.69)) (jump tmp-ra.115 rbp rax)))
              (begin (set! rax 318) (jump tmp-ra.115 rbp rax)))
            (begin (set! rax 318) (jump tmp-ra.115 rbp rax))))))
    (define L.cons.13
      ((new-frames ()))
        ...
        (begin
          ...
          (begin
            ...
            (begin
              (mset! tmp.56 -1 tmp.52)
              (mset! tmp.56 7 tmp.53)
              (begin (set! rax tmp.56) (jump tmp-ra.116 rbp rax)))))))
    (define L.fun/empty27006.4
      ((new-frames ()))
      (begin
        (set! tmp-ra.117 r15)
        (begin
          (begin (set! r15 tmp-ra.117) (jump L.fun/empty27007.9 rbp r15)))))
    ...
    (define L.fun/void27004.6
      ...
      (begin
        (set! tmp-ra.119 r15)
        (begin
          (begin (set! r15 tmp-ra.119) (jump L.fun/void27005.11 rbp r15)))))
    (define L.fun/ascii-char27003.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.120 r15)
        (begin (begin (set! rax 29998) (jump tmp-ra.120 rbp rax)))))
    (define L.fun/pair27008.8
      ((new-frames ()))
      (begin
        (set! tmp-ra.121 r15)
        (begin
          (begin (set! r15 tmp-ra.121) (jump L.fun/pair27009.5 rbp r15)))))
    ...
    (define L.fun/void27005.11
      ...
      (begin
        (set! tmp-ra.124 r15)
        (begin (begin (set! rax 30) (jump tmp-ra.124 rbp rax)))))
    (begin
      (set! tmp-ra.125 r15)
      (begin
        (begin
            ...
            (begin
              (return-point L.rp.64
                (begin
                  ...
                  (jump L.+.16 rbp r15 rdi rsi)))
              (set! fixnum5.1 rax))))
        (begin (set! r15 tmp-ra.125) (jump L.fun/pair27008.8 rbp r15))))))
(check-by-interp
 '(module
    ((new-frames
      (()
          ...
          (if (begin
            ...
            (if (begin
              ...
              (begin
                ...
                (begin (set! rax (* tmp.20 tmp.60)) (jump tmp-ra.93 rbp rax)))
          ...
          (if (begin
            ...
            (if (begin
                  (if (begin (set! tmp.68 (bitwise-and tmp.24 7)) (= tmp.68 0))
                    ...
                    (set! tmp.67 6))
                  (!= tmp.67 6))
              (begin (set! rax (- tmp.24 tmp.25)) (jump tmp-ra.95 rbp rax))
    ...
    (define L.fun/empty27120.5
      ...
      (begin
        (set! tmp-ra.97 r15)
        (begin
          (begin (set! r15 tmp-ra.97) (jump L.fun/empty27121.11 rbp r15)))))
    (define L.fun/error27116.6
      ((new-frames ()))
      (begin
        (set! tmp-ra.98 r15)
        (begin
          (begin (set! r15 tmp-ra.98) (jump L.fun/error27117.7 rbp r15)))))
    (define L.fun/error27117.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.99 r15)
        (begin (begin (set! rax 34622) (jump tmp-ra.99 rbp rax)))))
    (define L.fun/ascii-char27115.8
      ((new-frames ()))
      (begin
        (set! tmp-ra.100 r15)
        (begin (begin (set! rax 23342) (jump tmp-ra.100 rbp rax)))))
    (define L.fun/ascii-char27123.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.101 r15)
        (begin (begin (set! rax 27694) (jump tmp-ra.101 rbp rax)))))
    ...
    (define L.fun/empty27118.12
      ...
      (begin
        (set! tmp-ra.104 r15)
        (begin
          (begin (set! r15 tmp-ra.104) (jump L.fun/empty27119.13 rbp r15)))))
 ...
 '(module
    ...
    (define L.pair?.19
      ...
      (begin
        ...
        (begin
          (set! tmp.49 rdi)
          (if (begin (set! tmp.57 (bitwise-and tmp.49 7)) (= tmp.57 1))
            (begin (set! rax 14) (jump tmp-ra.60 rbp rax))
            (begin (set! rax 6) (jump tmp-ra.60 rbp rax))))))
    (define L.cons.18
      ((new-frames ()))
    ...
    (define L.fun/pair27447.4
      ...
      (begin
        (set! tmp-ra.62 r15)
        (begin
          (begin (set! r15 tmp-ra.62) (jump L.fun/pair27448.11 rbp r15)))))
    ...
    (define L.fun/ascii-char27438.6
      ...
      (begin
        (set! tmp-ra.64 r15)
        (begin (begin (set! rax 18222) (jump tmp-ra.64 rbp rax)))))
    (define L.fun/error27440.7
      ((new-frames ()))
      (begin
        (set! tmp-ra.65 r15)
        (begin (begin (set! rax 33342) (jump tmp-ra.65 rbp rax)))))
    ...
    (define L.fun/void27441.9
      ...
      (begin
        (set! tmp-ra.67 r15)
        (begin
          (begin (set! r15 tmp-ra.67) (jump L.fun/void27442.12 rbp r15)))))
    (define L.fun/error27439.10
      ((new-frames ()))
      (begin
        (set! tmp-ra.68 r15)
        (begin
          (begin (set! r15 tmp-ra.68) (jump L.fun/error27440.7 rbp r15)))))
    ...
    (define L.fun/ascii-char27446.13
      ...
      (begin
        (set! tmp-ra.71 r15)
        (begin (begin (set! rax 29230) (jump tmp-ra.71 rbp rax)))))
    (define L.fun/ascii-char27444.14
      ((new-frames ()))
      (begin
        (set! tmp-ra.72 r15)
        (begin (begin (set! rax 25134) (jump tmp-ra.72 rbp rax)))))
    ...
    (begin
      ...
      (begin
        ...
        (begin
          ...
          (set! ascii-char5.1 rax))
        (begin (set! r15 tmp-ra.75) (jump L.fun/pair27447.4 rbp r15))))))
