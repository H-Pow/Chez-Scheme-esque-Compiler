...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-imp-mf-lang-v7 (check-imp-mf-lang-v7 p))
                (interp-proc-imp-cmf-lang-v7 (check-proc-imp-cmf-lang-v7 (normalize-bind p)))))
...
(check-by-interp '(module (define L.ascii-char?.2
                    ...
                    (begin
                      ...
                      (begin
                        (set! ball.5.4 (if (!= 14 6) 30 foo.4.3))
