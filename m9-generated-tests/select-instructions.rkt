 ...
 '(module
    ...
    (define L.fun/any8618.7.11
      ...
      (begin
        ...
        (begin
          (set! c.70 rdi)
          (begin (begin (set! rax 19758) (jump tmp-ra.87 rbp rax))))))
    (define L.fun/ascii-char8619.6.10
      ...
      (begin
        ...
        (begin
          (set! c.69 rdi)
          (begin (begin (set! rax 26414) (jump tmp-ra.88 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char9294.12.21
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 22062) (jump tmp-ra.155 rbp rax))))))
    ...
    (define L.fun/error9288.7.16
      ...
      (begin
        ...
        (begin
          (set! c.84 rdi)
          (begin (begin (set! rax 60990) (jump tmp-ra.160 rbp rax))))))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.121 6))
                    (!= tmp.121 6))
                (begin (set! rax (- tmp.37 tmp.38)) (jump tmp-ra.167 rbp rax))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.130 6))
                    (!= tmp.130 6))
                (begin (set! rax (+ tmp.35 tmp.36)) (jump tmp-ra.169 rbp rax))
 ...
 '(module
    ...
    (define L.fun/ascii-char9347.12.16
      ...
      (begin
        ...
        (begin
          (set! c.82 rdi)
          (begin (begin (set! rax 26414) (jump tmp-ra.113 rbp rax))))))
    (define L.fun/void9338.11.15
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.114 rbp rax))))))
    ...
    (define L.fun/ascii-char9341.9.13
      ...
      (begin
        ...
        (begin
          (set! c.79 rdi)
          (begin (begin (set! rax 22574) (jump tmp-ra.116 rbp rax))))))
    ...
    (define L.fun/any9339.5.9
      ...
      (begin
        ...
        (begin
          (set! c.75 rdi)
          (begin (begin (set! rax 8) (jump tmp-ra.120 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/any10243.13.21
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 14) (jump tmp-ra.140 rbp rax))))))
    (define L.fun/any10242.12.20
      ...
      (begin
        ...
        (begin
          (set! c.88 rdi)
          (begin (begin (set! rax 28222) (jump tmp-ra.141 rbp rax))))))
    ...
    (define L.fun/empty10249.10.18
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.143 rbp rax))))))
    (define L.fun/error10245.9.17
      ...
      (begin
        ...
        (begin
          (set! c.85 rdi)
          (begin (begin (set! rax 13630) (jump tmp-ra.144 rbp rax))))))
    ...
    (define L.fun/empty10247.4.12
      ...
      (begin
        ...
        (begin
          (set! c.80 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.149 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char10779.13.19
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 25390) (jump tmp-ra.133 rbp rax))))))
    ...
    (define L.fun/void10771.10.16
      ...
      (begin
        ...
        (begin
          (set! c.83 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.136 rbp rax))))))
    (define L.fun/void10773.9.15
      ...
      (begin
        ...
        (begin
          (set! c.82 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.137 rbp rax))))))
    ...
    (define L.fun/void10777.5.11
      ...
      (begin
        ...
        (begin
          (set! c.78 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.141 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char11013.14.20
      ...
      (begin
        ...
        (begin
          (set! c.91 rdi)
          (begin (begin (set! rax 27438) (jump tmp-ra.155 rbp rax))))))
    ...
    (define L.fun/error11009.10.16
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 62014) (jump tmp-ra.159 rbp rax))))))
    ...
    (define L.fun/void11011.8.14
      ...
      (begin
        ...
        (begin
          (set! c.85 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.161 rbp rax))))))
    (define L.fun/empty11017.7.13
      ...
      (begin
        ...
        (begin
          (set! c.84 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.162 rbp rax))))))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.112 6))
                    (!= tmp.112 6))
                (begin (set! rax (- tmp.40 tmp.41)) (jump tmp-ra.166 rbp rax))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.116 6))
                    (!= tmp.116 6))
                (begin (set! rax (+ tmp.38 tmp.39)) (jump tmp-ra.167 rbp rax))
 ...
 '(module
    ...
    (define L.fun/void11872.11.17
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.169 rbp rax))))))
    ...
    (define L.fun/ascii-char11874.9.15
      ...
      (begin
        ...
        (begin
          (set! c.84 rdi)
          (begin (begin (set! rax 29230) (jump tmp-ra.171 rbp rax))))))
    ...
    (define L.fun/error11880.7.13
      ...
      (begin
        ...
        (begin
          (set! c.82 rdi)
          (begin (begin (set! rax 43070) (jump tmp-ra.173 rbp rax))))))
    (define L.fun/ascii-char11876.6.12
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 27950) (jump tmp-ra.174 rbp rax))))))
    ...
    (define L.fun/error11878.4.10
      ...
      (begin
        ...
        (begin
          (set! c.79 rdi)
          (begin (begin (set! rax 16446) (jump tmp-ra.176 rbp rax))))))
    (define L.-.72.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.177 r15)
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.120 6))
                    (!= tmp.120 6))
                (begin (set! rax (- tmp.38 tmp.39)) (jump tmp-ra.177 rbp rax))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.129 6))
                    (!= tmp.129 6))
                (begin (set! rax (+ tmp.36 tmp.37)) (jump tmp-ra.179 rbp rax))
 ...
 '(module
    ...
    (define L.fun/ascii-char12705.14.19
      ...
      (begin
        ...
        (begin
          (set! c.90 rdi)
          (begin (begin (set! rax 23854) (jump tmp-ra.133 rbp rax))))))
    (define L.fun/empty12693.13.18
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.134 rbp rax))))))
    ...
    (define L.fun/error12697.10.15
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 24382) (jump tmp-ra.137 rbp rax))))))
    ...
    (define L.fun/ascii-char12699.5.10
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 23342) (jump tmp-ra.142 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char12711.14.20
      ...
      (begin
        ...
        (begin
          (set! c.91 rdi)
          (begin (begin (set! rax 29998) (jump tmp-ra.155 rbp rax))))))
    ...
    (define L.fun/ascii-char12719.11.17
      ...
      (begin
        ...
        (begin
          (set! c.88 rdi)
          (begin (begin (set! rax 23342) (jump tmp-ra.158 rbp rax))))))
    (define L.fun/error12709.10.16
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 17214) (jump tmp-ra.159 rbp rax))))))
    ...
    (define L.fun/error12717.8.14
      ...
      (begin
        ...
        (begin
          (set! c.85 rdi)
          (begin (begin (set! rax 33086) (jump tmp-ra.161 rbp rax))))))
    ...
    (define L.fun/ascii-char12713.6.12
      ...
      (begin
        ...
        (begin
          (set! c.83 rdi)
          (begin (begin (set! rax 17710) (jump tmp-ra.163 rbp rax))))))
    ...
    (define L.fun/ascii-char12715.4.10
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 26926) (jump tmp-ra.165 rbp rax))))))
    (define L.-.74.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.166 r15)
 ...
 '(module
    ...
    (define L.fun/error14513.13.19
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 4926) (jump tmp-ra.155 rbp rax))))))
    ...
    (define L.fun/error14509.11.17
      ...
      (begin
        ...
        (begin
          (set! c.85 rdi)
          (begin (begin (set! rax 48958) (jump tmp-ra.157 rbp rax))))))
    ...
    (define L.fun/error14515.7.13
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 55870) (jump tmp-ra.161 rbp rax))))))
    ...
    (define L.fun/ascii-char14511.4.10
      ...
      (begin
        ...
        (begin
          (set! c.78 rdi)
          (begin (begin (set! rax 17710) (jump tmp-ra.164 rbp rax))))))
    (define L.*.72.9
      ((new-frames ()))
      (begin
        (set! tmp-ra.165 r15)
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.108 6))
                    (!= tmp.108 6))
                (begin (set! rax (- tmp.38 tmp.39)) (jump tmp-ra.166 rbp rax))
                (begin (set! rax 830) (jump tmp-ra.166 rbp rax)))
              (begin (set! rax 830) (jump tmp-ra.166 rbp rax)))))))
    (define L.+.74.7
      ((new-frames ()))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.112 6))
                    (!= tmp.112 6))
                (begin (set! rax (+ tmp.36 tmp.37)) (jump tmp-ra.167 rbp rax))
                (begin (set! rax 574) (jump tmp-ra.167 rbp rax)))
              (begin (set! rax 574) (jump tmp-ra.167 rbp rax)))))))
    (begin
      (set! tmp-ra.168 r15)
 ...
 '(module
    ...
    (define L.fun/ascii-char14885.12.15
      ...
      (begin
        ...
        (begin
          (set! c.83 rdi)
          (begin (begin (set! rax 25134) (jump tmp-ra.123 rbp rax))))))
    ...
    (define L.fun/error14879.9.12
      ...
      (begin
        ...
        (begin
          (set! c.80 rdi)
          (begin (begin (set! rax 29246) (jump tmp-ra.126 rbp rax))))))
    (define L.fun/error14881.8.11
      ...
      (begin
        ...
        (begin
          (set! c.79 rdi)
          (begin (begin (set! rax 11326) (jump tmp-ra.127 rbp rax))))))
    ...
    (define L.fun/error14883.4.7
      ...
      (begin
        ...
        (begin
          (set! c.75 rdi)
          (begin (begin (set! rax 37438) (jump tmp-ra.131 rbp rax))))))
    (begin
      (set! tmp-ra.132 r15)
      (begin
        (begin
 ...
 '(module
    ...
    (define L.fun/empty15205.17.24
      ...
      (begin
        ...
        (begin
          (set! c.97 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.156 rbp rax))))))
    ...
    (define L.fun/error15201.15.22
      ...
      (begin
        ...
        (begin
          (set! c.95 rdi)
          (begin (begin (set! rax 52286) (jump tmp-ra.158 rbp rax))))))
    ...
    (define L.fun/ascii-char15203.9.16
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 29230) (jump tmp-ra.164 rbp rax))))))
    ...
    (define L.fun/empty15207.7.14
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.166 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/void17417.17.23
      ...
      (begin
        ...
        (begin
          (set! c.93 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.140 rbp rax))))))
    ...
    (define L.fun/error17411.15.21
      ...
      (begin
        ...
        (begin
          (set! c.91 rdi)
          (begin (begin (set! rax 10814) (jump tmp-ra.142 rbp rax))))))
    (define L.fun/error17407.14.20
      ...
      (begin
        ...
        (begin
          (set! c.90 rdi)
          (begin (begin (set! rax 54078) (jump tmp-ra.143 rbp rax))))))
    ...
    (define L.fun/error17413.11.17
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 13886) (jump tmp-ra.146 rbp rax))))))
    ...
    (define L.fun/ascii-char17415.6.12
      ...
      (begin
        ...
        (begin
          (set! c.82 rdi)
          (begin (begin (set! rax 25902) (jump tmp-ra.151 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char18592.14.23
      ...
      (begin
        ...
        (begin
          (set! c.95 rdi)
          (begin (begin (set! rax 26414) (jump tmp-ra.177 rbp rax))))))
    ...
    (define L.fun/error18586.11.20
      ...
      (begin
        ...
        (begin
          (set! c.92 rdi)
          (begin (begin (set! rax 7998) (jump tmp-ra.180 rbp rax))))))
    (define L.fun/empty18590.10.19
      ...
      (begin
        ...
        (begin
          (set! c.91 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.181 rbp rax))))))
    ...
    (define L.fun/error18588.6.15
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 28990) (jump tmp-ra.185 rbp rax))))))
    ...
    (define L.fun/empty18594.4.13
      ...
      (begin
        ...
        (begin
          (set! c.85 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.187 rbp rax))))))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.131 6))
                    (!= tmp.131 6))
                (begin (set! rax (- tmp.40 tmp.41)) (jump tmp-ra.191 rbp rax))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.135 6))
                    (!= tmp.135 6))
                (begin (set! rax (+ tmp.38 tmp.39)) (jump tmp-ra.192 rbp rax))
 ...
 '(module
    ...
    (define L.fun/ascii-char19112.14.23
      ...
      (begin
        ...
        (begin
          (set! c.95 rdi)
          (begin (begin (set! rax 28718) (jump tmp-ra.177 rbp rax))))))
    ...
    (define L.fun/error19114.12.21
      ...
      (begin
        ...
        (begin
          (set! c.93 rdi)
          (begin (begin (set! rax 2366) (jump tmp-ra.179 rbp rax))))))
    ...
    (define L.fun/ascii-char19110.9.18
      ...
      (begin
        ...
        (begin
          (set! c.90 rdi)
          (begin (begin (set! rax 23086) (jump tmp-ra.182 rbp rax))))))
    ...
    (define L.fun/void19116.6.15
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.185 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/ascii-char20275.14.18
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 23086) (jump tmp-ra.132 rbp rax))))))
    ...
    (define L.fun/error20277.12.16
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 28222) (jump tmp-ra.134 rbp rax))))))
    (define L.fun/empty20279.11.15
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.135 rbp rax))))))
    ...
    (define L.fun/empty20273.9.13
      ...
      (begin
        ...
        (begin
          (set! c.84 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.137 rbp rax))))))
    ...
    (define L.fun/any20283.6.10
      ...
      (begin
        ...
        (begin
          (set! c.81 rdi)
          (begin (begin (set! rax 41790) (jump tmp-ra.140 rbp rax))))))
 ...
 '(module
    ...
    (define L.fun/error21157.14.25
      ...
      (begin
        ...
        (begin
          (set! c.98 rdi)
          (begin (begin (set! rax 26430) (jump tmp-ra.184 rbp rax))))))
    ...
    (define L.fun/any21161.5.16
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 1488) (jump tmp-ra.193 rbp rax))))))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.144 6))
                    (!= tmp.144 6))
                (begin (set! rax (+ tmp.38 tmp.39)) (jump tmp-ra.201 rbp rax))
 ...
 '(module
    ...
    (define L.fun/ascii-char23226.14.23
      ...
      (begin
        ...
        (begin
          (set! c.96 rdi)
          (begin (begin (set! rax 22830) (jump tmp-ra.168 rbp rax))))))
    ...
    (define L.fun/void23224.7.16
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 30) (jump tmp-ra.175 rbp rax))))))
    ...
    (define L.fun/error23218.5.14
      ...
      (begin
        ...
        (begin
          (set! c.87 rdi)
          (begin (begin (set! rax 46654) (jump tmp-ra.177 rbp rax))))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (begin (set! rax tmp.98) (jump tmp-ra.179 rbp rax))))))))
    (define L.pair?.75.11
      ((new-frames ()))
      (begin
        (set! tmp-ra.180 r15)
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.122 6))
                    (!= tmp.122 6))
                (begin (set! rax (+ tmp.38 tmp.39)) (jump tmp-ra.182 rbp rax))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.131 6))
                    (!= tmp.131 6))
                (begin (set! rax (- tmp.40 tmp.41)) (jump tmp-ra.184 rbp rax))
 ...
 '(module
    ...
    (define L.fun/any24033.10.19
      ...
      (begin
        ...
        (begin
          (set! c.91 rdi)
          (begin (begin (set! rax 22574) (jump tmp-ra.181 rbp rax))))))
    ...
    (define L.fun/any24031.8.17
      ...
      (begin
        ...
        (begin
          (set! c.89 rdi)
          (begin (begin (set! rax 6) (jump tmp-ra.183 rbp rax))))))
    ...
    (define L.fun/empty24029.5.14
      ...
      (begin
        ...
        (begin
          (set! c.86 rdi)
          (begin (begin (set! rax 22) (jump tmp-ra.186 rbp rax))))))
          ...
          (begin
            (begin
              ...
              (begin
                ...
                (begin (set! rax tmp.96) (jump tmp-ra.188 rbp rax))))))))
            ...
            (if (begin
              ...
              (if (begin
                    (if (begin
                      ...
                      (set! tmp.119 6))
                    (!= tmp.119 6))
                (begin (set! rax (- tmp.38 tmp.39)) (jump tmp-ra.190 rbp rax))
