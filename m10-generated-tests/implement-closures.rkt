 ...
 '(module
    ...
    (cletrec
     ((error?.84 (make-closure L.error?.84.10 1))
      ...
      (make-vector.82 (make-closure L.make-vector.82.15 1 make-init-vector.4))
 ...
 '(module
    ...
    (cletrec
     ((fun/error8523.7 (make-closure L.fun/error8523.7.10 0))
      (fun/error8522.8 (make-closure L.fun/error8522.8.11 0 fun/error8523.7)))
                     ...
                     (if (call L.error?.69.10 error?.69 g42119030.12)
                       ...
                       (let ((g42119033.15 (if #t (error 147) (error 181))))
                         (if (call L.error?.69.10 error?.69 g42119033.15)
                           g42119033.15
                           (let ((g42119034.16
                                  (call L.fun/error8557.7.11 fun/error8557.7)))
                ...
                (let ((tmp.8.29
                  ...
                  (if tmp.8.29
                    ...
                    (let ((tmp.9.31
                           (let ((procedure0.32
                                  (cletrec
                                   ((lam.108 (make-closure L.lam.108.15 0)))
                                   lam.108)))
                             #\Z)))
                      (if tmp.9.31
                        tmp.9.31
                                        ...
                                        (if tmp.14.42
                                          ...
                                          (let ((tmp.15.43 empty))
                                            (if tmp.15.43
                                              tmp.15.43
                                              empty))))))))
                             (if (call L.error?.114.16 error?.114 g42195368.40)
                               g42195368.40
                               (let ((g42195369.44
                                      (let ((pair0.46
                                             (call
...
(check-by-interp
 '(module
    (define L.lam.83.14
      (lambda (c.88)
        (let ((cons.82 (closure-ref c.88 0)))
          (call
           L.cons.82.10
           cons.82
           98
           ...
           (if (call L.error?.68.10 error?.68 g42225919.14)
             ...
             (let ((g42225920.15
               ...
               (if (call L.error?.68.10 error?.68 g42225920.15)
                 g42225920.15
                 (call L.fun/ascii-char8662.7.11 fun/ascii-char8662.7))))))))))
(check-by-interp
 '(module
    (if (if #f #t #t)
 ...
 '(module
    ...
    (cletrec
     ((error?.79 (make-closure L.error?.79.10 1))
      ...
      (make-vector.77 (make-closure L.make-vector.77.15 1 make-init-vector.4))
     ...
     (if (call
       ...
       (let ((procedure0.12
              (cletrec ((lam.81 (make-closure L.lam.81.20 0 cons.76))) lam.81))
             (error1.11 (error 137))
             (error2.10 (error 179)))
         #f)
       (let ((vector0.13
              (let ((tmp.7.14 (call L.make-vector.77.15 make-vector.77 8)))
                (let ((g42237367.15
                       (call L.vector-set!.78.12 vector-set!.78 tmp.7.14 0 0)))
                          ...
                          (if (call L.error?.79.10 error?.79 g42237369.17)
                            ...
                            (let ((g42237370.18
                                   (call
                                    ...
                                    3
                                    3)))
                              (if (call L.error?.79.10 error?.79 g42237370.18)
                                g42237370.18
                                (let ((g42237371.19
                                       (call
                                        L.vector-set!.78.12
 ...
 '(module
    ...
    (cletrec
     ((cons.75 (make-closure L.cons.75.10 2))
      ...
      (make-vector.71 (make-closure L.make-vector.71.17 1 make-init-vector.4)))
     (if (call
          L.fixnum?.74.11
          fixnum?.74
          (if #t
 ...
 '(module
    ...
    (cletrec
     ((fun/empty8484.7 (make-closure L.fun/empty8484.7.10 0))
      (fun/empty8483.8 (make-closure L.fun/empty8483.8.11 0 fun/empty8484.7)))
     ...
     (call
                        ...
                        (if (call L.error?.111.10 error?.111 g42252655.42)
                          ...
                          (let ((g42252656.46
                                 (let ((boolean0.49 #f)
                                       ...
                                       (fixnum2.47 165))
                                   #\k)))
                            (if (call L.error?.111.10 error?.111 g42252656.46)
                              g42252656.46
                              (let ((g42252657.50
                                     (call
      ...
      (call
       ...
       (let ((empty0.55 empty) (ascii-char1.54 #\d))
         (cletrec ((lam.112 (make-closure L.lam.112.27 0))) lam.112)))))))
(check-by-interp
 '(module
 ...
 '(module
    ...
    (cletrec
     ((error?.69 (make-closure L.error?.69.10 1))
      ...
      (fun/error8482.9 (make-closure L.fun/error8482.9.14 1 fun/error8483.7)))
     (call
 ...
 '(module
    ...
    (cletrec
     ((cons.90 (make-closure L.cons.90.10 2))
      ...
      (make-vector.87 (make-closure L.make-vector.87.16 1 make-init-vector.4))
...
(check-by-interp
 '(module
    ...
    (define L.lam.146.29
      (lambda (c.167)
        (let ((vector-set!.140 (closure-ref c.167 0))
              (error?.142 (closure-ref c.167 1))
              (make-vector.141 (closure-ref c.167 2)))
    ...
    (define L.lam.144.27
      (lambda (c.165)
        (let ((vector-set!.140 (closure-ref c.165 0))
              (error?.142 (closure-ref c.165 1))
              (make-vector.141 (closure-ref c.165 2)))
                 ...
                 (if (call L.error?.142.10 error?.142 g42328634.82)
                   ...
                   (let ((g42328635.83
                          (let ((g42328636.84
                            ...
                            (if (call L.error?.142.10 error?.142 g42328636.84)
                              g42328636.84
                              (call
                               L.cons.139.16
                               cons.139
                                  ...
                                  (if #t
                                    ...
                                    (call
                                     ...
                                     (call
                                      ...
                                      310
                                      empty)))))
                             (if (call L.error?.142.10 error?.142 g42328638.86)
                               g42328638.86
                               (call
 ...
 '(module
    ...
    (cletrec
     ((error?.95 (make-closure L.error?.95.10 1))
      ...
      (make-vector.93 (make-closure L.make-vector.93.15 1 make-init-vector.4))
      (<.92 (make-closure L.<.92.16 2))
      (cons.91 (make-closure L.cons.91.17 2))
      (fun/empty8510.8 (make-closure L.fun/empty8510.8.18 2))
      (fun/empty8513.9 (make-closure L.fun/empty8513.9.19 1 fun/empty8514.10))
                           ...
                           (if (call L.error?.95.10 error?.95 g42336239.31)
                             ...
                             (let ((g42336240.32
                                    (call
                                     ...
                                     3
                                     4)))
                               (if (call L.error?.95.10 error?.95 g42336240.32)
                                 g42336240.32
                                 (let ((g42336241.33
                                        (call
                                         L.vector-set!.94.12
     ...
     (if (call
       ...
       (let ((vector0.12
              (let ((tmp.7.13 (call L.make-vector.74.15 make-vector.74 8)))
                (let ((g42343841.14
                       (call L.vector-set!.75.12 vector-set!.75 tmp.7.13 0 1)))
                          ...
                          (if (call L.error?.76.10 error?.76 g42343843.16)
                            ...
                            (let ((g42343844.17
                                   (call
                                    ...
                                    3
                                    4)))
                              (if (call L.error?.76.10 error?.76 g42343844.17)
                                g42343844.17
                                (let ((g42343845.18
                                       (call
                                        L.vector-set!.75.12
 ...
 '(module
    ...
    (cletrec
     ((*.80 (make-closure L.*.80.10 2))
      ...
      (make-vector.76 (make-closure L.make-vector.76.17 1 make-init-vector.4))
          ...
          (let ((tmp.7.13 (call L.make-vector.76.17 make-vector.76 8)))
            (let ((g42347666.14
              ...
              (if (call L.error?.78.12 error?.78 g42347666.14)
                g42347666.14
                (let ((g42347667.15
                       (call L.vector-set!.77.14 vector-set!.77 tmp.7.13 1 2)))
                          ...
                          (if (call L.error?.78.12 error?.78 g42347669.17)
                            ...
                            (let ((g42347670.18
                                   (call
                                    ...
                                    4
                                    5)))
                              (if (call L.error?.78.12 error?.78 g42347670.18)
                                g42347670.18
                                (let ((g42347671.19
                                       (call
                                        L.vector-set!.77.14
                                      ...
                                      (if (call
                                        ...
                                        (let ((g42347673.21
                                          ...
                                          (if (call
                                            ...
                                            tmp.7.13))))))))))))))))))
        (if #f
          (call L.cons.79.11 cons.79 25 (call L.cons.79.11 cons.79 278 empty))
          (call
           L.cons.79.11
           cons.79
           168
          ...
          (let ((tmp.7.17 (call L.make-vector.87.15 make-vector.87 8)))
            (let ((g42366676.18
              ...
              (if (call L.error?.89.10 error?.89 g42366676.18)
                g42366676.18
                (let ((g42366677.19
                       (call L.vector-set!.88.12 vector-set!.88 tmp.7.17 1 2)))
                          ...
                          (if (call L.error?.89.10 error?.89 g42366679.21)
                            ...
                            (let ((g42366680.22
                                   (call
                                    ...
                                    4
                                    5)))
                              (if (call L.error?.89.10 error?.89 g42366680.22)
                                g42366680.22
                                (let ((g42366681.23
                                       (call
                                        L.vector-set!.88.12
          ...
          (let ((tmp.8.26 (call L.make-vector.87.15 make-vector.87 8)))
            (let ((g42366684.27
              ...
              (if (call L.error?.89.10 error?.89 g42366684.27)
                g42366684.27
                (let ((g42366685.28
                       (call L.vector-set!.88.12 vector-set!.88 tmp.8.26 1 2)))
                          ...
                          (if (call L.error?.89.10 error?.89 g42366687.30)
                            ...
                            (let ((g42366688.31
                                   (call
                                    ...
                                    4
                                    5)))
                              (if (call L.error?.89.10 error?.89 g42366688.31)
                                g42366688.31
                                (let ((g42366689.32
                                       (call
                                        L.vector-set!.88.12
                       ...
                       (if (call L.error?.218.16 error?.218 g42374307.90)
                         ...
                         (let ((g42374313.104
                                (let ((vector0.107
                                  ...
                                  empty)))
                           (if (call L.error?.218.16 error?.218 g42374313.104)
                             g42374313.104
                             (let ((g42374322.117
                                    (let ((g42374323.118
                            ...
                            (if (call L.error?.73.10 error?.73 g42378167.18)
                              ...
                              (let ((g42378168.19
                                     (call
                                      ...
                                      cons.72
                                      220
                                      (call L.cons.72.11 cons.72 290 empty))))
                                (if (call
                                     L.error?.73.10
                                     error?.73
                                     g42378168.19)
...
(check-by-interp
 '(module
    (define L.fun/procedure8559.13.18
      (lambda (c.104)
        (let () (cletrec ((lam.95 (make-closure L.lam.95.19 0))) lam.95))))
    ...
    (cletrec
     ((error?.86 (make-closure L.error?.86.10 1))
      ...
      (make-vector.84 (make-closure L.make-vector.84.15 1 make-init-vector.4))
 ...
 '(module
    ...
    (cletrec
     ((ascii-char?.102 (make-closure L.ascii-char?.102.10 1))
      ...
      (make-vector.99 (make-closure L.make-vector.99.16 1 make-init-vector.4))
                      ...
                      (let ((g42409235.31 (error 134)))
                        (if (call L.error?.101.11 error?.101 g42409235.31)
                          ...
                          (let ((g42409236.32 (error 216)))
                            (if (call L.error?.101.11 error?.101 g42409236.32)
                              g42409236.32
                              (error 132)))))))))
             (if tmp.9.29
               tmp.9.29
                 ...
                 (if tmp.10.33
                   ...
                   (let ((tmp.11.34
                          (call
                           ...
                           (void)
                           (let ((tmp.12.35
                                  (call L.make-vector.99.16 make-vector.99 8)))
                             (let ((g42409237.36
                                    (call
                                     L.vector-set!.100.13
                                     vector-set!.100
                       ...
                       (let ((tmp.13.44 (let ((fixnum0.45 172)) (error 184))))
                         (if tmp.13.44
                           ...
                           (let ((g42409245.46 (error 89)))
                             (if (call L.error?.101.11 error?.101 g42409245.46)
                               g42409245.46
                               (error 219)))))))))))))))))
(check-by-interp
 '(module
 ...
 '(module
    ...
    (cletrec
     ...
     (if (call
          ...
          (if #t (void) (void))
          (let ((tmp.7.19
                 (cletrec ((lam.77 (make-closure L.lam.77.13 0))) lam.77)))
            (if tmp.7.19
              tmp.7.19
              (let ((tmp.8.20
                     (cletrec ((lam.78 (make-closure L.lam.78.14 0))) lam.78)))
                (if tmp.8.20
                  tmp.8.20
                  (let ((tmp.9.21
                         (cletrec
                        ...
                        (if tmp.10.22
                          ...
                          (let ((tmp.11.23
                            ...
                            (if tmp.11.23
                              ...
                              (let ((tmp.12.24
                                     (cletrec
                                      ((lam.82 (make-closure L.lam.82.18 0)))
                                      lam.82)))
                                (if tmp.12.24
                                  tmp.12.24
                                  (cletrec
 ...
 '(module
    ...
    (cletrec
     ((empty?.77 (make-closure L.empty?.77.10 1))
      ...
      (make-vector.74 (make-closure L.make-vector.74.16 1 make-init-vector.4))
...
(check-by-interp
 '(module
    ...
    (define L.fun/procedure8497.10.13
      (lambda (c.70)
        (let () (cletrec ((lam.66 (make-closure L.lam.66.15 0))) lam.66))))
                           ...
                           (if (call L.error?.86.10 error?.86 g42439798.21)
                             ...
                             (let ((g42439799.22
                                    (call
                                     ...
                                     4
                                     4)))
                               (if (call L.error?.86.10 error?.86 g42439799.22)
                                 g42439799.22
                                 (let ((g42439800.23
                                        (call
                                         L.vector-set!.85.12
 ...
 '(module
    ...
    (cletrec
     ((<=.63 (make-closure L.<=.63.10 2))
      ...
      (fun/empty8514.8 (make-closure L.fun/empty8514.8.12 0 fun/empty8515.7)))
     (let ((boolean0.9
            (call L.<=.63.10 <=.63 (let () 15) (let ((void0.10 (void))) 193))))
       (call L.fun/empty8514.8.12 fun/empty8514.8)))))
(check-by-interp
 '(module
    (define L.lam.106.24
      (lambda (c.121)
        (let ((vector-set!.103 (closure-ref c.121 0))
              (error?.104 (closure-ref c.121 1))
              (make-vector.102 (closure-ref c.121 2)))
 ...
 '(module
    ...
    (cletrec
     ((cons.71 (make-closure L.cons.71.10 2))
      ...
      (fun/ascii-char8528.8 (make-closure L.fun/ascii-char8528.8.12 0 cons.71))
      ...
      (fun/void8529.12 (make-closure L.fun/void8529.12.16 0 fun/void8530.10)))
     (call
     ...
     (let ((g42455084.37
            (call
             ...
             (if #f
               ...
               (cletrec ((lam.144 (make-closure L.lam.144.34 0))) lam.144))
             (let () empty))))
                    ...
                    (if (call L.error?.132.17 error?.132 g42455086.43)
                      ...
                      (let ((g42455087.44 #\`))
                        (if (call L.error?.132.17 error?.132 g42455087.44)
                          g42455087.44
                          (let ((g42455088.45 #\a))
                            (if (call L.error?.132.17 error?.132 g42455088.45)
                              g42455088.45
                              (let ((g42455089.46 #\O))
                                (if (call
                                     L.error?.132.17
 ...
 '(module
    ...
    (cletrec
     ((error?.91 (make-closure L.error?.91.10 1))
      ...
      (make-vector.89 (make-closure L.make-vector.89.15 1 make-init-vector.4))
         ...
         (let ((tmp.7.19 (call L.make-vector.89.15 make-vector.89 8)))
           (let ((g42462740.20
             ...
             (if (call L.error?.91.10 error?.91 g42462740.20)
               g42462740.20
               (let ((g42462741.21
                      (call L.vector-set!.90.12 vector-set!.90 tmp.7.19 1 2)))
                           ...
                           (if (call L.error?.91.10 error?.91 g42462751.32)
                             ...
                             (let ((g42462752.33
                                    (call
                                     ...
                                     4
                                     5)))
                               (if (call L.error?.91.10 error?.91 g42462752.33)
                                 g42462752.33
                                 (let ((g42462753.34
                                        (call
                                         L.vector-set!.90.12
                              ...
                              (call
                               ...
                               (let ((tmp.117 (void)))
                                 (if (procedure? tmp.117)
                                   (if (eq? (unsafe-procedure-arity tmp.117) 0)
                                   ...
                                   (let ((tmp.118
                                     ...
                                     (if (procedure? tmp.118)
                                       (if (eq?
                                         ...
                                         (error 42))
                                       (error 43))))))
                             (if (call L.error?.114.10 error?.114 g42474207.26)
                               g42474207.26
                               (let ((g42474208.27
                                      (call
                                       L.vector-set!.113.12
                              ...
                              (call
                               ...
                               (let ((tmp.124
                                 ...
                                 (if (procedure? tmp.124)
                                   (if (eq? (unsafe-procedure-arity tmp.124) 0)
                                   ...
                                   (let ((tmp.125
                                     ...
                                     (if (procedure? tmp.125)
                                       (if (eq?
                                         ...
                                         (error 42))
                                       (error 43))))))
                             (if (call L.error?.114.10 error?.114 g42474223.44)
                               g42474223.44
                               (let ((g42474232.54
                                      (call
                                       L.vector-set!.113.12
 ...
 '(module
    ...
    (cletrec
     ((error?.81 (make-closure L.error?.81.10 1))
      ...
      (make-vector.79 (make-closure L.make-vector.79.15 1 make-init-vector.4))
      (cons.78 (make-closure L.cons.78.16 2))
      (fun/empty8599.8
       (make-closure L.fun/empty8599.8.17 1 fun/empty8601.10 fun/empty8600.9))
                           ...
                           (if (call L.error?.81.10 error?.81 g42478055.20)
                             ...
                             (let ((g42478056.21
                                    (call
                                     ...
                                     3
                                     4)))
                               (if (call L.error?.81.10 error?.81 g42478056.21)
                                 g42478056.21
                                 (let ((g42478057.22
                                        (call
                                         L.vector-set!.80.12
         ...
         (let ((tmp.8.22
                (call
                 ...
                 (call
                  L.fun/any8616.15.17
                  fun/any8616.15
                  (cletrec ((lam.78 (make-closure L.lam.78.18 0))) lam.78)))))
           (if tmp.8.22
             tmp.8.22
             (let ((tmp.9.23
                    (call
 ...
 '(module
    ...
    (cletrec
     ...
     (call
      L.>.117.10
      >.117
      (let ((g42516139.26 (call L.fun/fixnum8646.17.20 fun/fixnum8646.17 #\q)))
                      ...
                      (let ((g42519973.31 (void)))
                        (if (call L.error?.140.15 error?.140 g42519973.31)
                          ...
                          (let ((g42519974.32 (void)))
                            (if (call L.error?.140.15 error?.140 g42519974.32)
                              g42519974.32
                            ...
                            (let ((void0.71
                              ...
                              (let ((pair0.73
                                     (call
                                      ...
                                      cons.139
                                      100
                                      (call L.cons.139.16 cons.139 256 empty)))
                                    (pair1.72
                                     (call
                                      L.cons.139.16
                                      cons.139
 ...
 '(module
    ...
    (cletrec
     ((cons.74 (make-closure L.cons.74.10 2))
      ...
      (make-vector.72 (make-closure L.make-vector.72.14 1 make-init-vector.4))
 ...
 '(module
    ...
    (cletrec
     ((error?.88 (make-closure L.error?.88.10 1))
      ...
      (make-vector.86 (make-closure L.make-vector.86.15 1 make-init-vector.4))
     ...
     (if (let () #f)
                           ...
                           (if (call L.error?.88.10 error?.88 g42531469.17)
                             ...
                             (let ((g42531470.18
                                    (call
                                     ...
                                     3
                                     3)))
                               (if (call L.error?.88.10 error?.88 g42531470.18)
                                 g42531470.18
                                 (let ((g42531471.19
                                        (call
                                         L.vector-set!.87.12
       ...
       (let ((vector0.24
              (let ((tmp.8.25 (call L.make-vector.86.15 make-vector.86 8)))
                (let ((g42531475.26
                       (call L.vector-set!.87.12 vector-set!.87 tmp.8.25 0 1)))
                          ...
                          (if (call L.error?.88.10 error?.88 g42531477.28)
                            ...
                            (let ((g42531478.29
                                   (call
                                    ...
                                    3
                                    4)))
                              (if (call L.error?.88.10 error?.88 g42531478.29)
                                g42531478.29
                                (let ((g42531479.30
                                       (call
                                        L.vector-set!.87.12
 ...
 '(module
    ...
    (cletrec
     ((error?.100 (make-closure L.error?.100.10 1))
      ...
      (make-vector.98 (make-closure L.make-vector.98.15 1 make-init-vector.4))
     ...
     (let ((vector0.14
                              ...
                              (let ((tmp.103
                                     (if #t
                                       (call
                                        ...
                                        cons.97
                                        212
                                        (call L.cons.97.16 cons.97 273 empty))
                                       (call
                                        L.cons.97.16
                                        cons.97
                                        6
                                  ...
                                  (let ((tmp.104
                                    ...
                                    (if (procedure? tmp.104)
                                      (if (eq?
                                        ...
                                        (error 42))
                                      (error 43))))))
                            (if (call L.error?.100.10 error?.100 g42535306.19)
                              g42535306.19
                              (let ((g42535325.40
                                     (call
                                      L.vector-set!.99.12
                                      ...
                                      (let ((tmp.105
                                        ...
                                        (if (procedure? tmp.105)
                                          (if (eq?
                                               (unsafe-procedure-arity tmp.105)
                                               0)
           ...
           (empty1.13 (let () empty)))
       (let ((procedure0.44
              (cletrec ((lam.109 (make-closure L.lam.109.20 0))) lam.109)))
         (void))))))
(check-by-interp
 '(module
    (define L.lam.66.14
    ...
    (cletrec
     ((fun/error8673.7 (make-closure L.fun/error8673.7.10 0 fun/error8674.8))
      ...
      (fun/error8675.9 (make-closure L.fun/error8675.9.12 0 fun/error8676.10))
         ...
         (let ((tmp.7.20 (call L.make-vector.90.15 make-vector.90 8)))
           (let ((g42546779.21
             ...
             (if (call L.error?.92.10 error?.92 g42546779.21)
               g42546779.21
               (let ((g42546780.22
                      (call L.vector-set!.91.12 vector-set!.91 tmp.7.20 1 2)))
         ...
         (let ((tmp.8.29 (call L.make-vector.90.15 make-vector.90 8)))
           (let ((g42546787.30
             ...
             (if (call L.error?.92.10 error?.92 g42546787.30)
               g42546787.30
               (let ((g42546788.31
                      (call L.vector-set!.91.12 vector-set!.91 tmp.8.29 1 2)))
 ...
 '(module
    ...
    (cletrec
     ((error?.69 (make-closure L.error?.69.10 1))
      ...
      (fun/empty8691.9 (make-closure L.fun/empty8691.9.13 2 fun/empty8692.10))
...
(check-by-interp
 '(module
    (define L.fun/procedure8696.18.21
      (lambda (c.119)
        (let () (cletrec ((lam.107 (make-closure L.lam.107.22 0))) lam.107))))
    ...
    (cletrec
     ((cons.98 (make-closure L.cons.98.10 2))
      ...
      (make-vector.94 (make-closure L.make-vector.94.17 1 make-init-vector.4))
       ...
       (let ((tmp.9.34 (if #t empty empty)))
         (if tmp.9.34
           ...
           (let ((tmp.10.35 (let () empty)))
             (if tmp.10.35
               tmp.10.35
               (let ((tmp.11.36 (call L.fun/empty8698.16.19 fun/empty8698.16)))
                 (if tmp.11.36
                   tmp.11.36
                   (let ((tmp.12.37
 ...
 '(module
    ...
    (cletrec
     ((fun/error8703.7 (make-closure L.fun/error8703.7.10 0))
      (fun/error8702.8 (make-closure L.fun/error8702.8.11 1 fun/error8703.7)))
     (let ()
       (call
