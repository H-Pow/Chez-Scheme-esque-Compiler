...
(define (sequentialize-let vulv5)
  ...
  ;; let assignment be (list values-unique-lang-v6-aloc values-unique-lang-v6-value)
  ;; let k be continuation (imp-mf-lang-v6-effect ... imp-mf-lang-v6-tail) -> imp-mf-lang-v6-tail)
