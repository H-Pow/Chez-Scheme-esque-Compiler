 ...
 '(module
    ...
    (define L.vector-init-loop.7.7
      (lambda (c.58 len.8 i.10 vec.9)
        (let ((vector-init-loop.7 (unsafe-procedure-ref c.58 0)))
          (if (eq? len.8 i.10)
            vec.9
            (begin
              ...
              (call
               ...
               (unsafe-fx+ i.10 1)
               vec.9))))))
    (let ((vector-init-loop.7 (make-procedure L.vector-init-loop.7.7 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.8 1 1))
          (make-vector.57 (make-procedure L.make-vector.57.9 1 1))
          (fun/vector8453.4 (make-procedure L.fun/vector8453.4.10 0 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.7 0 vector-init-loop.7)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.7)
        (unsafe-procedure-set! make-vector.57 0 make-init-vector.1)
        (unsafe-procedure-set! fun/vector8453.4 0 make-vector.57)
        (call L.fun/vector8453.4.10 fun/vector8453.4)))))
(check-by-interp
 '(module
    (define L.fun/error8456.4.7 (lambda (c.57) (let () (error 240))))
    (let ((fun/error8456.4 (make-procedure L.fun/error8456.4.7 0 0)))
 ...
 '(module
    ...
    (define L.fun/error8470.4.10
      (lambda (c.65 oprand0.6)
        (let ((fun/error8471.5 (unsafe-procedure-ref c.65 0)))
          (call L.fun/error8471.5.11 fun/error8471.5))))
    (define L.make-vector.61.9
      (lambda (c.64 tmp.37)
        (let ((make-init-vector.1 (unsafe-procedure-ref c.64 0)))
          (if (fixnum? tmp.37)
            (call L.make-init-vector.1.8 make-init-vector.1 tmp.37)
            (error 8)))))
    (define L.make-init-vector.1.8
      (lambda (c.63 tmp.9)
        (let ((vector-init-loop.11 (unsafe-procedure-ref c.63 0)))
    ...
    (define L.vector-init-loop.11.7
      (lambda (c.62 len.12 i.14 vec.13)
        (let ((vector-init-loop.11 (unsafe-procedure-ref c.62 0)))
          (if (eq? len.12 i.14)
            vec.13
            (begin
              ...
              (call
               ...
               (unsafe-fx+ i.14 1)
               vec.13))))))
    (let ((vector-init-loop.11 (make-procedure L.vector-init-loop.11.7 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.8 1 1))
          (make-vector.61 (make-procedure L.make-vector.61.9 1 1))
          (fun/error8470.4 (make-procedure L.fun/error8470.4.10 1 1))
          (fun/error8471.5 (make-procedure L.fun/error8471.5.11 0 0)))
      (begin
        (unsafe-procedure-set! vector-init-loop.11 0 vector-init-loop.11)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.11)
        (unsafe-procedure-set! make-vector.61 0 make-init-vector.1)
        (unsafe-procedure-set! fun/error8470.4 0 fun/error8471.5)
        (call
...
(check-by-interp
 '(module
    ...
    (let ((fun/ascii-char8474.4 (make-procedure L.fun/ascii-char8474.4.7 1 0))
          (fun/void8475.5 (make-procedure L.fun/void8475.5.8 1 0)))
      (call
...
(check-by-interp
 '(module
    ...
    (let ((fun/empty8478.4 (make-procedure L.fun/empty8478.4.7 1 0)))
      (call
       L.fun/empty8478.4.7
       fun/empty8478.4
...
(check-by-interp
 '(module
    ...
    (let ((fun/ascii-char8481.4 (make-procedure L.fun/ascii-char8481.4.7 1 0)))
      (call
...
(check-by-interp
 '(module
    ...
    (let ((ascii-char?.65 (make-procedure L.ascii-char?.65.7 1 0))
          (*.64 (make-procedure L.*.64.8 2 0))
          (cons.63 (make-procedure L.cons.63.9 2 0))
          (fun/pair8495.4 (make-procedure L.fun/pair8495.4.10 2 1))
          (fun/pair8496.5 (make-procedure L.fun/pair8496.5.11 0 1)))
      (begin
        (unsafe-procedure-set! fun/pair8495.4 0 fun/pair8496.5)
        (unsafe-procedure-set! fun/pair8496.5 0 cons.63)
        (call
         L.fun/pair8495.4.10
         fun/pair8495.4
         (call
 ...
 '(module
    (define L.fun/void8506.9.16
      (lambda (c.84 oprand0.17 oprand1.16)
        (let ((fun/void8507.7 (unsafe-procedure-ref c.84 0)))
    ...
    (let ((vector-init-loop.23 (make-procedure L.vector-init-loop.23.7 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.8 1 1))
          (make-vector.74 (make-procedure L.make-vector.74.9 1 1))
          (cons.73 (make-procedure L.cons.73.10 2 0))
          (fun/pair8508.4 (make-procedure L.fun/pair8508.4.11 2 1))
          (fun/pair8509.5 (make-procedure L.fun/pair8509.5.12 0 1))
          (fun/empty8511.6 (make-procedure L.fun/empty8511.6.13 2 0))
          (fun/void8507.7 (make-procedure L.fun/void8507.7.14 0 0))
          (fun/error8510.8 (make-procedure L.fun/error8510.8.15 2 0))
          (fun/void8506.9 (make-procedure L.fun/void8506.9.16 2 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/pair8508.4 0 fun/pair8509.5)
        (unsafe-procedure-set! fun/pair8509.5 0 cons.73)
        (unsafe-procedure-set! fun/void8506.9 0 fun/void8507.7)
        (call
         L.fun/void8506.9.16
         fun/void8506.9
...
(check-by-interp
 '(module
    (define L.fun/vector8536.6.14
      (lambda (c.72)
        (let ((make-vector.62 (unsafe-procedure-ref c.72 0)))
    ...
    (define L.make-vector.62.11
      (lambda (c.69 tmp.38)
        (let ((make-init-vector.1 (unsafe-procedure-ref c.69 0)))
          (if (fixnum? tmp.38)
            (call L.make-init-vector.1.10 make-init-vector.1 tmp.38)
            (error 8)))))
    (define L.make-init-vector.1.10
      (lambda (c.68 tmp.10)
        (let ((vector-init-loop.12 (unsafe-procedure-ref c.68 0)))
    ...
    (define L.vector-init-loop.12.9
      (lambda (c.67 len.13 i.15 vec.14)
        (let ((vector-init-loop.12 (unsafe-procedure-ref c.67 0)))
          (if (eq? len.13 i.15)
            vec.14
            (begin
    ...
    (let ((boolean?.64 (make-procedure L.boolean?.64.7 1 0))
          (cons.63 (make-procedure L.cons.63.8 2 0))
          (vector-init-loop.12 (make-procedure L.vector-init-loop.12.9 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.10 1 1))
          (make-vector.62 (make-procedure L.make-vector.62.11 1 1))
          (fun/empty8535.4 (make-procedure L.fun/empty8535.4.12 0 0))
          (fun/empty8537.5 (make-procedure L.fun/empty8537.5.13 0 0))
          (fun/vector8536.6 (make-procedure L.fun/vector8536.6.14 0 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/vector8536.6 0 make-vector.62)
 ...
 '(module
    ...
    (define L.fun/pair8560.6.10
      (lambda (c.71 oprand0.12 oprand1.11)
        (let ((fun/pair8561.4 (unsafe-procedure-ref c.71 0)))
          (call L.fun/pair8561.4.8 fun/pair8561.4))))
    (define L.fun/ascii-char8562.5.9
      (lambda (c.70 oprand0.10 oprand1.9)
        (let ((fun/ascii-char8563.7 (unsafe-procedure-ref c.70 0)))
          (call L.fun/ascii-char8563.7.11 fun/ascii-char8563.7))))
    (define L.fun/pair8561.4.8
      (lambda (c.69)
        (let ((cons.67 (unsafe-procedure-ref c.69 0)))
          (call L.cons.67.7 cons.67 251 399))))
    (define L.cons.67.7
      (lambda (c.68 tmp.62 tmp.63) (let () (cons tmp.62 tmp.63))))
    (let ((cons.67 (make-procedure L.cons.67.7 2 0))
          (fun/pair8561.4 (make-procedure L.fun/pair8561.4.8 0 1))
          (fun/ascii-char8562.5 (make-procedure L.fun/ascii-char8562.5.9 2 1))
          (fun/pair8560.6 (make-procedure L.fun/pair8560.6.10 2 1))
          (fun/ascii-char8563.7 (make-procedure L.fun/ascii-char8563.7.11 0 0))
          (fun/empty8564.8 (make-procedure L.fun/empty8564.8.12 2 0)))
      (begin
        (unsafe-procedure-set! fun/pair8561.4 0 cons.67)
        (unsafe-procedure-set! fun/ascii-char8562.5 0 fun/ascii-char8563.7)
        (unsafe-procedure-set! fun/pair8560.6 0 fun/pair8561.4)
        (call
         L.fun/pair8560.6.10
         fun/pair8560.6
         (if #f 61 74)
 ...
 '(module
    ...
    (define L.vector-init-loop.14.10
      (lambda (c.71 len.15 i.17 vec.16)
        (let ((vector-init-loop.14 (unsafe-procedure-ref c.71 0)))
          (if (eq? len.15 i.17)
            vec.16
            (begin
      ...
      (lambda (c.68 tmp.28 tmp.29)
        (let ()
          (if (fixnum? tmp.29)
            ...
            (error 2)))))
    (let ((|+.67| (make-procedure L.+.67.7 2 0))
          (|-.66| (make-procedure L.-.66.8 2 0))
          (*.65 (make-procedure L.*.65.9 2 0))
          (vector-init-loop.14 (make-procedure L.vector-init-loop.14.10 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.11 1 1))
          (make-vector.64 (make-procedure L.make-vector.64.12 1 1))
          (fun/ascii-char8613.4 (make-procedure L.fun/ascii-char8613.4.13 0 0))
          (fun/vector8612.5 (make-procedure L.fun/vector8612.5.14 0 1))
          (fun/ascii-char8614.6 (make-procedure L.fun/ascii-char8614.6.15 0 0))
          (fun/void8611.7 (make-procedure L.fun/void8611.7.16 0 0)))
      (begin
        (unsafe-procedure-set! vector-init-loop.14 0 vector-init-loop.14)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.14)
        (unsafe-procedure-set! make-vector.64 0 make-init-vector.1)
        (unsafe-procedure-set! fun/vector8612.5 0 make-vector.64)
        (let ((fixnum0.11
               (call
                L.+.67.7
                |+.67|
...
(check-by-interp
 '(module
    ...
    (let ((|-.66| (make-procedure L.-.66.7 2 0))
          ...
          (fun/ascii-char8617.4 (make-procedure L.fun/ascii-char8617.4.13 0 0))
          (fun/vector8619.5 (make-procedure L.fun/vector8619.5.14 0 1))
          (fun/void8618.6 (make-procedure L.fun/void8618.6.15 0 0)))
      (begin
        ...
        (unsafe-procedure-set! fun/vector8619.5 0 make-vector.63)
        (let ((fixnum0.10
               (call
                L.*.65.8
                *.65
...
(check-by-interp
 '(module
    (define L.lam.68.17
      (lambda (c.79)
        (let ((fun/any8773.7 (unsafe-procedure-ref c.79 0))
              (vector?.67 (unsafe-procedure-ref c.79 1)))
          (call
           L.vector?.67.7
           vector?.67
    ...
    (define L.fun/vector8772.8.16
      (lambda (c.78)
        (let ((make-vector.65 (unsafe-procedure-ref c.78 0)))
    ...
    (define L.fun/any8771.4.12
      (lambda (c.74)
        (let ((make-vector.65 (unsafe-procedure-ref c.74 0)))
          (call L.make-vector.65.11 make-vector.65 8))))
    ...
    (define L.make-init-vector.1.10
      (lambda (c.72 tmp.13)
        (let ((vector-init-loop.15 (unsafe-procedure-ref c.72 0)))
    ...
    (let ((vector?.67 (make-procedure L.vector?.67.7 1 0))
          (error?.66 (make-procedure L.error?.66.8 1 0))
          (vector-init-loop.15 (make-procedure L.vector-init-loop.15.9 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.10 1 1))
          (make-vector.65 (make-procedure L.make-vector.65.11 1 1))
          (fun/any8771.4 (make-procedure L.fun/any8771.4.12 0 1))
          (fun/empty8774.5 (make-procedure L.fun/empty8774.5.13 0 0))
          (fun/void8770.6 (make-procedure L.fun/void8770.6.14 0 0))
          (fun/any8773.7 (make-procedure L.fun/any8773.7.15 0 0))
          (fun/vector8772.8 (make-procedure L.fun/vector8772.8.16 0 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/any8771.4 0 make-vector.65)
        (unsafe-procedure-set! fun/vector8772.8 0 make-vector.65)
        (let ((void0.12 (call L.fun/void8770.6.14 fun/void8770.6))
              ...
              (procedure3.9
               (let ((lam.68 (make-procedure L.lam.68.17 0 2)))
                 (begin
                   (unsafe-procedure-set! lam.68 0 fun/any8773.7)
                   (unsafe-procedure-set! lam.68 1 vector?.67)
                   lam.68))))
...
(check-by-interp
 '(module
    ...
    (define L.fun/void9398.4.14
      (lambda (c.85)
        (let ((fun/void9399.9 (unsafe-procedure-ref c.85 0)))
    ...
    (define L.make-init-vector.1.12
      (lambda (c.83 tmp.19)
        (let ((vector-init-loop.21 (unsafe-procedure-ref c.83 0)))
      ...
      (lambda (c.78 tmp.35 tmp.36)
        (let ()
          (if (fixnum? tmp.36)
            ...
            (error 2)))))
    (let ((|+.75| (make-procedure L.+.75.7 2 0))
          (|-.74| (make-procedure L.-.74.8 2 0))
          (*.73 (make-procedure L.*.73.9 2 0))
          (cons.72 (make-procedure L.cons.72.10 2 0))
          (vector-init-loop.21 (make-procedure L.vector-init-loop.21.11 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.12 1 1))
          (make-vector.71 (make-procedure L.make-vector.71.13 1 1))
          (fun/void9398.4 (make-procedure L.fun/void9398.4.14 0 1))
          (fun/empty9407.5 (make-procedure L.fun/empty9407.5.15 0 0))
          (fun/ascii-char9403.6 (make-procedure L.fun/ascii-char9403.6.16 0 0))
          (fun/pair9400.7 (make-procedure L.fun/pair9400.7.17 0 1))
          (fun/vector9404.8 (make-procedure L.fun/vector9404.8.18 0 1))
          (fun/void9399.9 (make-procedure L.fun/void9399.9.19 0 0))
          (fun/empty9406.10 (make-procedure L.fun/empty9406.10.20 0 1))
          (fun/vector9405.11 (make-procedure L.fun/vector9405.11.21 0 1))
          (fun/pair9401.12 (make-procedure L.fun/pair9401.12.22 0 1))
          (fun/ascii-char9402.13
           (make-procedure L.fun/ascii-char9402.13.23 0 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/void9398.4 0 fun/void9399.9)
        (unsafe-procedure-set! fun/pair9400.7 0 fun/pair9401.12)
        (unsafe-procedure-set! fun/vector9404.8 0 fun/vector9405.11)
        (unsafe-procedure-set! fun/empty9406.10 0 fun/empty9407.5)
        (unsafe-procedure-set! fun/vector9405.11 0 make-vector.71)
        (unsafe-procedure-set! fun/pair9401.12 0 cons.72)
        (unsafe-procedure-set! fun/ascii-char9402.13 0 fun/ascii-char9403.6)
        (let ((void0.18 (call L.fun/void9398.4.14 fun/void9398.4))
              ...
              (procedure2.16
               (let ((lam.76 (make-procedure L.lam.76.24 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.76 0 fun/pair9400.7)
                   lam.76)))
              (ascii-char3.15
               (call L.fun/ascii-char9402.13.23 fun/ascii-char9402.13))
              (procedure4.14
               (let ((lam.77 (make-procedure L.lam.77.25 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.77 0 fun/vector9404.8)
                   lam.77))))
...
(check-by-interp
 '(module
    (define L.fun/pair13318.15.22
      (lambda (c.93)
        (let ((fun/pair13319.9 (unsafe-procedure-ref c.93 0)))
    ...
    (define L.fun/ascii-char13314.13.20
      (lambda (c.91)
        (let ((fun/ascii-char13315.5 (unsafe-procedure-ref c.91 0)))
    ...
    (define L.fun/empty13316.4.11
      (lambda (c.82)
        (let ((fun/empty13317.11 (unsafe-procedure-ref c.82 0)))
    ...
    (let ((|-.77| (make-procedure L.-.77.7 2 0))
          ...
          (cons.74 (make-procedure L.cons.74.10 2 0))
          (fun/empty13316.4 (make-procedure L.fun/empty13316.4.11 0 1))
          (fun/ascii-char13315.5
           (make-procedure L.fun/ascii-char13315.5.12 0 0))
          (fun/error13313.6 (make-procedure L.fun/error13313.6.13 0 0))
          (fun/error13308.7 (make-procedure L.fun/error13308.7.14 0 1))
          (fun/error13312.8 (make-procedure L.fun/error13312.8.15 0 1))
          (fun/pair13319.9 (make-procedure L.fun/pair13319.9.16 0 1))
          (fun/void13310.10 (make-procedure L.fun/void13310.10.17 0 1))
          (fun/empty13317.11 (make-procedure L.fun/empty13317.11.18 0 0))
          (fun/error13309.12 (make-procedure L.fun/error13309.12.19 0 0))
          (fun/ascii-char13314.13
           (make-procedure L.fun/ascii-char13314.13.20 0 1))
          (fun/void13311.14 (make-procedure L.fun/void13311.14.21 0 0))
          (fun/pair13318.15 (make-procedure L.fun/pair13318.15.22 0 1)))
      (begin
        (unsafe-procedure-set! fun/empty13316.4 0 fun/empty13317.11)
        (unsafe-procedure-set! fun/error13308.7 0 fun/error13309.12)
        (unsafe-procedure-set! fun/error13312.8 0 fun/error13313.6)
        (unsafe-procedure-set! fun/pair13319.9 0 cons.74)
        (unsafe-procedure-set! fun/void13310.10 0 fun/void13311.14)
        (unsafe-procedure-set! fun/ascii-char13314.13 0 fun/ascii-char13315.5)
        (unsafe-procedure-set! fun/pair13318.15 0 fun/pair13319.9)
...
(check-by-interp
 '(module
    (define L.lam.74.21
      (lambda (c.89)
        (let ((fun/vector13354.8 (unsafe-procedure-ref c.89 0)))
    ...
    (define L.make-init-vector.1.11
      (lambda (c.79 tmp.18)
        (let ((vector-init-loop.20 (unsafe-procedure-ref c.79 0)))
    ...
    (define L.vector-init-loop.20.10
      (lambda (c.78 len.21 i.23 vec.22)
        (let ((vector-init-loop.20 (unsafe-procedure-ref c.78 0)))
          (if (eq? len.21 i.23)
            vec.22
            (begin
      ...
      (lambda (c.75 tmp.36 tmp.37)
        (let ()
          (if (fixnum? tmp.37)
            ...
            (error 3)))))
    (let ((|-.73| (make-procedure L.-.73.7 2 0))
          (|+.72| (make-procedure L.+.72.8 2 0))
          (*.71 (make-procedure L.*.71.9 2 0))
          (vector-init-loop.20 (make-procedure L.vector-init-loop.20.10 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.11 1 1))
          (make-vector.70 (make-procedure L.make-vector.70.12 1 1))
          (fun/error13358.4 (make-procedure L.fun/error13358.4.13 0 1))
          (fun/vector13357.5 (make-procedure L.fun/vector13357.5.14 0 1))
          (fun/vector13355.6 (make-procedure L.fun/vector13355.6.15 0 1))
          (fun/ascii-char13352.7
           (make-procedure L.fun/ascii-char13352.7.16 0 1))
          (fun/vector13354.8 (make-procedure L.fun/vector13354.8.17 0 1))
          (fun/vector13356.9 (make-procedure L.fun/vector13356.9.18 0 1))
          (fun/error13359.10 (make-procedure L.fun/error13359.10.19 0 0))
          (fun/ascii-char13353.11
           (make-procedure L.fun/ascii-char13353.11.20 0 0)))
      (begin
        (unsafe-procedure-set! vector-init-loop.20 0 vector-init-loop.20)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.20)
        (unsafe-procedure-set! make-vector.70 0 make-init-vector.1)
        (unsafe-procedure-set! fun/error13358.4 0 fun/error13359.10)
        (unsafe-procedure-set! fun/vector13357.5 0 make-vector.70)
        (unsafe-procedure-set! fun/vector13355.6 0 make-vector.70)
        (unsafe-procedure-set! fun/ascii-char13352.7 0 fun/ascii-char13353.11)
        (unsafe-procedure-set! fun/vector13354.8 0 fun/vector13355.6)
        (unsafe-procedure-set! fun/vector13356.9 0 fun/vector13357.5)
        (let ((fixnum0.17
               (call
                L.*.71.9
                *.71
              ...
              (procedure2.15
               (let ((lam.74 (make-procedure L.lam.74.21 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.74 0 fun/vector13354.8)
                   lam.74)))
              (fixnum3.14
               (call
                L.-.73.7
          ...
          (if (procedure? procedure2.15)
            (if (eq? (unsafe-procedure-arity procedure2.15) 0)
              (call (unsafe-procedure-label procedure2.15) procedure2.15)
              (error 42))
            (error 43)))))))
(check-by-interp
 '(module
    (define L.fun/empty14584.13.19
      (lambda (c.87)
        (let ((fun/empty14585.11 (unsafe-procedure-ref c.87 0)))
    ...
    (let ((*.74 (make-procedure L.*.74.7 2 0))
          ...
          (fun/void14593.4 (make-procedure L.fun/void14593.4.10 0 0))
          (fun/void14591.5 (make-procedure L.fun/void14591.5.11 0 0))
          (fun/void14590.6 (make-procedure L.fun/void14590.6.12 0 1))
          (fun/ascii-char14586.7
           (make-procedure L.fun/ascii-char14586.7.13 0 1))
          (fun/void14588.8 (make-procedure L.fun/void14588.8.14 0 1))
          (fun/void14592.9 (make-procedure L.fun/void14592.9.15 0 1))
          (fun/ascii-char14587.10
           (make-procedure L.fun/ascii-char14587.10.16 0 0))
          (fun/empty14585.11 (make-procedure L.fun/empty14585.11.17 0 0))
          (fun/void14589.12 (make-procedure L.fun/void14589.12.18 0 0))
          (fun/empty14584.13 (make-procedure L.fun/empty14584.13.19 0 1)))
      (begin
        (unsafe-procedure-set! fun/void14590.6 0 fun/void14591.5)
        (unsafe-procedure-set! fun/ascii-char14586.7 0 fun/ascii-char14587.10)
        (unsafe-procedure-set! fun/void14588.8 0 fun/void14589.12)
        (unsafe-procedure-set! fun/void14592.9 0 fun/void14593.4)
        (unsafe-procedure-set! fun/empty14584.13 0 fun/empty14585.11)
...
(check-by-interp
 '(module
    ...
    (define L.fun/void15141.14.25
      (lambda (c.98)
        (let ((fun/void15142.8 (unsafe-procedure-ref c.98 0)))
          (call L.fun/void15142.8.19 fun/void15142.8))))
    (define L.fun/empty15139.13.24
      (lambda (c.97)
        (let ((fun/empty15140.4 (unsafe-procedure-ref c.97 0)))
    ...
    (define L.fun/void15145.5.16
      (lambda (c.89)
        (let ((fun/void15146.12 (unsafe-procedure-ref c.89 0)))
    ...
    (let ((empty?.79 (make-procedure L.empty?.79.7 1 0))
          ...
          (fun/empty15140.4 (make-procedure L.fun/empty15140.4.15 0 0))
          (fun/void15145.5 (make-procedure L.fun/void15145.5.16 0 1))
          (fun/vector15138.6 (make-procedure L.fun/vector15138.6.17 0 1))
          (fun/ascii-char15135.7
           (make-procedure L.fun/ascii-char15135.7.18 0 1))
          (fun/void15142.8 (make-procedure L.fun/void15142.8.19 0 0))
          (fun/any15144.9 (make-procedure L.fun/any15144.9.20 0 1))
          (fun/any15143.10 (make-procedure L.fun/any15143.10.21 0 1))
          (fun/vector15137.11 (make-procedure L.fun/vector15137.11.22 0 1))
          (fun/void15146.12 (make-procedure L.fun/void15146.12.23 0 0))
          (fun/empty15139.13 (make-procedure L.fun/empty15139.13.24 0 1))
          (fun/void15141.14 (make-procedure L.fun/void15141.14.25 0 1))
          (fun/ascii-char15136.15
           (make-procedure L.fun/ascii-char15136.15.26 0 0)))
      (begin
        ...
        (unsafe-procedure-set! make-vector.74 0 make-init-vector.1)
        (unsafe-procedure-set! fun/void15145.5 0 fun/void15146.12)
        (unsafe-procedure-set! fun/vector15138.6 0 make-vector.74)
        (unsafe-procedure-set! fun/ascii-char15135.7 0 fun/ascii-char15136.15)
        (unsafe-procedure-set! fun/any15144.9 0 cons.75)
        (unsafe-procedure-set! fun/any15143.10 0 fun/any15144.9)
        (unsafe-procedure-set! fun/vector15137.11 0 fun/vector15138.6)
        (unsafe-procedure-set! fun/empty15139.13 0 fun/empty15140.4)
        (unsafe-procedure-set! fun/void15141.14 0 fun/void15142.8)
        (let ((ascii-char0.21
...
(check-by-interp
 '(module
    (define L.lam.77.24
      (lambda (c.95)
        (let ((fun/empty15764.14 (unsafe-procedure-ref c.95 0)))
          (call L.fun/empty15764.14.20 fun/empty15764.14))))
    (define L.fun/ascii-char15768.17.23
      (lambda (c.94)
        (let ((fun/ascii-char15769.10 (unsafe-procedure-ref c.94 0)))
    ...
    (define L.fun/empty15764.14.20
      (lambda (c.91)
        (let ((fun/empty15765.5 (unsafe-procedure-ref c.91 0)))
          (call L.fun/empty15765.5.11 fun/empty15765.5))))
    (define L.fun/empty15766.13.19
      (lambda (c.90)
        (let ((fun/empty15767.11 (unsafe-procedure-ref c.90 0)))
          (call L.fun/empty15767.11.17 fun/empty15767.11))))
    (define L.fun/ascii-char15776.12.18
      (lambda (c.89)
        (let ((fun/ascii-char15777.16 (unsafe-procedure-ref c.89 0)))
    ...
    (define L.fun/vector15771.9.15
      (lambda (c.86)
        (let ((make-vector.76 (unsafe-procedure-ref c.86 0)))
          (call L.make-vector.76.9 make-vector.76 8))))
    (define L.fun/error15772.8.14
      (lambda (c.85)
        (let ((fun/error15773.7 (unsafe-procedure-ref c.85 0)))
    ...
    (define L.fun/void15774.6.12
      (lambda (c.83)
        (let ((fun/void15775.15 (unsafe-procedure-ref c.83 0)))
    ...
    (define L.fun/vector15770.4.10
      (lambda (c.81)
        (let ((fun/vector15771.9 (unsafe-procedure-ref c.81 0)))
    ...
    (define L.make-init-vector.1.8
      (lambda (c.79 tmp.24)
        (let ((vector-init-loop.26 (unsafe-procedure-ref c.79 0)))
    ...
    (let ((vector-init-loop.26 (make-procedure L.vector-init-loop.26.7 3 1))
          ...
          (fun/vector15770.4 (make-procedure L.fun/vector15770.4.10 0 1))
          (fun/empty15765.5 (make-procedure L.fun/empty15765.5.11 0 0))
          (fun/void15774.6 (make-procedure L.fun/void15774.6.12 0 1))
          (fun/error15773.7 (make-procedure L.fun/error15773.7.13 0 0))
          (fun/error15772.8 (make-procedure L.fun/error15772.8.14 0 1))
          (fun/vector15771.9 (make-procedure L.fun/vector15771.9.15 0 1))
          (fun/ascii-char15769.10
           (make-procedure L.fun/ascii-char15769.10.16 0 0))
          (fun/empty15767.11 (make-procedure L.fun/empty15767.11.17 0 0))
          (fun/ascii-char15776.12
           (make-procedure L.fun/ascii-char15776.12.18 0 1))
          (fun/empty15766.13 (make-procedure L.fun/empty15766.13.19 0 1))
          (fun/empty15764.14 (make-procedure L.fun/empty15764.14.20 0 1))
          (fun/void15775.15 (make-procedure L.fun/void15775.15.21 0 0))
          (fun/ascii-char15777.16
           (make-procedure L.fun/ascii-char15777.16.22 0 0))
          (fun/ascii-char15768.17
           (make-procedure L.fun/ascii-char15768.17.23 0 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/vector15770.4 0 fun/vector15771.9)
        (unsafe-procedure-set! fun/void15774.6 0 fun/void15775.15)
        (unsafe-procedure-set! fun/error15772.8 0 fun/error15773.7)
        (unsafe-procedure-set! fun/vector15771.9 0 make-vector.76)
        (unsafe-procedure-set! fun/ascii-char15776.12 0 fun/ascii-char15777.16)
        (unsafe-procedure-set! fun/empty15766.13 0 fun/empty15767.11)
        (unsafe-procedure-set! fun/empty15764.14 0 fun/empty15765.5)
        (unsafe-procedure-set! fun/ascii-char15768.17 0 fun/ascii-char15769.10)
        (let ((procedure0.23
               (let ((lam.77 (make-procedure L.lam.77.24 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.77 0 fun/empty15764.14)
                   lam.77)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/vector21850.9.19
      (lambda (c.92)
        (let ((make-vector.74 (unsafe-procedure-ref c.92 0)))
          (call L.make-vector.74.13 make-vector.74 8))))
    (define L.fun/vector21849.8.18
      (lambda (c.91)
        (let ((fun/vector21850.9 (unsafe-procedure-ref c.91 0)))
          (call L.fun/vector21850.9.19 fun/vector21850.9))))
    (define L.fun/pair21851.7.17
      (lambda (c.90)
        (let ((fun/pair21852.12 (unsafe-procedure-ref c.90 0)))
    ...
    (define L.vector-init-loop.24.11
      (lambda (c.84 len.25 i.27 vec.26)
        (let ((vector-init-loop.24 (unsafe-procedure-ref c.84 0)))
          (if (eq? len.25 i.27)
            vec.26
            (begin
              (unsafe-vector-set! vec.26 i.27 0)
    ...
    (let ((|+.78| (make-procedure L.+.78.7 2 0))
          ...
          (cons.75 (make-procedure L.cons.75.10 2 0))
          (vector-init-loop.24 (make-procedure L.vector-init-loop.24.11 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.12 1 1))
          (make-vector.74 (make-procedure L.make-vector.74.13 1 1))
          (fun/void21848.4 (make-procedure L.fun/void21848.4.14 0 0))
          (fun/ascii-char21854.5
           (make-procedure L.fun/ascii-char21854.5.15 0 0))
          (fun/vector21856.6 (make-procedure L.fun/vector21856.6.16 0 1))
          (fun/pair21851.7 (make-procedure L.fun/pair21851.7.17 0 1))
          (fun/vector21849.8 (make-procedure L.fun/vector21849.8.18 0 1))
          (fun/vector21850.9 (make-procedure L.fun/vector21850.9.19 0 1))
          (fun/error21846.10 (make-procedure L.fun/error21846.10.20 0 0))
          (fun/vector21855.11 (make-procedure L.fun/vector21855.11.21 0 1))
          (fun/pair21852.12 (make-procedure L.fun/pair21852.12.22 0 1))
          (fun/error21845.13 (make-procedure L.fun/error21845.13.23 0 1))
          (fun/ascii-char21853.14
           (make-procedure L.fun/ascii-char21853.14.24 0 1))
          (fun/void21847.15 (make-procedure L.fun/void21847.15.25 0 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.24 0 vector-init-loop.24)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.24)
        (unsafe-procedure-set! make-vector.74 0 make-init-vector.1)
        (unsafe-procedure-set! fun/vector21856.6 0 make-vector.74)
        (unsafe-procedure-set! fun/pair21851.7 0 fun/pair21852.12)
        (unsafe-procedure-set! fun/vector21849.8 0 fun/vector21850.9)
        (unsafe-procedure-set! fun/vector21850.9 0 make-vector.74)
        (unsafe-procedure-set! fun/vector21855.11 0 fun/vector21856.6)
        (unsafe-procedure-set! fun/pair21852.12 0 cons.75)
        (unsafe-procedure-set! fun/error21845.13 0 fun/error21846.10)
        (unsafe-procedure-set! fun/ascii-char21853.14 0 fun/ascii-char21854.5)
        (unsafe-procedure-set! fun/void21847.15 0 fun/void21848.4)
        (let ((error0.21 (call L.fun/error21845.13.23 fun/error21845.13))
              ...
              (procedure3.18
               (let ((lam.79 (make-procedure L.lam.79.26 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.79 0 fun/pair21851.7)
                   lam.79)))
              (ascii-char4.17
...
(check-by-interp
 '(module
    ...
    (define L.fun/void10028.10.16
      (lambda (c.85)
        (let ((fun/void10029.8 (unsafe-procedure-ref c.85 0)))
          (call L.fun/void10029.8.14 fun/void10029.8))))
    (define L.fun/vector10031.9.15
      (lambda (c.84)
        (let ((make-vector.74 (unsafe-procedure-ref c.84 0)))
          (call L.make-vector.74.9 make-vector.74 8))))
    ...
    (define L.fun/vector10030.6.12
      (lambda (c.81)
        (let ((fun/vector10031.9 (unsafe-procedure-ref c.81 0)))
    ...
    (define L.fun/empty10026.4.10
      (lambda (c.79)
        (let ((fun/empty10027.11 (unsafe-procedure-ref c.79 0)))
    ...
    (define L.make-init-vector.1.8
      (lambda (c.77 tmp.22)
        (let ((vector-init-loop.24 (unsafe-procedure-ref c.77 0)))
          (let ((tmp.23 (unsafe-make-vector tmp.22)))
            (call
    ...
    (define L.vector-init-loop.24.7
      (lambda (c.76 len.25 i.27 vec.26)
        (let ((vector-init-loop.24 (unsafe-procedure-ref c.76 0)))
          (if (eq? len.25 i.27)
            vec.26
            (begin
              (unsafe-vector-set! vec.26 i.27 0)
              (call
               ...
               (unsafe-fx+ i.27 1)
               vec.26))))))
    (let ((vector-init-loop.24 (make-procedure L.vector-init-loop.24.7 3 1))
          (make-init-vector.1 (make-procedure L.make-init-vector.1.8 1 1))
          (make-vector.74 (make-procedure L.make-vector.74.9 1 1))
          (fun/empty10026.4 (make-procedure L.fun/empty10026.4.10 0 1))
          (fun/void10033.5 (make-procedure L.fun/void10033.5.11 0 0))
          (fun/vector10030.6 (make-procedure L.fun/vector10030.6.12 0 1))
          (fun/empty10023.7 (make-procedure L.fun/empty10023.7.13 0 0))
          (fun/void10029.8 (make-procedure L.fun/void10029.8.14 0 0))
          (fun/vector10031.9 (make-procedure L.fun/vector10031.9.15 0 1))
          (fun/void10028.10 (make-procedure L.fun/void10028.10.16 0 1))
          (fun/empty10027.11 (make-procedure L.fun/empty10027.11.17 0 0))
          (fun/vector10025.12 (make-procedure L.fun/vector10025.12.18 0 1))
          (fun/empty10022.13 (make-procedure L.fun/empty10022.13.19 0 1))
          (fun/vector10024.14 (make-procedure L.fun/vector10024.14.20 0 1))
          (fun/void10032.15 (make-procedure L.fun/void10032.15.21 0 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.24 0 vector-init-loop.24)
        (unsafe-procedure-set! make-init-vector.1 0 vector-init-loop.24)
        (unsafe-procedure-set! make-vector.74 0 make-init-vector.1)
        (unsafe-procedure-set! fun/empty10026.4 0 fun/empty10027.11)
        (unsafe-procedure-set! fun/vector10030.6 0 fun/vector10031.9)
        (unsafe-procedure-set! fun/vector10031.9 0 make-vector.74)
        (unsafe-procedure-set! fun/void10028.10 0 fun/void10029.8)
        (unsafe-procedure-set! fun/vector10025.12 0 make-vector.74)
        (unsafe-procedure-set! fun/empty10022.13 0 fun/empty10023.7)
        (unsafe-procedure-set! fun/vector10024.14 0 fun/vector10025.12)
        (unsafe-procedure-set! fun/void10032.15 0 fun/void10033.5)
        (let ((empty0.21 (call L.fun/empty10022.13.19 fun/empty10022.13))
              (procedure1.20
               (let ((lam.75 (make-procedure L.lam.75.22 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.75 0 fun/vector10024.14)
                   lam.75)))
          ...
          (if (procedure? procedure1.20)
            (if (eq? (unsafe-procedure-arity procedure1.20) 0)
              (call (unsafe-procedure-label procedure1.20) procedure1.20)
              (error 42))
            (error 43)))))))
(check-by-interp
 '(module
    (define L.lam.78.23
      (lambda (c.95)
        (let ((fun/error12088.11 (unsafe-procedure-ref c.95 0)))
          (call L.fun/error12088.11.18 fun/error12088.11))))
    (define L.fun/void12098.15.22
      (lambda (c.94)
        (let ((fun/void12099.10 (unsafe-procedure-ref c.94 0)))
          (call L.fun/void12099.10.17 fun/void12099.10))))
    (define L.fun/error12094.14.21
      (lambda (c.93)
        (let ((fun/error12095.6 (unsafe-procedure-ref c.93 0)))
    ...
    (define L.fun/error12088.11.18
      (lambda (c.90)
        (let ((fun/error12089.13 (unsafe-procedure-ref c.90 0)))
    ...
    (define L.fun/empty12096.7.14
      (lambda (c.86)
        (let ((fun/empty12097.12 (unsafe-procedure-ref c.86 0)))
    ...
    (define L.fun/empty12090.5.12
      (lambda (c.84)
        (let ((fun/empty12091.8 (unsafe-procedure-ref c.84 0)))
          (call L.fun/empty12091.8.15 fun/empty12091.8))))
    (define L.fun/any12092.4.11
      (lambda (c.83)
        (let ((fun/any12093.9 (unsafe-procedure-ref c.83 0)))
    ...
    (let ((fixnum?.77 (make-procedure L.fixnum?.77.7 1 0))
          (*.76 (make-procedure L.*.76.8 2 0))
          (|+.75| (make-procedure L.+.75.9 2 0))
          (|-.74| (make-procedure L.-.74.10 2 0))
          (fun/any12092.4 (make-procedure L.fun/any12092.4.11 0 1))
          (fun/empty12090.5 (make-procedure L.fun/empty12090.5.12 0 1))
          (fun/error12095.6 (make-procedure L.fun/error12095.6.13 0 0))
          (fun/empty12096.7 (make-procedure L.fun/empty12096.7.14 0 1))
          (fun/empty12091.8 (make-procedure L.fun/empty12091.8.15 0 0))
          (fun/any12093.9 (make-procedure L.fun/any12093.9.16 0 0))
          (fun/void12099.10 (make-procedure L.fun/void12099.10.17 0 0))
          (fun/error12088.11 (make-procedure L.fun/error12088.11.18 0 1))
          (fun/empty12097.12 (make-procedure L.fun/empty12097.12.19 0 0))
          (fun/error12089.13 (make-procedure L.fun/error12089.13.20 0 0))
          (fun/error12094.14 (make-procedure L.fun/error12094.14.21 0 1))
          (fun/void12098.15 (make-procedure L.fun/void12098.15.22 0 1)))
      (begin
        (unsafe-procedure-set! fun/any12092.4 0 fun/any12093.9)
        (unsafe-procedure-set! fun/empty12090.5 0 fun/empty12091.8)
        (unsafe-procedure-set! fun/empty12096.7 0 fun/empty12097.12)
        (unsafe-procedure-set! fun/error12088.11 0 fun/error12089.13)
        (unsafe-procedure-set! fun/error12094.14 0 fun/error12095.6)
        (unsafe-procedure-set! fun/void12098.15 0 fun/void12099.10)
        (let ((procedure0.21
               (let ((lam.78 (make-procedure L.lam.78.23 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.78 0 fun/error12088.11)
                   lam.78)))
              (fixnum1.20
               (call
                L.-.74.10
