...
(check-by-interp
 '(module
    ((new-frames ()) (locals (tmp-ra.53)))
    (define L.cons.5
      ((new-frames ()) (locals (tmp.50 tmp.54 tmp.51 tmp.47 tmp.46 tmp-ra.52)))
      (begin
        (set! tmp-ra.52 r15)
        (set! tmp.46 rdi)
        (set! tmp.47 rsi)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (ascii-char0.1 tmp-ra.51)))
    (begin
      (set! tmp-ra.51 r15)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (void0.1 tmp-ra.51)))
    (begin
      (set! tmp-ra.51 r15)
      (set! void0.1 30)
      (set! rax 31790)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (void0.1 tmp-ra.54)))
    (define L.cons.5
      ((new-frames ()) (locals (tmp.51 tmp.55 tmp.52 tmp.48 tmp.47 tmp-ra.53)))
      (begin
        (set! tmp-ra.53 r15)
        (set! tmp.47 rdi)
        (set! tmp.48 rsi)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (void1.1 boolean0.2 tmp-ra.52)))
    (begin
      (set! tmp-ra.52 r15)
      (set! boolean0.2 6)
      (set! void1.1 30)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (tmp.54 tmp.51 tmp-ra.53)))
    (define L.fun/fixnum8394.4
      ((new-frames ()) (locals (oprand0.1 tmp-ra.52)))
      (begin
        (set! tmp-ra.52 r15)
        (set! oprand0.1 rdi)
        (set! rax 312)
...
(check-by-interp
 '(module
    ((new-frames (())) (locals (pair1.1 ascii-char0.2 tmp-ra.55)))
    (define L.cons.5
      ((new-frames ()) (locals (tmp.52 tmp.56 tmp.53 tmp.49 tmp.48 tmp-ra.54)))
      (begin
        (set! tmp-ra.54 r15)
        (set! tmp.48 rdi)
        (set! tmp.49 rsi)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (tmp.58 tmp.53 tmp-ra.56)))
    (define L.cons.6
      ((new-frames ()) (locals (tmp.51 tmp.57 tmp.52 tmp.48 tmp.47 tmp-ra.54)))
      (begin
        (set! tmp-ra.54 r15)
        (set! tmp.47 rdi)
        (set! tmp.48 rsi)
    ...
    (define L.fun/pair8407.4
      ((new-frames ()) (locals (oprand0.1 tmp-ra.55)))
      (begin
        (set! tmp-ra.55 r15)
        (set! oprand0.1 rdi)
        (set! rsi 3872)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (boolean1.1 fixnum0.2 tmp-ra.52)))
    (begin
      (set! tmp-ra.52 r15)
      (set! fixnum0.2 1712)
      (set! boolean1.1 14)
...
(check-by-interp
 '(module
    ((new-frames ()) (locals (boolean1.1 error0.2 tmp-ra.52)))
    (begin
      (set! tmp-ra.52 r15)
      (set! error0.2 13118)
      (set! boolean1.1 14)
...
(check-by-interp
 '(module
    ((new-frames (() ())) (locals (tmp.59 tmp-ra.64 tmp.58)))
    (define L.cons.8
      ((new-frames ()) (locals (tmp.56 tmp.65 tmp.57 tmp.53 tmp.52 tmp-ra.60)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
    ...
    (define L.fun/error8419.4
      ((new-frames ()) (locals (oprand1.1 oprand0.2 tmp-ra.61)))
      (begin
        (set! tmp-ra.61 r15)
        (set! oprand0.2 rdi)
        (set! oprand1.1 rsi)
    ...
    (define L.fun/boolean8418.5
      ((new-frames ()) (locals (oprand1.3 oprand0.4 tmp-ra.62)))
      (begin
        (set! tmp-ra.62 r15)
        (set! oprand0.4 rdi)
        (set! oprand1.3 rsi)
    ...
    (define L.fun/error8420.6
      ((new-frames ()) (locals (oprand1.5 oprand0.6 tmp-ra.63)))
      (begin
        (set! tmp-ra.63 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (pair2.1 error1.2 ascii-char0.3 tmp-ra.64)))
    (define L.+.9
      ((new-frames ())
       (locals
        (tmp.56
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.59 rbp rax)))))
    (define L.cons.8
      ((new-frames ()) (locals (tmp.53 tmp.68 tmp.58 tmp.50 tmp.49 tmp-ra.60)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.49 rdi)
        (set! tmp.50 rsi)
...
(check-by-interp
 '(module
    ((new-frames (())) (locals (tmp.66 tmp.57 tmp.55 tmp.65 tmp.56 tmp-ra.62)))
    (define L.empty?.8
      ((new-frames ()) (locals (tmp-ra.58 tmp.63 tmp.41 tmp.53)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.41 rdi)
        (if (begin
    ...
    (define L.cons.7
      ((new-frames ()) (locals (tmp.52 tmp.64 tmp.54 tmp.49 tmp.48 tmp-ra.59)))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.48 rdi)
        (set! tmp.49 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (boolean2.1 ascii-char1.2 ascii-char0.3 tmp-ra.58)))
    (define L.pair?.8
      ((new-frames ()) (locals (tmp-ra.54 tmp.59 tmp.46 tmp.53)))
      (begin
        (set! tmp-ra.54 r15)
        (set! tmp.46 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals (empty3.1 void2.2 pair1.3 empty0.4 tmp-ra.61)))
    (define L.cons.9
      ((new-frames ()) (locals (tmp.54 tmp.62 tmp.55 tmp.51 tmp.50 tmp-ra.56)))
      (begin
        (set! tmp-ra.56 r15)
        (set! tmp.50 rdi)
        (set! tmp.51 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (void3.1 pair2.2 void1.3 fixnum0.4 tmp.70 tmp.69 tmp-ra.79)))
    (define L.+.12
      ((new-frames ())
       (locals
        (tmp.57
    ...
    (define L.*.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.73 rbp rax)))))
    (define L.cons.9
      ((new-frames ()) (locals (tmp.54 tmp.90 tmp.68 tmp.51 tmp.50 tmp-ra.74)))
      (begin
        (set! tmp-ra.74 r15)
        (set! tmp.50 rdi)
        (set! tmp.51 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals
      (tmp.74
       ...
       tmp-ra.81)))
    (define L.pair?.10
      ((new-frames ()) (locals (tmp-ra.75 tmp.82 tmp.59 tmp.67)))
      (begin
        (set! tmp-ra.75 r15)
        (set! tmp.59 rdi)
        (if (begin
    ...
    (define L.cons.9
      ((new-frames ()) (locals (tmp.66 tmp.83 tmp.68 tmp.63 tmp.62 tmp-ra.76)))
      (begin
        (set! tmp-ra.76 r15)
        (set! tmp.62 rdi)
        (set! tmp.63 rsi)
    ...
    (define L.fun/ascii-char8512.4
      ((new-frames ()) (locals (oprand2.1 oprand1.2 oprand0.3 tmp-ra.77)))
      (begin
        (set! tmp-ra.77 r15)
        (set! oprand0.3 rdi)
        (set! oprand1.2 rsi)
    ...
    (define L.fun/ascii-char8510.5
      ((new-frames ()) (locals (oprand2.4 oprand1.5 oprand0.6 tmp-ra.78)))
      (begin
        (set! tmp-ra.78 r15)
        (set! oprand0.6 rdi)
        (set! oprand1.5 rsi)
    ...
    (define L.fun/ascii-char8511.6
      ((new-frames ()) (locals (oprand2.7 oprand1.8 oprand0.9 tmp-ra.79)))
      (begin
        (set! tmp-ra.79 r15)
        (set! oprand0.9 rdi)
        (set! oprand1.8 rsi)
    ...
    (define L.fun/boolean8513.7
      ((new-frames ()) (locals (oprand2.10 oprand1.11 oprand0.12 tmp-ra.80)))
      (begin
        (set! tmp-ra.80 r15)
        (set! oprand0.12 rdi)
        (set! oprand1.11 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals (empty3.1 ascii-char2.2 ascii-char1.3 error0.4 tmp-ra.58)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (tmp.57 pair3.1 error2.2 error1.3 pair0.4 tmp-ra.65)))
    (define L.void?.11
      ((new-frames ()) (locals (tmp-ra.58 tmp.66 tmp.44 tmp.55)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.44 rdi)
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.58 rbp rax)))))
    (define L.cons.10
      ((new-frames ()) (locals (tmp.54 tmp.67 tmp.56 tmp.51 tmp.50 tmp-ra.59)))
      (begin
        (set! tmp-ra.59 r15)
        (set! tmp.50 rdi)
        (set! tmp.51 rsi)
    ...
    (define L.*.10
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 318) (jump tmp-ra.78 rbp rax)))))
    (define L.cons.9
      ((new-frames ()) (locals (tmp.55 tmp.95 tmp.69 tmp.52 tmp.51 tmp-ra.79)))
      (begin
        (set! tmp-ra.79 r15)
        (set! tmp.51 rdi)
        (set! tmp.52 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.cons.9
      ((new-frames ())
       (locals (tmp.55 tmp.101 tmp.69 tmp.52 tmp.51 tmp-ra.85)))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.51 rdi)
        (set! tmp.52 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.cons.8
      ((new-frames ())
       (locals (tmp.55 tmp.100 tmp.69 tmp.52 tmp.51 tmp-ra.85)))
      (begin
        (set! tmp-ra.85 r15)
        (set! tmp.51 rdi)
        (set! tmp.52 rsi)
    ...
    (define L.+.11
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 574) (jump tmp-ra.78 rbp rax)))))
    (define L.cons.10
      ((new-frames ()) (locals (tmp.55 tmp.96 tmp.69 tmp.52 tmp.51 tmp-ra.79)))
      (begin
        (set! tmp-ra.79 r15)
        (set! tmp.51 rdi)
        (set! tmp.52 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ()))
     (locals
      (void5.1
       ...
       tmp-ra.72)))
    (define L.void?.16
      ((new-frames ()) (locals (tmp-ra.60 tmp.73 tmp.46 tmp.56)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.46 rdi)
        (if (begin
    ...
    (define L.boolean?.15
      ((new-frames ()) (locals (tmp-ra.61 tmp.74 tmp.44 tmp.57)))
      (begin
        (set! tmp-ra.61 r15)
        (set! tmp.44 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals
      (pair5.1 empty4.2 empty3.3 ascii-char2.4 error1.5 error0.6 tmp-ra.71)))
    (define L.cons.17
      ((new-frames ()) (locals (tmp.56 tmp.72 tmp.57 tmp.53 tmp.52 tmp-ra.58)))
      (begin
        (set! tmp-ra.58 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
    ...
    ((new-frames
     ...
     (locals
      (tmp.112
       ...
       tmp-ra.124)))
    (define L.boolean?.15
      ((new-frames ()) (locals (tmp-ra.113 tmp.125 tmp.44 tmp.56)))
      (begin
        (set! tmp-ra.113 r15)
        (set! tmp.44 rdi)
        (if (begin
...
(check-by-interp
 '(module
    ...
    (define L.cons.15
      ((new-frames ())
       (locals (tmp.56 tmp.110 tmp.70 tmp.53 tmp.52 tmp-ra.88)))
      (begin
        (set! tmp-ra.88 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.-.18
      ...
      (begin
        ...
        (if (begin
          ...
          (begin (set! rax 830) (jump tmp-ra.89 rbp rax)))))
    (define L.vector?.17
      ((new-frames ()) (locals (tmp-ra.90 tmp.114 tmp.50 tmp.70)))
      (begin
        (set! tmp-ra.90 r15)
        (set! tmp.50 rdi)
        (if (begin
    ...
    (define L.cons.16
      ((new-frames ())
       (locals (tmp.56 tmp.115 tmp.71 tmp.53 tmp.52 tmp-ra.91)))
      (begin
        (set! tmp-ra.91 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () ()))
     (locals
      (empty5.1 pair4.2 boolean3.3 tmp.59 pair2.4 void1.5 error0.6 tmp-ra.75)))
    (define L.error?.19
      ((new-frames ()) (locals (tmp-ra.60 tmp.76 tmp.48 tmp.57)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.48 rdi)
        (if (begin
          ...
          (begin (set! rax 6) (jump tmp-ra.60 rbp rax)))))
    (define L.cons.18
      ((new-frames ()) (locals (tmp.56 tmp.77 tmp.58 tmp.53 tmp.52 tmp-ra.61)))
      (begin
        (set! tmp-ra.61 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
...
(check-by-interp
 '(module
    ...
    (define L.cons.13
      ((new-frames ())
       (locals (tmp.56 tmp.136 tmp.70 tmp.53 tmp.52 tmp-ra.116)))
      (begin
        (set! tmp-ra.116 r15)
        (set! tmp.52 rdi)
        (set! tmp.53 rsi)
    ...
    ((new-frames (() () () () () () ()))
     (locals
      (ascii-char5.1
       ...
       tmp-ra.75)))
    (define L.pair?.19
      ((new-frames ()) (locals (tmp-ra.60 tmp.76 tmp.49 tmp.57)))
      (begin
        (set! tmp-ra.60 r15)
        (set! tmp.49 rdi)
        (if (begin
