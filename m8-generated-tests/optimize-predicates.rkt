...
(require cpsc411/compiler-lib
         cpsc411/langs/v8
         (only-in "../optimize-predicates.rkt"))
 ...
 '(module
    ...
    (begin
      ...
      (begin
        ...
        (set! rbp (+ rbp 16)))
      (set! r15 rax)
      (if (begin (set! r14 6) (!= r14 6)) (set! r14 43582) (set! r14 65086))
      (begin
        (set! rbp (- rbp 16))
        (return-point L.rp.9
          (begin
...
(check-by-interp
 '(module
    ...
    (begin
      (set! fv0 r15)
      (if (begin (set! r15 6) (!= r15 6)) (set! r15 1712) (set! r15 688))
      (if (begin (set! r14 14) (!= r14 6)) (set! r14 1480) (set! r14 128))
      (begin
        (set! rbp (- rbp 16))
        (return-point L.rp.7
        ...
        (set! rbp (+ rbp 16)))
      (set! fv1 rax)
      (if (begin (set! r15 6) (!= r15 6)) (set! r15 352) (set! r15 264))
      (set! r14 25390)
      (set! r14 13118)
      (set! r14 22)
      (set! r14 608)
      ...
      (if (begin
        ...
        (begin
          (begin
            ...
            (set! rbp (+ rbp 8)))
          (set! r15 rax)
          (if (begin (set! r14 14) (!= r14 6)) (set! r14 1488) (set! r14 1392))
          (set! rsi r14)
          (set! rdi r15)
          (set! r15 fv0)
          (jump L.*.8))
    ...
    (begin
      ...
      (if (begin
            (begin
              ...
              (set! r15 rax))
            (!= r15 6))
        (if (begin (set! r15 6) (!= r15 6)) (set! fv1 22) (set! fv1 22))
        (begin
          (begin
            (set! rbp (- rbp 24))
            (return-point L.rp.18
...
(check-by-interp
 '(module
    (begin
      (set! r15 r15)
      (if (if (begin (set! r14 6) (!= r14 6))
            (begin (set! r14 14) (!= r14 6))
            (begin (set! r14 14) (!= r14 6)))
        (begin
          (set! r14 1720)
          (set! r13 984)
