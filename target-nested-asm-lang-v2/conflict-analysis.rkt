...
;; (asm-pred-lang-v6/undead p) -> (asm-pred-lang-v6/conflicts p)
...
(define (conflict-analysis p)
  ...
  (define (analyze-tree-effect ust effect graph-init)
    (match* (effect ust)
      ...
      [(`(return-point ,label ,tail) _)
        (analyze-tree-tail ust tail graph-init)]))
...
(module+ test
  ...
  (define-syntax-rule (check-by-interp p)
    (check-equal? (interp-asm-pred-lang-v6/undead p)
                  (interp-asm-pred-lang-v6/conflicts (conflict-analysis p))))
  (check-by-interp '(module ((new-frames ()) (locals (ball.2.3 foobar.3.1 bat.9.2 tmp-ra.4))
                                             (call-undead ())
...
(module+ test
   ...
   '(module ((new-frames ())
      ...
      (define L.fn.2.3
        ((new-frames ()) (locals (bar.2.5 bar.7.7
                                          ...
                                          bat.0.10
                                          tmp-ra.20))
                         (undead-out ((rdi rsi rdx rcx r8 r9 fv0 tmp-ra.20 rbp)
                                      ...
                                      ((bat.3.6 bat.5.11 foobar.4.8 bat.0.10 tmp-ra.20 rbp)
                                       ...
                                       ((bat.5.11 bat.3.6 foobar.4.8 tmp-ra.20 rbp)
                                        ((foobar.4.8 tmp.26 tmp-ra.20 rbp) (tmp.26 tmp-ra.20 rbp)
                                                                           (tmp-ra.20 rax rbp)
                                                                           (rax rbp))
              ...
              ((new-frames ()) (locals (bat.6.7 bat.5.2
                               ...
                               (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.11 rbp)
                                            ...
                                            ((foobar.8.1 tmp-ra.11 rbp)
                                             ...
                                             ((foobar.8.1 tmp-ra.11 rbp) (tmp-ra.11 rax rbp)
                                                                         (rax rbp)))))
                               (call-undead ()))
              (begin
                (set! tmp-ra.11 r15)
  ...
  (check-by-interp '(module ((new-frames ()) (locals (tmp.2 tmp-ra.1))
                                             (call-undead ())
                                             (undead-out ((tmp-ra.1 rbp) (tmp.2 tmp-ra.1 rbp)
                                                                         (tmp.2 tmp-ra.1 rbp)
                                                                         (tmp-ra.1 rax rbp)
                                                                         (rax rbp))))
                            (begin
   ...
   '(module ((new-frames ()) (locals (tmp-ra.17 tmp.19))
      ...
      (define L.x.1.2
        ((new-frames ()) (locals (bar.3.14 foobar.8.13 bat.6.12 tmp-ra.16))
                         (undead-out ((rdi rsi rdx tmp-ra.16 rbp)
        ...
        (begin
          ...
          (if (false)
              ...
              (begin
                ...
                (jump L.tmp.1.2 rbp r15 rdi rsi rdx)))))
      (define L.tmp.2.3
        ((new-frames ()) (locals (bat.9.6 bar.1.7 ball.5.8 foobar.7.9 foo.6.10 foobar.2.11 tmp-ra.14))
                         (undead-out ((rdi rsi rdx rcx r8 r9 tmp-ra.14 rbp)
