   ...
   (define L.proc.1.2
     (begin
       ...
       (begin
         ...
         (set! rbp (+ rbp 24)))
       (set! r15 rax)
       (if (begin (set! r15 -59730991) (= r15 fv1))
         (begin (set! rax 0) (jump fv0))
   ...
   (define L.func.0.1
     (begin
       ...
       (if (begin (set! r15 0) (true))
         (if (begin (set! r15 1346978436) (= r15 fv1))
           (begin (set! rax 0) (jump fv0))
           (begin (set! rax fv1) (jump fv0)))
         (begin
           (set! r8 fv2)
...
(check-by-interp '(module
   ...
   (begin
     ...
     (if (begin (set! r15 -9223372036854775808) (false))
       (begin (set! rax -1855219983) (jump fv0))
     ...
     (begin
       ...
       (if (begin (set! r15 r15) (set! r15 r15) (set! r15 r15) (= r15 r15))
         (begin
           ...
           (set! r15 fv0)
           (jump L.tmp.1.2))
         (begin (set! rdi r15) (set! r15 fv0) (jump L.func.0.1)))))
   (begin
     (set! r15 r15)
     (begin
       (set! r14 9223372036854775807)
...
(check-by-interp '(module
   ...
   (define L.proc.1.2
     (begin
       ...
       (set! r15 rax)
       (set! r14 fv1)
       (if (>= fv1 fv1) (set! r14 fv1) (set! r14 fv1))
       (set! r15 r15)
       (set! r15 r15)
       (set! r15 -9223372036854775808)
       (set! rax 9223372036854775807)
     ...
     (begin
       ...
       (if (not (begin (set! r14 0) (false)))
         (begin
           ...
           (jump fv1))
         (if (<= fv4 0)
           (begin (set! rax fv4) (jump fv1))
           (begin (set! rax fv3) (jump fv1))))))
   (define L.fn.1.2
     (begin
       (set! r15 r15)
       (set! r14 rdi)
...
(check-by-interp '(module
   ...
   (define L.tmp.1.2
     (begin
       ...
       (set! r14 (- r14 fv6))
       (set! r14 r14)
       (if (= fv6 r15) (set! r14 r15) (set! r14 fv6))
       (set! fv0 r15)
       (set! r9 -9223372036854775808)
       (set! r8 fv3)
       (set! rcx r14)
...
(check-by-interp '(module
   (define L.func.0.1
     (begin
       ...
       (if (begin
             (set! r14 fv3)
             (if (<= fv4 fv1) (set! r14 fv4) (set! r14 fv1))
             (begin
               (begin
                 (set! rbp (- rbp 40))
                 (return-point L.rp.3
     ...
     (begin
       ...
       (if (not (> fv0 -727829088))
         (begin
           ...
           (set! rax fv2)
           (jump fv1))
         (begin (set! rax -774243080) (jump fv1)))))
   (define L.fn.1.2
     (begin
       (set! r15 r15)
       (set! rdi rdi)
...
(check-by-interp '(module
   ...
   (define L.x.2.3
     (begin
       ...
       (set! r15 (- r15 r15))
       (set! r15 r15)
       (if (<= r15 fv1) (set! r14 r15) (set! r14 fv1))
       (set! r15 r15)
       (set! r14 fv1)
       (set! r14 r15)
       (set! r15 r15)
