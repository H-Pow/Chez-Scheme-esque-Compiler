...
(check-by-interp
 '(module
    ...
    (define L.pair?.65.7
      (lambda (c.66 tmp.56)
        (let ()
          (if (let ((tmp.78 (bitwise-and tmp.56 7))) (= tmp.78 1)) 14 6))))
    (let ((pair?.65
           (let ((tmp.72 (let ((tmp.79 (alloc 16))) (+ tmp.79 2))))
             (begin (mset! tmp.72 -2 L.pair?.65.7) (mset! tmp.72 6 8) tmp.72)))
          (fun/void8617.4
           (let ((tmp.73 (let ((tmp.80 (alloc 16))) (+ tmp.80 2))))
             (begin
               (mset! tmp.73 -2 L.fun/void8617.4.8)
               (mset! tmp.73 6 0)
               tmp.73)))
          (fun/void8621.5
           (let ((tmp.74 (let ((tmp.81 (alloc 16))) (+ tmp.81 2))))
             (begin
          ...
          (fun/ascii-char8619.6
           (let ((tmp.75 (let ((tmp.82 (alloc 16))) (+ tmp.82 2))))
             (begin
               ...
               tmp.75)))
          (fun/any8618.7
           (let ((tmp.76 (let ((tmp.83 (alloc 16))) (+ tmp.83 2))))
             (begin
               (mset! tmp.76 -2 L.fun/any8618.7.11)
               (mset! tmp.76 6 0)
               tmp.76)))
          (fun/void8620.8
           (let ((tmp.77 (let ((tmp.84 (alloc 16))) (+ tmp.84 2))))
             (begin
      ...
      (let ((void0.12 (call L.fun/void8617.4.8 fun/void8617.4))
            (boolean1.11
             (let ((tmp.85 (call L.fun/any8618.7.11 fun/any8618.7)))
 ...
 '(module
    ...
    (define L.make-vector.71.12
      (lambda (c.80 tmp.47)
        (let ((make-init-vector.1 (mref c.80 14)))
          (if (let ((tmp.108
                     (if (let ((tmp.109 (bitwise-and tmp.47 7))) (= tmp.109 0))
                       14
                       6)))
                (!= tmp.108 6))
    ...
    (define L.vector-init-loop.21.10
      (lambda (c.78 len.22 i.24 vec.23)
        (let ((vector-init-loop.21 (mref c.78 14)))
          (if (let ((tmp.114 (if (= len.22 i.24) 14 6))) (!= tmp.114 6))
            vec.23
            (begin
              (let ((tmp.115
                     (let ((tmp.116
                            (let ((tmp.117 (arithmetic-shift-right i.24 3)))
                              (* tmp.117 8))))
                       (+ tmp.116 5))))
    ...
    (define L.-.72.9
      (lambda (c.77 tmp.37 tmp.38)
        (let ()
          (if (let ((tmp.119
                     (if (let ((tmp.120 (bitwise-and tmp.38 7))) (= tmp.120 0))
                       14
                       6)))
                (!= tmp.119 6))
            (if (let ((tmp.121
                       (if (let ((tmp.122 (bitwise-and tmp.37 7)))
                             (= tmp.122 0))
                         14
                         6)))
                  (!= tmp.121 6))
    ...
    (define L.*.73.8
      (lambda (c.76 tmp.33 tmp.34)
        (let ()
          (if (let ((tmp.123
                     (if (let ((tmp.124 (bitwise-and tmp.34 7))) (= tmp.124 0))
                       14
                       6)))
                (!= tmp.123 6))
            (if (let ((tmp.125
                       (if (let ((tmp.126 (bitwise-and tmp.33 7)))
                             (= tmp.126 0))
                         14
                         6)))
                  (!= tmp.125 6))
              (let ((tmp.127 (arithmetic-shift-right tmp.34 3)))
                (* tmp.33 tmp.127))
              318)
            318))))
    (define L.+.74.7
      (lambda (c.75 tmp.35 tmp.36)
        (let ()
          (if (let ((tmp.128
                     (if (let ((tmp.129 (bitwise-and tmp.36 7))) (= tmp.129 0))
                       14
                       6)))
                (!= tmp.128 6))
            (if (let ((tmp.130
                       (if (let ((tmp.131 (bitwise-and tmp.35 7)))
                             (= tmp.131 0))
                         14
                         6)))
                  (!= tmp.130 6))
            ...
            574))))
    (let ((|+.74|
           (let ((tmp.92 (let ((tmp.132 (alloc 16))) (+ tmp.132 2))))
             (begin (mset! tmp.92 -2 L.+.74.7) (mset! tmp.92 6 16) tmp.92)))
          (*.73
           (let ((tmp.93 (let ((tmp.133 (alloc 16))) (+ tmp.133 2))))
             (begin (mset! tmp.93 -2 L.*.73.8) (mset! tmp.93 6 16) tmp.93)))
          (|-.72|
           (let ((tmp.94 (let ((tmp.134 (alloc 16))) (+ tmp.134 2))))
             (begin (mset! tmp.94 -2 L.-.72.9) (mset! tmp.94 6 16) tmp.94)))
          (vector-init-loop.21
           (let ((tmp.95 (let ((tmp.135 (alloc 24))) (+ tmp.135 2))))
             (begin
               (mset! tmp.95 -2 L.vector-init-loop.21.10)
               (mset! tmp.95 6 24)
               tmp.95)))
          (make-init-vector.1
           (let ((tmp.96 (let ((tmp.136 (alloc 24))) (+ tmp.136 2))))
             (begin
               (mset! tmp.96 -2 L.make-init-vector.1.11)
               (mset! tmp.96 6 8)
               tmp.96)))
          (make-vector.71
           (let ((tmp.97 (let ((tmp.137 (alloc 24))) (+ tmp.137 2))))
             (begin
               (mset! tmp.97 -2 L.make-vector.71.12)
               (mset! tmp.97 6 8)
               tmp.97)))
          (fun/vector9289.4
           (let ((tmp.98 (let ((tmp.138 (alloc 24))) (+ tmp.138 2))))
             (begin
               (mset! tmp.98 -2 L.fun/vector9289.4.13)
               (mset! tmp.98 6 0)
               tmp.98)))
          (fun/error9287.5
           (let ((tmp.99 (let ((tmp.139 (alloc 24))) (+ tmp.139 2))))
             (begin
               (mset! tmp.99 -2 L.fun/error9287.5.14)
               (mset! tmp.99 6 0)
               tmp.99)))
          (fun/vector9290.6
           (let ((tmp.100 (let ((tmp.140 (alloc 24))) (+ tmp.140 2))))
             (begin
               (mset! tmp.100 -2 L.fun/vector9290.6.15)
               (mset! tmp.100 6 0)
               tmp.100)))
          (fun/error9288.7
           (let ((tmp.101 (let ((tmp.141 (alloc 16))) (+ tmp.141 2))))
             (begin
               (mset! tmp.101 -2 L.fun/error9288.7.16)
               (mset! tmp.101 6 0)
               tmp.101)))
          (fun/vector9292.8
           (let ((tmp.102 (let ((tmp.142 (alloc 24))) (+ tmp.142 2))))
             (begin
               (mset! tmp.102 -2 L.fun/vector9292.8.17)
               (mset! tmp.102 6 0)
               tmp.102)))
          (fun/empty9296.9
           (let ((tmp.103 (let ((tmp.143 (alloc 16))) (+ tmp.143 2))))
             (begin
               (mset! tmp.103 -2 L.fun/empty9296.9.18)
               (mset! tmp.103 6 0)
               tmp.103)))
          (fun/empty9295.10
           (let ((tmp.104 (let ((tmp.144 (alloc 24))) (+ tmp.144 2))))
             (begin
               (mset! tmp.104 -2 L.fun/empty9295.10.19)
               (mset! tmp.104 6 0)
               tmp.104)))
          (fun/vector9291.11
           (let ((tmp.105 (let ((tmp.145 (alloc 24))) (+ tmp.145 2))))
             (begin
               (mset! tmp.105 -2 L.fun/vector9291.11.20)
               (mset! tmp.105 6 0)
               tmp.105)))
          (fun/ascii-char9294.12
           (let ((tmp.106 (let ((tmp.146 (alloc 16))) (+ tmp.146 2))))
             (begin
               (mset! tmp.106 -2 L.fun/ascii-char9294.12.21)
               (mset! tmp.106 6 0)
               tmp.106)))
          (fun/ascii-char9293.13
           (let ((tmp.107 (let ((tmp.147 (alloc 24))) (+ tmp.147 2))))
             (begin
      ...
      (begin
        ...
        (let ((error0.18 (call L.fun/error9287.5.14 fun/error9287.5))
              (fixnum1.17
               (let ((tmp.148
                      (let ((tmp.149 (call L.-.72.9 |-.72| 80 1456)))
                        (let ((tmp.150 (call L.*.73.8 *.73 1808 1976)))
                          (call L.+.74.7 |+.74| tmp.149 tmp.150)))))
                 (let ((tmp.151
                        (let ((tmp.152 (call L.+.74.7 |+.74| 280 1096)))
                          (let ((tmp.153 (call L.+.74.7 |+.74| 1328 424)))
...
(check-by-interp
 '(module
    ...
    (define L.vector?.72.7
      (lambda (c.73 tmp.64)
        (let ()
          (if (let ((tmp.97 (bitwise-and tmp.64 7))) (= tmp.97 3)) 14 6))))
    (let ((vector?.72
           (let ((tmp.85 (let ((tmp.98 (alloc 16))) (+ tmp.98 2))))
             (begin
               (mset! tmp.85 -2 L.vector?.72.7)
               (mset! tmp.85 6 8)
               tmp.85)))
          (fun/void9337.4
           (let ((tmp.86 (let ((tmp.99 (alloc 24))) (+ tmp.99 2))))
             (begin
          ...
          (fun/ascii-char9340.6
           (let ((tmp.88 (let ((tmp.101 (alloc 24))) (+ tmp.101 2))))
             (begin
               ...
               tmp.88)))
          (fun/void9345.7
           (let ((tmp.89 (let ((tmp.102 (alloc 16))) (+ tmp.102 2))))
             (begin
      ...
      (begin
        ...
        (let ((void0.19 (call L.fun/void9337.4.8 fun/void9337.4))
              (boolean1.18
               (let ((tmp.110 (call L.fun/any9339.5.9 fun/any9339.5)))
...
(check-by-interp
 '(module
    (define L.lam.74.22
      (lambda (c.90)
        (let ((fun/any10243.13 (mref c.90 14)) (vector?.73 (mref c.90 22)))
          (let ((tmp.108 (call L.fun/any10243.13.21 fun/any10243.13)))
    ...
    (define L.make-vector.71.11
      (lambda (c.79 tmp.47)
        (let ((make-init-vector.1 (mref c.79 14)))
          (if (let ((tmp.109
                     (if (let ((tmp.110 (bitwise-and tmp.47 7))) (= tmp.110 0))
                       14
                       6)))
                (!= tmp.109 6))
    ...
    (define L.vector-init-loop.21.9
      (lambda (c.77 len.22 i.24 vec.23)
        (let ((vector-init-loop.21 (mref c.77 14)))
          (if (let ((tmp.115 (if (= len.22 i.24) 14 6))) (!= tmp.115 6))
            vec.23
            (begin
              (let ((tmp.116
                     (let ((tmp.117
                            (let ((tmp.118 (arithmetic-shift-right i.24 3)))
                              (* tmp.118 8))))
                       (+ tmp.117 5))))
    ...
    (define L.void?.72.8
      (lambda (c.76 tmp.59)
        (let ()
          (if (let ((tmp.120 (bitwise-and tmp.59 255))) (= tmp.120 30))
            14
            6))))
    (define L.vector?.73.7
      (lambda (c.75 tmp.63)
        (let ()
          (if (let ((tmp.121 (bitwise-and tmp.63 7))) (= tmp.121 3)) 14 6))))
    (let ((vector?.73
           (let ((tmp.92 (let ((tmp.122 (alloc 16))) (+ tmp.122 2))))
             (begin
          ...
          (fun/empty10247.4
           (let ((tmp.97 (let ((tmp.127 (alloc 16))) (+ tmp.127 2))))
             (begin
               ...
               tmp.97)))
          (fun/vector10251.5
           (let ((tmp.98 (let ((tmp.128 (alloc 24))) (+ tmp.128 2))))
             (begin
          ...
          (fun/empty10248.8
           (let ((tmp.101 (let ((tmp.131 (alloc 24))) (+ tmp.131 2))))
             (begin
               ...
               tmp.101)))
          (fun/error10245.9
           (let ((tmp.102 (let ((tmp.132 (alloc 16))) (+ tmp.132 2))))
             (begin
          ...
          (fun/error10244.11
           (let ((tmp.104 (let ((tmp.134 (alloc 24))) (+ tmp.134 2))))
             (begin
               ...
               tmp.104)))
          (fun/any10242.12
           (let ((tmp.105 (let ((tmp.135 (alloc 16))) (+ tmp.135 2))))
             (begin
      ...
      (begin
        ...
        (let ((boolean0.18
               (let ((tmp.137 (call L.fun/any10242.12.20 fun/any10242.12)))
                 (call L.void?.72.8 void?.72 tmp.137)))
              (procedure1.17
               (let ((lam.74
                      (let ((tmp.107
                             (let ((tmp.138 (alloc 32))) (+ tmp.138 2))))
                        (begin
    ...
    (define L.make-vector.73.9
      (lambda (c.76 tmp.49)
        (let ((make-init-vector.1 (mref c.76 14)))
          (if (let ((tmp.105
                     (if (let ((tmp.106 (bitwise-and tmp.49 7))) (= tmp.106 0))
                       14
                       6)))
                (!= tmp.105 6))
            (call L.make-init-vector.1.8 make-init-vector.1 tmp.49)
    ...
    (define L.vector-init-loop.23.7
      (lambda (c.74 len.24 i.26 vec.25)
        (let ((vector-init-loop.23 (mref c.74 14)))
          (if (let ((tmp.111 (if (= len.24 i.26) 14 6))) (!= tmp.111 6))
            vec.25
            (begin
              (let ((tmp.112
                     (let ((tmp.113
                            (let ((tmp.114 (arithmetic-shift-right i.26 3)))
                              (* tmp.114 8))))
                       (+ tmp.113 5))))
              ...
              (let ((tmp.115 (+ i.26 8)))
                (call
                 ...
                 vec.25)))))))
    (let ((vector-init-loop.23
           (let ((tmp.90 (let ((tmp.116 (alloc 24))) (+ tmp.116 2))))
             (begin
               (mset! tmp.90 -2 L.vector-init-loop.23.7)
               (mset! tmp.90 6 24)
               tmp.90)))
          (make-init-vector.1
           (let ((tmp.91 (let ((tmp.117 (alloc 24))) (+ tmp.117 2))))
             (begin
               (mset! tmp.91 -2 L.make-init-vector.1.8)
               (mset! tmp.91 6 8)
               tmp.91)))
          (make-vector.73
           (let ((tmp.92 (let ((tmp.118 (alloc 24))) (+ tmp.118 2))))
             (begin
          ...
          (fun/void10770.4
           (let ((tmp.93 (let ((tmp.119 (alloc 24))) (+ tmp.119 2))))
             (begin
               ...
               tmp.93)))
          (fun/void10777.5
           (let ((tmp.94 (let ((tmp.120 (alloc 16))) (+ tmp.120 2))))
             (begin
          ...
          (fun/ascii-char10778.12
           (let ((tmp.101 (let ((tmp.127 (alloc 24))) (+ tmp.127 2))))
             (begin
               (mset! tmp.101 -2 L.fun/ascii-char10778.12.18)
               (mset! tmp.101 6 0)
               tmp.101)))
          (fun/ascii-char10779.13
           (let ((tmp.102 (let ((tmp.128 (alloc 16))) (+ tmp.128 2))))
             (begin
               (mset! tmp.102 -2 L.fun/ascii-char10779.13.19)
               (mset! tmp.102 6 0)
               tmp.102)))
          (fun/vector10781.14
           (let ((tmp.103 (let ((tmp.129 (alloc 24))) (+ tmp.129 2))))
             (begin
               (mset! tmp.103 -2 L.fun/vector10781.14.20)
               (mset! tmp.103 6 0)
               tmp.103)))
          (fun/vector10780.15
           (let ((tmp.104 (let ((tmp.130 (alloc 24))) (+ tmp.130 2))))
             (begin
 ...
 '(module
    ...
    (define L.-.74.9
      (lambda (c.80 tmp.40 tmp.41)
        (let ()
          (if (let ((tmp.110
                     (if (let ((tmp.111 (bitwise-and tmp.41 7))) (= tmp.111 0))
                       14
                       6)))
                (!= tmp.110 6))
            (if (let ((tmp.112
                       (if (let ((tmp.113 (bitwise-and tmp.40 7)))
                             (= tmp.113 0))
                         14
                         6)))
                  (!= tmp.112 6))
    ...
    (define L.+.75.8
      (lambda (c.79 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.114
                     (if (let ((tmp.115 (bitwise-and tmp.39 7))) (= tmp.115 0))
                       14
                       6)))
                (!= tmp.114 6))
            (if (let ((tmp.116
                       (if (let ((tmp.117 (bitwise-and tmp.38 7)))
                             (= tmp.117 0))
                         14
                         6)))
                  (!= tmp.116 6))
    ...
    (define L.*.76.7
      (lambda (c.78 tmp.36 tmp.37)
        (let ()
          (if (let ((tmp.118
                     (if (let ((tmp.119 (bitwise-and tmp.37 7))) (= tmp.119 0))
                       14
                       6)))
                (!= tmp.118 6))
            (if (let ((tmp.120
                       (if (let ((tmp.121 (bitwise-and tmp.36 7)))
                             (= tmp.121 0))
                         14
                         6)))
                  (!= tmp.120 6))
              (let ((tmp.122 (arithmetic-shift-right tmp.37 3)))
                (* tmp.36 tmp.122))
              318)
            318))))
    (let ((*.76
           (let ((tmp.94 (let ((tmp.123 (alloc 16))) (+ tmp.123 2))))
             (begin (mset! tmp.94 -2 L.*.76.7) (mset! tmp.94 6 16) tmp.94)))
          (|+.75|
           (let ((tmp.95 (let ((tmp.124 (alloc 16))) (+ tmp.124 2))))
             (begin (mset! tmp.95 -2 L.+.75.8) (mset! tmp.95 6 16) tmp.95)))
          (|-.74|
           (let ((tmp.96 (let ((tmp.125 (alloc 16))) (+ tmp.125 2))))
          ...
          (fun/void11010.5
           (let ((tmp.98 (let ((tmp.127 (alloc 24))) (+ tmp.127 2))))
             (begin
               ...
               tmp.98)))
          (fun/void11007.6
           (let ((tmp.99 (let ((tmp.128 (alloc 16))) (+ tmp.128 2))))
             (begin
               (mset! tmp.99 -2 L.fun/void11007.6.12)
               (mset! tmp.99 6 0)
               tmp.99)))
          (fun/empty11017.7
           (let ((tmp.100 (let ((tmp.129 (alloc 16))) (+ tmp.129 2))))
             (begin
      ...
      (begin
        ...
        (let ((fixnum0.21
               (let ((tmp.138
                      (let ((tmp.139
                             (let ((tmp.140 (call L.-.74.9 |-.74| 1352 32)))
                               (let ((tmp.141 (call L.+.75.8 |+.75| 1704 736)))
                                 (call L.-.74.9 |-.74| tmp.140 tmp.141)))))
                        (let ((tmp.142
                               (let ((tmp.143 (call L.*.76.7 *.76 1440 104)))
                                 (let ((tmp.144
                 ...
                 (let ((tmp.145
                        (let ((tmp.146
                               (let ((tmp.147 (call L.*.76.7 *.76 0 1528)))
                                 (let ((tmp.148
              ...
              (procedure2.19
               (let ((lam.77
                      (let ((tmp.109
                             (let ((tmp.152 (alloc 24))) (+ tmp.152 2))))
                        (begin
 ...
 '(module
    (define L.lam.75.20
      (lambda (c.89)
        (let ((|-.72| (mref c.89 14))
          ...
          (let ((tmp.104
                 (let ((tmp.105
                        (let ((tmp.106 (call L.-.72.9 |-.72| 1200 328)))
                          (let ((tmp.107 (call L.-.72.9 |-.72| 1384 800)))
                            (call L.*.73.8 *.73 tmp.106 tmp.107)))))
                   (let ((tmp.108
                          (let ((tmp.109 (call L.+.74.7 |+.74| 1704 736)))
                            (let ((tmp.110 (call L.+.74.7 |+.74| 328 480)))
                              (call L.+.74.7 |+.74| tmp.109 tmp.110)))))
                     (call L.+.74.7 |+.74| tmp.105 tmp.108)))))
            (let ((tmp.111
                   (let ((tmp.112
                          (let ((tmp.113 (call L.+.74.7 |+.74| 16 32)))
                            (let ((tmp.114 (call L.+.74.7 |+.74| 624 1912)))
                              (call L.+.74.7 |+.74| tmp.113 tmp.114)))))
                     (let ((tmp.115
                            (let ((tmp.116 (call L.*.73.8 *.73 1824 1352)))
                              (let ((tmp.117 (call L.+.74.7 |+.74| 1584 344)))
    ...
    (define L.-.72.9
      (lambda (c.78 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.118
                     (if (let ((tmp.119 (bitwise-and tmp.39 7))) (= tmp.119 0))
                       14
                       6)))
                (!= tmp.118 6))
            (if (let ((tmp.120
                       (if (let ((tmp.121 (bitwise-and tmp.38 7)))
                             (= tmp.121 0))
                         14
                         6)))
                  (!= tmp.120 6))
          ...
          (if (let ((tmp.122
            ...
            (if (let ((tmp.124
                       (if (let ((tmp.125 (bitwise-and tmp.34 7)))
                         ...
                         6)))
                  (!= tmp.124 6))
              (let ((tmp.126 (arithmetic-shift-right tmp.35 3)))
                (* tmp.34 tmp.126))
              318)
            318))))
    (define L.+.74.7
      (lambda (c.76 tmp.36 tmp.37)
        (let ()
          (if (let ((tmp.127
                     (if (let ((tmp.128 (bitwise-and tmp.37 7))) (= tmp.128 0))
                       14
                       6)))
                (!= tmp.127 6))
            (if (let ((tmp.129
                       (if (let ((tmp.130 (bitwise-and tmp.36 7)))
                             (= tmp.130 0))
                         14
                         6)))
                  (!= tmp.129 6))
            ...
            574))))
    (let ((|+.74|
           (let ((tmp.90 (let ((tmp.131 (alloc 16))) (+ tmp.131 2))))
             (begin (mset! tmp.90 -2 L.+.74.7) (mset! tmp.90 6 16) tmp.90)))
          (*.73
           (let ((tmp.91 (let ((tmp.132 (alloc 16))) (+ tmp.132 2))))
             (begin (mset! tmp.91 -2 L.*.73.8) (mset! tmp.91 6 16) tmp.91)))
          (|-.72|
           (let ((tmp.92 (let ((tmp.133 (alloc 16))) (+ tmp.133 2))))
             (begin (mset! tmp.92 -2 L.-.72.9) (mset! tmp.92 6 16) tmp.92)))
          (fun/error11878.4
           (let ((tmp.93 (let ((tmp.134 (alloc 16))) (+ tmp.134 2))))
             (begin
               (mset! tmp.93 -2 L.fun/error11878.4.10)
               (mset! tmp.93 6 0)
               tmp.93)))
          (fun/error11879.5
           (let ((tmp.94 (let ((tmp.135 (alloc 24))) (+ tmp.135 2))))
             (begin
          ...
          (fun/ascii-char11874.9
           (let ((tmp.98 (let ((tmp.139 (alloc 16))) (+ tmp.139 2))))
             (begin
          ...
          (fun/ascii-char11875.13
           (let ((tmp.102 (let ((tmp.143 (alloc 24))) (+ tmp.143 2))))
             (begin
      ...
      (begin
        ...
        (let ((procedure0.19
               (let ((lam.75
                      (let ((tmp.103
                             (let ((tmp.144 (alloc 40))) (+ tmp.144 2))))
                        (begin
          ...
          (let ((tmp.145
                 (let ((tmp.146
                        (let ((tmp.147 (call L.-.72.9 |-.72| 568 240)))
                          (let ((tmp.148
                                 (if (let ((tmp.149
                                            (if (let ((tmp.150
                                                       (bitwise-and
                                   ...
                                   (if (let ((tmp.151
                                              (if (let ((tmp.152
                                                ...
                                                6)))
                                         (!= tmp.151 6))
                                     (let ((tmp.153 (mref procedure0.19 -2)))
                   ...
                   (let ((tmp.154
                          (if (let ((tmp.155
                            ...
                            (if (let ((tmp.157
                                       (if (let ((tmp.158
                                                  (mref procedure0.19 6)))
                                             (= tmp.158 0))
                                         14
                                         6)))
                                  (!= tmp.157 6))
                              (let ((tmp.159 (mref procedure0.19 -2)))
            ...
            (let ((tmp.160
                   (if (let ((tmp.161
                         ...
                         (!= tmp.161 6))
                     (if (let ((tmp.163
                                (if (let ((tmp.164 (mref procedure0.19 6)))
                                      (= tmp.164 0))
                                  14
                                  6)))
                           (!= tmp.163 6))
                       (let ((tmp.165 (mref procedure0.19 -2)))
...
(check-by-interp
 '(module
    ...
    (define L.empty?.77.7
      (lambda (c.78 tmp.63)
        (let ()
          (if (let ((tmp.112 (bitwise-and tmp.63 255))) (= tmp.112 22))
            14
            6))))
    (let ((empty?.77
          ...
          (fun/ascii-char12698.4
           (let ((tmp.97 (let ((tmp.115 (alloc 24))) (+ tmp.115 2))))
             (begin
          ...
          (fun/any12703.6
           (let ((tmp.99 (let ((tmp.117 (alloc 24))) (+ tmp.117 2))))
             (begin
               ...
               tmp.99)))
          (fun/empty12692.7
           (let ((tmp.100 (let ((tmp.118 (alloc 24))) (+ tmp.118 2))))
             (begin
          ...
          (fun/void12701.9
           (let ((tmp.102 (let ((tmp.120 (alloc 16))) (+ tmp.120 2))))
             (begin
               ...
               tmp.102)))
          (fun/error12697.10
           (let ((tmp.103 (let ((tmp.121 (alloc 16))) (+ tmp.121 2))))
             (begin
               (mset! tmp.103 -2 L.fun/error12697.10.15)
               (mset! tmp.103 6 0)
               tmp.103)))
          (fun/any12702.11
           (let ((tmp.104 (let ((tmp.122 (alloc 24))) (+ tmp.122 2))))
             (begin
          ...
          (fun/ascii-char12705.14
           (let ((tmp.107 (let ((tmp.125 (alloc 16))) (+ tmp.125 2))))
             (begin
               (mset! tmp.107 -2 L.fun/ascii-char12705.14.19)
               (mset! tmp.107 6 0)
               tmp.107)))
          (fun/empty12695.15
           (let ((tmp.108 (let ((tmp.126 (alloc 16))) (+ tmp.126 2))))
             (begin
      ...
      (begin
        ...
        (let ((empty0.23 (call L.fun/empty12692.7.12 fun/empty12692.7))
              ...
              (boolean5.18
               (let ((tmp.129 (call L.fun/any12702.11.16 fun/any12702.11)))
 ...
 '(module
    (define L.lam.77.22
      (lambda (c.93)
        (let ((*.75 (mref c.93 14))
          ...
          (let ((tmp.110
                 (let ((tmp.111
                        (let ((tmp.112 (call L.-.74.9 |-.74| 1360 864)))
                          (let ((tmp.113 (call L.*.75.8 *.75 992 728)))
                            (call L.*.75.8 *.75 tmp.112 tmp.113)))))
                   (let ((tmp.114
                          (let ((tmp.115 (call L.+.76.7 |+.76| 1568 992)))
                            (let ((tmp.116 (call L.-.74.9 |-.74| 232 1656)))
                              (call L.-.74.9 |-.74| tmp.115 tmp.116)))))
                     (call L.+.76.7 |+.76| tmp.111 tmp.114)))))
            (let ((tmp.117
                   (let ((tmp.118
                          (let ((tmp.119 (call L.-.74.9 |-.74| 592 200)))
                            (let ((tmp.120 (call L.*.75.8 *.75 320 1800)))
                              (call L.+.76.7 |+.76| tmp.119 tmp.120)))))
                     (let ((tmp.121
                            (let ((tmp.122 (call L.+.76.7 |+.76| 736 1392)))
                              (let ((tmp.123 (call L.*.75.8 *.75 1768 1576)))
    ...
    (define L.-.74.9
      (lambda (c.80 tmp.40 tmp.41)
        (let ()
          (if (let ((tmp.124
                     (if (let ((tmp.125 (bitwise-and tmp.41 7))) (= tmp.125 0))
                       14
                       6)))
                (!= tmp.124 6))
            (if (let ((tmp.126
                       (if (let ((tmp.127 (bitwise-and tmp.40 7)))
                             (= tmp.127 0))
                         14
                         6)))
                  (!= tmp.126 6))
    ...
    (define L.*.75.8
      (lambda (c.79 tmp.36 tmp.37)
        (let ()
          (if (let ((tmp.128
                     (if (let ((tmp.129 (bitwise-and tmp.37 7))) (= tmp.129 0))
                       14
                       6)))
                (!= tmp.128 6))
            (if (let ((tmp.130
                       (if (let ((tmp.131 (bitwise-and tmp.36 7)))
                             (= tmp.131 0))
                         14
                         6)))
                  (!= tmp.130 6))
              (let ((tmp.132 (arithmetic-shift-right tmp.37 3)))
                (* tmp.36 tmp.132))
              318)
            318))))
    (define L.+.76.7
      (lambda (c.78 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.133
            ...
            574))))
    (let ((|+.76|
           (let ((tmp.94 (let ((tmp.137 (alloc 16))) (+ tmp.137 2))))
             (begin (mset! tmp.94 -2 L.+.76.7) (mset! tmp.94 6 16) tmp.94)))
          (*.75
           (let ((tmp.95 (let ((tmp.138 (alloc 16))) (+ tmp.138 2))))
             (begin (mset! tmp.95 -2 L.*.75.8) (mset! tmp.95 6 16) tmp.95)))
          (|-.74|
           (let ((tmp.96 (let ((tmp.139 (alloc 16))) (+ tmp.139 2))))
             (begin (mset! tmp.96 -2 L.-.74.9) (mset! tmp.96 6 16) tmp.96)))
          (fun/ascii-char12715.4
           (let ((tmp.97 (let ((tmp.140 (alloc 16))) (+ tmp.140 2))))
             (begin
          ...
          (fun/ascii-char12713.6
           (let ((tmp.99 (let ((tmp.142 (alloc 16))) (+ tmp.142 2))))
             (begin
               (mset! tmp.99 -2 L.fun/ascii-char12713.6.12)
               (mset! tmp.99 6 0)
               tmp.99)))
          (fun/ascii-char12710.7
           (let ((tmp.100 (let ((tmp.143 (alloc 24))) (+ tmp.143 2))))
             (begin
      ...
      (begin
        ...
        (let ((error0.21 (call L.fun/error12708.15.21 fun/error12708.15))
              (procedure1.20
               (let ((lam.77
                      (let ((tmp.109
                             (let ((tmp.152 (alloc 40))) (+ tmp.152 2))))
                        (begin
                          (mset! tmp.109 -2 L.lam.77.22)
                          (mset! tmp.109 6 0)
                          tmp.109))))
 ...
 '(module
    ...
    (define L.*.72.9
      (lambda (c.77 tmp.34 tmp.35)
        (let ()
          (if (let ((tmp.101
                     (if (let ((tmp.102 (bitwise-and tmp.35 7))) (= tmp.102 0))
                       14
                       6)))
                (!= tmp.101 6))
            (if (let ((tmp.103
                       (if (let ((tmp.104 (bitwise-and tmp.34 7)))
                             (= tmp.104 0))
                         14
                         6)))
                  (!= tmp.103 6))
              (let ((tmp.105 (arithmetic-shift-right tmp.35 3)))
                (* tmp.34 tmp.105))
              318)
            318))))
    (define L.-.73.8
      (lambda (c.76 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.106
                     (if (let ((tmp.107 (bitwise-and tmp.39 7))) (= tmp.107 0))
                       14
                       6)))
                (!= tmp.106 6))
            (if (let ((tmp.108
                       (if (let ((tmp.109 (bitwise-and tmp.38 7)))
                             (= tmp.109 0))
                         14
                         6)))
                  (!= tmp.108 6))
    ...
    (define L.+.74.7
      (lambda (c.75 tmp.36 tmp.37)
        (let ()
          (if (let ((tmp.110
                     (if (let ((tmp.111 (bitwise-and tmp.37 7))) (= tmp.111 0))
                       14
                       6)))
                (!= tmp.110 6))
            (if (let ((tmp.112
                       (if (let ((tmp.113 (bitwise-and tmp.36 7)))
                             (= tmp.113 0))
                         14
                         6)))
                  (!= tmp.112 6))
    ...
    (let ((|+.74|
          ...
          (fun/ascii-char14517.9
           (let ((tmp.96 (let ((tmp.122 (alloc 16))) (+ tmp.122 2))))
             (begin
               (mset! tmp.96 -2 L.fun/ascii-char14517.9.15)
               (mset! tmp.96 6 0)
               tmp.96)))
          (fun/error14508.10
           (let ((tmp.97 (let ((tmp.123 (alloc 24))) (+ tmp.123 2))))
             (begin
          ...
          (fun/error14509.11
           (let ((tmp.98 (let ((tmp.124 (alloc 16))) (+ tmp.124 2))))
             (begin
               ...
               tmp.98)))
          (fun/error14512.12
           (let ((tmp.99 (let ((tmp.125 (alloc 24))) (+ tmp.125 2))))
             (begin
               (mset! tmp.99 -2 L.fun/error14512.12.18)
               (mset! tmp.99 6 0)
               tmp.99)))
          (fun/error14513.13
           (let ((tmp.100 (let ((tmp.126 (alloc 16))) (+ tmp.126 2))))
             (begin
      ...
      (begin
        ...
        (let ((error0.19 (call L.fun/error14508.10.16 fun/error14508.10))
              (fixnum1.18
               (let ((tmp.127
                      (let ((tmp.128
                             (let ((tmp.129 (call L.*.72.9 *.72 1960 824)))
                               (let ((tmp.130 (call L.-.73.8 |-.73| 112 728)))
                                 (call L.+.74.7 |+.74| tmp.129 tmp.130)))))
                        (let ((tmp.131
                               (let ((tmp.132 (call L.*.72.9 *.72 976 520)))
                                 (let ((tmp.133 (call L.*.72.9 *.72 472 392)))
              ...
              (fixnum2.17
               (let ((tmp.141
                      (let ((tmp.142
                             (let ((tmp.143 (call L.-.73.8 |-.73| 224 1744)))
                               (let ((tmp.144
                                      (call L.+.74.7 |+.74| 1752 1304)))
                                 (call L.*.72.9 *.72 tmp.143 tmp.144)))))
                        (let ((tmp.145
                               (let ((tmp.146 (call L.-.73.8 |-.73| 264 344)))
                                 (let ((tmp.147
                 ...
                 (let ((tmp.148
                        (let ((tmp.149
                               (let ((tmp.150 (call L.-.73.8 |-.73| 496 1696)))
                                 (let ((tmp.151
                                        (call L.-.73.8 |-.73| 1312 1736)))
                                   (call L.-.73.8 |-.73| tmp.150 tmp.151)))))
                          (let ((tmp.152
                                 (let ((tmp.153 (call L.*.72.9 *.72 1672 304)))
                                   (let ((tmp.154
...
(check-by-interp
 '(module
    ...
    (let ((fun/error14883.4
           (let ((tmp.88 (let ((tmp.101 (alloc 16))) (+ tmp.101 2))))
             (begin
          ...
          (fun/empty14886.6
           (let ((tmp.90 (let ((tmp.103 (alloc 24))) (+ tmp.103 2))))
             (begin
               ...
               tmp.90)))
          (fun/error14882.7
           (let ((tmp.91 (let ((tmp.104 (alloc 24))) (+ tmp.104 2))))
             (begin
               (mset! tmp.91 -2 L.fun/error14882.7.10)
               (mset! tmp.91 6 0)
               tmp.91)))
          (fun/error14881.8
           (let ((tmp.92 (let ((tmp.105 (alloc 16))) (+ tmp.105 2))))
             (begin
          ...
          (fun/ascii-char14885.12
           (let ((tmp.96 (let ((tmp.109 (alloc 16))) (+ tmp.109 2))))
             (begin
               ...
               tmp.96)))
          (fun/empty14876.13
           (let ((tmp.97 (let ((tmp.110 (alloc 24))) (+ tmp.110 2))))
             (begin
          ...
          (fun/error14878.14
           (let ((tmp.98 (let ((tmp.111 (alloc 24))) (+ tmp.111 2))))
             (begin
               ...
               tmp.98)))
          (fun/empty14877.15
           (let ((tmp.99 (let ((tmp.112 (alloc 16))) (+ tmp.112 2))))
             (begin
      ...
      (begin
        ...
        (let ((empty0.21 (call L.fun/empty14876.13.16 fun/empty14876.13))
              ...
              (procedure3.18
               (let ((lam.74
                      (let ((tmp.100
                             (let ((tmp.113 (alloc 24))) (+ tmp.113 2))))
                        (begin
          ...
          (if (let ((tmp.114
                     (if (let ((tmp.115 (bitwise-and procedure3.18 7)))
                           (= tmp.115 2))
                       14
                       6)))
                (!= tmp.114 6))
            (if (let ((tmp.116
                       (if (let ((tmp.117 (mref procedure3.18 6)))
                             (= tmp.117 0))
                         14
                         6)))
                  (!= tmp.116 6))
              (let ((tmp.118 (mref procedure3.18 -2)))
...
(check-by-interp
 '(module
    (define L.lam.79.26
      (lambda (c.99)
        (let ((fun/any15198.16 (mref c.99 14)) (ascii-char?.77 (mref c.99 22)))
          (let ((tmp.121 (call L.fun/any15198.16.23 fun/any15198.16)))
    ...
    (define L.make-vector.76.10
      (lambda (c.83 tmp.52)
        (let ((make-init-vector.1 (mref c.83 14)))
          (if (let ((tmp.122
                     (if (let ((tmp.123 (bitwise-and tmp.52 7))) (= tmp.123 0))
                       14
                       6)))
                (!= tmp.122 6))
    ...
    (define L.vector-init-loop.26.8
      (lambda (c.81 len.27 i.29 vec.28)
        (let ((vector-init-loop.26 (mref c.81 14)))
          (if (let ((tmp.128 (if (= len.27 i.29) 14 6))) (!= tmp.128 6))
            vec.28
            (begin
              (let ((tmp.129
                     (let ((tmp.130
                            (let ((tmp.131 (arithmetic-shift-right i.29 3)))
                              (* tmp.131 8))))
                       (+ tmp.130 5))))
    ...
    (define L.ascii-char?.77.7
      (lambda (c.80 tmp.65)
        (let ()
          (if (let ((tmp.133 (bitwise-and tmp.65 255))) (= tmp.133 46))
            14
            6))))
    (let ((ascii-char?.77
           (let ((tmp.101 (let ((tmp.134 (alloc 16))) (+ tmp.134 2))))
             (begin
          ...
          (make-vector.76
           (let ((tmp.104 (let ((tmp.137 (alloc 24))) (+ tmp.137 2))))
             (begin
               ...
               tmp.104)))
          (fun/empty15196.4
           (let ((tmp.105 (let ((tmp.138 (alloc 24))) (+ tmp.138 2))))
             (begin
               (mset! tmp.105 -2 L.fun/empty15196.4.11)
               (mset! tmp.105 6 0)
               tmp.105)))
          (fun/empty15206.5
           (let ((tmp.106 (let ((tmp.139 (alloc 24))) (+ tmp.139 2))))
             (begin
               (mset! tmp.106 -2 L.fun/empty15206.5.12)
               (mset! tmp.106 6 0)
               tmp.106)))
          (fun/ascii-char15202.6
           (let ((tmp.107 (let ((tmp.140 (alloc 24))) (+ tmp.140 2))))
             (begin
          ...
          (fun/ascii-char15203.9
           (let ((tmp.110 (let ((tmp.143 (alloc 16))) (+ tmp.143 2))))
             (begin
               ...
               tmp.110)))
          (fun/empty15197.10
           (let ((tmp.111 (let ((tmp.144 (alloc 16))) (+ tmp.144 2))))
             (begin
               (mset! tmp.111 -2 L.fun/empty15197.10.17)
               (mset! tmp.111 6 0)
               tmp.111)))
          (fun/vector15209.11
           (let ((tmp.112 (let ((tmp.145 (alloc 24))) (+ tmp.145 2))))
             (begin
               (mset! tmp.112 -2 L.fun/vector15209.11.18)
               (mset! tmp.112 6 0)
               tmp.112)))
          (fun/empty15204.12
           (let ((tmp.113 (let ((tmp.146 (alloc 24))) (+ tmp.146 2))))
             (begin
               (mset! tmp.113 -2 L.fun/empty15204.12.19)
               (mset! tmp.113 6 0)
               tmp.113)))
          (fun/error15200.13
           (let ((tmp.114 (let ((tmp.147 (alloc 24))) (+ tmp.147 2))))
             (begin
               (mset! tmp.114 -2 L.fun/error15200.13.20)
               (mset! tmp.114 6 0)
               tmp.114)))
          (fun/any15199.14
           (let ((tmp.115 (let ((tmp.148 (alloc 16))) (+ tmp.148 2))))
             (begin
               (mset! tmp.115 -2 L.fun/any15199.14.21)
               (mset! tmp.115 6 0)
               tmp.115)))
          (fun/error15201.15
           (let ((tmp.116 (let ((tmp.149 (alloc 16))) (+ tmp.149 2))))
             (begin
               (mset! tmp.116 -2 L.fun/error15201.15.22)
               (mset! tmp.116 6 0)
               tmp.116)))
          (fun/any15198.16
           (let ((tmp.117 (let ((tmp.150 (alloc 24))) (+ tmp.150 2))))
             (begin
               (mset! tmp.117 -2 L.fun/any15198.16.23)
               (mset! tmp.117 6 0)
               tmp.117)))
          (fun/empty15205.17
           (let ((tmp.118 (let ((tmp.151 (alloc 16))) (+ tmp.151 2))))
             (begin
      ...
      (begin
        ...
        (let ((procedure0.23
              ...
              (procedure1.22
               (let ((lam.79
                      (let ((tmp.120
                             (let ((tmp.153 (alloc 32))) (+ tmp.153 2))))
                        (begin
 ...
 '(module
    ...
    (define L.make-vector.76.9
      (lambda (c.79 tmp.52)
        (let ((make-init-vector.1 (mref c.79 14)))
          (if (let ((tmp.112
                     (if (let ((tmp.113 (bitwise-and tmp.52 7))) (= tmp.113 0))
                       14
                       6)))
                (!= tmp.112 6))
            (call L.make-init-vector.1.8 make-init-vector.1 tmp.52)
    ...
    (define L.vector-init-loop.26.7
      (lambda (c.77 len.27 i.29 vec.28)
        (let ((vector-init-loop.26 (mref c.77 14)))
          (if (let ((tmp.118 (if (= len.27 i.29) 14 6))) (!= tmp.118 6))
            vec.28
            (begin
              (let ((tmp.119
                     (let ((tmp.120
                            (let ((tmp.121 (arithmetic-shift-right i.29 3)))
                              (* tmp.121 8))))
                       (+ tmp.120 5))))
          ...
          (fun/vector17409.9
           (let ((tmp.103 (let ((tmp.131 (alloc 24))) (+ tmp.131 2))))
             (begin
               ...
               tmp.103)))
          (fun/void17416.10
           (let ((tmp.104 (let ((tmp.132 (alloc 24))) (+ tmp.132 2))))
             (begin
          ...
          (fun/ascii-char17414.12
           (let ((tmp.106 (let ((tmp.134 (alloc 24))) (+ tmp.134 2))))
             (begin
               ...
               tmp.106)))
          (fun/error17412.13
           (let ((tmp.107 (let ((tmp.135 (alloc 24))) (+ tmp.135 2))))
             (begin
               (mset! tmp.107 -2 L.fun/error17412.13.19)
               (mset! tmp.107 6 0)
               tmp.107)))
          (fun/error17407.14
           (let ((tmp.108 (let ((tmp.136 (alloc 16))) (+ tmp.136 2))))
             (begin
               (mset! tmp.108 -2 L.fun/error17407.14.20)
               (mset! tmp.108 6 0)
               tmp.108)))
          (fun/error17411.15
           (let ((tmp.109 (let ((tmp.137 (alloc 16))) (+ tmp.137 2))))
             (begin
               (mset! tmp.109 -2 L.fun/error17411.15.21)
               (mset! tmp.109 6 0)
               tmp.109)))
          (fun/error17406.16
           (let ((tmp.110 (let ((tmp.138 (alloc 24))) (+ tmp.138 2))))
             (begin
               (mset! tmp.110 -2 L.fun/error17406.16.22)
               (mset! tmp.110 6 0)
               tmp.110)))
          (fun/void17417.17
           (let ((tmp.111 (let ((tmp.139 (alloc 16))) (+ tmp.139 2))))
             (begin
 ...
 '(module
    ...
    (define L.make-vector.74.12
      (lambda (c.84 tmp.50)
        (let ((make-init-vector.1 (mref c.84 14)))
          (if (let ((tmp.118
                     (if (let ((tmp.119 (bitwise-and tmp.50 7))) (= tmp.119 0))
                       14
                       6)))
                (!= tmp.118 6))
    ...
    (define L.vector-init-loop.24.10
      (lambda (c.82 len.25 i.27 vec.26)
        (let ((vector-init-loop.24 (mref c.82 14)))
          (if (let ((tmp.124 (if (= len.25 i.27) 14 6))) (!= tmp.124 6))
            vec.26
            (begin
              (let ((tmp.125
                     (let ((tmp.126
                            (let ((tmp.127 (arithmetic-shift-right i.27 3)))
                              (* tmp.127 8))))
                       (+ tmp.126 5))))
    ...
    (define L.-.75.9
      (lambda (c.81 tmp.40 tmp.41)
        (let ()
          (if (let ((tmp.129
                     (if (let ((tmp.130 (bitwise-and tmp.41 7))) (= tmp.130 0))
                       14
                       6)))
                (!= tmp.129 6))
            (if (let ((tmp.131
                       (if (let ((tmp.132 (bitwise-and tmp.40 7)))
                             (= tmp.132 0))
                         14
                         6)))
                  (!= tmp.131 6))
    ...
    (define L.*.77.7
      (lambda (c.79 tmp.36 tmp.37)
        (let ()
          (if (let ((tmp.137
                     (if (let ((tmp.138 (bitwise-and tmp.37 7))) (= tmp.138 0))
                       14
                       6)))
                (!= tmp.137 6))
            (if (let ((tmp.139
                       (if (let ((tmp.140 (bitwise-and tmp.36 7)))
                             (= tmp.140 0))
                         14
                         6)))
                  (!= tmp.139 6))
              (let ((tmp.141 (arithmetic-shift-right tmp.37 3)))
                (* tmp.36 tmp.141))
              318)
            318))))
    (let ((*.77
          ...
          (vector-init-loop.24
           (let ((tmp.102 (let ((tmp.145 (alloc 24))) (+ tmp.145 2))))
             (begin
               ...
               tmp.102)))
          (make-init-vector.1
           (let ((tmp.103 (let ((tmp.146 (alloc 24))) (+ tmp.146 2))))
             (begin
               (mset! tmp.103 -2 L.make-init-vector.1.11)
               (mset! tmp.103 6 8)
               tmp.103)))
          (make-vector.74
           (let ((tmp.104 (let ((tmp.147 (alloc 24))) (+ tmp.147 2))))
             (begin
               (mset! tmp.104 -2 L.make-vector.74.12)
               (mset! tmp.104 6 8)
               tmp.104)))
          (fun/empty18594.4
           (let ((tmp.105 (let ((tmp.148 (alloc 16))) (+ tmp.148 2))))
             (begin
          ...
          (fun/empty18593.7
           (let ((tmp.108 (let ((tmp.151 (alloc 24))) (+ tmp.151 2))))
             (begin
               ...
               tmp.108)))
          (fun/vector18596.8
           (let ((tmp.109 (let ((tmp.152 (alloc 24))) (+ tmp.152 2))))
             (begin
               (mset! tmp.109 -2 L.fun/vector18596.8.17)
               (mset! tmp.109 6 0)
               tmp.109)))
          (fun/vector18595.9
           (let ((tmp.110 (let ((tmp.153 (alloc 24))) (+ tmp.153 2))))
             (begin
               (mset! tmp.110 -2 L.fun/vector18595.9.18)
               (mset! tmp.110 6 0)
               tmp.110)))
          (fun/empty18590.10
           (let ((tmp.111 (let ((tmp.154 (alloc 16))) (+ tmp.154 2))))
             (begin
               (mset! tmp.111 -2 L.fun/empty18590.10.19)
               (mset! tmp.111 6 0)
               tmp.111)))
          (fun/error18586.11
           (let ((tmp.112 (let ((tmp.155 (alloc 16))) (+ tmp.155 2))))
             (begin
               (mset! tmp.112 -2 L.fun/error18586.11.20)
               (mset! tmp.112 6 0)
               tmp.112)))
          (fun/error18585.12
           (let ((tmp.113 (let ((tmp.156 (alloc 24))) (+ tmp.156 2))))
             (begin
               (mset! tmp.113 -2 L.fun/error18585.12.21)
               (mset! tmp.113 6 0)
               tmp.113)))
          (fun/empty18589.13
           (let ((tmp.114 (let ((tmp.157 (alloc 24))) (+ tmp.157 2))))
             (begin
      ...
      (begin
        ...
        (let ((error0.21 (call L.fun/error18585.12.21 fun/error18585.12))
              ...
              (procedure2.19
               (let ((lam.78
                      (let ((tmp.117
                             (let ((tmp.160 (alloc 24))) (+ tmp.160 2))))
                        (begin
              ...
              (fixnum3.18
               (let ((tmp.161
                      (let ((tmp.162
                             (let ((tmp.163 (call L.-.75.9 |-.75| 1032 224)))
                               (let ((tmp.164 (call L.-.75.9 |-.75| 960 832)))
                                 (call L.+.76.8 |+.76| tmp.163 tmp.164)))))
                        (let ((tmp.165
                               (let ((tmp.166 (call L.*.77.7 *.77 1416 1208)))
                                 (let ((tmp.167 (call L.+.76.8 |+.76| 16 912)))
 ...
 '(module
    ...
    (let ((*.77
          ...
          (fun/ascii-char19110.9
           (let ((tmp.110 (let ((tmp.153 (alloc 16))) (+ tmp.153 2))))
             (begin
               (mset! tmp.110 -2 L.fun/ascii-char19110.9.18)
               (mset! tmp.110 6 0)
               tmp.110)))
          (fun/ascii-char19111.10
           (let ((tmp.111 (let ((tmp.154 (alloc 24))) (+ tmp.154 2))))
             (begin
               (mset! tmp.111 -2 L.fun/ascii-char19111.10.19)
               (mset! tmp.111 6 0)
               tmp.111)))
          (fun/error19113.11
           (let ((tmp.112 (let ((tmp.155 (alloc 24))) (+ tmp.155 2))))
             (begin
               (mset! tmp.112 -2 L.fun/error19113.11.20)
               (mset! tmp.112 6 0)
               tmp.112)))
          (fun/error19114.12
           (let ((tmp.113 (let ((tmp.156 (alloc 16))) (+ tmp.156 2))))
             (begin
      ...
      (begin
        ...
        (let ((empty0.21 (call L.fun/empty19105.7.16 fun/empty19105.7))
              (fixnum1.20
               (let ((tmp.160
                      (let ((tmp.161
                             (let ((tmp.162 (call L.-.75.9 |-.75| 8 888)))
                               (let ((tmp.163 (call L.-.75.9 |-.75| 944 1120)))
                                 (call L.-.75.9 |-.75| tmp.162 tmp.163)))))
                        (let ((tmp.164
                               (let ((tmp.165 (call L.-.75.9 |-.75| 1264 616)))
                                 (let ((tmp.166
                 ...
                 (let ((tmp.167
                        (let ((tmp.168
                               (let ((tmp.169 (call L.+.76.8 |+.76| 512 1584)))
                                 (let ((tmp.170
              ...
              (procedure2.19
               (let ((lam.78
                      (let ((tmp.117
                             (let ((tmp.174 (alloc 24))) (+ tmp.174 2))))
                        (begin
                          (mset! tmp.117 -2 L.lam.78.25)
                          (mset! tmp.117 6 0)
                          tmp.117))))
...
(check-by-interp
 '(module
    ...
    (define L.pair?.76.7
      (lambda (c.78 tmp.67)
        (let ()
          (if (let ((tmp.110 (bitwise-and tmp.67 7))) (= tmp.110 1)) 14 6))))
    (let ((pair?.76
           (let ((tmp.94 (let ((tmp.111 (alloc 16))) (+ tmp.111 2))))
             (begin (mset! tmp.94 -2 L.pair?.76.7) (mset! tmp.94 6 8) tmp.94)))
          (fun/any20282.4
           (let ((tmp.95 (let ((tmp.112 (alloc 24))) (+ tmp.112 2))))
             (begin
               (mset! tmp.95 -2 L.fun/any20282.4.8)
               (mset! tmp.95 6 0)
               tmp.95)))
          (fun/void20271.5
           (let ((tmp.96 (let ((tmp.113 (alloc 16))) (+ tmp.113 2))))
             (begin
               (mset! tmp.96 -2 L.fun/void20271.5.9)
               (mset! tmp.96 6 0)
               tmp.96)))
          (fun/any20283.6
           (let ((tmp.97 (let ((tmp.114 (alloc 16))) (+ tmp.114 2))))
             (begin
               (mset! tmp.97 -2 L.fun/any20283.6.10)
               (mset! tmp.97 6 0)
               tmp.97)))
          (fun/void20270.7
           (let ((tmp.98 (let ((tmp.115 (alloc 24))) (+ tmp.115 2))))
             (begin
               (mset! tmp.98 -2 L.fun/void20270.7.11)
               (mset! tmp.98 6 0)
               tmp.98)))
          (fun/empty20278.8
           (let ((tmp.99 (let ((tmp.116 (alloc 24))) (+ tmp.116 2))))
             (begin
               (mset! tmp.99 -2 L.fun/empty20278.8.12)
               (mset! tmp.99 6 0)
               tmp.99)))
          (fun/empty20273.9
           (let ((tmp.100 (let ((tmp.117 (alloc 16))) (+ tmp.117 2))))
             (begin
               (mset! tmp.100 -2 L.fun/empty20273.9.13)
               (mset! tmp.100 6 0)
               tmp.100)))
          (fun/void20280.10
           (let ((tmp.101 (let ((tmp.118 (alloc 24))) (+ tmp.118 2))))
             (begin
               (mset! tmp.101 -2 L.fun/void20280.10.14)
               (mset! tmp.101 6 0)
               tmp.101)))
          (fun/empty20279.11
           (let ((tmp.102 (let ((tmp.119 (alloc 16))) (+ tmp.119 2))))
             (begin
               (mset! tmp.102 -2 L.fun/empty20279.11.15)
               (mset! tmp.102 6 0)
               tmp.102)))
          (fun/error20277.12
           (let ((tmp.103 (let ((tmp.120 (alloc 16))) (+ tmp.120 2))))
             (begin
               (mset! tmp.103 -2 L.fun/error20277.12.16)
               (mset! tmp.103 6 0)
               tmp.103)))
          (fun/error20276.13
           (let ((tmp.104 (let ((tmp.121 (alloc 24))) (+ tmp.121 2))))
             (begin
               (mset! tmp.104 -2 L.fun/error20276.13.17)
               (mset! tmp.104 6 0)
               tmp.104)))
          (fun/ascii-char20275.14
           (let ((tmp.105 (let ((tmp.122 (alloc 16))) (+ tmp.122 2))))
             (begin
               (mset! tmp.105 -2 L.fun/ascii-char20275.14.18)
               (mset! tmp.105 6 0)
               tmp.105)))
          (fun/empty20272.15
           (let ((tmp.106 (let ((tmp.123 (alloc 24))) (+ tmp.123 2))))
             (begin
               (mset! tmp.106 -2 L.fun/empty20272.15.19)
               (mset! tmp.106 6 0)
               tmp.106)))
          (fun/ascii-char20274.16
           (let ((tmp.107 (let ((tmp.124 (alloc 24))) (+ tmp.124 2))))
             (begin
               (mset! tmp.107 -2 L.fun/ascii-char20274.16.20)
               (mset! tmp.107 6 0)
               tmp.107)))
          (fun/void20281.17
           (let ((tmp.108 (let ((tmp.125 (alloc 16))) (+ tmp.125 2))))
             (begin
      ...
      (begin
        ...
        (let ((procedure0.23
               (let ((lam.77
                      (let ((tmp.109
                             (let ((tmp.126 (alloc 24))) (+ tmp.126 2))))
                        (begin
                          (mset! tmp.109 -2 L.lam.77.22)
                          (mset! tmp.109 6 0)
                          tmp.109))))
          ...
          (let ((tmp.127 (call L.fun/any20282.4.8 fun/any20282.4)))
 ...
 '(module
    ...
    (define L.make-vector.74.14
      (lambda (c.87 tmp.50)
        (let ((make-init-vector.1 (mref c.87 14)))
          (if (let ((tmp.121
                     (if (let ((tmp.122 (bitwise-and tmp.50 7))) (= tmp.122 0))
                       14
                       6)))
                (!= tmp.121 6))
            (call L.make-init-vector.1.13 make-init-vector.1 tmp.50)
    ...
    (define L.vector-init-loop.24.12
      (lambda (c.85 len.25 i.27 vec.26)
        (let ((vector-init-loop.24 (mref c.85 14)))
          (if (let ((tmp.127 (if (= len.25 i.27) 14 6))) (!= tmp.127 6))
            vec.26
            (begin
              (let ((tmp.128
                     (let ((tmp.129
                            (let ((tmp.130 (arithmetic-shift-right i.27 3)))
                              (* tmp.130 8))))
                       (+ tmp.129 5))))
    ...
    (define L.empty?.75.11
      (lambda (c.84 tmp.61)
        (let ()
          (if (let ((tmp.132 (bitwise-and tmp.61 255))) (= tmp.132 22))
            14
            6))))
    (define L.-.76.10
      (lambda (c.83 tmp.40 tmp.41)
        (let ()
          (if (let ((tmp.133
                     (if (let ((tmp.134 (bitwise-and tmp.41 7))) (= tmp.134 0))
                       14
                       6)))
                (!= tmp.133 6))
            (if (let ((tmp.135
                       (if (let ((tmp.136 (bitwise-and tmp.40 7)))
                             (= tmp.136 0))
                         14
                         6)))
                  (!= tmp.135 6))
    ...
    (define L.+.78.8
      (lambda (c.81 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.142
                     (if (let ((tmp.143 (bitwise-and tmp.39 7))) (= tmp.143 0))
                       14
                       6)))
                (!= tmp.142 6))
            (if (let ((tmp.144
                       (if (let ((tmp.145 (bitwise-and tmp.38 7)))
                             (= tmp.145 0))
                         14
                         6)))
                  (!= tmp.144 6))
    ...
    (define L.vector?.79.7
      (lambda (c.80 tmp.66)
        (let ()
          (if (let ((tmp.146 (bitwise-and tmp.66 7))) (= tmp.146 3)) 14 6))))
    (let ((vector?.79
           (let ((tmp.101 (let ((tmp.147 (alloc 16))) (+ tmp.147 2))))
             (begin
          ...
          (empty?.75
           (let ((tmp.105 (let ((tmp.151 (alloc 16))) (+ tmp.151 2))))
             (begin
               ...
               tmp.105)))
          (vector-init-loop.24
           (let ((tmp.106 (let ((tmp.152 (alloc 24))) (+ tmp.152 2))))
             (begin
          ...
          (make-vector.74
           (let ((tmp.108 (let ((tmp.154 (alloc 24))) (+ tmp.154 2))))
             (begin
               ...
               tmp.108)))
          (fun/empty21163.4
           (let ((tmp.109 (let ((tmp.155 (alloc 16))) (+ tmp.155 2))))
             (begin
          ...
          (fun/empty21162.8
           (let ((tmp.113 (let ((tmp.159 (alloc 24))) (+ tmp.159 2))))
             (begin
               ...
               tmp.113)))
          (fun/void21166.9
           (let ((tmp.114 (let ((tmp.160 (alloc 24))) (+ tmp.160 2))))
             (begin
          ...
          (fun/void21167.12
           (let ((tmp.117 (let ((tmp.163 (alloc 16))) (+ tmp.163 2))))
             (begin
               ...
               tmp.117)))
          (fun/vector21158.13
           (let ((tmp.118 (let ((tmp.164 (alloc 24))) (+ tmp.164 2))))
             (begin
               (mset! tmp.118 -2 L.fun/vector21158.13.24)
               (mset! tmp.118 6 0)
               tmp.118)))
          (fun/error21157.14
           (let ((tmp.119 (let ((tmp.165 (alloc 16))) (+ tmp.165 2))))
             (begin
      ...
      (begin
        ...
        (let ((error0.21 (call L.fun/error21156.10.21 fun/error21156.10))
              ...
              (boolean2.19
               (let ((tmp.167 (call L.fun/any21160.15.26 fun/any21160.15)))
                 (call L.empty?.75.11 empty?.75 tmp.167)))
              (fixnum3.18
               (let ((tmp.168
                      (let ((tmp.169
                             (let ((tmp.170 (call L.-.76.10 |-.76| 208 416)))
                               (let ((tmp.171
                        ...
                        (let ((tmp.172
                               (let ((tmp.173
                                 ...
                                 (let ((tmp.174 (call L.*.77.9 *.77 168 1416)))
                                   (call L.*.77.9 *.77 tmp.173 tmp.174)))))
                          (call L.+.78.8 |+.78| tmp.169 tmp.172)))))
                 (let ((tmp.175
                        (let ((tmp.176
                               (let ((tmp.177 (call L.-.76.10 |-.76| 448 88)))
                                 (let ((tmp.178
              ...
              (boolean5.16
               (let ((tmp.182 (call L.fun/any21164.7.18 fun/any21164.7)))
 ...
 '(module
    ...
    (define L.cons.74.12
      (lambda (c.85 tmp.69 tmp.70)
        (let ()
          (let ((tmp.98 (let ((tmp.117 (alloc 16))) (+ tmp.117 1))))
            (begin (mset! tmp.98 -1 tmp.69) (mset! tmp.98 7 tmp.70) tmp.98)))))
    (define L.pair?.75.11
      (lambda (c.84 tmp.65)
        (let ()
          (if (let ((tmp.118 (bitwise-and tmp.65 7))) (= tmp.118 1)) 14 6))))
    (define L.boolean?.76.10
      (lambda (c.83 tmp.60)
        (let ()
          (if (let ((tmp.119 (bitwise-and tmp.60 247))) (= tmp.119 6)) 14 6))))
    (define L.+.77.9
      (lambda (c.82 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.120
                     (if (let ((tmp.121 (bitwise-and tmp.39 7))) (= tmp.121 0))
                       14
                       6)))
                (!= tmp.120 6))
            (if (let ((tmp.122
                       (if (let ((tmp.123 (bitwise-and tmp.38 7)))
                             (= tmp.123 0))
                         14
                         6)))
                  (!= tmp.122 6))
          ...
          (if (let ((tmp.124
            ...
            (if (let ((tmp.126
                       (if (let ((tmp.127 (bitwise-and tmp.36 7)))
                         ...
                         6)))
                  (!= tmp.126 6))
              (let ((tmp.128 (arithmetic-shift-right tmp.37 3)))
                (* tmp.36 tmp.128))
              318)
            318))))
    (define L.-.79.7
      (lambda (c.80 tmp.40 tmp.41)
        (let ()
          (if (let ((tmp.129
            ...
            830))))
    (let ((|-.79|
           (let ((tmp.99 (let ((tmp.133 (alloc 16))) (+ tmp.133 2))))
             (begin (mset! tmp.99 -2 L.-.79.7) (mset! tmp.99 6 16) tmp.99)))
          (*.78
           (let ((tmp.100 (let ((tmp.134 (alloc 16))) (+ tmp.134 2))))
             (begin (mset! tmp.100 -2 L.*.78.8) (mset! tmp.100 6 16) tmp.100)))
          (|+.77|
           (let ((tmp.101 (let ((tmp.135 (alloc 16))) (+ tmp.135 2))))
             (begin (mset! tmp.101 -2 L.+.77.9) (mset! tmp.101 6 16) tmp.101)))
          (boolean?.76
           (let ((tmp.102 (let ((tmp.136 (alloc 16))) (+ tmp.136 2))))
             (begin
               (mset! tmp.102 -2 L.boolean?.76.10)
               (mset! tmp.102 6 8)
               tmp.102)))
          (pair?.75
           (let ((tmp.103 (let ((tmp.137 (alloc 16))) (+ tmp.137 2))))
             (begin
               (mset! tmp.103 -2 L.pair?.75.11)
               (mset! tmp.103 6 8)
               tmp.103)))
          (cons.74
           (let ((tmp.104 (let ((tmp.138 (alloc 16))) (+ tmp.138 2))))
             (begin
               (mset! tmp.104 -2 L.cons.74.12)
               (mset! tmp.104 6 16)
               tmp.104)))
          (fun/any23222.4
           (let ((tmp.105 (let ((tmp.139 (alloc 24))) (+ tmp.139 2))))
             (begin
          ...
          (fun/error23218.5
           (let ((tmp.106 (let ((tmp.140 (alloc 16))) (+ tmp.140 2))))
             (begin
               ...
               tmp.106)))
          (fun/void23223.6
           (let ((tmp.107 (let ((tmp.141 (alloc 24))) (+ tmp.141 2))))
             (begin
          ...
          (fun/void23224.7
           (let ((tmp.108 (let ((tmp.142 (alloc 16))) (+ tmp.142 2))))
             (begin
               ...
               tmp.108)))
          (fun/void23220.8
           (let ((tmp.109 (let ((tmp.143 (alloc 16))) (+ tmp.143 2))))
             (begin
          ...
          (fun/ascii-char23225.12
           (let ((tmp.113 (let ((tmp.147 (alloc 24))) (+ tmp.147 2))))
             (begin
          ...
          (fun/ascii-char23226.14
           (let ((tmp.115 (let ((tmp.149 (alloc 16))) (+ tmp.149 2))))
             (begin
               (mset! tmp.115 -2 L.fun/ascii-char23226.14.23)
               (mset! tmp.115 6 0)
               tmp.115)))
          (fun/any23215.15
           (let ((tmp.116 (let ((tmp.150 (alloc 24))) (+ tmp.150 2))))
             (begin
      ...
      (begin
        ...
        (let ((boolean0.21
               (let ((tmp.151 (call L.fun/any23215.15.24 fun/any23215.15)))
              ...
              (boolean3.18
               (let ((tmp.152 (call L.fun/any23221.9.18 fun/any23221.9)))
                 (call L.boolean?.76.10 boolean?.76 tmp.152)))
              (fixnum4.17
               (let ((tmp.153
                      (let ((tmp.154
                             (let ((tmp.155 (call L.+.77.9 |+.77| 1720 344)))
                               (let ((tmp.156 (call L.*.78.8 *.78 1304 728)))
                                 (call L.*.78.8 *.78 tmp.155 tmp.156)))))
                        (let ((tmp.157
                               (let ((tmp.158 (call L.+.77.9 |+.77| 344 1728)))
                                 (let ((tmp.159 (call L.+.77.9 |+.77| 96 904)))
                                   (call L.+.77.9 |+.77| tmp.158 tmp.159)))))
                          (call L.*.78.8 *.78 tmp.154 tmp.157)))))
                 (let ((tmp.160
                        (let ((tmp.161
                               (let ((tmp.162 (call L.*.78.8 *.78 1472 32)))
                                 (let ((tmp.163
 ...
 '(module
    (define L.lam.78.23
      (lambda (c.95)
        (let ((fun/any24030.9 (mref c.95 14)) (procedure?.73 (mref c.95 22)))
          (let ((tmp.114 (call L.fun/any24030.9.18 fun/any24030.9)))
    ...
    (define L.cons.72.12
      (lambda (c.84 tmp.67 tmp.68)
        (let ()
          (let ((tmp.96 (let ((tmp.115 (alloc 16))) (+ tmp.115 1))))
            (begin (mset! tmp.96 -1 tmp.67) (mset! tmp.96 7 tmp.68) tmp.96)))))
    (define L.procedure?.73.11
      (lambda (c.83 tmp.66)
        (let ()
          (if (let ((tmp.116 (bitwise-and tmp.66 7))) (= tmp.116 2)) 14 6))))
    (define L.-.74.10
      (lambda (c.82 tmp.38 tmp.39)
        (let ()
          (if (let ((tmp.117
    ...
    (define L.*.75.9
      (lambda (c.81 tmp.34 tmp.35)
        (let ()
          (if (let ((tmp.121
                     (if (let ((tmp.122 (bitwise-and tmp.35 7))) (= tmp.122 0))
                       14
                       6)))
                (!= tmp.121 6))
            (if (let ((tmp.123
                       (if (let ((tmp.124 (bitwise-and tmp.34 7)))
                             (= tmp.124 0))
                         14
                         6)))
                  (!= tmp.123 6))
              (let ((tmp.125 (arithmetic-shift-right tmp.35 3)))
                (* tmp.34 tmp.125))
              318)
            318))))
    (define L.+.76.8
    ...
    (define L.empty?.77.7
      (lambda (c.79 tmp.59)
        (let ()
          (if (let ((tmp.130 (bitwise-and tmp.59 255))) (= tmp.130 22))
            14
            6))))
    (let ((empty?.77
           (let ((tmp.97 (let ((tmp.131 (alloc 16))) (+ tmp.131 2))))
             (begin
               (mset! tmp.97 -2 L.empty?.77.7)
               (mset! tmp.97 6 8)
               tmp.97)))
          (|+.76|
           (let ((tmp.98 (let ((tmp.132 (alloc 16))) (+ tmp.132 2))))
          ...
          (fun/empty24028.6
           (let ((tmp.105 (let ((tmp.139 (alloc 24))) (+ tmp.139 2))))
             (begin
               ...
               tmp.105)))
          (fun/pair24037.7
           (let ((tmp.106 (let ((tmp.140 (alloc 24))) (+ tmp.140 2))))
             (begin
          ...
          (fun/any24031.8
           (let ((tmp.107 (let ((tmp.141 (alloc 16))) (+ tmp.141 2))))
             (begin
               ...
               tmp.107)))
          (fun/any24030.9
           (let ((tmp.108 (let ((tmp.142 (alloc 24))) (+ tmp.142 2))))
             (begin
      ...
      (begin
        ...
        (let ((empty0.19 (call L.fun/empty24028.6.15 fun/empty24028.6))
              (procedure1.18
               (let ((lam.78
                      (let ((tmp.113
                             (let ((tmp.147 (alloc 32))) (+ tmp.147 2))))
                        (begin
              ...
              (fixnum2.17
               (let ((tmp.148
                      (let ((tmp.149
                             (let ((tmp.150 (call L.-.74.10 |-.74| 1112 912)))
                               (let ((tmp.151 (call L.*.75.9 *.75 1808 704)))
                                 (call L.*.75.9 *.75 tmp.150 tmp.151)))))
                        (let ((tmp.152
                               (let ((tmp.153 (call L.+.76.8 |+.76| 752 360)))
                                 (let ((tmp.154 (call L.*.75.9 *.75 272 1632)))
                                   (call L.+.76.8 |+.76| tmp.153 tmp.154)))))
                          (call L.+.76.8 |+.76| tmp.149 tmp.152)))))
                 (let ((tmp.155
                        (let ((tmp.156
                               (let ((tmp.157 (call L.-.74.10 |-.74| 320 384)))
                                 (let ((tmp.158
              ...
              (fixnum3.16
               (let ((tmp.162
                      (let ((tmp.163
                             (let ((tmp.164 (call L.*.75.9 *.75 2000 336)))
                               (let ((tmp.165 (call L.+.76.8 |+.76| 320 1488)))
                                 (call L.+.76.8 |+.76| tmp.164 tmp.165)))))
                        (let ((tmp.166
                               (let ((tmp.167 (call L.+.76.8 |+.76| 352 1240)))
                                 (let ((tmp.168 (call L.*.75.9 *.75 984 320)))
                 ...
                 (let ((tmp.169
                        (let ((tmp.170
                               (let ((tmp.171
                                 ...
                                 (let ((tmp.172 (call L.*.75.9 *.75 304 48)))
              ...
              (boolean4.15
               (let ((tmp.176 (call L.fun/any24032.12.21 fun/any24032.12)))
