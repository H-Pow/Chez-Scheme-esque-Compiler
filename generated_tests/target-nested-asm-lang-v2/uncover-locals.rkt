       ...
       (if (begin (set! tmp.13 1) (> tmp.13 1))
         ...
         (if (if (> bar.9.4 9223372036854775807)
           ...
           (begin
             ...
             (set! r15 tmp-ra.10)
             (jump L.x.2.3 rbp r15 rdi rsi rdx))
           (begin (set! rax -9223372036854775808) (jump tmp-ra.10 rbp rax))))))
   (define L.x.2.3
     ((new-frames ()))
     (begin
       (set! tmp-ra.11 r15)
...
(check-by-interp-v6 '(module
   ...
   (define L.tmp.2.3
     ...
     (begin
       ...
       (if (if (begin (set! tmp.25 9223372036854775807) (> tmp.25 foobar.5.15))
...
(check-by-interp-v6 '(module
   ...
   (begin (set! tmp-ra.13 r15) (set! rax -575594324) (jump tmp-ra.13 rbp rax))))
(check-by-interp-v6 '(module
   ((new-frames ()))
   (define L.x.0.1
     ((new-frames ()))
...
(check-by-interp-v6 '(module
   ...
   (begin
     ...
     (if (> ball.1.1 ball.1.1) (set! foo.4.2 ball.1.1) (set! foo.4.2 ball.1.1))
...
(check-by-interp '(module
   ...
   (define L.L.tmp.1.2.5
     ()
     (begin (set! foo.2.1.5 rdi) (jump L.L.func.0.1.4 rbp)))
     ...
     (begin
       (if (true)
         ...
         (begin
           ...
           (set! bar.4.2.6 tmp.9)))
       (if (begin (set! tmp.10 1) (> tmp.10 0))
         (set! foobar.6.4.8 156890122)
         (set! foobar.6.4.8 bar.4.2.6))
       (halt 0)))
   (begin (set! rdi -1860620182) (jump L.L.tmp.1.2.5 rbp rdi))))
(check-by-interp '(module
   ()
   (define L.L.tmp.0.1.4
     ()
     (if (begin (set! tmp.9 9223372036854775807) (>= tmp.9 -1020514810))
   ...
   (define L.L.func.1.2.5
     ...
     (begin
       ...
       (if (not (begin (set! tmp.12 9223372036854775807) (> tmp.12 0)))
         (halt 1309557052)
         (halt bar.1.1.5))))
   (define L.L.x.2.3.6
     ()
     (if (if (true) (not (begin (set! tmp.13 0) (> tmp.13 1))) (true))
       (if (begin (set! tmp.14 0) (> tmp.14 0))
         (if (begin
               (set! tmp.15 9223372036854775807)
               (< tmp.15 9223372036854775807))
           (halt 9223372036854775807)
           (halt -260353756))
         (begin (set! ball.0.2.6 0) (halt ball.0.2.6)))
       (begin
         (if (begin (set! tmp.16 -302047143) (!= tmp.16 0))
           (set! bar.3.3.7 9223372036854775807)
           (set! bar.3.3.7 102036653))
         (if (begin (set! tmp.17 0) (= tmp.17 bar.3.3.7))
           (halt bar.3.3.7)
           (halt -362331747)))))
   (begin
     (set! tmp.18 -9223372036854775808)
...
(check-by-interp '(module
   ...
   (define L.L.proc.0.1.4
     ()
     (begin (set! ball.6.1.5 rdi) (jump L.L.func.1.2.5 rbp)))
   (define L.L.func.1.2.5
     ()
     (begin
       (set! tmp.10 1)
   ...
   (define L.L.fn.2.3.6
     ...
     (begin
       ...
       (if (true)
         (begin
           (if (begin (set! tmp.11 -2033705372) (<= tmp.11 965540822))
             (set! bat.0.3.7 -1853172774)
             (set! bat.0.3.7 1133506028))
           (set! foo.4.4.8 1)
           (halt 1236904416))
         (jump L.L.func.1.2.5 rbp))))
   (begin (set! rdi 1) (jump L.L.proc.0.1.4 rbp rdi))))
(check-by-interp '(module
   ()
   (define L.fn.0.1
     ()
     (begin
       (if (false) (set! bat.9.1 1) (begin (set! foo.5.2 1) (set! bat.9.1 1)))
       (if (if (begin
                 (set! tmp.5 9223372036854775807)
                 (>= tmp.5 -9223372036854775808))
             (begin (set! tmp.6 -248968641) (= tmp.6 9223372036854775807))
             (!= bat.9.1 -9223372036854775808))
         (begin (set! ball.4.3 bat.9.1) (halt 1622965009))
         (begin (set! foo.5.4 bat.9.1) (halt bat.9.1)))))
   (if (false)
     (if (begin (set! tmp.7 995853130) (>= tmp.7 1))
       (halt 1)
...
(check-by-interp '(module
   ...
   (define L.func.1.2
     ()
     (begin
       (if (begin (set! foo.8.5 1) (begin (set! tmp.11 1) (< tmp.11 foo.8.5)))
       ...
       (set! tmp.12 tmp.13)
       (halt tmp.12)))
   (begin (set! bat.5.8 1) (set! ball.9.9 0) (halt bat.5.8))))
(check-by-interp '(module
   ()
   (define L.x.0.1
     ()
     (begin (set! ball.1.2 rdi) (set! foo.0.1 rsi) (jump L.tmp.1.2 rbp)))
   (define L.tmp.1.2
     ()
     (if (if (if (begin (set! tmp.8 -765445006) (<= tmp.8 0))
               (begin (set! tmp.9 0) (!= tmp.9 -7399083))
               (begin (set! tmp.10 9223372036854775807) (<= tmp.10 1)))
           (false)
           (true))
       (begin
         ...
         (if (> ball.4.3 ball.4.3)
           ...
           (halt ball.4.3)))
       (begin
         (if (begin (set! tmp.11 1) (>= tmp.11 0))
           (set! foobar.9.5 -9223372036854775808)
           (set! foobar.9.5 -9223372036854775808))
         (if (begin (set! tmp.12 0) (= tmp.12 foobar.9.5))
           (halt 0)
           (halt 9223372036854775807)))))
   (define L.func.2.3
     ()
     (begin (set! ball.4.7 rdi) (set! ball.6.6 rsi) (jump L.tmp.1.2 rbp)))
   (if (begin (set! tmp.13 0) (<= tmp.13 1))
     (halt -1271132888)
     (halt 2101306416))))
(check-by-interp '(module
   ()
   (define L.proc.0.1
     ...
     (begin
       ...
       (set! bat.3.5 tmp.6)
       (if (!= bar.8.1 bar.8.1) (halt 1) (halt bar.8.1))))
   (if (begin (set! tmp.7 0) (<= tmp.7 0))
     (halt 1764584349)
     (halt -9223372036854775808))))
(check-by-interp '(module
   ()
   ...
   (begin
     ...
     (if (begin (set! tmp.8 9223372036854775807) (>= tmp.8 foobar.4.4))
       (halt 0)
       (halt -1617493587)))))
(check-by-interp '(module
   ()
   (define L.func.0.1
     ...
     (begin
       ...
       (if (begin
             ...
             (true))
         (if (true)
           (if (< bat.8.1 -9223372036854775808) (halt bat.8.1) (halt bat.8.1))
           (if (begin (set! tmp.4 -9223372036854775808) (= tmp.4 bat.8.1))
             (halt bat.8.1)
             (halt bat.8.1)))
         (jump L.proc.1.2 rbp))))
   (define L.proc.1.2
     ()
     (begin (set! rdi 954069433) (jump L.func.0.1 rbp rdi)))
   (if (false)
     (begin
...
(check-by-interp '(module
   ((locals (tmp.2 tmp.1)))
   (if (not (begin (set! tmp.1 1) (> tmp.1 9223372036854775807)))
     (if (begin (set! tmp.2 1) (>= tmp.2 1197468889))
       (halt 9223372036854775807)
       (halt 1))
     (halt 1))))
(check-by-interp '(module
...
(check-by-interp '(module
   ...
   (define L.tmp.0.1
     ...
     (begin
       ...
       (if (if (begin (set! tmp.7 -9223372036854775808) (<= tmp.7 bat.5.3))
             (begin (set! tmp.8 -9223372036854775808) (>= tmp.8 ball.6.4))
             (>= bat.5.3 2025307007))
         (begin
           (set! tmp.10 bat.2.5)
           (set! tmp.10 (+ tmp.10 9223372036854775807))
         ...
         (if (<= bat.5.3 -9223372036854775808)
           (halt 9223372036854775807)
           (halt 0)))))
   (begin (set! ball.6.6 0) (halt ball.6.6))))
(check-by-interp '(module
   ()
   (define L.func.0.1
     ()
     (begin
       (set! ball.6.2 rdi)
       (set! foobar.3.1 rsi)
       (if (begin (set! tmp.12 0) (= tmp.12 foobar.3.1))
         (begin
         ...
         (if (if (< ball.6.2 ball.6.2)
           ...
           (begin
             ...
             (set! tmp.15 tmp.16)
             (halt tmp.15))
           (if (begin (set! tmp.17 1) (= tmp.17 foobar.3.1))
             (halt ball.6.2)
             (halt foobar.3.1))))))
   (define L.x.1.2
     ()
   ...
   (define L.fn.2.3
     ...
     (if (begin
           ...
           (not (begin (set! tmp.21 0) (>= tmp.21 -1400373009))))
       (begin
       ...
       (begin
         ...
         (halt 770292232))))
   (begin (set! rdi 1840464414) (jump L.x.1.2 rbp rdi))))
(check-by-interp '(module
   ()
   (define L.proc.0.1
     ()
   ...
   (define L.func.1.2
     ...
     (begin
       ...
       (set! rdi bar.3.10)
       (jump L.proc.0.1 rbp rdi rsi rdx)))
   (begin (set! bat.0.13 -579691794) (halt 953357957))))
(check-by-interp '(module
   ()
   (begin
     (set! ball.2.2 9223372036854775807)
     (set! bar.5.1 -546026276)
     (if (!= bar.5.1 1) (halt 9223372036854775807) (halt 2063023986)))))
(check-by-interp '(module
   ()
   (define L.func.0.1
     ()
     (begin
       ...
       (if (not (begin (set! foo.8.3 foo.8.2) (= foo.8.3 0)))
         ...
         (begin
           ...
           (set! bat.7.5 tmp.9)
           (if (!= bat.7.5 -9223372036854775808) (halt bar.2.1) (halt 0))))))
   (if (begin (set! tmp.10 9223372036854775807) (= tmp.10 -315897602))
     (halt 1)
     (halt -9223372036854775808))))
(check-by-interp '(module
   ()
   (define L.fn.0.1
     ...
     (begin
       ...
       (if (begin (set! tmp.17 1) (!= tmp.17 bar.9.3))
         (halt 9223372036854775807)
         (halt ball.7.1))))
   (define L.x.1.2
     ()
...
(check-by-interp '(module
   ...
   (define L.proc.0.1
     ...
     (begin
       ...
       (set! ball.6.9 1)
       (if (<= foobar.2.4 1) (halt 9223372036854775807) (halt bat.3.2))))
   (begin
     (set! r9 9223372036854775807)
     (set! r8 -1891086346)
     (set! rcx -1371550930)
...
(check-by-interp '(module
   ...
   (define L.x.0.1
     ...
     (begin
       ...
       (set! ball.2.1 fv0)
       (if (not
            (if (begin (set! tmp.28 388494724) (>= tmp.28 ball.9.6))
              (> ball.5.4 -9223372036854775808)
              (< foobar.3.5 ball.5.4)))
         (if (<= ball.4.3 bar.0.2)
           (halt 0)
           (begin (set! ball.4.8 ball.5.4) (halt 1887946265)))
         (halt foobar.3.5))))
   (define L.tmp.1.2
     ()
     (begin
       ...
       (if (true)
         ...
         (if (begin (set! foobar.3.15 1) (<= bar.0.10 ball.5.12))
           (begin (set! ball.9.16 -9223372036854775808) (halt ball.9.16))
           (begin (set! bat.7.17 1) (halt 1))))))
   (define L.tmp.2.3
     ()
     (begin
       (set! bat.7.23 rdi)
       ...
       (if (begin (set! tmp.31 1525021420) (< tmp.31 1))
         (begin
           (set! r9 1067478227)
           (set! r8 -768559462)
           (set! rcx foo.6.21)
         ...
         (if (begin (set! tmp.32 389818959) (> tmp.32 882297114))
           (halt bar.8.19)
           (halt ball.2.22)))))
   (begin (set! bar.0.27 1) (halt 1))))
(check-by-interp '(module
   ()
   (define L.tmp.0.1
     ()
...
(check-by-interp '(module
   ...
   (if (true)
     (begin
       ...
       (set! tmp.1 tmp.2)
       (halt tmp.1))
     (if (begin (set! tmp.3 1383245321) (> tmp.3 0)) (halt 0) (halt 1)))))
(check-by-interp '(module
   ()
   (define L.x.0.1
     ()
   ...
   (define L.func.1.2
     ...
     (begin
       ...
       (if (begin (set! tmp.45 -577997854) (>= tmp.45 foobar.1.9))
         (halt -9223372036854775808)
         (halt bar.9.8))))
   (define L.fn.2.3
     ()
     (begin
       ...
       (if (false)
         (halt ball.7.10)
         (begin (set! foobar.1.11 ball.7.10) (halt 1969054361)))))
   (define L.x.3.4
     ()
     (begin
       (set! foobar.4.18 rdi)
   ...
   (define L.func.6.7
     ...
     (begin
       ...
       (if (if (true)
             ...
             (not (begin (set! tmp.48 -1101838227) (!= tmp.48 -1416967818))))
         (begin
   ...
   (define L.fn.7.8
     ()
     (if (true)
       (if (not (begin (set! tmp.50 0) (> tmp.50 100011461)))
         (begin
           (set! r9 -1579752260)
           (set! r8 0)
           (set! rcx -1248542300)
         ...
         (if (begin (set! tmp.51 -9223372036854775808) (= tmp.51 471889533))
           (halt 1)
           (halt 0)))
       (if (if (begin (set! tmp.52 1) (>= tmp.52 0))
             (begin (set! tmp.53 0) (>= tmp.53 -9223372036854775808))
             (begin (set! tmp.54 9223372036854775807) (> tmp.54 0)))
         (jump L.fn.7.8 rbp)
         (if (begin (set! tmp.55 1) (> tmp.55 1))
           (halt -444155079)
           (halt 9223372036854775807)))))
   (if (begin
         (if (begin (set! foobar.2.41 -9223372036854775808) (true))
           (begin
             (if (begin (set! tmp.56 9223372036854775807) (> tmp.56 0))
           ...
           (if (true)
             ...
             (if (begin
               ...
               (set! foo.6.40 1))))
         (if (true)
           (begin (set! bar.9.44 0) (true))
           (begin (set! tmp.58 858519747) (< tmp.58 foo.6.40))))
     (halt 1)
     (if (begin (set! tmp.59 1) (< tmp.59 -1323259230))
       (jump L.fn.2.3 rbp)
       (jump L.fn.2.3 rbp)))))
