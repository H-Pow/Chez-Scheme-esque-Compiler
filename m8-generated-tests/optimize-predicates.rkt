      ...
      (if (begin
        ...
        (begin
          (begin
            ...
            (set! rbp (+ rbp 16)))
          (set! fv1 rax)))
      (if (if (begin (set! r15 14) (!= r15 6))
            (begin (set! r15 6) (!= r15 6))
            (begin (set! r15 6) (!= r15 6)))
        (begin
          (set! r15 6)
          (set! r15 59198)
      ...
      (if (begin
        ...
        (begin
          ...
          (begin
            ...
            (set! rbp (+ rbp 16)))
          (set! r15 rax)
          (if (begin (set! r14 14) (!= r14 6)) (set! r14 30) (set! r14 30))
          (set! rdx r14)
          (set! rsi r15)
          (set! rdi fv1)
          (set! r15 fv0)
 ...
 '(module
    ...
    (begin
      ...
      (if (begin
            ...
            (!= r15 6))
        (begin
          (if (begin (set! r15 14) (!= r15 6)) (set! r15 400) (set! r15 1200))
          (if (begin (set! r14 14) (!= r14 6)) (set! r14 1000) (set! r14 1256))
          (set! rsi r14)
          (set! rdi r15)
          (set! r15 fv0)
          (jump L.*.6))
        (begin
          (if (begin (set! r15 6) (!= r15 6)) (set! r15 1464) (set! r15 360))
          (if (begin (set! r14 14) (!= r14 6)) (set! r14 72) (set! r14 816))
          (set! rsi r14)
          (set! rdi r15)
          (set! r15 fv0)
          (jump L.*.6))))))
