...
(check-by-interp
 '(module
    (if (if #t #f #t)
      ...
      (let ((procedure0.7 (letrec ((lam.60 (lambda () 143))) lam.60)))
        (error 251)))))
(check-by-interp
 '(module
      ...
      (if (let ((g42233549.10 (let () #t)))
        ...
        (unsafe-procedure-call
         ...
         (unsafe-procedure-call
          fun/any7325.7
          #\K
          (letrec ((lam.64 (lambda () 713))) lam.64)))
        (if #f #f #t)))))
(check-by-interp
 '(module
    (letrec ((error?.79 (lambda (tmp.65) (error? tmp.65)))
      ...
      (if (unsafe-procedure-call
           ...
           (unsafe-procedure-call
            fun/any8476.8
            (letrec ((lam.80 (lambda () 1020))) lam.80)))
        (let ((procedure0.12
               (letrec ((lam.81
                         (lambda ()
                           (unsafe-procedure-call
      ...
      (unsafe-procedure-call
       ...
       (unsafe-procedure-call
        ...
        (let ((empty0.55 empty) (ascii-char1.54 #\d))
          (letrec ((lam.112 (lambda () 530))) lam.112)))))))
(check-by-interp
 '(module
    (letrec ((error?.65 (lambda (tmp.55) (error? tmp.55)))
        ...
        (if (if #f empty empty)
          (if (let ((g42256477.10 empty))
            ...
            (unsafe-procedure-call
             fun/empty8501.7
             136
             (letrec ((lam.66 (lambda () 643))) lam.66))
            #f)
          #f)))))
(check-by-interp
 '(module
    (let ((void0.9 (let () (void)))
          (procedure1.8 (letrec ((lam.62 (lambda () (let () #t)))) lam.62))
          (boolean2.7 (let () #f)))
      (if (if #f #\n #\v) (if #\E (if #\a #\b #f) #f) #f))))
(check-by-interp
 '(module
      ...
      (unsafe-procedure-call
       ...
       (if (if (unsafe-procedure-call
         ...
         (unsafe-procedure-call
          fun/empty8513.9
          (if #t
            (letrec ((lam.96 (lambda () 622))) lam.96)
            (letrec ((lam.97 (lambda () 523))) lam.97)))
         #f)
...
(check-by-interp
 '(module
    (letrec ((error?.76 (lambda (tmp.64) (error? tmp.64)))
      ...
      (if (unsafe-procedure-call
           fun/boolean8517.8
           (letrec ((lam.77 (lambda () 918))) lam.77))
        #\L
        (let ((vector0.12
    ...
    (letrec ((cons.221 (lambda (tmp.212 tmp.213) (cons tmp.212 tmp.213)))
      ...
      (let ((g42374287.48
             (if (unsafe-procedure-call >=.217 2 186)
               ...
               (let ((procedure0.49
                      (letrec ((lam.229 (lambda (oprand0.51 oprand1.50) #\_)))
                        lam.229)))
                 empty))))
 ...
 '(module
    (letrec ((error?.86 (lambda (tmp.73) (error? tmp.73)))
             ...
             (fun/procedure8559.13
              (lambda () (letrec ((lam.95 (lambda () 550))) lam.95))))
      (let ((vector0.15
 ...
 '(module
    (letrec ((fun/fixnum8485.13 (lambda (oprand0.16) oprand0.16))
      ...
      (if (unsafe-procedure-call
           fun/boolean8483.14
           (if #t (void) (void))
           (let ((tmp.7.19 (letrec ((lam.77 (lambda () 845))) lam.77)))
             (if tmp.7.19
               tmp.7.19
               (let ((tmp.8.20 (letrec ((lam.78 (lambda () 630))) lam.78)))
                 (if tmp.8.20
                   tmp.8.20
                   (let ((tmp.9.21 (letrec ((lam.79 (lambda () 689))) lam.79)))
                     (if tmp.9.21
                       tmp.9.21
                       (let ((tmp.10.22
                              (letrec ((lam.80 (lambda () 943))) lam.80)))
                         (if tmp.10.22
                           tmp.10.22
                           (let ((tmp.11.23
                                  (letrec ((lam.81 (lambda () 1016))) lam.81)))
                             (if tmp.11.23
                               tmp.11.23
                               (let ((tmp.12.24
                                      (letrec ((lam.82 (lambda () 978)))
                                        lam.82)))
                                 (if tmp.12.24
                                   tmp.12.24
                                   (letrec ((lam.83 (lambda () 974)))
                                     lam.83))))))))))))))
 ...
 '(module
    (letrec ((fun/empty8494.7
             ...
             (fun/procedure8497.10
              (lambda () (letrec ((lam.66 (lambda () 609))) lam.66)))
      ...
      (if (let ((void0.21 (let () (void)))
        ...
        (if (if (unsafe-procedure-call
              ...
              (if (let () #\T)
                (if (if #f #\_ #\J)
                  (let ((procedure0.23
                         (letrec ((lam.105 (lambda (oprand0.24) 53))) lam.105))
                        (pair1.22
                         (unsafe-procedure-call
                          cons.101
                          151
    ...
    (letrec ((procedure?.136 (lambda (tmp.126) (procedure? tmp.126)))
      ...
      (let ((g42455084.37
             (unsafe-procedure-call
              fun/ascii-char8534.26
              (if #f
                (letrec ((lam.143 (lambda () 968))) lam.143)
                (letrec ((lam.144 (lambda () 631))) lam.144))
              (let () empty))))
                                      ...
                                      (if (unsafe-procedure-call
                                        ...
                                        (let ((g42462747.27
                                          ...
                                          (if (unsafe-procedure-call
                                            ...
                                            g42462747.27
                                            tmp.7.19)))))))))))))))))
          (letrec ((lam.92 (lambda () 807))) lam.92)))
       (if (unsafe-procedure-call
            fun/boolean8563.12
              ...
              (if tmp.8.21
                ...
                (let ((tmp.9.22
                       (unsafe-procedure-call
                        ...
                        (letrec ((lam.78 (lambda () 729))) lam.78))))
                  (if tmp.9.22
                    tmp.9.22
        ...
        (if tmp.7.21
          ...
          (let ((tmp.8.22
                 (unsafe-procedure-call
                  ...
                  (unsafe-procedure-call
                   fun/any8616.15
                   (letrec ((lam.78 (lambda () 764))) lam.78)))))
            (if tmp.8.22
              tmp.8.22
              (let ((tmp.9.23
                     (unsafe-procedure-call
             ...
             (if tmp.7.49
               ...
               (let ((tmp.8.50
                      (let ((boolean0.53 #f)
                            (ascii-char1.52 #\K)
                            (procedure2.51
                             (letrec ((lam.213 (lambda () 176))) lam.213)))
                        (error 222))))
                 (if tmp.8.50
                   tmp.8.50
      ...
      (unsafe-procedure-call
       ...
       (if (unsafe-procedure-call
         ...
         (if (let ((procedure0.27
                    (letrec ((lam.118
                              (lambda (oprand0.29 oprand1.28) oprand0.29)))
                      lam.118)))
               198)
           (if (let ((tmp.7.30 (let () 226)))
             ...
             (if (let ((boolean0.55 #t)
                       ...
                       (procedure2.53
                        (letrec ((lam.119 (lambda () 174))) lam.119)))
                   130)
               (if (if (if #t 35 220)
                     (if (if #t 36 135)
                       (if (unsafe-procedure-call
                                         ...
                                         (if (unsafe-procedure-call
                                           ...
                                           (let ((g42535328.43
                                             ...
                                             (if (unsafe-procedure-call
                                               ...
                                               tmp.7.15))))))))))))))))))
            (empty1.13 (let () empty)))
        (let ((procedure0.44 (letrec ((lam.109 (lambda () empty))) lam.109)))
          (void))))))
(check-by-interp
 '(module
      ...
      (unsafe-procedure-call
       ...
       (unsafe-procedure-call
        ...
        (unsafe-procedure-call
         fun/boolean8686.10
         (if #t
           (letrec ((lam.93 (lambda () 628))) lam.93)
           (letrec ((lam.94 (lambda () 577))) lam.94))))))))
(check-by-interp
 '(module
    (letrec ((error?.69 (lambda (tmp.59) (error? tmp.59)))
 ...
 '(module
    (letrec ((cons.98 (lambda (tmp.89 tmp.90) (cons tmp.89 tmp.90)))
             ...
             (fun/procedure8696.18
              (lambda () (letrec ((lam.107 (lambda () 758))) lam.107))))
      (let ((vector0.21
    ...
    (letrec ((fun/error8703.7 (lambda () (error 178)))
      ...
      (let ()
        (unsafe-procedure-call
         fun/error8702.8
         (if #t
           (letrec ((lam.62 (lambda () 781))) lam.62)
           (letrec ((lam.63 (lambda () 718))) lam.63)))))))
(check-by-interp
 '(module
