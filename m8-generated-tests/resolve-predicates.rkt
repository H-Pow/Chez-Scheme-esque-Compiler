#lang racket
(require cpsc411/compiler-lib cpsc411/langs/v8 "../resolve-predicates.rkt")
...
(check-by-interp
 '(module
    (define L.__main.5 (begin (set! r15 r15) (set! rax 25390) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.5 (begin (set! r15 r15) (set! rax 48958) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.6
...
(check-by-interp
 '(module
    (define L.__main.5
      (begin (set! r15 r15) (set! r14 22) (set! rax 30) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.7
      (begin
    ...
    (define L.__nested.5 (begin (set! rax 50494) (jump r15)))
    (define L.__nested.6 (begin (set! rax 57662) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.9
      (begin
    ...
    (define L.tmp.6 (begin (set! r14 928) (jump L.tmp.8)))
    (define L.tmp.7 (begin (set! r14 1456) (jump L.tmp.8)))
    (define L.tmp.8
      (begin (set! rdi r14) (set! r15 r15) (jump L.fun/boolean8393.4)))))
(check-by-interp
 '(module
    (define L.__main.11
      (begin
        (set! (rbp - 0) r15)
        (set! r15 14)
        (if (true) (jump L.tmp.8) (jump L.tmp.9))))
    (define L.+.6
      (begin
        (set! r15 r15)
        (set! r13 rdi)
    ...
    (define L.__nested.13 (begin (set! rax 574) (jump r15)))
    (define L.fun/fixnum8396.4
      (begin (set! r15 r15) (set! r14 rdi) (set! rax 1928) (jump r15)))
    (define L.tmp.8 (begin (set! (rbp - 8) 592) (jump L.tmp.10)))
    (define L.tmp.9 (begin (set! (rbp - 8) 776) (jump L.tmp.10)))
    (define L.tmp.10
      (begin
        (set! rbp (- rbp 16))
        (set! rdi 30)
...
(check-by-interp
 '(module
    ...
    (define L.tmp.16 (begin (set! r9 14) (jump L.tmp.18)))
    (define L.tmp.17 (begin (set! r9 6) (jump L.tmp.18)))
    (define L.tmp.18 (if (!= r9 6) (jump L.__nested.9) (jump L.__nested.10)))
    (define L.tmp.13 (begin (set! r9 14) (jump L.tmp.15)))
    (define L.tmp.14 (begin (set! r9 6) (jump L.tmp.15)))
    (define L.tmp.15 (if (!= r9 6) (jump L.__nested.11) (jump L.__nested.12)))
    (define L.__nested.11
      (begin
        ...
        (set! rax r14)
        (jump r15)))
    (define L.__nested.12 (begin (set! rax 318) (jump r15)))
    (define L.__nested.9
      (begin
        (set! r9 r14)
        (set! r9 (bitwise-and r9 7))
        (set! r9 r9)
        (if (= r9 0) (jump L.tmp.13) (jump L.tmp.14))))
    (define L.__nested.10 (begin (set! rax 318) (jump r15)))
 ...
 '(module
    (define L.__main.7
      (begin
        ...
        (set! r14 6)
        (if (false) (jump L.__nested.5) (jump L.__nested.6))))
    (define L.__nested.5 (begin (set! rax 48) (jump r15)))
    (define L.__nested.6 (begin (set! rax 1600) (jump r15)))))
(check-by-interp
 '(module
    (define L.__main.10
      (begin
        ...
        (set! r15 56894)
        (set! r14 6)
        (if (false) (jump L.tmp.7) (jump L.tmp.8))))
    (define L.fun/error8463.4
      (begin
        ...
        (set! rax r14)
        (jump r15)))
    (define L.tmp.7 (begin (set! r14 318) (jump L.tmp.9)))
    (define L.tmp.8 (begin (set! r14 37182) (jump L.tmp.9)))
    (define L.tmp.9
      (begin
        (set! rbp (- rbp 16))
        (set! rsi r14)
 ...
 '(module
    ...
    (define L.rp.8
      (begin
        (set! rbp (+ rbp 8))
        (set! r15 rax)
        (if (!= r15 6) (jump L.__nested.9) (jump L.__nested.10))))
    (define L.__nested.9
      (begin
        (set! rsi 14)
        (set! rdi 30)
...
(check-by-interp
 '(module
    ...
    (define L.__nested.11 (begin (set! rax 318) (jump r15)))
 ...
 '(module
    (define L.__main.8
      (begin
        ...
        (set! r14 1616)
        (set! r14 14)
        (if (true) (jump L.__nested.6) (jump L.__nested.7))))
    (define L.+.5
      (begin
        (set! r15 r15)
        (set! r13 rdi)
    ...
    (define L.__nested.11
      (begin (set! r13 r13) (set! r13 (+ r13 r14)) (set! rax r13) (jump r15)))
    (define L.__nested.12 (begin (set! rax 574) (jump r15)))
    (define L.__nested.9
      (begin
        (set! r9 r13)
        (set! r9 (bitwise-and r9 7))
        (set! r9 r9)
        (if (= r9 0) (jump L.tmp.13) (jump L.tmp.14))))
    (define L.__nested.10 (begin (set! rax 574) (jump r15)))
    (define L.__nested.6
...
(check-by-interp
 '(module
    ...
    (define L.__nested.15
      (begin (set! r13 r13) (set! r13 (+ r13 r14)) (set! rax r13) (jump r15)))
    (define L.__nested.16 (begin (set! rax 574) (jump r15)))
    (define L.__nested.13
      (begin
        ...
        (set! r9 r9)
        (if (= r9 0) (jump L.tmp.17) (jump L.tmp.18))))
    (define L.__nested.14 (begin (set! rax 574) (jump r15)))
    (define L.pair?.7
      (begin
        (set! r15 r15)
        (set! r14 rdi)
        ...
        (set! r14 r14)
        (if (= r14 1) (jump L.__nested.23) (jump L.__nested.24))))
    (define L.__nested.23 (begin (set! rax 14) (jump r15)))
    (define L.__nested.24 (begin (set! rax 6) (jump r15)))
 ...
 '(module
    (define L.__main.22
      (begin
        (set! (rbp - 0) r15)
        (set! r15 14)
        (if (true) (jump L.tmp.19) (jump L.tmp.20))))
    (define L.-.10
      (begin
        (set! r15 r15)
        (set! r13 rdi)
    ...
    (define L.fun/fixnum10118.6
      (begin
        ...
        (set! rax 1640)
        (jump r15)))
    (define L.tmp.19 (begin (set! r15 27710) (jump L.tmp.21)))
    (define L.tmp.20 (begin (set! r15 36158) (jump L.tmp.21)))
    (define L.tmp.21
      (begin
        (set! r14 30)
        (set! r14 232)
    ...
    (define L.tmp.16 (begin (set! (rbp - 24) 760) (jump L.tmp.18)))
    (define L.tmp.17 (begin (set! (rbp - 24) 424) (jump L.tmp.18)))
    (define L.tmp.18
      (begin
        (set! rbp (- rbp 40))
        (set! rdx 22)
...
(check-by-interp
 '(module
    ...
    (define L.__nested.20 (begin (set! rax 574) (jump r15)))
    (define L.*.8
      (begin
        (set! r15 r15)
        (set! r14 rdi)
 ...
 '(module
    ...
    (define L.boolean?.11
      (begin
        ...
        (set! r14 r14)
        (if (= r14 6) (jump L.__nested.19) (jump L.__nested.20))))
 ...
 '(module
    ...
    (define L.vector?.12
      (begin
        ...
        (set! r14 (bitwise-and r14 7))
        (set! r14 r14)
        (if (= r14 3) (jump L.__nested.27) (jump L.__nested.28))))
    ...
    (define L.empty?.9
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 22) (jump L.__nested.49) (jump L.__nested.50))))
    (define L.__nested.49 (begin (set! rax 14) (jump r15)))
    (define L.__nested.50 (begin (set! rax 6) (jump r15)))
 ...
 '(module
    ...
    (define L.fixnum?.10
      (begin
        ...
        (set! r14 (bitwise-and r14 7))
        (set! r14 r14)
        (if (= r14 0) (jump L.__nested.50) (jump L.__nested.51))))
 ...
 '(module
    ...
    (define L.ascii-char?.11
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 46) (jump L.__nested.20) (jump L.__nested.21))))
    ...
    (define L.void?.10
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 30) (jump L.__nested.22) (jump L.__nested.23))))
    (define L.__nested.22 (begin (set! rax 14) (jump r15)))
    (define L.__nested.23 (begin (set! rax 6) (jump r15)))
...
(check-by-interp
 '(module
    ...
    (define L.__nested.33
      (begin (set! r13 r13) (set! r13 (- r13 r14)) (set! rax r13) (jump r15)))
    (define L.__nested.34 (begin (set! rax 830) (jump r15)))
    (define L.__nested.31
      (begin
        (set! r9 r13)
        (set! r9 (bitwise-and r9 7))
    ...
    (define L.empty?.8
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 22) (jump L.__nested.61) (jump L.__nested.62))))
 ...
 '(module
    ...
    (define L.empty?.17
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 22) (jump L.__nested.40) (jump L.__nested.41))))
 ...
 '(module
    ...
    (define L.void?.17
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 30) (jump L.__nested.41) (jump L.__nested.42))))
    (define L.__nested.41 (begin (set! rax 14) (jump r15)))
    (define L.__nested.42 (begin (set! rax 6) (jump r15)))
    (define L.fixnum?.16
      (begin
        (set! r15 r15)
        (set! r14 rdi)
        ...
        (set! r14 (bitwise-and r14 7))
        (set! r14 r14)
        (if (= r14 0) (jump L.__nested.43) (jump L.__nested.44))))
 ...
 '(module
    ...
    (define L.void?.15
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 30) (jump L.__nested.52) (jump L.__nested.53))))
 ...
 '(module
    ...
    (define L.__nested.60
      (begin
        ...
        (set! r9 r9)
        (if (= r9 0) (jump L.tmp.64) (jump L.tmp.65))))
    (define L.__nested.61 (begin (set! rax 318) (jump r15)))
    (define L.boolean?.14
      (begin
        (set! r15 r15)
        (set! r14 rdi)
        ...
        (set! r14 (bitwise-and r14 247))
        (set! r14 r14)
        (if (= r14 6) (jump L.__nested.70) (jump L.__nested.71))))
 ...
 '(module
    ...
    (define L.boolean?.14
      (begin
        ...
        (set! r14 (bitwise-and r14 247))
        (set! r14 r14)
        (if (= r14 6) (jump L.__nested.71) (jump L.__nested.72))))
    ...
    (define L.void?.13
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 30) (jump L.__nested.73) (jump L.__nested.74))))
 ...
 '(module
    ...
    (define L.empty?.16
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 22) (jump L.__nested.72) (jump L.__nested.73))))
 ...
 '(module
    ...
    (define L.fixnum?.16
      (begin
        ...
        (set! r14 (bitwise-and r14 7))
        (set! r14 r14)
        (if (= r14 0) (jump L.__nested.25) (jump L.__nested.26))))
 ...
 '(module
    ...
    (define L.pair?.18
      (begin
        ...
        (set! r14 (bitwise-and r14 7))
        (set! r14 r14)
        (if (= r14 1) (jump L.__nested.27) (jump L.__nested.28))))
    (define L.__nested.27 (begin (set! rax 14) (jump r15)))
    (define L.__nested.28 (begin (set! rax 6) (jump r15)))
 ...
 '(module
    ...
    (define L.error?.15
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 62) (jump L.__nested.56) (jump L.__nested.57))))
    (define L.__nested.56 (begin (set! rax 14) (jump r15)))
    (define L.__nested.57 (begin (set! rax 6) (jump r15)))
    (define L.boolean?.14
      (begin
        ...
        (set! r14 (bitwise-and r14 247))
        (set! r14 r14)
        (if (= r14 6) (jump L.__nested.58) (jump L.__nested.59))))
    ...
    (define L.void?.13
      (begin
        ...
        (set! r14 (bitwise-and r14 255))
        (set! r14 r14)
        (if (= r14 30) (jump L.__nested.60) (jump L.__nested.61))))
    ...
    (define L.__nested.74
      (begin (set! r13 r13) (set! r13 (+ r13 r14)) (set! rax r13) (jump r15)))
    (define L.__nested.75 (begin (set! rax 574) (jump r15)))
    ...
    (define L.__nested.73 (begin (set! rax 574) (jump r15)))
    (define L.-.10
      (begin
        (set! r15 r15)
        (set! r13 rdi)
    ...
    (define L.__nested.84
      (begin (set! r13 r13) (set! r13 (- r13 r14)) (set! rax r13) (jump r15)))
    (define L.__nested.85 (begin (set! rax 830) (jump r15)))
    ...
    (define L.__nested.83 (begin (set! rax 830) (jump r15)))
