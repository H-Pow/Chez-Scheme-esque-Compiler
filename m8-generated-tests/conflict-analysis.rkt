...
(check-by-interp
 '(module
    ((new-frames (() ()))
     (locals (tmp.56 tmp.55 tmp-ra.59))
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (fixnum2.1 error1.2 empty0.3 tmp-ra.60))
...
(check-by-interp
 '(module
    ((new-frames (()))
     (locals (tmp.58 tmp-ra.57 tmp.54))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (ascii-char4.1 empty3.2 empty2.3 ascii-char1.4 void0.5 tmp-ra.60))
