...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.52 void0.2 ascii-char1.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.52 rbp)
       (tmp-ra.52 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.55 ascii-char0.3 boolean1.2 tmp.53))
     (call-undead ())
     (undead-out
      ((tmp-ra.55 rbp)
       (tmp-ra.55 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.52 empty0.2 ascii-char1.1))
     (call-undead ())
     (undead-out
      ((tmp-ra.52 rbp)
       (tmp-ra.52 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.55 void0.3 error1.2 tmp.53))
     (call-undead ())
     (undead-out
      ((tmp-ra.55 rbp)
       (tmp-ra.55 rbp)
...
(check-by-interp
 '(module
    ((new-frames ())
     (locals (tmp-ra.55 ascii-char0.3 error1.2 tmp.53))
     (call-undead ())
     (undead-out
      ((tmp-ra.55 rbp)
       (tmp-ra.55 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (fixnum0.3 fixnum1.2 empty2.1))
...
(check-by-interp
 '(module
    ((new-frames (() ()))
     (locals (ascii-char0.9 empty1.8 error2.7 tmp.61 tmp.62 tmp.67 tmp.60))
     ...
     (conflicts
      ((tmp-ra.66
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.66 fv0) (tmp.59 fv1))))
    (define L.fun/ascii-char8467.4
      ((new-frames ())
       (locals (tmp-ra.63 oprand0.2 oprand1.1))
       (undead-out
    ...
    (define L.fun/void8469.5
      ((new-frames ())
       (locals (tmp-ra.64 oprand0.4 oprand1.3))
       (undead-out
    ...
    (define L.fun/empty8468.6
      ((new-frames ())
       (locals (tmp-ra.65 oprand0.6 oprand1.5))
       (undead-out
    ...
    ((new-frames (() ()))
     ...
     (conflicts
      ((tmp-ra.70
       ...
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.70 fv0) (tmp.62 fv1))))
    (define L.*.6
      ((new-frames ())
       (locals
        (tmp.53
...
(check-by-interp
 '(module
    ((new-frames (() () ()))
     (locals (tmp.63 tmp.64 tmp.80 tmp.66 tmp.65 tmp.81))
    ...
    (define L.vector?.6
      ((new-frames ())
       (locals (tmp.62 tmp.47 tmp.79 tmp-ra.69))
       (undead-out
        ((rdi tmp-ra.69 rbp)
    ...
    (define L.fun/any8734.4
      ((new-frames ())
       (locals (tmp-ra.70 oprand0.3 oprand1.2 oprand2.1))
       (undead-out
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals (void0.4 void1.3 void2.2 ascii-char3.1))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () ()))
     (locals (empty0.4 tmp.68 fixnum1.3 tmp.70 fixnum2.2 void3.1))
     ...
     (conflicts
      ((tmp-ra.77
       ...
       (rdi (r15 rbp rsi))))
     (assignment ((tmp-ra.77 fv0) (tmp.67 fv1) (tmp.69 fv1))))
    (define L.*.10
      ((new-frames ())
       (locals
        (tmp.54
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () ()))
     ...
     (conflicts
      ((tmp-ra.90
       ...
       (r15 (rbp rdi rsi rdx))))
     (assignment ((tmp-ra.90 fv0) (tmp.74 fv1) (tmp.76 fv2))))
    (define L.error?.16
      ((new-frames ())
       (locals (tmp.67 tmp.59 tmp.91 tmp-ra.78))
       (undead-out
        ((rdi tmp-ra.78 rbp)
    ...
    (define L.fixnum?.15
      ((new-frames ())
       (locals (tmp.68 tmp.54 tmp.92 tmp-ra.79))
       (undead-out
        ((rdi tmp-ra.79 rbp)
    ...
    (define L.vector?.13
      ((new-frames ())
       (locals (tmp.73 tmp.61 tmp.96 tmp-ra.81))
       (undead-out
        ((rdi tmp-ra.81 rbp)
    ...
    (define L.fun/empty9034.4
      ((new-frames ())
       (locals (tmp-ra.82 oprand0.3 oprand1.2 oprand2.1))
       (undead-out
    ...
    (define L.fun/ascii-char9031.10
      ((new-frames ())
       (locals (tmp-ra.88 oprand0.6 oprand1.5 oprand2.4))
       (undead-out
    ...
    (define L.fun/boolean9033.11
      ((new-frames ())
       (locals (tmp-ra.89 oprand0.9 oprand1.8 oprand2.7))
       (undead-out
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals (error0.4 void1.3 ascii-char3.1))
     ...
     (conflicts
      ((tmp-ra.58 (ascii-char3.1 empty2.2 void1.3 error0.4 rax rbp))
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.58 fv0) (empty2.2 fv1))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (empty0.4 error1.3 error2.2 error3.1 tmp.55))
    ...
    (define L.boolean?.10
      ((new-frames ())
       (locals (tmp.54 tmp.42 tmp.63 tmp-ra.56))
       (undead-out
        ((rdi tmp-ra.56 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () ()))
     (locals (empty0.4 ascii-char2.2 void3.1))
     ...
     (conflicts
      ((tmp-ra.58 (void3.1 ascii-char2.2 void1.3 empty0.4 rax rbp))
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.58 fv0) (void1.3 fv1))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (ascii-char1.3 tmp.64 fixnum2.2 ascii-char3.1))
     ...
     (conflicts
      ((tmp-ra.70
       ...
       (rdi (r15 rbp rsi))))
     (assignment ((tmp-ra.70 fv0) (tmp.63 fv1) (void0.4 fv2))))
    (define L.-.9
      ((new-frames ())
       (locals
        (tmp.54
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () () ()))
     (locals
      (ascii-char0.5 tmp.64 boolean1.4 tmp.67 tmp.70 tmp.68 fixnum3.2 void4.1))
     ...
     (assignment
      ((tmp-ra.78 fv0) (empty2.3 fv1) (tmp.69 fv2) (tmp.65 fv3) (tmp.66 fv2))))
    (define L.-.11
      ((new-frames ())
       (locals
        (tmp.55
    ...
    (define L.ascii-char?.9
      ((new-frames ())
       (locals (tmp.63 tmp.46 tmp.85 tmp-ra.73))
       (undead-out
        ((rdi tmp-ra.73 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (ascii-char0.5 ascii-char1.4 error2.3 ascii-char4.1))
     ...
     (conflicts
      ((tmp-ra.60
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.60 fv0) (void3.2 fv1))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (error0.5 void1.4 ascii-char2.3 void3.2 error4.1))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals
      (error0.5 empty1.4 tmp.70 tmp.73 tmp.71 fixnum2.3 void3.2 error4.1))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals
      (tmp.66 tmp.69 tmp.67 fixnum0.5 empty1.4 empty2.3 void3.2 error4.1))
     ...
     (conflicts
      ((tmp-ra.77
       ...
       (rdi (r15 rbp rsi))
       (r15 (rbp rdi rsi))))
     (assignment ((tmp-ra.77 fv0) (tmp.68 fv1) (tmp.64 fv2) (tmp.65 fv1))))
    (define L.-.11
      ((new-frames ())
       (locals
        (tmp.55
...
(check-by-interp
 '(module
    ...
    (define L.fixnum?.11
      ((new-frames ())
       (locals (tmp.55 tmp.42 tmp.96 tmp-ra.88))
       (undead-out
        ((rdi tmp-ra.88 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals (ascii-char0.5 tmp.65 tmp.68 tmp.66 fixnum2.3 void3.2 void4.1))
     ...
     (conflicts
      ((tmp-ra.75
       ...
       (rdi (r15 rbp rsi))))
     (assignment
      ((tmp-ra.75 fv0) (void1.4 fv1) (tmp.67 fv2) (tmp.63 fv3) (tmp.64 fv2))))
    (define L.-.10
      ((new-frames ())
       (locals
        (tmp.55
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (empty1.4 empty2.3 error3.2 empty4.1))
     ...
     (conflicts
      ((tmp-ra.60 (empty4.1 error3.2 empty2.3 empty1.4 error0.5 rax rbp))
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.60 fv0) (error0.5 fv1))))
...
(check-by-interp
 '(module
    ((new-frames (() () () () () () () () () () ()))
     (locals
      (empty0.5 void1.4 void2.3 ascii-char3.2 void4.1 tmp.70 tmp.73 tmp.71))
     (call-undead (tmp.72 tmp.68 tmp.69 tmp-ra.82))
     (undead-out
      ((tmp-ra.82 rbp)
       ((rax tmp-ra.82 rbp) ((r15 rbp) (r15 rbp)))
...
(check-by-interp
 '(module
    ((new-frames (() () () () ()))
     (locals (void0.5 empty1.4 void2.3 void3.2 ascii-char4.1))
...
(check-by-interp
 '(module
    ...
    (define L.error?.19
      ((new-frames ())
       (locals (tmp.56 tmp.48 tmp.103 tmp-ra.87))
       (undead-out
        ((rdi tmp-ra.87 rbp)
    ...
    (define L.void?.15
      ((new-frames ())
       (locals (tmp.70 tmp.46 tmp.114 tmp-ra.91))
       (undead-out
        ((rdi tmp-ra.91 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.fixnum?.15
      ((new-frames ())
       (locals (tmp.56 tmp.43 tmp.111 tmp-ra.99))
       (undead-out
        ((rdi tmp-ra.99 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.void?.13
      ((new-frames ())
       (locals (tmp.56 tmp.46 tmp.123 tmp-ra.113))
       (undead-out
        ((rdi tmp-ra.113 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.ascii-char?.17
      ((new-frames ())
       (locals (tmp.56 tmp.47 tmp.115 tmp-ra.101))
       (undead-out
        ((rdi tmp-ra.101 rbp)
    ...
    (define L.boolean?.16
      ((new-frames ())
       (locals (tmp.57 tmp.44 tmp.116 tmp-ra.102))
       (undead-out
        ((rdi tmp-ra.102 rbp)
...
(check-by-interp
 '(module
    ...
    (define L.boolean?.17
      ((new-frames ())
       (locals (tmp.56 tmp.44 tmp.99 tmp-ra.85))
       (undead-out
        ((rdi tmp-ra.85 rbp)
...
(check-by-interp
 '(module
    ((new-frames (() () () () () ()))
     (locals (void0.6 empty2.4 void3.3 void4.2 void5.1))
     ...
     (conflicts
      ((tmp-ra.68 (void5.1 void4.2 void3.3 empty2.4 error1.5 void0.6 rax rbp))
       ...
       (r15 (rbp))))
     (assignment ((tmp-ra.68 fv0) (error1.5 fv1))))
...
(check-by-interp
 '(module
    ...
    (define L.pair?.14
      ((new-frames ())
       (locals (tmp.69 tmp.49 tmp.113 tmp-ra.92))
       (undead-out
        ((rdi tmp-ra.92 rbp)
