...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8485.7 (lambda ((free ())) () 60)))
      (unsafe-procedure-call fun/fixnum8485.7))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8488.7 (lambda ((free ())) () #\A)))
      (unsafe-procedure-call fun/ascii-char8488.7))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8491.7 (lambda ((free ())) () #\Z)))
...
(check-by-interp
 '(module
    (letrec ((fun/empty8500.7 (lambda ((free ())) () empty)))
...
(check-by-interp
 '(module
    (letrec ((unsafe-vector-set!.5
             ...
             (vector-set!.83
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.60)
                  ...
                  (error 10))))
             (vector-init-loop.31
              (lambda ((free (vector-init-loop.31)))
                (len.32 i.34 vec.33)
                (if (eq? len.32 i.34)
                  vec.33
                  (begin
             ...
             (fun/void8514.8 (lambda ((free ())) () (void)))
             (fun/void8513.9 (lambda ((free ())) () (void))))
...
(check-by-interp
 '(module
    (letrec ((fun/void8538.7 (lambda ((free ())) () (void))))
      (if (if (void) (void) #f) (unsafe-procedure-call fun/void8538.7) #f))))
(check-by-interp '(module (if #f #\_ #\i)))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8543.7
              (lambda ((free (fun/fixnum8544.8)))
                ()
                (unsafe-procedure-call fun/fixnum8544.8)))
             (fun/fixnum8544.8 (lambda ((free ())) () 117)))
      (unsafe-procedure-call fun/fixnum8543.7))))
(check-by-interp '(module (if #f (error 164) (error 184))))
(check-by-interp '(module (let () #\Z)))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8551.7 (lambda ((free ())) () (if #t 67 129))))
      (unsafe-procedure-call fun/fixnum8551.7))))
(check-by-interp
 '(module
    (letrec ((fun/error8558.7
              (lambda ((free (fun/error8559.8)))
                ()
                (unsafe-procedure-call fun/error8559.8)))
             (fun/error8559.8 (lambda ((free ())) () (error 186))))
      (unsafe-procedure-call fun/error8558.7))))
(check-by-interp
 '(module
    (letrec ((fun/void8562.7
              (lambda ((free (fun/void8563.10)))
                ()
                (unsafe-procedure-call fun/void8563.10)))
             (fun/void8565.8 (lambda ((free ())) () (void)))
             (fun/void8564.9
              (lambda ((free (fun/void8565.8)))
                ()
                (unsafe-procedure-call fun/void8565.8)))
             (fun/void8563.10 (lambda ((free ())) () (void))))
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8568.7
              (lambda ((free (fun/ascii-char8569.8)))
                (oprand0.9)
                (unsafe-procedure-call fun/ascii-char8569.8)))
             (fun/ascii-char8569.8 (lambda ((free ())) () #\X)))
      (unsafe-procedure-call fun/ascii-char8568.7 (if #t 65 125)))))
(check-by-interp
 '(module
    (letrec ((cons.78
              (lambda ((free ())) (tmp.70 tmp.71) (cons tmp.70 tmp.71)))
             (error?.77 (lambda ((free ())) (tmp.65) (error? tmp.65)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
...
(check-by-interp
 '(module
    (letrec ((cons.64
              (lambda ((free ())) (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             (vector-init-loop.13
             ...
             (make-vector.63
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.39)
                  ...
                  (error 8))))
             (fun/boolean8574.7 (lambda ((free ())) (oprand0.8) #f)))
      (if (unsafe-procedure-call
           fun/boolean8574.7
...
(check-by-interp
 '(module
    (letrec ((fun/empty8578.7
              (lambda ((free (fun/empty8579.8)))
                ()
                (unsafe-procedure-call fun/empty8579.8)))
             (fun/empty8579.8 (lambda ((free ())) () empty))
             (fun/empty8577.9
              (lambda ((free ())) (oprand0.10) (if #f empty empty))))
        ...
        (if (unsafe-procedure-call
          ...
          (if (let () empty)
            (if (let ((procedure0.13
                       (letrec ((lam.66 (lambda ((free ())) () #f))) lam.66))
                      (fixnum1.12 204))
                  empty)
             ...
             (*.76
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.36)
                  ...
                  (error 1))))
             (error?.75 (lambda ((free ())) (tmp.63) (error? tmp.63)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (make-vector.73
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.49)
                  ...
                  (error 8))))
             (fun/vector8584.8
              (lambda ((free (vector-set!.74 error?.75 make-vector.73)))
                ()
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42848282.19
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  g42848282.19
                                                  tmp.7.11)))))))))))))))))))
             (fun/fixnum8582.9 (lambda ((free ())) () 234))
             (fun/fixnum8583.10
              (lambda ((free ())) (oprand0.20) (if #f 70 77))))
      (unsafe-procedure-call
       >=.77
       (unsafe-procedure-call
        *.76
...
(check-by-interp
 '(module
    (letrec ((error?.92 (lambda ((free ())) (tmp.82) (error? tmp.82)))
             (fun/empty8588.19
              (lambda ((free ())) (oprand0.21) (let () empty)))
             (fun/empty8587.20 (lambda ((free ())) () empty)))
...
(check-by-interp
 '(module
    (letrec ((error?.90 (lambda ((free ())) (tmp.79) (error? tmp.79)))
             (cons.89
              (lambda ((free ())) (tmp.84 tmp.85) (cons tmp.84 tmp.85)))
             (fun/empty8592.11 (lambda ((free ())) () (if #t empty empty)))
             (fun/empty8594.12
              (lambda ((free ())) (oprand0.16) (if #f empty empty)))
             (fun/empty8593.13
              (lambda ((free ())) (oprand0.17) (let () empty)))
             (fun/empty8591.14 (lambda ((free ())) (oprand0.18) empty))
             (fun/empty8595.15 (lambda ((free ())) () empty)))
      (let ((g42855921.19
             (let ((pair0.21
                    (unsafe-procedure-call
                     cons.89
...
(check-by-interp
 '(module
    (letrec ((error?.64 (lambda ((free ())) (tmp.54) (error? tmp.54)))
             (fun/fixnum8598.7 (lambda ((free ())) () 203))
             (fun/fixnum8599.8 (lambda ((free ())) () 64)))
...
(check-by-interp
 '(module
    (letrec ((cons.63
              (lambda ((free ())) (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             (fun/fixnum8602.7
              (lambda ((free (fun/fixnum8603.9)))
                (oprand0.10)
                (unsafe-procedure-call fun/fixnum8603.9)))
             (fun/fixnum8604.8 (lambda ((free ())) () 49))
             (fun/fixnum8603.9
              (lambda ((free (fun/fixnum8604.8)))
                ()
                (unsafe-procedure-call fun/fixnum8604.8))))
      (unsafe-procedure-call
       fun/fixnum8602.7
       (if #t
         (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.81 (lambda ((free ())) (tmp.71) (error? tmp.71)))
             (fun/error8609.14 (lambda ((free ())) () (error 43)))
             (fun/error8608.15 (lambda ((free ())) () (error 155)))
             (fun/error8607.16 (lambda ((free ())) (oprand0.17) oprand0.17)))
      (let ((tmp.7.18
             (let ((tmp.8.19
...
(check-by-interp
 '(module
    (letrec ((fun/fixnum8612.7
              (lambda ((free (fun/fixnum8613.9)))
                ()
                (unsafe-procedure-call fun/fixnum8613.9)))
             (fun/fixnum8614.8 (lambda ((free ())) () 46))
             (fun/fixnum8613.9
              (lambda ((free (fun/fixnum8614.8)))
                ()
                (unsafe-procedure-call fun/fixnum8614.8))))
...
(check-by-interp
 '(module
    (letrec ((error?.107 (lambda ((free ())) (tmp.95) (error? tmp.95)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.59 tmp.60 tmp.61)
             ...
             (vector-set!.106
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.84)
                  ...
                  (error 10))))
             (vector-init-loop.55
              (lambda ((free (vector-init-loop.55)))
                (len.56 i.58 vec.57)
                (if (eq? len.56 i.58)
                  vec.57
                  (begin
             ...
             (make-vector.105
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.81)
                  ...
                  (error 8))))
             (fun/boolean8626.14 (lambda ((free ())) (oprand0.16) #f))
             (fun/boolean8625.15
              (lambda ((free ())) (oprand0.17) (if #t #t #f))))
      (unsafe-procedure-call
       fun/boolean8625.15
...
(check-by-interp
 '(module
    (letrec ((cons.62
             ...
             (fun/empty8631.7
              (lambda ((free ())) (oprand0.8) (if #t empty empty))))
      (unsafe-procedure-call
       fun/empty8631.7
...
(check-by-interp
 '(module
    (letrec ((fun/empty8634.7 (lambda ((free ())) () (if #t empty empty))))
             ...
             (make-vector.74
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.50)
                  ...
                  (error 8))))
             (fun/vector8638.8
              (lambda ((free (vector-set!.75 error?.76 make-vector.74)))
                ()
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42905570.19
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  g42905570.19
                                                  tmp.7.11)))))))))))))))))))
             (fun/void8637.9 (lambda ((free ())) () (void)))
             (fun/fixnum8639.10 (lambda ((free ())) () 23)))
      (let ((void0.21 (unsafe-procedure-call fun/void8637.9))
            (procedure1.20
             (letrec ((lam.77
                       (lambda ((free (fun/vector8638.8)))
                         ()
                         (unsafe-procedure-call fun/vector8638.8))))
               lam.77)))
        (unsafe-procedure-call fun/fixnum8639.10)))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8642.7 (lambda ((free ())) () 171)))
      (if (let () #f)
        (if #f 157 104)
        (unsafe-procedure-call fun/fixnum8642.7)))))
(check-by-interp
 '(module
    (letrec ((error?.73 (lambda ((free ())) (tmp.61) (error? tmp.61)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
 ...
 '(module
    (letrec ((error?.92 (lambda ((free ())) (tmp.80) (error? tmp.80)))
             ...
             (fun/ascii-char8647.14
              (lambda ((free (make-vector.90 error?.92 vector-set!.91)))
                ()
                (let ((vector0.16
                       (let ((tmp.7.17
                              (unsafe-procedure-call make-vector.90 8)))
                         (let ((g42917032.18
                                (unsafe-procedure-call
                                 vector-set!.91
                                 tmp.7.17
                                                   ...
                                                   (if (unsafe-procedure-call
                                                     ...
                                                     (let ((g42917039.25
                                                       ...
                                                       (if (unsafe-procedure-call
                                                         ...
                                                         tmp.7.17)))))))))))))))))))
                  #\])))
             (fun/ascii-char8648.15 (lambda ((free ())) (oprand0.26) #\u)))
...
(check-by-interp
 '(module
    (letrec ((error?.83 (lambda ((free ())) (tmp.71) (error? tmp.71)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.35 tmp.36 tmp.37)
                (if (unsafe-fx< tmp.36 (unsafe-vector-length tmp.35))
             ...
             (make-vector.81
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.57)
                  (unsafe-procedure-call make-init-vector.4 tmp.57)
                  (error 8))))
             (fun/void8651.9 (lambda ((free ())) () (void))))
      (let ((vector0.10
...
(check-by-interp
 '(module
    (letrec ((fun/void8654.7
              (lambda ((free ())) (oprand0.8) (if #f (void) (void)))))
      (unsafe-procedure-call
       fun/void8654.7
       (let ((procedure0.9
              (letrec ((lam.63 (lambda ((free ())) (oprand0.10) #t))) lam.63)))
         (letrec ((lam.64 (lambda ((free ())) () 908))) lam.64))))))
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8657.7 (lambda ((free ())) (oprand0.8) #\^)))
      (let () (unsafe-procedure-call fun/ascii-char8657.7 (void))))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8661.7 (lambda ((free ())) () 122))
             (fun/empty8660.8 (lambda ((free ())) () empty)))
      (let ((empty0.10 (unsafe-procedure-call fun/empty8660.8))
            (boolean1.9 #f))
        (unsafe-procedure-call fun/fixnum8661.7)))))
(check-by-interp
 '(module
    (letrec ((cons.66
              (lambda ((free ())) (tmp.60 tmp.61) (cons tmp.60 tmp.61)))
             (error?.65 (lambda ((free ())) (tmp.55) (error? tmp.55)))
             (fun/fixnum8664.7 (lambda ((free ())) (oprand0.8) 40)))
      (if (if #t 75 131)
...
(check-by-interp
 '(module
    (letrec ((fun/error8667.7
              (lambda ((free ()))
                (oprand0.8)
                (if #t (error 243) (error 182)))))
      (unsafe-procedure-call fun/error8667.7 (if #f #\k #\l)))))
(check-by-interp
 '(module
    (letrec ((error?.66 (lambda ((free ())) (tmp.56) (error? tmp.56)))
             (fun/empty8670.9 (lambda ((free ())) () empty))
             (fun/empty8671.10 (lambda ((free ())) () (if #f empty empty))))
      (let ((g42943766.11
...
(check-by-interp
 '(module
    (letrec ((fun/void8674.7 (lambda ((free ())) () (void))))
      (let () (unsafe-procedure-call fun/void8674.7)))))
(check-by-interp
 '(module
    (letrec ((error?.78 (lambda ((free ())) (tmp.64) (error? tmp.64)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.28 tmp.29 tmp.30)
                (if (unsafe-fx< tmp.29 (unsafe-vector-length tmp.28))
             ...
             (make-vector.76
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.50)
                  ...
                  (error 8))))
             (cons.75
              (lambda ((free ())) (tmp.69 tmp.70) (cons tmp.69 tmp.70)))
             (fixnum?.74 (lambda ((free ())) (tmp.59) (fixnum? tmp.59)))
             (fun/void8678.8 (lambda ((free ())) () (void)))
             (fun/any8677.9 (lambda ((free ())) () 207)))
      (let ((boolean0.12
             (unsafe-procedure-call
              fixnum?.74
...
(check-by-interp
 '(module
    (letrec ((procedure?.98 (lambda ((free ())) (tmp.88) (procedure? tmp.88)))
             (error?.97 (lambda ((free ())) (tmp.84) (error? tmp.84)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (fun/error8682.16 (lambda ((free ())) () (error 7)))
             (fun/boolean8683.17 (lambda ((free ())) () #f))
             (fun/error8681.18
              (lambda ((free (fun/error8682.16)))
                ()
                (unsafe-procedure-call fun/error8682.16)))
             (fun/boolean8684.19 (lambda ((free ())) () #t)))
      (let ((pair0.22
             (unsafe-procedure-call
              cons.94
              (unsafe-procedure-call
            ...
            (procedure2.20
             (letrec ((lam.99
                       (lambda ((free
                                 (make-vector.95 error?.97 vector-set!.96)))
                         ()
                         (let ()
                           (let ((tmp.7.23
                                  (unsafe-procedure-call make-vector.95 8)))
                             (let ((g42955226.24
                                    (unsafe-procedure-call
                                     vector-set!.96
                                     tmp.7.23
              ...
              (if tmp.9.33
                ...
                (let ((tmp.10.34 (unsafe-procedure-call fun/boolean8683.17)))
                  (if tmp.10.34
                    tmp.10.34
                    (let ((tmp.11.35
                           (unsafe-procedure-call fun/boolean8684.19)))
                      (if tmp.11.35
                        tmp.11.35
                        (let ((tmp.12.36
                               (let ((g42955234.37 #f))
...
(check-by-interp
 '(module
    (letrec ((error?.93 (lambda ((free ())) (tmp.80) (error? tmp.80)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.44 tmp.45 tmp.46)
                (if (unsafe-fx< tmp.45 (unsafe-vector-length tmp.44))
             ...
             (make-vector.91
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.66)
                  ...
                  (error 8))))
             (cons.90
              (lambda ((free ())) (tmp.85 tmp.86) (cons tmp.85 tmp.86)))
             (fun/error8688.15 (lambda ((free ())) () (error 156)))
             (fun/error8687.16
              (lambda ((free (fun/error8688.15)))
...
(check-by-interp
 '(module
    (letrec ((error?.86 (lambda ((free ())) (tmp.74) (error? tmp.74)))
             (boolean?.85 (lambda ((free ())) (tmp.70) (boolean? tmp.70)))
             (cons.84
              (lambda ((free ())) (tmp.79 tmp.80) (cons tmp.79 tmp.80)))
             (fun/void8692.11
              (lambda ((free ())) (oprand0.16 oprand1.15) (void)))
             (fun/void8693.12
              (lambda ((free ())) (oprand0.18 oprand1.17) (let () (void))))
             (fun/boolean8691.13 (lambda ((free ())) () #f))
             (fun/void8694.14 (lambda ((free ())) () (void))))
      (if (let ((tmp.7.19
                 (let ((pair0.21
                        (unsafe-procedure-call
                         cons.84
        ...
        (if (let ((procedure0.27
                   (letrec ((lam.87 (lambda ((free ())) () (error 38))))
                     lam.87))
                  (error1.26 (error 99))
                  (empty2.25 empty))
              (void))
...
(check-by-interp
 '(module
    (letrec ((fun/error8697.7 (lambda ((free ())) () (let () (error 156)))))
      (let ((error0.9 (unsafe-procedure-call fun/error8697.7))
            (error1.8 (let () (error 2))))
        (if #t (error 191) (error 77))))))
(check-by-interp
 '(module
    (letrec ((fun/void8702.13 (lambda ((free ())) () (void)))
             (fun/void8701.14
              (lambda ((free (fun/void8702.13)))
                ()
                (unsafe-procedure-call fun/void8702.13)))
             (fun/empty8700.15 (lambda ((free ())) () empty)))
      (let ((empty0.18
...
(check-by-interp
 '(module
    (letrec ((cons.150
              (lambda ((free ())) (tmp.142 tmp.143) (cons tmp.142 tmp.143)))
             (vector-init-loop.97
              (lambda ((free (vector-init-loop.97)))
                (len.98 i.100 vec.99)
                (if (eq? len.98 i.100)
                  vec.99
                  (begin
             ...
             (make-vector.149
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.123)
                  ...
                  (error 8))))
             (error?.148 (lambda ((free ())) (tmp.137) (error? tmp.137)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.101 tmp.102 tmp.103)
             ...
             (vector-set!.147
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.126)
                  ...
                  (error 10))))
             (fun/void8706.20
              (lambda ((free ())) (oprand0.32 oprand1.31) (let () oprand1.31)))
             (fun/void8714.21
              (lambda ((free (fun/void8715.28)))
                ()
                (unsafe-procedure-call fun/void8715.28)))
             (fun/void8713.22 (lambda ((free ())) () (void)))
             (fun/void8705.23 (lambda ((free ())) () (void)))
             (fun/void8708.24 (lambda ((free ())) (oprand0.33) (void)))
             (fun/void8709.25 (lambda ((free ())) () (void)))
             (fun/void8710.26 (lambda ((free ())) (oprand0.34) (void)))
             (fun/boolean8712.27 (lambda ((free ())) () #f))
             (fun/void8715.28 (lambda ((free ())) () (void)))
             (fun/void8711.29
              (lambda ((free (vector-set!.147)))
                ...
                (unsafe-procedure-call
                 ...
                 5
                 oprand0.36)))
             (fun/void8707.30 (lambda ((free ())) (oprand0.37) oprand0.37)))
        ...
        (if (if (if #f (void) (void))
          ...
          (if (if (let ((boolean0.69 #f)) #t)
            ...
            (if (let ()
                  (unsafe-procedure-call
                   fun/void8711.29
                   (letrec ((lam.151 (lambda ((free ())) () 1012))) lam.151)
...
(check-by-interp
 '(module
    (letrec ((cons.64
             ...
             (fun/boolean8722.7 (lambda ((free ())) () #t))
             (fun/fixnum8721.8
              (lambda ((free (cons.64 fun/boolean8722.7)))
                ()
    ...
    (letrec ((unsafe-vector-ref.6
              (lambda ((free ()))
                ...
                (if (unsafe-fx< tmp.36 (unsafe-vector-length tmp.35))
                  ...
                  (error 11))))
             (vector-ref.79
              (lambda ((free (unsafe-vector-ref.6)))
                (tmp.57 tmp.58)
                (if (fixnum? tmp.58)
                  (if (vector? tmp.57)
             ...
             (make-vector.77
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.52)
                  ...
                  (error 8))))
             (error?.76 (lambda ((free ())) (tmp.66) (error? tmp.66)))
             (fun/ascii-char8726.8 (lambda ((free ())) () (if #t #\H #\a)))
             (fun/ascii-char8725.9 (lambda ((free ())) () #\s)))
      (let ((g42981987.10
...
(check-by-interp
 '(module
    (letrec ((pair?.129 (lambda ((free ())) (tmp.116) (pair? tmp.116)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.128
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.104)
                  ...
                  (error 10))))
             (vector-init-loop.75
              (lambda ((free (vector-init-loop.75)))
                (len.76 i.78 vec.77)
                (if (eq? len.76 i.78)
                  vec.77
                  (begin
             ...
             (make-vector.127
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.101)
                  ...
                  (error 8))))
             (error?.126 (lambda ((free ())) (tmp.115) (error? tmp.115)))
             (cons.125
              (lambda ((free ())) (tmp.120 tmp.121) (cons tmp.120 tmp.121)))
             (fun/empty8731.21 (lambda ((free ())) () empty))
             (fun/pair8730.22
              (lambda ((free (cons.125)))
                ()
                (if #t
                  (unsafe-procedure-call
                   cons.125
...
(check-by-interp
 '(module
    (letrec ((fun/error8736.7
              (lambda ((free (fun/error8737.9)))
                ()
                (unsafe-procedure-call fun/error8737.9)))
             (fun/boolean8735.8 (lambda ((free ())) () #f))
             (fun/error8737.9 (lambda ((free ())) () (error 242)))
             (fun/boolean8734.10
              (lambda ((free (fun/boolean8735.8)))
                ()
                (unsafe-procedure-call fun/boolean8735.8))))
      (let ((procedure0.13
             (letrec ((lam.66 (lambda ((free ())) () (let () #t)))) lam.66))
            (boolean1.12 (unsafe-procedure-call fun/boolean8734.10))
            (ascii-char2.11 (if #t #\z #\u)))
        (unsafe-procedure-call fun/error8736.7)))))
(check-by-interp
 '(module
    (letrec ((error?.82 (lambda ((free ())) (tmp.72) (error? tmp.72)))
             (fun/void8741.11 (lambda ((free ())) () (void)))
             (fun/void8740.12
              (lambda ((free ())) (oprand0.14 oprand1.13) (void))))
      (let ()
    ...
    (letrec ((|+.80|
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.42)
                  ...
                  (error 2))))
             (error?.79 (lambda ((free ())) (tmp.67) (error? tmp.67)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.31 tmp.32 tmp.33)
             ...
             (vector-set!.78
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.56)
                  ...
                  (error 10))))
             (vector-init-loop.27
              (lambda ((free (vector-init-loop.27)))
                (len.28 i.30 vec.29)
                (if (eq? len.28 i.30)
                  vec.29
                  (begin
             ...
             (make-vector.77
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.53)
                  ...
                  (error 8))))
             (fun/empty8745.8
              (lambda ((free (fun/empty8746.11)))
                ()
                (unsafe-procedure-call fun/empty8746.11)))
             (fun/empty8744.9
              (lambda ((free (fun/empty8745.8)))
                (oprand0.13)
                (unsafe-procedure-call fun/empty8745.8)))
             (fun/vector8748.10
              (lambda ((free (vector-set!.78 error?.79 make-vector.77)))
                ()
                                            ...
                                            (if (unsafe-procedure-call
                                              ...
                                              (let ((g42997305.22
                                                ...
                                                (if (unsafe-procedure-call
                                                  ...
                                                  tmp.7.14)))))))))))))))))))
             (fun/empty8746.11
              (lambda ((free (fun/empty8747.12)))
                ()
                (unsafe-procedure-call fun/empty8747.12)))
             (fun/empty8747.12 (lambda ((free ())) () empty)))
      (unsafe-procedure-call
       fun/empty8744.9
...
(check-by-interp
 '(module
    (letrec ((error?.80 (lambda ((free ())) (tmp.69) (error? tmp.69)))
             (ascii-char?.79
              (lambda ((free ())) (tmp.68) (ascii-char? tmp.68)))
             (fun/boolean8753.10 (lambda ((free ())) (oprand0.11) #t)))
      (if (let ((ascii-char0.14 #\q) (void1.13 (void)) (boolean2.12 #t)) #t)
        (let ((empty0.17 empty) (fixnum1.16 19) (boolean2.15 #f)) #t)
        (let ((tmp.7.18
               (unsafe-procedure-call
                ascii-char?.79
                (letrec ((lam.81 (lambda ((free ())) () 526))) lam.81))))
          (if tmp.7.18
            tmp.7.18
            (let ((tmp.8.19 (if #f #t #t)))
              (if tmp.8.19
                tmp.8.19
                (let ((tmp.9.20
                       (unsafe-procedure-call fun/boolean8753.10 195)))
                  (if tmp.9.20
                    tmp.9.20
                    (let ((g43004938.21 #f))
             ...
             (make-vector.76
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.52)
                  (unsafe-procedure-call make-init-vector.4 tmp.52)
                  (error 8))))
             (fun/boolean8757.8 (lambda ((free ())) () #f))
             (fun/boolean8756.9
              (lambda ((free (fun/boolean8757.8)))
...
(check-by-interp
 '(module
    (letrec ((cons.69
              (lambda ((free ())) (tmp.64 tmp.65) (cons tmp.64 tmp.65)))
             (fun/empty8761.9 (lambda ((free ())) () empty))
             (fun/empty8760.10 (lambda ((free ())) () empty)))
      (let ((empty0.12
...
(check-by-interp
 '(module
    (letrec ((error?.82 (lambda ((free ())) (tmp.70) (error? tmp.70)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.81
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.59)
                  ...
                  (error 10))))
             (vector-init-loop.30
              (lambda ((free (vector-init-loop.30)))
                (len.31 i.33 vec.32)
                (if (eq? len.31 i.33)
                  vec.32
                  (begin
             ...
             (make-vector.80
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.56)
                  ...
                  (error 8))))
             (fun/fixnum8766.9 (lambda ((free ())) (oprand0.12) 66))
             (fun/fixnum8765.10
              (lambda ((free (fun/fixnum8766.9)))
                ()
                (unsafe-procedure-call fun/fixnum8766.9 empty)))
             (fun/boolean8764.11
              (lambda ((free ())) (oprand0.14 oprand1.13) (let () #f))))
      (if (unsafe-procedure-call
           fun/boolean8764.11
           (let ((tmp.7.15
                  (letrec ((lam.83 (lambda ((free ())) () 522))) lam.83)))
             (if tmp.7.15
               tmp.7.15
               (letrec ((lam.84 (lambda ((free ())) () 662))) lam.84)))
             ...
             (*.70
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.33)
                  ...
                  (error 1))))
             (fun/fixnum8773.7
              (lambda ((free (fun/fixnum8774.10)))
                (oprand0.12)
                (unsafe-procedure-call fun/fixnum8774.10)))
             (fun/fixnum8771.8
              (lambda ((free (fun/fixnum8772.11)))
                ()
                (unsafe-procedure-call fun/fixnum8772.11 #f)))
             (fun/fixnum8775.9 (lambda ((free ())) (oprand0.13) 117))
             (fun/fixnum8774.10 (lambda ((free ())) () 126))
             (fun/fixnum8772.11 (lambda ((free ())) (oprand0.14) 87)))
      (unsafe-procedure-call
       |+.72|
       (if (let () 213)
...
(check-by-interp
 '(module
    (letrec ((unsafe-vector-set!.5
             ...
             (error?.73 (lambda ((free ())) (tmp.63) (error? tmp.63)))
             (fun/empty8780.8 (lambda ((free ())) () empty)))
...
(check-by-interp
 '(module
    (letrec ((vector-init-loop.110
              (lambda ((free (vector-init-loop.110)))
                (len.111 i.113 vec.112)
                (if (eq? len.111 i.113)
                  vec.112
                  (begin
             ...
             (make-vector.163
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.136)
                  ...
                  (error 8))))
             (error?.162 (lambda ((free ())) (tmp.150) (error? tmp.150)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.114 tmp.115 tmp.116)
             ...
             (vector-set!.161
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.139)
                  ...
                  (error 10))))
             (cons.160
              (lambda ((free ())) (tmp.155 tmp.156) (cons tmp.155 tmp.156)))
             (fun/boolean8789.21 (lambda ((free ())) (oprand0.30) #t))
             (fun/boolean8790.22
              (lambda ((free ())) (oprand0.32 oprand1.31) #t))
             (fun/ascii-char8791.23
              (lambda ((free ())) (oprand0.33) (if #t #\m #\`)))
             (fun/void8788.24 (lambda ((free ())) () (void)))
             (fun/void8786.25 (lambda ((free ())) () (void)))
             (fun/ascii-char8785.26 (lambda ((free ())) () #\k))
             (fun/ascii-char8783.27
              (lambda ((free (fun/ascii-char8784.29)))
                (oprand0.35 oprand1.34)
                (unsafe-procedure-call fun/ascii-char8784.29)))
             (fun/void8787.28
              (lambda ((free (cons.160 vector-set!.161)))
                (oprand0.36)
                (unsafe-procedure-call
                 vector-set!.161
                 oprand0.36
             ...
             (fun/ascii-char8784.29
              (lambda ((free (fun/ascii-char8785.26)))
                ()
                (unsafe-procedure-call fun/ascii-char8785.26))))
      (let ((tmp.7.37
             (unsafe-procedure-call
              fun/ascii-char8783.27
          ...
          (let ((tmp.9.55
            ...
            (if tmp.9.55
              ...
              (let ((tmp.11.66
                     (if (unsafe-procedure-call
                          fun/boolean8789.21
                          (letrec ((lam.164 (lambda ((free ())) () 792)))
                            lam.164))
                       (let ((tmp.12.67 #\[))
                         (if tmp.12.67
                           tmp.12.67
             ...
             (make-vector.94
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.70)
                  ...
                  (error 8))))
             (fun/empty8795.13
              (lambda ((free ())) (oprand0.17 oprand1.16) (let () empty)))
             (fun/boolean8796.14 (lambda ((free ())) (oprand0.18) #t))
             (fun/empty8794.15 (lambda ((free ())) (oprand0.19) empty)))
      (let ((tmp.7.20
        ...
        (if tmp.7.20
          ...
          (let ((tmp.8.24
                 (if (let ((empty0.25 empty)) empty)
                   (if (unsafe-procedure-call
                        fun/empty8794.15
                        (letrec ((lam.98 (lambda ((free ())) () 949))) lam.98))
                     (let () empty)
                     #f)
                   #f)))
            (if tmp.8.24
                                                   ...
                                                   (if (unsafe-procedure-call
                                                     ...
                                                     (let ((g43039365.35
                                                       ...
                                                       (if (unsafe-procedure-call
                                                         ...
                                                         tmp.10.27))))))))))))))))))
                      (if #t
                        (letrec ((lam.99 (lambda ((free ())) () 556))) lam.99)
                        (letrec ((lam.100 (lambda ((free ())) () 797)))
                          lam.100)))))
                (if tmp.9.26
                  tmp.9.26
...
(check-by-interp
 '(module
    (letrec ((fun/void8801.7 (lambda ((free ())) () (void)))
             (fun/void8800.8
              (lambda ((free (fun/void8801.7)))
                ()
                (unsafe-procedure-call fun/void8801.7)))
             (fun/void8799.9
              (lambda ((free (fun/void8800.8)))
                ()
                (unsafe-procedure-call fun/void8800.8))))
    ...
    (letrec ((<.81
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.46)
                  ...
                  (error 4))))
             (error?.80 (lambda ((free ())) (tmp.67) (error? tmp.67)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.31 tmp.32 tmp.33)
                (if (unsafe-fx< tmp.32 (unsafe-vector-length tmp.31))
             ...
             (make-vector.78
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.53)
                  (unsafe-procedure-call make-init-vector.4 tmp.53)
                  (error 8))))
             (fixnum?.77 (lambda ((free ())) (tmp.62) (fixnum? tmp.62)))
             (fun/any8804.8
              (lambda ((free ())) (oprand0.10 oprand1.9) (error 108))))
      (if (unsafe-procedure-call
           fixnum?.77
 ...
 '(module
    (letrec ((cons.61
             ...
             (fun/fixnum8807.7
              (lambda ((free (cons.61)))
                ()
                (let ((pair0.8 (unsafe-procedure-call cons.61 #\j (error 63))))
                  37))))
...
(check-by-interp
 '(module
    (letrec ((error?.70 (lambda ((free ())) (tmp.60) (error? tmp.60))))
    ...
    (letrec ((|+.61|
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.25)
                  ...
                  (error 2))))
             (cons.60
              (lambda ((free ())) (tmp.55 tmp.56) (cons tmp.55 tmp.56))))
      (unsafe-procedure-call
       |+.61|
       (if #t 94 161)
       (let ((pair0.7
...
(check-by-interp
 '(module
    (letrec ((cons.64
              (lambda ((free ())) (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             (fun/ascii-char8826.7 (lambda ((free ())) () #\k))
             ...
             (fun/ascii-char8825.9 (lambda ((free ())) () #\r))
             (fun/boolean8824.10 (lambda ((free ())) (oprand0.11) #f)))
      (unsafe-procedure-call fun/ascii-char8823.8))))
(check-by-interp
 '(module
    (letrec ((fun/boolean8831.7
              (lambda ((free (fun/boolean8832.9)))
                ()
                (unsafe-procedure-call fun/boolean8832.9)))
             (fun/boolean8829.8
              (lambda ((free (fun/boolean8830.10)))
                (oprand0.11)
                (unsafe-procedure-call fun/boolean8830.10)))
             (fun/boolean8832.9 (lambda ((free ())) () #t))
             (fun/boolean8830.10
              (lambda ((free (fun/boolean8831.7)))
                ()
                (unsafe-procedure-call fun/boolean8831.7))))
      (unsafe-procedure-call
       fun/boolean8829.8
             ...
             (vector-set!.81
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.58)
                  ...
                  (error 10))))
             (vector-init-loop.29
              (lambda ((free (vector-init-loop.29)))
                (len.30 i.32 vec.31)
                (if (eq? len.30 i.32)
                  vec.31
                  (begin
             ...
             (make-vector.80
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.55)
                  ...
                  (error 8))))
             (error?.79 (lambda ((free ())) (tmp.69) (error? tmp.69))))
...
(check-by-interp
 '(module
    (letrec ((cons.138
              (lambda ((free ())) (tmp.130 tmp.131) (cons tmp.130 tmp.131)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (vector-set!.137
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.114)
                  ...
                  (error 10))))
             (vector-init-loop.85
              (lambda ((free (vector-init-loop.85)))
                (len.86 i.88 vec.87)
                (if (eq? len.86 i.88)
                  vec.87
                  (begin
             ...
             (make-vector.136
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.111)
                  ...
                  (error 8))))
             (error?.135 (lambda ((free ())) (tmp.125) (error? tmp.125)))
             (fun/ascii-char8840.13
              (lambda ((free ())) (oprand0.19 oprand1.18) #\M))
             (fun/ascii-char8839.14
              (lambda ((free ())) (oprand0.21 oprand1.20) #\q))
             (fun/ascii-char8841.15
              (lambda ((free ())) (oprand0.23 oprand1.22) #\p))
             (fun/boolean8837.16
              (lambda ((free (fun/boolean8838.17)))
                (oprand0.25 oprand1.24)
                (unsafe-procedure-call fun/boolean8838.17)))
             (fun/boolean8838.17 (lambda ((free ())) () #f)))
      (if (unsafe-procedure-call
           fun/boolean8837.16
             ...
             (vector-set!.126
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.101)
                  ...
                  (error 10))))
             (vector-init-loop.72
              (lambda ((free (vector-init-loop.72)))
                (len.73 i.75 vec.74)
                (if (eq? len.73 i.75)
                  vec.74
                  (begin
             ...
             (*.124
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.85)
                  ...
                  (error 1))))
             (error?.123 (lambda ((free ())) (tmp.112) (error? tmp.112)))
             (cons.122
              (lambda ((free ())) (tmp.117 tmp.118) (cons tmp.117 tmp.118)))
             (fun/error8847.16
              (lambda ((free (fun/error8848.22)))
                ()
                (unsafe-procedure-call fun/error8848.22)))
             (fun/error8846.17
              (lambda ((free (fun/error8847.16)))
                (oprand0.27 oprand1.26)
                (unsafe-procedure-call fun/error8847.16)))
             (fun/pair8849.18
              (lambda ((free (cons.122)))
                (oprand0.28)
                (unsafe-procedure-call
                 cons.122
                 200
                 (unsafe-procedure-call cons.122 421 empty))))
             (fun/fixnum8851.19 (lambda ((free ())) (oprand0.29) 236))
             (fun/fixnum8850.20 (lambda ((free ())) (oprand0.30) 31))
             (fun/error8852.21
              (lambda ((free (fun/error8853.23)))
                ()
                (unsafe-procedure-call fun/error8853.23)))
             (fun/error8848.22 (lambda ((free ())) () (error 200)))
             (fun/error8853.23 (lambda ((free ())) () (error 51)))
             (fun/error8854.24
              (lambda ((free ())) () (if #f (error 82) (error 144))))
             (fun/error8855.25 (lambda ((free ())) () (error 63))))
      (let ((tmp.7.31
             (unsafe-procedure-call
              fun/error8846.17
              (let ((g43089053.32
          ...
          (let ((tmp.8.34
                 (let ((tmp.9.35 (if #f (error 28) (error 67))))
                   (if tmp.9.35
                     tmp.9.35
                     (let ((tmp.10.36
                            (unsafe-procedure-call fun/error8852.21)))
                       (if tmp.10.36
                         tmp.10.36
    ...
    (letrec ((|-.114|
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.77)
                  ...
                  (error 3))))
             (vector-init-loop.60
              (lambda ((free (vector-init-loop.60)))
                (len.61 i.63 vec.62)
                (if (eq? len.61 i.63)
                  vec.62
                  (begin
             ...
             (make-vector.113
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.86)
                  ...
                  (error 8))))
             (cons.112
              (lambda ((free ())) (tmp.105 tmp.106) (cons tmp.105 tmp.106)))
             (error?.111 (lambda ((free ())) (tmp.100) (error? tmp.100)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
              ...
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.89)
                  (if (vector? tmp.88)
                    ...
                    (error 10))
                  (error 10))))
             (fun/fixnum8859.11 (lambda ((free ())) () 240))
             (fun/fixnum8863.12 (lambda ((free ())) () 189))
             (fun/fixnum8864.13 (lambda ((free ())) (oprand0.19) (let () 246)))
             (fun/void8861.14
              (lambda ((free (vector-set!.110)))
                (oprand0.21 oprand1.20)
                (unsafe-procedure-call
                 vector-set!.110
                 oprand1.20
                 5
                 (unsafe-procedure-call
                  ...
                  3
                  oprand0.21))))
             (fun/error8865.15 (lambda ((free ())) (oprand0.22) (error 210)))
             (fun/fixnum8858.16 (lambda ((free ())) () (if #f 223 114)))
             (fun/fixnum8860.17
              (lambda ((free ())) (oprand0.24 oprand1.23) (let () 190)))
             (fun/empty8862.18 (lambda ((free ())) (oprand0.25) empty)))
      (let ((g43092885.26
                  ...
                  (unsafe-procedure-call
                   ...
                   (let ((tmp.10.57 (error 62)))
                     (if tmp.10.57
                       ...
                       (unsafe-procedure-call
                        fun/error8865.15
                        (letrec ((lam.116 (lambda ((free ())) () 976)))
                          lam.116))))))))))))))
(check-by-interp
 '(module
    (letrec ((cons.92
              (lambda ((free ())) (tmp.84 tmp.85) (cons tmp.84 tmp.85)))
             (error?.91 (lambda ((free ())) (tmp.79) (error? tmp.79)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (make-vector.89
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.65)
                  ...
                  (error 8))))
             (fun/fixnum8869.14 (lambda ((free ())) () 144))
             (fun/fixnum8868.15
              (lambda ((free (fun/fixnum8869.14)))
...
(check-by-interp
 '(module
    (letrec ((cons.68
              (lambda ((free ())) (tmp.63 tmp.64) (cons tmp.63 tmp.64)))
             (fun/fixnum8875.7
              (lambda ((free (fun/fixnum8876.11)))
                (oprand0.13)
                (unsafe-procedure-call fun/fixnum8876.11)))
             (fun/fixnum8873.8 (lambda ((free ())) () (let () 155)))
             (fun/fixnum8874.9
              (lambda ((free (fun/pair8877.12 fun/fixnum8875.7)))
                ()
                (unsafe-procedure-call
                 fun/fixnum8875.7
                 (unsafe-procedure-call fun/pair8877.12 #\N))))
             (fun/fixnum8872.10
              (lambda ((free (fun/fixnum8873.8)))
                (oprand0.14)
                (unsafe-procedure-call fun/fixnum8873.8)))
             (fun/fixnum8876.11 (lambda ((free ())) () 203))
             (fun/pair8877.12
              (lambda ((free (cons.68)))
                (oprand0.15)
                (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.98 (lambda ((free ())) (tmp.85) (error? tmp.85)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.49 tmp.50 tmp.51)
             ...
             (vector-set!.97
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.74)
                  ...
                  (error 10))))
             (vector-init-loop.45
              (lambda ((free (vector-init-loop.45)))
                (len.46 i.48 vec.47)
                (if (eq? len.46 i.48)
                  vec.47
                  (begin
             ...
             (make-vector.96
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.71)
                  ...
                  (error 8))))
             (cons.95
              (lambda ((free ())) (tmp.90 tmp.91) (cons tmp.90 tmp.91)))
             (fun/empty8882.14
              (lambda ((free (fun/empty8883.16)))
                ()
                (unsafe-procedure-call fun/empty8883.16 (void))))
             (fun/empty8885.15
              (lambda ((free ())) (oprand0.19 oprand1.18) empty))
             (fun/empty8883.16 (lambda ((free ())) (oprand0.20) empty))
             (fun/empty8884.17 (lambda ((free ())) () empty)))
      (if (if #t #t #t)
...
(check-by-interp
 '(module
    (letrec ((fun/ascii-char8895.7 (lambda ((free ())) () #\I))
             (fun/boolean8892.8
              (lambda ((free (fun/boolean8893.9)))
                (oprand0.12 oprand1.11)
                (unsafe-procedure-call fun/boolean8893.9)))
             (fun/boolean8893.9 (lambda ((free ())) () #f))
             (fun/ascii-char8894.10
              (lambda ((free (fun/ascii-char8895.7)))
                ()
                (unsafe-procedure-call fun/ascii-char8895.7))))
      (if (unsafe-procedure-call
           fun/boolean8892.8
...
(check-by-interp
 '(module
    (letrec ((fun/empty8899.7
              (lambda ((free (fun/empty8900.9)))
                (oprand0.12)
                (unsafe-procedure-call fun/empty8900.9)))
             (fun/error8902.8
              (lambda ((free ())) (oprand0.13) (let () (error 138))))
             (fun/empty8900.9
              (lambda ((free (fun/empty8901.11)))
                ()
                (unsafe-procedure-call fun/empty8901.11)))
             (fun/empty8898.10
              (lambda ((free (fun/error8902.8 fun/empty8899.7)))
                ()
                (unsafe-procedure-call
                 fun/empty8899.7
                 (unsafe-procedure-call fun/error8902.8 (if #t #\C #\I)))))
             (fun/empty8901.11 (lambda ((free ())) () empty)))
      (unsafe-procedure-call fun/empty8898.10))))
(check-by-interp
 '(module
    (letrec ((cons.64
              (lambda ((free ())) (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             (fun/empty8905.7 (lambda ((free ())) (oprand0.8) (let () empty))))
      (let ()
        (unsafe-procedure-call
         fun/empty8905.7
         (let ((void0.11 (void))
               (procedure1.10
                (letrec ((lam.65 (lambda ((free ())) () #\W))) lam.65))
               (fixnum2.9 220))
           (unsafe-procedure-call
            cons.64
            141
...
(check-by-interp
 '(module
    (letrec ((error?.71 (lambda ((free ())) (tmp.61) (error? tmp.61)))
             (fun/fixnum8912.7
              (lambda ((free ())) (oprand0.13 oprand1.12) oprand0.13))
             (fun/error8911.8
              (lambda ((free ()))
                (oprand0.15 oprand1.14)
                (if #f (error 227) (error 92))))
             (fun/empty8908.9
              (lambda ((free (fun/empty8910.11 fun/boolean8909.10)))
                (oprand0.16)
                (if (unsafe-procedure-call fun/boolean8909.10)
                  (let () empty)
                  (unsafe-procedure-call fun/empty8910.11))))
             (fun/boolean8909.10 (lambda ((free ())) () #f))
             (fun/empty8910.11 (lambda ((free ())) () empty)))
      (unsafe-procedure-call
       fun/empty8908.9
       (unsafe-procedure-call
        fun/error8911.8
...
(check-by-interp
 '(module
    (letrec ((fun/empty8915.7
              (lambda ((free (fun/ascii-char8917.9 fun/empty8916.8)))
                ()
                (unsafe-procedure-call
                 fun/empty8916.8
                 (unsafe-procedure-call fun/ascii-char8917.9 (if #t #t #f)))))
             (fun/empty8916.8
              (lambda ((free ())) (oprand0.10) (if #t empty empty)))
             (fun/ascii-char8917.9 (lambda ((free ())) (oprand0.11) #\t)))
      (unsafe-procedure-call fun/empty8915.7))))
(check-by-interp
 '(module
    (letrec ((error?.138 (lambda ((free ())) (tmp.125) (error? tmp.125)))
             (vector-init-loop.85
              (lambda ((free (vector-init-loop.85)))
                (len.86 i.88 vec.87)
                (if (eq? len.86 i.88)
             ...
             (cons.135
              (lambda ((free ())) (tmp.130 tmp.131) (cons tmp.130 tmp.131)))
             (fun/void8925.14
              (lambda ((free ())) (oprand0.24 oprand1.23) oprand0.24))
             (fun/fixnum8922.15 (lambda ((free ())) () 32))
             (fun/void8928.16
              (lambda ((free ())) (oprand0.26 oprand1.25) (let () (void))))
             (fun/fixnum8921.17
              (lambda ((free (fun/fixnum8922.15)))
                ()
                (unsafe-procedure-call fun/fixnum8922.15)))
             (fun/fixnum8920.18
              (lambda ((free (fun/fixnum8921.17)))
                (oprand0.28 oprand1.27)
                (unsafe-procedure-call fun/fixnum8921.17)))
             (fun/void8924.19 (lambda ((free ())) () (void)))
             (fun/void8923.20
              (lambda ((free (vector-set!.136 cons.135)))
                (oprand0.29)
                (let ()
                  (unsafe-procedure-call
                   vector-set!.136
             ...
             (fun/void8926.21 (lambda ((free ())) () (void)))
             (fun/void8927.22
              (lambda ((free (make-vector.137 error?.138 vector-set!.136)))
                ()
                (let ((vector0.30
                       (let ((tmp.7.31
                              (unsafe-procedure-call make-vector.137 8)))
                         (let ((g43134900.32
                                (unsafe-procedure-call
                                 vector-set!.136
                                 tmp.7.31
...
(check-by-interp
 '(module
    (letrec ((fun/boolean8934.7 (lambda ((free ())) () #t))
             (fun/fixnum8933.8
              (lambda ((free (fun/boolean8934.7)))
                ()
...
(check-by-interp
 '(module
    (letrec ((error?.87 (lambda ((free ())) (tmp.75) (error? tmp.75)))
             (ascii-char?.86
              (lambda ((free ())) (tmp.74) (ascii-char? tmp.74)))
             (cons.85
              (lambda ((free ())) (tmp.80 tmp.81) (cons tmp.80 tmp.81)))
             (fun/void8949.12
              (lambda ((free ())) (oprand0.16 oprand1.15) (let () (void))))
             (fun/void8950.13 (lambda ((free ())) () (void)))
             (fun/void8951.14 (lambda ((free ())) () (void))))
      (if (unsafe-procedure-call
           ascii-char?.86
           (let ((procedure0.18
                  (letrec ((lam.88
                            (lambda ((free ()))
                              (oprand0.19)
                              (letrec ((lam.89 (lambda ((free ())) () 1019)))
                                lam.89))))
                    lam.88))
                 (pair1.17
                  (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((fun/error8958.7
              (lambda ((free ())) () (if #t (error 216) (error 110))))
             (fun/error8956.8
              (lambda ((free (fun/error8957.9)))
                ()
                (unsafe-procedure-call fun/error8957.9)))
             (fun/error8957.9
              (lambda ((free (fun/error8958.7)))
                ()
                (unsafe-procedure-call fun/error8958.7))))
...
(check-by-interp
 '(module
    (letrec ((cons.63
              (lambda ((free ())) (tmp.58 tmp.59) (cons tmp.58 tmp.59)))
             (fun/error8961.7
              (lambda ((free (fun/error8962.8)))
                ()
                (unsafe-procedure-call fun/error8962.8)))
             (fun/error8962.8 (lambda ((free ())) () (error 73))))
      (let ((pair0.10
             (unsafe-procedure-call
              cons.63
              (unsafe-procedure-call
...
(check-by-interp
 '(module
    (letrec ((error?.93 (lambda ((free ())) (tmp.81) (error? tmp.81)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
             ...
             (fun/ascii-char8966.15
              (lambda ((free ())) (oprand0.18 oprand1.17) #\j))
             (fun/ascii-char8965.16
              (lambda ((free ())) (oprand0.20 oprand1.19) #\g)))
      (if (if #t #t #f)
        (let ((tmp.7.21 (if #t #\r #\`)))
          (if tmp.7.21
            tmp.7.21
...
(check-by-interp
 '(module
    (letrec ((fun/void8969.13 (lambda ((free ())) () (void))))
      (let ((ascii-char0.16 (if #f #\a #\S))
            (procedure1.15
             (letrec ((lam.75
                       (lambda ((free (fun/void8969.13)))
                         ()
                         (let ((tmp.7.17 (void)))
                           (if tmp.7.17
                             tmp.7.17
                             (let ((tmp.8.18
                                    (unsafe-procedure-call fun/void8969.13)))
                               (if tmp.8.18
                                 tmp.8.18
               ...
               lam.75))
            (procedure2.14
             (letrec ((lam.76 (lambda ((free ())) () (let () #f)))) lam.76)))
        (if #t (error 237) (error 2))))))
(check-by-interp
 '(module
    (letrec ((fun/boolean8974.7 (lambda ((free ())) () #t))
             (fun/boolean8973.8
              (lambda ((free (fun/boolean8974.7)))
                (oprand0.10)
                (unsafe-procedure-call fun/boolean8974.7)))
             (fun/boolean8972.9
              (lambda ((free (fun/boolean8973.8)))
                ()
                (unsafe-procedure-call
                 fun/boolean8973.8
                 (if #f
                   (letrec ((lam.63 (lambda ((free ())) () 569))) lam.63)
                   (letrec ((lam.64 (lambda ((free ())) () 967))) lam.64))))))
      (unsafe-procedure-call fun/boolean8972.9))))
(check-by-interp
 '(module
    (letrec ((error?.89 (lambda ((free ())) (tmp.75) (error? tmp.75)))
             (unsafe-vector-set!.5
              (lambda ((free ()))
                (tmp.39 tmp.40 tmp.41)
             ...
             (vector-set!.88
              (lambda ((free (unsafe-vector-set!.5)))
                ...
                (if (fixnum? tmp.64)
                  ...
                  (error 10))))
             (vector-init-loop.35
              (lambda ((free (vector-init-loop.35)))
                (len.36 i.38 vec.37)
                (if (eq? len.36 i.38)
                  vec.37
                  (begin
             ...
             (make-vector.87
              (lambda ((free (make-init-vector.4)))
                ...
                (if (fixnum? tmp.61)
                  ...
                  (error 8))))
             (pair?.86 (lambda ((free ())) (tmp.76) (pair? tmp.76)))
             (cons.85
              (lambda ((free ())) (tmp.80 tmp.81) (cons tmp.80 tmp.81)))
             (fun/boolean8978.9 (lambda ((free ())) (oprand0.15) #t))
             (fun/procedure8982.10
              (lambda ((free ()))
                ()
                (let ()
                  (letrec ((lam.90 (lambda ((free ())) () 845))) lam.90))))
             (fun/void8979.11
              (lambda ((free (fun/void8980.13)))
                (oprand0.17 oprand1.16)
                (unsafe-procedure-call fun/void8980.13)))
             (fun/void8977.12 (lambda ((free ())) () (void)))
             (fun/void8980.13
              (lambda ((free (fun/void8981.14)))
                ()
                (unsafe-procedure-call fun/void8981.14)))
             (fun/void8981.14 (lambda ((free ())) () (void))))
    ...
    (letrec ((>.73
              (lambda ((free ()))
                ...
                (if (fixnum? tmp.44)
                  ...
                  (error 6))))
             (error?.72 (lambda ((free ())) (tmp.61) (error? tmp.61)))
             (cons.71
              (lambda ((free ())) (tmp.66 tmp.67) (cons tmp.66 tmp.67)))
             (fun/fixnum8985.7 (lambda ((free ())) (oprand0.8) 23)))
      (if (unsafe-procedure-call
           >.73
           (unsafe-procedure-call
            fun/fixnum8985.7
        ...
        (let ((pair0.15
          ...
          (void))
        (let ((procedure0.18
               (letrec ((lam.74 (lambda ((free ())) () #\v))) lam.74))
              (fixnum1.17 181)
              (pair2.16
               (unsafe-procedure-call
                cons.71
...
(check-by-interp
 '(module
    (letrec ((cons.64
              (lambda ((free ())) (tmp.59 tmp.60) (cons tmp.59 tmp.60)))
             (fun/void8988.7
              (lambda ((free (fun/void8990.9 cons.64 fun/boolean8989.8)))
                ()
                (if (unsafe-procedure-call
                     fun/boolean8989.8
                     (unsafe-procedure-call
                  ...
                  (if #f (void) (void)))))
             (fun/boolean8989.8 (lambda ((free ())) (oprand0.10) #f))
             (fun/void8990.9 (lambda ((free ())) (oprand0.11) (void))))
      (unsafe-procedure-call fun/void8988.7))))
(check-by-interp
 '(module
    (letrec ((fun/fixnum8993.7
              (lambda ((free (fun/fixnum8994.8)))
                (oprand0.9)
                (unsafe-procedure-call fun/fixnum8994.8)))
             (fun/fixnum8994.8 (lambda ((free ())) () (if #f 82 210))))
      (unsafe-procedure-call
       fun/fixnum8993.7
       (let ()
         (let ((empty0.10 empty))
           (letrec ((lam.63 (lambda ((free ())) () 562))) lam.63)))))))
(check-by-interp
 '(module
    (letrec ((fun/error8998.7
              (lambda ((free (fun/error8999.8)))
                ()
                (unsafe-procedure-call fun/error8999.8)))
             (fun/error8999.8 (lambda ((free ())) () (error 87)))
             (fun/boolean9002.9 (lambda ((free ())) () #t))
             (fun/error8997.10
              (lambda ((free (fun/error8998.7)))
                (oprand0.13)
                (unsafe-procedure-call fun/error8998.7)))
             (fun/boolean9001.11
              (lambda ((free (fun/boolean9002.9)))
                ()
                (unsafe-procedure-call fun/boolean9002.9)))
             (fun/procedure9000.12
              (lambda ((free ()))
                (oprand0.14)
                (if oprand0.14
                  (letrec ((lam.67 (lambda ((free ())) () 608))) lam.67)
                  (letrec ((lam.68 (lambda ((free ())) () 525))) lam.68)))))
      (unsafe-procedure-call
       fun/error8997.10
       (unsafe-procedure-call
        fun/procedure9000.12
