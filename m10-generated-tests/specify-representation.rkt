...
(check-by-interp
 '(module
    ...
    (let ((fun/ascii-char8491.7
           (make-procedure L.fun/ascii-char8491.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (let ((fun/empty8500.7 (make-procedure L.fun/empty8500.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (define L.make-init-vector.4.13
      (lambda (c.87 tmp.29)
        (let ((vector-init-loop.31 (unsafe-procedure-ref c.87 0)))
    ...
    (define L.vector-init-loop.31.12
      (lambda (c.86 len.32 i.34 vec.33)
        (let ((vector-init-loop.31 (unsafe-procedure-ref c.86 0)))
          (if (eq? len.32 i.34)
            vec.33
            (begin
    ...
    (let ((unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.10 3 0))
          (vector-set!.83 (make-procedure L.vector-set!.83.11 3 1))
          (vector-init-loop.31 (make-procedure L.vector-init-loop.31.12 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.13 1 1))
          (make-vector.82 (make-procedure L.make-vector.82.14 1 1))
          (error?.81 (make-procedure L.error?.81.15 1 0))
          (fun/void8514.8 (make-procedure L.fun/void8514.8.16 0 0))
          (fun/void8513.9 (make-procedure L.fun/void8513.9.17 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.83 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.31 0 vector-init-loop.31)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.31)
...
(check-by-interp
 '(module
    ...
    (let ((fun/empty8524.7 (make-procedure L.fun/empty8524.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (let ((error?.72 (make-procedure L.error?.72.10 1 0))
          (fun/error8534.11 (make-procedure L.fun/error8534.11.11 0 0))
          (fun/error8535.12 (make-procedure L.fun/error8535.12.12 0 0)))
            ...
            (if (call L.fun/error8535.12.12 fun/error8535.12)
              (if (if #f (error 148) (error 136))
                (if (let ((procedure0.17
                           (let ((lam.73 (make-procedure L.lam.73.13 0 0)))
                             lam.73)))
                      (error 64))
...
(check-by-interp
 '(module
    ...
    (let ((fun/void8538.7 (make-procedure L.fun/void8538.7.10 0 0)))
      (if (if (void) (void) #f)
...
(check-by-interp
 '(module
    ...
    (define L.fun/fixnum8543.7.10
      (lambda (c.61)
        (let ((fun/fixnum8544.8 (unsafe-procedure-ref c.61 0)))
          (call L.fun/fixnum8544.8.11 fun/fixnum8544.8))))
    (let ((fun/fixnum8543.7 (make-procedure L.fun/fixnum8543.7.10 0 1))
          (fun/fixnum8544.8 (make-procedure L.fun/fixnum8544.8.11 0 0)))
      (begin
        (unsafe-procedure-set! fun/fixnum8543.7 0 fun/fixnum8544.8)
...
(check-by-interp
 '(module
    ...
    (let ((fun/fixnum8551.7 (make-procedure L.fun/fixnum8551.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/error8558.7.10
      (lambda (c.61)
        (let ((fun/error8559.8 (unsafe-procedure-ref c.61 0)))
          (call L.fun/error8559.8.11 fun/error8559.8))))
    (let ((fun/error8558.7 (make-procedure L.fun/error8558.7.10 0 1))
          (fun/error8559.8 (make-procedure L.fun/error8559.8.11 0 0)))
      (begin
        (unsafe-procedure-set! fun/error8558.7 0 fun/error8559.8)
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8564.9.12
      (lambda (c.67)
        (let ((fun/void8565.8 (unsafe-procedure-ref c.67 0)))
          (call L.fun/void8565.8.11 fun/void8565.8))))
    (define L.fun/void8565.8.11 (lambda (c.66) (let () (void))))
    (define L.fun/void8562.7.10
      (lambda (c.65)
        (let ((fun/void8563.10 (unsafe-procedure-ref c.65 0)))
          (call L.fun/void8563.10.13 fun/void8563.10))))
    (let ((fun/void8562.7 (make-procedure L.fun/void8562.7.10 0 1))
          (fun/void8565.8 (make-procedure L.fun/void8565.8.11 0 0))
          (fun/void8564.9 (make-procedure L.fun/void8564.9.12 0 1))
          (fun/void8563.10 (make-procedure L.fun/void8563.10.13 0 0)))
      (begin
        (unsafe-procedure-set! fun/void8562.7 0 fun/void8563.10)
        (unsafe-procedure-set! fun/void8564.9 0 fun/void8565.8)
 ...
 '(module
    ...
    (define L.fun/ascii-char8568.7.10
      (lambda (c.62 oprand0.9)
        (let ((fun/ascii-char8569.8 (unsafe-procedure-ref c.62 0)))
          (call L.fun/ascii-char8569.8.11 fun/ascii-char8569.8))))
    (let ((fun/ascii-char8568.7 (make-procedure L.fun/ascii-char8568.7.10 1 1))
          (fun/ascii-char8569.8
           (make-procedure L.fun/ascii-char8569.8.11 0 0)))
      (begin
        (unsafe-procedure-set! fun/ascii-char8568.7 0 fun/ascii-char8569.8)
        (call
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.75.16
      (lambda (c.86 tmp.51)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.86 0)))
          (if (fixnum? tmp.51)
    ...
    (define L.vector-init-loop.25.14
      (lambda (c.84 len.26 i.28 vec.27)
        (let ((vector-init-loop.25 (unsafe-procedure-ref c.84 0)))
          (if (eq? len.26 i.28)
            vec.27
            (begin
    ...
    (define L.vector-set!.76.13
      (lambda (c.83 tmp.53 tmp.54 tmp.55)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.83 0)))
          (if (fixnum? tmp.54)
            (if (vector? tmp.53)
              (call
    ...
    (let ((cons.78 (make-procedure L.cons.78.10 2 0))
          (error?.77 (make-procedure L.error?.77.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.76 (make-procedure L.vector-set!.76.13 3 1))
          (vector-init-loop.25 (make-procedure L.vector-init-loop.25.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.75 (make-procedure L.make-vector.75.16 1 1)))
      (begin
        (unsafe-procedure-set! vector-set!.76 0 unsafe-vector-set!.5)
        ...
        (unsafe-procedure-set! make-vector.75 0 make-init-vector.4)
        (let ((vector0.9
...
(check-by-interp
 '(module
    ...
    (let ((cons.64 (make-procedure L.cons.64.10 2 0))
          ...
          (fun/boolean8574.7 (make-procedure L.fun/boolean8574.7.14 1 0)))
      (begin
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8578.7.10
      (lambda (c.67)
        (let ((fun/empty8579.8 (unsafe-procedure-ref c.67 0)))
          (call L.fun/empty8579.8.11 fun/empty8579.8))))
    (let ((fun/empty8578.7 (make-procedure L.fun/empty8578.7.10 0 1))
          (fun/empty8579.8 (make-procedure L.fun/empty8579.8.11 0 0))
          (fun/empty8577.9 (make-procedure L.fun/empty8577.9.12 1 0)))
      (begin
        (unsafe-procedure-set! fun/empty8578.7 0 fun/empty8579.8)
          ...
          (if (call
            ...
            (if (let () empty)
              (if (let ((procedure0.13
                         (let ((lam.66 (make-procedure L.lam.66.13 0 0)))
                           lam.66))
                        (fixnum1.12 204))
                    empty)
...
(check-by-interp
 '(module
    ...
    (define L.fun/vector8584.8.18
      (lambda (c.86)
        (let ((vector-set!.74 (unsafe-procedure-ref c.86 0))
              (error?.75 (unsafe-procedure-ref c.86 1))
              (make-vector.73 (unsafe-procedure-ref c.86 2)))
    ...
    (define L.make-vector.73.17
      (lambda (c.85 tmp.49)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.85 0)))
          (if (fixnum? tmp.49)
            (call L.make-init-vector.4.16 make-init-vector.4 tmp.49)
            (error 8)))))
    (define L.make-init-vector.4.16
      (lambda (c.84 tmp.21)
        (let ((vector-init-loop.23 (unsafe-procedure-ref c.84 0)))
    ...
    (define L.vector-init-loop.23.15
      (lambda (c.83 len.24 i.26 vec.25)
        (let ((vector-init-loop.23 (unsafe-procedure-ref c.83 0)))
          (if (eq? len.24 i.26)
            vec.25
            (begin
    ...
    (define L.vector-set!.74.14
      (lambda (c.82 tmp.51 tmp.52 tmp.53)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.82 0)))
          (if (fixnum? tmp.52)
            (if (vector? tmp.51)
              (call
      ...
      (lambda (c.78 tmp.47 tmp.48)
        (let ()
          (if (fixnum? tmp.48)
            ...
            (error 7)))))
    (let ((>=.77 (make-procedure L.>=.77.10 2 0))
          (*.76 (make-procedure L.*.76.11 2 0))
          (error?.75 (make-procedure L.error?.75.12 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.13 3 0))
          (vector-set!.74 (make-procedure L.vector-set!.74.14 3 1))
          (vector-init-loop.23 (make-procedure L.vector-init-loop.23.15 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.16 1 1))
          (make-vector.73 (make-procedure L.make-vector.73.17 1 1))
          (fun/vector8584.8 (make-procedure L.fun/vector8584.8.18 0 3))
          (fun/fixnum8582.9 (make-procedure L.fun/fixnum8582.9.19 0 0))
          (fun/fixnum8583.10 (make-procedure L.fun/fixnum8583.10.20 1 0)))
      (begin
        (unsafe-procedure-set! vector-set!.74 0 unsafe-vector-set!.5)
        ...
        (unsafe-procedure-set! make-vector.73 0 make-init-vector.4)
        (unsafe-procedure-set! fun/vector8584.8 0 vector-set!.74)
        (unsafe-procedure-set! fun/vector8584.8 1 error?.75)
        (unsafe-procedure-set! fun/vector8584.8 2 make-vector.73)
        (call
         L.>=.77.10
         >=.77
         (call
...
(check-by-interp
 '(module
    ...
    (let ((error?.92 (make-procedure L.error?.92.10 1 0))
          (fun/empty8588.19 (make-procedure L.fun/empty8588.19.11 1 0))
          (fun/empty8587.20 (make-procedure L.fun/empty8587.20.12 0 0)))
...
(check-by-interp
 '(module
    ...
    (let ((error?.90 (make-procedure L.error?.90.10 1 0))
          (cons.89 (make-procedure L.cons.89.11 2 0))
          (fun/empty8592.11 (make-procedure L.fun/empty8592.11.12 0 0))
          (fun/empty8594.12 (make-procedure L.fun/empty8594.12.13 1 0))
          (fun/empty8593.13 (make-procedure L.fun/empty8593.13.14 1 0))
          (fun/empty8591.14 (make-procedure L.fun/empty8591.14.15 1 0))
          (fun/empty8595.15 (make-procedure L.fun/empty8595.15.16 0 0)))
      (let ((g42855921.19
             (let ((pair0.21
                    (call
                     L.cons.89.11
...
(check-by-interp
 '(module
    ...
    (let ((error?.64 (make-procedure L.error?.64.10 1 0))
          (fun/fixnum8598.7 (make-procedure L.fun/fixnum8598.7.11 0 0))
          (fun/fixnum8599.8 (make-procedure L.fun/fixnum8599.8.12 0 0)))
...
(check-by-interp
 '(module
    (define L.fun/fixnum8603.9.13
      (lambda (c.67)
        (let ((fun/fixnum8604.8 (unsafe-procedure-ref c.67 0)))
    ...
    (define L.fun/fixnum8602.7.11
      (lambda (c.65 oprand0.10)
        (let ((fun/fixnum8603.9 (unsafe-procedure-ref c.65 0)))
          (call L.fun/fixnum8603.9.13 fun/fixnum8603.9))))
    (define L.cons.63.10
      (lambda (c.64 tmp.58 tmp.59) (let () (cons tmp.58 tmp.59))))
    (let ((cons.63 (make-procedure L.cons.63.10 2 0))
          (fun/fixnum8602.7 (make-procedure L.fun/fixnum8602.7.11 1 1))
          (fun/fixnum8604.8 (make-procedure L.fun/fixnum8604.8.12 0 0))
          (fun/fixnum8603.9 (make-procedure L.fun/fixnum8603.9.13 0 1)))
      (begin
        (unsafe-procedure-set! fun/fixnum8602.7 0 fun/fixnum8603.9)
        (unsafe-procedure-set! fun/fixnum8603.9 0 fun/fixnum8604.8)
        (call
         ...
         (if #t
           (call
            ...
            cons.63
            141
            (call L.cons.63.10 cons.63 350 empty))
           (call
            L.cons.63.10
            cons.63
            232
...
(check-by-interp
 '(module
    ...
    (let ((error?.81 (make-procedure L.error?.81.10 1 0))
          (fun/error8609.14 (make-procedure L.fun/error8609.14.11 0 0))
          (fun/error8608.15 (make-procedure L.fun/error8608.15.12 0 0))
          (fun/error8607.16 (make-procedure L.fun/error8607.16.13 1 0)))
      (let ((tmp.7.18
             (let ((tmp.8.19
...
(check-by-interp
 '(module
    (define L.fun/fixnum8613.9.12
      (lambda (c.64)
        (let ((fun/fixnum8614.8 (unsafe-procedure-ref c.64 0)))
          (call L.fun/fixnum8614.8.11 fun/fixnum8614.8))))
    (define L.fun/fixnum8614.8.11 (lambda (c.63) (let () 46)))
    (define L.fun/fixnum8612.7.10
      (lambda (c.62)
        (let ((fun/fixnum8613.9 (unsafe-procedure-ref c.62 0)))
          (call L.fun/fixnum8613.9.12 fun/fixnum8613.9))))
    (let ((fun/fixnum8612.7 (make-procedure L.fun/fixnum8612.7.10 0 1))
          (fun/fixnum8614.8 (make-procedure L.fun/fixnum8614.8.11 0 0))
          (fun/fixnum8613.9 (make-procedure L.fun/fixnum8613.9.12 0 1)))
      (begin
        (unsafe-procedure-set! fun/fixnum8612.7 0 fun/fixnum8613.9)
        (unsafe-procedure-set! fun/fixnum8613.9 0 fun/fixnum8614.8)
...
(check-by-interp
 '(module
    (define L.lam.109.19
      (lambda (c.119)
        (let ((vector-set!.106 (unsafe-procedure-ref c.119 0))
              (error?.107 (unsafe-procedure-ref c.119 1))
              (make-vector.105 (unsafe-procedure-ref c.119 2)))
    ...
    (define L.lam.108.18
      (lambda (c.118)
        (let ((vector-set!.106 (unsafe-procedure-ref c.118 0))
              (error?.107 (unsafe-procedure-ref c.118 1))
              (make-vector.105 (unsafe-procedure-ref c.118 2)))
    ...
    (define L.vector-init-loop.55.13
      (lambda (c.113 len.56 i.58 vec.57)
        (let ((vector-init-loop.55 (unsafe-procedure-ref c.113 0)))
          (if (eq? len.56 i.58)
            vec.57
            (begin
    ...
    (let ((error?.107 (make-procedure L.error?.107.10 1 0))
          ...
          (vector-set!.106 (make-procedure L.vector-set!.106.12 3 1))
          (vector-init-loop.55 (make-procedure L.vector-init-loop.55.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.105 (make-procedure L.make-vector.105.15 1 1))
          (fun/boolean8626.14 (make-procedure L.fun/boolean8626.14.16 1 0))
          (fun/boolean8625.15 (make-procedure L.fun/boolean8625.15.17 1 0)))
      (begin
        (unsafe-procedure-set! vector-set!.106 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.55 0 vector-init-loop.55)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.55)
        (unsafe-procedure-set! make-vector.105 0 make-init-vector.4)
        (call
                 ...
                 (let ((tmp.9.20
                   ...
                   (if tmp.9.20
                     ...
                     (let ((tmp.11.30
                            (let ((procedure0.32
                                   (let ((lam.108
                                          (make-procedure L.lam.108.18 0 3)))
                                     (begin
                       ...
                       (if tmp.11.30
                         ...
                         (let ((ascii-char0.43 #\B)
                               (procedure1.42
                                (let ((lam.109
                                       (make-procedure L.lam.109.19 0 3)))
                                  (begin
                                    (unsafe-procedure-set!
                                     lam.109
                                     0
...
(check-by-interp
 '(module
    ...
    (let ((cons.62 (make-procedure L.cons.62.10 2 0))
          (fun/empty8631.7 (make-procedure L.fun/empty8631.7.11 1 0)))
      (call
...
(check-by-interp
 '(module
    ...
    (let ((fun/empty8634.7 (make-procedure L.fun/empty8634.7.10 0 0)))
      (call L.fun/empty8634.7.10 fun/empty8634.7))))
(check-by-interp
 '(module
    (define L.lam.77.19
      (lambda (c.87)
        (let ((fun/vector8638.8 (unsafe-procedure-ref c.87 0)))
    ...
    (define L.fun/vector8638.8.16
      (lambda (c.84)
        (let ((vector-set!.75 (unsafe-procedure-ref c.84 0))
              (error?.76 (unsafe-procedure-ref c.84 1))
              (make-vector.74 (unsafe-procedure-ref c.84 2)))
    ...
    (let ((error?.76 (make-procedure L.error?.76.10 1 0))
          ...
          (fun/vector8638.8 (make-procedure L.fun/vector8638.8.16 0 3))
          (fun/void8637.9 (make-procedure L.fun/void8637.9.17 0 0))
          (fun/fixnum8639.10 (make-procedure L.fun/fixnum8639.10.18 0 0)))
      (begin
        ...
        (unsafe-procedure-set! fun/vector8638.8 0 vector-set!.75)
        (unsafe-procedure-set! fun/vector8638.8 1 error?.76)
        (unsafe-procedure-set! fun/vector8638.8 2 make-vector.74)
        (let ((void0.21 (call L.fun/void8637.9.17 fun/void8637.9))
              (procedure1.20
               (let ((lam.77 (make-procedure L.lam.77.19 0 1)))
                 (begin
                   (unsafe-procedure-set! lam.77 0 fun/vector8638.8)
                   lam.77))))
          (call L.fun/fixnum8639.10.18 fun/fixnum8639.10))))))
(check-by-interp
 '(module
    (define L.fun/fixnum8642.7.10 (lambda (c.60) (let () 171)))
    (let ((fun/fixnum8642.7 (make-procedure L.fun/fixnum8642.7.10 0 0)))
      (if (let () #f)
        (if #f 157 104)
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.71.15
      (lambda (c.80 tmp.47)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.80 0)))
          (if (fixnum? tmp.47)
    ...
    (define L.vector-set!.72.12
      (lambda (c.77 tmp.49 tmp.50 tmp.51)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.77 0)))
          (if (fixnum? tmp.50)
            (if (vector? tmp.49)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.73 (make-procedure L.error?.73.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.72 (make-procedure L.vector-set!.72.12 3 1))
          (vector-init-loop.21 (make-procedure L.vector-init-loop.21.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.71 (make-procedure L.make-vector.71.15 1 1)))
      (begin
                   ...
                   (if (call L.error?.73.10 error?.73 g42913205.10)
                     ...
                     (let ((g42913206.11
                            (call
                             ...
                             tmp.7.9
                             1
                             (let ((lam.74 (make-procedure L.lam.74.16 0 0)))
                               lam.74))))
...
(check-by-interp
 '(module
    ...
    (define L.lam.93.18
      (lambda (c.104)
        (let () (let ((lam.94 (make-procedure L.lam.94.19 0 0))) lam.94))))
    ...
    (define L.fun/ascii-char8647.14.16
      (lambda (c.102)
        (let ((make-vector.90 (unsafe-procedure-ref c.102 0))
              (error?.92 (unsafe-procedure-ref c.102 1))
              (vector-set!.91 (unsafe-procedure-ref c.102 2)))
          (let ((vector0.16
    ...
    (define L.make-init-vector.4.14
      (lambda (c.100 tmp.38)
        (let ((vector-init-loop.40 (unsafe-procedure-ref c.100 0)))
    ...
    (let ((error?.92 (make-procedure L.error?.92.10 1 0))
          ...
          (fun/ascii-char8647.14
           (make-procedure L.fun/ascii-char8647.14.16 0 3))
          (fun/ascii-char8648.15
           (make-procedure L.fun/ascii-char8648.15.17 1 0)))
      (begin
        ...
        (unsafe-procedure-set! fun/ascii-char8647.14 0 make-vector.90)
        (unsafe-procedure-set! fun/ascii-char8647.14 1 error?.92)
        (unsafe-procedure-set! fun/ascii-char8647.14 2 vector-set!.91)
        (let ((tmp.8.27
          ...
          (if tmp.8.27
            ...
            (let ((tmp.9.28
                   (let ((procedure0.29
                          (let ((lam.93 (make-procedure L.lam.93.18 0 0)))
                            lam.93)))
                     #\r)))
              (if tmp.9.28
                tmp.9.28
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.81.15
      (lambda (c.89 tmp.57)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.89 0)))
          (if (fixnum? tmp.57)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.57)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.88 tmp.29)
        (let ((vector-init-loop.31 (unsafe-procedure-ref c.88 0)))
          (let ((tmp.30 (unsafe-make-vector tmp.29)))
            (call
    ...
    (define L.vector-set!.82.12
      (lambda (c.86 tmp.59 tmp.60 tmp.61)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.86 0)))
          (if (fixnum? tmp.60)
            (if (vector? tmp.59)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.83 (make-procedure L.error?.83.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.82 (make-procedure L.vector-set!.82.12 3 1))
          (vector-init-loop.31 (make-procedure L.vector-init-loop.31.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.81 (make-procedure L.make-vector.81.15 1 1))
          (fun/void8651.9 (make-procedure L.fun/void8651.9.16 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.82 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.31 0 vector-init-loop.31)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.31)
        (unsafe-procedure-set! make-vector.81 0 make-init-vector.4)
        (let ((vector0.10
...
(check-by-interp
 '(module
    ...
    (let ((fun/void8654.7 (make-procedure L.fun/void8654.7.10 1 0)))
      (call
       L.fun/void8654.7.10
       fun/void8654.7
       (let ((procedure0.9
              (let ((lam.63 (make-procedure L.lam.63.11 1 0))) lam.63)))
...
(check-by-interp
 '(module
    ...
    (let ((fun/ascii-char8657.7
           (make-procedure L.fun/ascii-char8657.7.10 1 0)))
...
(check-by-interp
 '(module
    ...
    (let ((fun/fixnum8661.7 (make-procedure L.fun/fixnum8661.7.10 0 0))
          (fun/empty8660.8 (make-procedure L.fun/empty8660.8.11 0 0)))
...
(check-by-interp
 '(module
    ...
    (let ((cons.66 (make-procedure L.cons.66.10 2 0))
          (error?.65 (make-procedure L.error?.65.11 1 0))
          (fun/fixnum8664.7 (make-procedure L.fun/fixnum8664.7.12 1 0)))
      (if (if #t 75 131)
...
(check-by-interp
 '(module
    ...
    (let ((fun/error8667.7 (make-procedure L.fun/error8667.7.10 1 0)))
...
(check-by-interp
 '(module
    ...
    (let ((error?.66 (make-procedure L.error?.66.10 1 0))
          (fun/empty8670.9 (make-procedure L.fun/empty8670.9.11 0 0))
          (fun/empty8671.10 (make-procedure L.fun/empty8671.10.12 0 0)))
      (let ((g42943766.11
...
(check-by-interp
 '(module
    ...
    (let ((fun/void8674.7 (make-procedure L.fun/void8674.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (let ((error?.78 (make-procedure L.error?.78.10 1 0))
          ...
          (cons.75 (make-procedure L.cons.75.16 2 0))
          (fixnum?.74 (make-procedure L.fixnum?.74.17 1 0))
          (fun/void8678.8 (make-procedure L.fun/void8678.8.18 0 0))
          (fun/any8677.9 (make-procedure L.fun/any8677.9.19 0 0)))
      (begin
                       ...
                       (if (call L.error?.78.10 error?.78 g42951405.15)
                         ...
                         (let ((g42951406.16
                                (call
                                 ...
                                 (let ()
                                   (let ((lam.79
                                          (make-procedure L.lam.79.20 0 0)))
                                     lam.79)))))
...
(check-by-interp
 '(module
    (define L.lam.99.22
      (lambda (c.112)
        (let ((make-vector.95 (unsafe-procedure-ref c.112 0))
              (error?.97 (unsafe-procedure-ref c.112 1))
              (vector-set!.96 (unsafe-procedure-ref c.112 2)))
          (let ()
    ...
    (define L.fun/error8681.18.20
      (lambda (c.110)
        (let ((fun/error8682.16 (unsafe-procedure-ref c.110 0)))
    ...
    (define L.make-vector.95.16
      (lambda (c.106 tmp.70)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.106 0)))
          (if (fixnum? tmp.70)
            (call L.make-init-vector.4.15 make-init-vector.4 tmp.70)
            (error 8)))))
    (define L.make-init-vector.4.15
      (lambda (c.105 tmp.42)
        (let ((vector-init-loop.44 (unsafe-procedure-ref c.105 0)))
    ...
    (define L.vector-init-loop.44.14
      (lambda (c.104 len.45 i.47 vec.46)
        (let ((vector-init-loop.44 (unsafe-procedure-ref c.104 0)))
          (if (eq? len.45 i.47)
            vec.46
            (begin
    ...
    (define L.vector-set!.96.13
      (lambda (c.103 tmp.72 tmp.73 tmp.74)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.103 0)))
          (if (fixnum? tmp.73)
            (if (vector? tmp.72)
              (call
               L.unsafe-vector-set!.5.12
    ...
    (let ((procedure?.98 (make-procedure L.procedure?.98.10 1 0))
          (error?.97 (make-procedure L.error?.97.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.96 (make-procedure L.vector-set!.96.13 3 1))
          (vector-init-loop.44 (make-procedure L.vector-init-loop.44.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.95 (make-procedure L.make-vector.95.16 1 1))
          (cons.94 (make-procedure L.cons.94.17 2 0))
          (fun/error8682.16 (make-procedure L.fun/error8682.16.18 0 0))
          (fun/boolean8683.17 (make-procedure L.fun/boolean8683.17.19 0 0))
          (fun/error8681.18 (make-procedure L.fun/error8681.18.20 0 1))
          (fun/boolean8684.19 (make-procedure L.fun/boolean8684.19.21 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.96 0 unsafe-vector-set!.5)
        ...
        (unsafe-procedure-set! make-vector.95 0 make-init-vector.4)
        (unsafe-procedure-set! fun/error8681.18 0 fun/error8682.16)
        (let ((pair0.22
               (call
                L.cons.94.17
                cons.94
              ...
              (procedure2.20
               (let ((lam.99 (make-procedure L.lam.99.22 0 3)))
                 (begin
                   (unsafe-procedure-set! lam.99 0 make-vector.95)
                   (unsafe-procedure-set! lam.99 1 error?.97)
                   (unsafe-procedure-set! lam.99 2 vector-set!.96)
                   lam.99))))
          (let ((tmp.8.32 (if #f #f #t)))
            (if tmp.8.32
              tmp.8.32
              (let ((tmp.9.33
                     (call L.procedure?.98.10 procedure?.98 (error 58))))
                (if tmp.9.33
                  tmp.9.33
                  (let ((tmp.10.34
 ...
 '(module
    (define L.fun/error8687.16.18
      (lambda (c.102 oprand0.18 oprand1.17)
        (let ((fun/error8688.15 (unsafe-procedure-ref c.102 0)))
    ...
    (define L.make-vector.91.15
      (lambda (c.99 tmp.66)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.99 0)))
          (if (fixnum? tmp.66)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.66)
            (error 8)))))
    (define L.make-init-vector.4.14
    ...
    (define L.vector-init-loop.40.13
      (lambda (c.97 len.41 i.43 vec.42)
        (let ((vector-init-loop.40 (unsafe-procedure-ref c.97 0)))
          (if (eq? len.41 i.43)
            vec.42
            (begin
              (unsafe-vector-set! vec.42 i.43 0)
    ...
    (define L.vector-set!.92.12
      (lambda (c.96 tmp.68 tmp.69 tmp.70)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.96 0)))
          (if (fixnum? tmp.69)
            (if (vector? tmp.68)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.93 (make-procedure L.error?.93.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.92 (make-procedure L.vector-set!.92.12 3 1))
          (vector-init-loop.40 (make-procedure L.vector-init-loop.40.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.91 (make-procedure L.make-vector.91.15 1 1))
          (cons.90 (make-procedure L.cons.90.16 2 0))
          (fun/error8688.15 (make-procedure L.fun/error8688.15.17 0 0))
          (fun/error8687.16 (make-procedure L.fun/error8687.16.18 2 1)))
      (begin
        (unsafe-procedure-set! vector-set!.92 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.40 0 vector-init-loop.40)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.40)
        (unsafe-procedure-set! make-vector.91 0 make-init-vector.4)
        (unsafe-procedure-set! fun/error8687.16 0 fun/error8688.15)
        (let ((tmp.7.19
...
(check-by-interp
 '(module
    ...
    (let ((error?.86 (make-procedure L.error?.86.10 1 0))
          (boolean?.85 (make-procedure L.boolean?.85.11 1 0))
          (cons.84 (make-procedure L.cons.84.12 2 0))
          (fun/void8692.11 (make-procedure L.fun/void8692.11.13 2 0))
          (fun/void8693.12 (make-procedure L.fun/void8693.12.14 2 0))
          (fun/boolean8691.13 (make-procedure L.fun/boolean8691.13.15 0 0))
          (fun/void8694.14 (make-procedure L.fun/void8694.14.16 0 0)))
      (if (let ((tmp.7.19
                 (let ((pair0.21
                        (call
                         L.cons.84.12
        ...
        (if (let ((procedure0.27
                   (let ((lam.87 (make-procedure L.lam.87.17 0 0))) lam.87))
                  (error1.26 (error 99))
                  (empty2.25 empty))
              (void))
          (if (let () (void))
...
(check-by-interp
 '(module
    ...
    (let ((fun/error8697.7 (make-procedure L.fun/error8697.7.10 0 0)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8701.14.11
      (lambda (c.78)
        (let ((fun/void8702.13 (unsafe-procedure-ref c.78 0)))
          (call L.fun/void8702.13.10 fun/void8702.13))))
    (define L.fun/void8702.13.10 (lambda (c.77) (let () (void))))
    (let ((fun/void8702.13 (make-procedure L.fun/void8702.13.10 0 0))
          (fun/void8701.14 (make-procedure L.fun/void8701.14.11 0 1))
          (fun/empty8700.15 (make-procedure L.fun/empty8700.15.12 0 0)))
      (begin
        (unsafe-procedure-set! fun/void8701.14 0 fun/void8702.13)
        (let ((empty0.18
 ...
 '(module
    ...
    (define L.fun/void8711.29.26
      (lambda (c.168 oprand0.36 oprand1.35)
        (let ((vector-set!.147 (unsafe-procedure-ref c.168 0)))
          (call
           L.vector-set!.147.16
           vector-set!.147
           oprand1.35
    ...
    (define L.fun/void8714.21.18
      (lambda (c.160)
        (let ((fun/void8715.28 (unsafe-procedure-ref c.160 0)))
    ...
    (define L.vector-set!.147.16
      (lambda (c.158 tmp.125 tmp.126 tmp.127)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.158 0)))
          (if (fixnum? tmp.126)
            (if (vector? tmp.125)
              (call
    ...
    (define L.make-vector.149.13
      (lambda (c.155 tmp.123)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.155 0)))
          (if (fixnum? tmp.123)
            (call L.make-init-vector.4.12 make-init-vector.4 tmp.123)
            (error 8)))))
    (define L.make-init-vector.4.12
      (lambda (c.154 tmp.95)
        (let ((vector-init-loop.97 (unsafe-procedure-ref c.154 0)))
    ...
    (define L.vector-init-loop.97.11
      (lambda (c.153 len.98 i.100 vec.99)
        (let ((vector-init-loop.97 (unsafe-procedure-ref c.153 0)))
          (if (eq? len.98 i.100)
            vec.99
            (begin
    ...
    (let ((cons.150 (make-procedure L.cons.150.10 2 0))
          (vector-init-loop.97 (make-procedure L.vector-init-loop.97.11 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.12 1 1))
          (make-vector.149 (make-procedure L.make-vector.149.13 1 1))
          (error?.148 (make-procedure L.error?.148.14 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.15 3 0))
          (vector-set!.147 (make-procedure L.vector-set!.147.16 3 1))
          (fun/void8706.20 (make-procedure L.fun/void8706.20.17 2 0))
          (fun/void8714.21 (make-procedure L.fun/void8714.21.18 0 1))
          (fun/void8713.22 (make-procedure L.fun/void8713.22.19 0 0))
          (fun/void8705.23 (make-procedure L.fun/void8705.23.20 0 0))
          (fun/void8708.24 (make-procedure L.fun/void8708.24.21 1 0))
          (fun/void8709.25 (make-procedure L.fun/void8709.25.22 0 0))
          (fun/void8710.26 (make-procedure L.fun/void8710.26.23 1 0))
          (fun/boolean8712.27 (make-procedure L.fun/boolean8712.27.24 0 0))
          (fun/void8715.28 (make-procedure L.fun/void8715.28.25 0 0))
          (fun/void8711.29 (make-procedure L.fun/void8711.29.26 2 1))
          (fun/void8707.30 (make-procedure L.fun/void8707.30.27 1 0)))
      (begin
        (unsafe-procedure-set! vector-init-loop.97 0 vector-init-loop.97)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.97)
        (unsafe-procedure-set! make-vector.149 0 make-init-vector.4)
        (unsafe-procedure-set! vector-set!.147 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! fun/void8714.21 0 fun/void8715.28)
        (unsafe-procedure-set! fun/void8711.29 0 vector-set!.147)
            ...
            (if (if (let ((boolean0.69 #f)) #t)
              ...
              (if (let ()
                    (call
                     ...
                     fun/void8711.29
                     (let ((lam.151 (make-procedure L.lam.151.28 0 0)))
                       lam.151)
                     (let ((tmp.16.70
...
(check-by-interp
 '(module
    (define L.fun/fixnum8721.8.12
      (lambda (c.67)
        (let ((cons.64 (unsafe-procedure-ref c.67 0))
              (fun/boolean8722.7 (unsafe-procedure-ref c.67 1)))
    ...
    (let ((cons.64 (make-procedure L.cons.64.10 2 0))
          (fun/boolean8722.7 (make-procedure L.fun/boolean8722.7.11 0 0))
          (fun/fixnum8721.8 (make-procedure L.fun/fixnum8721.8.12 0 2)))
      (begin
        (unsafe-procedure-set! fun/fixnum8721.8 0 cons.64)
        (unsafe-procedure-set! fun/fixnum8721.8 1 fun/boolean8722.7)
 ...
 '(module
    ...
    (define L.vector-ref.79.11
      (lambda (c.82 tmp.57 tmp.58)
        (let ((unsafe-vector-ref.6 (unsafe-procedure-ref c.82 0)))
          (if (fixnum? tmp.58)
            (if (vector? tmp.57)
        ...
        (let ()
          (if (unsafe-fx< tmp.36 (unsafe-vector-length tmp.35))
            (if (unsafe-fx>= tmp.36 0)
              ...
              (error 11))
            (error 11)))))
    (let ((unsafe-vector-ref.6 (make-procedure L.unsafe-vector-ref.6.10 2 0))
          (vector-ref.79 (make-procedure L.vector-ref.79.11 2 1))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.78 (make-procedure L.vector-set!.78.13 3 1))
          (vector-init-loop.26 (make-procedure L.vector-init-loop.26.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.77 (make-procedure L.make-vector.77.16 1 1))
          (error?.76 (make-procedure L.error?.76.17 1 0))
          (fun/ascii-char8726.8 (make-procedure L.fun/ascii-char8726.8.18 0 0))
          (fun/ascii-char8725.9
           (make-procedure L.fun/ascii-char8725.9.19 0 0)))
      (begin
        (unsafe-procedure-set! vector-ref.79 0 unsafe-vector-ref.6)
...
(check-by-interp
 '(module
    ...
    (define L.fun/pair8730.22.19
      (lambda (c.141)
        (let ((cons.125 (unsafe-procedure-ref c.141 0)))
          (if #t
            (call
             L.cons.125.17
             cons.125
    ...
    (define L.make-vector.127.15
      (lambda (c.137 tmp.101)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.137 0)))
          (if (fixnum? tmp.101)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.101)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.136 tmp.73)
        (let ((vector-init-loop.75 (unsafe-procedure-ref c.136 0)))
    ...
    (define L.vector-init-loop.75.13
      (lambda (c.135 len.76 i.78 vec.77)
        (let ((vector-init-loop.75 (unsafe-procedure-ref c.135 0)))
          (if (eq? len.76 i.78)
            vec.77
            (begin
    ...
    (define L.vector-set!.128.12
      (lambda (c.134 tmp.103 tmp.104 tmp.105)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.134 0)))
          (if (fixnum? tmp.104)
            (if (vector? tmp.103)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((pair?.129 (make-procedure L.pair?.129.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.128 (make-procedure L.vector-set!.128.12 3 1))
          (vector-init-loop.75 (make-procedure L.vector-init-loop.75.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.127 (make-procedure L.make-vector.127.15 1 1))
          (error?.126 (make-procedure L.error?.126.16 1 0))
          (cons.125 (make-procedure L.cons.125.17 2 0))
          (fun/empty8731.21 (make-procedure L.fun/empty8731.21.18 0 0))
          (fun/pair8730.22 (make-procedure L.fun/pair8730.22.19 0 1))
          (fun/empty8729.23 (make-procedure L.fun/empty8729.23.20 2 0)))
      (begin
        (unsafe-procedure-set! vector-set!.128 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.75 0 vector-init-loop.75)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.75)
        (unsafe-procedure-set! make-vector.127 0 make-init-vector.4)
        (unsafe-procedure-set! fun/pair8730.22 0 cons.125)
        (let ((tmp.7.26
               (let ()
              ...
              (if tmp.8.28
                ...
                (let ((tmp.9.29
                       (let ((vector0.32
                             ...
                             (procedure1.31
                              (let ((lam.131
                                     (make-procedure L.lam.131.22 0 0)))
                                lam.131))
                             (empty2.30 (let () empty)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/boolean8734.10.13
      (lambda (c.70)
        (let ((fun/boolean8735.8 (unsafe-procedure-ref c.70 0)))
    ...
    (define L.fun/error8736.7.10
      (lambda (c.67)
        (let ((fun/error8737.9 (unsafe-procedure-ref c.67 0)))
          (call L.fun/error8737.9.12 fun/error8737.9))))
    (let ((fun/error8736.7 (make-procedure L.fun/error8736.7.10 0 1))
          (fun/boolean8735.8 (make-procedure L.fun/boolean8735.8.11 0 0))
          (fun/error8737.9 (make-procedure L.fun/error8737.9.12 0 0))
          (fun/boolean8734.10 (make-procedure L.fun/boolean8734.10.13 0 1)))
      (begin
        (unsafe-procedure-set! fun/error8736.7 0 fun/error8737.9)
        (unsafe-procedure-set! fun/boolean8734.10 0 fun/boolean8735.8)
        (let ((procedure0.13
               (let ((lam.66 (make-procedure L.lam.66.14 0 0))) lam.66))
...
(check-by-interp
 '(module
    ...
    (let ((error?.82 (make-procedure L.error?.82.10 1 0))
          (fun/void8741.11 (make-procedure L.fun/void8741.11.11 0 0))
          (fun/void8740.12 (make-procedure L.fun/void8740.12.12 2 0)))
      (let ()
        (let ((g42993474.15
               (call L.fun/void8740.12.12 fun/void8740.12 191 72)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8746.11.20
      (lambda (c.91)
        (let ((fun/empty8747.12 (unsafe-procedure-ref c.91 0)))
          (call L.fun/empty8747.12.21 fun/empty8747.12))))
    (define L.fun/vector8748.10.19
      (lambda (c.90)
        (let ((vector-set!.78 (unsafe-procedure-ref c.90 0))
              (error?.79 (unsafe-procedure-ref c.90 1))
              (make-vector.77 (unsafe-procedure-ref c.90 2)))
    ...
    (define L.fun/empty8744.9.18
      (lambda (c.89 oprand0.13)
        (let ((fun/empty8745.8 (unsafe-procedure-ref c.89 0)))
          (call L.fun/empty8745.8.17 fun/empty8745.8))))
    (define L.fun/empty8745.8.17
      (lambda (c.88)
        (let ((fun/empty8746.11 (unsafe-procedure-ref c.88 0)))
    ...
    (define L.make-init-vector.4.15
      (lambda (c.86 tmp.25)
        (let ((vector-init-loop.27 (unsafe-procedure-ref c.86 0)))
    ...
    (define L.vector-init-loop.27.14
      (lambda (c.85 len.28 i.30 vec.29)
        (let ((vector-init-loop.27 (unsafe-procedure-ref c.85 0)))
          (if (eq? len.28 i.30)
            vec.29
            (begin
    ...
    (let ((|+.80| (make-procedure L.+.80.10 2 0))
          (error?.79 (make-procedure L.error?.79.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.78 (make-procedure L.vector-set!.78.13 3 1))
          (vector-init-loop.27 (make-procedure L.vector-init-loop.27.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.77 (make-procedure L.make-vector.77.16 1 1))
          (fun/empty8745.8 (make-procedure L.fun/empty8745.8.17 0 1))
          (fun/empty8744.9 (make-procedure L.fun/empty8744.9.18 1 1))
          (fun/vector8748.10 (make-procedure L.fun/vector8748.10.19 0 3))
          (fun/empty8746.11 (make-procedure L.fun/empty8746.11.20 0 1))
          (fun/empty8747.12 (make-procedure L.fun/empty8747.12.21 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.78 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.27 0 vector-init-loop.27)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.27)
        (unsafe-procedure-set! make-vector.77 0 make-init-vector.4)
        (unsafe-procedure-set! fun/empty8745.8 0 fun/empty8746.11)
        (unsafe-procedure-set! fun/empty8744.9 0 fun/empty8745.8)
        (unsafe-procedure-set! fun/vector8748.10 0 vector-set!.78)
        (unsafe-procedure-set! fun/vector8748.10 1 error?.79)
        (unsafe-procedure-set! fun/vector8748.10 2 make-vector.77)
        (unsafe-procedure-set! fun/empty8746.11 0 fun/empty8747.12)
        (call
...
(check-by-interp
 '(module
    ...
    (let ((error?.80 (make-procedure L.error?.80.10 1 0))
          (ascii-char?.79 (make-procedure L.ascii-char?.79.11 1 0))
          (fun/boolean8753.10 (make-procedure L.fun/boolean8753.10.12 1 0)))
      (if (let ((ascii-char0.14 #\q) (void1.13 (void)) (boolean2.12 #t)) #t)
        ...
        (let ((tmp.7.18
               (call
                L.ascii-char?.79.11
                ascii-char?.79
                (let ((lam.81 (make-procedure L.lam.81.13 0 0))) lam.81))))
          (if tmp.7.18
            tmp.7.18
 ...
 '(module
    (define L.fun/boolean8756.9.18
      (lambda (c.88 oprand0.11 oprand1.10)
        (let ((fun/boolean8757.8 (unsafe-procedure-ref c.88 0)))
      ...
      (lambda (c.80 tmp.50 tmp.51)
        (let ()
          (if (fixnum? tmp.51)
            ...
            (error 7)))))
    (let ((>=.79 (make-procedure L.>=.79.10 2 0))
          (error?.78 (make-procedure L.error?.78.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.77 (make-procedure L.vector-set!.77.13 3 1))
          (vector-init-loop.26 (make-procedure L.vector-init-loop.26.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.76 (make-procedure L.make-vector.76.16 1 1))
          (fun/boolean8757.8 (make-procedure L.fun/boolean8757.8.17 0 0))
          (fun/boolean8756.9 (make-procedure L.fun/boolean8756.9.18 2 1)))
      (begin
        (unsafe-procedure-set! vector-set!.77 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.26 0 vector-init-loop.26)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.26)
        (unsafe-procedure-set! make-vector.76 0 make-init-vector.4)
        (unsafe-procedure-set! fun/boolean8756.9 0 fun/boolean8757.8)
        (if (call
...
(check-by-interp
 '(module
    ...
    (let ((cons.69 (make-procedure L.cons.69.10 2 0))
          (fun/empty8761.9 (make-procedure L.fun/empty8761.9.11 0 0))
          (fun/empty8760.10 (make-procedure L.fun/empty8760.10.12 0 0)))
      (let ((empty0.12
...
(check-by-interp
 '(module
    ...
    (define L.fun/fixnum8765.10.17
      (lambda (c.92)
        (let ((fun/fixnum8766.9 (unsafe-procedure-ref c.92 0)))
    ...
    (define L.make-vector.80.15
      (lambda (c.90 tmp.56)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.90 0)))
          (if (fixnum? tmp.56)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.56)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.89 tmp.28)
        (let ((vector-init-loop.30 (unsafe-procedure-ref c.89 0)))
    ...
    (define L.vector-init-loop.30.13
      (lambda (c.88 len.31 i.33 vec.32)
        (let ((vector-init-loop.30 (unsafe-procedure-ref c.88 0)))
          (if (eq? len.31 i.33)
            vec.32
            (begin
    ...
    (define L.vector-set!.81.12
      (lambda (c.87 tmp.58 tmp.59 tmp.60)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.87 0)))
          (if (fixnum? tmp.59)
            (if (vector? tmp.58)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.82 (make-procedure L.error?.82.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.81 (make-procedure L.vector-set!.81.12 3 1))
          (vector-init-loop.30 (make-procedure L.vector-init-loop.30.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.80 (make-procedure L.make-vector.80.15 1 1))
          (fun/fixnum8766.9 (make-procedure L.fun/fixnum8766.9.16 1 0))
          (fun/fixnum8765.10 (make-procedure L.fun/fixnum8765.10.17 0 1))
          (fun/boolean8764.11 (make-procedure L.fun/boolean8764.11.18 2 0)))
      (begin
        (unsafe-procedure-set! vector-set!.81 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.30 0 vector-init-loop.30)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.30)
        (unsafe-procedure-set! make-vector.80 0 make-init-vector.4)
        (unsafe-procedure-set! fun/fixnum8765.10 0 fun/fixnum8766.9)
        (if (call
             L.fun/boolean8764.11.18
             fun/boolean8764.11
             (let ((tmp.7.15
                    (let ((lam.83 (make-procedure L.lam.83.19 0 0))) lam.83)))
               (if tmp.7.15
                 tmp.7.15
                 (let ((lam.84 (make-procedure L.lam.84.20 0 0))) lam.84)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/fixnum8771.8.14
      (lambda (c.77)
        (let ((fun/fixnum8772.11 (unsafe-procedure-ref c.77 0)))
          (call L.fun/fixnum8772.11.17 fun/fixnum8772.11 #f))))
    (define L.fun/fixnum8773.7.13
      (lambda (c.76 oprand0.12)
        (let ((fun/fixnum8774.10 (unsafe-procedure-ref c.76 0)))
      ...
      (lambda (c.73 tmp.34 tmp.35)
        (let ()
          (if (fixnum? tmp.35)
            ...
            (error 2)))))
    (let ((|+.72| (make-procedure L.+.72.10 2 0))
          (cons.71 (make-procedure L.cons.71.11 2 0))
          (*.70 (make-procedure L.*.70.12 2 0))
          (fun/fixnum8773.7 (make-procedure L.fun/fixnum8773.7.13 1 1))
          (fun/fixnum8771.8 (make-procedure L.fun/fixnum8771.8.14 0 1))
          (fun/fixnum8775.9 (make-procedure L.fun/fixnum8775.9.15 1 0))
          (fun/fixnum8774.10 (make-procedure L.fun/fixnum8774.10.16 0 0))
          (fun/fixnum8772.11 (make-procedure L.fun/fixnum8772.11.17 1 0)))
      (begin
        (unsafe-procedure-set! fun/fixnum8773.7 0 fun/fixnum8774.10)
        (unsafe-procedure-set! fun/fixnum8771.8 0 fun/fixnum8772.11)
        (call
         L.+.72.10
         |+.72|
         (if (let () 213)
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.75.14
      (lambda (c.81 tmp.49)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.81 0)))
          (if (fixnum? tmp.49)
            (call L.make-init-vector.4.13 make-init-vector.4 tmp.49)
            (error 8)))))
    (define L.make-init-vector.4.13
      (lambda (c.80 tmp.21)
        (let ((vector-init-loop.23 (unsafe-procedure-ref c.80 0)))
          (let ((tmp.22 (unsafe-make-vector tmp.21)))
            (call
    ...
    (define L.vector-init-loop.23.12
      (lambda (c.79 len.24 i.26 vec.25)
        (let ((vector-init-loop.23 (unsafe-procedure-ref c.79 0)))
          (if (eq? len.24 i.26)
            vec.25
            (begin
              (unsafe-vector-set! vec.25 i.26 0)
    ...
    (define L.vector-set!.76.11
      (lambda (c.78 tmp.51 tmp.52 tmp.53)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.78 0)))
          (if (fixnum? tmp.52)
            (if (vector? tmp.51)
              (call
               L.unsafe-vector-set!.5.10
      ...
      (lambda (c.77 tmp.27 tmp.28 tmp.29)
        (let ()
          (if (unsafe-fx< tmp.28 (unsafe-vector-length tmp.27))
            ...
            (error 10)))))
    (let ((unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.10 3 0))
          (vector-set!.76 (make-procedure L.vector-set!.76.11 3 1))
          (vector-init-loop.23 (make-procedure L.vector-init-loop.23.12 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.13 1 1))
          (make-vector.75 (make-procedure L.make-vector.75.14 1 1))
          (cons.74 (make-procedure L.cons.74.15 2 0))
          (error?.73 (make-procedure L.error?.73.16 1 0))
          (fun/empty8780.8 (make-procedure L.fun/empty8780.8.17 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.76 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.23 0 vector-init-loop.23)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.23)
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char8784.29.25
      (lambda (c.180)
        (let ((fun/ascii-char8785.26 (unsafe-procedure-ref c.180 0)))
          (call L.fun/ascii-char8785.26.22 fun/ascii-char8785.26))))
    (define L.fun/void8787.28.24
      (lambda (c.179 oprand0.36)
        (let ((cons.160 (unsafe-procedure-ref c.179 0))
              (vector-set!.161 (unsafe-procedure-ref c.179 1)))
          (call
           L.vector-set!.161.15
           vector-set!.161
           oprand0.36
    ...
    (define L.fun/ascii-char8783.27.23
      (lambda (c.178 oprand0.35 oprand1.34)
        (let ((fun/ascii-char8784.29 (unsafe-procedure-ref c.178 0)))
    ...
    (define L.vector-set!.161.15
      (lambda (c.170 tmp.138 tmp.139 tmp.140)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.170 0)))
          (if (fixnum? tmp.139)
            (if (vector? tmp.138)
              (call
    ...
    (define L.vector-init-loop.110.10
      (lambda (c.165 len.111 i.113 vec.112)
        (let ((vector-init-loop.110 (unsafe-procedure-ref c.165 0)))
          (if (eq? len.111 i.113)
            vec.112
            (begin
              ...
              (call
               ...
               (unsafe-fx+ i.113 1)
               vec.112))))))
    (let ((vector-init-loop.110 (make-procedure L.vector-init-loop.110.10 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.11 1 1))
          (make-vector.163 (make-procedure L.make-vector.163.12 1 1))
          (error?.162 (make-procedure L.error?.162.13 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.14 3 0))
          (vector-set!.161 (make-procedure L.vector-set!.161.15 3 1))
          (cons.160 (make-procedure L.cons.160.16 2 0))
          (fun/boolean8789.21 (make-procedure L.fun/boolean8789.21.17 1 0))
          (fun/boolean8790.22 (make-procedure L.fun/boolean8790.22.18 2 0))
          (fun/ascii-char8791.23
           (make-procedure L.fun/ascii-char8791.23.19 1 0))
          (fun/void8788.24 (make-procedure L.fun/void8788.24.20 0 0))
          (fun/void8786.25 (make-procedure L.fun/void8786.25.21 0 0))
          (fun/ascii-char8785.26
           (make-procedure L.fun/ascii-char8785.26.22 0 0))
          (fun/ascii-char8783.27
           (make-procedure L.fun/ascii-char8783.27.23 2 1))
          (fun/void8787.28 (make-procedure L.fun/void8787.28.24 1 2))
          (fun/ascii-char8784.29
           (make-procedure L.fun/ascii-char8784.29.25 0 1)))
      (begin
        (unsafe-procedure-set! vector-init-loop.110 0 vector-init-loop.110)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.110)
        (unsafe-procedure-set! make-vector.163 0 make-init-vector.4)
        (unsafe-procedure-set! vector-set!.161 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! fun/ascii-char8783.27 0 fun/ascii-char8784.29)
        (unsafe-procedure-set! fun/void8787.28 0 cons.160)
        (unsafe-procedure-set! fun/void8787.28 1 vector-set!.161)
        (unsafe-procedure-set! fun/ascii-char8784.29 0 fun/ascii-char8785.26)
        (let ((tmp.7.37
               (call
              ...
              (if tmp.9.55
                ...
                (let ((tmp.11.66
                       (if (call
                            ...
                            fun/boolean8789.21
                            (let ((lam.164 (make-procedure L.lam.164.26 0 0)))
                              lam.164))
                         (let ((tmp.12.67 #\[))
                           (if tmp.12.67
                             tmp.12.67
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.94.16
      (lambda (c.107 tmp.70)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.107 0)))
          (if (fixnum? tmp.70)
            (call L.make-init-vector.4.15 make-init-vector.4 tmp.70)
            (error 8)))))
    (define L.make-init-vector.4.15
      (lambda (c.106 tmp.42)
        (let ((vector-init-loop.44 (unsafe-procedure-ref c.106 0)))
          (let ((tmp.43 (unsafe-make-vector tmp.42)))
            (call
             L.vector-init-loop.44.14
             vector-init-loop.44
    ...
    (define L.vector-set!.95.13
      (lambda (c.104 tmp.72 tmp.73 tmp.74)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.104 0)))
          (if (fixnum? tmp.73)
            (if (vector? tmp.72)
              (call
               L.unsafe-vector-set!.5.12
    ...
    (let ((cons.97 (make-procedure L.cons.97.10 2 0))
          (error?.96 (make-procedure L.error?.96.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.95 (make-procedure L.vector-set!.95.13 3 1))
          (vector-init-loop.44 (make-procedure L.vector-init-loop.44.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.94 (make-procedure L.make-vector.94.16 1 1))
          (fun/empty8795.13 (make-procedure L.fun/empty8795.13.17 2 0))
          (fun/boolean8796.14 (make-procedure L.fun/boolean8796.14.18 1 0))
          (fun/empty8794.15 (make-procedure L.fun/empty8794.15.19 1 0)))
      (begin
            ...
            (let ((tmp.8.24
                   (if (let ((empty0.25 empty)) empty)
                     (if (call
                          ...
                          fun/empty8794.15
                          (let ((lam.98 (make-procedure L.lam.98.20 0 0)))
                            lam.98))
                       (let () empty)
                       #f)
                     #f)))
                                                     ...
                                                     (if (call
                                                       ...
                                                       (let ((g43039365.35
                                                         ...
                                                         (if (call
                                                           ...
                                                           tmp.10.27))))))))))))))))))
                        (if #t
                          (let ((lam.99 (make-procedure L.lam.99.21 0 0)))
                            lam.99)
                          (let ((lam.100 (make-procedure L.lam.100.22 0 0)))
                            lam.100)))))
                  (if tmp.9.26
                    tmp.9.26
...
(check-by-interp
 '(module
    (define L.fun/void8799.9.12
      (lambda (c.64)
        (let ((fun/void8800.8 (unsafe-procedure-ref c.64 0)))
          (call L.fun/void8800.8.11 fun/void8800.8))))
    (define L.fun/void8800.8.11
      (lambda (c.63)
        (let ((fun/void8801.7 (unsafe-procedure-ref c.63 0)))
          (call L.fun/void8801.7.10 fun/void8801.7))))
    (define L.fun/void8801.7.10 (lambda (c.62) (let () (void))))
    (let ((fun/void8801.7 (make-procedure L.fun/void8801.7.10 0 0))
          (fun/void8800.8 (make-procedure L.fun/void8800.8.11 0 1))
          (fun/void8799.9 (make-procedure L.fun/void8799.9.12 0 1)))
      (begin
        (unsafe-procedure-set! fun/void8800.8 0 fun/void8801.7)
        (unsafe-procedure-set! fun/void8799.9 0 fun/void8800.8)
...
(check-by-interp
 '(module
    ...
    (define L.make-init-vector.4.15
      (lambda (c.87 tmp.25)
        (let ((vector-init-loop.27 (unsafe-procedure-ref c.87 0)))
          (let ((tmp.26 (unsafe-make-vector tmp.25)))
            (call
             L.vector-init-loop.27.14
             vector-init-loop.27
      ...
      (lambda (c.82 tmp.45 tmp.46)
        (let ()
          (if (fixnum? tmp.46)
            ...
            (error 4)))))
    (let ((<.81 (make-procedure L.<.81.10 2 0))
          (error?.80 (make-procedure L.error?.80.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.79 (make-procedure L.vector-set!.79.13 3 1))
          (vector-init-loop.27 (make-procedure L.vector-init-loop.27.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.78 (make-procedure L.make-vector.78.16 1 1))
          (fixnum?.77 (make-procedure L.fixnum?.77.17 1 0))
          (fun/any8804.8 (make-procedure L.fun/any8804.8.18 2 0)))
      (begin
        (unsafe-procedure-set! vector-set!.79 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.27 0 vector-init-loop.27)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.27)
        (unsafe-procedure-set! make-vector.78 0 make-init-vector.4)
        (if (call
             L.fixnum?.77.17
             fixnum?.77
...
(check-by-interp
 '(module
    (define L.fun/fixnum8807.7.11
      (lambda (c.63)
        (let ((cons.61 (unsafe-procedure-ref c.63 0)))
          (let ((pair0.8 (call L.cons.61.10 cons.61 #\j (error 63)))) 37))))
    (define L.cons.61.10
      (lambda (c.62 tmp.56 tmp.57) (let () (cons tmp.56 tmp.57))))
    (let ((cons.61 (make-procedure L.cons.61.10 2 0))
          (fun/fixnum8807.7 (make-procedure L.fun/fixnum8807.7.11 0 1)))
      (begin
        (unsafe-procedure-set! fun/fixnum8807.7 0 cons.61)
...
(check-by-interp
 '(module
    ...
    (let ((error?.70 (make-procedure L.error?.70.10 1 0)))
      ...
      (lambda (c.62 tmp.24 tmp.25)
        (let ()
          (if (fixnum? tmp.25)
            ...
            (error 2)))))
    (let ((|+.61| (make-procedure L.+.61.10 2 0))
          (cons.60 (make-procedure L.cons.60.11 2 0)))
      (call
       L.+.61.10
       |+.61|
       (if #t 94 161)
...
(check-by-interp
 '(module
    ...
    (define L.fun/ascii-char8823.8.12
      (lambda (c.67)
        (let ((fun/ascii-char8826.7 (unsafe-procedure-ref c.67 0))
              (fun/ascii-char8825.9 (unsafe-procedure-ref c.67 1))
              (cons.64 (unsafe-procedure-ref c.67 2))
              (fun/boolean8824.10 (unsafe-procedure-ref c.67 3)))
          (if (call
    ...
    (define L.cons.64.10
      (lambda (c.65 tmp.59 tmp.60) (let () (cons tmp.59 tmp.60))))
    (let ((cons.64 (make-procedure L.cons.64.10 2 0))
          (fun/ascii-char8826.7 (make-procedure L.fun/ascii-char8826.7.11 0 0))
          (fun/ascii-char8823.8 (make-procedure L.fun/ascii-char8823.8.12 0 4))
          (fun/ascii-char8825.9 (make-procedure L.fun/ascii-char8825.9.13 0 0))
          (fun/boolean8824.10 (make-procedure L.fun/boolean8824.10.14 1 0)))
      (begin
        (unsafe-procedure-set! fun/ascii-char8823.8 0 fun/ascii-char8826.7)
        (unsafe-procedure-set! fun/ascii-char8823.8 1 fun/ascii-char8825.9)
        (unsafe-procedure-set! fun/ascii-char8823.8 2 cons.64)
        (unsafe-procedure-set! fun/ascii-char8823.8 3 fun/boolean8824.10)
        (call L.fun/ascii-char8823.8.12 fun/ascii-char8823.8)))))
(check-by-interp
 '(module
    (define L.fun/boolean8830.10.13
      (lambda (c.69)
        (let ((fun/boolean8831.7 (unsafe-procedure-ref c.69 0)))
    ...
    (define L.fun/boolean8829.8.11
      (lambda (c.67 oprand0.11)
        (let ((fun/boolean8830.10 (unsafe-procedure-ref c.67 0)))
          (call L.fun/boolean8830.10.13 fun/boolean8830.10))))
    (define L.fun/boolean8831.7.10
      (lambda (c.66)
        (let ((fun/boolean8832.9 (unsafe-procedure-ref c.66 0)))
          (call L.fun/boolean8832.9.12 fun/boolean8832.9))))
    (let ((fun/boolean8831.7 (make-procedure L.fun/boolean8831.7.10 0 1))
          (fun/boolean8829.8 (make-procedure L.fun/boolean8829.8.11 1 1))
          (fun/boolean8832.9 (make-procedure L.fun/boolean8832.9.12 0 0))
          (fun/boolean8830.10 (make-procedure L.fun/boolean8830.10.13 0 1)))
      (begin
        (unsafe-procedure-set! fun/boolean8831.7 0 fun/boolean8832.9)
        (unsafe-procedure-set! fun/boolean8829.8 0 fun/boolean8830.10)
        (unsafe-procedure-set! fun/boolean8830.10 0 fun/boolean8831.7)
        (call
...
(check-by-interp
 '(module
    ...
    (define L.make-init-vector.4.13
      (lambda (c.85 tmp.27)
        (let ((vector-init-loop.29 (unsafe-procedure-ref c.85 0)))
    ...
    (define L.vector-init-loop.29.12
      (lambda (c.84 len.30 i.32 vec.31)
        (let ((vector-init-loop.29 (unsafe-procedure-ref c.84 0)))
          (if (eq? len.30 i.32)
            vec.31
            (begin
      ...
      (lambda (c.82 tmp.33 tmp.34 tmp.35)
        (let ()
          (if (unsafe-fx< tmp.34 (unsafe-vector-length tmp.33))
            ...
            (error 10)))))
    (let ((unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.10 3 0))
          (vector-set!.81 (make-procedure L.vector-set!.81.11 3 1))
          (vector-init-loop.29 (make-procedure L.vector-init-loop.29.12 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.13 1 1))
          (make-vector.80 (make-procedure L.make-vector.80.14 1 1))
          (error?.79 (make-procedure L.error?.79.15 1 0)))
      (begin
        (unsafe-procedure-set! vector-set!.81 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.29 0 vector-init-loop.29)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.29)
        (unsafe-procedure-set! make-vector.80 0 make-init-vector.4)
 ...
 '(module
    ...
    (define L.fun/boolean8837.16.20
      (lambda (c.150 oprand0.25 oprand1.24)
        (let ((fun/boolean8838.17 (unsafe-procedure-ref c.150 0)))
    ...
    (define L.make-vector.136.15
      (lambda (c.145 tmp.111)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.145 0)))
          (if (fixnum? tmp.111)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.111)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.144 tmp.83)
        (let ((vector-init-loop.85 (unsafe-procedure-ref c.144 0)))
    ...
    (define L.vector-init-loop.85.13
      (lambda (c.143 len.86 i.88 vec.87)
        (let ((vector-init-loop.85 (unsafe-procedure-ref c.143 0)))
          (if (eq? len.86 i.88)
            vec.87
            (begin
    ...
    (define L.vector-set!.137.12
      (lambda (c.142 tmp.113 tmp.114 tmp.115)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.142 0)))
          (if (fixnum? tmp.114)
            (if (vector? tmp.113)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((cons.138 (make-procedure L.cons.138.10 2 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.137 (make-procedure L.vector-set!.137.12 3 1))
          (vector-init-loop.85 (make-procedure L.vector-init-loop.85.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.136 (make-procedure L.make-vector.136.15 1 1))
          (error?.135 (make-procedure L.error?.135.16 1 0))
          (fun/ascii-char8840.13
           (make-procedure L.fun/ascii-char8840.13.17 2 0))
          (fun/ascii-char8839.14
           (make-procedure L.fun/ascii-char8839.14.18 2 0))
          (fun/ascii-char8841.15
           (make-procedure L.fun/ascii-char8841.15.19 2 0))
          (fun/boolean8837.16 (make-procedure L.fun/boolean8837.16.20 2 1))
          (fun/boolean8838.17 (make-procedure L.fun/boolean8838.17.21 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.137 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.85 0 vector-init-loop.85)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.85)
        (unsafe-procedure-set! make-vector.136 0 make-init-vector.4)
        (unsafe-procedure-set! fun/boolean8837.16 0 fun/boolean8838.17)
        (if (call
                  ...
                  (let ((g43081411.66
                    ...
                    (if (call L.error?.135.16 error?.135 g43081411.66)
                      ...
                      (let ((g43081415.70
                             (let ((procedure0.73
                                    (let ((lam.139
                                           (make-procedure L.lam.139.22 0 0)))
                                      lam.139))
                                   (empty1.72 empty)
                                   (error2.71 (error 52)))
                               #\T)))
...
(check-by-interp
 '(module
    ...
    (define L.fun/error8852.21.23
      (lambda (c.143)
        (let ((fun/error8853.23 (unsafe-procedure-ref c.143 0)))
    ...
    (define L.fun/pair8849.18.20
      (lambda (c.140 oprand0.28)
        (let ((cons.122 (unsafe-procedure-ref c.140 0)))
          (call
           L.cons.122.17
           cons.122
           200
    ...
    (define L.fun/error8846.17.19
      (lambda (c.139 oprand0.27 oprand1.26)
        (let ((fun/error8847.16 (unsafe-procedure-ref c.139 0)))
          (call L.fun/error8847.16.18 fun/error8847.16))))
    (define L.fun/error8847.16.18
      (lambda (c.138)
        (let ((fun/error8848.22 (unsafe-procedure-ref c.138 0)))
    ...
    (define L.make-vector.125.14
      (lambda (c.134 tmp.98)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.134 0)))
          (if (fixnum? tmp.98)
            (call L.make-init-vector.4.13 make-init-vector.4 tmp.98)
            (error 8)))))
    (define L.make-init-vector.4.13
      (lambda (c.133 tmp.70)
        (let ((vector-init-loop.72 (unsafe-procedure-ref c.133 0)))
    ...
    (define L.vector-init-loop.72.12
      (lambda (c.132 len.73 i.75 vec.74)
        (let ((vector-init-loop.72 (unsafe-procedure-ref c.132 0)))
          (if (eq? len.73 i.75)
            vec.74
            (begin
    ...
    (define L.vector-set!.126.11
      (lambda (c.131 tmp.100 tmp.101 tmp.102)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.131 0)))
          (if (fixnum? tmp.101)
            (if (vector? tmp.100)
              (call
               L.unsafe-vector-set!.5.10
      ...
      (lambda (c.130 tmp.76 tmp.77 tmp.78)
        (let ()
          (if (unsafe-fx< tmp.77 (unsafe-vector-length tmp.76))
            ...
            (error 10)))))
    (let ((unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.10 3 0))
          (vector-set!.126 (make-procedure L.vector-set!.126.11 3 1))
          (vector-init-loop.72 (make-procedure L.vector-init-loop.72.12 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.13 1 1))
          (make-vector.125 (make-procedure L.make-vector.125.14 1 1))
          (*.124 (make-procedure L.*.124.15 2 0))
          (error?.123 (make-procedure L.error?.123.16 1 0))
          (cons.122 (make-procedure L.cons.122.17 2 0))
          (fun/error8847.16 (make-procedure L.fun/error8847.16.18 0 1))
          (fun/error8846.17 (make-procedure L.fun/error8846.17.19 2 1))
          (fun/pair8849.18 (make-procedure L.fun/pair8849.18.20 1 1))
          (fun/fixnum8851.19 (make-procedure L.fun/fixnum8851.19.21 1 0))
          (fun/fixnum8850.20 (make-procedure L.fun/fixnum8850.20.22 1 0))
          (fun/error8852.21 (make-procedure L.fun/error8852.21.23 0 1))
          (fun/error8848.22 (make-procedure L.fun/error8848.22.24 0 0))
          (fun/error8853.23 (make-procedure L.fun/error8853.23.25 0 0))
          (fun/error8854.24 (make-procedure L.fun/error8854.24.26 0 0))
          (fun/error8855.25 (make-procedure L.fun/error8855.25.27 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.126 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.72 0 vector-init-loop.72)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.72)
        (unsafe-procedure-set! make-vector.125 0 make-init-vector.4)
        (unsafe-procedure-set! fun/error8847.16 0 fun/error8848.22)
        (unsafe-procedure-set! fun/error8846.17 0 fun/error8847.16)
        (unsafe-procedure-set! fun/pair8849.18 0 cons.122)
        (unsafe-procedure-set! fun/error8852.21 0 fun/error8853.23)
        (let ((tmp.7.31
               (call
                  ...
                  (if tmp.12.53
                    ...
                    (let ((tmp.13.54
                      ...
                      (if tmp.13.54
                        ...
                        (let ((procedure0.67
                               (let ((lam.129
                                      (make-procedure L.lam.129.30 1 0)))
                                 lam.129)))
                          (let () (error 252)))))))))))))))
(check-by-interp
 '(module
    ...
    (define L.fun/void8861.14.21
      (lambda (c.128 oprand0.21 oprand1.20)
        (let ((vector-set!.110 (unsafe-procedure-ref c.128 0)))
          (call
           L.vector-set!.110.17
           vector-set!.110
           oprand1.20
    ...
    (define L.vector-set!.110.17
      (lambda (c.124 tmp.88 tmp.89 tmp.90)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.124 0)))
          (if (fixnum? tmp.89)
            (if (vector? tmp.88)
              (call
    ...
    (define L.make-vector.113.13
      (lambda (c.120 tmp.86)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.120 0)))
          (if (fixnum? tmp.86)
            (call L.make-init-vector.4.12 make-init-vector.4 tmp.86)
            (error 8)))))
    (define L.make-init-vector.4.12
      (lambda (c.119 tmp.58)
        (let ((vector-init-loop.60 (unsafe-procedure-ref c.119 0)))
    ...
    (define L.vector-init-loop.60.11
      (lambda (c.118 len.61 i.63 vec.62)
        (let ((vector-init-loop.60 (unsafe-procedure-ref c.118 0)))
          (if (eq? len.61 i.63)
            vec.62
            (begin
      ...
      (lambda (c.117 tmp.76 tmp.77)
        (let ()
          (if (fixnum? tmp.77)
            ...
            (error 3)))))
    (let ((|-.114| (make-procedure L.-.114.10 2 0))
          (vector-init-loop.60 (make-procedure L.vector-init-loop.60.11 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.12 1 1))
          (make-vector.113 (make-procedure L.make-vector.113.13 1 1))
          (cons.112 (make-procedure L.cons.112.14 2 0))
          (error?.111 (make-procedure L.error?.111.15 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.16 3 0))
          (vector-set!.110 (make-procedure L.vector-set!.110.17 3 1))
          (fun/fixnum8859.11 (make-procedure L.fun/fixnum8859.11.18 0 0))
          (fun/fixnum8863.12 (make-procedure L.fun/fixnum8863.12.19 0 0))
          (fun/fixnum8864.13 (make-procedure L.fun/fixnum8864.13.20 1 0))
          (fun/void8861.14 (make-procedure L.fun/void8861.14.21 2 1))
          (fun/error8865.15 (make-procedure L.fun/error8865.15.22 1 0))
          (fun/fixnum8858.16 (make-procedure L.fun/fixnum8858.16.23 0 0))
          (fun/fixnum8860.17 (make-procedure L.fun/fixnum8860.17.24 2 0))
          (fun/empty8862.18 (make-procedure L.fun/empty8862.18.25 1 0)))
      (begin
        (unsafe-procedure-set! vector-init-loop.60 0 vector-init-loop.60)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.60)
        (unsafe-procedure-set! make-vector.113 0 make-init-vector.4)
        (unsafe-procedure-set! vector-set!.110 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! fun/void8861.14 0 vector-set!.110)
        (let ((g43092885.26
                 ...
                 (if tmp.7.27
                   ...
                   (let ((tmp.8.28
                     ...
                     (if tmp.8.28
                       ...
                       (let ((procedure0.31
                              (let ((lam.115
                                     (make-procedure L.lam.115.26 0 0)))
                                lam.115))
                             (error1.30 (error 143))
                             (void2.29 (void)))
                         166)))))))
                     ...
                     (let ((tmp.10.57 (error 62)))
                       (if tmp.10.57
                         ...
                         (call
                          ...
                          fun/error8865.15
                          (let ((lam.116 (make-procedure L.lam.116.27 0 0)))
                            lam.116)))))))))))))))
(check-by-interp
 '(module
    (define L.lam.93.19
      (lambda (c.103)
        (let ((cons.92 (unsafe-procedure-ref c.103 0)))
          (call
           L.cons.92.10
           cons.92
           148
    ...
    (define L.fun/fixnum8868.15.18
      (lambda (c.102 oprand0.17 oprand1.16)
        (let ((fun/fixnum8869.14 (unsafe-procedure-ref c.102 0)))
    ...
    (define L.make-init-vector.4.15
      (lambda (c.99 tmp.37)
        (let ((vector-init-loop.39 (unsafe-procedure-ref c.99 0)))
    ...
    (define L.vector-init-loop.39.14
      (lambda (c.98 len.40 i.42 vec.41)
        (let ((vector-init-loop.39 (unsafe-procedure-ref c.98 0)))
          (if (eq? len.40 i.42)
            vec.41
            (begin
    ...
    (let ((cons.92 (make-procedure L.cons.92.10 2 0))
          (error?.91 (make-procedure L.error?.91.11 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.12 3 0))
          (vector-set!.90 (make-procedure L.vector-set!.90.13 3 1))
          (vector-init-loop.39 (make-procedure L.vector-init-loop.39.14 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.15 1 1))
          (make-vector.89 (make-procedure L.make-vector.89.16 1 1))
          (fun/fixnum8869.14 (make-procedure L.fun/fixnum8869.14.17 0 0))
          (fun/fixnum8868.15 (make-procedure L.fun/fixnum8868.15.18 2 1)))
      (begin
        ...
        (unsafe-procedure-set! fun/fixnum8868.15 0 fun/fixnum8869.14)
        (if (let ((empty0.20 empty)
                  (vector1.19
                   (let ((tmp.7.21
                          (call L.make-vector.89.16 make-vector.89 8)))
                     (let ((g43096720.22
                            (call
                             L.vector-set!.90.13
                             vector-set!.90
                                               ...
                                               (if (call
                                                 ...
                                                 (let ((g43096727.29
                                                   ...
                                                   (if (call
                                                     ...
                                                     tmp.7.21))))))))))))))))))
                  (procedure2.18
                   (let ((lam.93 (make-procedure L.lam.93.19 0 1)))
                     (begin (unsafe-procedure-set! lam.93 0 cons.92) lam.93))))
              #f)
          (if #f 51 196)
          (call
 ...
 '(module
    (define L.fun/pair8877.12.16
      (lambda (c.75 oprand0.15)
        (let ((cons.68 (unsafe-procedure-ref c.75 0)))
          (call
           L.cons.68.10
           cons.68
           28
    ...
    (define L.fun/fixnum8872.10.14
      (lambda (c.73 oprand0.14)
        (let ((fun/fixnum8873.8 (unsafe-procedure-ref c.73 0)))
          (call L.fun/fixnum8873.8.12 fun/fixnum8873.8))))
    (define L.fun/fixnum8874.9.13
      (lambda (c.72)
        (let ((fun/pair8877.12 (unsafe-procedure-ref c.72 0))
              (fun/fixnum8875.7 (unsafe-procedure-ref c.72 1)))
          (call
    ...
    (define L.fun/fixnum8875.7.11
      (lambda (c.70 oprand0.13)
        (let ((fun/fixnum8876.11 (unsafe-procedure-ref c.70 0)))
          (call L.fun/fixnum8876.11.15 fun/fixnum8876.11))))
    (define L.cons.68.10
      (lambda (c.69 tmp.63 tmp.64) (let () (cons tmp.63 tmp.64))))
    (let ((cons.68 (make-procedure L.cons.68.10 2 0))
          (fun/fixnum8875.7 (make-procedure L.fun/fixnum8875.7.11 1 1))
          (fun/fixnum8873.8 (make-procedure L.fun/fixnum8873.8.12 0 0))
          (fun/fixnum8874.9 (make-procedure L.fun/fixnum8874.9.13 0 2))
          (fun/fixnum8872.10 (make-procedure L.fun/fixnum8872.10.14 1 1))
          (fun/fixnum8876.11 (make-procedure L.fun/fixnum8876.11.15 0 0))
          (fun/pair8877.12 (make-procedure L.fun/pair8877.12.16 1 1)))
      (begin
        (unsafe-procedure-set! fun/fixnum8875.7 0 fun/fixnum8876.11)
        (unsafe-procedure-set! fun/fixnum8874.9 0 fun/pair8877.12)
        (unsafe-procedure-set! fun/fixnum8874.9 1 fun/fixnum8875.7)
        (unsafe-procedure-set! fun/fixnum8872.10 0 fun/fixnum8873.8)
        (unsafe-procedure-set! fun/pair8877.12 0 cons.68)
        (call
...
(check-by-interp
 '(module
    (define L.lam.99.21
      (lambda (c.111)
        (let ((vector-set!.97 (unsafe-procedure-ref c.111 0))
              (error?.98 (unsafe-procedure-ref c.111 1))
              (make-vector.96 (unsafe-procedure-ref c.111 2)))
    ...
    (define L.fun/empty8882.14.17
      (lambda (c.107)
        (let ((fun/empty8883.16 (unsafe-procedure-ref c.107 0)))
    ...
    (define L.make-vector.96.15
      (lambda (c.105 tmp.71)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.105 0)))
          (if (fixnum? tmp.71)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.71)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.104 tmp.43)
        (let ((vector-init-loop.45 (unsafe-procedure-ref c.104 0)))
    ...
    (define L.vector-init-loop.45.13
      (lambda (c.103 len.46 i.48 vec.47)
        (let ((vector-init-loop.45 (unsafe-procedure-ref c.103 0)))
          (if (eq? len.46 i.48)
            vec.47
            (begin
    ...
    (define L.vector-set!.97.12
      (lambda (c.102 tmp.73 tmp.74 tmp.75)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.102 0)))
          (if (fixnum? tmp.74)
            (if (vector? tmp.73)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.98 (make-procedure L.error?.98.10 1 0))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.11 3 0))
          (vector-set!.97 (make-procedure L.vector-set!.97.12 3 1))
          (vector-init-loop.45 (make-procedure L.vector-init-loop.45.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.96 (make-procedure L.make-vector.96.15 1 1))
          (cons.95 (make-procedure L.cons.95.16 2 0))
          (fun/empty8882.14 (make-procedure L.fun/empty8882.14.17 0 1))
          (fun/empty8885.15 (make-procedure L.fun/empty8885.15.18 2 0))
          (fun/empty8883.16 (make-procedure L.fun/empty8883.16.19 1 0))
          (fun/empty8884.17 (make-procedure L.fun/empty8884.17.20 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.97 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.45 0 vector-init-loop.45)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.45)
        (unsafe-procedure-set! make-vector.96 0 make-init-vector.4)
        (unsafe-procedure-set! fun/empty8882.14 0 fun/empty8883.16)
        (if (if #t #t #t)
            ...
            (if empty
              (if (call
                ...
                (if (let ((pair0.22
                          ...
                          (procedure1.21
                           (let ((lam.99 (make-procedure L.lam.99.21 0 3)))
                             (begin
                               (unsafe-procedure-set! lam.99 0 vector-set!.97)
                               (unsafe-procedure-set! lam.99 1 error?.98)
                               (unsafe-procedure-set! lam.99 2 make-vector.96)
                               lam.99))))
                      empty)
...
(check-by-interp
 '(module
    (define L.fun/ascii-char8894.10.13
      (lambda (c.68)
        (let ((fun/ascii-char8895.7 (unsafe-procedure-ref c.68 0)))
    ...
    (define L.fun/boolean8892.8.11
      (lambda (c.66 oprand0.12 oprand1.11)
        (let ((fun/boolean8893.9 (unsafe-procedure-ref c.66 0)))
          (call L.fun/boolean8893.9.12 fun/boolean8893.9))))
    (define L.fun/ascii-char8895.7.10 (lambda (c.65) (let () #\I)))
    (let ((fun/ascii-char8895.7 (make-procedure L.fun/ascii-char8895.7.10 0 0))
          (fun/boolean8892.8 (make-procedure L.fun/boolean8892.8.11 2 1))
          (fun/boolean8893.9 (make-procedure L.fun/boolean8893.9.12 0 0))
          (fun/ascii-char8894.10
           (make-procedure L.fun/ascii-char8894.10.13 0 1)))
      (begin
        (unsafe-procedure-set! fun/boolean8892.8 0 fun/boolean8893.9)
        (unsafe-procedure-set! fun/ascii-char8894.10 0 fun/ascii-char8895.7)
        (if (call
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8898.10.13
      (lambda (c.69)
        (let ((fun/error8902.8 (unsafe-procedure-ref c.69 0))
              (fun/empty8899.7 (unsafe-procedure-ref c.69 1)))
          (call
    ...
    (define L.fun/empty8900.9.12
      (lambda (c.68)
        (let ((fun/empty8901.11 (unsafe-procedure-ref c.68 0)))
    ...
    (define L.fun/empty8899.7.10
      (lambda (c.66 oprand0.12)
        (let ((fun/empty8900.9 (unsafe-procedure-ref c.66 0)))
          (call L.fun/empty8900.9.12 fun/empty8900.9))))
    (let ((fun/empty8899.7 (make-procedure L.fun/empty8899.7.10 1 1))
          (fun/error8902.8 (make-procedure L.fun/error8902.8.11 1 0))
          (fun/empty8900.9 (make-procedure L.fun/empty8900.9.12 0 1))
          (fun/empty8898.10 (make-procedure L.fun/empty8898.10.13 0 2))
          (fun/empty8901.11 (make-procedure L.fun/empty8901.11.14 0 0)))
      (begin
        (unsafe-procedure-set! fun/empty8899.7 0 fun/empty8900.9)
        (unsafe-procedure-set! fun/empty8900.9 0 fun/empty8901.11)
        (unsafe-procedure-set! fun/empty8898.10 0 fun/error8902.8)
        (unsafe-procedure-set! fun/empty8898.10 1 fun/empty8899.7)
...
(check-by-interp
 '(module
    ...
    (let ((cons.64 (make-procedure L.cons.64.10 2 0))
          (fun/empty8905.7 (make-procedure L.fun/empty8905.7.11 1 0)))
      (let ()
        (call
         ...
         (let ((void0.11 (void))
               (procedure1.10
                (let ((lam.65 (make-procedure L.lam.65.12 0 0))) lam.65))
               (fixnum2.9 220))
           (call
            L.cons.64.10
            cons.64
 ...
 '(module
    ...
    (define L.fun/empty8908.9.13
      (lambda (c.75 oprand0.16)
        (let ((fun/empty8910.11 (unsafe-procedure-ref c.75 0))
              (fun/boolean8909.10 (unsafe-procedure-ref c.75 1)))
    ...
    (let ((error?.71 (make-procedure L.error?.71.10 1 0))
          (fun/fixnum8912.7 (make-procedure L.fun/fixnum8912.7.11 2 0))
          (fun/error8911.8 (make-procedure L.fun/error8911.8.12 2 0))
          (fun/empty8908.9 (make-procedure L.fun/empty8908.9.13 1 2))
          (fun/boolean8909.10 (make-procedure L.fun/boolean8909.10.14 0 0))
          (fun/empty8910.11 (make-procedure L.fun/empty8910.11.15 0 0)))
      (begin
        (unsafe-procedure-set! fun/empty8908.9 0 fun/empty8910.11)
        (unsafe-procedure-set! fun/empty8908.9 1 fun/boolean8909.10)
        (call
...
(check-by-interp
 '(module
    ...
    (define L.fun/empty8915.7.10
      (lambda (c.64)
        (let ((fun/ascii-char8917.9 (unsafe-procedure-ref c.64 0))
              (fun/empty8916.8 (unsafe-procedure-ref c.64 1)))
          (call
           ...
           (call
            ...
            (if #t #t #f))))))
    (let ((fun/empty8915.7 (make-procedure L.fun/empty8915.7.10 0 2))
          (fun/empty8916.8 (make-procedure L.fun/empty8916.8.11 1 0))
          (fun/ascii-char8917.9
           (make-procedure L.fun/ascii-char8917.9.12 1 0)))
      (begin
        (unsafe-procedure-set! fun/empty8915.7 0 fun/ascii-char8917.9)
        (unsafe-procedure-set! fun/empty8915.7 1 fun/empty8916.8)
        (call L.fun/empty8915.7.10 fun/empty8915.7)))))
(check-by-interp
 '(module
    (define L.lam.139.26
      (lambda (c.157)
        (let () (let ((lam.140 (make-procedure L.lam.140.27 0 0))) lam.140))))
    (define L.lam.140.27 (lambda (c.158) (let () 738)))
    (define L.fun/void8927.22.25
      (lambda (c.156)
        (let ((make-vector.137 (unsafe-procedure-ref c.156 0))
              (error?.138 (unsafe-procedure-ref c.156 1))
              (vector-set!.136 (unsafe-procedure-ref c.156 2)))
          (let ((vector0.30
                 (let ((tmp.7.31
    ...
    (define L.fun/void8923.20.23
      (lambda (c.154 oprand0.29)
        (let ((vector-set!.136 (unsafe-procedure-ref c.154 0))
              (cons.135 (unsafe-procedure-ref c.154 1)))
          (let ()
            (call
             L.vector-set!.136.15
             vector-set!.136
    ...
    (define L.fun/fixnum8920.18.21
      (lambda (c.152 oprand0.28 oprand1.27)
        (let ((fun/fixnum8921.17 (unsafe-procedure-ref c.152 0)))
          (call L.fun/fixnum8921.17.20 fun/fixnum8921.17))))
    (define L.fun/fixnum8921.17.20
      (lambda (c.151)
        (let ((fun/fixnum8922.15 (unsafe-procedure-ref c.151 0)))
    ...
    (define L.make-vector.137.13
      (lambda (c.144 tmp.111)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.144 0)))
          (if (fixnum? tmp.111)
    ...
    (define L.vector-init-loop.85.11
      (lambda (c.142 len.86 i.88 vec.87)
        (let ((vector-init-loop.85 (unsafe-procedure-ref c.142 0)))
          (if (eq? len.86 i.88)
            vec.87
            (begin
              (unsafe-vector-set! vec.87 i.88 0)
    ...
    (let ((error?.138 (make-procedure L.error?.138.10 1 0))
          (vector-init-loop.85 (make-procedure L.vector-init-loop.85.11 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.12 1 1))
          (make-vector.137 (make-procedure L.make-vector.137.13 1 1))
          (unsafe-vector-set!.5 (make-procedure L.unsafe-vector-set!.5.14 3 0))
          (vector-set!.136 (make-procedure L.vector-set!.136.15 3 1))
          (cons.135 (make-procedure L.cons.135.16 2 0))
          (fun/void8925.14 (make-procedure L.fun/void8925.14.17 2 0))
          (fun/fixnum8922.15 (make-procedure L.fun/fixnum8922.15.18 0 0))
          (fun/void8928.16 (make-procedure L.fun/void8928.16.19 2 0))
          (fun/fixnum8921.17 (make-procedure L.fun/fixnum8921.17.20 0 1))
          (fun/fixnum8920.18 (make-procedure L.fun/fixnum8920.18.21 2 1))
          (fun/void8924.19 (make-procedure L.fun/void8924.19.22 0 0))
          (fun/void8923.20 (make-procedure L.fun/void8923.20.23 1 2))
          (fun/void8926.21 (make-procedure L.fun/void8926.21.24 0 0))
          (fun/void8927.22 (make-procedure L.fun/void8927.22.25 0 3)))
      (begin
        (unsafe-procedure-set! vector-init-loop.85 0 vector-init-loop.85)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.85)
        (unsafe-procedure-set! make-vector.137 0 make-init-vector.4)
        (unsafe-procedure-set! vector-set!.136 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! fun/fixnum8921.17 0 fun/fixnum8922.15)
        (unsafe-procedure-set! fun/fixnum8920.18 0 fun/fixnum8921.17)
        (unsafe-procedure-set! fun/void8923.20 0 vector-set!.136)
        (unsafe-procedure-set! fun/void8923.20 1 cons.135)
        (unsafe-procedure-set! fun/void8927.22 0 make-vector.137)
        (unsafe-procedure-set! fun/void8927.22 1 error?.138)
        (unsafe-procedure-set! fun/void8927.22 2 vector-set!.136)
        (call
...
(check-by-interp
 '(module
    (define L.fun/fixnum8933.8.11
      (lambda (c.62)
        (let ((fun/boolean8934.7 (unsafe-procedure-ref c.62 0)))
          (if (call L.fun/boolean8934.7.10 fun/boolean8934.7)
            (if #t 180 142)
            (let () 34)))))
    (define L.fun/boolean8934.7.10 (lambda (c.61) (let () #t)))
    (let ((fun/boolean8934.7 (make-procedure L.fun/boolean8934.7.10 0 0))
          (fun/fixnum8933.8 (make-procedure L.fun/fixnum8933.8.11 0 1)))
      (begin
        (unsafe-procedure-set! fun/fixnum8933.8 0 fun/boolean8934.7)
 ...
 '(module
    (define L.lam.88.16
      (lambda (c.96 oprand0.19)
        (let () (let ((lam.89 (make-procedure L.lam.89.17 0 0))) lam.89))))
    ...
    (let ((error?.87 (make-procedure L.error?.87.10 1 0))
          (ascii-char?.86 (make-procedure L.ascii-char?.86.11 1 0))
          (cons.85 (make-procedure L.cons.85.12 2 0))
          (fun/void8949.12 (make-procedure L.fun/void8949.12.13 2 0))
          (fun/void8950.13 (make-procedure L.fun/void8950.13.14 0 0))
          (fun/void8951.14 (make-procedure L.fun/void8951.14.15 0 0)))
      (if (call
           L.ascii-char?.86.11
           ascii-char?.86
           (let ((procedure0.18
                  (let ((lam.88 (make-procedure L.lam.88.16 1 0))) lam.88))
                 (pair1.17
                  (call
                   L.cons.85.12
                   cons.85
...
(check-by-interp
 '(module
    (define L.fun/error8957.9.12
      (lambda (c.64)
        (let ((fun/error8958.7 (unsafe-procedure-ref c.64 0)))
          (call L.fun/error8958.7.10 fun/error8958.7))))
    (define L.fun/error8956.8.11
      (lambda (c.63)
        (let ((fun/error8957.9 (unsafe-procedure-ref c.63 0)))
          (call L.fun/error8957.9.12 fun/error8957.9))))
    (define L.fun/error8958.7.10
      (lambda (c.62) (let () (if #t (error 216) (error 110)))))
    (let ((fun/error8958.7 (make-procedure L.fun/error8958.7.10 0 0))
          (fun/error8956.8 (make-procedure L.fun/error8956.8.11 0 1))
          (fun/error8957.9 (make-procedure L.fun/error8957.9.12 0 1)))
      (begin
        (unsafe-procedure-set! fun/error8956.8 0 fun/error8957.9)
        (unsafe-procedure-set! fun/error8957.9 0 fun/error8958.7)
...
(check-by-interp
 '(module
    ...
    (define L.fun/error8961.7.11
      (lambda (c.65)
        (let ((fun/error8962.8 (unsafe-procedure-ref c.65 0)))
          (call L.fun/error8962.8.12 fun/error8962.8))))
    (define L.cons.63.10
      (lambda (c.64 tmp.58 tmp.59) (let () (cons tmp.58 tmp.59))))
    (let ((cons.63 (make-procedure L.cons.63.10 2 0))
          (fun/error8961.7 (make-procedure L.fun/error8961.7.11 0 1))
          (fun/error8962.8 (make-procedure L.fun/error8962.8.12 0 0)))
      (begin
        (unsafe-procedure-set! fun/error8961.7 0 fun/error8962.8)
        (let ((pair0.10
               (call
                L.cons.63.10
                cons.63
...
(check-by-interp
 '(module
    ...
    (define L.make-init-vector.4.14
      (lambda (c.98 tmp.39)
        (let ((vector-init-loop.41 (unsafe-procedure-ref c.98 0)))
    ...
    (define L.vector-init-loop.41.13
      (lambda (c.97 len.42 i.44 vec.43)
        (let ((vector-init-loop.41 (unsafe-procedure-ref c.97 0)))
          (if (eq? len.42 i.44)
            vec.43
            (begin
    ...
    (let ((error?.93 (make-procedure L.error?.93.10 1 0))
          ...
          (fun/ascii-char8966.15
           (make-procedure L.fun/ascii-char8966.15.16 2 0))
          (fun/ascii-char8965.16
           (make-procedure L.fun/ascii-char8965.16.17 2 0)))
      (begin
        (unsafe-procedure-set! vector-set!.92 0 unsafe-vector-set!.5)
...
(check-by-interp
 '(module
    ...
    (define L.lam.75.11
      (lambda (c.78)
        (let ((fun/void8969.13 (unsafe-procedure-ref c.78 0)))
          (let ((tmp.7.17 (void)))
            (if tmp.7.17
              tmp.7.17
    ...
    (let ((fun/void8969.13 (make-procedure L.fun/void8969.13.10 0 0)))
      (let ((ascii-char0.16 (if #f #\a #\S))
            (procedure1.15
             (let ((lam.75 (make-procedure L.lam.75.11 0 1)))
               (begin
                 (unsafe-procedure-set! lam.75 0 fun/void8969.13)
                 lam.75)))
            (procedure2.14
             (let ((lam.76 (make-procedure L.lam.76.12 0 0))) lam.76)))
        (if #t (error 237) (error 2))))))
(check-by-interp
 '(module
    (define L.fun/boolean8972.9.12
      (lambda (c.67)
        (let ((fun/boolean8973.8 (unsafe-procedure-ref c.67 0)))
          (call
           L.fun/boolean8973.8.11
           fun/boolean8973.8
           (if #f
             (let ((lam.63 (make-procedure L.lam.63.13 0 0))) lam.63)
             (let ((lam.64 (make-procedure L.lam.64.14 0 0))) lam.64))))))
    ...
    (define L.fun/boolean8973.8.11
      (lambda (c.66 oprand0.10)
        (let ((fun/boolean8974.7 (unsafe-procedure-ref c.66 0)))
          (call L.fun/boolean8974.7.10 fun/boolean8974.7))))
    (define L.fun/boolean8974.7.10 (lambda (c.65) (let () #t)))
    (let ((fun/boolean8974.7 (make-procedure L.fun/boolean8974.7.10 0 0))
          (fun/boolean8973.8 (make-procedure L.fun/boolean8973.8.11 1 1))
          (fun/boolean8972.9 (make-procedure L.fun/boolean8972.9.12 0 1)))
      (begin
        (unsafe-procedure-set! fun/boolean8973.8 0 fun/boolean8974.7)
        (unsafe-procedure-set! fun/boolean8972.9 0 fun/boolean8973.8)
...
(check-by-interp
 '(module
    ...
    (define L.make-vector.87.15
      (lambda (c.96 tmp.61)
        (let ((make-init-vector.4 (unsafe-procedure-ref c.96 0)))
          (if (fixnum? tmp.61)
            (call L.make-init-vector.4.14 make-init-vector.4 tmp.61)
            (error 8)))))
    (define L.make-init-vector.4.14
      (lambda (c.95 tmp.33)
        (let ((vector-init-loop.35 (unsafe-procedure-ref c.95 0)))
    ...
    (define L.vector-init-loop.35.13
      (lambda (c.94 len.36 i.38 vec.37)
        (let ((vector-init-loop.35 (unsafe-procedure-ref c.94 0)))
          (if (eq? len.36 i.38)
            vec.37
            (begin
    ...
    (define L.vector-set!.88.12
      (lambda (c.93 tmp.63 tmp.64 tmp.65)
        (let ((unsafe-vector-set!.5 (unsafe-procedure-ref c.93 0)))
          (if (fixnum? tmp.64)
            (if (vector? tmp.63)
              (call
               L.unsafe-vector-set!.5.11
    ...
    (let ((error?.89 (make-procedure L.error?.89.10 1 0))
          ...
          (vector-init-loop.35 (make-procedure L.vector-init-loop.35.13 3 1))
          (make-init-vector.4 (make-procedure L.make-init-vector.4.14 1 1))
          (make-vector.87 (make-procedure L.make-vector.87.15 1 1))
          (pair?.86 (make-procedure L.pair?.86.16 1 0))
          (cons.85 (make-procedure L.cons.85.17 2 0))
          (fun/boolean8978.9 (make-procedure L.fun/boolean8978.9.18 1 0))
          (fun/procedure8982.10 (make-procedure L.fun/procedure8982.10.19 0 0))
          (fun/void8979.11 (make-procedure L.fun/void8979.11.20 2 1))
          (fun/void8977.12 (make-procedure L.fun/void8977.12.21 0 0))
          (fun/void8980.13 (make-procedure L.fun/void8980.13.22 0 1))
          (fun/void8981.14 (make-procedure L.fun/void8981.14.23 0 0)))
      (begin
        (unsafe-procedure-set! vector-set!.88 0 unsafe-vector-set!.5)
        (unsafe-procedure-set! vector-init-loop.35 0 vector-init-loop.35)
        (unsafe-procedure-set! make-init-vector.4 0 vector-init-loop.35)
        (unsafe-procedure-set! make-vector.87 0 make-init-vector.4)
        (unsafe-procedure-set! fun/void8979.11 0 fun/void8980.13)
        (unsafe-procedure-set! fun/void8980.13 0 fun/void8981.14)
      ...
      (lambda (c.75 tmp.43 tmp.44)
        (let ()
          (if (fixnum? tmp.44)
            ...
            (error 6)))))
    (let ((>.73 (make-procedure L.>.73.10 2 0))
          (error?.72 (make-procedure L.error?.72.11 1 0))
          (cons.71 (make-procedure L.cons.71.12 2 0))
          (fun/fixnum8985.7 (make-procedure L.fun/fixnum8985.7.13 1 0)))
      (if (call
           L.>.73.10
           >.73
           (call
        ...
        (let ((pair0.15
          ...
          (void))
        (let ((procedure0.18
               (let ((lam.74 (make-procedure L.lam.74.14 0 0))) lam.74))
              (fixnum1.17 181)
              (pair2.16
               (call
                L.cons.71.12
...
(check-by-interp
 '(module
    ...
    (define L.fun/void8988.7.11
      (lambda (c.66)
        (let ((fun/void8990.9 (unsafe-procedure-ref c.66 0))
              (cons.64 (unsafe-procedure-ref c.66 1))
              (fun/boolean8989.8 (unsafe-procedure-ref c.66 2)))
          (if (call
    ...
    (define L.cons.64.10
      (lambda (c.65 tmp.59 tmp.60) (let () (cons tmp.59 tmp.60))))
    (let ((cons.64 (make-procedure L.cons.64.10 2 0))
          (fun/void8988.7 (make-procedure L.fun/void8988.7.11 0 3))
          (fun/boolean8989.8 (make-procedure L.fun/boolean8989.8.12 1 0))
          (fun/void8990.9 (make-procedure L.fun/void8990.9.13 1 0)))
      (begin
        (unsafe-procedure-set! fun/void8988.7 0 fun/void8990.9)
        (unsafe-procedure-set! fun/void8988.7 1 cons.64)
        (unsafe-procedure-set! fun/void8988.7 2 fun/boolean8989.8)
 ...
 '(module
    ...
    (define L.fun/fixnum8993.7.10
      (lambda (c.64 oprand0.9)
        (let ((fun/fixnum8994.8 (unsafe-procedure-ref c.64 0)))
          (call L.fun/fixnum8994.8.11 fun/fixnum8994.8))))
    (let ((fun/fixnum8993.7 (make-procedure L.fun/fixnum8993.7.10 1 1))
          (fun/fixnum8994.8 (make-procedure L.fun/fixnum8994.8.11 0 0)))
      (begin
        (unsafe-procedure-set! fun/fixnum8993.7 0 fun/fixnum8994.8)
        (call
         L.fun/fixnum8993.7.10
         fun/fixnum8993.7
         (let ()
           (let ((empty0.10 empty))
             (let ((lam.63 (make-procedure L.lam.63.12 0 0))) lam.63))))))))
(check-by-interp
 '(module
    ...
    (define L.fun/error8998.7.10
      (lambda (c.69)
        (let ((fun/error8999.8 (unsafe-procedure-ref c.69 0)))
          (call L.fun/error8999.8.11 fun/error8999.8))))
    (let ((fun/error8998.7 (make-procedure L.fun/error8998.7.10 0 1))
          (fun/error8999.8 (make-procedure L.fun/error8999.8.11 0 0))
          (fun/boolean9002.9 (make-procedure L.fun/boolean9002.9.12 0 0))
          (fun/error8997.10 (make-procedure L.fun/error8997.10.13 1 1))
          (fun/boolean9001.11 (make-procedure L.fun/boolean9001.11.14 0 1))
          (fun/procedure9000.12
           (make-procedure L.fun/procedure9000.12.15 1 0)))
      (begin
        (unsafe-procedure-set! fun/error8998.7 0 fun/error8999.8)
        (unsafe-procedure-set! fun/error8997.10 0 fun/error8998.7)
        (unsafe-procedure-set! fun/boolean9001.11 0 fun/boolean9002.9)
        (call
